...
if($ecom_ismsnmetacode==1 && trim($ecom_msnmetacode))
{
 ...
 if($ecom_siteid==109 || $ecom_siteid==115)
 {
?>
...
else
{
    echo "<script type=\"text/javascript\" src=\"".url_head_link("images/".$ecom_hostname."/".$scripts_folder."/jquery.js",1)."\"></script>";
     echo "<script type=\"text/javascript\" src=\"".url_head_link("images/".$ecom_hostname."/".$scripts_folder."/jquery-ui.min.js",1)."\"></script>";
}
 if($ecom_siteid==109 || $ecom_siteid==115)
 {
	 //moved to home.php bottom
 }
 else
 {      
  ...
  echo 
    "
     <link href=\"".url_head_link("images/".$ecom_hostname."/".$css_folder."/bootstrap.min.css",1)."\" rel=\"stylesheet\">
        <link href=\"".url_head_link("images/".$ecom_hostname."/".$css_folder."/font-awesome.min.css",1)."\" rel=\"stylesheet\">

         <link href=\"".url_head_link("images/".$ecom_hostname."/".$css_folder."/backstretch_style.css",1)."\" media=\"screen\" type=\"text/css\" rel=\"stylesheet\" />

     <link href=\"".url_head_link("images/".$ecom_hostname."/".$css_folder."/".$ecom_themename.".css",1)."\" media=\"screen\" type=\"text/css\" rel=\"stylesheet\" />
               <link href=\"".url_head_link("images/".$ecom_hostname."/".$css_folder."/".$ecom_themename.".min.css",1)."\" media=\"screen\" type=\"text/css\" rel=\"stylesheet\" />

     
        <link href=\"".url_head_link("images/".$ecom_hostname."/".$css_folder."/responsive.css",1)."\" rel=\"stylesheet\">";
	}

    echo 
    "     
         <!--[if lt IE 9]>
              <script type=\"text/javascript\" src=\"".url_head_link("scripts/html5shiv.js",1)."\"></script>
              <script type=\"text/javascript\" src=\"".url_head_link("scripts/respond.min.js",1)."\"></script>

    <![endif]-->    

            <link rel=\"shortcut icon\" href=\"".url_head_link("images/".$ecom_hostname."/".$site_images_folder."/ico/favicon.ico",1)."\"/>
            
			<link rel=\"icon\" type=\"image/png\" href=\"".url_head_link("images/".$ecom_hostname."/".$site_images_folder."/ico/favicon-196x196.png",1)."\" sizes=\"196x196\" />
			<link rel=\"icon\" type=\"image/png\" href=\"".url_head_link("images/".$ecom_hostname."/".$site_images_folder."/ico/favicon-96x96.png",1)."\" sizes=\"96x96\" />
			<link rel=\"icon\" type=\"image/png\" href=\"".url_head_link("images/".$ecom_hostname."/".$site_images_folder."/ico/favicon-32x32.png",1)."\" sizes=\"32x32\" />
			<link rel=\"icon\" type=\"image/png\" href=\"".url_head_link("images/".$ecom_hostname."/".$site_images_folder."/ico/favicon-16x16.png",1)."\" sizes=\"16x16\" />
			<link rel=\"icon\" type=\"image/png\" href=\"".url_head_link("images/".$ecom_hostname."/".$site_images_folder."/ico/favicon-128.png",1)."\" sizes=\"128x128\" />
			<meta name=\"application-name\" content=\"Luxury Student Homes\"/>
			<meta name=\"msapplication-TileColor\" content=\"#FFFFFF\" />
			<meta name=\"msapplication-TileImage\" content=\"".url_head_link("images/".$ecom_hostname."/".$site_images_folder."/ico/mstile-144x144.png",1)."\" />
			<meta name=\"msapplication-square70x70logo\" content=\"".url_head_link("images/".$ecom_hostname."/".$site_images_folder."/ico/mstile-70x70.png",1)."\" />
			<meta name=\"msapplication-square150x150logo\" content=\"".url_head_link("images/".$ecom_hostname."/".$site_images_folder."/ico/mstile-150x150.png",1)."\" />
			<meta name=\"msapplication-wide310x150logo\" content=\"".url_head_link("images/".$ecom_hostname."/".$site_images_folder."/ico/mstile-310x150.png",1)."\" />
			<meta name=\"msapplication-square310x310logo\" content=\"".url_head_link("images/".$ecom_hostname."/".$site_images_folder."/ico/mstile-310x310.png",1)."\" />";
			if($ecom_siteid==109 || $ecom_siteid==115)
			{
				//moved to home.php bottom
				 echo "<link href=\"".url_head_link("images/".$ecom_hostname."/".$css_folder."/bootsnav.css",1)."\" rel=\"stylesheet\">
             ";
			}
			else
			{
        ...
        <link href=\"".url_head_link("images/".$ecom_hostname."/".$css_folder."/bootsnav.css",1)."\" rel=\"stylesheet\">
        <link href=\"".url_head_link("images/".$ecom_hostname."/".$css_folder."/overwrite.css",1)."\" rel=\"stylesheet\">
             <link href=\"".url_head_link("images/".$ecom_hostname."/".$css_folder."/owl.carousel.css",1)."\" rel=\"stylesheet\">
        <link href=\"".url_head_link("images/".$ecom_hostname."/".$css_folder."/owl.theme.css",1)."\" rel=\"stylesheet\">
   
           <link href=\"".url_head_link("images/".$ecom_hostname."/".$css_folder."/responsive_bootstrap_carousel.css",1)."\" rel=\"stylesheet\">
