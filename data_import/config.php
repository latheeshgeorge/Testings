...
// Source Site Details
// ###############################################################################
$src_siteid		= 263  ; // www.theturner.co.uk/ on old domain
$src_host 		= 'localhost';
$src_user 		= 'newserver';
$src_pass 		= 'yuj*dff';
$src_db 		= 'bshop_3_1'; 
define('SRC_DOCROOT','/var/www/vhosts/bshop4.co.uk/httpdocs/testings');
...
// ###############################################################################
// Path for the image resize 'convert'
// ###############################################################################
...
// ###############################################################################
$dest_siteid		= 98; //theturner.bshop4.co.uk  on new domain
$dest_host			= 'localhost';
$dest_user			= 'bshop_am4';
$dest_pass			= 'b$H0pF@Ur';
$dest_db			= 'business1st_bshop4';
define('DEST_DOCROOT','/var/www/vhosts/bshop4.co.uk/httpdocs'); 
...
$tree = '<strong>Import From</strong> '.$row_src['domain'].'<strong> to </strong>'.$row_dest['site_domain'];
...
$onclick = "this.style.display='none';document.getElementById('import_processing_div').style.display='';";

echo "<br>src: $src_image_path";
echo "<br>dest: $dest_image_path";
?>