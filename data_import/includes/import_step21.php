...
<td align="left"><?php echo $import_survey['sur_cnt']?></td>
</tr>
<tr>
<tr>
<td align="left" width="30%">Total Survey Results Imported</td>
<td align="left" width="3%">:</td>
<td align="left"><?php echo $import_survey['surres_cnt']?></td>
</tr>
...
<input type="hidden" name="next_step" value="step22" />
...
<input type="hidden" name="sur_cnt" value="<?php echo $import_survey['sur_cnt']?>" />
<input type="hidden" name="surres_cnt" value="<?php echo $import_survey['surres_cnt']?>" />
