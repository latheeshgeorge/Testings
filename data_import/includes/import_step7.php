...
<td align="left"><?php echo $import_cat_cnt['cat_cnt']?></td>
</tr>
<tr>
<td align="left">Total Product Categories mapped with keywords</td>
<td align="left">:</td>
<td align="left"><?php echo $import_cat_cnt['catmap_cnt']?></td>
</tr>
<tr>
...
<input type="hidden" name="next_step" value="step8" />
...
<input type="hidden" name="cat_cnt" value="<?php echo $import_cat_cnt['cat_cnt']?>" />
<input type="hidden" name="catmap_cnt" value="<?php echo $import_cat_cnt['catmap_cnt']?>" />
