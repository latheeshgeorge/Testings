...
<input type="hidden" name="next_step" value="step16" />
...
<input type="hidden" name="featured_cnt" value="<?php echo $import_misc['featured_cnt']?>" />
<input type="hidden" name="secprod_cnt" value="<?php echo $import_misc['secprod_cnt']?>" />
<input type="hidden" name="promo_cnt" value="<?php echo $import_misc['promo_cnt']?>" />
<input type="hidden" name="promoprod_cnt" value="<?php echo $import_misc['promoprod_cnt']?>" />
