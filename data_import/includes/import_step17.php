...
<td align="left"><?php echo $import_shop['shop_cnt']?></td>
</tr>
<tr>
<td align="left" width="30%">Total Products mapped with Shop By Brands</td>
<td align="left" width="3%">:</td>
<td align="left"><?php echo $import_shop['shopprod_cnt']?></td>
</tr>
<tr>
<td align="left" width="30%">Total Keywords imported for Shop By Brands</td>
<td align="left" width="3%">:</td>
<td align="left"><?php echo $import_shop['shopkw_cnt']?></td>
</tr>
...
<input type="hidden" name="next_step" value="step18" />
...
<input type="hidden" name="shop_cnt" value="<?php echo $import_shop['shop_cnt']?>" />
<input type="hidden" name="shopprod_cnt" value="<?php echo $import_shop['shopprod_cnt']?>" />
<input type="hidden" name="shopkw_cnt" value="<?php echo $import_shop['shopkw_cnt']?>" />
