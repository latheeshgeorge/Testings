...
<td align="left"><?php echo $import_users['usr_cnt']?></td>
</tr>
<tr>
...
<input type="hidden" name="next_step" value="step24" />
...
<input type="hidden" name="usr_cnt" value="<?php echo $import_users['usr_cnt']?>" />
