...
{
	fieldRequired = Array('customer_title','customer_fname','customer_email');
...
<form name='frmEditCustomer' action='home.php?request=customer_search' method="post" onsubmit="return valform(this);">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="2" align="left" valign="middle" class="treemenutd"><a href="home.php?request=customer_search&sort_by=<?=$_REQUEST['sort_by']?>&sort_order=<?=$_REQUEST['sort_order']?>&records_per_page=<?=$_REQUEST['records_per_page']?>&search_name=<?=$_REQUEST['search_name']?>&start=<?=$_REQUEST['start']?>&pg=<?=$_REQUEST['pg']?>">List Customers</a> &gt;&gt; Edit Customer</td>
        </tr>
        <tr>
		...
		<tr>
          ...
          <td width="72%" align="left" valign="middle" class="tdcolorgray">
		  <input class="input" type="text" name="customer_email" value="<?=$row_customer['customer_email']?>"  />		  </td>
        </tr>
		<tr>
		...
		?>
		 ...
		 // #Selecting already assigned groups
		  ...
		  <td colspan="2" align="left" valign="middle">
		   ...
		   <a href="#" onmouseover ="ddrivetip('<?=get_help_messages('EDIT_CUSTOMERS_NEWSLETT')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a></td>
          </table>
		  </td></tr>
		...
		if($db->num_rows($res_cat)>0)
		{
           ...
           <td  align="left" valign="middle" class="seperationtd"  width="97%">Please Select Your Favorite Categories:
		   		  <a href="#" onmouseover ="ddrivetip('<?=get_help_messages('EDIT_CUSTOMER_FAVCAT')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a>&nbsp;&nbsp;
		...
		<tr>
		 ...
		 <table width="100%" border="0" cellspacing="1" cellpadding="1">
            <tr>
			  ...
			  <a href="#" onmouseover ="ddrivetip('<?=get_help_messages('EDIT_CUSTOMERS_FAVPROD')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a>&nbsp;&nbsp;
</td>
            </tr>
          </table></td>
        </tr>
		<tr>
          <td colspan="2" align="right" valign="middle" class="tdcolorgray" ><input name="Addmore" type="button" class="red" id="Addmore" value="Assign More" onclick="document.frmEditCustomer.fpurpose.value='list_assign_products';document.frmEditCustomer.sort_order.value='';document.frmEditCustomer.sort_by.value='';document.frmEditCustomer.submit();" />
				...
				?>
					...
					<a href="#" onmouseover ="ddrivetip('<?=get_help_messages('EDIT_CUSTOMER_PROD_CHSTATUS')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a>
					...
					<a href="#" onmouseover ="ddrivetip('<?=get_help_messages('EDIT_CUSTOMER_PROD_UNASS')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a>
					</div>	
				<?php
				}				
				?></td>
