<?php
	...
	$help_msg 			= get_help_messages('ADD_SETTINGS_DELIVERY_EDIT_LOCATION_AMNT_MESS1');
...
<input type='hidden' name='add_fpurpose' value=''>
   <table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td colspan="2" class="treemenutd"><b>Location</b>&nbsp;&nbsp;&nbsp;&nbsp;<b><u><a href="home.php?request=delivery_settings&fpurpose=editdelivery&deliveryid=<? echo $delivery_id;?>"><font color="#CC0000" style="font-weight:normal">(Please Click here to add more Locations)</font></a></u></b><a href="#" onmouseover ="ddrivetip('<?=get_help_messages('ADD_DELIVERY_SETTINGS_LOCATION_AMT_ADD')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a></td>
	</tr>
	<?php
	...
	?>
			...
			?>
				...
				<td class="tdcolorgray" colspan="3">
