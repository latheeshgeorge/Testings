			...
			<td colspan="4" align="left" valign="middle">
				<div class="editarea_div">
					...
					<tr>
						...
						<td colspan="2" align="right"><input type="button" value="Submit and enter more rates" class="red"  onClick="return valform('more')"></td>
					</tr>
					</table>
				</div>
			</td>
...
?>
				<tr>
					<td colspan="4" align="left" valign="top" class="sorttd" >	
						<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
