...
<form name='frmAddSettingsCaptions' action='home.php?request=delivery_settings' method="post" onsubmit="return valform(this);">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="2" align="left" valign="middle" class="treemenutd"><div class="treemenutd_div"><a href="home.php?request=delivery_settings">Delivery Settings</a> <a href="home.php?request=delivery_settings&fpurpose=list_delmethod_groups&group_name=<?php echo $_REQUEST['group_name']?>&records_per_page=<?=$_REQUEST['records_per_page']?>&start=<?=$_REQUEST['start']?>&pg=<?=$_REQUEST['pg']?>&sort_by=<?=$_REQUEST['sort_by']?>&sort_order=<?=$_REQUEST['sort_order']?>">List Delivery Settings Groups </a><span> Edit <?php echo $page_type?></span></div></td>
        </tr>
        <tr>
        ...
        <tr>
		  ...
		  <div class="editarea_div">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
			 <td colspan="2" align="center" valign="middle" class="sorttd">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">	
        <tr>
		...
		?>
			...
			<td align="left" valign="middle" class="tdcolorgray" ><input name="delivery_group_free_delivery" type="radio" value="0" <?php echo ($row_group['delivery_group_free_delivery']==0)?'checked="checked"':''?>/>
			No 
			<input name="delivery_group_free_delivery" type="radio" value="1" <?php echo ($row_group['delivery_group_free_delivery']==1)?'checked="checked"':''?>/>
