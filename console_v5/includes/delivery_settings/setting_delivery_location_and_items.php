<?php
	/*#################################################################
	# Script Name 	: settings_delivery_location_and_items.php
	# Description 	: Delivery type location and items
	# Coded by 		: SKR
    ...
    $help_msg = get_help_messages('EDIT_DELIVERY_LOCATION_ITEMS_MESS1');
...
function handle_tabs(id,mod)
	...
	switch(mod)
	{
		case 'deliverymain_info':
			document.frmlistDelivery.fpurpose.value ='list_delivery_maininfo_items';
			document.frmlistDelivery.submit();
		break;
		case 'date_time': // Case of Categories in the group
			document.frmlistDelivery.fpurpose.value ='show_date_time_items';
...
<!--		   <tr>
		...
		<td colspan="4" align="left" valign="middle" class="sorttd" >
			...
			<tr>  
				...
				<tr>
				  <td colspan="<?php echo $colspan;?>" align="left" class="sorttd" ><div id='master_div'>
			<?php 
...
<!--		   <tr>
	...
	<tr>
		...
		<tr>
	  		<td align="left" style="width:35%;"><b>Location  :</b>  <input name="location" type="text" value="<? echo $rowloc['location_name'] ?>" size="50"></td><td  style="width:18%;" align='left'><div><input type="checkbox" onclick="javascript:handle_change_free_delivery();" name="location_free_delivery" id="location_free_delivery" value="1" <?php echo ($rowloc['location_free_delivery']==1)?'checked="checked"':''?>/>Allow Free Delivery? <a href="#" onmouseover ="ddrivetip('<?=get_help_messages('ADD_SETTINGS_DELIVERY_FREE_DELIVERY')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.gif" width="17" height="13" border="0" /></a></div><div><input type="checkbox" name="location_tax_applicable" id="location_tax_applicable" value="1" <?php echo ($rowloc['location_tax_applicable']==1)?'checked="checked"':''?>/>Apply Tax? <a href="#" onmouseover ="ddrivetip('<?=get_help_messages('ADD_SETTINGS_DELIVERY_APPLY_TAX')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.gif" width="17" height="13" border="0" /></a></div></td>
        ...
        <tr id="free_msg"style="display:<?php echo ($rowloc['location_free_delivery']==1)?'none':'none'?>" >
          <td align='center' colspan="3"><div><span class='redtext'>Options and charges set for this location (if any) will be ignored as "Allow free delivery" is ticked</span></div></td>
        </tr>
	 <?php 
	...
	?>
			<tr>
			  <td align="center" width="386"><b>Option</b></td>
  ...
  <?
   ...
   ?>
		   <tr>
			<td align="right" width="386"> <? echo $msg; ?> 
  ...
  <?
	...
	<? } ?>
 	  ...
 	  <tr id="largebuttonlink">
            ...
            <td colspan="2" align="left"><input name="button" type="button" class="red"  onclick="valform('more')" value="Submit and enter more rates" /></td>
          </tr>
          <tr id="largebuttonlink">
            <td colspan="3" align="center">&nbsp;</td>
          </tr>
