<?php
	/*#################################################################
	# Script Name 	: settings_delivery_location_and_amount.php
	# Description 	: Delivery type location and amount
	# Coded by 		: SKR
...
function handle_tabs(id,mod)
	...
	switch(mod)
	{
		case 'deliverymain_info':
			document.frmlistDelivery.fpurpose.value ='list_delivery_maininfo_amount';
			document.frmlistDelivery.submit();
		break;
		case 'date_time': // Case of Categories in the group
			document.frmlistDelivery.fpurpose.value ='show_date_time_amount';
...
<!--		   <tr>
	...
	?>
          <tr>
            <td align="center" width="446"><b>Option</b></td>
  ...
  while($row = $db->fetch_array($res))
  {
   ...
   ?>
          <tr>
            <td align="right" width="446"><? echo $msg; ?>
            ...
            <td colspan="2" align="center"><input name="price[]" class="input" type="text" size="5" value="<? echo $row['delopt_price']?>" />            </td>
          </tr>
          <?
  }
