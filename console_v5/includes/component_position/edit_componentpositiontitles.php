...
<form name='frmComponentTitles' action='home.php?request=comp_pos' method="post" onSubmit="return valform(this);" >
...
<table border="0" cellpadding="2" cellspacing="0" width="100%" align="left">
  <tr> 
	<td align="left" class="treemenutd"><div class="treemenutd_div"><a href="home.php?request=comp_pos&layoutcode=<?php echo $_REQUEST['passlayoutcode']?>">Assign and manage the components</a> <span> Edit Component Titles</span></div></td>
  </tr>
</table></td>
</tr>
<tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
			...
			<input type="submit" name="title_Submit" value="Save" class="red" />
			</div>
			</td>
  </tr>
<tr>
