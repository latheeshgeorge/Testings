<?php
	/*#################################################################
	# Script Name 	: list_product_shopbybrand_shopselproduct.php
...
$table_name			= 'products';
$page_type			= 'Products';
$help_msg 			= get_help_messages('LIST_PROD_SHOP_BRAND_MESS1');
...
$query_string 		= "request=shopbybrand&fpurpose=assign_selshopprod&pass_show_shopgroup=".$_REQUEST['pass_show_shopgroup']."&pass_sort_order=".$_REQUEST['pass_sort_order']."&pass_sort_by=".$_REQUEST['pass_sort_by']."&pass_pg=".$_REQUEST['pass_pg']."&pass_start=".$_REQUEST['pass_start']."&pass_records_per_page=".$_REQUEST['pass_records_per_page']."&pass_shopname=".$_REQUEST['pass_shopname']."&pass_shop_id=".$_REQUEST['pass_shop_id'];
...
$sql_assigned		= "SELECT products_product_id FROM product_shopbybrand_product_map WHERE product_shopbybrand_shopbrand_id=".$shop_id;
...
function call_save_selected(cname,sortby,sortorder,recs,start,pg,group_id) 
{
	...
	else
	{
		...
		{
			show_processing();
			document.frm_products.fpurpose.value='save_prodShopAssign';
...
<input type="hidden" name="fpurpose" value="assign_selshopprod" />
<input type="hidden" name="search_click" value="" />
<input type="hidden" name="pass_shop_id" value="<?=$shop_id?>" />
<input type="hidden" name="pass_show_shopgroup" value="<?=$_REQUEST['pass_show_shopgroup']?>" />
...
<table border="0" cellpadding="0" cellspacing="0" class="maintable">
    <tr>
      <td colspan="3" align="left" valign="middle" class="treemenutd"><div class="treemenutd_div"><a href="home.php?request=shopbybrand&fpurpose=edit&checkbox[0]=<?php echo $shop_id?>&shopname=<?=$_REQUEST['pass_shopname']?>&show_shopgroup=<?=$_REQUEST['pass_show_shopgroup']?>&sort_by=<?=$_REQUEST['pass_sort_by']?>&sort_order=<?=$_REQUEST['pass_sort_order']?>&records_per_page=<?=$_REQUEST['pass_records_per_page']?>&start=<?=$_REQUEST['pass_start']?>&pg=<?=$_REQUEST['pass_pg']?>&curtab=products_tab_td">Edit Product Shop</a> <span>Assign Product to '<? echo $show_groupname;?>'</span></div></td>
    </tr>
	<tr>
	...
	<?php 
		...
		?>
		 ...
		 ?> 
		 <tr>
		 <td width="232" align="right" class="sorttd" colspan="3">
        <?php 
    ...
    <tr>
		  ...
		  <table width="100%" height="56" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td align="left"><input name="Search_go" type="submit" class="red" id="Search_go" value="Go" onclick="document.frm_products.search_click.value=1" />
                <a href="#" onmouseover ="ddrivetip('<?=get_help_messages('LIST_PROD_SHOP_BRAND_GO')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a></td>
            </tr>
          </table>
		  </td>
        </tr>
     ...
     <tr>
      ...
      <table  border="0" cellpadding="1" cellspacing="0" class="listingtable" width="100%">
    <tr>
      
      <td width="317" align="right" class="listeditd" colspan="3">
	  <input name="change_hide" type="button" class="red" id="change_hide" onClick="call_save_selected()" value="Assign Selected">
	  &nbsp;<a href="#" onmouseover ="ddrivetip('<?=get_help_messages('LIST_PROD_SHOP_BRAND_ASS')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a></td>
    </tr>
    <tr>
	...
	<tr>
      <td align="right" class="listing_bottom_paging" colspan="4">
	  <?php 
		if ($db->num_rows($ret_qry))
		{
			paging_footer($query_string,$numcount,$pg,$pages,$page_type,$colspan);
