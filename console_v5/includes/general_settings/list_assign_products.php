...
$table_name='products';
$page_type='Products';
$help_msg =get_help_messages('LIST_PROD_ASS_EMAIL_MESS1');
...
$email_id=$pass_cat_id=($_REQUEST['pass_email_id']?$_REQUEST['pass_email_id']:'0');
/*
...
$sql_assigned_products = "SELECT products_product_id FROM general_settings_sites_mail_product_map where product_inactive_mail_id =".$email_id;
...
//#Search terms.
$query_string .= "request=general_settings&fpurpose=productAssign";
...
{ 
	...
	if (atleastone==0) 
	{
		alert('Please select the Products to assign to the email template');
		return false;
	}
	else
	{
		if(confirm('Assign Selected Product(s) to current email template?'))
		{
				show_processing();
...
<input type="hidden" name="request" value="general_settings" />
  <input type="hidden" name="product_ids" id="product_ids" value="" />
	...
	<input type="hidden" name="pass_email_id" value="<?=$pass_email_id?>" />

  <table border="0" cellpadding="0" cellspacing="0" class="maintable" width="100%">
    <tr>
      <td colspan="3" align="left" valign="middle" class="treemenutd">
		  <div class="treemenutd_div">
		  <a href="home.php?request=general_settings&fpurpose=sent_email_inactive&curtab=email_tab_td">Emails to Inactive Customer</a>
		  </div>
		  </td>
    </tr>
	 <tr>
    ...
    <tr>
      ...
      <table  border="0" cellpadding="0" cellspacing="0" class="listingtable" width="100%">
       ...
       <tr>     
	   <td class="listeditd" align="right" colspan="6">
