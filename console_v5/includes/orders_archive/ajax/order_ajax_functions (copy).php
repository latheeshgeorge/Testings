...
Payment Type
  <?php
		...
		?>
		 <tr>
           <td align="left" valign="middle" class="subcaption <?php echo $cls?>" >
		   <?PHP if($print_buttons != 1 and $row_ord['order_status']!='NOT_AUTH' and $chk_show_ord_status) {  ?><span class="subcaption listingtablestyleB">Change Order Status </span><? } ?></td>
  ...
  <tr>
	...
	?>
			<tr>
				...
				<table width="100%" cellpadding="1" cellspacing="0" border="0">
				<tr>
					<td align="left" class="listingtablestyleB" width="40%"><strong>Payment Type</strong></td>
				...
				<tr>
					<td align="left" class="listingtablestyleB"><strong>Payment Status</strong></td>
					<td align="left" class="listingtablestyleB">  <?php echo  getpaymentstatus_Name($row_ord['order_paystatus']);?></td>
				</tr>
				<?php
				if($row_ord['order_paystatus_changed_manually']==1) // case if payment status changed manually
				{
				?>
				<tr>
					<td align="left" class="listingtablestyleB"><strong>Payment Status Manually Changed by</strong></td>
					<td align="left" class="listingtablestyleB">
				...
				?>
					<tr>
						<td align="left" class="listingtablestyleB"><strong>Payment Manually done by</strong></td>
						<td align="left" class="listingtablestyleB">
				...
				?>
					...
					<tr>
					<td align="left" class="listingtablestyleB"><strong>Amount Paid while placing the order</strong></td>
					<td align="left" class="listingtablestyleB"><strong><?php echo print_price_selected_currency($row_ord['order_deposit_amt'],$row_ord['order_currency_convertionrate'],$row_ord['order_currency_symbol'],true)?></strong> (Product Deposit)</td>
					</tr>
					<?php
					...
					?>
						<tr>
						<td align="left" class="listingtablestyleB"><strong>Amount Remaining to be Released</strong></td>
						<td align="left" class="listingtablestyleB"><strong><?php echo print_price_selected_currency(($row_ord['order_totalprice']-$row_ord['order_deposit_amt']),$row_ord['order_currency_convertionrate'],$row_ord['order_currency_symbol'],true)?></strong></td>
						</tr>
					<?php
					}
				...
				?>
						<tr>
						<td align="left" class="listingtablestyleB"><strong>Released Remaining Amount</strong></td>
						<td align="left" class="listingtablestyleB"><strong><?php echo print_price_selected_currency(($row_ord['order_totalprice']-$row_ord['order_deposit_amt']),$row_ord['order_currency_convertionrate'],$row_ord['order_currency_symbol'],true)?></strong> By <?php echo $cleared_msg?></td>
						</tr>
				<?php	
					}
				}
  ...
  <tr>
	...
	elseif ($row_ord['order_paymenttype']=='cheque')
	{
		...
		?>
				...
				<tr>
					<td align="left" width="15%" class="subcaption listingtablestyleB" valign="top">
					Date of Cheque					</td>
 ...
 function show_Order_CustomerQueries($order_id,$alert='')
 {
	...
	?>
		...
		if($db->num_rows($ret_query))
		{
				...
				?>
					<tr>
						<td align="left" class="listingtablestyleB"><?php echo $i++;?></td>
					<td align="left" class="listingtablestyleB"><?php echo dateFormat($row_query['query_date'],'datetime')?></td>
					<td align="left" class="listingtablestyleB"><a href="home.php?request=order_enquiries&fpurpose=edit&checkbox[0]=<?php echo $row_query['query_id']?>&order_id=<?php echo $order_id?>" title="Click to view the query details" class="edittextlink"><?php echo stripslashes($row_query['query_subject'])?></a></td>
					<td align="left" class="listingtablestyleB">
					<?php
					...
					<td align="left" width="15%" class="listingtablestyleB">
					<?php
...
?>
		...
		?>
				...
				?>
					<tr>
						<td width="5%" align="left" valign="middle" class="listingtablestyleB">
						<input type="checkbox" name="download_check[]" id="download_check[]" value="<?php echo $row_query['ord_down_id']?>" />					  </td>
						<td align="left" valign="middle" class="listingtablestyleB"><?php echo $slno++;?>.</td>
						<td align="left" valign="middle" class="listingtablestyleB"><a href="home.php?request=products&fpurpose=edit_proddownload&checkbox[0]=<?php echo $row_prod['products_product_id']?>&edit_id=<?php echo $row_query['product_downloadable_products_proddown_id']?>&curtab=download_tab_td" title="Click to go to downlod edit page" class="edittextlink"><?php echo  stripslashes($row_query['proddown_title'])?></a>
						<?php 
						...
						<td align="center" valign="middle" class="listingtablestyleB">
						<?php 
					  ...
					  <?php	
						...
						?>					  </td>
						<td width="20%" align="center" valign="middle" class="listingtablestyleB">
						<?php
							if ($row_query['proddown_days_active']==1)
							{
						...
						?>					  </td>
						<td width="15%" align="center" valign="middle" class="listingtablestyleB">
				...
				?>
					...
					<td colspan="4" align="center">
						...
						<tr>
							...
							?>
									<tr>
										<td align="center" width="5%" class="listingtablestyleB"><?php echo $cnt++?></td>
										<td align="left" width="95%" class="listingtablestyleB"><?php echo $row_history['download_date']?></td>
									</tr>
							<?php
							}
							?>
							<tr>
									<td align="right" colspan="2" class="listingtablestyleB"><strong>Total Downloads: <?php echo ($cnt-1)?></strong></td>
						  </tr>
						</table>
					</td>
					</tr>
...
?>	
		...
		<tr>
			...
			<table width="100%" cellpadding="1" cellspacing="1" border="0">
			<tr>
				<td class="listingtablestyleB" width="20%">Gift Wrap Per</td>
				<td class="listingtablestyleB"><?php echo $row_ord['order_giftwrap_per']?></td>
				<td width="60%" class="listingtablestyleB">&nbsp;</td>
			</tr>
			<?php
			...
			?>
				<tr>
					<td class="listingtablestyleB" width="20%">Gift Wrap Mininum Price? </td>
					<td class="listingtablestyleB">&nbsp;</td>
					<td width="60%" class="listingtablestyleB"><?php echo print_price_selected_currency($row_ord['order_giftwrap_minprice'],$row_ord['order_currency_convertionrate'],$row_ord['order_currency_symbol'],true)?></td>
				</tr>
			<?php
			}
			?>	
			...
			?>
				<tr>
					<td class="listingtablestyleB" width="20%" align="left" valign="top">Gift Wrap Message</td>
					<td class="listingtablestyleB" valign="top"><?php echo stripslashes($row_ord['order_giftwrapmessage_text'])?></td>
					<td width="60%" class="listingtablestyleB" valign="top"><?php echo print_price_selected_currency($row_ord['order_giftwrap_message_charge'],$row_ord['order_currency_convertionrate'],$row_ord['order_currency_symbol'],true)?></td>
				</tr>
			<?php
			}
		?>
		...
		?>
				<tr>
				<td class="listingtablestyleB" align="left" width="20%"><?php echo ucwords(strtolower(stripslashes($row_wrap_details['giftwrap_type']))) ?>
				</td>
				<td class="listingtablestyleB" align="left" width="20%"><?php echo stripslashes($row_wrap_details['giftwrap_name'])?>
				</td>
				<td width="60%" class="listingtablestyleB"><?php echo print_price_selected_currency($row_wrap_details['giftwrap_price'],$row_ord['order_currency_convertionrate'],$row_ord['order_currency_symbol'],true)?></td>
				</tr>
		<?php
			}
		?>
		...
		<tr>
			...
			<table width="100%" cellpadding="1" cellspacing="1" border="0">
			<tr>
				<td class="listingtablestyleB" align="right"><strong>Gift Wrap Total</strong></td>
				<td width="60%" class="listingtablestyleB"><strong><?php echo print_price_selected_currency($row_ord['order_giftwraptotal'],$row_ord['order_currency_convertionrate'],$row_ord['order_currency_symbol'],true)?></strong></td>
				</tr>
			</table>
			</td>
		</tr>
		...
		<tr>
			...
			?>
					<tr>
						...
						<td align="left" width="25%" class="listingtablestyleB"><?php echo ucwords(strtolower(stripslashes($row_ord['order_deliverytype'])))?>
						<?php
						...
						<td align="left" width="25%" class="subcaption listingtablestyleB">&nbsp;Delivery Charge</td>
						<td align="left" width="25%" class="listingtablestyleB"><?php echo print_price_selected_currency($row_ord['order_deliveryprice_only'],$row_ord['order_currency_convertionrate'],$row_ord['order_currency_symbol'],true)?>
						<?php 
	...
	?>
	   <table border="0" cellpadding="1" cellspacing="1" width="100%">
		...
		<tbody><tr>
		  ...
		  <tr>
		  <td width="25%" align="left" class="listingtablestyleB">&nbsp;</td>
		  <td width="75%" align="left" class="listingtablestyleB"><input name="txt_despatch_id" id="txt_despatch_id" size="55" type="text" value=""></td>
		</tr>
		 <tr>
		  ...
		  <tr>
		  <td width="25%" align="left" class="listingtablestyleB">&nbsp;</td>
		  <td width="75%" align="left" class="listingtablestyleB"><input name="txt_expected_delivery_date" id="txt_expected_delivery_date" size="12" type="text" value="<?php echo date('d-m-Y')?>" readonly="readonly"> (dd-mm-yyyy)
		  ...
		  <td align="left" class="listingtablestyleB"><textarea name="txt_despatch_note" id="txt_despatch_note" cols="50" rows="6"></textarea></td>
		</tr>
		<tr>
...
?>
	...
	<?php
		...
		?>				
					...
					<tr>
					  <td colspan="6" align="left"><table border="0" cellpadding="1" cellspacing="1" width="100%">
						<tbody>
...
function Receiptshow_OrderTotals($order_id,$row_ord)
{
	global $db,$ecom_siteid;
?>
	<table width="100%" border="0" cellspacing="1" cellpadding="1" style="border-left:1px solid #000000;border-right:1px solid #000000">
	<tr>
