		 ...
		 <tr>
           ...
           <td align="left" valign="middle" class="<?php echo $cls?>" >
			...
			if($print_buttons != 1 and $row_ord['order_status']!='NOT_AUTH' and $chk_show_ord_status) {
					  ...
					  if ($row_ord['order_status']!='INPROGRESS') 
					  $orderstat_array['INPROGRESS'] = 'In Progress';
 ...
 function show_Order_Payments($order_id,$alert='')
 {
  ...
  <tr>
	...
	<?php
		...
		elseif ($row_ord['order_paymentmethod']=='FIDELITY') // case if payment method is BARCLAYCARD
		{
			// Get the details given back to us from paypal
			$sql_fidelity = "SELECT 
									responseCode,transactionID,timestamp,amountReceived,
									cardNumberMask,cardType,displayAmount,cardExpiryDate,customerName,
									remoteAddress,currencyCode
							FROM 
							...
							LIMIT 
								1";
			$ret_fidelity = $db->query($sql_fidelity);
			if($db->num_rows($ret_fidelity))
			{
				$row_fidelity = $db->fetch_array($ret_fidelity);
		?>
				<table width="100%" cellpadding="1" cellspacing="0" border="0">
				<tr>
					<td align="left" colspan="2" class="shoppingcartheader">
					Fidelity Gateway Return Details</td>
				</tr>
				<?php
				if($row_fidelity['currencyCode']!='')
				{
				?>
					<tr>
						<td align="left" width="45%" class="listingtablestyleB_n">
						<strong>Order currency code</strong></td>
						<td align="left" class="listingtablestyleB_n">
						<?php echo $row_fidelity['currencyCode']?></td>
					</tr>
				<?php
				}
				if($row_fidelity['amountReceived']!='')
				{
				?>
					<tr>
						<td align="left" width="45%" class="listingtablestyleB_n">
						<strong>Order amount</strong></td>
						<td align="left" class="listingtablestyleB_n">
						<?php echo $row_fidelity['amountReceived']?></td>
					</tr>
				<?php
				}
				if($row_fidelity['responseCode']!='')
				{
				?>
					<tr>
						<td align="left" width="45%" class="listingtablestyleB_n">
						<strong>Response Code</strong></td>
						<td align="left" class="listingtablestyleB_n">
						<?php echo $row_fidelity['responseCode']?></td>
					</tr>
				<?php
				}
				if($row_fidelity['transactionID']!='')
				{
				?>
					<tr>
						<td align="left" width="45%" class="listingtablestyleB_n">
						...
						<td align="left" class="listingtablestyleB_n">
						<?php echo $row_fidelity['transactionID']?></td>
					</tr>
				<?php
				}
				if($row_fidelity['timestamp']!='')
				{
				?>
					<tr>
						<td align="left" width="45%" class="listingtablestyleB_n">
						...
						<td align="left" class="listingtablestyleB_n">
						<?php echo $row_fidelity['timestamp']?></td>
					</tr>
				<?php
				}
				if($row_fidelity['cardNumberMask']!='')
				{
				?>
					<tr>
						<td align="left" width="45%" class="listingtablestyleB_n">
						<strong>Masked card number</strong></td>
						<td align="left" class="listingtablestyleB_n">
						<?php echo $row_fidelity['cardNumberMask']?></td>
					</tr>
				<?php
				}
				if($row_fidelity['cardType']!='')
				{
				?>
					<tr>
						<td align="left" width="45%" class="listingtablestyleB_n">
						<strong>card type</strong></td>
						<td align="left" class="listingtablestyleB_n">
						<?php echo $row_fidelity['cardType']?></td>
					</tr>
				<?php
				}
				if($row_fidelity['displayAmount']!='')
				{
				?>
					<tr>
						<td align="left" width="45%" class="listingtablestyleB_n">
						<strong>Amount Display</strong></td>
						<td align="left" class="listingtablestyleB_n">
						<?php echo $row_fidelity['displayAmount']?></td>
					</tr>
				<?php
				}
				if($row_fidelity['cardExpiryDate']!='')
				{
				?>
					<tr>
						<td align="left" width="45%" class="listingtablestyleB_n">
						<strong>Card expiry date</strong></td>
						<td align="left" class="listingtablestyleB_n">
						<?php echo $row_fidelity['cardExpiryDate']?></td>
					</tr>
				<?php
				}
				if($row_fidelity['customerName']!='')
				{
				?>
					<tr>
						<td align="left" width="45%" class="listingtablestyleB_n">
						...
						<td align="left" class="listingtablestyleB_n">
						<?php echo $row_fidelity['customerName']?></td>
					</tr>
				<?php
				}
				if($row_fidelity['remoteAddress']!='')
				{
				?>
					<tr>
						<td align="left" width="45%" class="listingtablestyleB_n">
						<strong>Remote Address</strong></td>
						<td align="left" class="listingtablestyleB_n">
						<?php echo $row_fidelity['remoteAddress']?></td>
					</tr>
				<?php
				}				
				?>
...
<?php
 ...
 function show_Order_Others($order_id,$alert='')
 {
	...
	$sql_ord = "SELECT order_tax_total,gift_vouchers_voucher_id,promotional_code_code_id,order_ip  
						FROM 
							orders 
						WHERE 
							order_id = $order_id 
...
?>
	...
	?>
		<tr>
		<td colspan="4" style="padding:0;spacing:0">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">	
		<tr>
		<td align="left" valign="middle" class="listingtablestyleB" width="12%">
		<strong>IP Address</strong>
		</td>
		<td align="left" valign="middle" class="listingtablestyleB">
		 <strong><?php echo $row_ord['order_ip'];?></strong>
		</td>
		<td align="left" valign="middle" width="50%" class="listingtablestyleB">
		</td>
		</tr>
		</table>
		</td>
					  ...
					  <table width="100%" border="0" cellspacing="0" cellpadding="1">
                        ...
                        <tr>
						  ...
						  for($i=0;$i<count($to_arr);$i++)
						  {
						  	...
						  	if(trim($to_arr[$i])!='')
						  	{
								echo mask_emails_orddetails($to_arr[$i]);
							}
						  }
						  ?></td>
                        </tr>
                        ...
                        <tr id="<?php echo $row_email['email_id']?>_messagetr"<?php /*?> style="display:none"<?php */?>>
						 ...
						 <?php
						 if($ecom_siteid==105 && ($row_email['email_type']=='ORDER_CONFIRM_CUST' || $row_email['email_type']=='ORDER_CONFIRM_CUST_INVOICED'))
						 { 
							 //ORDER_CONFIRM_CUST  	ORDER_CONFIRM_CUST_INVOICED
						 ?>
						 <style type="text/css">
								  .emaildiv_cls #custconfirm_tpl td {
									  padding:0px;
								  }
							  </style>
						<?php
						...
						?>	 
						  ...
						  <?php //echo $row_email['email_message']
						  	...
						  	if($ecom_siteid==104)
							{
								$sql_getemail = "SELECT order_custemail FROM orders where order_id = $order_id AND sites_site_id = $ecom_siteid LIMIT 1";
								$ret_getemail = $db->query($sql_getemail);
								if($db->num_rows($ret_getemail))
								{
									$row_getemail = $db->fetch_array($ret_getemail);
									$cemail = $row_getemail['order_custemail'];
								}
								
								$sql_getemail = "SELECT delivery_email FROM order_delivery_data where orders_order_id = $order_id LIMIT 1";
								$ret_getemail = $db->query($sql_getemail);
								if($db->num_rows($ret_getemail))
								{
									$row_getemail = $db->fetch_array($ret_getemail);
									$demail = $row_getemail['delivery_email'];
								}
								
								$cemail_m = mask_emails($cemail);
								$demail_m = mask_emails($demail);
								$sr_emailarr = array($cemail,$demail);
								$rp_emailarr = array($cemail_m,$demail_m);
								echo str_replace($sr_emailarr,$rp_emailarr,read_email_from_file('ord',$row_email['email_id']));
							}
							else
							{
								echo read_email_from_file('ord',$row_email['email_id']);
...
// ###############################################################################################################
// 				Function which holds the display logic of emails related to order emails to customer
// ###############################################################################################################
function show_order_emails_custom_cust($order_id,$alert='')
{
	global $db,$ecom_siteid,$ecom_hostname;
	// Get the list of email related to current order
	$sql_email = "SELECT order_email_cust_id,email_to,email_subject,email_headers,
							email_sendonce,email_lastsenddate
						FROM
							order_emails_tocust
						WHERE
							orders_order_id = $order_id
	...
	{
		//$table_headers 		= array('<img src="images/checkbox.gif" border="0" onclick="select_all(document.frm_orderdetails,\'checkbox_email[]\')"/><img src="images/uncheckbox.gif" border="0" onclick="select_none(document.frm_orderdetails,\'checkbox_email[]\')"/>','#','Type','Subject','Mail Disabled?','Sent Atleast Once');
		$table_headers 		= array('#','Subject','Sent Atleast Once','Details');
	...
	?>
		...
		?>
				<tr>
					...
					<td width="15%" align="center" class="<?php echo $cls?>">
					<div id='<?php echo $row_email['order_email_cust_id']?>_div' onclick="handle_showdetailsdiv('<?php echo $row_email['order_email_cust_id']?>_tr','<?php echo $row_email['order_email_cust_id']?>_div')" title="Click here" style="cursor:pointer">Details<img src="images/right_arr.gif" /></div>
					</td>
				</tr>
				<tr id="<?php echo $row_email['order_email_cust_id']?>_tr" <?php echo ($_REQUEST['emailid']!=$row_email['order_email_cust_id'])?'style="display:none"':''?>>
				  <td colspan="<?php echo $colspan?>" align="center" valign="top">
				  <table width="100%" border="0" cellspacing="0" cellpadding="1">
                    <tr>
                      <td width="62%" align="left" valign="top">
					  <table width="100%" border="0" cellspacing="0" cellpadding="1">
                        ...
                        <tr>
                          <td align="left" class="subcaption listingtablestyleB_n"><div id='<?php echo $row_email['order_email_cust_id']?>_messagediv' <?php /*?>onclick="handle_showmessageiv('<?php echo $row_email['email_id']?>_messagetr','<?php echo $row_email['email_id']?>_messagediv')"<?php */?> title="Click here"<?php /*?> style="cursor:pointer"<?php */?>>Message<?php /*?><img src="images/right_arr.gif" /><?php */?></div></td>
                          <td align="right" class="listingtablestyleB_n"><input type="button" name="Mail_Send_button2" value="Send This Mail" class="red" onclick="resend_orderemail_cust('<?php echo $row_email['order_email_cust_id']?>')"/></td>
                        </tr>
                        <tr id="<?php echo $row_email['order_email_cust_id']?>_messagetr"<?php /*?> style="display:none"<?php */?>>
                          <td colspan="2" align="left">
						  <!--<textarea name="just_display" rows="20" cols="60"><?php //echo $row_email['email_message']?></textarea>-->
							 
						  <div class="emaildiv_cls" style="font-size:12px;">
						  <?php //echo $row_email['email_message']
						  	//echo read_email_from_file('ord',$row_email['email_id']);						
							
								echo read_emailcust_from_file($row_email['order_email_cust_id']);
                        ...
                        <tr id="<?php echo $row_email['order_email_cust_id']?>_messagetr_down" style="display:none">
                          <td colspan="2" align="right"><input type="button" name="Mail_Send_button" value="Send This Mail" class="red" onclick="resend_orderemail('<?php echo $row_email['email_id']?>')" /></td>
                        </tr>
                        <tr>
                          <td colspan="2" align="right">&nbsp;</td>
                      ...
                      <td width="38%" align="left" valign="top">
						...
						$sql_resend = "SELECT send_id,send_date,send_by
											FROM
												order_emails_custom_cust_resend
											WHERE
												email_id = ".$row_email['order_email_cust_id']."
											ORDER BY
												send_date
													DESC";
						$ret_resend = $db->query($sql_resend);
	...
	else
	{
	  ...
	  <tr>
										<td colspan="3" align="center" class="errormsg">No Details found.</td>
									</tr>
									</table>
	  <?php
	}
			...
			if ($db->num_rows($ret_prods))
			{
				...
				<tr>
					...
					if($row_prods['order_freedelivery']==1 and $product_no_link!=1)
						...
						if($product_no_link!=1 and is_product_special_product_code_active())
							show_specialcode($row_prods['products_product_id'],$row_prods['order_stock_combination_id'],$row_prods['orderdet_id']);		
						$cat_str = '';
...
function show_billing_address($order_id,$fromprint=0)
{
	...
	?>
			...
			if($db->num_rows($ret_checkout))
			{
				...
				while($row_checkout = $db->fetch_array($ret_checkout))
				{
					...
					else if($row_checkout['field_key'] !='checkout_fname' and $row_checkout['field_key']!= 'checkout_mname' and $row_checkout['field_key'] != 'checkout_surname')
					{
						...
						{
							 //this section for customer emails ffrom order details page.
							if($ecom_siteid==104)
							{
								$value	= mask_emails_orddetails(stripslashes($row_ord[$row_checkout['field_orgname']]));
								
							}	
							else
							{
								$value	= '<a style="color:#FF0000" href="mailto:'.stripslashes($row_ord[$row_checkout['field_orgname']]).'">'.mask_emails_orddetails(stripslashes($row_ord[$row_checkout['field_orgname']])).'</a>';
							}	
							if($ecom_siteid==104 || $ecom_siteid==113  || $ecom_siteid==100)
							{
							$value	.='<span style="padding:0px 0px 0px 5px"><input  type="button" id="send_email_cust" onclick="open_modal_cust()"  value="Send Email" class="red"/></span>';
							}
						}	
						else
						{
		...
		{		//passport details
		 $sql_passport = "SELECT passport_id,passport_orgfilename FROM order_passport_details WHERE orders_order_id=$order_id AND tenant_name='tenant1'";
		
		$ret_passport = $db->query($sql_passport);
		if($db->num_rows($ret_passport)>0)
		{
		$row_passport = $db->fetch_array($ret_passport);
			if($row_passport['passport_orgfilename']!='')
			{
			?>
			<tr>	
			<td align="left" width="50%" class="<?php echo $cls?>" >
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
			<tr><td align="left" width="25%" class="subcaption">Passport</td>	
			<td align="left" valign="middle" class="normltdtext">		
			<?php echo $row_passport['passport_orgfilename']?> &nbsp;&nbsp;<a href="includes/orders/download_passport.php?passport_id=<?php echo $row_passport['passport_id']?>" title="Download" class="edittextlink"><img src="images/download.gif" alt="Download" title="Click to download this file" border="0" />
			 </td>
			 </tr>
			</table>
			</td>
						<td align="left" width="50%" class="<?php echo $cls?>" >&nbsp;</td>
			</tr>
			  <?php
			}
		}
	...
	if($ecom_siteid==109 || $ecom_siteid==117)
	{
	show_billing_address_tenant($order_id,$fromprint=0);
	}
}
// ###############################################################################################################
// 				Function which holds the display logic of billing address 
// ###############################################################################################################
function show_billing_address_tenant($order_id,$fromprint=0)
{
	global $db,$ecom_siteid,$ecom_hostname,$call_src,$show_order_details;
	
	 $sql_ordqty = "SELECT order_orgqty FROM order_details WHERE 
						orders_order_id = $order_id LIMIT 1 ";
	$ret_ordqty = $db->query($sql_ordqty);
	if($db->num_rows($ret_ordqty)>0)
	{
		$row_qty    = $db->fetch_array($ret_ordqty);
		$ord_qty    = $row_qty['order_orgqty'];					
	...
	while($cnt < $ord_qty)			
	{
	    ...
	    $sql_ord = "SELECT customers_customer_id,order_custtitle,order_custfname,order_custmname,order_custsurname,order_custcompany,
							...
							order_custemail,order_notes
					FROM
						order_extra_billing_details
					WHERE
						order_id = $order_id
						AND order_tenant_name = '$tenant_name'  
						AND sites_site_id = $ecom_siteid";
	$ret_ord = $db->query($sql_ord);
	if ($db->num_rows($ret_ord))
	{
	...
	?>
		...
		?>
			<tr>
				<td colspan="2" align="left" class="shoppingcartheader" valign="middle">Billing Address <?php echo $tenant_name;?>
				<?php 
          	if($row_ord['customers_customer_id']>0 and !$fromprint==1)
          	{	
				// Check whether customer exists
		  ...
		  ?>	
			...
			if($db->num_rows($ret_checkout))
			{
				...
				for($i=0;$i<$max_cnt;$i++)
				{	
					$cls = ($i%2==0)?'listingtablestyleB':'listingtablestyleB';
				?>
					<tr>	
						<td align="left" width="50%" class="<?php echo $cls?>">
							<table width="100%" cellpadding="0" cellspacing="0" border="0">
			...
			if ($cur_col<$max_cols and $cur_col>0)
				echo '<td colspan="'.($max_cols-$cur_col).'" class="'.$cls.'">&nbsp;</td></tr>';
		//passport details
		 $sql_passport = "SELECT passport_id,passport_orgfilename FROM order_passport_details WHERE orders_order_id=$order_id AND tenant_name='$tenant_name'";
...
function show_delivery_address($order_id)
{
	...
	// the customer
			//datetime script start here
				// Added ,order_delivery_time,order_delivery_date in the below query
             //datetime script end here

	$sql_ord = "SELECT order_currency_convertionrate,order_currency_symbol,
							order_deliverytype,order_deliverylocation,order_delivery_option,
							order_deliverytotal,order_splitdeliveryreq,order_extrashipping,
							order_deliveryprice_only,order_freedeliverytype,order_delivery_time,order_delivery_date  
						FROM
							orders
						WHERE
							order_id = $order_id
	...
	?>
				...
				while($row_checkout = $db->fetch_array($ret_checkout))
				{
					...
					else if($row_checkout['field_key'] !='checkoutdelivery_fname' and $row_checkout['field_key']!= 'checkoutdelivery_mname' and $row_checkout['field_key'] != 'checkoutdelivery_surname')
					{
						...
						if($row_checkout['field_key']=='checkoutdelivery_email')
						{
							if($ecom_siteid==104)
							{
								$value	= mask_emails_orddetails(stripslashes($row_del[$row_checkout['field_orgname']]));
							}
							else
							{
								$value	= '<a style="color:#FF0000" href="mailto:'.stripslashes($row_del[$row_checkout['field_orgname']]).'">'.mask_emails_orddetails(stripslashes($row_del[$row_checkout['field_orgname']])).'</a>';
							}	
						}	
						else
							$value	= stripslashes($row_del[$row_checkout['field_orgname']]);
		...
		<tr>
			...
			//datetime script start here
			$sql_common = "SELECT enable_location_datetime FROM general_settings_sites_common WHERE sites_site_id=$ecom_siteid";
			$ret_common = $db->query($sql_common);
			$row_common = $db->fetch_array($ret_common);
			if($row_common['enable_location_datetime']==1)
			{
				if($row_ord['order_delivery_date']!='0000-00-00')
				{
					?>
				<tr>
							<td align="left" width="25%" class="listingtablestyleB_n">Preferred Delivery Date</td>
							<td align="left" width="25%" class="listingtablestyleB_n"><?php echo dateFormat($row_ord['order_delivery_date'],'date') ?></td>
							<td align="left" width="25%" class="listingtablestyleB_n"></td>
							<td align="left" width="25%" class="listingtablestyleB_n"></td>
						</tr>
						<?php
				}		
				if($row_ord['order_delivery_time']!='')
				{
					...
					$row_time = $db->fetch_array($ret_time);
						?>
						<tr>
							<td align="left" width="25%" class="listingtablestyleB_n">Preferred Delivery Time</td>
							<td align="left" width="25%" class="listingtablestyleB_n"><?php echo ucwords(strtolower(stripslashes($row_time['time'])))?></td>
							<td align="left" width="25%" class="listingtablestyleB_n"></td>
							<td align="left" width="25%" class="listingtablestyleB_n"></td>
						</tr>
						<?php
	   ...
	   <table border="0" cellpadding="1" cellspacing="0" width="100%">
		...
		<tbody><tr>
		 ...
		 <tr>
		  ...
		  <tr>
		  <td width="25%" align="left" class="listingtablestyleB_n">&nbsp;</td>
		  <td width="75%" align="left" class="listingtablestyleB_n">
			  <?php
			  if($ecom_siteid==105) // just for puregusto 105
			  {
				  $ddate = date('d-m-Y', strtotime(' +1 day'));
			  }
			  else
			  {
			     $ddate = date('d-m-Y');
			  ...
			  ?>
			  <input name="txt_expected_delivery_date" id="txt_expected_delivery_date" size="12" type="text" value="<?php echo $ddate?>" readonly="readonly"> (dd-mm-yyyy)
...
function show_specialcode($product_id,$comb_id,$orddet_id)
{
	...
	if($specialcode!='')
	{
		echo '<br><span style="color:#FF0000"><strong>Special Code:</strong> '.$specialcode.'</span>';	
	}
}
...
function is_product_special_product_code_active()
	...
	function metrodent_special_display($prodid)
	{
		global $db,$ecom_siteid;
		if($ecom_siteid==103)
		{
			$sql_check = "SELECT product_id,product_isocode,manufacture_id,product_model,product_intensivecode,product_metrodentcode   
							FROM
								products
							WHERE
								product_id = $prodid
			...
			{
				$row_check 	= $db->fetch_array($ret_check);
				$manufact 	= trim(stripslashes($row_check['manufacture_id']));
				$intensive 	= trim(stripslashes($row_check['product_intensivecode']));
				$metrodent 	= trim(stripslashes($row_check['product_metrodentcode']));
				$iso		= trim(stripslashes($row_check['product_isocode']));
				
				if ($manufact!='')
					echo '<br><strong>Product Id :</strong> '.$manufact;
				if ($metrodent!='')
					echo '<br><strong>Metrodent Code :</strong> '.$metrodent;	
				if ($intensive!='')
					echo '<br><strong>Intensiv Code :</strong> '.$intensive;
				if ($iso!='')
					echo '<br><strong>ISO Code :</strong> '.$iso;			
			}	
		}	
	}
?>
