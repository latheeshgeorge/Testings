...
/////////////////////////////////////////////////////////////////////////////////////
$query_string .= "sort_by=$sort_by&sort_order=$sort_order&request=costperclick_report&fpurpose=list_clicks&url_id=".$_REQUEST['url_id']."&month_id=".$_REQUEST['month_id']."&typ=".$_REQUEST['typ']."&records_per_page=$records_per_page&search_name=".$_REQUEST['search_name']."&start=$start";
      ...
      <td height="48" class="sorttd" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			?>
					<tr>
					<td colspan="3" align="center"><input type="button" name="Button" value="Click to Export Clicks for Selected Month" class="red" onclick="document.frmlistclicks.fpurpose.value='list_export';document.frmlistclicks.submit();" /></td>
					</tr>
			 <?php
			 	}
			 ?> 
