    ...
    <tr>
      <td height="48" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="47%" valign="top" class="sorttd"><table width="100%" border="0" cellpadding="1" cellspacing="1">
            <tr>
			...
			?>
            <tr>
              <td colspan="3" align="center"><input type="button" name="Button" value="Click to Export Monthly Report" class="red" onclick="document.frmlistmonthly.fpurpose.value='list_export';document.frmlistmonthly.submit();" /></td>
              </tr>
		 <?php
		 }
		 ?> 
