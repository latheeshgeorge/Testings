...
&nbsp;&nbsp;&nbsp;&nbsp;</td>
	...
	?>
	 <tr >
	  <td align="center" valign="middle" class="listeditd"><input name="button7" type="submit" class="red" id="button7" value="Click to Download File" /><a href="#" onmouseover ="ddrivetip('<?=get_help_messages('LIST_VISIT_DETAILS_EXPORT_DOWNLOAD')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a></td>
	 </tr>
    </table>
</form>
