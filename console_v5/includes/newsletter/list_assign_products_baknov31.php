...
$table_name='products';
$page_type='Products';
$help_msg = 'This section lists the Products that can be assigned to the Adverts.';
$table_headers = array('<img src="images/checkbox.gif" border="0" onclick="select_all(document.frmlistProducts,\'checkbox[]\')"/><img src="images/uncheckbox.gif" border="0" onclick="select_none(document.frmlistProducts,\'checkbox[]\')"/>','Slno.','Product Name','Adverts assigned for the product','Category','Active');
...
/////////////////////////////////////////////////////////////////////////////////////
$query_string .= "request=adverts&fpurpose=list_assign_products&sort_by=$sort_by&sort_order=$sort_order&records_per_page=$records_per_page&search_name=".$_REQUEST['search_name']."&start=$start&advert_id=".$_REQUEST['advert_id']."&advert_title=".$_REQUEST['advert_title']."&pass_sort_by=$pass_sort_by&pass_sort_order=$pass_sort_order&pass_records_per_page=$pass_records_per_page&pass_search_name=".$_REQUEST['pass_search_name']."";
// 
?>
...
{ 
	...
	if (atleastone==0) 
	{
		alert('Please select the Products to assign to the Advert');
		return false;
	}
	else
	{
		if(confirm('Assign Products to the Advert?'))
		{
				show_processing();
    ...
    <tr>
      ...
      <table width="18%" border="0" cellpadding="0" cellspacing="0" class="sorttableright">
        ...
        <tr>
          ...
          <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;<input name="button5" type="submit" class="red" id="button5" value="Go" /> <a href="#" onmouseover ="ddrivetip('Use \'Go\' button to search for Products that can be assigned to Adverts.')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a></td>
        </tr>
      </table>
	  </td>
    </tr>
    <tr>
	  ...
	  ?>
		...
		<input name="assign_products" type="button" class="red" id="assign_products" value="Assign Products" onclick="return assignproducts();" />
		  <a href="#" onmouseover ="ddrivetip('Use This button to assign products to the Advert. Select the products to be assigned to the Advert and press \'Assign Products\' button.')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a>
		<?
		}
		?>
   	   </td>
