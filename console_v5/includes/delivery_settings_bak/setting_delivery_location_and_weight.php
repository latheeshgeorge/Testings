...
<input type="hidden" name="deliveryid" value="<?php echo $delivery_id;?>">
 ...
 <input type="hidden" name="locationid" value="<?php echo $_REQUEST['locationid'];?>">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
		<td colspan="4" align="left" valign="middle" class="sorttd" ><table width="100%" border="0" cellpadding="4" cellspacing="0">
          <tr>
	...
	?>
          <tr>
            <td align="center" width="353"><b>Option</b></td>
            <td align="center" width="590"><b>Charges (<?php echo  display_curr_symbol()?>)</b></td>
          </tr>
          <?
    $k=0;
  ...
  //echo "test".  $option;
   ...
   ?>
          <tr>
            <td align="right" width="353"><? echo $msg; ?>
            ...
            <td align="center" width="590"><input name="price[]" class="input" type="text" size="5" value="<? echo $row['delopt_price']?>" />            </td>
          </tr>
          <?
  }
   ...
   $msg='More than zero but less than ';
    ...
    ?>
          <tr>
            ...
            <td align="center" width="590"><input name="price[]" class="input" type="text" size="5" />            </td>
          </tr>
          <? } ?>
...
?>
   ...
   ?>
          <tr>
            ...
            <td align="center" width="590"><input name="price_<?php echo $row_check['delivery_group_id']?>[]" class="input" type="text" size="5" value="<? echo $row['delopt_price']?>" />            </td>
          </tr>
          <?
  	}
	   ...
	   $msg='More than zero but less than ';
		...
		?>
          <tr>
            ...
            <td align="center" width="590"><input name="price_<?php echo $row_check['delivery_group_id']?>[]" class="input" type="text" size="5" />            </td>
          </tr>
          <? } ?>
          <?php
		}
