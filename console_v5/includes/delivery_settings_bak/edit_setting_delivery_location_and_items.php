...
function delete_confirmbox(locid,delid)
{
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td colspan="2" class="treemenutd"><b>Location</b>&nbsp;&nbsp;&nbsp;&nbsp;<b><u><a href="home.php?request=delivery_settings&fpurpose=editdelivery&deliveryid=<? echo $delivery_id;?>"><font color="#CC0000" style="font-weight:normal">(Please Click here to add more Locations & amount spent )</font></a></u></b><a href="#" onmouseover ="ddrivetip('<?=get_help_messages('ADD_DELIVERY_SETTINGS_LOCATION_IEMTS_ADD')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a></td>
