...
<input type="hidden" name="type1" value="Amount">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="3" align="left" valign="middle" class="treemenutd"><a href="home.php?request=delivery_settings"> Delivery Charges</a> &gt;&gt; '<? echo $rowname['deliverymethod_name'];?>'</td>
        </tr>
        <tr>
		...
		?>
				...
				<tr>
					<td align="center" width="363"><b>Option</b></td>
					<td align="center" width="60"><b>Charges (<?php echo  display_curr_symbol()?>)</b></td>
				</tr>
  <?
  $k=0;
