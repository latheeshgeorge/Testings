...
$help_msg 			= get_help_messages('ADD_SETTINGS_DELIVERY_ITEMS_MESS1');
...
<input type="hidden" name="type1" value="Items">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		?>
				...
				<table width="699" border="0" cellpadding="4" cellspacing="0">
			<tr>
			  <td align="center" width="398"><b>Option</b></td>
			  <td align="center" width="95"><b>Charges (<?php echo  display_curr_symbol()?>)</b></td>
			</tr>
		  <?
		  $k=0;
		   ...
		   <select name="del_optionbig[]" class="input">
			...
			<? } ?>
			 <tr id="largebuttonlink">
				<td colspan="2" align="center">&nbsp;<input type="button" value="Submit Rates" class="red"  onClick="show_processing();document.frmlistDelivery.fpurpose.value='deliveryData';document.forms.frmlistDelivery.submit();"></td>
				<td colspan="2" align="center">
				  <input type="button" value="Submit and enter more rates" class="red"  onClick="show_processing();document.frmlistDelivery.fpurpose.value='deliveryData';document.forms.frmlistDelivery.more_req.value=1;document.forms.frmlistDelivery.submit();"></td>
			</tr>
</table>
		</td>
		</tr>
