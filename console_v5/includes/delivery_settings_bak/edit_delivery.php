...
<input type="hidden" name="fpurpose" value="delivery_settings" />
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="4" align="left" valign="middle" class="treemenutd"><a href="home.php?request=delivery_settings"> Delivery Charges</a>&gt;&gt;'<? echo $row['deliverymethod_name'];?>'
   ...
   <select name="del_optionbig[]" class="input">
	...
	<input name="price[]" class="input" type="text" size="5">
 	 ...
 	 <tr id="largebuttonlink">
		<td colspan="2" align="center">&nbsp;<input type="button" value="Submit Rates" class="bigsubmit" onClick="formhandler('deliveryData')"></td>
		<td colspan="2" align="center">&nbsp;<input type="button" value="Submit and enter more rates" class="bigsubmit" onClick="formhandler('deliveryData_more')"></td>
	</tr>
</table>
		</td>
		</tr>
