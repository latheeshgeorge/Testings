...
if ($db->num_rows($ret_common))
{
	...
	if($row_common['delivery_settings_weight_max_limit']=0 or $row_common['delivery_settings_weight_increment']==0 
		or $row_common['delivery_settings_common_max']==0 or $row_common['delivery_settings_common_increment']==0)
	{
...
<input type="hidden" name="fpurpose" value="delivery_settings" />
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="3" align="left" valign="middle" class="treemenutd">Delivery Charges</td>
        </tr>
        <tr>
		...
		?>
		  ...
		  <a href="#" onmouseover ="ddrivetip('<?=$del_rep_mess_edit_loc?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a><? } ?></td>
		  </tr>
		<?
		}
		?>
