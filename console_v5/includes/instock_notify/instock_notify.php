...
$page_type   = 'Stock Notifications';
$help_msg 			= get_help_messages('LIST_INSTOCK_MESS1');
...
$table_headers = array('<img src="images/checkbox.gif" border="0" onclick="select_all(document.frmListNotify,\'checkbox[]\')"/><img src="images/uncheckbox.gif" border="0" onclick="select_none(document.frmListNotify,\'checkbox[]\')"/>','Slno.','Requested Date','Email Address','');
...
<input type="hidden" name="request" value="instock_notify" />
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="5" align="left" valign="middle" class="treemenutd"><div class="treemenutd_div"><span> Stock Notification Request</span></div></td>
        </tr>
		<tr>
	...
	?>
	<tr>
      <td height="48" class="sorttd" colspan="5" >
	  <div class="sorttd_div">
      	<table width="100%" border="0" cellpadding="0" cellspacing="0">
			 <tr>
				  <td width="8%" align="left" valign="middle" nowrap="nowrap">Customer Email &nbsp;</td>
			   <td width="22%" align="left" valign="middle"><input name="search_mail" type="text" class="textfeild" id="search_mail" value="<?=$_REQUEST['search_mail']?>">				  				  </td>
			   <td width="9%"  align="left" valign="middle" nowrap="nowrap">Between Dates </td>
			   <td width="6%"  align="left" valign="middle"><input name="not_fromdate" class="textfeild" type="text" size="12" value="<?php echo $_REQUEST['not_fromdate']?>" /></td>
			   <td width="5%"  align="left" valign="middle"><a href="javascript:show_calendar('frmListNotify.not_fromdate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="images/show-calendar.gif" width="24" height="22" border="0" /></a></td>
			   <td width="6%"  align="left" valign="middle" nowrap="nowrap"><input name="not_todate" class="textfeild" id="ord_todate" type="text" size="12" value="<?php echo $_REQUEST['not_todate']?>" />&nbsp;</td>
			   <td width="5%"  align="left" valign="middle" nowrap="nowrap"><a href="javascript:show_calendar('frmListNotify.not_todate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="images/show-calendar.gif" width="24" height="22" border="0" /></a></td>
			  <td width="4%"  align="left" >&nbsp;Show</td>
			  <td width="27%" align="left" ><input name="records_per_page" type="text" class="textfeild" id="records_per_page" size="3" maxlength="3"  value="<?=$records_per_page?>"/>
			  <?=$page_type?> Per Page</td>
			  <td width="8%" colspan="5" align="right" >&nbsp;&nbsp;&nbsp;&nbsp;
		      <input name="button5" type="submit" class="red" id="button5" value="Go" /> <a href="#" onmouseover ="ddrivetip('<?=get_help_messages('LIST_INSTOCK_NOTIFY')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a></td>
			</tr>
      </table>
	  </div></td>
    </tr>
	...
	<?	  
	  ...
	  ?>
	  <tr>
	  <td align="left" class="listeditd" colspan="5"><a href="#" onclick="call_ajax_delete('<?php echo $_REQUEST['notify_id']?>','<?php echo $sort_by?>','<?php echo $sort_order?>','<?php echo $records_per_page?>','<?php echo $start?>','<?php echo $pg?>')" class="deletelist">Delete</a> </td>
	  </tr>
	  <? 
	  }
		if($alert)
	...
	if($numcount)
	  {
		...
		<tr >
          <td align="left" valign="top" class="<?=$class_val;?>"  width="9%"><input name="checkbox[]" value="<? echo $row_notify['notify_id']; ?>" type="checkbox"></td>
		  <td align="left" valign="top" class="<?=$class_val;?>"  width="3%"><?php echo $count_no; ?></td>
		  <td width="28%" align="left" valign="top" class="<?=$class_val;?>"><?PHP echo $row_notify['notifydate']; ?></td>
          <td align="left" valign="top" class="<?=$class_val;?>" width="32%"><?PHP echo $row_notify['cust_email']; ?></td>
		  <td align="center" valign="top" class="<?=$class_val;?>" width="28%"><div id="downloadhistory_div_<?php echo $row_notify['notify_id']?>" onclick="handle_downloadhistory('<?PHP echo $row_notify['notify_id']; ?>', '<?PHP echo $vardisplay; ?>')" style="width:180px; float:right; cursor:pointer">
	...
	<tr id="notdetails_<?PHP echo $row_notify['notify_id'];  ?>" style="display:none; "  >
	 <td  colspan="3" align="right" valign="top"    >&nbsp;</td>
		...
		?>
			...
			<? */ ?>
				...
				if(trim($smsrow['message_value']))	{	
				?>
				 <tr id="varname_<?PHP echo $row_notify['notify_id'];  ?>" class="<?=$class_val?>">
              <td colspan="4" align="center" class="listingtablestyleB">
			  <span  style="float:left; padding-left:10px;"><?=$smsrow['message_caption']  ."  :  ". $smsrow['message_value']?></span> &nbsp;</td>
            </tr>
			<? 
			 }
			/* ?>
	 ...
	 <? 
	  ...
	  else
	  {
	    ?>
		  <tr>
		  <td align="center" valign="middle" class="norecordredtext"  colspan="5">No Notifications Found</td>
	  </tr>
		<?   
	  }
	  ...
	  ?>
		...
		<tr>
          <td width="9%" align="left" valign="middle" class="tdcolorgray" >&nbsp;</td>
          <td width="3%" align="left" valign="middle" class="tdcolorgray">
