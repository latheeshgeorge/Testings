      ...
      <table  border="0" cellpadding="0" cellspacing="0" class="listingtable" width="100%">
	   ...
	   ?>
        <tr >
		  ...
		  <td align="left" valign="middle" class="<?=$class_val;?>"><?php echo ($row['hide'] == 'Y')?'Yes':'No'; ?></td>
        </tr>
      <?
	  }
	  }
