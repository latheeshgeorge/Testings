		...
		<table cellspacing="0" cellpadding="0" width="100%">
		 ...
		 <tr> 
		  ...
		  <td width="32%" align="left" valign="middle" class="tdcolorgray" >:
			...
			<input name="Submit" type="button" class="red" value="Go" onclick="enquire_action('go')" />&nbsp;<a href="#" onmouseover ="ddrivetip('<?=get_help_messages('LIST_PROD_ENQUIRE_DETAILS_DO')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.gif" width="17" height="13" border="0" /></a></td>
		 </tr>
		  <tr>
		 ...
		 <tr> 
		  ...
		  <td colspan="2" align="left" valign="top" class="tdcolorgray">:
		   ...
		   <a href="#" onmouseover ="ddrivetip('<?=get_help_messages('LIST_PROD_ENQUIRE_DETAILS_SENDMAIL')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.gif" width="17" height="13" border="0" /></a></td>
		 </tr>
			 ...
			 <td align="left" valign="middle" class="tdcolorgray" colspan="5">
				 <table border="0" cellpadding="0" cellspacing="0" width="100%">
					...
					<tr>	
					 ...
					 <tr><td align="center" valign="middle" class="tdcolorgray" colspan="2"><input name="Submit2" type="button" class="red" value="Cancel" onclick="select_mail()" /> <a href="#" onmouseover ="ddrivetip('<?=get_help_messages('LIST_PROD_ENQUIRE_DETAILS_CANCEL')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.gif" width="17" height="13" border="0" /></a>&nbsp;<input name="Submit2" type="button" class="red" value="Send" onclick="enquire_action('send_mail')"/><a href="#" onmouseover ="ddrivetip('<?=get_help_messages('LIST_PROD_ENQUIRE_DETAILS_SEND')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.gif" width="17" height="13" border="0" /></a></td></tr>
				 </table>			 </td>
		 </tr>
		  </table>		  </td>
		  </tr>
	...
	function show_product_details_list($enq_id,$alert='')
	{
		...
		$resp=$db->query($sqlp);
		  ...
		  <table width="100%" cellpadding="0" cellspacing="1" border="0">
			    <tr>
				  <td   align="left" valign="middle" class="helpmsgtd" colspan="6" ><? echo get_help_messages('LIST_PROD_ENQ_PRODDET_MSS1') ?></td>
				</tr>
				<?php
				if($alert)
				{
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
					<tr>
					  <td   align="left" valign="middle" class="helpmsgtd" colspan="6" ><? echo get_help_messages('LIST_PROD_ENQ_NOTE_SUBMSS1') ?></td>
					</tr>
<?php  
					if($alert)
					{			
