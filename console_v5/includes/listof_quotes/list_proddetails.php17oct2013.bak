...
<input type="hidden" name="txt_mod" value="" />
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td   align="left" valign="middle" class="treemenutd"><a href="home.php?request=product_enquire&sort_by=<?=$_REQUEST['sort_by']?>&sort_order=<?=$_REQUEST['sort_order']?>&records_per_page=<?=$_REQUEST['records_per_page']?>&search_name=<?=$_REQUEST['search_name']?>&start=<?=$_REQUEST['start']?>&pg=<?=$_REQUEST['pg']?>&search_status=<?=$_REQUEST['search_status']?>&search_email=<?=$_REQUEST['search_email']?>&srch_review_startdate=<?=$_REQUEST['srch_review_startdate']?>&srch_review_enddate=<?=$_REQUEST['srch_review_enddate']?>">List Product Enquiries</a> &gt;&gt; List Product Enquiry Details </td>
        </tr>
       <tr>
		...
		<tr>
			<td  align="left">
				...
				<tr>
						<td  align="left" onClick="handle_tabs('main_tab_td','customermain_info')" class="<?php if($curtab=='main_tab_td') echo "toptab_sel"; else echo "toptab"?>" id="main_tab_td">Customer Details</td>
						<td  align="left" onClick="handle_tabs('productmenu_tab_td','product')" class="<?php if($curtab=='productmenu_tab_td') echo "toptab_sel"; else echo "toptab"?>" id="productmenu_tab_td">Product Details</td>
						<td  align="left" onClick="handle_tabs('notemenu_tab_td','note')" class="<?php if($curtab=='notemenu_tab_td') echo "toptab_sel"; else echo "toptab"?>" id="notemenu_tab_td">Notes</td>
