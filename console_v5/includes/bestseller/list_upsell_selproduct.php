...
$table_name		= 'products';
$page_type		= 'Products';
$help_msg 		= get_help_messages('LIST_UPSELL_PRO_MESS1');
...
//#Search terms
$search_fields = array('productname','manufactureid','categoryid','vendorid','rprice_from','rprice_to','cprice_from','cprice_to','discount','discountas','bulkdiscount','stock_from','stock_to','preorder','prodhidden','sort_by','sort_order');

$query_string = "request=bestseller&fpurpose=prodUpsellAssign";
...
$sql_assigned="SELECT products_product_id FROM upsell_products_map WHERE  sites_site_id=$ecom_siteid";
...
function call_save_selected(cname,sortby,sortorder,recs,start,pg,group_id) 
{
	...
	else
	{
		...
		{
			show_processing();
			document.frm_products.fpurpose.value ='save_prodUpsellAssign';
...
<input type="hidden" name="request" value="bestseller" />
<input type="hidden" name="fpurpose" value="prodUpsellAssign" />
<input type="hidden" name="search_click" value="" />
<input type="hidden" name="pick_type" value="<?=$_REQUEST['pick_type']?>" />
...
<table border="0" cellpadding="0" cellspacing="0" class="maintable">
    <tr>
      <td colspan="3" align="left" valign="middle" class="treemenutd"><div class="treemenutd_div"><a href="home.php?request=bestseller&curtab=upselprods_tab_td">Upsell Products</a><span>Assign Upsell Products</span></div></td>
    </tr>
		  ...
		  <table width="100%" height="56" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td align="left"><input name="Search_go" type="submit" class="red" id="Search_go" value="Go" onclick="document.frm_products.search_click.value=1" />
                <a href="#" onmouseover ="ddrivetip('<?=get_help_messages('LIST_BESTSEL_SELPROD_GO')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.gif" width="17" height="13" border="0" /></a></td>
            </tr>
          </table>
		  </td>
        </tr>
    ...
    <tr>
	 ...
	 ?>
			   	<tr>
				  <td align="left" valign="middle" class="<?php echo $cls?>" width="7%">
