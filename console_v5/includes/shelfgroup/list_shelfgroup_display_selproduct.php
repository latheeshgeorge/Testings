<?php
	/*#################################################################
	# Script Name 	: list_shelfgroup_display_selproduct.php
...
$query_string = "request=shelfgroup&fpurpose=displayProdShelfGroupAssign&pass_shelfgroup_id=".$shelfgroup_id."";
...
$sql_assigned="SELECT products_product_id FROM shelf_group_display_product WHERE  shelf_group_id=".$shelfgroup_id;
...
function call_save_selected(cname,sortby,sortorder,recs,start,pg,group_id) 
{
	...
	else
	{
		...
		{
			show_processing();
			document.frm_products.fpurpose.value='save_displayProdShelfGroupAssign';
...
<input type="hidden" name="fpurpose" value="displayProdShelfGroupAssign" />
