<?php
	/*#################################################################
	# Script Name 	: list_shelfgroup_display_selcategory.php
...
if(!server_check($tabale, $where)) {
	...
	$query_string = "request=shelfgroup&fpurpose=displayCategoryShelfGroupAssign&pass_shelfgroup_id=".$shelfgroup_id."";
	...
	$sql_assigned="SELECT product_categories_category_id FROM shelf_group_display_category WHERE sites_site_id=$ecom_siteid AND shelf_group_id=".$shelfgroup_id;
	...
	function call_save_selected(cname,sortby,sortorder,recs,start,pg,shelf_id) 
    {
		...
		else
		{
			...
			{
				show_processing();
				document.frm_prodcat.fpurpose.value='save_displayCategoryShelfGroupAssign';
				document.frm_prodcat.submit();
			}	
		}	
	...
	<input type="hidden" name="fpurpose" value="displayCategoryShelfGroupAssign" />
		...
		<tr>
		  <td height="48" colspan="3" class="sorttd">
			...
			<tr>
			  ...
			  <td width="19%" height="30"  align="left" valign="middle"><input name="catname" type="text" class="textfeild" id="catname" value="<?php echo $_REQUEST['catname']?>" /></td>
			  <td width="10%" height="30"  align="left" valign="middle">Parent Category</td>
			  ...
			  <tr>
			  <td width="11%" height="30"  align="left" valign="middle">Category Group </td>
			  <td width="19%" height="30"  align="left" valign="middle"><?php
			  ...
			  <td width="20%" height="30"  align="left" valign="middle"><input name="records_per_page" type="text" class="textfeild" id="records_per_page" size="3" maxlength="3" value="<?php echo $records_per_page?>" /></td>
			  ...
			  <td width="9%" height="30"  align="right" valign="middle"><input name="Search_go" type="submit" class="red" id="Search_go" value="Go" onclick="document.frm_prodcat.search_click.value=1" />
