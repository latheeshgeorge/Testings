...
{	
	tab_arr 									= new Array('main_tab_td','category_tab_td'<?php if($ecom_site_mobile_api==1){ echo ",'categorymobile_tab_td'";}?>,'product_tab_td','image_tab_td','settings_tab_td'<?php echo $label_group_td?>,'shops_tab_td','seo_tab_td');
	var atleastone 						= 0;
