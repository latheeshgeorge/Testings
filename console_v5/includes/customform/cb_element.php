...
if($_REQUEST['cb_submit'] and (!$_REQUEST['emt_id']))
{
	...
	if($flag_name)
	{
		$sql_insert = "INSERT INTO elements SET site_id='$ecom_siteid', element_label='$element_label', element_name='$element_name', element_valign='".$_REQUEST['valign']."', element_align='".$_REQUEST['align']."', element_type='checkbox', mandatory='$mandatory', error_msg='$error_msg', sort_no='".$row['cnt']."', section_id=".$_REQUEST['section_id'];
		$db->query($sql_insert);
...
?>
<form name="frmtb" action="add_elements.php" method="POST">
<table width="100%" align="center">
	<tr class="content_header">
		<td colspan="2" align="center">
			<h1><?php if($_REQUEST['emt_id']) echo "Edit Check Box"; else echo "Add Check Box"; ?></h1>
		</td>
	</tr>
	<tr class="subhead">
		<td>
	...
	<tr>
		<td colspan="2" align="center">
			<input type="submit" value="Add Values" name="add_values" class="smallsubmit">
		</td>
	</tr>
	<tr class="subhead">
		<td>
	...
	<tr>
		<td colspan="2" align="center">
			...
			{
		?>
			<input type="submit" name="cb_submit" value="Update" class="smallsubmit">
			<?php
			}
			else
			{
			?>
			<input type="submit" name="cb_submit" value="Create" class="smallsubmit">
			<?php
			}
			?>
		</td>
