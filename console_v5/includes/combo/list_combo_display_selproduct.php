<?php
	/*#################################################################
	# Script Name 	: list_combo_display_selproduct.php
...
$table_name='products';
$page_type='Products';
$help_msg = get_help_messages('LIST_PROD_WHEN_VIEW_COMBO');
...
$query_string = "request=combo&fpurpose=displayProdComboAssign";
...
$sql_assigned="SELECT products_product_id FROM combo_display_product WHERE  combo_id=".$combo_id;
...
function call_save_selected(cname,sortby,sortorder,recs,start,pg,group_id) 
{
	...
	else
	{
		...
		{
			show_processing();
			document.frm_products.fpurpose.value='save_displayProdComboAssign';
...
<input type="hidden" name="fpurpose" value="displayProdComboAssign" />
...
<table border="0" cellpadding="0" cellspacing="0" class="maintable" width="100%">
      ...
      <td height="48" colspan="2" class="sorttd">
        ...
        <tr>
		  ...
		  <table width="100%" border="0" cellspacing="1" cellpadding="1">
            <tr>
              <td width="9%" height="30" align="left">Product Name</td>
              <td width="13%" height="30" align="left"><input name="productname" type="text" class="textfeild" id="productname" value="<?php echo $_REQUEST['productname']?>" /></td>
			  ...
			  ?>			  </td>
              <td width="11%" height="30" align="left">Records Per Page </td>
              <td width="20%" height="30" align="left"><input name="records_per_page" type="text" class="textfeild" id="records_per_page" size="3" maxlength="3" value="<?php echo $records_per_page?>" /></td>
            ...
            <tr>
              ...
              <td height="30" align="left"><?php echo $sort_option_txt;?>&nbsp;&nbsp;&nbsp;in&nbsp;&nbsp;&nbsp;<?php echo $sort_by_txt?> </td>
              <td height="30" align="right"><input name="Search_go" type="submit" class="red" id="Search_go" value="Go" onclick="document.frm_products.search_click.value=1" />
    ...
    <tr>
	  ...
	  &nbsp;<a href="#" onmouseover ="ddrivetip('<?=get_help_messages('LIST_PROD_WHEN_VIEW_ASSIGN')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a></td>
    </tr>
	 <?php  
