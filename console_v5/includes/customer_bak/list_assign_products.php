...
$table_name='products';
$page_type='Products';
$help_msg = 'This section lists the Products that can be assigned to the Page Group.';
...
{ 
	...
	if (atleastone==0) 
	{
		alert('Please select the Products to assign to the Customer');
		return false;
	}
	else
	{
		if(confirm('Assign Products to the Page Group?'))
		{
				show_processing();
...
<form name="frmlistProducts" action="home.php?request=customer" method="post" >	
    ...
    <tr>
      ...
      <table width="18%" border="0" cellpadding="0" cellspacing="0" class="sorttableright">
        ...
        <tr>
          ...
          <td align="left">&nbsp;&nbsp;&nbsp;&nbsp;<input name="button5" type="submit" class="red" id="button5" value="Go" /> <a href="#" onmouseover ="ddrivetip('Use \'Go\' button to search for Products that can be assigned to Static Page groups.')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a></td>
        </tr>
      </table>
	  </td>
    </tr>
    <tr>
	  ...
	  ?>
		...
		<input name="assign_products" type="button" class="red" id="assign_products" value="Assign Products" onclick="return assignproducts();" />
		  <a href="#" onmouseover ="ddrivetip('Use This button to assign products to the Customers. Select the products to be assigned to the customer and press \'Assign Products\' button.')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a>
		<?
		}
		?>
   	   </td>
