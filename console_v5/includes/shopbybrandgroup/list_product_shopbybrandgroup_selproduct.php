<?php
	/*#################################################################
	# Script Name 	: list_product_shopbybrandgroup_selproduct.php
...
$table_name			= 'products';
$page_type			= 'Products';
$help_msg 			= get_help_messages('LIST_PROD_DISP_SHOP_BRAND_MESS1');
...
$query_string 		= "request=shopbybrandgroup&fpurpose=prodGroupAssign&pass_shopgroup_id=".$shopgroup_id."";
...
$sql_assigned		= "SELECT products_product_id FROM product_shopbybrand_group_display_products WHERE sites_site_id=$ecom_siteid AND product_shopbybrand_group_shopbrandgroup_id=".$shopgroup_id;
...
$query_string .= "&records_per_page=$records_per_page&productname=".$_REQUEST['productname']."&start=$start";
...
<table border="0" cellpadding="0" cellspacing="0" class="maintable">
	  ...
	  <div class="editarea_div">
        ...
        <tr>
		  ...
		  <table width="100%" border="0" cellspacing="1" cellpadding="1">
            <tr>
              <td width="18%" align="left">Product Name</td>
              <td width="24%" align="left"><input name="productname" type="text" class="textfeild" id="productname" value="<?php echo $_REQUEST['productname']?>" /></td>
		  ...
		  <table width="100%" height="56" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td align="left"><input name="Search_go" type="submit" class="red" id="Search_go" value="Go" onclick="document.frm_products.search_click.value=1" />
                <a href="#" onmouseover ="ddrivetip('<?=get_help_messages('LIST_PROD_DISP_SHOP_BRAND_GO')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a></td>
            </tr>
          </table>
		  </td>
        </tr>
	...
	<tr>
	  ...
	  &nbsp;<a href="#" onmouseover ="ddrivetip('<?=get_help_messages('LIST_PROD_DISP_SHOP_BRAND_ASS')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a></td>
    </tr>
    <tr>
