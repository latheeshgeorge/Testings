...
$table_name='products';
$page_type='Products';
$help_msg = get_help_messages('LIST_PROD_ASS_FETU_PROD_MESS1');
...
//#Search terms
$search_fields = array('productname','manufactureid','categoryid','vendorid','rprice_from','rprice_to','cprice_from','cprice_to','discount','discountas','bulkdiscount','stock_from','stock_to','preorder','prodhidden','sort_by','sort_order','records_per_page');

$query_string = "request=featured&fpurpose=assign";
...
$sql_assigned="SELECT products_product_id FROM product_featured WHERE sites_site_id=$ecom_siteid";
$ret_assigned = $db->query($sql_assigned);
$row_assigned = $db->fetch_array($ret_assigned);
$product_assigned=$row_assigned['products_product_id'];
if($product_assigned)
{
	$where_conditions.=" AND product_id<>$product_assigned";
}	
...
function call_ajax_assign(cname,sortby,sortorder,recs,start,pg)
{
	...
	{
		alert('Please select only one product to assign');
	}
	else
	{
		if(confirm('Are you sure you want to assign selected Product ?'))
		{
			document.frm_products.fpurpose.value = 'save_selected';
...
<form method="post" name="frm_products" class="frmcls" action="home.php?request=featured">
<input type="hidden" name="request" value="featured" />
<input type="hidden" name="fpurpose" value="assign" />
<input type="hidden" name="search_click" value="" />
<table border="0" cellpadding="0" cellspacing="0" class="maintable">
    <tr>
      <td colspan="3" align="left" valign="middle" class="treemenutd"><div class="treemenutd_div"><a href="home.php?request=featured">List Featured Product</a><span>Assign Product</span></div></td>
    </tr>
	<tr>
      ...
      <td height="48" colspan="3" class="sorttd">
        ...
        <tr>
		  ...
		  <table width="100%" border="0" cellspacing="1" cellpadding="1">
            <tr>
              <td width="9%" height="30" align="left" valign="middle">Product Name</td>
              <td width="13%" height="30" align="left" valign="middle"><input name="productname" type="text" class="textfeild" id="productname" value="<?php echo $_REQUEST['productname']?>" /></td>
              <td width="11%" height="30" align="left" valign="middle">Category</td>
              ...
              <td height="30" colspan="2" align="left" valign="middle"><input name="records_per_page" type="text" class="textfeild" id="records_per_page" size="3" maxlength="3" value="<?php echo $records_per_page?>" /></td>
              </tr>
            <tr>
              <td height="30" align="left" valign="middle">Product Id </td>
              <td height="30" align="left" valign="middle"><input name="manufactureid" type="text" class="textfeild" id="manufactureid" value="<?php echo $_REQUEST['manufactureid']?>" /></td>
              <td height="30" align="left" valign="middle">Vendor</td>
              ...
              <td width="27%" height="30" align="left" valign="middle"><?php echo $sort_option_txt;?>&nbsp;&nbsp;&nbsp;in&nbsp;&nbsp;&nbsp;<?php echo $sort_by_txt?> </td>
              <td width="6%" height="30" align="right" valign="middle"><input name="Search_go" type="submit" class="red" id="Search_go" value="Go" onclick="document.frm_products.search_click.value=1" />
                <a href="#" onmouseover ="ddrivetip('<?=get_help_messages('LIST_ASSPROD_FEATU_GO')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a></td>
            </tr>
            <tr>
              <td colspan="7" align="left"><div id="show_morediv" onclick="handle_showmorediv()" title="Click here">Options<img src="images/right_arr.gif"></div></td>
              </tr>
            <tr id="listmore_tr"  <?=$option_search_style_display ?>>
              <td colspan="7"><table width="100%" border="0" cellspacing="1" cellpadding="1">
                <tr>
                  ...
                  <td width="22%" height="30" align="left" valign="middle">Retail Price Between </td>
                  <td width="9%" height="30" align="left" valign="middle"><input name="rprice_from" type="text" class="textfeild" id="rprice_from" value="<?php echo $_REQUEST['rprice_from']?>" size="10" /></td>
                  <td width="5%" height="30" align="left" valign="middle">and </td>
                  <td width="55%" height="30" align="left" valign="middle"><input name="rprice_to" type="text" class="textfeild" id="rprice_to" value="<?php echo $_REQUEST['rprice_to']?>" size="10" /></td>
                </tr>
                <tr>
                  <td height="30" align="left" valign="middle">&nbsp;</td>
                  <td height="30" align="left" valign="middle">Cost Price Between </td>
                  <td height="30" align="left" valign="middle">
				<input name="cprice_from" type="text" class="textfeild" id="cprice_from" value="<?php echo $_REQUEST['cprice_from']?>" size="10" /></td>
                  <td height="30" align="left" valign="middle">and </td>
                  <td height="30" align="left" valign="middle"><input name="cprice_to" type="text" class="textfeild" id="cprice_to" value="<?php echo $_REQUEST['cprice_to']?>" size="10" /></td>
                </tr>
                <tr>
                  <td height="30" align="left" valign="middle">&nbsp;</td>
                  <td height="30" align="left" valign="middle">Discount Atleast </td>
                  <td height="30" align="left" valign="middle"><input name="discount" type="text" class="textfeild" id="discount" value="<?php echo $_REQUEST['discount']?>" size="10" /></td>
				...
				?>
				 <tr>
                  <td height="30" align="left" valign="middle">&nbsp;</td>
                  <td height="30" align="left" valign="middle">Total Stock Between </td>
                  <td height="30" align="left" valign="middle">
				<input name="stock_from" type="text" class="textfeild" id="stock_from" value="<?php echo $_REQUEST['stock_from']?>" size="10" /></td>
                  <td height="30" align="left" valign="middle">and </td>
                  <td height="30" align="left" valign="middle"><input name="stock_to" type="text" class="textfeild" id="stock_to" value="<?=($_REQUEST['stock_to']==-1)?0:$_REQUEST['stock_to'];?>" size="10" /></td>
                </tr>
               <?
			   /* <tr>
                  <td>&nbsp;</td>
                ...
                <tr>
                  <td height="30" align="left" valign="middle">&nbsp;</td>
                  <td height="30" align="left" valign="middle">In Preorder?</td>
                ...
                <tr>
                  <td height="30" align="left" valign="middle">&nbsp;</td>
                  <td height="30" align="left" valign="middle">Hidden?</td>
                  <td height="30" colspan="3" align="left" valign="middle">
				  <?php
    ...
    <tr>
      ...
      <table  border="0" cellpadding="0" cellspacing="0" class="listingtable">
	   <tr>
      <td align="right" class="listeditd" colspan="<?php echo $colspan?>">
	  <input name="change_hide" type="button" class="red" id="change_hide" onClick="call_ajax_assign('<?php echo $_REQUEST['search_name']?>','<?php echo $sort_by?>','<?php echo $sort_order?>','<?php echo $records_per_page?>','<?php echo $start?>','<?php echo $pg?>')" value="Assign Selected">
	  &nbsp;<a href="#" onmouseover ="ddrivetip('<?=get_help_messages('LIST_ASSPROD_FEATU_ASS')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a></td>
    </tr>
	 <?php  
	 ...
	 ?>
				  ...
				  $actual_stock	= $row_qry['product_actualstock'];
				  echo $web_stock."(".$actual_stock.")" ; //<?php echo $row_qry['product_webstock']."(".$row_qry['product_actualstock'].")"?></td>
	...
	?>
	<tr>
      <td align="right" class="listing_bottom_paging" colspan="<?php echo $colspan?>">
	  <?php paging_footer($query_string,$numcount,$pg,$pages,$page_type,$colspan); ?></td>
    </tr>
	<?php 
		}
