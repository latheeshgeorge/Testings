<?php
	...
	// ###############################################################################################################
	function show_categories($mod,$edit_id=0,$cat_arr=array(),$pg=0,$alert='')
	{
	...
	$table_headers = array('<img src="images/checkbox.gif" border="0" onclick="select_all(document.'.$form.',\'checkbox_assigncat[]\')"/><img src="images/uncheckbox.gif" border="0" onclick="select_none(document.'.$form.',\'checkbox_assigncat[]\')"/>','Slno.','Category Name','Parent','Hide');
	$header_positions=array('left','left','left','left','center');
	$colspan = count($table_headers);
	
	//#Search terms
	$search_fields = array('catname','sort_order','parentid','catgroupid','perpage');
	...
	*/ 
	...
	/////////////////////////////////For paging///////////////////////////////////////////
	$records_per_page = (is_numeric($_REQUEST['perpage']) and $_REQUEST['perpage'])?$_REQUEST['perpage']:10;//#Total records shown in a page
	$pg = !($pg)?1:$pg;		
	if (!($pg > 0) || $pg == 0) { $pg = 1; }
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" >
			<tr>		
			 ...
			 <?php
				...
				{
					echo generateselectbox('parentid_pop',$parent_arr,$_REQUEST['parentid']);
				}
			  ?>			  </td>
			...
			<tr>
			  ...
			  <td  align="left" valign="middle"><input name="catname_pop" type="text" class="textfeild" id="catname_pop" value="<?php echo $_REQUEST['catname']?>" /></td>
			 ...
			 <input name="perpage_pop" type="text"  id="perpage_pop" class="textfeild" size="4" value="<?php echo $_REQUEST['perpage'] ?>"  />
			  ...
			  <input name="Search_go" type="submit" class="red" id="Search_go" value="Go" onclick="call_ajax_search('<?php echo $edit_id ?>')" />
...
<input name="Assign_selected" type="button" class="red" id="Assign_selected" value="Assign Selected" onClick="call_ajax_assign_category('<?php echo $edit_id?>')" /> <a href="#" onmouseover ="ddrivetip('<? echo get_help_messages('LIST_SEL_CAT_GROUP_ASSIGN') ?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a>
</div>
					</td>
					</tr>
<?php
