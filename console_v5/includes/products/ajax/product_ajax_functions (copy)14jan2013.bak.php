<?php
	...
	// ###############################################################################################################
	function show_prodlinked_list($edit_id,$alert='')
	{
		global $db,$ecom_siteid;
	...
	function show_prodstock_list($edit_id,$store_id=-1,$alert='')
	{
		...
		$gen_arr 		= get_general_settings('product_maintainstock','general_settings_sites_common');
		...
		// stock field
		$sql_prod = "SELECT product_variablestock_allowed,product_webstock,product_variablecomboprice_allowed,product_bulkdiscount_allowed,product_variablecombocommon_image_allowed 										  
								FROM 
									products 
								WHERE 
									product_id=$edit_id";
...
?>						
										 ...
										 <?PHP
													 ...
													 if($variable_cnt>0 and $gen_arr['product_maintainstock'])
													{
													 ?>
														...
														Allow Individual Stock? &nbsp;<a href="#" onmouseover ="ddrivetip('<?=get_help_messages('PROD_VAR_STK_ALLOWED')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a></div>
													<? 
													}
													?>
										  </td>
								  ...
								  <td align="left" colspan="4">
									...
									?>
										  ...
										  <?php
												...
												$sql_prod = "SELECT product_id,product_webstock,product_barcode FROM products WHERE
									...
									<?php
											...
											<?php
												...
												echo table_header($table_headers,$header_positions); 
												// Check whether the current product is available in web
												$sql_prod = "SELECT shop_stock_id,shop_stock,product_price,product_barcode FROM product_shop_stock WHERE
									...
									do {
										...
										// Start of - Section to check whether the current combination already exists
											...
											if($store_id == 0)// case of web
											{
												$sql_comb 	= "SELECT comb_id,web_stock,comb_barcode,comb_price,comb_img_assigned FROM product_variable_combination_stock WHERE 
															products_product_id = $edit_id";
											...
											{
												// getting the combinations existing for current product
												$sql_comb 	= "SELECT comb_id,comb_barcode,comb_img_assigned FROM product_variable_combination_stock WHERE 
																products_product_id = $edit_id";
												$ret_comb	= $db->query($sql_comb);
											}	
												...
												while ($row_comb = $db->fetch_array($ret_comb))
												{
													...
													if ($db->num_rows($ret_cnt)==$cur_val_cnt)
													{
														...
														else
														{
															...
															$sql_stores = "SELECT shop_stock,comb_barcode,comb_price FROM product_shop_variable_combination_stock 
	...
	function showvariablevalue_list($prodid,$edit_id,$val_exists=-1,$store_id=-1,$alert='')
	{
				   ...
				   <tr>
					...
					?>
									<tr>
								      ...
								      <td align="let"><input type="color" class="color" name="extvar_valcolorcode_<?php echo $row_vals['var_value_id']?>" id="extvar_valcolorcode_<?php echo $row_vals['var_value_id']?>" size="10"  value="<?php echo stripslashes($show_colorcode)?>" <?php echo ($var_style=='drop')?'readonly="true" class="disabled_class"':' class="normal_class"'?>/></td>
									  <td align="center">
					 ...
					 ?>
								 <tr>
								   ...
								   <td align="left"><input type="color" class="color" name="var_valcolorcode[]" id="var_valcolorcode<?=$i?>" size="10"  value="" <?php echo ($var_style=='drop')?'readonly="true" class="disabled_class"':' class="normal_class"'?>/></td>
								   <td align="center">&nbsp;</td>
				   ...
				   <table width="100%" border="0" cellspacing="0" cellpadding="1">
					...
					?>
									<tr>
									  ...
									  <td valign="bottom" align="left" width="13%"><input type="color" class="color" size="10" name="extvar_valcolorcode_<?php echo $row_vals['var_value_id']?>"  id="extvar_valcolorcode_<?php echo $row_vals['var_value_id']?>" value="<?php echo $show_colorcode?>" /></td>
								 ...
								 <tr>
									   ...
									   <?php
										...
										<td  width="8%" valign="bottom"><input type="text" name="var_val_order[]" id="var_val_order[]" size="2" value="" /></td>
										 <td valign="bottom" align="left" width="12%"><input type="color" class="color" size="10" name="var_valcolorcode[]"  id="var_valcolorcode_<?php echo $kk?>" value="" /></td>
...
<?php
	...
	?>
			...
			<tr style="display:<?php echo ($tot_feat_exists>0)?'':'none'?>">
					<td colspan="4" align="left" valign="bottom">
						<table width="100%" border="0" cellspacing="0" cellpadding="1">
						<tr>
						<td align="left" colspan="2" class="helpmsgtd"><?=get_help_messages('EDIT_PROD_OFFER_FEAT')?></td>
						</tr>
						</table>
					</td>
				</tr>
		...
		?>
		 ...
		 <tr>
           <td  align="left" valign="top" class="tdcolorgray" >
				<div class="editarea_div">
					<table width="100%" border="0" cellspacing="0" cellpadding="1">
						<tr>
							...
							<td align="left"><input name="in_mobile_api_sites_prod" type="checkbox" id="in_mobile_api_sites_prod" value="1" <?php echo ($row_prod['in_mobile_api_sites']==1)?'checked="checked"':''?>/>
							...
							<td width="32%" align="left"><input name="product_name" type="text" size="30" value="<?php echo str_replace('"',"''",stripslashes($row_prod['product_name']));?>"  maxlength="100"/></td>
							<td width="13%" align="left">Added On </td>
							<td width="36%" align="left">
							<?php
							$add_arr	= explode(" ",$row_prod['product_adddate']);
							$adddate 	= explode("-",$add_arr[0]);
							$addtime	= explode(":",$add_arr[1]);
							echo date('d/M/Y',mktime(0,0,0,$adddate[1],$adddate[2],$adddate[0])).' '.$add_arr[1];
							?></td>
							</tr>
							<tr>
							<td align="left">Product Id </td>
							<td align="left"><input name="manufacture_id" type="text" size="30" value="<?php echo stripslashes($row_prod['manufacture_id']);?>" maxlength="100"/></td>
							...
							<td align="left">
							<input name="product_model" type="text" size="40" value="<?php echo stripslashes($row_prod['product_model'])?>" maxlength="100"/>        </td>
							<td align="left" colspan="2"> <table cellpadding="0" cellspacing="0" border="0" width="100%">
							<tr>
							<td width="26%" align="left" valign="top" class="tdcolorgray_url">Website URL</td>
							<td width="74%" align="left" valign="top" class="tdcolorgray_url"><?php url_product($row_prod['product_id'],$row_prod['product_name'],-1);?></td>
							</tr>
							</table>
							</td>
						</tr>
						...
						<tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
								<td align="left" width="19%">Short Description &nbsp;<span class="redtext">*</span></td>
								<td  align="left"><input name="product_shortdesc" type="text" size="104" value="<?php echo str_replace('"',"''",stripslashes($row_prod['product_shortdesc']))?>" maxlength="1000" /></td>
								</tr>
								<tr>
								<td colspan="2">&nbsp;</td>
								</tr>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
								<td  align="left" valign="top" class="seperationtd">Price Settings</td>
								</tr>
								<tr>
								<td  align="left">
								<table width="100%" border="0" cellspacing="0" cellpadding="1">
								...
								<tr>
								<td  align="left" valign="top" class="seperationtd">Discounts</td>
								</tr>
								<tr>
								<td  align="left" valign="top"><?=get_help_messages('PRODUCT_DISCOUNT_DESC')?></td>
								</tr>
								<tr>
								<td valign="top">
								<table width="100%" border="0" cellspacing="0" cellpadding="1">
								...
								<tr>
								<td  align="left" valign="top" class="seperationtd">Product Deposit </td>
								</tr>
								<tr>
								<td  align="left" valign="top"><?=get_help_messages('ADD_PROD_DEP_DESC')?></td>
								</tr>
								<tr>
								<td>
								<table width="100%" border="0" cellspacing="0" cellpadding="1">
					...
					<table width="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
				<td  align="left" valign="top" class="seperationtd">Other Settings </td>
				</tr>
				<tr>
				<td  align="left" valign="top">
				<table width="100%" border="0" cellspacing="0" cellpadding="1">
				...
				Show Product Sale Icon <a href="#" onmouseover ="ddrivetip('<?=get_help_messages('')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a></td>
				...
				Show product New Icon <a href="#" onmouseover ="ddrivetip('<?=get_help_messages('')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a></td>
				...
				<tr>
				 <td align="left"  class="seperationtd">Price Caption Settings <a href="#" onmouseover ="ddrivetip('<?=get_help_messages('ADD_PROD_PRICE_CAP')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a>
				 </td>
				 </tr>
				 <tr>
				 <td >
				 ...
				 <?php //end of price caption settings?>
						 ...
						 // Get the list of vendors added for the site
										...
										{	
											?>
												<tr>
													<td colspan="2" class="seperationtd">Vendors <a href="#" onmouseover ="ddrivetip('<?=get_help_messages('')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0"  /></a>
												</td>
												</tr>
												<tr>
												<td colspan="2">
												...
												?>	
						<tr>
				<td  align="left" valign="top" class="seperationtd" colspan="2">Preorder</td>
				</tr>
				<tr>
				<td colspan="0" align="left" valign="top" colspan="2"><?=get_help_messages('ADD_PROD_PREORDER_WHAT')?></td>
				</tr>
				<tr>
					<td colspan="0" align="left" valign="top" colspan="2">
				<table width="100%" border="0" cellspacing="0" cellpadding="1">
          <tr>
	...
	?> <div class="editarea_div">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="1" style="border:2px solid #CFDEF4">
		<!-- <tr>
	...
	?> <div class="editarea_div">
		...
		?>
		 ...
		 ?>
		  <tr>
			<td align="left" colspan="2" class="helpmsgtd"><?=get_help_messages('EDIT_PROD_STOCK_MAIN');?></td>
		  </tr>
		   <tr>
			<td align="left" colspan="2" style="background-color:#FEEAA4; padding-left:38px"><?
...
<?php			
	...
	// ###############################################################################################################
	function show_prodlinkedinfo($edit_id,$alert='')
	{
		global $db,$ecom_siteid;
	?> <div class="editarea_div">
		<table width="100%" border="0" cellspacing="0" cellpadding="1">
...
<?php			
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="1">
		...
		?>
		 ...
		 ?>
		   <tr>
			<td align="left" colspan="2" class="helpmsgtd"><?=get_help_messages('EDIT_PROD_IMAGE_MAIN')?></td>
		  </tr>
		 <tr>
        ...
        <td colspan="3" align="left" valign="top" class="seperationtd">Image Display Format in Details Page</td>
		  ...
		  <tr>
			<td align="left" colspan="2" class="helpmsgtd"><?=get_help_messages('EDIT_PROD_IMAGE_SUB')?></td>
		  </tr>
      <tr>
...
<?php			
	...
	?>
		...
		?>
		 ...
		 ?>
		  <tr>
			<td align="left" colspan="2" class="helpmsgtd"><?=get_help_messages('EDIT_PROD_DOWNLOAD_MAIN')?></td>
		  </tr>
		 <tr>
		  <td align="right" colspan="2" class="tdcolorgray_buttons">
...
<?php			
	...
	?>
		 ...
		 ?>
		  <tr>
			<td align="left" colspan="2" class="helpmsgtd"><?=get_help_messages('EDIT_PROD_SIZEHEAD_MAIN')?></td>
		  </tr>
		 <tr>
		...
		<table width="99%" border="0" cellspacing="0" cellpadding="1">	
		 <tr>
			<td align="left" colspan="2" class="helpmsgtd"><?=get_help_messages('EDIT_PROD_SIZEHEAD_MAIN_SUB')?></td>
		  </tr>
			 <tr>
				<td align="right" colspan="2" class="tdcolorgray_buttons">
				<table width="100%" border="0" cellspacing="0" cellpadding="1">
		...
		<table width="99%" border="0" cellspacing="0" cellpadding="1">
		 <tr>
			<td align="left" colspan="2" class="helpmsgtd"><?=get_help_messages('EDIT_PROD_SIZEHEAD_COMMON')?></td>
		  </tr>
		  <tr>
		  <td align="center" colspan="2">
			...
			<td align="left"><input type="text" name="product_commonsizechart_link" id="product_commonsizechart_link" value="<?php echo $row_common['product_commonsizechart_link']?>" size="80" />&nbsp;&nbsp;<strong>(e.g. http://<?php echo $ecom_hostname?>/[pagename].html)</strong></td>
			</tr>
			<tr>
...
// ###############################################################################################################
	...
	<table width="90%" border="0" cellspacing="0" cellpadding="1" align="right" style="border:solid 1px #FF0000">
		...
		?>
		 ...
		 ?>
		   <tr>
			<td align="left" colspan="2" class="helpmsgtd"><?=get_help_messages('EDIT_PROD_COMB_IMAGE_MAIN')?></td>
		  </tr>
		 <tr>
		  <td align="right" colspan="3" class="tdcolorgray_buttons">
...
<?php
	...
	?>
					...
					<tr>
						<td colspan="4" align="left" class="helpmsgtd"><?=get_help_messages('EDIT_PROD_PRESTVAR_HELP')?></td>
					</tr>	
					<tr>
