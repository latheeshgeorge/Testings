...
$sql_linkexist = "SELECT link_product_id FROM product_linkedproducts WHERE link_parent_id=".$_REQUEST['checkbox'][0];
$ret_linkexist = $db->query($sql_linkexist);
if ($db->num_rows($ret_linkexist))
{
	while ($row_linkexist = $db->fetch_array($ret_linkexist))
	{
		$ext_arr[] = $row_linkexist['link_product_id'];
	}
}
...
$table_name='products';
$page_type='Products';
$help_msg = get_help_messages('EDIT_PROD_LINKED_ASSMORE');
...
//#Search terms
$search_fields = array('productname','manufactureid','categoryid','vendorid','rprice_from','rprice_to','cprice_from','cprice_to','discount','discountas','bulkdiscount','stockatleast','preorder','prodhidden','sort_by_link','sort_order_link','cbo_bulkdisc');

$query_string = "request=products&fpurpose=add_prodlink&prod_dontsave=1&checkbox[0]=".$_REQUEST['checkbox'][0]."&curtab=".$_REQUEST['curtab']."&records_per_page_link=".$_REQUEST['records_per_page_link']."&pss_records_per_page=".$_REQUEST['pss_records_per_page']."&pss_pg=".$_REQUEST['pss_pg']."&pss_start=".$_REQUEST['pss_start'];
...
<input type="hidden" name="fpurpose" value="add_prodlink" />
      ...
      <td height="48" colspan="2" class="sorttd">
        ...
        <tr>
		  ...
		  <table width="100%" border="0" cellspacing="1" cellpadding="1">
            <tr>
              <td width="5%" height="30" align="left">Product Name</td>
              ...
              <td width="10%" height="30" align="left">Product Id </td>
              <td width="13%" height="30" align="left"><input name="manufactureid_link" type="text" class="textfeild" id="manufactureid_link" value="<?php echo $_REQUEST['manufactureid_link']?>" /></td>
            ...
            <tr>
			  ...
			  ?></td>
              <td height="30" align="left">Records Per Page </td>
              <td height="30" align="left"><input name="records_per_page_link2" type="text" class="textfeild" id="records_per_page_link2" size="3" maxlength="3" value="<?php echo $records_per_page?>" /></td>
              <td height="30" align="left">Sort By</td>
              <td height="30" align="left"><?php echo $sort_option_txt;?> in <?php echo $sort_by_txt?></td>
              <td height="30" align="right"><input name="Search_go" type="submit" class="red" id="Search_go" value="Go" onclick="document.frm_products_link.search_click.value=1" />
...
$pnc().ready(function() { 
	auto_search('productname_link','prdts'); 
});
</script>
