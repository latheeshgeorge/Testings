...
<a href="home.php?request=login_track" class="addviewlist">Logs of Console Logins</a>
			<a href="home.php?request=listof_console_useractions" class="addviewlist">List of Console User Action</a>
	  ...
	  <tr>
		...
		?>	
		<tr>
      <td class="listeditd" colspan="<?=($colspan-1)?>"><a href="home.php?sort_by=<?=$sort_by?>&sort_order=<?=$sort_order?>&request=console_user&fpurpose=add&records_per_page=<?=$records_per_page?>&start=<?=$start?>&pg=<?=$pg?>" class="addlist" onclick="show_processing()" >Add</a> <a href="#" onclick="edit_selected()" class="editlist">Edit</a> <a href="#" onclick="call_ajax_delete('<?php echo $_REQUEST['search_name']?>','<?php echo $sort_by?>','<?php echo $sort_order?>','<?php echo $records_per_page?>','<?php echo $start?>','<?php echo $pg?>')" class="deletelist">Delete</a>
<a href="home.php?request=login_track" class="addviewlist">Logs of Console Logins</a>
      			<a href="home.php?request=listof_console_useractions" class="addviewlist">List of Console User Action</a>
