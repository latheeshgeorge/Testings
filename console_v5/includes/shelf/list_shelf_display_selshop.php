...
if(!server_check($tabale, $where)) {
	...
	$query_string = "request=shelfs&fpurpose=displayShopShelfAssign&pass_shelf_id=".$shelf_id."";
	...
	$sql_assigned="SELECT product_shop_shop_id FROM product_shelf_display_shop WHERE sites_site_id=$ecom_siteid AND product_shelf_shelf_id=".$shelf_id;
	...
	function call_save_selected(cname,sortby,sortorder,recs,start,pg,shelf_id) 
    {
		...
		else
		{
			...
			{
				show_processing();
				document.frm_prodshop.fpurpose.value='save_displayShopShelfAssign';
	...
	<input type="hidden" name="fpurpose" value="displayShopShelfAssign" />
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="maintable">
		...
		<tr>
		  <td height="48" colspan="3" class="sorttd">
			...
			<tr>
			  <td width="13%" height="30" align="left" valign="middle">Shop Name </td>
			  <td width="15%" height="30"  align="left" valign="middle"><input name="shopname" type="text" class="textfeild" id="shopname" value="<?php echo $_REQUEST['shopname']?>" /></td>
			  <td width="9%" height="30"  align="left" valign="middle">Parent Shop</td>
			  <td width="27%" height="30"  align="left" valign="middle"><?php
			  ...
			  ?></td>
			  <td width="8%" height="30"  align="left" valign="middle">Shop Group</td>
