...
$sql_assigned="SELECT static_pages_page_id FROM product_shelf_display_static WHERE sites_site_id=$ecom_siteid AND product_shelf_shelf_id=".$shelf_id;
...
/////////////////////////////////////////////////////////////////////////////////////
$query_string .= "sort_by=$sort_by&sort_order=$sort_order&request=shelfs&fpurpose=displayStaticShelfAssign&records_per_page=$records_per_page&pass_searchname=".$_REQUEST['pass_searchname']."&pass_sortby=".$_REQUEST['pass_sortby']."&pass_sortorder=".$_REQUEST['pass_sortorder']."&pass_records_per_page=".$_REQUEST['pass_records_per_page']."&pass_start=".$_REQUEST['pass_start']."&pass_pg=".$_REQUEST['pass_pg']."&start=$start&pass_shelf_id=".$shelf_id."";
?>
...
function call_save_selected(cname,sortby,sortorder,recs,start,pg,group_id) 
{
	...
	else
	{
		...
		{
			show_processing();
			document.frmlistPage.fpurpose.value='save_displayStaticShelfAssign';
...
<input type="hidden" name="fpurpose" value="displayStaticShelfAssign" />
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="maintable">
	...
	<tr>
	  ...
	  <div class="sorttd_div">
        ...
        <tr>
          <td width="5%" height="30" align="left" valign="middle">Title </td>
          ...
          <td width="16%" height="30" align="right" valign="middle"><input name="button5" type="submit" class="red" id="button5" value="Go" />
            <a href="#" onmouseover ="ddrivetip('<?=get_help_messages('LIST_STAT_SHELVES_ASS_GO')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a></td>
        </tr>
      </table>
	  </div>      </td>
	</tr>
    ...
    <tr>
      <td colspan="5" align="right" valign="middle" class="listeditd">	  <input name="change_hide" type="button" class="red" id="change_hide" onClick="call_save_selected()" value="Assign Selected">   	   </td>
    </tr>
       <?
	  ...
	  <tr>
	    ...
	    ?>
		<tr>
			<td class="listeditd" colspan="5"  align="right" valign="middle"><?php paging_footer($query_string,$numcount,$pg,$pages,$page_type,$colspan); ?></td>
		</tr>
		<?php
	  	  }
		?>
