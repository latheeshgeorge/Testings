...
$query_string = "request=shelfs&fpurpose=prodShelfAssign&pass_shelf_id=".$shelf_id."";
...
$sql_assigned="SELECT products_product_id FROM product_shelf_product WHERE  product_shelf_shelf_id=".$shelf_id;
...
function call_save_selected(cname,sortby,sortorder,recs,start,pg,group_id) 
{
	...
	else
	{
		...
		{
			show_processing();
			document.frm_products.fpurpose.value='save_prodShelfAssign';
...
<input type="hidden" name="fpurpose" value="prodShelfAssign" />
        ...
        <tr>
		  ...
		  <table width="100%" border="0" cellspacing="1" cellpadding="1">
            <tr>
			  ...
			  ?>			  </td>
              <td width="14%" height="30" align="left" valign="middle">Records Per Page </td>
              <td width="21%" height="30" align="left" valign="middle"><input name="records_per_page" type="text" class="textfeild" id="records_per_page" size="3" maxlength="3" value="<?php echo $records_per_page?>" /></td>
            ...
            <tr>
              ...
              <td height="30" align="right" valign="middle"><input name="Search_go" type="submit" class="red" id="Search_go" value="Go" onclick="document.frm_products.search_click.value=1" />
