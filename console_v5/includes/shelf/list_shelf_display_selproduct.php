<?php
	/*#################################################################
	# Script Name 	: list_shelf_display_selproduct.php
...
$table_name='products';
$page_type='Products';
$help_msg = get_help_messages('LIST_PROD_ASS_SHELF_MESS1');
...
//#Search terms
$search_fields = array('productname','manufactureid','categoryid','vendorid','rprice_from','rprice_to','cprice_from','cprice_to','discount','discountas','bulkdiscount','stockatleast','stock_from','stock_to','preorder','prodhidden','sort_by','sort_order');

$query_string = "request=shelfs&fpurpose=displayProdShelfAssign&pass_shelf_id=".$shelf_id."";
...
$sql_assigned="SELECT products_product_id FROM product_shelf_display_product WHERE  product_shelf_shelf_id=".$shelf_id;
...
function call_save_selected(cname,sortby,sortorder,recs,start,pg,group_id) 
{
	...
	else
	{
		...
		{
			show_processing();
			document.frm_products.fpurpose.value='save_displayProdShelfAssign';
...
<input type="hidden" name="fpurpose" value="displayProdShelfAssign" />
...
<table border="0" cellpadding="0" cellspacing="0" class="maintable">
        ...
        <tr>
		  ...
		  <table width="100%" border="0" cellspacing="1" cellpadding="1">
            <tr>
              ...
              <td width="7%" height="30" align="left" valign="middle">Category</td>
            ...
            <tr>
              ...
              <td width="13%" height="30" align="right" valign="middle"><input name="Search_go" type="submit" class="red" id="Search_go" value="Go" onclick="document.frm_products.search_click.value=1" />
                <a href="#" onmouseover ="ddrivetip('<?=get_help_messages('LIST_PROD_ASS_SHELF_GO')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a></td>
            </tr>
            <tr>
    ...
    <tr>
	 ...
	 ?>
				  ...
				  $actual_stock	= $row_qry['product_actualstock'];
				  echo $web_stock."(".$actual_stock.")" ; //echo $row_qry['product_webstock']."(".$row_qry['product_actualstock'].")
	...
	?>
	<tr>
      <td colspan="<?php echo $colspan?>" align="right" valign="middle" class="listing_bottom_paging">  <?php paging_footer($query_string,$numcount,$pg,$pages,$page_type,$colspan);?></td>
    </tr>
	<?php
		}
	?>
