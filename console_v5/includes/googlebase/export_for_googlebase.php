...
<script type='text/javascript'>
	function handle_url_update(mod='')
	{
		var qrystr = '';
		...
		if(document.getElementById('chk_google_product_apparel_req'))
		{
			if(document.getElementById('chk_google_product_apparel_req').checked)
			{
				...
				if(mod=='main')
				{
				document.getElementById('apparel_agegroup_req').checked=true;
				document.getElementById('apparel_gender_req').checked=true;
				document.getElementById('apparel_color_req').checked=true;
				document.getElementById('apparel_size_req').checked=true;
				}
		...
		if(qrystr!='')
			qrystr = '?' + qrystr; 
		document.getElementById('google_base_input_url').innerHTML='<?php echo $http?>'+ecomhost+'/googlebaseExport.php'+qrystr; 	
	}
...
<td valign="top">
	...
	<tr>
	<td align="left" class="treemenutd"><div class="treemenutd_div"><span>Google Base Exporter</span></div></td>
	</tr>
	<tr>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="1">
      <tr>
        <td align="left" valign="top" class="advanced_seperator">
		<div class="advanced_seperator_div">
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
          <tr>
            <td colspan="2" class="seperationtd"><input type="checkbox" name="chk_brand_req" id="chk_brand_req" onclick='handle_url_update()' value="1" checked="checked" />Include "Brand" column in export
			</td>
		  </tr>
		  <tr>
            <td colspan="2" align="left" valign="middle" class="listingtablestyleA" >This option allows to decide whether the column <strong>&quot;Brand&quot;</strong> is to be included in the google base export file. If ticked, the column will be included otherwise it will be excluded. </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td width="99%" align="left" class="listingtablestyleA" >1. If <strong>&quot;Model&quot;</strong> is specified for a product, then that value will be placed in this field </td>
          </tr>
          <tr>
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
          <tr>
            <td align="left" colspan="3" class="seperationtd">
              <input type="checkbox" name="chk_barcode_req" id="chk_barcode_req"  onclick='handle_url_update()' value="1"/>
            Include <strong>"Barcode"</strong> column in export</td>
          </tr>
		  <tr>
            <td align="right" valign="middle" class="tdcolorgray" >&nbsp;</td>
            <td colspan="2" align="left" valign="middle" class="listingtablestyleA" >This option allows to decide whether the column <strong>&quot;Barcode&quot;</strong> is to be included in the google base export file. If ticked, the column will be included otherwise it will be excluded. The name of the column will be <strong>&quot;gtin&quot;</strong></td>
          </tr>
          <tr>
            <td align="left" class="tdcolorgray" >&nbsp;</td>
            <td colspan="2" align="left" class="tdcolorgray" >&nbsp;</td>
	 ...
	 <tr>
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
          <tr>
            <td align="left" colspan="3" class="seperationtd"><input name="chk_google_product_category_req" type="checkbox" id="chk_google_product_category_req"  onclick='handle_url_update()' value="1" checked="checked"/>
              Include <strong>&quot;Google Product Category&quot;</strong> column in export </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td align="left" class="listingtablestyleA" > It only accepts categories from Google's product taxonomy
              ...
              <br />
              Apparel &amp; Accessories &gt; Clothing <br />
              Apparel &amp; Accessories &gt; Shoes <br />
              Apparel &amp; Accessories (Note that submitting this value for clothing and shoes is not acceptable.) <br />
              Media &gt; Books <br />
              Media &gt; DVDs &amp; Videos <br />
              Media &gt; Music <br />
              Software &gt; Video Game Software <br />
              For products that belong to other product categories, providing this attribute is recommended. For countries other than the US, Japan, UK, Germany and France, this attribute is recommended for all product categories. </td>
          </tr>
        </table>
		</div>
		</td>
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
          <tr>
            <td align="left" colspan="2" class="seperationtd">
              <input name="chk_availability_req" type="checkbox" id="chk_availability_req"  onclick='handle_url_update()' value="1" checked="checked"/>
            Include "Availability" column in export</td>
          </tr>
		  <tr>
         ...
         <tr>
            <td width="1%" align="left" class="tdcolorgray" >&nbsp;</td>
            <td width="96%" align="left" class="listingtablestyleA" >1. If stock is available for a product, then the value <strong>&quot;in stock&quot;</strong> will be used.</td>
          </tr>
         <tr>
           <td align="left" class="tdcolorgray" >&nbsp;</td>
	 ...
	 <tr>
	   ...
	   <table width="100%" border="0" cellspacing="1" cellpadding="2">
         <tr>
           <td colspan="2" class="seperationtd"><input type="checkbox" name="chk_mpn_req" id="chk_mpn_req"  onclick='handle_url_update()' value="1"/>
             Include <strong>&quot;MPN&quot;</strong> column in export </td>
         </tr>
         <tr>
           <td colspan="2" align="left" valign="middle" class="listingtablestyleA" >This option allows to decide whether the column <strong>&quot;MPN&quot;</strong> is to be included in the google base export file. If ticked, the column will be included otherwise it will be excluded. The name of the column will be <strong>&quot;MPN&quot;</strong></td>
         </tr>
         <tr>
           <td colspan="2" align="left" class="tdcolorgray" >&nbsp;</td>
         </tr>
	   ...
	   <table width="100%" border="0" cellspacing="1" cellpadding="1">
         <tr>
           <td colspan="2" class="seperationtd"><input type="checkbox" name="chk_add_image_link_req" id="chk_add_image_link_req"  onclick='handle_url_update()' value="1"/>
             Include <strong>&quot;Additional Image Link&quot;</strong> column in export</td>
         </tr>
         <tr>
	...
	if($row_site['is_apparel_site']==1)
	{
	   ...
	   <table width="100%" border="0" cellspacing="0" cellpadding="2">
          <tr id="tr_discval">
           <td colspan="2" class="seperationtd"><input type="checkbox" name="chk_google_product_apparel_req" id="chk_google_product_apparel_req"  onclick='handle_url_update("main")' value="1"/>
             Include <strong>"Apparel Product Details"</strong> column in export </td>
         </tr>
          <tr>
           <td colspan="2" align="left" valign="middle" class="listingtablestyleA" >This option allows you to decide whether the "Apparel Product Details" is to be included in the google base export details. If this option is ticked, you will be able to see the attributes for the apparel products. Tick mark the attributes you would like to include in the export.</td>
         </tr>
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="2">
          ...
          <tr >
            ...
            <tr>
              ...
              <a href="#" onmouseover ="ddrivetip('<?=get_help_messages('LIST_GOOGLE_BASE_GENFILE')?>')"; onmouseout="hideddrivetip()"><img src="images/helpicon.png" width="17" height="13" border="0" /></a>
           ...
           <tr>
            <td align="left" class="tdcolorgray" >The URL depends on the above checkboxes. To get relevant data in the Data Feed Url, pls tick the required boxes before copying the url from this section</td>
             ...
             <tr>
            <td  align="center" class="tdcolorgray" ><div style='width:600px;background-color:#CCCCCC;padding:10px;font-weight:bold;border:solid 1px' name='google_base_input_url' id='google_base_input_url'><?php echo $http.$ecom_hostname;?>/googlebaseExport.php?brn=1&avi=1&gpc=1</div></td>
            </tr>
             <tr>
