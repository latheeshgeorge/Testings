...
function url_product($prodId,$prodName='',$ret=-1,$value_id=0,$value_name='')
{
    global $productPageUrlHash, $db, $ecom_siteid, $ecom_hostname,$ecom_advancedseo,$ecom_selfssl_active;                
	...
	{
		$value_name = strip_url_console($value_name); // Stripping unwanted characters from the value name
	...
	while($row_prod = $db->fetch_array($ret_prod)) 
	{
		...
		{		
			...
			else if(trim($row_prod['product_longdesc']))
			{
			...
			$ret_link = url_product($row_prod['product_id'],$row_prod['product_name'],1,$row_var_data['var_value_id'],$row_var_data['var_value']);
			print $ret_link."\t";
			...
			if($include_shipping)
			{
				...
				if ($ecom_siteid!=105) // case of puregusto Jan31
				{
