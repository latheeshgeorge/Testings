...
$title = new title("No:of Orders By Month (Past ".($gp_max-1)." months)" );
...
$t->set_title_style( "{font-size: 10px; color: #FFFFFF;}" );
$t->set_body_style( "{font-size: 10px; font-weight: bold; color: #000000;}" );

$bar_stack->set_colours( array( '#425261','#59c8c5','#c8a259','#6b59c8','#c85978','#75c859','#75c859','#75c859') );
...
if ($max_val>1500)
	$range_vals = 100;
$y->set_range( 0, ($max_val+40), $range_vals );
