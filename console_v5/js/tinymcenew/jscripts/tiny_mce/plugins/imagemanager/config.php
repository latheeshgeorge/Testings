<?php
	...
	$mcImageManagerConfig['filesystem.rootpath'] = "/var/www/vhosts/bshop4.co.uk/httpdocs/images/".$_SERVER['HTTP_HOST']."/static"; // absolute or relative from this script path, required.
	...
	$mcImageManagerConfig['upload.extensions'] = "gif,jpg,jpeg,png,swf";
	...
	$mcImageManagerConfig['authenticator.login_page'] = "";
