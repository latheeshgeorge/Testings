...
{
	include("includes/component_position/manage_componentpositions.php");
} 
elseif($_REQUEST['fpurpose']=='save_componentsection')
{
	if($_REQUEST['comp_str'])
	{
		...
		$sql_lay = "SELECT layout_positions,layout_id FROM themes_layouts WHERE themes_theme_id=$ecom_themeid AND layout_code='".$sellayout."'";
	...
	{	
		include("includes/component_position/edit_componentpositiontitles.php");
	}
	else
	{
