...
elseif($_REQUEST['fpurpose'] == 'search_key_cat') {
include("includes/seo/ad_keywords_list.php");
}
elseif($_REQUEST['fpurpose'] == 'search_key_prod') {
include("includes/seo/ad_keywords_list.php");
}
elseif($_REQUEST['fpurpose'] == 'search_key_shop') {
include("includes/seo/ad_keywords_list.php");
}
elseif($_REQUEST['fpurpose'] == 'search_key_shelf') {
include("includes/seo/ad_keywords_list.php");
}
elseif($_REQUEST['fpurpose'] == 'search_key_combo') {
include("includes/seo/ad_keywords_list.php");
}
elseif($_REQUEST['fpurpose'] == 'search_key_stat') {
include("includes/seo/ad_keywords_list.php");
}
elseif($_REQUEST['fpurpose'] == 'search_key_saved') {
include("includes/seo/ad_keywords_list.php");
}
			...
			foreach($_REQUEST as $k=>$v)
			{
				...
				elseif(substr($k,0,7) == 'txthelp'){
					...
					else
					{
						...
						$db->update_from_array($update_array, 'se_help_title', array('sites_site_id' => $cbo_sites ,  'id' => $row_check['id']));
					}
				...
				elseif(substr($k,0,15) == 'txtregistration'){
					...
					else
					{
						...
						$db->update_from_array($update_array, 'se_registration_title', array('sites_site_id' => $cbo_sites ,  'id' => $row_check['id']));
					}
				...
				elseif(substr($k,0,18) == 'txtsavedsearchmain'){
					...
					else
					{
						...
						$db->update_from_array($update_array, 'se_savedsearchmain_title', array('sites_site_id' => $cbo_sites ,  'id' => $row_check['id']));
					}
				...
				elseif(substr($k,0,10) == 'txtsitemap'){
					...
					else
					{
						...
						$db->update_from_array($update_array, 'se_sitemap_title', array('sites_site_id' => $cbo_sites ,  'id' => $row_check['id']));
					}
				...
				elseif(substr($k,0,17) == 'txtforgotpassword'){
					...
					else
					{
						...
						$db->update_from_array($update_array, 'se_forgotpassword_title', array('sites_site_id' => $cbo_sites ,'id' => $row_check['id']));
					}
				...
				elseif(substr($k,0,14) == 'txtsitereviews'){
					...
					else
					{
						...
						$db->update_from_array($update_array, 'se_sitereviews_title', array('sites_site_id' => $cbo_sites ,'id' => $row_check['id']));
					}
				...
				elseif(substr($k,0,8) == 'txtsaved')//This section will be executed only in case of Saved search
				{
					...
					$sql_check = "SELECT id FROM se_search_title WHERE 
										 saved_search_search_id=$cur_id AND sites_site_id = $cbo_sites LIMIT 1";
					$ret_check = $db->query($sql_check);
					if($db->num_rows($ret_check)==0)
					{
						$insert_array	= array();
					...
					else
					{
						...
						$db->update_from_array($update_array, 'se_search_title', array('sites_site_id' => $cbo_sites ,  'id' => $row_check['id']));
					}
				}
...
else if($_REQUEST['fpurpose']=='SaveKeywordDesc'){
