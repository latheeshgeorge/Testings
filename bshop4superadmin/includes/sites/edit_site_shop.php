...
$help_msg = 'This section helps in editing a  Shop in a site.';
$sql = "SELECT * FROM sites_shops WHERE shop_id=".$_REQUEST['shop_id'];
$res = $db->query($sql);
        ...
        <td class="maininnertabletd2">
			<table width="100%"  border="0" cellpadding="4" cellspacing="1" class="">
				...
				<tr>
				  ...
				  <td width="25%" align="left"><input name="shop_title" type="text" id="shop_title" value="<?=$row['shop_title']?>" size="30" />
				...
				<tr>
				  ...
				  <td align="left"><span class="fontblacknormal">
				    <input name="shop_address" type="text" id="shop_address" value="<?=$row['shop_address']?>" size="30" />
				...
				<tr>
				  ...
				  <td align="center">:</td>
				  <td align="left"><input name="shop_phone" type="text" id="shop_phone" value="<?=$row['shop_phone']?>" size="30"><span class="redtext">&nbsp;*</span></td>
				  <td align="left">&nbsp;</td>
			    </tr>
				<tr>
				  <td align="right" class="fontblacknormal">Mobile </td>
				  <td align="center">:</td>
				  <td align="left"><input name="shop_mobile" type="text" id="shop_mobile" value="<?=$row['shop_mobile']?>" size="30" />
			      <span class="redtext">*</span></td>
			      <td align="left">&nbsp;</td>
		      </tr>
				<tr>
				  ...
				  <td align="center">:</td>
				  <td align="left"><input name="shop_email" type="text" id="shop_email" value="<?=$row['shop_email']?>" size="30" />
			      <span class="redtext">&nbsp;*</span></td>
		          <td align="left">&nbsp;</td>
	          </tr>
				<tr>
				  ...
				  <td align="center">:</td>
				  <td align="left"><input name="shop_contactperson" type="text" id="shop_contactperson" value="<?=$row['shop_contactperson']?>" size="30" /></td>
			      <td align="left">&nbsp;</td>
		      </tr>
				<tr>
<td align="right" class="fontblacknormal">Contect Person Designation </td>
				  <td align="center">:</td>
				  <td align="left"><input name="shop_conatactperson_designation" type="text" id="shop_conatactperson_designation" value="<?=$row['shop_conatactperson_designation']?>" size="30" /></td>
		          <td align="left">&nbsp;</td>
			  </tr>
				<tr>
				  <td align="right" class="fontblacknormal">Order</td>
				  <td align="center">:</td>
				  <td align="left"><input name="shop_order" type="text" size="2" value="<?php echo $row['shop_order']?>" /></td>
			      <td align="left">&nbsp;</td>
		      </tr>
				...
				<tr>
			      ...
			      <td align="right">:</td>
			      <td align="left"><input name="shop_active" type="checkbox" id="shop_active" value="1" <?php echo ($row['shop_active']==1)?'checked="checked"':''?> /></td>
			      <td align="right">&nbsp;</td>
		      </tr>
				<tr>
				...
				<tr align="center">
				<td colspan="5">
				<input type="hidden" name="shop_id" id="shop_id" value="<?=$_REQUEST['shop_id']?>" />
                    ...
                    <input type="hidden" name="fpurpose" id="fpurpose" value="update_shops" />
                  <input type="Submit" name="UpdateShop_submit" id="UpdateShop_submit" value="Update" class="input-button"></td>
			  </tr>
				<tr>
				  <td colspan="4" align="right">&nbsp;</td>
				</tr>
