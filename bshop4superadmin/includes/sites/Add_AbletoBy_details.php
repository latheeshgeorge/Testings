...
*/
$page_type = 'AbleToBy';
$help_msg = 'This section helps in adding a  details of AbleToBy payment type.';
?>
...
<form name='frmAddAbleToByInSite' action='home.php?request=sites' method="post" onsubmit="return valform(this);">
        ...
        <td class="maininnertabletd2">
			<table width="100%"  border="0" cellpadding="4" cellspacing="1" class="">
				...
				<tr>
				  ...
				  <td colspan="2" align="left"><input name="det_code" type="text" id="det_code" value="<?=$_REQUEST['det_code']?>" size="65" />
				...
				<tr>
				  ...
				  <td colspan="2" align="left"><span class="fontblacknormal">
				    <input name="det_caption" type="text" id="det_caption" value="<?=$_REQUEST['det_caption']?>" size="65" />
				...
				<tr>
				  ...
				  <td align="center">:</td>
				  <td colspan="2" align="left"><input name="det_order" type="text" size="2" value="<?php echo $_REQUEST['det_order']?>" /></td>
		      </tr>
				
				<tr>
				  <td align="right">Active</td>
			      <td align="right">:</td>
			      <td colspan="2" align="left"><input name="det_hidden" type="checkbox" id="det_hidden" value="1" <?php echo ($_REQUEST['det_hidden']==0)?'checked="checked"':''?> /></td>
		      </tr>
				<tr>
				...
				<input type="hidden" name="shop_id" id="shop_id" value="<?=$_REQUEST['shop_id']?>" />
                    ...
                    <input type="hidden" name="fpurpose" id="fpurpose" value="insert_AbleToBY" />
                  <input type="Submit" name="AddAbleToBy_submit" id="AddAbleToBy_submit" value="Add" class="input-button"></td>
			  </tr>
				<tr>
