...
<form name='frmAddClient' action='home.php?request=clients' method="post" >
        ...
        <td class="maininnertabletd2">
			<table width="100%"  border="0" cellpadding="4" cellspacing="1" class="">
				...
				<tr>
				  ...
				  <td align="center">:</td>
				  <td align="left"><input name="fname" type="text" id="fname" value="<?=$_REQUEST['fname']?>" size="30">
					  <span class="redtext">*</span></td>
				</tr>
				<tr>
				  <td align="right" class="fontblacknormal">Surname</td>
				  <td align="center">:</td>
				  <td align="left"><input name="surname" type="text" id="surname" value="<?=$_REQUEST['surname']?>" size="30"><span class="redtext">*</span></td>
				</tr>
				<tr>
				  <td align="right" class="fontblacknormal">Company</td>
				  <td align="center">:</td>
				  <td align="left"><input name="company" type="text" id="company" value="<?=$_REQUEST['company']?>" size="30"><span class="redtext">*</span></td>
				</tr>
				<tr>
				  <td align="right" class="fontblacknormal">Address</td>
				  <td align="center">:</td>
				  <td align="left"><textarea name="address" id="address"><?=$_REQUEST['address']?></textarea></td>
				</tr>
				<tr>
				  <td align="right" class="fontblacknormal">Email</td>
				  <td align="center">:</td>
				  <td align="left"><input name="email" type="text" id="email" value="<?=$_REQUEST['email']?>" size="30">
				...
				<tr>
				  ...
				  <td align="center">:</td>
				  <td align="left"><input name="postcode" type="text" id="postcode" value="<?=$_REQUEST['postcode']?>" size="30"></td>
				</tr>
				<tr>
				  <td align="right" class="fontblacknormal">Phone</td>
				  <td align="center">:</td>
				  <td align="left"><input name="phone" type="text" id="phone" value="<?=$_REQUEST['phone']?>" size="30">
				  <span class="redtext">*</span>
				  </td>
				</tr>
				<tr>
				  ...
				  <td align="center">:</td>
				  <td align="left"><input name="fax" type="text" id="fax" value="<?=$_REQUEST['fax']?>" size="30"></td>
				</tr>
				<tr>
