...
$page_type = 'Client';
$help_msg = 'This section helps in adding a new client.';
        ...
        <td class="maininnertabletd2">
			<table width="100%"  border="0" cellpadding="4" cellspacing="1" class="">
				...
				<tr>
				  ...
				  <td align="center">:</td>
				  <td align="left"><input name="client_fname" type="text" id="client_fname" value="<?=$_REQUEST['client_fname']?>" size="30">
					  <span class="redtext">*</span></td>
				</tr>
				<tr>
				  <td align="right" class="fontblacknormal">Last Name </td>
				  <td align="center">:</td>
				  <td align="left"><input name="client_lname" type="text" id="client_lname" value="<?=$_REQUEST['client_lname']?>" size="30"><span class="redtext">*</span></td>
				</tr>
				<tr>
				  <td align="right" class="fontblacknormal">Company</td>
				  <td align="center">:</td>
				  <td align="left"><input name="client_company" type="text" id="client_company" value="<?=$_REQUEST['client_company']?>" size="30"><span class="redtext">*</span></td>
				</tr>
				<tr>
				  <td align="right" class="fontblacknormal">Address</td>
				  <td align="center">:</td>
				  <td align="left"><textarea name="client_address" id="client_address"><?=$_REQUEST['client_address']?></textarea></td>
				</tr>
				<tr>
				  <td align="right" class="fontblacknormal">Email</td>
				  <td align="center">:</td>
				  <td align="left"><input name="client_email" type="text" id="client_email" value="<?=$_REQUEST['client_email']?>" size="30">
				  <span class="redtext">*</span>				  </td>
				</tr>
				<tr>
				 ...
				 /* $sql_country = "SELECT country_id,country_name FROM country ORDER BY country_name ASC";
				  ...
				  echo generateselectbox('country_id',$country_array,$_REQUEST['country_id']);*/
				   echo generateselectbox('cbo_country',$country_arr,$row['country_id'],'','showstate(this.value)');
				  ?>				  </td>
				</tr>
				<tr>
				  <td align="right" class="fontblacknormal">State</td>
				  <td align="center">:</td>
				  <td align="left"><input type="text" name="cbo_state" value="<?=$_REQUEST['cbo_state']?>" id="cbo_state" size="30" /></td>
			  </tr>
				<tr>
				  <td align="right" class="fontblacknormal">Postcode</td>
				  <td align="center">:</td>
				  <td align="left"><input name="client_postcode" type="text" id="client_postcode" value="<?=$_REQUEST['client_postcode']?>" size="30"></td>
				</tr>
				<tr>
				  <td align="right" class="fontblacknormal">Phone</td>
				  <td align="center">:</td>
				  <td align="left"><input name="client_phone" type="text" id="client_phone" value="<?=$_REQUEST['client_phone']?>" size="30">
				  <span class="redtext">*</span>				  </td>
				</tr>
				<tr>
				...
				<tr>
				  ...
				  <td align="center">:</td>
				  <td align="left"><input name="client_fax" type="text" id="client_fax" value="<?=$_REQUEST['client_fax']?>" size="30"></td>
				</tr>
				<tr>
