...
$query_string .='request=seo&fpurpose=AssignKeyword&cbo_keytype='.$keytype.'&cbo_sites='.$cbo_sites;
...
<tr>
        <td valign="middle" class="maininnertabletd1" colspan="<?=$colspan?>" align="left">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td   align="left" valign="middle" class="seperationtd">&nbsp;<strong>Select type</strong>
                <?php
	  ...
	  ?>
              &nbsp;</td>
            <td  colspan="3"  align="left" valign="middle" class="listeditd"><?php if($keytype == 'cat') {?>
                <span>Category Name
			  ...
			  ?>
                  <input name="Search_go" type="button" class="red" id="Search_go" value="Go" onclick="document.frmKeywords.fpurpose.value='search_key_<?=$keytype?>';document.frmKeywords.submit();" />
                  </span>
              <? }elseif($keytype == 'prod'){?>
                <span>Product Name
                  <input name="search_name" type="text" class="textfeild" id="search_name" value="<?php echo $_REQUEST['search_name']?>" />
          ...
          <tr>
            <td width="22%"  align="left" valign="middle" class="listeditd" >&nbsp;Assign Keyword for <?php echo $showtype;?></td>
            <td colspan="3"  valign="middle" class="listeditd" align="center" ><?php if($pages) paging_footer($query_string,$numcount,$pg,$pages,$showtype,2);?></td>
          </tr>
          <?php
				...
				if($db->num_rows($res))
				{
					while ($row = $db->fetch_array($res))
					{
						...
						$sql_prod = "SELECT b.keyword_keyword FROM se_shop_keywords a,se_keywords b 
									WHERE b.sites_site_id=$cbo_sites AND a.product_shopbybrand_shopbrand_id=".$row['shopbrand_id']." AND 
									a.se_keywords_keyword_id=b.keyword_id ORDER BY a.id";
						$ret_prod = $db->query($sql_prod);
						$show_arr = array();
						if ($db->num_rows($ret_prod))
		...
		if($db->num_rows($res))
		{
			while ($row = $db->fetch_array($res))
			{
				...
				$sql_prod = "SELECT b.keyword_keyword FROM se_shelf_keywords a,se_keywords b 
							WHERE b.sites_site_id=$cbo_sites AND a.product_shelf_shelf_id=".$row['shelf_id']." AND 
							a.se_keywords_keyword_id=b.keyword_id ORDER BY a.id";
				$ret_prod = $db->query($sql_prod);
				$show_arr = array();
				if ($db->num_rows($ret_prod))
				...
				if($db->num_rows($res))
				{
					while ($row = $db->fetch_array($res))
					{
						...
						$sql_prod = "SELECT b.keyword_keyword FROM se_combo_keywords a,se_keywords b 
									WHERE b.sites_site_id=$cbo_sites AND a.combo_combo_id=".$row['combo_id']." AND 
									a.se_keywords_keyword_id=b.keyword_id ORDER BY a.id";
						$ret_prod = $db->query($sql_prod);
						$show_arr = array();
						if ($db->num_rows($ret_prod))
	...
	?>
	   ...
	   ?>
                      ...
                      <!--<a href="#" onmouseover ="ddrivetip('<?=$show_curnote?>')"; onmouseout="hideddrivetip()">
                      <!--<a href="#" style="cursor:pointer;" onmouseover="return overlib('<?php //echo $show_curnote?>',300,VAUTO);" onmouseout="return nd();"> 
                        <img src="images/helpicon.gif" width="17" height="13" border="0" /></span></a> -->
                      <?php
	   		}
	   ?></td>
                </tr>
	...
	?>
          <?php
			...
			?>
          <tr>
            <td valign="middle" align="left" colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
            ...
            <td valign="middle" align="left" colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                <tr>
                  <?php
						  ...
						  {
						  ?>
                  <td align="left" valign="top" class="listingtableheader" ><input type="text" name="txthelp_<?php echo $cbo_sites?>_<?php echo $i;?>" value="<?php echo $show_arr[$i]?>" size="20"/></td>
                  <?php
						  }
						  ?>
                </tr>
            ...
            <td valign="middle" align="left" colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                <tr>
                  <?php
						  ...
						  {
						  ?>
                  <td align="left" valign="top" class="listingtableheader" ><input type="text" name="txtregistration_<?php echo $cbo_sites?>_<?php echo $i;?>" value="<?php echo $show_arr[$i]?>" size="20"/></td>
                  <?php
						  }
						  ?>
                </tr>
            ...
            <td valign="middle" align="left" colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                <tr>
                  <?php
						  ...
						  {
						  ?>
                  <td align="left" valign="top" class="listingtableheader" ><input type="text" name="txtsitemap_<?php echo $cbo_sites?>_<?php echo $i;?>" value="<?php echo $show_arr[$i]?>" size="20"/></td>
                  <?php
						  }
						  ?>
                </tr>
            ...
            <td valign="middle" align="left" colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                <tr>
                  <?php
						  ...
						  {
						  ?>
                  <td align="left" valign="top" class="listingtableheader" ><input type="text" name="txtforgotpassword_<?php echo $cbo_sites?>_<?php echo $i;?>" value="<?php echo $show_arr[$i]?>" size="20"/></td>
                  <?php
						  }
						  ?>
                </tr>
            ...
            <td valign="middle" align="left" colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                <tr>
                  <?php
						  ...
						  {
						  ?>
                  <td align="left" valign="top" class="listingtableheader" ><input type="text" name="txtsavedsearchmain_<?php echo $cbo_sites?>_<?php echo $i;?>" value="<?php echo $show_arr[$i]?>" size="20"/></td>
                  <?php
						  }
						  ?>
                </tr>
            ...
            <td valign="middle" align="left" colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                <tr>
                  <?php
						  ...
						  {
						  ?>
                  <td align="left" valign="top" class="listingtableheader" ><input type="text" name="txtsitereviews_<?php echo $cbo_sites?>_<?php echo $i;?>" value="<?php echo $show_arr[$i]?>" size="20"/></td>
                  <?php
						  }
						  ?>
                </tr>
            ...
            <td valign="middle" align="left" colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                <tr>
                  <?php
						  ...
						  {
						  ?>
                  <td align="left" valign="top" class="listingtableheader" ><input type="text" name="txtbestsellers_<?php echo $cbo_sites?>_<?php echo $i;?>" value="<?php echo $show_arr[$i]?>" size="20"/></td>
                  <?php
						  }
						  ?>
                </tr>
	...
	?>
          <tr>
            <?php if($pages) {?>
            <td colspan="4" align="center" valign="middle" class="listeditd" ><? paging_footer($query_string,$numcount,$pg,$pages,$showtype,2); }else{
	  ?></td>
            <? }?>
            <td width="1%" colspan="2" class="listeditd">&nbsp;</td>
          </tr>
          <tr>
            <td valign="middle" align="center" colspan="4">
			<input type="submit" name="catSubmit" value="Save Keywords" class="red" />            </td>
          </tr>
          <tr>
