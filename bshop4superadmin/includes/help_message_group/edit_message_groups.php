<?php
/*#################################################################
# Script Name 	: edit_message_groups.php
# Description 	: Page for editing message groups.
# Coded by 		: LSH
...
$help_msg  = 'This section helps in editing the values for a Message Groups.';

//#Sql
$sql_payment_type 	= "SELECT help_group_id,help_group_name FROM console_help_group WHERE help_group_id=".$_REQUEST['help_group_id'];
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="maininnertable">
      <tr>
        <td align="left" class="menutabletoptd">&nbsp;&nbsp;<a href="home.php?request=help_message_group&help_group_name=<?=$_REQUEST['help_group_name']?>&sort_by=<?=$_REQUEST['sort_by']?>&sort_order=<?=$_REQUEST['sort_order']?>&records_per_page=<?=$_REQUEST['records_per_page']?>&pg=<?=$_REQUEST['pg']?>" title="List Themes">List Message Groups </a> <font size="1">>></font> <strong>Edit <?=$page_type?></strong></td>
      </tr>
      <tr>
        ...
        <td class="maininnertabletd2" valign="top" >
			<table width="100%"  border="0" cellpadding="4" cellspacing="1" class="">
				...
				<tr>
				  ...
				  <td width="55%" align="left"><input name="help_group_name" type="text" id="help_group_name" value="<?=$row['help_group_name']?>" size="30" />
