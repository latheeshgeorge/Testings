...
echo 
    "<link rel=\"shortcut icon\" href=\"".url_head_link("images/".$ecom_hostname."/".$site_images_folder."/favicon.ico",1)."\"/>
     <link href=\"".url_head_link("images/".$ecom_hostname."/".$css_folder."/".$ecom_themename.".css",1)."\" media=\"screen\" type=\"text/css\" rel=\"stylesheet\" />
         ...
         <link href=\"".url_head_link("images/".$ecom_hostname."/".$css_folder."/bootstrap.min.css",1)."\" media=\"screen\" type=\"text/css\" rel=\"stylesheet\" />
     <link href=\"".url_head_link("images/".$ecom_hostname."/".$css_folder."/animate.min.css",1)."\" media=\"screen\" type=\"text/css\" rel=\"stylesheet\" />
         <link href=\"".url_head_link("images/".$ecom_hostname."/".$css_folder."/font-awesome.min.css",1)."\" media=\"screen\" type=\"text/css\" rel=\"stylesheet\" />

     <link href=\"".url_head_link("images/".$ecom_hostname."/".$css_folder."/form-elements.css",1)."\" media=\"screen\" type=\"text/css\" rel=\"stylesheet\" />
     ...
     <script type=\"text/javascript\" src=\"".url_head_link("images/".$ecom_hostname."/".$scripts_folder."/javascript.js",1)."\"></script>
              <script type=\"text/javascript\" src=\"".url_head_link("images/".$ecom_hostname."/".$scripts_folder."/jquery-1.12.0.min.js",1)."\"></script>

         <script type=\"text/javascript\" src=\"".url_head_link("images/".$ecom_hostname."/".$scripts_folder."/modernizr.js",1)."\"></script>
...
";
	...
	{
		echo "<link rel=\"canonical\" href=\"".$ecom_selfhttp.$ecom_hostname."\" />";
	}
	...
	if($_REQUEST['product_id'])
	{
		...
		{
	?>
			<meta property="og:image" content="<?php echo $ecom_selfhttp.$ecom_hostname?>/images/<?php echo $ecom_hostname?>/<?php echo $prodimg_arr[0]['image_extralargepath']?>" /> 
	<?php
		}
	}	
