			...
			<tr>
			   ...
			   <?php 
					...
					<tr  onmouseover="this.className='normalshelf_hover'" onmouseout="this.className='<?=$td_pdt_style_class?>'">
					  ...
					  <h2 class="shelfBprodname"><a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" title="<?php echo stripslash_normal($row_prod['product_name'])?>"><?php echo stripslashes($row_prod['product_name'])?></a></h2>
