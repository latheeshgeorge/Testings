...
if($insmsg)
	...
	<td width="31%" align="left" valign="top" class="usermenucontentA"> 
		<?php echo getorderstatus_Name($row_select_ord['order_status']);
			...
			{
				echo "<br><br><span id='cancelBut'>&nbsp;&nbsp;<div class=\"cart_shop_cont\"><div><input type=\"button\" name=\"cancel\" value=\" Cancel \" class=\"inner_btn_red\" onClick=\"javascript:ord_cancel(document.frm_orderdetail, '$row_select_ord[order_id]')\"></div></div></span>";				
			}	
