						...
						if(count($grp_array))
						{
							...
							<div class="static_lf_top"></div>
								...
								<?php
										...
										?>
								<li>
								<a href="<?php url_link('')?>" class="staticlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_HOME']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_HOME']?></a>
								</li>
								<?
										}
										while ($row_pg = $db->fetch_array($ret_pg))
										...
										?>
								<li>
								<a href="<?php if ($row_pg['page_type']=='Page') url_static_page($row_pg['page_id'],$row_pg['title']); else echo $row_pg['page_link'];?>" class="staticlink" title="<?php echo stripslashes($row_pg['title'])?>" <?php echo $target?>><?php echo stripslashes($row_pg['title']);?></a>
								</li>
								<?php
										}
										...
										?>
								<li>
								<a href="<?php url_link('sitemap.html')?>" class="staticlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_SITEMAP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_SITEMAP']?></a>
								</li>
								<?php		
										}
										if ($grpData['group_showxmlsitemaplink']==1 )
										...
										?>
								<li>
								<a href="<?php url_link('sitemap.xml')?>" class="staticlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP']?></a>
								</li>
								<?php		
										}
										if ($grpData['group_showhelplink']==1)
										...
										?>
								<li>
								<a href="<?php url_link('help.html')?>" class="staticlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_HELP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_HELP']?></a>
								</li>
								<?php		
										}
										if ($grpData['group_showsavedsearchlink']==1)
										...
										?>
								<li>
								<a href="<?php url_link('saved-search.html')?>" class="staticlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH']?></a>
								</li>
								<?php			
										}
										?>
			...
			?>
            	<div class="top_news_con">
                 ...
                 <div class="top_news_con_mid">
					<div class="top_phone"><?php /*?>Info@dincwear<?php */?></div>	<div class="top_social"><a href="http://www.facebook.com/pages/Beverley-Hills-Home/133236643406718" title="Facebook" target="_blank"><img src="<?php url_site_image('soci-top_01.gif')?>"></a> <a href="http://twitter.com/bevhillsathome" title="Twitter" target="_blank"><img src="<?php url_site_image('soci-top_02.gif')?>"></a><?php /*?><img src="<?php url_site_image('soci-top_03.gif')?>"><img src="<?php url_site_image('soci-top_04.gif')?>"><?php */?></div> 
