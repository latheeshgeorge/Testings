...
<div class="women_main">
		...
		galleryActiveClass: "active"
			...
			<div class="row single">
				...
				$price_arr =  show_Price($row_prod,$price_class_arr,'cat_detail_1',false,3);
				//print_r($price_arr);
				if($price_arr['base_price']!='')
				{
                   ?>
					...
					<span id="Rprice"><strike><?php echo $price_arr['base_price'];?></strike></span>
					</li>
					<li class="vip-our-pric">
					<span id="Oprice"><?php echo $price_arr['discounted_price'];?></span>
					</li>
					<li class="vip-off-pric">
					<span id="Ofprice"><?php echo $price_arr['yousave_price'];?></span>
					</li>

					<li class="vip-off-shipp txt-green">
					...
					?>
					<div class="buttons group"><dl class="last">
                ...
                <?php if($mod!=''){ ?>
                <a class="btn add-to-wish" href="#" id="enq<?php echo $row_prod['product_id'] ?>" onclick="responsive_addto_cart_fromlist('add_prod_tocart_ajax','Prod_Enquire','frm_proddetails','<?php echo SITE_URL?>',<?php echo $row_prod['product_id'] ?>)"><i class="icon-heart"></i>Add to enquiry</a>
                <?php
			 }
               if ($Settings_arr['proddet_showwishlist'])
				{
					...
					{
						?>
						<input name="submit_wishlist" type="submit" class="btn add-to-wish" id="submit_wishlist" value="<?php echo $Captions_arr['PROD_DETAILS']['PRODDET_ADDWISHLIST'];?>" onclick="show_wait_button(this,'Please Wait...');document.frm_proddetails.fpurpose.value='Prod_Addwishlist'" />
						<?php
					}
					else
					{
					...
					?>
						<input name="submit_wishlist" type="button" class="btn add-to-wish" id="submit_wishlist" value="<?php echo $Captions_arr['PROD_DETAILS']['PRODDET_ADDWISHLIST'];?>" onclick="<?php echo $wishlist_onclick?>" />
	...
	<div class="col-md-3">    <h2>recently viewed</h2><div class="related-product clearfix">

    <figure><img src="images/home/pro-1.jpg" height="164" width="193"></figure><h5><a href="#">Jacket Suiting Blazer</a></h5><div class="ratings-container"></div><div class="vip-off-pric">$40</div></div>
    
    <div class="related-product clearfix">

    <figure><img src="images/home/pro-1.jpg" height="164" width="193"></figure><h5><a href="#">Jacket Suiting Blazer</a></h5><div class="ratings-container"></div><div class="vip-off-pric">$40</div></div><div class="related-product clearfix">
...
<div class="tabs-7">
	<ul class="tabs">
		...
		<li><a href="#tab2">current offers</a></li>
		<li><a href="#tab-copyright">Best Buy</a></li>
		<li><a href="#tab4">Deals</a></li>
	</ul>
    ...
    <div class="col-sm-3"><div class="product-grid">
							...
							<div class="product-pic">
								<a href="#"><img src="images/home/pro-1.jpg" height="164" width="193"></a>
								<p>
...
<h2>recently viewd products</h2>
              <div id="owl-demo" class="owl-carousel">
                ...
                <div class="item"><div class="product-grid">
							...
							<div class="product-pic">
								<a href="#"><img src="images/home/pro-1.jpg" width="193" height="164"></a>
								<p>
								<a href="#">Tempo Double Robe Hook</a>
