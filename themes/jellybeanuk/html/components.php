		...
		function mod_staticgroup($grp_array,$title)
		{
			...
			switch($position)
			{
				...
				if ($cache_exists==false)
				{
					...
					// ############## Top ##############
					if ($position == 'top121') // Case if value of position is top;
					{
						...
						<div class=" static_con">
							<ul>
								...
								if(count($grp_array))
								{
									...
									?>
										<li>
										<h2> <a href="<?php if ($row_pg['page_type']=='Page') url_static_page($row_pg['page_id'],$row_pg['title']); else echo $row_pg['page_link'];?>" class="static_menu" title="<?php echo stripslash_normal($row_pg['title'])?>" <?php echo $target?>><span><?php echo stripslash_normal($row_pg['title']);?></span></a></h2>
										</li>
									<?php
									}
...
<?php
					...
					else if ($position == 'topband' && $ecom_siteid==87) //$ecom_siteid==87 sumpandpump // Case if value of position is topband;
					{
					  $show_top = $show_bottom = 0;
						?>
						<div class=" static_topband_con">
							<ul>
								<?php
								if(count($grp_array))
								{
									...
									?>
										<li>
										<h2> <a href="<?php url_link('')?>" class="static_topband" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?></span></a></h2>
										</li>
									<?php
									}
									while ($row_pg = $db->fetch_array($ret_pg))
									...
									?>
										<li>
										<h2> <a href="<?php if ($row_pg['page_type']=='Page') url_static_page($row_pg['page_id'],$row_pg['title']); else echo $row_pg['page_link'];?>" class="static_topband" title="<?php echo stripslash_normal($row_pg['title'])?>" <?php echo $target?>><span><?php echo stripslash_normal($row_pg['title']);?></span></a></h2>
										</li>
									<?php
									}
									if ($grpData['group_showxmlsitemaplink']==1 )
									...
									?>
										<li>
										<h2> <a href="<?php url_link('sitemap.xml')?>" class="static_topband" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP'])?></span></a></h2>
										</li>
									<?php	
									}
									if ($grpData['group_showsitemaplink']==1 ) 
									...
									?>
										<li>
										<h2> <a href="<?php url_link('sitemap.html')?>" class="static_topband" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SITEMAP'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SITEMAP'])?></span></a></h2>
										</li>
									<?php		
									}
									if ($grpData['group_showsavedsearchlink']==1)
									...
									?>
										<li>
										<h2> <a href="<?php url_link('saved-search.html')?>" class="static_topband" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH'])?></span></a></h2>
										</li>
									<?php		
									}
									if ($grpData['group_showhelplink']==1 )
									...
									?>
										<li>
										<h2> <a href="<?php url_link('help.html')?>" class="static_topband" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HELP'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HELP'])?></span></a></h2>
										</li>
									<?php
									}
									if ($grpData['group_showfaqlink']==1 )
									...
									?>
										<li>
										<h2> <a href="<?php url_link('faq.html')?>" class="static_topband" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_FAQ'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_FAQ'])?></span></a></h2>
										</li>
									<?php
									}
									}
		...
		function mod_productcatgroup($grp_array,$title)
		{
			...
			switch($position)
			{
				...
				if ($cache_exists==false)
				{
					...
					// ############## Top ##############
						if ($position == 'topband121') // Case if value of position is top;
						{
							if(count($grp_array))
							{
								...
								$sql_cat = "SELECT a.category_id,a.category_name,parent_id,b.category_displaytype,b.category_islink,a.category_subcatlisttype   
									...
									if ($db->num_rows($ret_cat))
									{
										...
										while ($row_cat = $db->fetch_array($ret_cat))
										{
											...
											?>
												<li >
												<h2><a href="<?php url_category($row_cat['category_id'],$row_cat['category_name'],-1)?>" class="catelinkA" title="<?php echo stripslash_normal($row_cat['category_name'])?>"><?php echo ucwords(stripslash_normal($row_cat['category_name']));?></a></h2>
												</li>
											<?php
											}
					...
					<form name="frm_newsletter" method="post" action="" class="frm_cls" onsubmit="return newsletter_validation(this)">
						<div class="newsletter_inner">
						  <div class="newsletter_input">
							<input name="newsletter_email" type="text" class="newsletterinput" id="newsletter_email" size="12" value="Email Id.." onfocus="if(this.value=='EmailId..') this.value ='';" onblur="if(this.value=='') this.value='EmailId..'"; />
						  </div>
						  <?php 
							...
							{	
								...
								elseif($position == 'topband')
								{
									...
									if ($cache_exists==false)
									{
										...
										if ($groupData['shopbrandgroup_id']==72)
										{
											$con_cls = 'shp_brnd_con';
										}
										else
										{
											$con_cls = 'shp_brnd_con_normal';
										}
										$flexiselid = uniqid('shoprow');
										$navid	= 'nav_'.$flexiselid;	
										if($HTML_Content!='')
										{
									?>
									
									<div style="width:800px;margin:auto; z-index:-1">
										
										<ul id="<?php echo $flexiselid;?>" style="display:none"> 
										...
										jQuery.noConflict();
										 jQuery(window).load(function() {
											...
											jQuery("#<?php echo $flexiselid?>").flexisel({
												visibleItems: 5,
												itemsToScroll: 4,
												animationSpeed: 800,
												infinite: false,
		...
		?>
			<tr>
			  <td colspan="3" class="userloginmenuytop" >
				...
				?>
				<li><h2>
                	<a href="<?php echo $logoutUrl; ?>" class="userloginmenuytoplink"><?=$Captions_arr['LOGIN_MENU']['LOGOUT']?></a>
                </h2></li>
				<?php
					}
					else
