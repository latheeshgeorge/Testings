	...
	<tr>
		...
		<td class="login_inner_right">
			...
			<p>
				...
				{
				//echo '* '.stripslash_normal($Captions_arr['CUST_LOGIN']['NEW_CUST_CATLOG_MESG'])?>
				<?
				}
				if($Captions_arr['CUST_LOGIN']['NEW_CUST_ENQ_MESG']!='')
				{
				//echo '* '.stripslash_normal($Captions_arr['CUST_LOGIN']['NEW_CUST_ENQ_MESG'])?>
				<?
				}
				if($Captions_arr['CUST_LOGIN']['NEW_CUST_PAYON_MESG']!='')
				{
			//	echo '* '.stripslash_normal($Captions_arr['CUST_LOGIN']['NEW_CUST_PAYON_MESG'])?>
				<?
				}
				if($Captions_arr['CUST_LOGIN']['NEW_CUST_WISH_MESG']!='')
				{
			//	echo '* '.stripslash_normal($Captions_arr['CUST_LOGIN']['NEW_CUST_WISH_MESG'])?>
				<?
				}
				?>
			</p>
