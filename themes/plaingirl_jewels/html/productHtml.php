<?php
	...
	class product_Html
	{
		...
		function Show_ProductDetails($row_prod)
		{
			...
			{ 
				$HTML_pdf = '<a href="javascript:download_pdf_stream(\''.$_SERVER['HTTP_HOST'].'\',\''.$_SERVER['REQUEST_URI'].'\')" title="'.stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_DOWNLOADPDF']).'">'.stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_DOWNLOADPDF']).'</a>';
			}
...
?>
<div class="releated_pdt_con_otr">
               ...
               <div id="scroller" style="width:<?php echo $div_width?>px">
				...
				$price_arr =  show_Price($row_prod,array(),'prod_detail',false,5);
					if($price_arr['discounted_price'])
						$HTML_price = $price_arr['prince_without_captions']['discounted_price'];
					else
						$HTML_price = $price_arr['prince_without_captions']['base_price'];
				...
				<div class="shlf_a_pdt_r">
					...
					<? /*=$HTML_desc*/ ?>
							<div class="shlf_a_pdt_buy_otr">
								<div class="pdt_list_pdt_price">Price<span>
					<?
...
?>
		...
		<div class="deat_conts_con_download">
