		...
		<form method="post" name="frm_wishlist" class="frm_cls" action="<?php url_link('wishlist.html')?>">
			...
			<div class="reg_shlf_outr">
              ...
              <? 
				 ...
				 <tr>
				<td class="ordertableheader" colspan="3" align="left"><?php echo stripslash_normal($Captions_arr['WISHLIST']['WISHLIST_ITEM'])?> </td>
				<td class="ordertableheader" align="left" colspan="3"><?php echo stripslash_normal($Captions_arr['WISHLIST']['WISHLIST_PRICE'])?> </td>
		  ...
		  <?php
				...
				?>
				  <tr>
				  <td align="left" valign="middle" class="cart_td_delete" width="3%" >
				  <input type="checkbox" name="wishlist_check[]" value="<?=$row_prod_det['product_id']?>" />
					...
					<td align="center" valign="middle" class="cart_td_price" colspan="3" >
					<?php
