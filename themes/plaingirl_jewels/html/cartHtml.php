                                                            ...
                                                            if($proceed_bonus)
                                                            {
                                                                ...
                                                                if($cust_id) // case if logged in
                                                                {
                                                                    ...
                                                                    {  
                                                                        ...
                                                                        ?>
                                                                            <tr>
                                                                            <td colspan="3" class="cart_bonus_tdA">1<?php echo stripslash_normal($Captions_arr['CART']['CART_SPENT_BONUS_POINTS_VALUE'])?> : <span class='cart_bonus_tdD'><? echo print_price($cartData["bonus"]["value"],true);?></span></td>
                                                                            </tr>
                                                                        <?php	
                                                                        }
                                                                        */ 
										  ...
										  $prod_cart_arr =array();
											  ...
											  ?>
												<tr >
													...
													<td align="left" valign="top" class="cart_td_name" colspan="2">
...
*/														}
		...
		<td align="left" valign="top" class="cart_td_name"><a href="<?php echo url_product($row_orddet['products_product_id'],$row_orddet['product_name'])?>" title="<?php echo $row_orddet['product_name']?>" class="shoppingcartprod_link"><?php echo $row_orddet['product_name']?></a></td>
		<td align="left" valign="middle" class="cart_td_qty"><label>
		<?php 
