		...
		{ 
			...
			if (count($shelf_arr))
			{
				...
				{ 
					...
					if ($proceed)
					{
						...
						else
						{
							   ...
							   $shelfData['shelf_currentstyle']= 'listingall_home';
						}
						...
						{ 
							...
							if($shelfData['shelf_currentstyle']=='listingall') // case of normal design layout
							{
				...
				while($row_prod = $db->fetch_array($ret_prod))
				{
					...
					if($_REQUEST['req']=='')
					{
						$price_class_arr['normal_class']        = 'normal_shlfB_pdt_priceA1';
						$price_class_arr['strike_class']        = 'normal_shlfB_pdt_priceB1';
						$price_class_arr['yousave_class']       = 'normal_shlfB_pdt_priceC1';
						$price_class_arr['discount_class']      = 'normal_shlfB_pdt_priceC1';
					}
					else
					{
					 ...
					 /*$price_arr =  show_Price($row_prod,array(),'compshelf',false,5);
				...
				if($row_prod['product_show_pricepromise']==1)
				{
					//if($desc!='')
					{
						  $HTML_promise = '<div class="pdt_list_pricepromise"></div>';
					}
				}
				echo $HTML_promise;
				echo $HTML_new;
				...
				<div class="pdt_list_pdt_buy_otr">
					<div class="pdt_list_pdt_price"><span>
					<?
					...
					<div class="pdt_list_pdt_moreA"><a class="" title="<?php echo stripcslashes(trim($row_prod['product_name']))?>" href="<?php url_product($row_prod['product_id'],$row_prod['product_name'])?>">More Info</a></div>
					<?php
					/*
			   ...
			   $cur_col++;
				...
				?>
						...
						<?php
							...
							elseif($shelfData['shelf_currentstyle']=='listingall_home') // case of shelf to be displayed in inner pages
							{							
										$HTML_comptitle = $HTML_maindesc = $HTML_paging = $HTML_showall = '';
										if($cur_title!='')
										{
						...
						else
						{
							$HTML_rating = '&nbsp;';
                                                ...
                                                //echo $HTML_rating;
												?>
                                                <div class="pdt_list_pdt_r"><?=$HTML_image?>
