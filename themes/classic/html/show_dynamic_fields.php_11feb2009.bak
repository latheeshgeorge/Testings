										...
										if ($db->num_rows($ret_check)!=0)// case of no values
										{
											while ($row_check = $db->fetch_array($ret_check))
											{
												if($no>0)
													echo "<br/>";
								?>
												<input class="regiinput" name="<?php echo $row_elem['element_name']?>[]" id="<?php echo $row_elem['element_name']?>[]" type="checkbox" value="<?php echo stripslashes($row_check['element_values'])?>" <?php if(is_array($_REQUEST[$row_elem['element_name']])){if(in_array($row_check['element_values'],$_REQUEST[$row_elem['element_name']])) {echo "checked";}}?>/>											
												&nbsp;
								<?php			
											...
											{						
												while ($row_check = $db->fetch_array($ret_check))
												{
													if($no>0)
														echo "<br/>";
									?>
													<input class="regiinput" name="<?php echo $row_elem['element_name']?>" id="<?php echo $row_elem['element_name']?>" type="radio" value="<?php echo stripslashes($row_check['element_values'])?>" <?php if($_REQUEST[$row_elem['element_name']]==$row_check['element_values']) {echo "checked";}?>/>											
													&nbsp;
									<?php		
													echo stripslashes($row_check['element_values']);	
													$no++;	
