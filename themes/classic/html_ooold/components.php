...
-->						<?php			
		...
		function mod_customerlogin($title)
		{
			...
			?>
				...
				<tr>
					 <td class="signup_btn"><a href="<?php url_link('registration.html')?>" title="<?php echo stripslash_normal($Captions_arr['CUST_LOGIN']['NEW_USER'])?>">fghgf<img src="<?php url_site_image('signup-btn.gif')?>" /></a></td>
					 <td class="login_btn"><a href="<?php url_link('custlogin.html')?>">fghfgh<img src="<?php url_site_image('login-btn.gif')?>" /></a></td>
				</tr> 
				</table>
			<?php
			}	
		...
		function mod_newsletter($title)
		{
			...
			if($Settings_arr['shownewsletter_as_banner']==1) // Decide whether customer login is to be displayed as banner or in normal style
			{
				...
				<tr>
					<td class="newsletter_banner">
						<a href="<?php url_link('newsletter.html')?>"><img src="<?php url_site_image('neweletter-banner.gif')?>" border="0" />sddsfsdfsd</a>
					</td>
				<tr>
				</table>
				<?php
