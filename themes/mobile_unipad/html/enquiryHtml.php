	   ...
	   ?>
           ...
           <div class="reg_shlf_pdt_con"> 
			...
			?>
			  ...
			  */?> 
			  <tr>
				<td class="regi_txtfeildA" align="left" valign="top" width="19%"><?=stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_DET_FNAME'])?><span class="redtext">*</span></td>
				</tr>
				<tr>
			...
			?>
				<tr>
			<td class="regi_txtfeildAB"  align="center">
			<input name="enquiry_submit" type="submit" class="enquire_submitA" id="enquiry_submit" value="Send" />
			</td>
			</tr>
				</table>
			 </div>
