<?php
	...
	class faq_Html
	{
		...
		function Show_Faq($title,$ret_faq)
		{
			...
			$HTML_treemenu = '<div class="tree_menu_con"><ul class="tree_menu">
								<li><a href="'.url_link('',1).'">'.stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']).'</a>
								</li><li>'.stripslash_normal($Captions_arr['FAQ']['FAQ_HEAD']).'</li></div>';
			echo $HTML_treemenu;	
	?>
	<script>
		   jQuery.noConflict();
