...
<?php
		...
		{
			global $position;
			if($position=='bottomband' or $position == 'right')
			{
				?>
				<div class="callbackcon" align="left"><a href="<?php url_link('callback.html')?>"><img src="<?php url_site_image('requestACallback.jpg')?>" alt="Call Back" title="Call back request" border="0" /></a></div>
				<?php	
			}	
		}
		// ####################################################################################################
