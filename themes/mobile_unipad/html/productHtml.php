...
<tr class="details_expand_cont" style="display:none;" id="<?php echo "tab-".$row_tab['tab_id'];?>-cont">
	...
	if($row_tab['product_common_tabs_common_tab_id']==0)
						...
						$str_search ="<iframe ";
						$str_rpl    = "<iframe width=\"100%\"";
						$tab_cont = str_replace($str_search,$str_rpl,$tab_cont);
	...
	//Faq loading section for product details
		   ...
		   $ret_faq = $db->query($sql_faq);
				if($db->num_rows($ret_faq))
				{
					...
					?>
						<tr class="details_expand_expand" id="faq" onclick="javascript: showTab('faq-cont',this.id);">
	<td>FAQ</td>
</tr>
<tr class="details_expand_cont" style="display:none;" id="faq-cont">
	<td><script>
		   jQuery.noConflict();
            var $j = jQuery; 
  $j(function() {
    $j( "#accordion" ).accordion({
		...
		<a name="top"></a>
		 <div class="inner_contntN" >
        <div class="inner_contnt_topN"></div>
		<div class="inner_contnt_middleN">
			<div id="accordion">
		...
		*/  
			...
			{
		?>	
			<h3 class="faqqstN">Q:&nbsp;<?php echo $v['faq_question']?></h3>
			<div class="faqcontentN">
			<?php 
	...
	?>
		...
		<div class="inner_contnt_bottomN"></div>
		</div> 
		</td>
		</tr>
...
<div class="callwrap">
<ul>
<li class="call_icon"><a href="+44&shy;01524&shy;888880"> +44 1524 888880
 </a></li>
</ul>
</div>
<div class="callwrap1">
