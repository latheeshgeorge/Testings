<?php
	...
	if($bestseller_type == 1) // Case of manual picking
	{
		$sql_best = "SELECT a.product_id,a.product_name,a.product_default_category_id,a.product_webprice,
							...
							a.product_show_cartlink,a.product_show_enquirelink,a.product_preorder_allowed,a.product_webstock,a.product_alloworder_notinstock, 
							a.product_total_preorder_allowed,a.product_variablestock_allowed  			    
	...
	elseif ($bestseller_type == 0) // case of automatic picking
	{
		$sql_best = "SELECT p.product_id,p.product_name,p.product_default_category_id,p.product_webprice,
							...
							p.price_normalprefix,p.price_normalsuffix, p.price_fromprefix, p.price_fromsuffix,p.price_specialofferprefix, p.price_specialoffersuffix, 
							p.price_discountprefix, p.price_discountsuffix, p.price_yousaveprefix, p.price_yousavesuffix,p.price_noprice, 
							p.product_show_cartlink,p.product_show_enquirelink,p.product_preorder_allowed,p.product_webstock,p.product_alloworder_notinstock, 
							p.product_total_preorder_allowed,p.product_variablestock_allowed 	
							$more_conditions 		    
