 ...
 ?>
	...
	<div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >>
	 ...
	 <input type="hidden" name="action_pricepurpose" value="insert_det" />
	              <table border="0" cellpadding="0" cellspacing="0" class="regitable">
					<? if($fetch_arr_admin['pricepromise_topcontent']!='')
					 {
					 ?>
						<?php /*?><tr>
						<td  class="message_header"><?=$Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_TREEMENU_TITLE']?></td></tr><?php */?>
						<tr>
					...
					<?=$Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_THE_PROD_HEAD']?></td>
					</tr>
					<tr>
					...
					<tr>
					<td colspan="2" align="left" class="shoppingcartheader">
					<?=$Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_PRICE_BEAT_HEAD']?></td>
					</tr>
					<tr>
					<td valign="top" align="left"  >
					<table  width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
					...
					?>
						...
						<tr>
						<td align="center">
						<input name="pricepromise_submit" type="submit" class="buttongray" id="Submit" value="<?=$Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_SUBMIT_REQ']?>"/>
						</td>
						</tr>
		...
		function Show_Mypricepromise_requests()
		{
			...
			?>
					...
					<input type="hidden" name="search_click" value="search_click" />
							...
							<div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >>
							 <?=stripslashes($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_DETAILS_HEADER'])?></div>
							</td>
							</tr>
							<tr>
							<td colspan="3">
							...
							<table  border="0" cellpadding="2" cellspacing="3" width="100%" class="userordertablestyleA">
							  <tr>
								<td height="20" colspan="1" align="left" valign="middle" nowrap="nowrap" class="usermenucontent"><?php echo stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICEPROM_PRODNAME'])?></td>
								<td height="20" colspan="3" align="left" valign="middle" nowrap="nowrap" class="usermenucontent"><input name="prm_prodname" id="prm_prodname" type="text"  value="<?php echo $_REQUEST['prm_prodname']?>" /></td>
								<td height="20" align="left" valign="middle" nowrap="nowrap" class="usermenucontent" >&nbsp;</td>
						      </tr>
							  <tr>
							    <td height="20" align="left" valign="middle" nowrap="nowrap" class="usermenucontent"><?php echo stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICEPROM_STATUS'])?></td>
							    <td height="20" colspan="3" align="left" valign="middle" nowrap="nowrap" class="usermenucontent"><?php
							  ...
							  <tr>
								<td height="20" align="left" valign="middle" nowrap="nowrap" class="usermenucontent"><?php echo stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_BETDATE'])?> </td>
								<td height="20" align="left" valign="middle" nowrap="nowrap" class="usermenucontent"><input name="prm_fromdate" class="textfeild" type="text" size="8" value="<?php echo $_REQUEST['prm_fromdate']?>" /> <a href="javascript:show_calendar('frm_promise.prm_fromdate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('calender.png')?>" width="32" height="32" border="0" align="absmiddle" /></a></td>
								<td height="20" align="left" valign="middle" nowrap="nowrap" class="usermenucontent"><?php echo stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICEPROM_AND'])?></td>
								<td height="20" align="left" valign="middle" nowrap="nowrap" class="usermenucontent"><input name="prm_todate" class="textfeild" id="prm_todate" type="text" size="8" value="<?php echo $_REQUEST['prm_todate']?>" />
							    <a href="javascript:show_calendar('frm_promise.prm_todate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('calender.png')?>" width="32" height="32" border="0" align="absmiddle" /></a></td>
								<td height="20" align="left" valign="middle" nowrap="nowrap" class="usermenucontent">&nbsp;</td>
							  </tr>
							  <tr>
								<td width="11%" height="20" align="left" valign="middle" nowrap="nowrap" class="usermenucontent"><?php echo stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_SORTBY'])?></td>
								<td width="6%" height="20" align="left" valign="middle" nowrap="nowrap"><?php echo $sort_option_txt;?></td>
								<td width="5%" height="20" align="left" valign="middle" nowrap="nowrap" class="usermenucontent"><?php echo stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICEPROM_IN'])?></td>
								<td width="11%" height="20" align="left" valign="middle" nowrap="nowrap" class="usermenucontent"><?php echo $sort_by_txt?></td>
								<td width="10%" height="20" align="left" valign="middle" nowrap="nowrap"><div class="cart_shop_cont">
								  <div>
				...
				<tr id="add_post" style="display:none">
					...
					<input type="hidden" name="add_post" id="add_post" value="1" />
						...
						<tr>
							...
							<td align="center">
							<div class="cart_shop_cont"><div>
							<input name="post_go" class="buttongray" id="post_go" value="Save Post" onclick="" type="submit">
							</div></div>
