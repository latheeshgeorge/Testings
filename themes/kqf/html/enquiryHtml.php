				  ...
				  <table width="100%" border="0" cellpadding="0" cellspacing="2" class="shoppingcarttable">
					 ...
					 <tr>
					   <td  colspan="3"><table cellpadding="2" cellspacing="3" width="100%"  class="userordertablestyleA"><tr>
						<td  align="left"  class="usermenucontent" valign="middle" width="18%">Date From</td><td  align="left" class="usermenucontent" valign="middle"  width="16%"> <input class="textfeild" type="text" name="srch_review_startdate" size="8" value="<?=$_REQUEST['srch_review_startdate']?>"  /></td><td width="6%" nowrap="nowrap"><a href="javascript:show_calendar('my_enquire.srch_review_startdate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('calender.png')?>" width="32" height="32" border="0" /></a></td><td  align="left"  class="usermenucontent" valign="middle" width="14%">Date To </td>
						<td  align="left"  class="usermenucontent" valign="top"  nowrap="nowrap" width="16%">  
               				 <input class="textfeild" type="text" name="srch_review_enddate" size="8" value="<?=$_REQUEST['srch_review_enddate']?>"  /></td><td width="" nowrap="nowrap" colspan="2"><a href="javascript:show_calendar('my_enquire.srch_review_enddate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('calender.png')?>" width="32" height="32" border="0" /></a></td></tr>
