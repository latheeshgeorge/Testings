								...
								<?php			
									...
									case 'date': 
						         	?>   
										...
										<a href="javascript:show_calendar('<?PHP echo $formname.'.'.$row_elem['element_name']; ?>');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('calender.png')?>" width="32" height="32" border="0" /></a></span>
							       <?php
									break;
								};
							?>							  </td>
