              ...
              <tr>
                ...
                <table  border="0" cellpadding="2" cellspacing="3" width="100%" class="userordertablestyleA">
                  ...
                  <tr>
                    ...
                    <td width="6%" nowrap="nowrap"><a href="javascript:show_calendar('frm_orders.ord_fromdate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('calender.png')?>" width="32" height="32" border="0" /></a></td>
                    ...
                    <td width="10%" nowrap="nowrap"><a href="javascript:show_calendar('frm_orders.ord_todate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('calender.png')?>" width="32" height="32" border="0" /></a></td>
	...
	<?php
	 ...
	 ?>
	  ...
	  /* ===========================================   ORDER DETAILS ============================= */
	   ...
	   function orderdet_Showform($defalert='')
	  {
...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
  ...
  <?php
	  ...
	  <td align="right" valign="top"><?php echo "<input type=\"button\" name=\"repeat_order\" value=\" Repeat Order \" class=\"buttongray\" onClick=\"javascript:ord_repeat(document.frm_orderdetail, '$row_select_ord[order_id]')\">";?></td>
	  </tr>
  <tr>
...
?>
 ...
 <tr>
  ...
  <?PHP
  			...
  			//added ,order_delivery_date,order_delivery_time in the below query
  	...
  	$sql_ord = "SELECT order_currency_convertionrate,order_currency_symbol,
							...
							order_deliveryprice_only,order_delivery_date,order_delivery_time     
						FROM 
							orders 
						WHERE 
							order_id = '". $_REQUEST['order_id'] ."'
	...
	?>
		...
		<tr>
         ...
         {
			if($row_ord['order_delivery_date']!='0000-00-00')
			{
			?>
					<tr>
						<td align="left" width="25%" class="userordercontentbold">Preferred delivery date</td>
						<td align="left"  class="userordercontent" colspan="3"><?php echo ucwords(strtolower(stripslashes(dateFormat($row_ord['order_delivery_date'],'date'))))?></td>
						
					</tr>
			<?php
			}
			if($row_ord['order_delivery_time']!='')
			{
				$sql_time = "SELECT time FROM delivery_location_time_map WHERE id=".$row_ord['order_delivery_time']." AND sites_site_id=$ecom_siteid LIMIT 1";
			    $ret_time = $db->query($sql_time);
			    $row_time = $db->fetch_array($ret_time);
			?>
					<tr>
						<td align="left" width="25%" class="userordercontentbold">Preferred delivery time</td>
						<td align="left"  class="userordercontent" colspan="3"><?php echo ucwords(strtolower(stripslashes($row_time['time'])))?></td>
