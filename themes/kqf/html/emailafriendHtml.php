...
/*############################################################################
  ...
  <tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="2" class="addproreivewtable">
        <tr>
          ...
          <td width="38%" align="left" valign="middle"><a href="<?php url_product($product_id,$product_name,-1)?>" title="<?php echo stripslashes($product_name)?>">
          <? 
          if(count($img_arr))
          {
			show_image(url_root_image($img_arr[0]['image_thumbpath'],1),$product_name,$product_name);
		  }
		  else
		  {
			...
			if ($no_img)
			{
				show_image($no_img,$product_name,$product_name);
			}
		  }
		  ?></a></td>
        </tr>
  ...
  <tr>
    ...
    <td width="77%" align="left" valign="middle" class="emailfriendtext"><input name="friend_name" type="text" class="addreivewinput" id="friend_name" size="25" value="<?=$_REQUEST['friend_name']?>"
	/></td>
  </tr>
  <tr>
    <td class="emailfriendtext"><?=stripslashes($Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_FRIEND_EMAIL'])?><span class="redtext">*</span> </td>
    <td align="left" valign="middle" class="emailfriendtext"><input name="friend_email" type="text" class="addreivewinput" id="friend_email" size="25" value="<?=$_REQUEST['friend_email']?>" /></td>
  </tr>
  <tr>
    ...
    <td align="left" valign="middle" class="emailfriendtext"><label>
      <input name="customer_name" type="text" class="addreivewinput" id="customer_name" size="25" value="<?=$_REQUEST['customer_name']?>"/>
    </label></td>
  </tr>
  <tr>
    <td class="emailfriendtext"><?=stripslashes($Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_CUSTOMER_EMAIL'])?> <span class="redtext">*</span></td>
    <td align="left" valign="middle" class="emailfriendtext"><input name="customer_email" type="text" class="addreivewinput" id="customer_email" size="25" value="<?=$_REQUEST['customer_email']?>" /></td>
  </tr>
  <tr>
    <td class="emailfriendtext"><?=stripslashes($Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_CUSTOMER_MESSAGE'])?></td>
    <td align="left" valign="middle" class="emailfriendtext"><textarea name="customer_message" cols="25" rows="4" class="addreivewinput" id="customer_message"><?=$_REQUEST['customer_message']?></textarea></td>
  </tr>
