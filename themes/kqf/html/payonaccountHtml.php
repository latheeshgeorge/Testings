<?php
	...
	class payonaccountHtml
	{
 		  ...
 		  <tr>
		       <td valign="top" class="cust_regmiddle_td">
			...
			<?php
				...
				<a href="<?php url_link('registration.html?pagetype=payonacc')?>" class="cust_login_button">Create New Account&nbsp;</a>
				</div>
				 </td>
				</tr>
				  </table>
		  ...
		  <input type="hidden" name="redirect_back" value="1" /> 
			...
			<input name="custpayonacclogin_Submit" type="submit" class="buttonred_cartA" value="Login" onclick="document.javascript:document.frm_custlogin_payonacc.submit();" />
			</td>
	      </tr>
		  <?php
				 ...
				 $where_conditions = " WHERE 
				  ...
				  <tr>
					...
					<td align="middle" valign="middle" class="ordertableheader" ><?php echo $Captions_arr['PAYONACC']['PAYONACC_DATE']?></td>
					 ...
					 <td  align="middle" valign="middle" class="ordertableheader" colspan="3" ><?php echo $Captions_arr['PAYONACC']['AMOUNT']?></td>
				  ...
				  <table width="100%" border="0" cellpadding="3" cellspacing="0" >
					...
					<table  border="0" cellpadding="2" cellspacing="3" width="100%" class="userordertablestyleA">
					  ...
					  <tr>
						...
						<td width="6%" nowrap="nowrap"><a href="javascript:show_calendar('frm_viewbills.limit_from');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('calender.png')?>" width="32" height="32" border="0" /></a></td>
						...
						<td width="10%" nowrap="nowrap"><a href="javascript:show_calendar('frm_viewbills.limit_to');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('calender.png')?>" width="32" height="32" border="0" /></a></td>
