...
/*############################################################################
	...
	class callback_Html
	{
		...
		?>
			...
			<div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?=$Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_TREEMENU_TITLE']?></div>
...
?>
  ...
  <tr>
    ...
    <td width="62%" align="left" valign="middle" class="emailfriendtext"><input name="callback_fname" type="text" class="addreivewinput" id="callback_fname" size="25" value="<?=$_REQUEST['callback_fname']?>"
	/></td>
  </tr>
  <tr>
    <td width="38%" class="emailfriendtext"><?=$Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_LASTNAME']?><br /></td>
    <td width="62%" align="left" valign="middle" class="emailfriendtext"><input name="callback_lname" type="text" class="addreivewinput" id="callback_lname" size="25" value="<?=$_REQUEST['callback_lname']?>"
	/></td>
  </tr>
  <tr>
    <td class="emailfriendtext"><?=$Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_EMAIL']?><span class="redtext">*</span> </td>
    <td align="left" valign="middle" class="emailfriendtext"><input name="callback_email" type="text" class="addreivewinput" id="callback_email" size="25" value="<?=$_REQUEST['callback_email']?>" /></td>
  </tr>
  <?php /*?><tr>
