...
<div class="centerwrap_spcl">
	<?php	// Including the page which decides the display logic for the middle section
		include ("mainbody.php");
?>
</div>
<div class="cust_inerspcl_new">
<?php
if($show_login==true)
{
	...
	{	/*			 
		if ($registrationHtml=="")
		{ 
			require("themes/$ecom_themename/html/registrationHtml.php");
			$registrationHtml= new registration_Html(); // Creating an object for the registration_Html class
		}
	$registrationHtml->Display_Login();
	*/
	?>
	<form name="frm_custlogin" id="frm_custlogin" method="post" action="" onsubmit="return validate_login(this)" class="frm_cls">		
		...
		{
		   $caption  = $Captions_arr['CART']['TRADE'];
		}
		else
		{
		    $caption  = $Captions_arr['CART']['SCHOOL'];
		}
		*/ 
		?>
		<tr>
		<td valign="top" class="cust_regmiddle_td_right_new" colspan="2">
			  <table width="100%" border="0" cellspacing="4" cellpadding="0" class="cust_regmiddle">
        
		  
          <tr>
            <td colspan="2" align="left" valign="middle" class="message_header">&nbsp;<?php echo $Captions_arr['CART']['LOGIN_CUST_SPCL']?></td>
          </tr>
          <tr>
		  ...
		  <tr>
		       <td valign="top" class="cust_regmiddle_td_right_new" colspan="2">
				  <table width="100%" border="0" cellspacing="4" cellpadding="0" class="cust_regmiddle">
			<tr>
				<td  align="left" valign="middle" class="message_header"><?php echo $Captions_arr['CART']['NEW_CUST_SPCL']?></td>
			  </tr>
			    <tr>
				<td  align="left" valign="middle" class="regiconent"><br/><br/><?php //echo $Captions_arr['CART']['NEW_CUST_TOP_MSG_SPCL']?></td>
			  </tr>
				<tr>
				 <td class="regiconent"> 
				 <div class="new-customer" >				
				
				<a href="<?php url_link('registration.html')?>" class="cust_login_button_new"><?php echo $Captions_arr['CART']['NEW_CUST_BUTT_MSG_SPCL']?>&nbsp;</a>
				</div>
				 </td>
				</tr>
				  </table>
...
<div class="bottomcat">
	<?php
		//Showing the top static page groups
		$position = 'bottom';
