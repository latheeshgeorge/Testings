...
/*if($ecom_siteid==70) // www.nationwidefireextinguishers.co.uk
{
?>
...
if($_REQUEST['req']=='')
{
	if($Captions_arr['COMMON']['COOKIE_POLICY']!='')
	{
		...
		{
		  $onload = "onload=\"popup('popUpDiv','')\"";
		 // setcookie('cookie_policy', 'visited'); 
		}
	}
}
...
<!--POPUP-->    
	...
	<div id="popUpDiv" style="display:none;">
    	<a href="javascript:void(0)" onclick="popup('popUpDiv','close')" >Close</a>        
        <div class="popupcontents">			
			<?php echo $Captions_arr['COMMON']['COOKIE_POLICY']?>
			</div>        
	</div>	
