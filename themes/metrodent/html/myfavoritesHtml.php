...
<input type="hidden" name="fpurpose" id="fpurpose" value="" />
		...
		<li><?=stripslash_normal($Captions_arr['MY_FAVORITES']['FAVORITES_TREEMENU_TITLE'])?></li>
		</ul>
		</div>
		<div class="inner_header"><?=stripslash_normal($Captions_arr['MY_FAVORITES']['FAVORITES_TREEMENU_TITLE'])?></div>
		<div class="inner_con" >
		<div class="inner_top"></div>
		<div class="inner_middle_cart">	
		<table width="100%" border="0" cellpadding="0" cellspacing="4"  >
		<tr>
		<td colspan="3" class="prod_orderheader"><?=stripslash_normal($Captions_arr['MY_FAVORITES']['FAVORITES_CATEGORY_HEADING'])?></td>
		</tr>
		<tr><td colspan="3">
		...
		<td width="19%" align="left" valign="middle" class="favcontent"><a  class="favorite_linkdelete" href="remove-favorite-category-<?=$fav_categories['id']?>.html" onclick="if(confirm('<?=stripslash_javascript($Captions_arr['MY_FAVORITES']['CATEGORY_REM_MSG'])?>'))return true;else return false;" ><img src="<?php url_site_image('delete.gif')?>" alt="Delete" title="Delete" /> </a></td>
		</tr>
		<? } 
		}
		else{ ?>
		...
		<tr>
			<td colspan="3" class="prod_orderheader"><?=stripslash_normal($Captions_arr['MY_FAVORITES']['FAVORITES_PRODUCTS_HEADING'])?></td>
		</tr>
		...
		<tr class="edithreflink_tronmouse" title="View Details" onmouseover="this.className='edithreflink_trmouseout'" onmouseout="this.className='edithreflink_tronmouse'">
			...
			<td width="19%" align="left" valign="middle" class="favcontent"><a href="remove-favorite-product-<?=$fav_products['id']?>.html" class="favorite_linkdelete" onclick="if(confirm('<?=stripslash_javascript($Captions_arr['MY_FAVORITES']['PRODUCT_REM_MSG'])?>'))return true;else return false;" ><img src="<?php url_site_image('delete.gif')?>" alt="Delete" title="Delete" /></a></td>
		</tr>
