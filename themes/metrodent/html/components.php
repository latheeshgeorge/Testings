<?php
	...
	class components
	{
				...
				if ($cache_exists==false)
				{
						...
						if(count($grp_array))
						{
							...
							foreach ($grp_array as $k=>$grpData)
							{
								...
								$cnt = $db->num_rows($ret_pg);
									...
									{
					?>		
										<li><h2> <a href="<?php url_link('help.html')?>" class="sta_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HELP'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HELP'])?></span></a></h2></li>
					<?php
									}
									if ($grpData['group_showfaqlink']==1 )
									{
					?>		
										<li><h2> <a href="<?php url_link('faq.html')?>" class="sta_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_FAQ'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_FAQ'])?></span></a></h2></li>
					<?php
									}
									if ($grpData['group_showxmlsitemaplink']==1 )
									{
									?>
										<li><h2> <a href="<?php url_link('sitemap.xml')?>" class="sta_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP'])?></span></a></h2></li>
									<?php	
									}
									...
									{
					?>							
										<li><h2> <a href="<?php url_link('sitemap.html')?>" class="sta_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SITEMAP'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SITEMAP'])?></span></a></h2></li>
					<?php		
									}
									if ($grpData['group_showsavedsearchlink']==1)
									{
					?>							
										<li><h2> <a href="<?php url_link('saved-search.html')?>" class="sta_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH'])?></span></a></h2></li>
					<?php		
									}
								...
								?>
										<li><h2> <a href="<?php if ($row_pg['page_type']=='Page') url_static_page($row_pg['page_id'],$row_pg['title']); else echo $row_pg['page_link'];?>" class="sta_menu" title="<?php echo stripslash_normal($row_pg['title'])?>" <?php echo $target?>><span><?php echo stripslash_normal($row_pg['title']);?></span></a></h2></li>
								<?php
								}
						...
						?>
									<li><h2> <a href="<?php url_link('')?>" class="sta_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?></span></a></h2></li>
						<?php
								}
						}		
						?>			
					...
					if ($position == 'bottom') // Case if value of position is bottom;
					{
						...
						<?php
							...
							foreach ($grp_array as $k=>$grpData)
							{
								...
								if($show_top==0)
								{
									...
									{
						?>
										<li><h3><a href="<?php url_link('')?>" class="bottomlink" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?></a></h3></li>
						<?php			
									}
										$show_top = 0;
								}	
								...
								while ($row_pg = $db->fetch_array($ret_pg))
								{
									$target = ($row_pg['page_link_newwindow']==1 and $row_pg['page_type']!='Page')?'target="_blank"':'';
								?>
										<li><h3><a href="<?php if ($row_pg['page_type']=='Page') url_static_page($row_pg['page_id'],$row_pg['title']); else echo $row_pg['page_link'];?>" class="bottomlink" title="<?php echo stripslash_normal($row_pg['title'])?>" <?php echo $target?>><?php echo stripslash_normal($row_pg['title']);?></a></h3></li>
								<?php
								}
							}
						?>
						<?php			
									...
									{
						?>
										<li><h3><a href="<?php url_link('sitemap.html')?>" class="bottomlink" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SITEMAP'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SITEMAP'])?></a></h3></li>
						<?php			
									}
									if ($grpData['group_showxmlsitemaplink']==1 )
									{			
									?>
										<li><h3><a href="<?php url_link('sitemap.xml')?>" class="bottomlink" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP'])?></a></h3></li>
									<?php									
									}
									if ($grpData['group_showfaqlink']==1)
									{
						?>
										<li><h3><a href="<?php url_link('faq.html')?>" class="bottomlink" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_FAQ'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_FAQ'])?></a></h3></li>
						<?php			
									}
									if ($grpData['group_showhelplink']==1)
									{
						?>
										<li><h3><a href="<?php url_link('help.html')?>" class="bottomlink" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HELP'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HELP'])?></a></h3></li>
						<?php			
									}
									if ($grpData['group_showsavedsearchlink']==1)
									{
						?>
										<li><h3><a href="<?php url_link('saved-search.html')?>" class="bottomlink" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH'])?></a></h3></li>
						<?php			
									}
						?>			
							</ul>
					...
					if ($position == 'left' or $position == 'right') // Case if value of position in left or right;
					{
						if(count($grp_array))
						{
						?>
							<div class="prodlist_menu_lf">
							<div class="prodlist_menu_lf_top"></div>
							<div class="prodlist_menu_lf_middle">
						...
						?>
										...
										<li class="catprod_prodes"><a href="<?php url_link('')?>" class="catprod_prodlink" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?></a>
										</li>
										</ul>
						<?php			
									}
								...
								?>
										<ul class="catprod_prod">  
										<li class="catprod_prodes">
										<a href="<?php if ($row_pg['page_type']=='Page') url_static_page($row_pg['page_id'],$row_pg['title']); else echo $row_pg['page_link'];?>" class="catprod_prodlink" title="<?php echo stripslash_normal($row_pg['title'])?>" <?php echo $target?>><?php echo stripslash_normal($row_pg['title']);?></a>
										</li>
										</ul>
								<?php
								}
						...
						?>
										<ul class="catprod_prod">  
										<li class="catprod_prodes"><a href="<?php url_link('sitemap.html')?>" class="catprod_prodlink" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SITEMAP'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SITEMAP'])?></a>
										</li>
										</ul>
						<?php			
									}
									...
									?>
										<ul class="catprod_prod">  
										<li class="catprod_prodes"><a href="<?php url_link('sitemap.xml')?>" class="catprod_prodlink" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP'])?></a>
										</li>
										</ul>
									<?php									
									}
						...
						?>
										<ul class="catprod_prod">  
										<li class="catprod_prodes"><a href="<?php url_link('faq.html')?>" class="catprod_prodlink" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_FAQ'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_FAQ'])?></a>
										</li>
										</ul>
						<?php			
									}
						...
						?>
										<ul class="catprod_prod">  
										<li class="catprod_prodes"><a href="<?php url_link('help.html')?>" class="catprod_prodlink" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HELP'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HELP'])?></a>
										</li>
										</ul>
						<?php			
									}
						...
						?>
										<ul class="catprod_prod">  
										<li class="catprod_prodes"><a href="<?php url_link('saved-search.html')?>" class="bottomlink" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH'])?></a>
										</li>
										</ul>
						<?php			
									}
						?>	
							...
							<div class="prodlist_menu_lf_bottom"></div>
							</div>
						<?php	
						}
					}// End of bottom
					if ($position=='seo-section')
					{ return;
						if(count($grp_array))
						{
							//Iterating through the group array to fetch the pages to be shown.
					...
					?>
					  <div class="general_links_table_outer">
						<div class="general_links_table">
	                        <?php 
	                        if($prev_grp != $grpData['group_id'])
							{
								...
								{
							?>	
		  						<div class="general_links_hdr"><?php echo stripslashes($title)?></div>
		  					<?php
								}
								...
								foreach ($grp_array as $k=>$grpData)
								{
									...
									if ($db->num_rows($ret_cat))
									{
										...
										?>
											...
											<div class="toparea_cat_menu">
												<ul>
												<?php
													while ($row_cat = $db->fetch_array($ret_cat))
													{
														?>
														<li><h2><a href="<?php url_category($row_cat['category_id'],$row_cat['category_name'],-1)?>" class="cat_menu" title="<?php echo stripslash_normal($row_cat['category_name'])?>"><span><?php echo ucwords(stripslash_normal($row_cat['category_name']));?></span></a></h2></li>
														<?
													}
												?>
												</ul>
									...
									if ($db->num_rows($ret_cat))
									{
										...
										<?php
											while ($row_cat = $db->fetch_array($ret_cat))
											{
												$startpnt++;
										?>
														<li><h3><a href="<?php url_category($row_cat['category_id'],$row_cat['category_name'],-1)?>" class="bottomlink" title="<?php echo stripslash_normal($row_cat['category_name'])?>"><?php echo ucwords(stripslash_normal($row_cat['category_name']));?></a></h3></li>
										<?php
											}
										?>
											</ul>
												...
												<div class="lf_catgry_middle">
													...
													while ($row_cat = $db->fetch_array($ret_cat))
													{
														if($prev_grp != $grpData['catgroup_id'])
														{
															...
															{
													?>
																<div class="categoryheader"><?php echo stripslash_normal($title)?></div>
													<?php
															}
													...
													{
													?>
														 <li><h2><a href="<?php url_category($row_cat['category_id'],$row_cat['category_name'],-1)?>" class="catelink" title="<?php echo stripslash_normal($row_cat['category_name'])?>"><?php echo ucwords(stripslash_normal($row_cat['category_name']));?></a></h2></li>
													<?php
													}
													elseif($row_cat['category_displaytype']=='Normal' && !$row_cat['category_islink'])
													{
													?>
														 <li><h2><?php echo stripslash_normal($row_cat['category_name']);?></h2></li>
													<?											
													}
													elseif($row_cat['category_displaytype']=='Heading' && $row_cat['category_islink'])
													{
													?>
														 <li><h2><span class="subcategoryheader"><span><a href="<?php url_category($row_cat['category_id'],$row_cat['category_name'],-1)?>" class="subcategoryheaderlink" title="<?php echo stripslash_normal($row_cat['category_name'])?>"><?php echo ucwords(stripslash_normal($row_cat['category_name']));?></a></span></span></h2></li>
													<?
													}
													elseif($row_cat['category_displaytype']=='Heading' && !$row_cat['category_islink'])
													{
													?>
														 <li><h2><span class="subcategoryheaderAB"><span><?php echo ucwords(stripslash_normal($row_cat['category_name']));?></span></span></h2></li>
													<?
													}
														...
														if ($row_cat['category_subcatlisttype']=='List' or $row_cat['category_subcatlisttype']=='Both')
														{
															...
															{	
																...
																if ($db->num_rows($ret_child))
																{
																	...
																	{
																?>
																			<li><h2><a href="<?php url_category($row_child['category_id'],$row_child['category_name'],-1)?>" title="<?php echo stripslash_normal($row_child['category_name'])?>" class="subcatelink"><?php echo ucwords(stripslash_normal($row_child['category_name']));?></a></h2></li>
																<?php		
																	}
																}
															}
		...
		function mod_quicksearch($title)
		{
			...
			if ($position=='left' || $position=='right') // show only if position value is top
			{
				$cart_tot = print_price(get_session_var('cart_total'),true);
				$pass_tot = print_price(get_session_var('cart_total'),true,true);	
			?>	
			
			<div class="cart_conlf">
				<div class="cart_middlelf">
				 <div class="cart_hdrlf"><?php echo $title?></div>
				  <div class="cart_itemlf"><?php echo stripslash_normal($Captions_arr['COMMON']['CART_TOTAL'])?> <?php echo $cart_tot?></div>
				  <div class="cart_itemlf"><?php echo stripslash_normal($Captions_arr['COMMON']['ITEMS_IN_CART'])?><?php echo  (get_session_var('cart_total_items'))?get_session_var('cart_total_items'):0?></div>
				  <div class="cart_btnlf"><a href="javascript:handle_checkout_submit('<?php echo $ecom_hostname?>',0,'<?php echo $pass_tot?>')" class="cart_linklf"  title="<?php echo stripslash_normal($Captions_arr['COMMON']['CHECK_OUT'])?>"><span><?php echo stripslash_normal($Captions_arr['COMMON']['CHECK_OUT'])?></span></a>
				  <a href="javascript:gobackto_cart('<?php echo ($protectedUrl)?base64_encode($ecom_hostname):$ecom_hostname?>')" class="cart_linklfa" title="<?php echo stripslash_normal($Captions_arr['COMMON']['VIEW_CART'])?>"><span><?php echo stripslash_normal($Captions_arr['COMMON']['VIEW_CART'])?></span></a>
				</div>
			</div>
			<?php
			}
		...
		function mod_customerlogin($title)
		{
			...
			{
			?>	   <div class="login_btnlf">
					 <a class="login_linklf" href="<?php url_link('custlogin.html')?>"><span><?php echo stripslash_normal($Captions_arr['CUST_LOGIN']['LOGIN'])?></span></a>
				   					 <a class="login_linklfa" href="<?php url_link('registration.html')?>" title="<?php echo stripslash_normal($Captions_arr['CUST_LOGIN']['NEW_USER'])?>"><span><?php echo stripslash_normal($Captions_arr['CUST_LOGIN']['NEW_USER'])?></span></a>
					 ...
					 <table class="logintable" border="0" cellpadding="0" cellspacing="0">
						...
						<?php   
							...
							<tr>
								...
								<td class="logintablecontentright" align="right" valign="top">
								<input name="custlogin_uname" class="inputA" id="custlogin_uname" size="15" type="text" /></td>
							</tr>
							<tr>
								<td class="logintablecontent"><?php echo stripslash_normal($Captions_arr['CUST_LOGIN']['PASSWORD'])?> </td>
								<td class="logintablecontentright" align="right" valign="top">
								<input name="custlogin_pass" class="inputA" id="custlogin_pass" size="15" type="password"></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
		...
		<?php	
			...
			?>
			<div class="user_menu_lf">
			 <div class="user_menu_lf_top"></div>
			  <div class="user_menu_lf_middle">
				<ul class="userloginmenu"> 
						<li><h2><a href="<?php url_link('login_home.html')?>" class="userloginmenulink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['MY_HOME'])?></a></h2></li>
						<li><h2><a href="<?php url_link('myprofile.html')?>" class="userloginmenulink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['MY_PROFILE'])?></a></h2></li>
						<?php /*?><li><h2><a href="<?php url_link('myenquiries.html')?>" class="userloginmenulink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['MY_ENQUIRIES'])?></a></h2></li><?php */?>
						<?php /*?><li><h2><a href="<?php url_link('wishlist.html')?>" class="userloginmenulink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['MY_WISHLIST'])?></a></h2></li><?php */?>
					<?php	
						$myfav_module = 'mod_myfavorites';
						/*if(in_array($myfav_module,$inlineSiteComponents)){
					?>
						<li><h2><a href="<?php url_link('myfavorites.html')?>" class="userloginmenulink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['MY_FAVOURITE'])?></a></h2></li>
					<? }	*/
						$myaddr_module = 'mod_myaddressbook';
						/*if(in_array($myaddr_module,$inlineSiteComponents)){
					?>
						<li><h2><a href="<?php url_link('myaddressbook.html')?>" class="userloginmenulink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['MY_ADDRESSBOOK'])?></a></h2></li>
					<? }*/?>
						<li><h2><a href="<?php url_link('myorders.html')?>" class="userloginmenulink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['MY_ORDERS'])?></a></h2></li>
					<?php
						...
						{
					?>	
							<li><h2><a href="<?php url_link('mydownloads.html')?>" class="userloginmenulink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['MY_DOWNLOADS'])?></a></h2></li>
					<?php
						}
					...
					?>	
							<li><h2><a href="<?php url_link('mypayonaccountpayment.html')?>" class="userloginmenulink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['MY_PAYONACCDETAILS'])?></a></h2></li>
					<?php
						}
					?>	
						<?php /*?><li><h2><a href="<?php url_link('mypricepromise.html')?>" class="userloginmenulink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['MY_PRICE_PROMISE'])?></a></h2></li><?php */?>
						<li><h2><a href="<?php url_link('logout.html')?>" class="userloginmenulink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['LOGOUT'])?></a></h2></li>
					</ul> 
			   </div>
			 <div class="user_menu_lf_bottom"></div>
			</div>
			<?	
			}	
		}
			...
			{	
				...
				?>
						<div class="bestsellers">
							<div class="bestsellers_top"></div>
								<div class="bestsellers_middle">
									<?php
									if($title) // check whether title exists
									{
										?>
										<div class="bestsellers_hdr"><?php echo $title?></div>
										<?php
									}
									while ($row_main = $db->fetch_array($ret_main))
									{
										?>	
										<div class="bestseller_pdt">
										<div class="bestsellers_buy"><a href="<?php url_product($row_main['product_id'],$row_main['product_name'],-1)?>" title="<?php echo stripslash_normal($row_main['product_name'])?>" class="best_comp_name_link"><?php echo stripslash_normal($Captions_arr['COMMON']['COMMON_BUY_NOW'])?></a></div>
												
												 <div class="bestseller_pdt_top"></div>
										<div class="bestseller_pdt_middle">
											<div class="bestseller_name"><a href="<?php url_product($row_main['product_id'],$row_main['product_name'],-1)?>" title="<?php echo stripslash_normal($row_main['product_name'])?>" class="best_comp_name_link"><?php echo stripslash_normal($row_main['product_name'])?></a>
										   </div>
										 ...
										 <div class="bestseller_pdt_bottom"></div>
										</div>
										
									<? }?>
								<div class="bestseller_show"><a href="<? url_link('bestsellers'.$display_id.'.html')?>" class="bestseller_showall" title="<?php echo stripslash_normal($Captions_arr['COMMON']['SHOW_ALL'])?>"><?php echo stripslash_normal($Captions_arr['COMMON']['SHOW_ALL'])?></a></div>
								</div>
							<div class="bestsellers_bottom"></div>
						  </div>
				...
				?>
								<div class="compare_div">
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="0" class="compare_table">
										...
										<tr>
											<td width="26" class="compare_table_td"><img src="<?php url_site_image('comp-icn.gif')?>" onclick="document.common_compare_list.remove_compareid.value=<?=$row_compare_pdts['product_id']?>; if(confirm('Are You sure You want to remove the product from the compare list')){ document.common_compare_list.submit()};" alt="Remove" title="Remove" /></td>
											<td width="168" class="compare_table_td">
											<a href="<?php url_product($row_compare_pdts['product_id'],$row_compare_pdts['product_name'],-1)?>" class="comparelink" title="<?php echo stripslash_normal($row_compare_pdts['product_name'])?>"><?php echo stripslash_normal($row_compare_pdts['product_name'])?></a>
											</td>
										</tr>				
			...
			if ($position=='left' or $position =='right')// Combo deal is allowed only in left or right panel
			{
				...
				{	
						...
						?>
									...
									{
									?>	
										<div class="lf_combodeal_hdr"><? echo $title?></div>
									<?php
									}
									?> 
									<?php
									...
									while ($row_prod = $db->fetch_array($ret_prod))
									{
									    ...
									    <a href="<?php url_combo($combData['combo_id'],$combData['combo_name'],-1)?>" title="<?php echo stripslash_normal($Captions_arr['COMMON']['SHOW_DEAL'])?>">
									   <?php
									...
									<a href="<?php url_combo($combData['combo_id'],$combData['combo_name'],-1)?>" class="lf-combodeal-showall" title="<?php echo stripslash_normal($Captions_arr['COMMON']['SHOW_DEAL'])?>"><?php echo stripslash_normal($Captions_arr['COMMON']['SHOW_DEAL'])?></a>
									</div> 
						...
						if ($db->num_rows($ret_prod))
						{
							if($shelfData['shelf_currentstyle']=='nor') // case of normal design layout
							{
								switch($shelfData['shelf_displaytype'])
								{
									...
									?>
									<div class="normal_shlf">
										<div class="normal_shlf_top"></div>
										<?php
										if ($title)
										{
										?>	
											<div class="normal_shlf_hdr"><?php  echo $title?></div>
										<? 
										}
										?>
										<div class="normal_shlf_middle">
										<?php
										while($row_prod = $db->fetch_array($ret_prod))
										{
											?>
											<div class="normal_shlf_pdt">
											<?php
											if($shelfData['shelf_showtitle']==1)// whether title is to be displayed
											{
											?>
												<div class="normal_shlf_name"><a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" class="normal_lf_link" title="<?php echo stripslash_normal($row_prod['product_name'])?>"><?php echo stripslash_normal($row_prod['product_name'])?></a></div>
											<? 
											}
											if($shelfData['shelf_showimage']==1) // whether image is to be displayed
											{
											?>
											<div class="normal_shlf_image">
											...
											{
											?>
											<div class="normal_shlf_price">
											<?php
												$price_class_arr['class_type'] ='div';
												$price_class_arr['normal_class'] 	= 'normal_shlf_normalprice';
												$price_class_arr['strike_class'] 	= 'normal_shlf_strikeprice';
												$price_class_arr['yousave_class'] 	= 'normal_shlf_yousaveprice';
												$price_class_arr['discount_class'] 	= 'normal_shlf_discountprice';
										...
										?>
											<div class="normal_shlf_show"><a href="<?php  url_shelf_all($shelfData['shelf_id'],$shelfData['shelf_name'],-1)?>" class="normal_shlf_showall" title="<?php echo stripslash_normal($Captions_arr['COMMON']['SHOW_ALL'])?>"><?php echo stripslash_normal($Captions_arr['COMMON']['SHOW_ALL'])?></a></div>
											</div>
										<div class="normal_shlf_bottom"></div>
								    </div>
									<?php	
									break;
								};	
							}	
							elseif($shelfData['shelf_currentstyle']=='special1') // case of christmas layout
							{
								switch($shelfData['shelf_displaytype'])
								{
								case '1row': // case of one in a row
								case '2row':
									?>
									<div class="spl_shlf">
									<div class="spl_shlf_top"></div>
									<div class="spl_shlf_middle">
									<?php
									if ($title)
									{
									?>
									<div class="spl_shlf_hdr"><?php echo $title?></div>
									<? }
									while($row_prod = $db->fetch_array($ret_prod))
									{
									?>
									<div class="spl_shlf_pdt">
										<div class="spl_shlf_buy"><a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" class="normal_name_link" title="<?php echo stripslash_normal($row_prod['product_name'])?>"><?php echo stripslash_normal($Captions_arr['COMMON']['COMMON_BUY_NOW'])?></a></div>
										<div class="spl_shlf_pdt_top"></div>
										<div class="spl_shlf_pdt_middle">
										<?php
										if($shelfData['shelf_showimage']==1) // whether image is to be displayed
											{
											?>
										<div class="spl_shlf_image">
										<div class="normal_pdt_img">
										<a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" title="<?php echo stripslash_normal($row_prod['product_name'])?>">
														<?php
															// Calling the function to get the type of image to shown for current 
															$pass_type = 'image_iconpath';
										...
										<? }
										?>
										<div class="spl_shlf_price">	<?php $price_arr =  show_Price($row_prod,array(),'compshelf',false,3);
										if($price_arr['discounted_price'])
										echo $price_arr['discounted_price'];
										else
										echo $price_arr['base_price'];
										...
										{
										?>
											<div class="spl_shlf_name"><a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>"  title="<?php echo stripslash_normal($row_prod['product_name'])?>"><?php echo stripslash_normal($row_prod['product_name'])?></a></div>
										<? 
										}
										?>
										</div>
										<div class="spl_shlf_pdt_bottom"></div>
										</div>	
									<? }?>
									<div class="spl_shlf_show"><a href="<?php  url_shelf_all($shelfData['shelf_id'],$shelfData['shelf_name'],-1)?>" class="spl_shlf_showall" title="<?php echo stripslash_normal($Captions_arr['COMMON']['SHOW_ALL'])?>"><?php echo stripslash_normal($Captions_arr['COMMON']['SHOW_ALL'])?></a></div>	
									</div>
									<div class="spl_shlf_bottom"></div>
									</div>
									<?php	
								break;
        ...
        <table class="rt_newslettertable" border="0" cellpadding="0" cellspacing="0">
						...
						?>	
						  <tr>
								<td class="rt_newslettertd"><?php echo stripslash_normal($Captions_arr['NEWS_LETTER']['TITLE'])?></td>
							<td align="left" valign="top" class="rt_newslettertd">
						...
						?>
						<tr>
							<td class="rt_newslettertd"><?php echo stripslash_normal($Captions_arr['NEWS_LETTER']['NAME'])?></td>
							<td align="left" valign="top" class="rt_newslettertd">
						...
						?>		 
						<tr>
							<td class="rt_newslettertd"><?php echo stripslash_normal($Captions_arr['NEWS_LETTER']['EMAIL'])?></td>
							<td align="left" valign="top" class="rt_newslettertd">
						...
						?>
						<tr>
							<td class="rt_newslettertd"><?php echo stripslash_normal($Captions_arr['NEWS_LETTER']['PHONE'])?></td>
							<td align="left" valign="top" class="rt_newslettertd">
						...
						?>
							<tr>
								<td colspan="2" valign="top" class="rt_newslettertd"><?php echo stripslash_normal($Captions_arr['NEWS_LETTER']['GROUP'])?></td>
							</tr>
							<tr>
								<td colspan="2" align="left" valign="top" class="rt_newslettertd">
							<?php
							if (count($cust_group_arr))
							{ 
								echo generateselectbox('newsletter_group[]',$cust_group_arr,0,'','',5,'rt_newsletterinput',false,'sel_newsletter_group');
							}	
							?>				</td>
							</tr>
						<?php
						...
						?>
						  <tr>
							<td align="left" colspan="2" class="rt_newslettertd"><?=stripslash_normal($Captions_arr['NEWS_LETTER']['ENTER_CODE'])?>&nbsp;<span class="redtext">*</span></td>
						  </tr>
						  <tr>
							 <td align="left" valign="middle" colspan="2" class="rt_newslettertd"><img src="<?php url_verification_image('includes/vimg.php?size=4&pass_vname=newsletter_Vimg&amp;bg=143 186 2')?>" border="0" alt="Image Verification"/></td>
						  </tr>
						  <tr>
							<td  colspan="2" align="left" class="rt_newslettertd">
							  <?php 
					  ...
					  <?php
						...
						?>
						<tr>
						<td class="rt_newslettertd" align="left" colspan="2" >
							<input name="newsletter_Submit" type="submit" class="nws_btn" id="newsletter_Submit" value="<?php echo stripslash_normal($Captions_arr['NEWS_LETTER']['SUBSCRIBE'])?>" />				</td>
						</tr>
						<tr>
		...
		?>
			 ...
			 <?php
				...
				?>
						...
						<div class="sry_stas">
							<div class="sry_top"></div>
							<div class="sry_middle">
							 <table class="surveytable" width="100%" border="0" cellpadding="2" cellspacing="0">
							  <tbody>
							<?php	
								if($title)
								{
							...
							?>		
								  <tr>
									<td colspan="2" align="left" valign="top" class="surveytablequst"><?php echo stripslash_normal($surveyData['survey_question'])?></td>
								  </tr>
							<?php
							...
							?>
									  <tr>
										...
										<td align="left" valign="middle" class="surveytabletd"><?php echo stripslash_normal($row_surveyopt['option_text']);?></td>
									  </tr>
							<?php
									}
								}
							...
							<input name="survey_Submit" type="submit" class="sry_btn" value="<?php echo stripslash_normal($Captions_arr['SURVEY']['VOTE'])?>" /></td>
							</tr>
						   </tbody></table>
							</div>
							<div class="sry_bottom"></div>
						</div>
				   </form>
			 <?php
			 		}
			...
			if(count($grp_array))
			{
				...
				foreach ($grp_array as $k=>$groupData)
				{
					...
					if($cache_exists!=true)
					{
						...
						{
							if ($position == 'left1' or $position == 'right1') // ############## Left ##############
							{ 
							// Check the listing type for shop in product shop group
									...
									?>
											<div class="shop_brand">
												<div class="shop_brand_top"></div>
													<div class="shop_brand_middle">
														...
														<?php
															while ($row_shop = $db->fetch_array($ret_shop))
															{
																...
																if($prev_grp != $groupData['shopbrandgroup_id'])
																{
																	...
																	{
															?>
																		<li class="categoryheader"><?php echo stripslash_normal($title)?></li>
															<?php
																	}
																		$prev_grp = $groupData['shopbrandgroup_id'];
																}
															?>
																 <li><h2><a href="<?php url_shops($row_shop['shopbrand_id'],$row_shop['shopbrand_name'],-1)?>" class="shop_brand_link" title="<?php echo stripslash_normal($row_shop['shopbrand_name'])?>"><?php echo stripslash_normal($row_shop['shopbrand_name']);?></a></h2></li>
															<?php
																	...
																	if (($row_shop['shopbrand_id']==$_REQUEST['shop_id']) or ($row_shop['shopbrand_id']==$parent))
																	{
																	  ...
																	  $comp_shop = $row_shop['shopbrand_id']; 
																		...
																		<?php	
																			...
																			{
																		?>
																					<li><h2><a href="<?php url_shops($row_child['shopbrand_id'],$row_child['shopbrand_name'],-1)?>" title="<?php echo stripslash_normal($row_child['shopbrand_name'])?>" class="shopleftlink"><?php echo stripslash_normal($row_child['shopbrand_name']);?></a></h2></li>
																		<?php		
																			}
																		?>
																			</ul>
												...
												<div class="shop_brand_bottom"></div>
											</div>
									<?php
											if($cache_required)// If caching was required then stop the recording and save the cache and display the cached content
											{
									...
									?>
											...
											<div class="shop_brand_top"></div>
												...
												{
												?>
												<li class="categoryheader"><?php echo $title?></li>
												<?php
												}
												?>
												<div align="center">
									...
									{
										?>
										<a href="<?php url_link('shopbybrand.html')?>"><img src="<?php url_site_image('shop-brnd-banner.gif')?>" border="0" /></a>
										<?php
										if($groupData['shopbrandgroup_display_rotator']==1)
										{
											while ($row_shop = $db->fetch_array($ret_shop))
								...
								elseif ($position=='top')
								{
									...
									<div class="shp_brnd_thumbimg_con">
									  <?php /*?><div class="shp_brnd_nav"><a href="#" onmouseover="scrollDivRight('<?=$divid?>')" onmouseout="stopMe()" ><img src="<?php url_site_image('shop-arrow-l.gif')?>"></a></div><?php */?>
									  <div id="<?=$divid?>" class="shp_brnd_thumbimg_inner">
										<div id="shp_brnd_thumb" style="width: <?php echo $div_width?>px;">
										<?=$HTML_Content?>												
										</div>
									  </div>
									  <?php /*?><div class="shp_brnd_nav"><a href="#" onmouseover="scrollDivLeft('<?=$divid?>',<?php echo ($cnts*90)?>)" onmouseout="stopMe()" o=""><img src="<?php url_site_image('shop-arrow-r.gif')?>"></a>
									  </div><?php */?>
									</div>
									</div>
									</div>
...
// Function to support the image rotate in shop by brand menu
		...
		?>
				...
				<input type="hidden" name="remove_recent" id="remove_recent" value="remove_recent" />	
					<div class="lf_recent">
					<div class="lf_recent_middle">
							<?php
							if($title)
							{
							?>
									<div class="recent_header"><?php echo $title ?></div>
							<? 
							}
							?>
							<?php
							$cookarray 	= explode(",",$cookval);
								...
								{
									$sql_prod = "SELECT product_id, product_name,product_default_category_id ,product_discount,product_webprice   
												FROM 
													products 
												WHERE 
													sites_site_id = $ecom_siteid 
									...
									if ($db->num_rows($ret_prod))
									{
										...
										{
										?>
										<div class="lf_recent_pdt">
											<div class="lf_recent_pdt_top">
												 <div class="lf_recent_pdt_l">
										<?php 
							...
							<?php $price_arr =  show_Price($row_prod,array(),'compshelf',false,4);							
												?>
							<div class="lf_recent_pdt_r"><?php if($price_arr['discounted_price'])
													echo $price_arr['discounted_price'];
												else
													echo $price_arr['base_price'];?></div>
							</div>
							<div class="lf_recent_pdt_name"><a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" title="<?php echo stripslash_normal($row_prod['product_name'])?>"><?php echo $row_prod['product_name'];?></a></div>
							</div>
							<?php
							}
							}
						...
						<div class="recent_view_bottom"><a href="#"  title="<?php echo stripslash_normal($Captions_arr['COMMON']['COMON_RECENT'])?>"  onclick="if(confirm('Are You sure You want to clear the recent product list')){ document.<?=$frm_name?>.submit()};" class="recent_view-showall"><?php echo stripslash_normal($Captions_arr['COMMON']['COMON_RECENT'])?></a></div>
					  </div>
					  							 </div>
				...
				if (count($advert_arr))
				{
				  ...
				  <?php
						...
						<?php		
							...
							$path = url_root_image('nor/img/'.$k['advert_source'],1);
							$link = $k['advert_link'];
							$flash_path =  '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="192" height="95">
							<param name="movie" value='.$path.'  >
    						<param name="quality" value="high" >
							<param name="BGCOLOR" value="#D6D8CB"><embed src='.$path.' type=application/x-shockwave-flash width = 192 height=95> </object>';
							$img_link=  '';
							echo  $flash_path ;
		...
		function mod_sitereviews($title)
		{
			global $ecom_siteid,$db,$position,$Settings_arr;
				//print_r($title);
		?>	
				  <div class="site_review"><a href="<?php url_link('sitereview.html');?>"><img src="<?php url_site_image('review.gif')?>" /></a></div>
		<?php	
		}
        ...
        <div class="prodlist_menu_lf_middle">
			...
			<tr>
				...
				?>
						<ul class="catprod_prod">  
							<li class="catprod_prodes"><a href="<?php echo url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" class="catprod_prodlink" title="<?php echo stripslash_normal($row_prod['product_name'])?>"><?php echo stripslash_normal($row_prod['product_name'])?></a></li>
						</ul> 
				<?php
					}
				?>					    
                                ...
                                <tr>
                                 <td>
                                  <div class="prolist_btnlf">
                                    <a href="<?php  url_category($_REQUEST['category_id'],$row_cats['category_name'],-1)?>" class="prodlist_linklf" title="<?php echo $Captions_arr['COMMON']['SHOW_PROD_ALL']?>"><span><?php echo $Captions_arr['COMMON']['SHOW_PROD_ALL']?></span></a>
                                </div>
                                 </td>
                                </tr>
			 </table>
		...
		?>
		<div class="web_stas">
			<div class="web_stas_top"></div>
				<div class="web_stas_middle">
				<?php
					if($title)
					{
					?>
					...
					?>
					<div class="stcs_txtB"><span class="webstatisticsA">"<?=$row_query['site_hits']?>"</span><br /><?php echo stripslash_normal($Captions_arr['COMMON']['WEB_STATISTICS'])?></div>
				</div>
			<div class="web_stas_bottom"></div>
		</div>
		<?
		}
		...
		?>
			<tr>
				...
				<li><h2><a href="<?php url_link('logout.html')?>" class="userloginmenuytoplink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['LOGOUT'])?></a></h2></li>
				<?php /*?><li><h2><a href="<?php url_link('mypricepromise.html')?>" class="userloginmenuytoplink"><?=$Captions_arr['LOGIN_MENU']['MY_PRICE_PROMISE']?></a></h2></li><?php */?>
				<li><h2><a href="<?php url_link('myorders.html')?>" class="userloginmenuytoplink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['MY_ORDERS'])?></a></h2></li>
				<? /*$myaddr_module = 'mod_myaddressbook';
					if(in_array($myaddr_module,$inlineSiteComponents))
					{
				?>
					<li><h2><a href="<?php url_link('myaddressbook.html')?>" class="userloginmenuytoplink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['MY_ADDRESSBOOK'])?></a></h2></li>
				<?php
					}*/
				?>
				<?php	
					...
					{
				?>
					<li><h2><a href="<?php url_link('myfavorites.html')?>" class="userloginmenuytoplink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['MY_FAVOURITE'])?></a></h2></li>
				<?php
					}*/
					?>
				<?php /*?><li><h2><a href="<?php url_link('wishlist.html')?>" class="userloginmenuytoplink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['MY_WISHLIST'])?></a></h2></li><?php */?>
				<?php /*?><li><h2><a href="<?php url_link('myenquiries.html')?>" class="userloginmenuytoplink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['MY_ENQUIRIES'])?></a></h2></li><?php */?>
				<li><h2><a href="<?php url_link('myprofile.html')?>" class="userloginmenuytoplink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['MY_PROFILE'])?></a></h2></li>
				<?php
				// check whether payon account link is to be displayed for current user
				$sql_usr = "SELECT customer_payonaccount_status 
									FROM 
				...
				{
				?>
 					<li><h2><a href="<?php url_link('mypayonaccountpayment.html')?>" class="userloginmenuytoplink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['MY_PAYONACCDETAILS'])?></a></h2></li>
				<?php
				}
					$sql_download	= "SELECT ord_down_id 
													FROM 
					...
					{
				?>	
					<li><h2><a href="<?php url_link('mydownloads.html')?>" class="userloginmenuytoplink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['MY_DOWNLOADS'])?></a></h2></li>
				<?php
					}
					
				?>
				<li><h2><a href="<?php url_link('login_home.html')?>" class="userloginmenuytoplink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['MY_HOME'])?></a></h2></li>
				</ul>          
				</td>
			</tr>
		<?php
			...
			{	
				...
				<div class="preorder">
					<div class="preorder_top"></div>
						<div class="preorder_middle">
						<?php
							if($title)
							{
							?>
								<div class="preorder_hdr"><?php echo $title?></div>
							<?
							}
									$cookarray 	= explode(",",$cookval);
								...
								{	
									...
									{
										?>
										<div class="preorder_pdt">
											<div class="preorder_pdt_top">
												<div class="preorder_image">
											...
											<div class="preorder_name"><a href="<?php echo url_product($row_main['product_id'],$row_main['product_name'],-1)?>" class="preordprodlink" title="<?php echo stripslash_normal($row_main['product_name'])?>"><?php echo stripslash_normal($row_main['product_name'])?></a></div>
										    </div>
											
											<div class="preorder_pdt_bottom"><div class="preorder_price_sapn"><span><?php
											$price_arr =  show_Price($row_main,array(),'compshelf',false,3);
										if($price_arr['discounted_price'])
											echo $price_arr['discounted_price'];
										else
