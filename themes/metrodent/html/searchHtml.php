...
class search_Html
{
	...
	function Show_Search($search_sql,$tot_cnt,$sql_relate)
	{
		...
		<div class="navselect"><select name="searchprod_sortbytop" id="searchprod_sortbytop">
		...
		<div class="navtxt"><?php echo $Captions_arr['SEARCH']['SEARCH_ITEMS'] ?></div>
		<div class="navselect"><select name="searchprod_prodperpagetop" id="searchprod_prodperpagetop">
					<?php
...
$query_string =$first_querystring;
	...
	{
	?>
	<table align = "center" width="98%" border="0" cellspacing="0" cellpadding="3" class="search_cat">
	<tr>
	...
	<table width="100%" cellpadding="0" cellspacing="8" border="0" class="search_catA">
	<tr>
	<?php 
	$alpha_index = 0;
