...
?>
			<div class="treemenu"><a href="<? url_link('');?>"><?=stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']);?></a> >> <?=stripslash_normal($Captions_arr['MY_DOWNLOADS']['DOWN_HEADER'])?></div>
		<table width="100%" border="0" cellpadding="0" cellspacing="4"  >
		
		<tr>
			<td colspan="3" class="prod_orderheader"><?=stripslash_normal($Captions_arr['MY_DOWNLOADS']['DOWN_HEADER'])?></td>
		</tr>
		<tr>
		<td colspan="3">
