				...
				if ($db->num_rows($ret_prod))
				{
					...
					$querystring = ""; // if any additional query string required specify it over here
						...
						?>
							...
							{
							?>
							<div class="bulkdiscHeader"><?php echo str_replace('[tot_cnt]',$tot_cnt,stripslashes($Captions_arr['BULKDISC_PROD']['BULKDISC_PROD_TOPMSG']));?></div>
							<?
							}
							...
							if($bottom_content!='')
										{	
										?>
										<div class="bulkdisc_bottom_desc">
