...
?>
	...
	function mailinglist_mainsel()
	{
		...
		<li><?=stripslash_normal($Captions_arr['CUST_REG']['REGISTRATION_TREEMENU_TITLE'])?></li>
		 ...
		 <div class="inner_header"><?=stripslash_normal($Captions_arr['CUST_REG']['REGISTRATION_TREEMENU_TITLE'])?></div>
		...
		?>	
		<tr>
			<td width="33%" align="left" valign="top" class="regiconentA1"><?//=stripslash_normal($Captions_arr['CUST_REG']['ACCNT_TYPE'])?></td>
			<td width="67%" align="left" valign="top" class="regi_txtfeild1">
			<?php /*?><select name="customer_accounttype" class="regiinput" id="customer_accounttype" onchange="showAccountTypeDetails(this);" >
		...
		$custstat_caption_map_array = array(
												...
												'customer_compname'		=> 'Company Name',
        ...
        <div class="inner_middle">
          <table width="100%" align="left" border="0" cellpadding="0" cellspacing="0">
            <tbody>
              <tr>
                <td align="left" valign="top" class="regiheader"><span class="reg_header"><span><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_COMPANY_DETAILS_HEADER'])?></span></span></td>
                <td align="left" valign="top" class="regiheader"> </td>
              </tr>
			  <?php
					...
					{	
						...
						?>
							 <tr>
								<td class="regiconent" valign="middle" width="33%" align="left">
								...
								<td width="67%" align="left" valign="middle" class="regi_txtfeild">
								<?php
	  ...
	  <div class="inner_con" >
	   ...
	   <table class="regitable" width="100%" border="0" cellpadding="0" cellspacing="0">
           <tbody>
              <tr>
                <td colspan="2" class="regiheader" align="left"><span class="reg_header"><span><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_PERSONAL_DETAILS_HEADER'])?></span></span></td>
              </tr>
				<?php
				//section for custom registration form 
				...
				$cellpadding 			= 0;		
				include 'show_dynamic_fields.php';
				// array_splice($custstat_caption_map_array, 1, 0, 'customer_compname');
				// print_r($custstat_caption_map_array);
				// Get the list of static fields to be display for business accounts
				...
				{	
					...
					{ $cnt ++;
						if($row_custstat['field_req']==1)
						{
							...
							if($ecom_siteid==91)//live http://www.teeth247.co.uk
							{
								 if($cnt==2)
								 {
								 ?>
						...
						<tr>
							<td class="regiconent" valign="middle" align="left">
							<?php 					  
								   	echo stripslashes($custstat_caption_map_array[$row_custstat['field_key']]); if($row_custstat['field_req']==1) { echo '&nbsp;<span class="redtext">*</span>';}
							 ?>
							</td>
							<td align="left" valign="middle" class="regi_txtfeild">
							<?php
				...
				?>
              <tr>
                <td class="regiconent" valign="middle" align="left"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_EMAIL'])?><span class="redtext">*</span></td>
			   ...
			   <tr>
              <td align="left" valign="middle" class="regiconent"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_PASSWORD'])?><span class="redtext">*</span></td>
              <td align="left" valign="middle" class="regi_txtfeild"><input name="customer_pwd" type="password" class="regiinput" id="customer_pwd" size="25" value="" /></td>
            </tr>
            <tr>
              <td class="regiconent" valign="middle" align="left"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_CONF_PASSWORD'])?><span class="redtext">*</span></td>
	  ...
	  <div class="inner_con" >
        ...
        <div class="inner_middle">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
           <?php /*?> <tr>
              <td width="42%" align="left" valign="middle" class="regiconent"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_PASSWORD'])?><span class="redtext">*</span></td>
              <td width="58%" align="left" valign="middle" class="regi_txtfeild"><input name="customer_pwd" type="password" class="regiinput" id="customer_pwd" size="25" value="" /></td>
            </tr>
            <tr>
              <td class="regiconent" valign="middle" align="left"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_CONF_PASSWORD'])?><span class="redtext">*</span></td>
              <td align="left" valign="middle" class="regi_txtfeild"><input name="customer_pwd_cnf" type="password" class="regiinput" id="customer_pwd_cnf" size="25" value="" /></td>
			...
			?>
				...
				<tbody>
				  <tr>
				    ...
				    <td width="96%" align="left" valign="middle"><?=stripslash_normal($Captions_arr['CUST_REG']['PAY_ON_ACCOUNT'])?></td>
				  </tr>
				</tbody>
				</table>
				</div>
	  ...
	  <div class="inner_con_clr1" >
        ...
        <div class="inner_clr1_middle">
          <table class="regi_tableA" width="100%" border="0" cellpadding="0" cellspacing="4">
            <tbody>
              <tr>
                <td valign="middle" width="4%" align="left"><?php /*<img src="<?php url_site_image('re-icn1.gif')?>" width="61" height="53" /> */ ?></td>
                <td valign="middle" width="4%" align="left"><input name="chk_newsletter" value="1" type="checkbox" /></td>
                <td valign="middle" width="96%" align="left"><?=stripslash_normal($Captions_arr['CUST_REG']['REQUEST_NEWS_RECEIVE_NEWPROD']) //RECEIVING_NEWSLETTER?></td>
              </tr>
            </tbody>
          </table>
        </div>
		...
		?>
			...
			<div class="inner_clr1_middle">
			  <table class="regi_tableA" width="100%" border="0" cellpadding="0" cellspacing="4">
				<tbody>
				  <tr>
					<td valign="middle" width="4%" align="left"><?php /*<img src="<?php url_site_image('re-icn-group.gif')?>" width="61" height="53" /> */ ?></td>
					<td valign="middle" width="4%" align="left"><input type="checkbox" name="customer_in_mailing_list" id="customer_in_mailing_list" value="1" onchange="maillinglist_onchange(this)" <?php if ($_REQUEST['customer_in_mailing_list']==1) echo 'checked="checked"';?> /></td>
					<td valign="middle" width="96%" align="left"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_RECEIVE_NEWSLETTER_HEADER'])?></td>
				  </tr>
				  <tr>
				  <td colspan="3">
					...
					<?php 
						...
						?>
							...
							<input type="checkbox" name="newsletergroup[]" value="<?=$customer_grp['custgroup_id']?>" <?=($customer_grp['custgroup_id']==$customer_grp['selected_grp'])?"checked":""?> onchange="mailinglist_mainsel()"/>						</td>
				...
				<div class="inner_clr1_middle">
				  <table class="regi_tableA" width="100%" border="0" cellpadding="0" cellspacing="4">
					  <tr>
						<td valign="middle" width="4%" align="left"><?php /*<img src="<?php url_site_image('re-icn-group.gif')?>" width="61" height="53" /> */ ?></td>
						<td valign="middle" width="4%" align="left"><input type="checkbox" name="customer_in_mailing_list" id="customer_in_mailing_list" value="1" onchange="maillinglist_onchange(this)" <?php if ($_REQUEST['customer_in_mailing_list']==1) echo 'checked="checked"';?> /></td>
						<td valign="middle" width="96%" align="left"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_RECEIVE_NEWSLETTER_HEADER_ONLY'])?></td>
					  </tr>
			  	</table>
			  </div>
			<div class="inner_clr1_bottom"></div>
			  ...
			  <div class="inner_con" >
				...
				<div class="inner_middle">
				  <table class="regifontnormal" width="100%" border="0" cellpadding="0" cellspacing="0">
					<tbody>
					<tr>
					 <td class="regiconentA_more" colspan="4"><?=stripslash_normal($Captions_arr['COMMON']['IMAGE_VERIFY_TEXT_COUPLEMORE'])?>
					 </td>
					</tr>
					  <tr class="regitable">
						<td class="regi_txtfeild" align="right" width="30%"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_REGISTRATION_CODE'])?></td>
						<td align="left" valign="middle" class="regi_txtfeild">
						<?php 
						...
						<td align="left" valign="middle" class="regi_txtfeild"><img src="<?php url_verification_image('includes/vimg.php?size=4&amp;pass_vname=registration_Vimg&amp;bg=143 186 2')?>" border="0" alt="Image Verification"/>	</td>
						<td align="left" valign="middle" class="regi_txtfeild"><div class="imgver_text"><?=stripslash_normal($Captions_arr['COMMON']['IMAGE_VERIFY_TEXT_CODE'])?>
						</div></td>
					  </tr>
					</tbody>
				  </table>
            ...
            <tbody>
              ...
              <tr>
				...
				?>			
					...
					<?php /*?><input name="custcartlogin_Submit" type="submit" class="buttonred_cart" value="Login" onclick="document.frm_custlogin_cart.submit()" /><?php */?>
				<? 
				...
				<div class="lgn_btn">
				<div class="lgn_btn_innerA"><a href="javascript:document.frm_custlogin.submit()"><img src="<?php echo url_site_image('login-img.gif')?>" border="0" /></a></div>
				</div></td>
              </tr>
            </tbody>
          </table>
