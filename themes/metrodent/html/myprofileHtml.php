	...
	if(atleast_one)
	 ...
	 <div class="inner_con_clr1" >
		...
		?>	<tr>
			...
			<td width="67%" align="left" valign="middle" class="regi_txtfeild1">
			<input type="hidden" name="customer_account_type" id="customer_account_type" value="personal" />
<?php /*?>			<select name="customer_accounttype" class="regiinput" id="customer_account_type" onchange="showAccountTypeDetails(this);" >
