           ...
           <div class="reg_shlf_pdt_con">
		    <table width="100%" border="0" cellpadding="0" cellspacing="3"  class="reg_table">
					...
					?>
								...
								<div class="cart_top_links"><div class="inner_btn_red"><div>
								<input name="pricepromise_submit" type="submit" class="" id="Submit" value="<?=$Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_SUBMIT_REQ']?>"/>
								</div>
								</div>
								</div>
								</td>
...
?>
				...
				<div class="reg_shlf_inner">
					...
					<? }?>
						<div class="reg_shlf_cont_div">
							<div class="reg_shlf_pdt_con">
                            <table  border="0" cellpadding="2" cellspacing="3" width="100%" class="reg_table_top">
							  <tr>
								...
								<td width="22%" nowrap="nowrap" class="usermenucontent"><input name="prm_prodname" id="prm_prodname" type="text"  value="<?php echo $_REQUEST['prm_prodname']?>" /></td>
							    <td width="10%" nowrap="nowrap" class="usermenucontent"><?php echo stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICEPROM_STATUS'])?></td>
							    <td width="57%" nowrap="nowrap" class="usermenucontent"><?php
							  ...
							  <tr>
							    <td nowrap="nowrap" class="usermenucontent"><?php echo stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_BETDATE'])?></td>
							    <td colspan="3" nowrap="nowrap" class="usermenucontent"><input name="prm_fromdate" class="textfeild" type="text" size="8" value="<?php echo $_REQUEST['prm_fromdate']?>" />
						        <a href="javascript:show_calendar('frm_promise.prm_fromdate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('show-calendar.gif')?>" width="24" height="22" border="0" /> <?php echo stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICEPROM_AND'])?></a> <input name="prm_todate" class="textfeild" id="prm_todate" type="text" size="8" value="<?php echo $_REQUEST['prm_todate']?>" />
						        <a href="javascript:show_calendar('frm_promise.prm_todate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('show-calendar.gif')?>" width="24" height="22" border="0" /></a></td>
						      </tr>
							  <tr>
							    <td nowrap="nowrap" class="usermenucontent"><?php echo stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_SORTBY'])?></td>
							    <td colspan="3" nowrap="nowrap" class="usermenucontent"><?php echo $sort_option_txt;?> <?php echo stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICEPROM_IN'])?> <?php echo $sort_by_txt?>
						        <input name="Search_go" type="submit" class="inner_btn_red" id="Search_go" value="Go" onclick="document.frm_promise.search_click.value=1" /></td>
						      </tr>
							</table>
			...
			?>
				...
				<tr id="add_post" style="display:none">
					...
					<input type="hidden" name="add_post" id="add_post" value="1" />
						...
						<tr>
							<td align="center" colspan="4" class="usermenucontentAz">
							...
							<td align="center" class="usermenucontentAz">
							<div class="cart_shop_cont"><div>
