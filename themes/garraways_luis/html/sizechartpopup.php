...
<div  class="sizechart_logo" align="left"><img src="<?php url_site_image('logo.png')?>"></div>
...
{
?>
  <td class="<?php echo $cls; ?>" align="center" ><?PHP echo ($sizevalue[$k][$i])?stripslashes($sizevalue[$k][$i]):'-'; ?></td>
<?php
} 
?>
</tr>
...
?>
<tr>
  <td colspan="4" ><div id="sizechart_close_div2" class="sizechart_close" align="RIGHT"> <a href="javascript:window.close()" title="Click to Close"><img src="<?php url_site_image('comp-icn.gif')?>" ></a></div></td>
</tr>
</tbody></table>
</body>
</html>
