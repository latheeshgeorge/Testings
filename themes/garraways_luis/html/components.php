...
<?php
                    ...
                    <ul>
                        ...
                        if(count($grp_array))
                        {
                            ...
                            {
                                $target = ($row_pg['page_link_newwindow']==1 and $row_pg['page_type']!='Page')?'target="_blank"':'';
                                $row_pg['title'] = str_replace('&','&amp;',$row_pg['title']);
                            ?>
                                <li>
									...
									if ($db->num_rows($ret_cat))
									{
										...
										{ 
											...
											if($_SERVER["HTTP_HOST"] == "www.bsecured.co.uk" || $_SERVER["HTTP_HOST"] == "bsecured.co.uk")
													$thttp = 'https://www.bsecured.co.uk/'.$ecom_hostname.'/';
											else 	
												$thttp = $ecom_selfhttp.$ecom_hostname.'/';
										?>	
...
function showCateImg(imgVal,cateID)
{
	if(document.getElementById('cate_menu_img_'+cateID))
	{
		if(imgVal != '')
		{
			var imgePath	=	'<img src="<?php echo $thttp?>/images/<?php echo $ecom_hostname;?>/'+imgVal+'" alt="Category Image" border="0"/>';
...
<link href="<?php url_head_link("images/".$ecom_hostname."/".$site_images_folder."/css/owl.carousel.css")?>" rel="stylesheet">
<link href="<?php url_head_link("images/".$ecom_hostname."/".$site_images_folder."/css/owl.theme.css")?>" rel="stylesheet">
                                        	...
                                        	<div class="category_con">
												<div class="category_left"></div>
                                                    ...
                                                    <?php 
														...
														<ul class="dropEverything">
															<?php
																...
																?>
																	...
																	<span><a href="<?php url_category($row_cat['category_id'],$row_cat['category_name'],-1)?>" class="top-a" title="<?php echo stripslash_normal($row_cat['category_name'])?>" rel="<?php $this->category_menuimage($row_cat['category_id'],stripslash_normal($row_cat['category_name']),'img');?>" id="cat<?php echo $row_cat['category_id']?>" onmouseover="javascript: showCateImg(this.rel,'<?php echo $row_cat['category_id'];?>');"><?php echo ucwords(stripslash_normal($row_cat['category_name']));?></a></span>
																<?php
                                                                ...
                                                                <?php
																		while($row_subcat = $db->fetch_array($ret_subcat))
																		{
																			...
																			if($subcat_cnt==0)
																				...
																				$row_subcat['category_name'] = str_replace('&','&amp;',$row_subcat['category_name']);
																		?>
																			<li><a href="<?php url_category($row_subcat['category_id'],$row_subcat['category_name'],-1)?>" rel="<?php $this->category_menuimage($row_subcat['category_id'],stripslash_normal($row_subcat['category_name']),'img');?>"  onmouseover="javascript: showCateImg(this.rel,'<?php echo $row_cat['category_id']?>');"><?php echo stripslashes($row_subcat['category_name']);?></a>
																			<?php
                                                                            ...
                                                                            <?php
																					...
																					{
																						$row_subsubcat['category_name'] = str_replace('&','&amp;',$row_subsubcat['category_name']);
																			?>			<li><a href="<?php url_category($row_subsubcat['category_id'],$row_subsubcat['category_name'],-1)?>" rel="<?php $this->category_menuimage($row_subcat['category_id'],stripslash_normal($row_subcat['category_name']),'img');?>" onmouseover="javascript: showCateImg(this.rel,'<?php echo $row_cat['category_id']?>');"><?php echo stripslashes($row_subsubcat['category_name'])?></a></li>
																			<?php
																					}
																			?>		</ul>
                                                                            <?php
																		...
																		?>	</div>
																		<?php
																		// Check whether featured products assigned for this category
																		$sql_featdet = "SELECT
																						...
																						FROM 
																							products a,category_featuredprod_map b 
																						WHERE 
																							b.product_categories_category_id = ".$row_cat['category_id']." 
																							AND a.product_id = b.products_product_id 
																							AND a.product_hide = 'N' 
																							AND a.sites_site_id =$ecom_siteid 
																						ORDER BY 
																							b.prod_order";
																		$ret_featdet = $db->query($sql_featdet);;
																		if($db->num_rows($ret_featdet))
																		{
																		?>
																			<div class="catfeat_outer">
																				<div id="owl-featured-<?php echo $owl_feat_counter;?>" class="owl-carousel">
																				<?php
																				while ($row_featdet = $db->fetch_array($ret_featdet))
																				{
																			?>		
																					<div class="item">
																						
																						<div class="featuredprodcat_block">
																							<div class="featureprodcatimgqrap"><a href="<?php url_product($row_featdet['product_id'],$row_featdet['product_name'],-1)?>" title="<?php echo stripslash_normal($row_featdet['product_name'])?>" class="product_image">
																							<?php
																										//$pass_type = 'image_thumbcategorypath';
																										$pass_type = 'image_thumbpath';
																										// Calling the function to get the image to be shown
																										$img_arr = get_imagelist('prod',$row_featdet['product_id'],$pass_type,0,0,1);
																									if(count($img_arr))
																									{
																										show_image(url_root_image($img_arr[0][$pass_type],1),$row_featdet['product_name'],$row_featdet['product_name']);
																									}
																									else
																									{
																										...
																										if ($no_img)
																										{
																										show_image($no_img,$row_featdet['product_name'],$row_featdet['product_name']);
																										}	
																									}	
																									?>
																							</a> </div>
																							<div class="featuredprodcat_content">
																							<p class="featuredprodcat_desc">
																							<a href="<?php url_product($row_featdet['product_id'],$row_featdet['product_name'],-1)?>"  title="<?php echo stripslash_normal($row_featdet['product_name'])?>" class="product_descr" style="text-decoration:none;"><span class="grey"><?php echo stripslash_normal($row_featdet['product_name'])?></span></a>
																							</p>
																							</div>
																							<?php
																							$price_class_arr['ul_class'] 		= 'prodfeat_shelfBul_lu';
																							$price_class_arr['normal_class'] 	= 'prodfeat_shelfBnormalprice_lu';
																							$price_class_arr['strike_class'] 	= 'prodfeat_shelfBstrikeprice_lu';
																							$price_class_arr['yousave_class'] 	= 'prodfeat_shelfByousaveprice_lu';
																							$price_class_arr['discount_class'] 	= 'prodfeat_shelfBdiscountprice_lu';
																							echo show_Price($row_featdet,$price_class_arr,'cat_detail_1');
																							?>
																						</div>
														...
														<script src="<?php url_head_link("images/".$ecom_hostname."/".$site_images_folder."/scripts/owl.carousel.js")?>"></script>
														<script type="text/javascript">
														jQuery.noConflict();
														var $ajax_j = jQuery;
														$ajax_j(document).ready(function() {
														  <?php 
														  for($owlcnt=0;$owlcnt<$owl_feat_counter;$owlcnt++)
														  {
														  ?>
															$ajax_j("#owl-featured-<?php echo $owlcnt?>").owlCarousel({
																navigation : true,
																slideSpeed : 300,
																pagination:false,
																paginationSpeed : 400,
...
<?
		...
		{  
            ...
            <a href="#" onclick="gobackto_cart('<?php echo ($protectedUrl)?base64_encode($ecom_hostname):$ecom_hostname?>')" title="<?php echo stripslash_normal($Captions_arr['COMMON']['VIEW_CART'])?>"><?php echo stripslash_normal($Captions_arr['COMMON']['LABEL_CART'])?></a>&nbsp;
			...
			?></span>
            <!--<span class="ajax_cart_product_txt_s hidden"><?php echo stripslash_normal($Captions_arr['COMMON']['CART_TOTAL'])?> <?php echo $cart_tot?></span>-->
            </div>
			<?php
				  if($cust_id)
				  {
				...
				?>
					<div class="spcl_shlf_lf_con">
                        ...
                        ?>	<div class="spcl_shlf_pdt_outer">
                        		...
                        		<?php /* <!--<div class="spcl_shlf_first_buy"> <a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" title="<?php echo stripslash_normal($row_prod['product_name'])?>"><?php echo stripslash_normal($Captions_arr['COMMON']['COMMON_BUY_NOW'])?></a> </div>--> */?>
                                </div>
                            </div>
                        <?php	
                            }
                        ...
                        ?>
                            ...
                            <?php /* <!--<div class="spcl_shlf_pdt_bottom"> <a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" title="<?php echo stripslash_normal($row_prod['product_name'])?>"><?php echo stripslash_normal($Captions_arr['COMMON']['COMMON_BUY_NOW'])?></a> </div>--> */?>
                        </div>
                        <?php
                            }
                            $recordCnt++;
...
<?php	
	...
	<?php	
		...
		{
			//print_r($shelf_arr);
			global $db,$ecom_siteid,$ecom_hostname,$Settings_arr,$Captions_arr,$position,$position1;
						...
						{ 
							...
							//echo "shelf display style - ".$shelfData['shelf_displaytype'];
								...
								switch($shelfData['shelf_displaytype'])
								{
											 ...
											 if($row_prod['product_saleicon_show']==1)
												{
													...
													//if($desc!='')
													{
														 echo $HTML_sale = '<div class="pdt_list_sale_3row"></div>';
													}
												}
												if($row_prod['product_newicon_show']==1)
												{
													...
													//if($desc!='')
													{
														echo  $HTML_new = '<div class="pdt_list_new_3row"></div>';
													}
												}
											?>	
								 ...
								 else if($shelfData['shelf_currentstyle']=='scroll')
									{
									$width_one_set 	= 305;
										$min_number_req	= 3;
...
<?php	
							...
							if($shelfData['shelf_currentstyle']=='sp1') // case of christmas layout
							{
								switch($shelfData['shelf_displaytype'])
								{
								case '3row': 
						...
						if ($db->num_rows($ret_prod))
						{
							...
							if($shelfData['shelf_currentstyle']=='nor') // case of normal design layout
							{
								switch($shelfData['shelf_displaytype'])
								{
									case '3row': 
									?>
									<div class="sideshelf_mainouter">
										<?php
										if ($title)
										{
										?>
											<div class="sideshelf_maintitle">
											<?php  echo $title?>
											</div>
										<?php
										}?>
										...
										?>	<div class="sideshelf_productouter">
                                        <?php
												if($shelfData['shelf_showtitle']==1)// whether title is to be displayed
												{
										?>			<div class="sideshelf_prodtitle"> <a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>"  title="<?php echo stripslash_normal($row_prod['product_name'])?>"><?php echo stripslash_normal($row_prod['product_name'])?></a> </div>
										<?php	}
												if($shelfData['shelf_showimage']==1) // whether image is to be displayed
												{
										?>		<div class="sideshelf_img">
                                        		<a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" title="<?php echo stripslash_normal($row_prod['product_name'])?>">
                                                <?php
														$pass_type = 'image_iconpath';
														// Calling the function to get the image to be shown
										...
										<?php	}*/
												...
												{
										?>		<div class="sideshelf_proddesc"> <a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" title="<?php echo stripslash_normal($row_prod['product_name'])?>"><?php echo stripslash_normal($row_prod['product_shortdesc'])?></a></div>
                                        <?php	}*/
												if($shelfData['shelf_showprice']==1) // whether price is to be displayed
												{
										?>			<div class="sideshelf_prodprice">
										<?php 		//$price_arr =  show_Price($row_prod,array(),'compshelf',false,4);
													...
													$price_class_arr['ul_class'] 		= 'sideshelf_lu';
													$price_class_arr['normal_class'] 	= 'sideshelfnormalprice_lu';
													$price_class_arr['strike_class'] 	= 'sideshelfstrikeprice_lu';
													$price_class_arr['yousave_class'] 	= 'sideshelfyousaveprice_lu';
													$price_class_arr['discount_class'] 	= 'sideshelfdiscountprice_lu';
									...
									<div class="sideshelf_showall"> <a href="<?php  url_shelf_all($shelfData['shelf_id'],$shelfData['shelf_name'],-1)?>" class="spcl_shlf_showall" title="<?php echo stripslash_normal($Captions_arr['COMMON']['SHOW_ALL'])?>"><?php echo stripslash_normal($Captions_arr['COMMON']['SHOW_ALL'])?></a> </div>
									</div>
<?php	
									break;
								};	
		...
		function mod_spendvoucher($title)
		{
			...
			{
			?>
				<div class="left_comp_gift_buy"><a href="<?php echo $ecom_selfhttp.$ecom_hostname?>/spend_voucher.html" title="<?php echo stripslash_normal($Captions_arr['GIFT_VOUCHER']['SPEND_VOUCHER_CLICK_HERE'])?>"><img src="<?php url_site_image('spend_giftvoucher.png')?>" border="0" /></a></div>
			...
			{
			?>
				<div class="bottom_comp_gift_buy"><a href="<?php echo $ecom_selfhttp.$ecom_hostname?>/spend_voucher.html" title="<?php echo stripslash_normal($Captions_arr['GIFT_VOUCHER']['SPEND_VOUCHER_CLICK_HERE'])?>"><img src="<?php url_site_image('spend_giftvoucher.png')?>" border="0" /></a></div>
			...
			if($position1=='right')//for category details page
			{
			  foreach ($advert_arr as $d=>$k)
				...
				(function($, d) {
					...
					// demos				 
					$('#three').liteAccordion({ theme : 'dark', rounded : true, enumerateSlides : true, firstSlide : 2, linkable : false, easing: 'easeInOutQuart' });
						...
						switch ($k['advert_type'])
						{
							...
							?>
								...
								*/ 
								...
								<div class="rotator_newrightdiv">
								<div class="rotator_newrightdiv"><a href="<?php echo $ecom_selfhttp?>www.puregusto.co.uk/great-taste-award-winners-c79241.html" title="Great Taste Award Winning Product"><img src="<?php url_site_image('box-img1.jpg')?>" alt="Great Taste Award Winning Product" border="0"/></a></div>
								<div class="rotator_newrightdiv"><a href="<?php echo $ecom_selfhttp?>www.puregusto.co.uk/paper-coffee-cups-c77619.html" title="Paper Coffee Cups and Disposables"><img src="<?php url_site_image('box-img2.jpg')?>" alt="Paper Coffee Cups and Disposables" border="0"/></a></div>
								</div>
