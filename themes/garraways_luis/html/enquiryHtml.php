<?php
				  ...
				  <td colspan="7" align="left" valign="middle" class="cartlogin_msg1">
					...
					{  
						...
						?>
							...
							<div class="cart_top_info_link"><? echo stripslash_normal($Captions_arr['CART']['CART_IF_YOU_NOT_LOG']);?> <a href="<?php echo $ecom_selfhttp.$ecom_hostname?>/logout.html?rets=2" title="Logout" class="cartlogin_link"><? echo stripslash_normal($Captions_arr['CART']['CART_HERE']);?></a><? echo "&nbsp;". stripslash_normal($Captions_arr['CART']['CART_TO_LOGOUT']);?> </div>
						<?php
						}
	...
	<?php 
		...
		while($row_select_enq = $db->fetch_array($ret_select_enq))
		{
			...
			?>
			<tr>
			<td align="left" valign="middle" class="cart_td_delete"><img src="<?php url_site_image('delete-cart.gif')?>" onclick="if(confirm_message('Are you sure you want to Delete this Enquiry?')){document.frm_enquire.enq_mod.value='delete_enquiry';document.frm_enquire.enquiry_id.value='<?=$row_select_enq['enquiry_id']?>';document.frm_enquire.submit();}" alt="Delete" title="Delete" /></td>
			...
			<a href="<?php echo url_product($row_prod_det['product_id'],$row_prod_det['product_name'])?>" title="<?php echo $row_prod_det['product_name']?>" class="cart_pdt_link"><?php echo $row_prod_det['product_name']?></a>
			 <?php
			$check_arr = is_grid_display_enabled_prod($row_prod_det['product_id']);
			...
			<?php 
			 ...
			 <td align="right" valign="top" class="cart_td_delete"><img src="<?php url_site_image('enquire_note.gif')?>" onclick="add_Enquire_notes(frm_enquire,'<?=$row_select_enq['enquiry_id']?>')" alt="Add Notes" title="Add Notes" /></td>
			</tr>
...
?>		
           <tr>
				...
				<td colspan="7" align="left" valign="top" class="enquiry_inner_left">
					...
					<div>                   
					<input type="password" name="custlogin_pass" id="custlogin_pass_main"  value="" class="cart_inputA"/>                </div>
					<div> <?php /*?><a href="javascript:validatemiddle_login(document.frm_custlogin_middle)" class="login-new">Login</a><?php */?>
					<input type="button" name="button2" id="button2" value="Go"  class="cart_login_button" onclick="submit_enquirecust_login('frm_enquire');"/>
					</div>              
			 ...
			 <?php
			  ...
			  ?>
				...
				<?php
						...
						{
							?>
						<div class="cart_shop_chkout">	<a class="clearenq_buttonA" href="#" onClick="show_wait_button(this,'Please Wait...');window.location='<?=$ps_url?>'"><?php echo stripslash_normal($Captions_arr['CART']['CART_CONT_SHOP'])?></a><div>
							</div></div><?php
						}
						else
							echo '&nbsp;';
	 ...
	 function Display_Message()
	 {
			...
			$HTML_treemenu .=
				...
				<div class="reg_shlf_inner">
					...
					<? }?>
						<div class="reg_shlf_cont_div">
							<div class="reg_shlf_pdt_con">	
                            <table cellpadding="2" cellspacing="0" width="100%"  class="reg_table_top"><tr>
				<td  align="left"  class="usermenucontent" valign="middle" width="9%">Date From</td><td  align="left" class="usermenucontent" valign="middle"  width="25%"> <input class="textfeild" type="text" name="srch_review_startdate" size="8" value="<?=$_REQUEST['srch_review_startdate']?>"  /></td><td width="6%" nowrap="nowrap"><a href="javascript:show_calendar('my_enquire.srch_review_startdate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('show-calendar.gif')?>" width="24" height="22" border="0" /></a></td><td  align="left"  class="usermenucontent" valign="middle" width="14%">Date To </td>
				<td  align="left"  class="usermenucontent" valign="top"  nowrap="nowrap" width="16%">  
				<input class="textfeild" type="text" name="srch_review_enddate" size="8" value="<?=$_REQUEST['srch_review_enddate']?>"  /></td><td width="30%" nowrap="nowrap" colspan="2"><a href="javascript:show_calendar('my_enquire.srch_review_enddate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('show-calendar.gif')?>" width="24" height="22" border="0" /></a></td></tr>
				<tr><td class="usermenucontent" valign="middle">Status </td><td valign="middle" class="usermenucontent"><select name="search_status"  id="search_status">
				  ...
				  <td valign="middle" class="usermenucontent">&nbsp;</td>
				  <td valign="middle" class="usermenucontent">Sort By</td>
				  <td colspan="2" valign="middle" class="usermenucontent"><?php echo $sort_option_txt;?>&nbsp;in <?php echo $sort_by_txt?> <input name="clearenq_button2" type="button" class="inner_btn_red" id="clearenq_button2" value="<?php echo stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_SEARCH'])?>" onclick="document.my_enquire.submit()" /></td>
				  </tr>
				</table>
		...
		function myenquiry_EnquiryDetails($enqid)
		{
			...
			<?php
				...
				{
			?>
					<input name="clearenq_button" type="button" class="cart_btn_enq" id="clearenq_button" value="<?php echo stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_CANCEL'])?>" onclick="if(confirm_message('Are you sure you want to cancel the Enquiry?')){document.my_enquire_det.enq_mod.value='cancel_enquiry';document.my_enquire_det.enquiry_id.value='<?=$row_enq['enquiry_id']?>';document.my_enquire_det.submit();}" />
			<?php
				}
			 ?>	</td>
			</tr>
			...
			<td  align="left"   class="shoppingcartcontent" width="13%">Enquiry Added on:</td><td  class="enquiryheader" width="13%"><?=$row_enq['added_date']?></td>
			<td  align="left"   class="shoppingcartcontent" width="13%">Enquiry Status:</td><td  class="enquiryheader" width="10%"><?=$row_enq['enquiry_status']?></td>
			</tr>
			</table>
			</td>
			</tr>
			...
			<td align="left" valign="middle" class="<?=$trmainclass?>" ><?php echo $rowpr['product_actualstock']?></td>
			<td align="left" valign="middle" class="<?=$trmainclass?>" ><?php echo $rowpr['product_weight']?></td>
			<td align="left" valign="middle" class="<?=$trmainclass?>" ><?php echo $rowpr['product_discount']?>&nbsp;&nbsp;<?php if($rowp['product_text']){?><img src="<?php url_site_image('plus.png')?>" border="0"  onclick="display_prodtext(this,<?=$rowp['products_product_id']?>);" title="Product Note" alt="Product Note"/><? } ?></td>
			</tr> 
			...
			<tr><td class="shoppingcartcontent" colspan="4"><table cellpadding="3" cellspacing="4" border="0" width="30%">
