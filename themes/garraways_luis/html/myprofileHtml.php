...
<p>By following the simple instructions below, you can give us your permission for us to stay in touch. The form also helps us to know which forms of contact you prefer, and exactly what information you do and don't want to receive. 
			...
			<option value="M/S." <?=($row_sql['customer_title']=='M/S.')?"selected":''?>>M/S.</option>
					  ...
					  <tr>
					    ...
					    <td  align="center" >:</td>
					    <td  align="left" class="regi_txtfeildA"><input type="text" name="fname" value="<?=$fname; ?>" maxlength="<?=$short?>"/></td>
				    </tr> 
					 <tr>
					    <td  colspan="2"  align="right" class="regi_txtfeildA">Last Name<span class="redtext">*</span> </td>
					    <td  align="center" >:</td>
					    <td  align="left" class="regi_txtfeildA"><input type="text" name="lname" value="<?=$lname; ?>" maxlength="<?=$short?>"/></td>
				    </tr>
				      <tr>
					    <td  colspan="2"  align="right" >&nbsp;</td>
					    <td  align="center" >&nbsp;</td>
				    ...
				    <tr>
					  ...
					  <tr>
					    ...
					    <td  align="center" >:</td>
					    <td  align="left" class="regi_txtfeildA1" width="40%">Yes&nbsp;<input type="radio" name="through_email" <?php if($row_sql['through_email']==1){?> checked="checked" <?php }?>  value="1">&nbsp;&nbsp;&nbsp;&nbsp;No&nbsp;<input type="radio" <?php if($row_sql['through_email']==0){?> checked="checked" <?php }?> name="through_email"  value="0"></td>
				    </tr>
				     <tr>
					    <td  colspan="2"  align="right"class="regi_txtfeildA" >If Yes Enter Email Id</td>
					    <td  align="center" >:</td>
					    <td  align="left" class="regi_txtfeildA"><input type="text" name="email_id" value="<?=$row_sql['email_id'] ?>" maxlength="<?=$medium?>"/></td>
				    </tr>
				     <tr>
					    <td  colspan="2"  align="right" class="regi_txtfeildA" >Telephone</td>
					    <td  align="center" >:</td>
					    <td  align="left" class="regi_txtfeildA1">Yes&nbsp;<input type="radio" name="through_phone" <?php if($row_sql['through_phone']==1){?> checked="checked" <?php }?>  value="1">&nbsp;&nbsp;&nbsp;&nbsp;No&nbsp;<input type="radio" name="through_phone"  <?php if($row_sql['through_phone']==0){?> checked="checked" <?php }?> value="0"></td>
				    </tr>
				     <tr>
					    <td  colspan="2"  align="right" class="regi_txtfeildA">If Yes Enter Phone Number</td>
					    <td  align="center" >:</td>
					    <td  align="left" class="regi_txtfeildA"><input type="text" name="phone_number" value="<?=$row_sql['phone_number'] ?>" maxlength="<?=$medium?>"/></td>
				    </tr>
				     <tr>
					    <td  colspan="2"  align="right" class="regi_txtfeildA">Post</td>
					    <td  align="center" >:</td>
					    <td  align="left" class="regi_txtfeildA1">Yes&nbsp;<input type="radio" name="through_post" <?php if($row_sql['through_post']==1){?> checked="checked" <?php }?> value="1">&nbsp;&nbsp;&nbsp;&nbsp;No&nbsp;<input type="radio" name="through_post" <?php if($row_sql['through_post']==0){?> checked="checked" <?php }?>  value="0"></td>
				    </tr>
				     <tr>
					    <td  colspan="2"  align="right"  valign="top" class="regi_txtfeildA">If Yes Enter Address here</td>
					    <td  align="center" valign="top">:</td>
					    <td  align="left" class="regi_txtfeildA"><textarea  name="postal_address"  rows="5" cols="30" /><?=$row_sql['postal_address'] ?></textarea></td>
				    </tr>
				     <tr>
					    <td  colspan="2"  align="right" class="regi_txtfeildA">Text</td>
					    <td  align="center" >:</td>
					    <td  align="left" class="regi_txtfeildA1">Yes&nbsp;<input type="radio" name="through_text" <?php if($row_sql['through_text']==1){?> checked="checked" <?php }?>  value="1">&nbsp;&nbsp;&nbsp;&nbsp;No&nbsp;<input type="radio" name="through_text" <?php if($row_sql['through_text']==0){?> checked="checked" <?php }?> value="0"></td>
				    </tr>
				     <tr>
					    <td  colspan="2"  align="right" class="regi_txtfeildA">If Yes Enter Text number</td>
					    <td  align="center" >:</td>
					    <td  align="left" class="regi_txtfeildA"><input type="text" name="text_number" value="<?=$row_sql['text_number'] ?>" maxlength="<?=$medium?>"/></td>
				    </tr>	
				      <tr>
					    <td  colspan="2"  align="right" >&nbsp;</td>
					    <td  align="center" >&nbsp;</td>
				    ...
				    <tr>
				      ...
				      <tr>
					    ...
					    <td  align="center" valign="top" >:</td>
					    <td  align="left" valign="top" class="regi_txtfeildA1">Yes&nbsp;<input type="radio" name="special_seasonal_offers" <?php if($row_sql['special_seasonal_offers']==1){?> checked="checked" <?php }?>   value="1">&nbsp;&nbsp;&nbsp;&nbsp;No&nbsp;<input type="radio" name="special_seasonal_offers"  <?php if($row_sql['special_seasonal_offers']==0){?> checked="checked" <?php }?> value="0"></td>
				    </tr>
				    <?php
				    /*
				       <tr>
...
For more details, please check our <a href="https://www.puregusto.co.uk/gdpr-pg50546.html" target="_blank"><strong>data protection</strong></a> to see how we use and protect your data. 
				   ...
				   <tr>
				     <td align="center" valign="middle" class="shoppingcartcontent" colspan="4" ><input class="inner_btn_red_x" type="button" name="Submit" value="Save" onclick="javascript:add_newconsent(document.add_address)" /></td>
			        </tr>	
				</table>
				</form>	
				<script language="javascript">
