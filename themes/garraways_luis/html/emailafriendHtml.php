	...
	class emailafriend_Html
	{
		...
		?>
		  <div class="reg_shlf_outr">
           ...
           <div class="reg_shlf_hdr_outr_email"><div class="reg_shlf_hdr_in"><span><?=stripslash_normal($Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_HEADER_TEXT'])?> '<?php echo stripslash_normal($product_name)?>'</span></div></div>
           ...
           <div class="reg_shlf_pdt_con">	
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="reg_table">
					...
					<tr>
						<td colspan="2" class="regiconentA_msg"><?=stripslash_normal($Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_MESSAGE_TEXT'])?> </td>
					</tr>
					<tr>
					  <td width="24%" class="regiconentA"><?=stripslash_normal($Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_FRIEND_NAME'])?><br /></td>
						<td width="76%" align="left" valign="middle" class="regi_txtfeildA"><input name="friend_name" type="text" class="addreivewinput" id="friend_name" size="32" value="<?=$_REQUEST['friend_name']?>"/></td>
					</tr>
					<tr>
			...
			<div style="margin-right:52%">
				<div class="cart_shop_cont_email"><div>
	...
	else
	{
		...
		?>
           ...
           <div class="reg_shlf_inner">
            <div class="reg_shlf_inner_top"></div>
           <div class="reg_shlf_inner_cont">
           <div class="reg_shlf_hdr_outr_email"><div class="reg_shlf_hdr_in"><span><?php echo $mesgHeader;?></span></div></div>
            <div class="reg_shlf_cont_div">
           <div class="reg_shlf_pdt_con">	
