...
if($_REQUEST['req']=='categories')
	{ 	
        echo   "<link href=\"".url_head_link("images/lightbox.css",1)."\" media=\"screen\" type=\"text/css\" rel=\"stylesheet\" />
				<script type=\"text/javascript\" src=\"".$ecom_selfhttp."ajax.googleapis.com/ajax/libs/prototype/1.6.0.2/prototype.js"."\"></script>
 ...
 */
?>
<?php /*<body  style='background: url("http://www.puregusto.co.uk/images/www.puregusto.co.uk/site_images/black-friday-bg.jpg") no-repeat fixed 100% 100% transparent;'>*/?>
...
echo '
        <div id="bw" style="display:none;">&nbsp;1</div>';
if($fraud_detection==1)
{
