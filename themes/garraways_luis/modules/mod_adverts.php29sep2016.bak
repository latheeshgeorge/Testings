<?php
	...
	{
			$sql_advert = "SELECT a.advert_title,a.advert_id,a.advert_source,a.advert_link,a.advert_target,
									a.advert_type,a.advert_activateperiodchange,
									a.advert_displaystartdate,a.advert_displayenddate,NOW() as date,
									a.advert_rotate_height,a.advert_rotate_speed   
						FROM 
	...
	if (count($advert_arr))
		$components->mod_adverts($advert_arr,$display_title,$position); // call the function to show the advert
?>
