         ...
         $HTML_topcontent .= '
			...
			$comp_active = isProductCompareEnabled();
				...
				?>
					<tr>
						...
						<div class="shlf_table_1row_nameTop">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class="shlf_table_1rowIn">
							<tr>
				...
				<?php
							//}
				?>				
								<td class="shlf_td_1row_desc" valign="top">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="cat_table">
				...
				?>
				        <tr>
							...
							<?php		
							if($row_category['category_id']==80314)
							{
							?>
								<a href="<?php url_static_page(50475,$row_category['category_name'],-1)?>" class="cate_link" title="<?php echo stripslashes($row_category['category_name'])?>"><?php echo stripslashes($row_category['category_name'])?></a>
							<?php	
							}
							else
							{?>							  
