		...
		<?php	while($row_prod = $db->fetch_array($ret_prod))
				{
					...
					if($shop_det['product_showtitle']==1)// whether title is to be displayed
					...
					if ($shop_det['product_showimage']==1)// Check whether description is to be displayed
					{
					...
					if ($shop_det['product_showshortdescription']==1)// Check whether description is to be displayed
					{
