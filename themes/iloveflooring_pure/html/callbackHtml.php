	...
	class callback_Html
	{
		...
		?>	
					...
					<? }?>
						<div class="reg_shlf_cont_div">
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="3"  class="reg_table">
								<tr>
									<td width="20%" class="regiconentA"><?=stripslash_normal($Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_FIRSTNAME'])?><span class="redtext">*</span></td>
								  <td width="80%" align="left" valign="middle" class="regi_txtfeildA"><input name="callback_fname" type="text" class="addreivewinput" id="callback_fname" size="39" value="<?=$_REQUEST['callback_fname']?>"
									/></td>
								</tr>
								<tr>
								  <td width="20%" class="regiconentA"><?=stripslash_normal($Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_LASTNAME'])?><br /></td>
								  <td width="80%" align="left" valign="middle" class="regi_txtfeildA"><input name="callback_lname" type="text" class="addreivewinput" id="callback_lname" size="39" value="<?=$_REQUEST['callback_lname']?>"
									/></td>
								</tr>
								<tr>
           ...
           <div class="reg_shlf_inner_cont">
				   ...
				   <table class="verification_code_table" width="100%" border="0" cellpadding="2" cellspacing="2">
					<tbody>
					<? if($Settings_arr['imageverification_req_callback']) {?>
					  <tr>
					    <td colspan="2" align="left"><?=stripslash_normal($Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_VERIFICATION_CODE'])?> </td>
					    </tr>
					  <tr>
					    ...
					    <td  align="center" width="70%">  <div class="imgver_text"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_LETTER_LONG_TEXT'])?></div></td>
					    </tr>
					  <tr>
					    <td align="left"><?php 
