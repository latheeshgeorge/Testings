						...
						echo
							'<table width="100%" border="0" cellspacing="0" cellpadding="0" class="reg_table">
							  ...
							  <tr>
								...
								echo
								'<tr>
									<td height="15" class="usermenucontentA">&nbsp;</td>
									<td class="usermenucontentA"><input name="compvoucher_Submit" type="submit" class="inner_btn_red" id="compvoucher_Submit" value="'.stripslash_normal($Captions_arr['GIFT_VOUCHER']['VOUCHER_GO']).'" /></td>
								</tr>
							</table>';
							echo $HTML_bottomdiv;
							?>
