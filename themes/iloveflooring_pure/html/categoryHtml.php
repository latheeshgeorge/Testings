		...
		function Show_CategoryDetails($row_cat)
		{
			...
			else // case of showing normal display for the category
			{
				*/ 
					...
					if ($cat_desc!='')
					{
						 $sr_array  = array('font-family: Verdana','xx-large','font-size: medium');
						$rep_array = array('font-family:  Arial, Helvetica, sans-serif','14px','font-size: 12px');  
			...
			$clsf = 'det_name_otr_no';
					...
					<div class="<?php echo $clsc?>">
						<div class="<?php echo $clsf ?>">
						   ...
						   <div class="<?php echo $clse ?>"></div><div class="deat_pdt_iconsb"><?php //echo $HTML_icons ?></div>
						...
						while ($row_subcat = $db->fetch_array($ret_subcat))
						{
							...
							if($row_cat['category_showname']==1)
							{
								$class = ( $cnt % 2 ? 'sub_cate_mid_ul_a' : 'sub_cate_mid_ul_b' );
						  		...
						  		$HTML_subcatname= '<span class="product_namespAC">'.stripslash_normal($row_subcat['category_name']).'</span>';
							}
