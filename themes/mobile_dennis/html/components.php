			...
			?>
			 <form method="post" name="frm_quicksearch" class="frm_cls" action="<?php url_link('search.html')?>">
                   ...
                   <input type="hidden" name="rdo_suboption" id="rdo_suboption" value='title_desc'/>
						...
						<tr>
						<td  class="td_D" ><label>
							<input name="quick_search" type="text" class="input_s" id="quick_search"  value="SEARCH DENNISTHECHEMIST" onFocus="if (this.value=='SEARCH DENNISTHECHEMIST') this.value='';" onBlur="if (this.value=='') this.value='SEARCH DENNISTHECHEMIST';"/>					
						</label></td>
  					...
  					<?php
						switch ($k['advert_type'])
						{
							...
							case 'SWF'://for  flash file
								$path = url_root_image('adverts/'.$k['advert_source'],1);
								$link = $k['advert_link'];
								$flash_path =  '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http'.$ecom_selfhttp.'://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="200" height="95">
