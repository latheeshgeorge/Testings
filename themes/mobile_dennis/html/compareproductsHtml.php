...
?>
				...
				<td align="left" valign="top" width="15%">&nbsp;</td>
						...
						{
						?>
							<td align="center" valign="top" class="prod_comparison_img" width="<?php echo $td_width?>%">
					  ...
					  ?>
							  <tr>
								<td align="left" valign="top" class="comparison_mainheadertop"><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_COMPPRICE']);?></td>
								  <?php
									for ($i=0;$i<$num_products;$i++)
									{
					  ...
					  ?>
						  <tr>
							<td align="left" valign="top" class="comparison_mainheaderbottom"><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_COMPSTOCK']);?></td>
							 <?php
								for ($i=0;$i<$num_products;$i++)
								{
									$cls = ($i==0)?'comparison_contentA':'comparison_contentB';
					 ...
					 ?> 
						  <tr>					
							<td colspan="<?php echo $num_products+1?>" align="left" valign="top" class="comparison_sec_header"><div class="reg_shlf_hdr_outrC"><div class="reg_shlf_hdr_in"><span><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_COMPKEYFEATURE']);?></span></div></div></td>
						  </tr>
						  <?php 
						   $cnt_feat = 0;
						  ...
						  ?>
							  <tr>
								<td align="left" valign="top" class="<?=$clsc?>"><?php echo $v?></td>
								<?php
									for ($i=0;$i<$num_products;$i++)
									{
										$cls = ($i==0)?'comparison_contentA':'comparison_contentB';
						...
						?>						  
						  <tr>
							<td colspan="<?php echo $num_products+1?>" align="left" valign="top" class="comparison_sec_header"><div class="reg_shlf_hdr_outrC"><div class="reg_shlf_hdr_in"><span><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_COMPGENFEATURE']);?></span></div></div></td>
						  </tr>
						  <?php 
						 } 
						  	if($desc==1)
						  ...
						  ?>
							  <tr>
								  <td align="left" valign="top" class="comparison_mainheadertop"><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_COMPDESC']);?></td>
								  <?php
									for ($i=0;$i<$num_products;$i++)
									{
										$cls = ($i==0)?'comparison_contentA':'comparison_contentB';
									?>
										  <td align="left" valign="top" class="<?php echo $cls?>"><?php echo stripslash_normal($compare_arr['description'][$i])?></td>
									<?php
									}
									?>	  
								</tr>
					  <?php
						...
						?>
							...
							<tr>
							<td align="left" valign="top" class="comparison_mainheader"><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_COMPVAR']);?></td>
							<?php
							for ($i=0;$i<$num_products;$i++)
							{
								$cls = ($i==0)?'comparison_contentA':'comparison_contentB';
					  ...
					  ?>
						   <tr>
							<td align="left" valign="top" class="comparison_mainheader"><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_COMPBULK']);?></td>
							 <?php
								for ($i=0;$i<$num_products;$i++)
								{
									$cls = ($i==0)?'comparison_contentA':'comparison_contentB';
					  ...
					  ?>
					  <tr>
						<td align="left" valign="top" class="comparison_mainheader"><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_COMPWEIGHT']);?></td>
						 <?php
							for ($i=0;$i<$num_products;$i++)
							{
								$cls = ($i==0)?'comparison_contentA':'comparison_contentB';
					  ...
					  ?>
					 <tr>
						<td align="left" valign="top" class="comparison_mainheader"><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_COMPSHIP']);?></td>
						 <?php
							for ($i=0;$i<$num_products;$i++)
							{
								$cls = ($i==0)?'comparison_contentA':'comparison_contentB';
					  ...
					  ?>
						  <tr>
							<td align="left" valign="top" class="comparison_mainheader"><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_COMPMANUFACT']);?></td>
							 <?php
								for ($i=0;$i<$num_products;$i++)
								{
									$cls = ($i==0)?'comparison_contentA':'comparison_contentB';
					  ...
					  ?>
							<tr>
							<td align="left" valign="top" class="comparison_mainheader"><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_COMPMODEL']);?></td>
							 <?php
								for ($i=0;$i<$num_products;$i++)
								{
									$cls = ($i==0)?'comparison_contentA':'comparison_contentB';
					  ...
					  ?>
						   <tr>
							<td align="left" valign="top" class="comparison_mainheader"><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_COMPPOINTS']);?></td>
							 <?php
								for ($i=0;$i<$num_products;$i++)
								{
									$cls = ($i==0)?'comparison_contentA':'comparison_contentB';
					  ...
					  // Check whether the free deliveryte
						...
						?>
					  <tr>
						<td align="left" valign="top" class="comparison_mainheader"><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_FREEDEL_CAPTION']);?></td>
						 <?php
							for ($i=0;$i<$num_products;$i++)
							{
								$cls = ($i==0)?'comparison_contentA':'comparison_contentB';
					  ...
					  // Check whether the product review module is active for the site
						...
						?>
					  <tr>
						<td align="left" valign="top" class="comparison_mainheaderbottom"><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_REVIEW_CAPTION']);?></td>
						 <?php
							for ($i=0;$i<$num_products;$i++)
							{
								$cls = ($i==0)?'comparison_contentA':'comparison_contentB';
...
<?php 
	...
	?>
		<table width="100%" border="0" cellpadding="0" cellspacing="1" class="prod_comparison_table">
		<tr>
			<td align="center" valign="top" class="prod_comparison_name"><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_COMPNOPROD']);?></td>
		</tr>
		</table>	
	<?php	
	}
