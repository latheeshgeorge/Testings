...
/*############################################################################
	...
	class advert_Html
	{
            ...
            function Show_Adverts($title,$advert_arr)
            {
                ...
                $HTML_Content = '';
				$HTML_normaltop_outer = '	<div class="advert_mid_con">
									<div class="advert_mid_top"></div>
									<div class="advert_mid_mid">
									<div class="advert_content">';
				$HTML_normalbottom_outer = '</div></div><div class="advert_mid_bottom"></div>
										</div>';
                        ...
                        if($proceed)
                        {
                            ...
                            switch ($k['advert_type'])
                            {
                                ...
                                case 'SWF': // case if advert is of type flash
                                    $path = url_root_image('adverts/'.$k['advert_source'],1);
                                    $link = $k['advert_link'];
                                    $HTML_Content .= '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="'.$ecom_selfhttp.'download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="552" height="280">
