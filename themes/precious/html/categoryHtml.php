	...
	class category_Html
	{
		...
		function Show_CategoryDetails($row_cat)
		{
			...
			//if ($row_cat['category_turnoff_pdf']==0)
			{
				...
				/*$HTML_icons .= '<!-- Web2PDF Converter Button BEGIN -->
							<script type="text/javascript">
							var
							pdfbuttonstyle="custimg"
							custimg="'.url_site_image('pdfico.gif',1).'"
							</script>
							<script src="http://www.web2pdfconvert.com/pdfbutton2.js" id="Web2PDF" type="text/javascript"></script>
							<!-- Web2PDF Converter Button END -->
							';*/
				//$HTML_icons .= '<a href="http://www.web2pdfconvert.com/convert" target="_blank"><img src="'.url_site_image('pdfico.gif',1).'" alt="download pdf"></a>';			
				//$HTML_icons .= '<a href="http://do.convertapi.com/web2pdf?curl=http://'.$ecom_hostname.'/'.$_SERVER['REQUEST_URI'].'"><img src="'.url_site_image('pdfico.gif',1).'"></a>';
				//$HTML_icons .= '<a  href="javascript:download_pdf_stream(\''.$_SERVER['HTTP_HOST'].'\',\''.$_SERVER['REQUEST_URI'].'\')" title="'.stripslash_normal($Captions_arr['CAT_DETAILS']['CATDET_DOWNLOADPDF']).'"><img src="'.url_site_image('pdfico.gif',1).'" alt="'.stripslash_normal($Captions_arr['CAT_DETAILS']['CATDET_DOWNLOADPDF']).'" border="0" /></a>';
				$HTML_icons .= '<a  href="javascript:download_pdf_stream(\''.$_SERVER['HTTP_HOST'].'\',\''.$_SERVER['REQUEST_URI'].'\')" title="'.stripslash_normal($Captions_arr['CAT_DETAILS']['CATDET_DOWNLOADPDF']).'"><img src="'.url_site_image('pdfico.gif',1).'" alt="'.stripslash_normal($Captions_arr['CAT_DETAILS']['CATDET_DOWNLOADPDF']).'" border="0" /></a>';
			}
	  ...
	  function download_pdf() 
	  {
		...
		<div class="sub_cate_hdr"><?php echo stripslashes($row_cat['category_name'])?></div>
