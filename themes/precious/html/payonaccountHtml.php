	...
	class payonaccountHtml
	{
            function show_payonaccount_request($alert='',$hide_status=0)
            {
                ...
                $Captions_arr['PAYONACC']       = getCaptions('PAYONACC');
				 $sql 							= "SELECT payon_account_details_content FROM general_settings_sites_common WHERE sites_site_id=".$ecom_siteid;
								...
								'<div class="tree_menu_conA">
								  ...
								  <div class="tree_menu_midA">
									...
									<li><a href="'.url_link('',1).'">'.stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']).'</a></li>
									 <li>'.stripslash_normal($Captions_arr['PAYONACC']['PAYONACCOUNT_MAINHEADING']).'</li>
									</ul>
									  </div>
								  </div>
				...
				<div class="cart_msg_topA"></div>
						<div class="cart_msg_txt">';
								$HTML_alert .= stripslash_normal($Captions_arr['PAYONACC'][$alert]);
				$HTML_alert .=	'</div>
				...
				echo $HTML_alert;
            ?>
				<div class="pay_on_banner"></div>
				<?php
				// Check whether payonaccount text is there or not
                if ($fetch_arr_admin['payon_account_details_content']!='')
                {
                	echo '<div class="pay_on_cont">'.stripslashes($fetch_arr_admin['payon_account_details_content']).'</div>';
                }
                        ...
                        ?>
                               <div class="chk_paymnt_btn">
								<div>
                                    ...
                                    <input type='submit' name='payonaccount_request_place' id ='payonaccount_request_place' class='buttonred_cart' value='<?php echo $Captions_arr['PAYONACC']['PAYONACC_PLACE_REQUEST']?>'/>
                                    </form>
								</div>
								</div>
                        <?php
                            ...
                            {
                        ?>
                               <div class="pay_on_message"><?php echo $show_status?></div>
                        <?php
                            }
                    }
                }
                else // case if not logged in
                {
					...
					$('.login_inner_input').each(function() {
					...
					<div class="login_inner_alert"><?php echo stripslash_normal($Captions_arr['CUST_LOGIN']['TOP_MSG'])?></div>
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="login_inner_table">
					<tr>
					<td><img src="<? url_site_image('lgoin-in-a.gif')?>" /></td>
					<td class="login_inner_top"><img src="<? url_site_image('lgoin-inb.gif')?>" /></td>
					</tr>
					<tr>
					<td class="login_inner_cnt">
					<div>             
					<input type="text" name="custlogin_uname" id="custlogin_uname" class="login_inner_input" value="Email Id" />
					</div>
					<div>
					<?php
					...
					{
					?>
					<input id="password-clear" type="text" value="Password" autocomplete="off"  class="login_inner_inputA"/>
					<?
					}
					?>
					<input id="password-password" type="password" name="custlogin_pass" value="" autocomplete="off"  class="login_inner_inputA"/> 
					</div>
					<div> <a href="javascript:document.frm_custlogin_payonacc.submit()"><img src="<? url_site_image('loin-inbt.gif')?>"  /></a></div>
					...
					<div> <a href="<?php url_link('registration.html?pagetype=payonacc')?>"><img src="<? url_site_image('login-btb.gif')?>"  border="0" /></a></div>
					</td>
					</tr>
					</table>
					</form>
			...
			<form name='frmpayonaccount_summary' action='<?php url_link('payonaccountpayment.html')?>' method="post">
				 ...
				 $where_conditions = " WHERE 
				   ...
				   <td colspan="2"></td><!--onclick="window.location='<?php //url_link('payonaccountpayment.html')?>'"-->
					<td align="right" class="usermenucontentA"><div id="make_pay_top_div"><? if($row_cust['customer_payonaccount_usedlimit']>0){?>
					<div style="margin-right:44%">
								<div class="cart_shop_cont"><div>
												<input  type="button" name="make_payment" value="<?php echo stripslash_normal($Captions_arr['PAYONACC']['MAKEPAY_BUTTON'])?>" class="inner_btn_red" onclick="handle_make_payment_top()" />
								</div></div>
								</div>
					
					<? }?></div></td>
					 <td colspan="2" class="usermenucontentA"><? if($numbillcount>0){?>	<div style="margin-right:44%">
								<div class="cart_shop_cont"><div><input type="button" name="view_statements" title="View Statements" value="<?php echo stripslash_normal($Captions_arr['PAYONACC']['VIEWSTATEMENT_BUTTON'])?>" class="buttonred_cart" onclick="window.location='<?php url_link('accountviewbills.html')?>'" /></div></div></div><? }?>
					</td>
				   </tr>
				   <? }?>
					...
					<td colspan="6" align="center">
						...
						<tr>
							...
							<td align="center" width="75%">
									<table cellspacing="4" cellpadding="4" border="0" width="100%" class="expandtable_cls" >
										<tr>
										...
										<td align="left"   width="71%" ><textarea name="pay_additional_details" id="pay_additional_details" cols="30" rows="5" class="regiinput"></textarea>
										  </td>
										</tr>
										<tr>
										   <td class="usermenucontentA"> <div class="cart_shop_cont"><div><input name="Cancel" type="button" class="inner_btn_red" id="cancel" value="<?php echo stripslash_normal($Captions_arr['PAYONACC']['CANCEL_BUTTON'])?>" onclick="handle_make_payment_cancel()"  /></div></div></td>
										  <td  align="left" valign="middle" class="usermenucontentA" ><div style="margin-right:44%"><div class="cart_shop_cont"><div><input name="make_payment" type="button" class="inner_btn_red" id="make_payment" value="<?php echo stripslash_normal($Captions_arr['PAYONACC']['MAKEPAY_BUTTON'])?>" onclick="validate_payment(this.form)" /></div></div></div> </td>
										</tr>
								</table>
							  </td>
								<td width="14%" >&nbsp;</td>
								...
								'<div class="tree_menu_conA">
								  ...
								  <div class="tree_menu_midA">
									<div class="tree_menu_content">
									  <ul class="tree_menu">
									<li><a href="'.url_link('',1).'">'.stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']).'</a></li>
									<li><a href="'.url_link('mypayonaccountpayment.html',1).'">'.stripslash_normal($Captions_arr['PAYONACC']['PAYONACCOUNT_MAINHEADING']).'</a></li>
									 <li>'.stripslash_normal($Captions_arr['PAYONACC']['VIEWBILLS_MAINHEADING']).'</li>
									</ul>
									  </div>
								  </div>
								  <div class="tree_menu_bottomA"></div>
					...
					$HTML_treemenu .=
								'<div class="tree_menu_conA">
								  ...
								  <div class="tree_menu_midA">
									...
									<li><a href="'.url_link('',1).'">'.stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']).'</a></li>
									<li><a href="'.url_link('mypayonaccountpayment.html',1).'">'.stripslash_normal($Captions_arr['PAYONACC']['PAYONACCOUNT_MAINHEADING']).'</a></li>
																		<li><a href="'.url_link('accountviewbills.html',1).'">'.stripslash_normal($Captions_arr['PAYONACC']['VIEWBILLS_MAINHEADING']).'</a></li>

									 <li>'.stripslash_normal($Captions_arr['PAYONACC']['VIEWBILLS_STATEMENT_ON']).dateFormat($closing_date,'datetime').'</li>
									</ul>
									  </div>
								  </div>
								  <div class="tree_menu_bottomA"></div>
...
<?php
	...
	<?php
					 if($Settings_arr['imageverification_req_payonaccount'] and $_REQUEST['pret']!=1)
	 	 {
					?>
					  ...
					  <tr>
					    <td colspan="4" align="left"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_REGISTRATION_CODE'])?> </td>
					    </tr>
					  <tr>
					    <td align="left" colspan="1"><img src="<?php url_verification_image('includes/vimg.php?size=4&amp;pass_vname=payonaccountpayment_Vimg&amp;bg=255 255 255&amp;brdr=255 255 255&fnt=255 0 0&circle=1')?>" border="0" alt="Image Verification" class="captcha"/></td>
  ...
  <td colspan="2">
	...
	<td colspan="2" align="left" valign="middle">	
		<table width="100%" cellpadding="1" cellspacing="1" border="0">
		<tr>
			<td colspan="2" align="left" class="chk_credit_hdr"><?php echo stripslash_normal($Captions_arr['PAYONACC']['PAY_ON_CHEQUE_DETAILS'])?></td>
		</tr>
		<?php
	...
	<tr id="payonaccount_self_tr" style="display:<?php echo $self_disp?>">
		...
		<table width="100%" cellpadding="1" cellspacing="1" border="0">
		<tr>
			<td colspan="2" align="left" class="chk_credit_hdr"><span class="reg_header"><span><?php echo stripslash_normal($Captions_arr['PAYONACC']['PAYON_CREDIT_CARD_DETAILS'])?></span></span></td>
		</tr>
		<?php
		...
		?>
				<tr>
					<td align="left" width="40%" class="regiconentA">
					<?php echo stripslash_normal($row_checkout['field_name']); if($row_checkout['field_req']==1) { echo '&nbsp;<span class="redtext">*</span>';}?>					</td>
					<td align="left" width="60%" class="regi_txtfeildA">
					<?php
	...
	?>
	 <tr>
    <td colspan="4" align="right" class="usermenucontentA">
	<div class="cart_shop_cont" ><div>
	<input name="payonaccount_payment_Submit" type="submit" class="inner_btn_red" id="payonaccount_payment_Submit" value="<?="Make Payment"?>"/></div></div></td>
    </tr>
	<?php
	}
        }
								...
								'<div class="tree_menu_conA">
								  ...
								  <div class="tree_menu_midA">
									<div class="tree_menu_content">
									  <ul class="tree_menu">
									<li><a href="'.url_link('',1).'">'.stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']).'</a></li>
									 <li>'.stripslash_normal($Captions_arr['PAYONACC']['PAYON_FAILED_TITLE']).'</li>
									</ul>
									  </div>
								  </div>
								  <div class="tree_menu_bottomA"></div>
				...
				$HTML_treemenu .=
								'<div class="tree_menu_conA">
								  ...
								  <div class="tree_menu_midA">
									...
									<li><a href="'.url_link('',1).'">'.stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']).'</a></li>
									<li><a href="'.url_link('mypayonaccountpayment.html',1).'">'.stripslash_normal($Captions_arr['PAYONACC']['PAYONACCOUNT_MAINHEADING']).'</a></li>
									 <li>'.stripslash_normal($Captions_arr['PAYONACC']['PAYON_BUY_TREEMENU_PREVIEWTITLE']).'</li>
									</ul>
									  </div>
								  </div>
								  <div class="tree_menu_bottomA"></div>
	...
	?>		
			...
			?>
			<tr>
				<td width="40%" class="emailfriendtextnormal" id="vouch_caption_td"><?=stripslash_normal($Captions_arr['PAYONACC']['PAY_AMT_LABEL'])?></td>
			...
			<?php
				...
				{
			?><tr>
			<td colspan="2" align="right" class="usermenucontentA">
						<div class="cart_shop_cont" ><div>
							<input type="button" name="submit_backhome" value="<?php echo stripslash_normal($Captions_arr['PAYONACC']['PAYON_PREVIEW_BACH_HOME'])?>" onclick="window.location ='<?php url_link('')?>'" class="inner_btn_red" />
						</div></div></td>
					</tr>	
			<?php
				}	
