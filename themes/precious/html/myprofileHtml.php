			...
			<option value="M/S." <?=($row_sql['customer_title']=='M/S.')?"selected":''?>>M/S.</option>
				    ...
				    <tr>
					    <td  colspan="4"  align="left" >
							<table width="100%" border="0" cellpadding="0" cellspacing="2" class="shoppingcarttable">
				      <tr>
					    <td  colspan="3"  align="left" >I give my permission for Dennis The Chemist to send me the following.Please tick 'Yes' or 'No' for each option.</td>
...
If you decide to change your preferences, you can do so at any time. Please just call our customer services team on 0161 773 1994 during office hours Monday to Friday and let us know what you want us to do. For example, you can call us to update your contact details or you can opt out from communications altogether. Alternatively, you can let us know your wishes by email: <strong><a href="mailto:info@dennisthechemist.com">info@dennisthechemist.com</a>.</strong></p>
<p><strong>Terms and Privacy:</strong></br>
Dennis The Chemist will keep your contact details safe. We will not share them with any other person or organisation. We will only contact you by the channels you have chosen (phone, email etc.) and we will only contact you about the subjects you have chosen. You may unsubscribe at any time. For more details, please see our privacy policy and data protection to see how we use and protect your data. <br/>
For more details, please check our <a href="<?php echo $ecom_selfhttp;?>www.dennisthechemist.com/privacy-policy-pg49687.html " target="_blank"><strong>data protection</strong></a> to see how we use and protect your data. 
</p>
</td>
						</tr>
				   <tr>
				     <td align="center" valign="middle" class="shoppingcartcontent" colspan="4" ><div class="cart_top_links"><div class="cart_shop_cont"><div><input class="inner_btn_red" id="myprofile_Submit" type="button" name="Submit" value="Save" onclick="javascript:add_newconsent(document.add_address)" /></div></td>
			        </tr>	
				</table>
				</form>	
				<script language="javascript">
