	...
	global $Captions_arr;
		...
		switch($mod)
		{
		  case 'Cart':
			...
			<tr>
			<td align="left" valign="middle"><a href="javascript:void(0)" onclick="unloadQuickviewPopupBox()"><input name="continue_submit" class="buttonred_cartQ" id="continue_submit" value="Continue Shopping"  type="button"></a>
			</td>
			<td align="right" valign="middle"><a href="<?php echo SITE_URL?>/cart.html"><input name="continue_submit" class="buttonred_cartQ" id="continue_submit" value="View Cart"  type="button" onclick="window.location='<?php echo SITE_URL?>/cart.html'" ></a></td>
			</tr>
			</table>
			</div>
			</div>
