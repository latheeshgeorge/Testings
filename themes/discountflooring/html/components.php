	...
	class components
	{
		...
		?>				
					...
					<form method="post" name="frm_quicksearch" class="frm_cls" action="<?php url_link('search.html')?>">
						...
						<tbody>
						<tr>
							<td class="inputAB"><input name="quick_search" type="text" class="inputAB" id="quick_search"  value="Search Discount Flooring" onFocus="if (this.value=='Search Discount Flooring') this.value='';" onBlur="if (this.value=='') this.value='Search Discount Flooring';"/>
					...
					if ($proceed)
					{
						...
						if ($db->num_rows($ret_prod))
						{
							...
							if($shelfData['shelf_currentstyle']=='nor' || $shelfData['shelf_currentstyle']=='new') // case of christmas layout
							{
								...
								{
								?>		<tr>
								<td class="catBoxWrap_threecolumn">
		...
		?>
			 ...
			 <?php
				...
				?>		
				  ...
				  ?>
							  <tr>
								<td width="2%" height="20" align="right" valign="middle" class="surveytabletd"><input name="survey_opt" type="radio" value="<?php echo $row_surveyopt['option_id']?>" /></td>
			  ...
			  ?>
				  <tr>
					<td align="left" valign="middle" class="surveytabletdbottom" colspan="2">
