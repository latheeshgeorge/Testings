			...
			<tr>
										...
										<tr>
											  ...
											  <option value="product_id" <?php echo ($prodsort_by=='product_id')?'selected="selected"':''?>><?php echo $Captions_arr['SEARCH']['SHOPDET_DATEADDED']?></option>		
												...
												?>
																		<?php /*<option value="9999" <?php echo ($prodperpage==9999)?'selected="selected"':''?>>display all</option> */?>
...
<?php
												...
												//if ($shelfData['shelf_showimage']==1)// Check whether description is to be displayed
												{
													?>
																...
																if(trim($row_search['product_shortdesc'])!='')
																{
																?>
																<div class="prod_list_shortdesc">
																	<?php echo stripslashes($row_search['product_shortdesc']) ?>
																</div>
																<?php
																}
