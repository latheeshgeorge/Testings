...
$j("#zoom_03").bind("click", function(e) {  
  ...
  return false;
		...
		*/ 
        ...
        if($ecom_siteid!=106 and $ecom_siteid!=104)
        {
			if($row_prod['product_saleicon_show']==1)
			{
				...
				if($desc!='')
				{
				?>	<div class="prod_details_sale"><?php //echo $desc ?>
				Seen This Item For Less? <span style='color:#a90303'>Call 01245 905144</span> For A Better Price
				</div>
				<?php		
				}
			}
...
function show_ProductVariables($row_prod,$pos='column')
{
				...
				if ($db->num_rows($ret_var) or $db->num_rows($ret_msg))
				{
					...
					padding-right: 5px;
						...
						.resize_thumb {
							width: 22px; /* enter desired thumb width here */
							height : auto;
						}
...
function show_offer_buttons($row_prod)
{
					...
					if($ecom_siteid==106 or $ecom_siteid==104)
					{
						...
						*/ 
						...
						{
						?>
						<div class="ins_banner_wrap"><img src="<?php url_site_image('price_promise_banner.png')?>" alt="" border="0"></div>
						<?php
						}
					}
					else
