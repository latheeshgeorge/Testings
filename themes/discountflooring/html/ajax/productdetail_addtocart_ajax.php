<?php
	...
	<?php
	if($productHtml->do_show_calculator()) // only for floorings online
					{    $hide_qty = true;
						 echo "<input type='hidden' name='show_calc' value='1' id='show_calc'/>";
						 $button_displayed   = $productHtml->show_buttons_ajax($row_outerprods,true);

						 $productHtml-> show_ProductVariables_special($row_outerprods,'','ajax');
					}
					else
					{  
