...
/*############################################################################
	...
	class newsletter_Html
	{
		...
		?>
		<div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?=stripslash_normal($Captions_arr['NEWS_LETTER']['NEWSLETTER_TREEMENU_TITLE'])?></div>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="8"  class="regitable">
			...
			?>	
			<tr>
				<td width="26%" class="regiconent"><?php echo stripslash_normal($Captions_arr['NEWS_LETTER']['TITLE'])?></td>
			...
			<tr>
				...
				<input name="newsletter_name" type="text" class="reginput" id="newsletter_name" size="35" value="<?=$_REQUEST['newsletter_name']?>" />				</td>
			</tr>	
			<?php
			}
			?>		 
			<tr>
				...
				<td align="left" valign="top" >
				<input name="newsletter_email" type="text" class="reginput" id="newsletter_email" size="35"  value="<?=$_REQUEST['newsletter_email']?>"/>				</td>
			</tr>
			<?php
			...
			<tr>
				...
				<td align="left" valign="top" >
				<input name="newsletter_phone" type="text" class="reginput" id="newsletter_phone" size="35" value="<?=$_REQUEST['newsletter_phone']?>"/>				</td>
			</tr>
			<?php
			}
			...
			?>
				<tr>
					<td valign="top" class="regiconent"><?php echo stripslash_normal($Captions_arr['NEWS_LETTER']['GROUP'])?></td>
								<td class="reginput_middle" valign="top">&nbsp;</td>
					...
					<td align="left" valign="middle" class="regiconent">&nbsp;
					  ...
					  <tr >
						...
						<?php 
			            	...
			            	$vImage->showCodBox(1,'newsletter_Vimg','class="reginput"'); 
						?>
						</td>
					</tr>
