	...
	<?PHP	
		...
		?>
		       <script type="text/javascript">
			    ...
			    function SearchProducts_cat()
				{ 
					
					var dataString = $j("#frm_cateproducts").serialize();
					 $j.ajax({
						   type: 'post',			   
						...
						if($from_filter == true)
							{
								...
								<input type="button" name="submit_Page" value="<?php echo $Captions_arr['CAT_DETAILS']['CATDET_GO']?>" class="buttonred" onclick="javascript: sortAction('bottom','catdet_sortorderbottom','catdet_sortbybottom','catdet_prodperpagebottom');" />														
								<?php
							}
							else
							{
