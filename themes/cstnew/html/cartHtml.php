          ...
          <div class="cart_cont_inner_cont">
			...
			<input type="hidden" name="hold_section" value="" />
			  ...
			  <tr>
				...
				<td class="cart_table_hidden"><?php echo stripslash_normal($Captions_arr['CART']['ACTION'])?></td>
				<td class="cart_table_hidden"><?php echo stripslash_normal($Captions_arr['CART']['CART_QTY'])?> </td>
  ...
  <tr>
   ...
   <?php
    ...
    <div class="cart_cont_inner_bottom"></div>
										  ...
										  $prod_cart_arr =array();
											  ...
											  ?>
												<tr class="cart_table">
													...
													<td align="left" valign="middle" class="cart_td_qty"><?php /*?><label><strong>
														<?php 
														if($products_arr['product_det_qty_type']=='DROP')
														{
															if (trim($products_arr['product_det_qty_drop_prefix'])!='')
		...
		<td align="left" valign="middle" class="cart_td_qty"><?php /*?><label>
		<?php 
...
<?php /*?>		<tr>
		...
		function Show_CheckoutSuccess($order_id=0)
		{
			...
			if ($order_id>0)
			{
				...
				$sql_ord = "SELECT order_totalprice,order_paystatus,order_cpc_keyword, order_cpc_se_id, order_cpc_click_id,order_paymenttype,
			...
			*/
			if($ecom_isadword)
			{
				...
				?>
						...
						<script type="text/javascript">
						/* <![CDATA[ */
						var google_conversion_id = 1068713674;
						var google_conversion_language = "en";
						var google_conversion_format = "3";
						var google_conversion_color = "ffffff";
						var google_conversion_label = "_46bCKz-1l8Qyo3N_QM";
						if (<?=$total_price?>) 
						{
						...
						<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/1068713674/?value=<?=$total_price?>&amp;currency_code=GBP&amp;label=_46bCKz-1l8Qyo3N_QM&amp;guid=ON&amp;script=0"/>
						</div>
						</noscript>
		...
		?>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="shoppingcarttable">
			  ...
			  <tr>
			  	<td align="left" class="cartsuccess_msg">
				<?php 
				if($order_id>0)
				{
					if($row_ord['order_paymenttype']=='pay_on_phone' or $row_ord['order_paymenttype']=='invoice')
					{
						$add_msg_text ='<br><br> Please Telephone 0161 688 7246 to Pay For Your Order';
					}
				}
		...
		?>
			...
			?>
					<tr>
						<td align="left" class="cartfail_msg">
