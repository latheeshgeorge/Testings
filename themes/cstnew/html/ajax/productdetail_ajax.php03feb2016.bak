	...
	function show_Variable_price_detail($product_id,$var_arr=array(),$qty=1)
	{
		...
		if ($db->num_rows($ret_prod))
		{
			...
			if($ecom_siteid==62) // case of eurolabels
			{
				...
				$price_class_arr['ul_class'] 		= 'deat_price';
				$price_class_arr['normal_class'] 	= 'deat_priceB';
				$price_class_arr['strike_class'] 	= 'deat_priceB';
				$price_class_arr['yousave_class'] 	= 'deat_priceCleft';
