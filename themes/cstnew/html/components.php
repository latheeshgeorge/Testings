						...
						<div class=" static_con">
							<ul>
								...
								if(count($grp_array))
								{
									...
									?>
										<li>
										<h2> <a href="<?php url_link('')?>" class="static_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?></span></a></h2>
										</li>
									<?php
									}
									...
									?>
										<li>
										<h2> <a href="<?php if ($row_pg['page_type']=='Page') urlencode(url_static_page($row_pg['page_id'],$row_pg['title'])); else echo $row_pg['page_link'];?>" class="static_menu" title="<?php echo str_replace('&','&amp;',stripslash_normal($row_pg['title']))?>" <?php echo $target?>><span><?php echo stripslash_normal(str_replace('&','&amp;',$row_pg['title']));?></span></a></h2>
										</li>
									<?php
									}
									...
									?>
										<li>
										<h2> <a href="<?php url_link('sitemap.xml')?>" class="static_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP'])?></span></a></h2>
										</li>
									<?php	
									}
									...
									?>
										<li>
										<h2> <a href="<?php url_link('sitemap.html')?>" class="static_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SITEMAP'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SITEMAP'])?></span></a></h2>
										</li>
									<?php		
									}
									...
									?>
										<li>
										<h2> <a href="<?php url_link('saved-search.html')?>" class="static_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH'])?></span></a></h2>
										</li>
									<?php		
									}
									...
									?>
										<li>
										<h2> <a href="<?php url_link('help.html')?>" class="static_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HELP'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HELP'])?></span></a></h2>
										</li>
									<?php
									}
					  ...
					  $show_top = $show_bottom = 0;
						...
						<ul id="main_navigation">
							...
							if(count($grp_array))
							{
								...
								{
								?>
									<li class="item1"><h2><a href="<?php url_link('')?>" class="category_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?></span></a></h2></li>
								<?php
								}
								while ($row_pg = $db->fetch_array($ret_pg))
								{
									$target = ($row_pg['page_link_newwindow']==1 and $row_pg['page_type']!='Page')?'target="_blank"':'';
								?>
									<li class="item1"><h2><a href="<?php if ($row_pg['page_type']=='Page') url_static_page($row_pg['page_id'],$row_pg['title']); else echo $row_pg['page_link'];?>" class="category_menu" title="<?php echo stripslash_normal(str_replace('&','&amp;',$row_pg['title']))?>" <?php echo $target?>><span><?php echo stripslash_normal(str_replace('&','&amp;',$row_pg['title']));?></span></a></h2></li>
								<?php
								}
								if ($grpData['group_showxmlsitemaplink']==1 )
								{
								?>
									<li class="item1"><h2><a href="<?php url_link('sitemap.xml')?>" class="category_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP'])?></span></a></h2></li>
								<?php	
								}
								if ($grpData['group_showsitemaplink']==1 ) 
								{
								?>
									<li class="item1"><h2><a href="<?php url_link('sitemap.html')?>" class="category_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SITEMAP'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SITEMAP'])?></span></a></h2></li>
								<?php		
								}
								if ($grpData['group_showsavedsearchlink']==1)
								{
								?>
									<li class="item1"><h2><a href="<?php url_link('saved-search.html')?>" class="category_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH'])?></span></a></h2></li>
								<?php		
								}
								if ($grpData['group_showhelplink']==1 )
								{
								?>
									<li class="item1"><h2><a href="<?php url_link('help.html')?>" class="category_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HELP'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HELP'])?></span></a></h2></li>
								<?php
								}
								if ($grpData['group_showfaqlink']==1 )
								{
								?>
									<li class="item1"><h2><a href="<?php url_link('faq.html')?>" class="category_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_FAQ'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_FAQ'])?></span></a></h2></li>
								<?php
								}
								}
							}		
						...
						<div class="static_con_bottom">
							<ul >
								...
								$target = ($row_pg['page_link_newwindow']==1 and $row_pg['page_type']!='Page')?'target="_blank"':'';
									?>
									<li>
									<h4><a href="<?php if ($row_pg['page_type']=='Page') url_static_page($row_pg['page_id'],$row_pg['title']); else echo $row_pg['page_link'];?>" class="bottomlink" title="<?php echo stripslash_normal(str_replace('&','&amp;',$row_pg['title']))?>" <?php echo $target?>><?php echo stripslash_normal(str_replace('&','&amp;',$row_pg['title']));?></a></h4>
									</li>
									<?php
								}
								}
						...
						if(count($grp_array))
						{
							...
							<div class="static_lf_top"></div>
								...
								<?php		
										...
										?>
                                <li>
                                <h2> <a href="<?php url_link('faq.html')?>" class="staticlink" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_FAQ'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_FAQ'])?></a></h2>
                                </li>
										<?php
										}
										if ($grpData['group_showsavedsearchlink']==1)
								...
								$sql_cat = "SELECT a.category_id,a.category_name,parent_id,b.category_displaytype,b.category_islink,a.category_subcatlisttype   
									...
									if ($db->num_rows($ret_cat))
									{
										...
										while ($row_cat = $db->fetch_array($ret_cat))
										{
											...
											{
											?>
												<li class="category_header_li">
												<h2 class="category_header_lih2"><span class="subcategoryheader"><a href="<?php url_category($row_cat['category_id'],$row_cat['category_name'],-1)?>" class="subcategoryheaderlink" title="<?php echo stripslash_normal($row_cat['category_name'])?>"><?php echo ucwords(stripslash_normal($row_cat['category_name']));?></a></span></h2>
											<?
												$entered = 1;
											}
											elseif($row_cat['category_displaytype']=='Heading' && !$row_cat['category_islink'])
											...
											?>
												<li class="category_header_li">
												<h2 class="category_header_lih2"><span class="subcategoryheader"><?php echo ucwords(stripslash_normal($row_cat['category_name']));?></span></h2>
											<?
											}
...
<?
			...
			?>
					...
					{
				?>
				<li><h2><a href="<?php url_link('gdproptin.html')?>" class="userloginmenulink">GDPR Opt-In Form</a></h2></li>
				<?php
					}
				?>
								<li>
...
<?
		...
		function mod_shoppingcart($title)
		{
			...
			if ($position=='top' or $position=='topband') // Best sellers is allowed in left or right panels
			{	
			?>
				<div id="shoppingcart_ajax_container">
				<div class="cart_outer_in">
				<div class="cart_con">
				...
				<form method="post" name="frm_quicksearch" class="frm_cls" action="<?php url_link('search.html')?>">
				  <div class="search_inner">
					<div class="search_input">
					  <input name="quick_search" type="text" class="searchinput" id="quick_search"  value="Search.." onfocus="if(this.value=='Search..') this.value ='';" onblur="if(this.value=='') this.value='Search..'"/>
					</div>
					<div class="search_btn">
					  <input name="button_submit_search" type="image" src="<?php url_site_image('search-btn.gif')?>" onclick="javascript:document.frm_quicksearch.submit()" />
					</div>
							...
							?>
										...
										<div class="combo_deal_lf_top"></div>
											...
											?>
												...
												<div class="combo_deal_pdt_topF"><?php echo stripslash_normal($Captions_arr['COMBO']['COMBO_BUNDLE_PRICE'])?>&nbsp;<?php echo print_price($bundle_price)	?></div>
												</div>
				...
				foreach ($shelf_arr as $k=>$shelfData)
				{
					...
					if ($proceed)
					{
									...
									<div class="spcl_shlf_lf_con">
										...
										?>
											...
											if($row_prod['product_newicon_show']==1)
											{
												...
												if($desc!='')
												{
													  $HTML_sale = '<div class="normal_shlfA_pdt_new"></div>';
												}
											}
											...
											<?php
																	$frm_name = uniqid('shelfhome_');
													?>
																												<div class="prod_list_buy_home">
						...
						<?php			$class_arr['ADD_TO_CART']       = '';
											...
											<?php
											/*
											<div class="spcl_shlf_pdt_bottom"> <a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" title="<?php echo stripslash_normal($row_prod['product_name'])?>">Enquire</a> </div>
											*/
											?> 
										</div>
										<?	
					...
					<form name="frm_newsletter" method="post" action="" class="frm_cls" onsubmit="return newsletter_validation(this)">
						<div class="newsletter_inner">
							<div class="offer_text">
							  special offers &amp; discounts direct to your inbox

							</div>
						  <div class="newsletter_input">
							<input name="newsletter_email" type="text" class="newsletterinput" id="newsletter_email" size="12" value="Email Id.." onfocus="if(this.value=='Email Id..') this.value ='';" onblur="if(this.value=='') this.value='Email Id..';" />
						  </div>
						  <?php 
						...
						if($cache_exists!=true)
						{
							...
							{	
								...
								elseif($position == 'topband')
								{
									...
									?>
									<script  type="text/javascript" src="<?php echo url_head_link("images/".$ecom_hostname."/scripts/crawler.js",1)?>"></script>
									<div class="shp_brnd_con">
									<div class="shp_brnd_left"></div>
									<div class="shp_brnd_mid">
									<div class="marquee" id="mycrawler2">
									<div class="shp_brnd_thumbimg_con">
<?php /*?>									  <div class="shp_brnd_nav"><a href="<?php url_link('shopbybrand.html')?>" onmouseover="scrollDivRight('<?=$divid?>')" onmouseout="stopMe()"><img src="<?php url_site_image('top-shop-arrow-left.gif')?>"></a></div><?php */?>
									  <div id="<?=$divid?>" class="shp_brnd_thumbimg_inner">
										<div id="shp_brnd_thumb" style="width:<?php echo $div_width?>px">
										  <?=$HTML_Content?>
										</div>
									  </div>
									  <?php /*?><div class="shp_brnd_nav"><a href="<?php url_link('shopbybrand.html')?>" onmouseover="scrollDivLeft('<?=$divid?>',<?php echo ($cnts*173)?>)" onmouseout="stopMe()"><img src="<?php url_site_image('top-shop-arrow-right.gif')?>"></a></div><?php */?>
									</div>
									</div>
									</div>
				...
				?>
					...
					?>
							<div class="pre_odr_pdt_outer">
							  ...
							  <div class="pre_odr_pdt_mid"><a href="<?php echo url_product($row_main['product_id'],$row_main['product_name'],-1)?>" class="preordprodlink" title="<?php echo stripslash_normal($row_main['product_name'])?>">
							  <?php
														$pass_type = 'image_thumbcategorypath';
														// Calling the function to get the image to be shown
														$img_arr = get_imagelist('prod',$row_main['product_id'],$pass_type,0,0,1);
							  ...
							  <div class="pre_odr_pdt_bottom"><a href="<?php echo url_product($row_main['product_id'],$row_main['product_name'],-1)?>" class="preordprodlink" title="<?php echo stripslash_normal($row_main['product_name'])?>"><?php echo stripslash_normal($row_main['product_name'])?></a></div>
							</div>
					<?
							}
						}
