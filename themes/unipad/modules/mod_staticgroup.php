<?php
	...
	if ($_REQUEST['product_id']) // If specific product is selected
	{
		$sql_grp = "SELECT a.group_id,a.group_name,group_hide,group_hidename,
							group_showhomelink,group_showsitemaplink,group_showhelplink,group_showsavedsearchlink,group_showxmlsitemaplink,group_showfaqlink,group_listtype      
					FROM 
