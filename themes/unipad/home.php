...
<head>
    ...
    require("head.php");
	echo "     <link href=\"".url_head_link("images/".$ecom_hostname."/".$css_folder."/".$ecom_themename.".css",1)."\" media=\"print\" type=\"text/css\" rel=\"stylesheet\" />";
...
<div class="wrapper">
    ...
    <div class="middle_header">
        <div class="middlebanner">
            <div class="rotator">
                <div id="sliderb_container" style="position: relative; width: 673px; height: 396px; overflow: hidden;">
                    <!-- Loading Screen -->
                    <div u="loading" style="position: absolute; top: 0px; left: 0px;">
                        <div style="filter: alpha(opacity=70); opacity:0.7; position: absolute; display: block; background-color: #000; top: 0px; left: 0px;width: 100%;height:100%;"></div>
                        <div style="position: absolute; display: block; background: url(<?php url_site_image('loading.gif')?>) no-repeat center center; top: 0px; left: 0px;width: 100%;height:100%;"></div>
                    </div>
                    <?php
                        $position = 'topband-left';
    ...
    <div class="middlecontent">
        <div class="middle">
            <div class="welcomewrap">
                <div class="welcome">
                    <?php
                        //$position = 'middleband-left';
                        include("mainbody.php");
                    ?>
                </div>
                <div class="featurewrap">
                <?php
                    $position = 'middleband-right';
                    include("Components.php");
                ?>
                </div>
            </div>		
