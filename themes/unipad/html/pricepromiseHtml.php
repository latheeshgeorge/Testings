			  ...
			  $session_id = session_id();	
			   $HTML_img = $HTML_alert = $HTML_treemenu='';
				...
				'<div class="treemenu">
					...
					if($product_id!=0)
					{
					 $HTML_treemenu .='<span>&raquo;</span><a href="'.url_product($product_id,$prod_name,1).'">'.$prod_name.'</a>';
					}
					$HTML_treemenu .='<span>&raquo;</span>'.stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_TREEMENU_TITLE']).'
					</div>';
				echo $HTML_treemenu;
		   		$varN = 'var_';
				$varM = 'varmsg_';
					...
					<? }?>
						<div class="reg_shlf_cont_div">
							...
							<table  border="0" cellpadding="2" cellspacing="3" width="100%" class="userordertablestyleA">
							  ...
							  <tr>
								<td width="11%" nowrap="nowrap" class="usermenucontent" valign="middle"><input name="prm_fromdate" class="textfeild" type="text" size="8" value="<?php echo $_REQUEST['prm_fromdate']?>" /></td>
								<td width="6%" nowrap="nowrap" valign="middle"><a href="javascript:show_calendar('frm_promise.prm_fromdate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('show-calendar.gif')?>" width="24" height="22" border="0" /></a></td>
								<td width="5%" nowrap="nowrap" class="usermenucontent" valign="middle"><?php echo stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICEPROM_AND'])?></td>
								<td width="11%" nowrap="nowrap" class="usermenucontent" valign="middle"><input name="prm_todate" class="textfeild" id="prm_todate" type="text" size="8" value="<?php echo $_REQUEST['prm_todate']?>" />
								...
								<td width="10%" nowrap="nowrap" valign="middle"><a href="javascript:show_calendar('frm_promise.prm_todate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('show-calendar.gif')?>" width="24" height="22" border="0" /></a></td>
								<td width="7%" nowrap="nowrap" valign="middle"><?php echo $sort_option_txt;?></td>
								<td width="5%" nowrap="nowrap" class="usermenucontent" valign="middle"><?php echo stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICEPROM_IN'])?></td>
								<td width="7%" nowrap="nowrap" valign="middle"><?php echo $sort_by_txt?></td>
								<td class="usermenucontentAz" width="38%">	
								<div class="cart_shop_cont"><div>
								<input name="Search_go" type="submit" class="inner_btn_red" id="Search_go" value="Go" onclick="document.frm_promise.search_click.value=1" />
								</div></div></td>
							  </tr>
							</table></td>
							</tr>
