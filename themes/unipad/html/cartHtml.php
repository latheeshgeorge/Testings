<?php
	...
	class cart_Html
	{
		...
		function Show_Cart()
		{
			...
			$HTML_treemenu = '<div class="treemenu"><a href="'.url_link('',1).'" title="'.stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']).'">'.stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']).'</a><span>&raquo;</span>'.stripslash_normal($Captions_arr['CART']['CART_MAINHEADING']).'</div>';
                            ...
                            { // Check whether logged in 
                                ...
                                if ($cust_id) // Case logged in 
                                {
									 $ctsr_arr = array('Mr.','Mrs.','Miss.','Ms.','M/s.','Dr.','Sir.','Rev.');
				                       $ctrp_arr = array('','','','','','','','');
                                      $HTML_topdesc1 .=' <div class="cart_top_info_name">'.stripslash_normal($Captions_arr['CART']['CART_LOGGED_IN_AS']).'&nbsp;'.str_replace($ctsr_arr,$ctrp_arr,get_session_var('ecom_login_customer_shortname')).'</div>
                    ...
                    <tr>
                        <td colspan="2" align="left" valign="top"><table class="cart_table" width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                    <td align="left" valign="top" class="cart_table_cntsA" colspan="2">
                                        <?php
                                        if (count($cartData['products'])!=0) // Done to show the message if no products in cart
                                        {
                                            ?>
                                                ...
                                                <tbody>
												 ...
												 <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <table class="cart_bonus_table" width="40%" border="0" cellpadding="0" cellspacing="0">
                                                        <tbody>
                        ...
                        if(is_Feature_exists($module_name)) // Check whether giftwrap module exists for the current site
                        {
                            ...
                            <?php
                                                ...
                                                ?>
                                                    <tr>
                                                        <td align="right" valign="middle" class="cart_VAT" ><?php echo stripslash_normal($Captions_arr['CART']['CART_SPENT_BONUS_POINTS_VALUE'])?>&nbsp; </td>
                                                        <td align="right" valign="middle" class="cart_VAT">(-) <? echo print_price($cartData["bonus"]["value"],true);?></td>
                                                    </tr>
                                                <?php			
                                                }
                                                ...
                                                ?>
                                                <tr>
                                                    <td align="right" valign="middle" class="cart_VAT">
                                                    <?php 
                                                    if ($row_cartdet['promotionalcode_id']!=0 and $cartData["bonus"]['type']=='promotional' and $cartData['totals']['pro_type']!='product')
                                                    {
                                                        ?>
		...
		function Show_Checkout()
		{
			...
			if($protectedUrl)
				...
				$http = url_link('checkout.html',1);	
						...
						$HTML_treemenu = '<div class="treemenu"><a href="'.url_link('',1).'" title="'.stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']).'">'.stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']).'</a><span>&raquo;</span>'.stripslash_normal($Captions_arr['CART']['CART_CHECKOUTHEADING']).'</div>';
				...
				<div class="cart_cont">    
					<div class="cart_cont_outr">
						...
						?>
							...
							?>
									<tr>
										<td colspan="2" class="checkout_hdr"><?php echo "Main Tenant Details"; ?></td>
									</tr>
									<?php
									...
									<tr>
										...
										<?php
											...
											if(($cartData['totals']['qty'])>1)
											{
											  ...
											  ?>
											  <tr>
										<td colspan="2" align="left" valign="middle" class= "tenant_header" onclick="expand_tenant('<?php echo $tenantname;?>','<?php echo $ecom_hostname?>')"> <img id="refunddet_imgtag<?php echo $tenantname;?>" src="<?php echo url_site_image('imgpsh_fullsize.png')?>"  title="Click" border="0">&nbsp;<strong><?php echo "Details of Tenant ".$cnt; ?></strong>
											</td>
											</tr>
											  <tr id="<?php echo $tenantname;?>">
										<td colspan="2" align="right" valign="middle">
										<table width="100%" cellpadding="1" cellspacing="1" border="0">
										<?php
											// Get the list of billing address static fields to be shown in the checkout out page in required order
															...
															{		
																...
																?>
																	<tr>
																		...
																		<?php
																		$class_array['txtarea_cls'] = 'regiinput';
																			echo get_Field_tenant($ext_name,$ext_name.$row_checkout['field_key'],$saved_checkoutvals_extrabilling,$cartData['customer'],'',$class_array);
																		?>
																		</td>
																	</tr>
															<?php
											...
											?>
											<script type="text/javascript">
												function expand_tenant(tenant,host)
											{
												
												imgobj = eval("document.getElementById('refunddet_imgtag"+tenant+"')"); 
												obj = eval("document.getElementById('"+tenant+"')");
											   if(obj.style.display=='')
											   {
											   obj.style.display ='none';
											   imgobj.src = 'http://'+host+'/images/'+host+'/site_images/imgpll_fullsize .png';
											   }
											   else
											   {
												 obj.style.display ='';
												  imgobj.src = 'http://'+host+'/images/'+host+'/site_images/imgpsh_fullsize.png';
												...
												<td colspan="6" align="right" valign="top" class="chk_td_price">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														...
														if ($deliverydet_Arr['delivery_type'] != 'None') // Check whether any delivery method is selected for the site
														{
															...
															?>	
																		<tr>
																			<td  align="center" valign="top" class="cart_del_charge_left" colspan="2"><?php echo stripslash_normal($Captions_arr['CART']['CART_DELIVERY_LOC'])?>&nbsp;: &nbsp;<?php echo stripslash_normal($row_loc['location_name'])?></td>
																		</tr>
															<?php
																	}
																}
															...
															?>	
																		<tr>
																			<td  align="center" valign="top" class="cart_del_charge_left" colspan="2"><?php echo stripslash_normal($Captions_arr['CART']['CART_DELIVERY_OPT'])?>&nbsp;:&nbsp;<?php echo stripslash_normal($row_grp['delivery_group_name'])?></td>
																		</tr>
															<?php
																	}
																}	
...
*/														}
													  ...
													  <?php
														 ...
														 ?>
																<tr>
																	<td align="right" valign="middle" class="cart_del_charge"><div align="">
																	<?php echo stripslash_normal($Captions_arr['CART']['CART_TAX_CHARGE_APPLIED'])?>
																	<?	
																		foreach($cartData["tax"] as $tax)
																		{
		...
		$auto_submit	= false;
		$HTML_treemenu = '<div class="treemenu"><a href="'.url_link('',1).'" title="'.stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']).'">'.stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']).'</a><span>&raquo;</span>'.stripslash_normal($Captions_arr['CART']['CART_CHECKOUTPREVIEWHEADING']).'</div>';
		...
		<div align="right" style="float:right;"><input class="buttonpaypalconfirm_cart" type="button" onclick="show_wait_button(this,'Please Wait...');gobackto_cart('<?php echo ($protectedUrl)? base64_encode($ecom_hostname):$ecom_hostname?>')" value="<?php echo stripslash_normal($Captions_arr['CART']['CART_BACK_CARTPAGE'])?>" /></div>
		...
		?>
		<tr>
		<td colspan="2" class="checkout_hdr">Main Tenant Details</td>
		</tr>
		...
		*/	
		...
		{	
			?>
			<tr>
				<td colspan="2" class="checkout_hdr" onclick="expand_tenant('<?php echo $tenant_name;?>','<?php echo $ecom_hostname?>')"><img id="refunddet_imgtag<?php echo $tenant_name;?>" src="<?php echo url_site_image('imgpsh_fullsize.png')?>"  title="Click" border="0">&nbsp;<?php echo $tenantname ." details"?></td>
			</tr>
			<tr id="<?php echo $tenant_name;?>">
				<td colspan="2" >
		      <table width="100%" cellpadding="1" cellspacing="1" border="0">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr >
		<td class="cart_table_header" colspan="3"><?php echo stripslash_normal($Captions_arr['CART']['CART_ITEM'])?> </td>
		<td class="cart_table_header"><?php echo stripslash_normal($Captions_arr['CART']['CART_QTY'])?></td>
		...
		<td align="left" valign="middle" class="cart_td_name" colspan="2"><a href="<?php echo url_product($row_orddet['products_product_id'],$row_orddet['product_name'])?>" title="<?php echo $row_orddet['product_name']?>" class="shoppingcartprod_link"><?php echo $row_orddet['product_name']?></a></td>
		<td align="left" valign="middle" class="cart_td_qty"><label>
		<?php 
		...
		function Show_CheckoutSuccess($order_id=0)
		{
			...
			*/
			...
			$HTML_treemenu1 = '<div class="tree_menu_conB">
						...
						$HTML_treemenu = '<div class="treemenu"><a href="'.url_link('',1).'" title="'.stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']).'">'.stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']).'</a><span>&raquo;</span>'.stripslash_normal($Captions_arr['CART']['CART_CHECKOUT_SUCCESS_TITLE']).'</div>';
