	...
	class enquiry_Html
	{
	  function enquiry_Showform()
	  {
		...
		$HTML_img = $HTML_alert = $HTML_treemenu='';
				$HTML_treemenu .=
				'<div class="treemenu">
					<span>&raquo;</span><a href="'.url_link('',1).'">'.stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']).'</a>
					<span>&raquo;</span>'.stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_MAINHEADING']).'
				</div>';
				echo $HTML_treemenu;
		?>
	...
	<?php 
			...
			?>
			 <tr>
				...
				<?php /*<td class="cart_table_header" align="right"><?php echo stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_NOTE'])?></td>
				*/ ?>
		...
		while($row_select_enq = $db->fetch_array($ret_select_enq))
		{
			...
			<?php 
			 ...
			 <?php
			 /*
			 <td colspan="2" align="right" valign="top" class="cart_td_delete_new"><img src="<?php url_site_image('enquire_note.gif')?>" onclick="add_Enquire_notes(frm_enquire,'<?=$row_select_enq['enquiry_id']?>')" alt="Add Notes" title="Add Notes" /></td>
			 */
			 ?> 
			</tr>
			<?php
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="cart_login_table">
					  <tr>
						<td class="cart_login_td_left">
							...
							<tr>
							<td align="left" valign="middle"><input type="button" name="button2" id="button2" value="Submit"  class="cart_login_button" onclick="submit_enquirecust_login('frm_custlogin_enquire');"/></td>
							</tr>
							<tr>
							...
							<tr>
							<td align="left" valign="middle" ><span class='enquiry_new_user'>New User?</span></td>
							</tr>
							<tr>
							<td align="left" valign="middle">&nbsp;</td>
							</tr>
							<tr>
							<td align="left" valign="middle"><a href="<?php url_link('registration.html?pagetype=cart')?>"><input type="button" name="button3" id="button3" value="Submit"  class="cart_newuser_button" /></a></td>
							</tr>
							</table></td>
					  </tr>
					</table>
	...
	function enquiry_Fillform($alert,$cust_id,$prod_cart_arr)
	{
		  ...
		  ?>
			...
			function validate_defaultregistration(frm)
			{
				...
				fieldDescription 	= Array('<?=stripslash_javascript($Captions_arr['ENQUIRE']['ENQUIRE_DET_FNAME'])?>','<?=stripslash_javascript($Captions_arr['ENQUIRE']['ENQUIRE_DET_LNAME'])?>','<?=stripslash_javascript($Captions_arr['ENQUIRE']['ENQUIRE_DET_EMAIL'])?>');
		...
		$HTML_treemenu .= '<div class="treemenu">
							<span>&raquo;</span><a href="'.url_link('',1).'">'.stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']).'</a>
							<span>&raquo;</span><a href="'.url_link('enquiry.html',1).'">'.stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_MAINHEADING']).'</a>
							<span>&raquo;</span>'.stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_DET_MAIN']).'
						</div>';
		//echo $HTML_treemenu;
	   ...
	   ?>
           ...
           <div class="reg_shlf_pdt_con"> 
			...
			?>
			  ...
			  */?> 
			  <tr>
				<td class="regiconentABC" align="left" valign="top" width="19%"><?=stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_DET_FNAME'])?><span class="redtext">*</span></td>
			...
			?>
				<tr>
			<td class="" >&nbsp;</td>
			<td class="regi_txtfeildA" >
			<input name="enquiry_submit" type="submit" class="inner_btn_redAB" id="enquiry_submit" value="Send" />
			</td>
			</tr>
				</table>
			 </div>
	 ...
	 function Display_Message()
	 {
		...
		function myenquiry_Enquiry($custid)
		{
			...
			$HTML_treemenu .=
				'<div class="treemenu">
					...
					<span>&raquo;</span>'.stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_MYENQUIRYHEADING']).'
				</div>';
				echo $HTML_treemenu;
				?>
				...
				<tr>
				<td  colspan="3"><table cellpadding="0" cellspacing="0" width="100%"  class="userordertablestyleA"><tr>
				<td  align="right"  class="usermenucontent" valign="middle" width="10%">Date From</td>
                <td  align="left" class="usermenucontent" valign="middle"  width="9%"> <input class="textfeild" type="text" name="srch_review_startdate" size="8" value="<?=$_REQUEST['srch_review_startdate']?>"  /></td>
                <td width="9%" nowrap="nowrap" class="usermenucontent"><a href="javascript:show_calendar('my_enquire.srch_review_startdate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;" class="caldivmid"><img src="<?php url_site_image('show-calendar.gif')?>" width="24" height="22" border="0" /></a></td>
                <td  align="right"  class="usermenucontent" valign="middle" width="9%">Date To </td>
				<td  align="left"  class="usermenucontent" valign="top"  nowrap="nowrap" width="16%">  
				<input class="textfeild" type="text" name="srch_review_enddate" size="8" value="<?=$_REQUEST['srch_review_enddate']?>"  /></td>
                <td width="10%" nowrap="nowrap"><a href="javascript:show_calendar('my_enquire.srch_review_enddate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;" class="caldivmid"><img src="<?php url_site_image('show-calendar.gif')?>" width="24" height="22" border="0" /></a></td>
                <td width="44%" nowrap="nowrap"></td></tr>
				<tr><td class="usermenucontent" valign="middle">Status </td><td class="usermenucontent" valign="middle"></td><td class="usermenucontent" valign="middle" colspan="5">Sort By</td></tr>
				<tr>
				
				<td class="usermenucontent" valign="top" colspan="2"><select name="search_status"  id="search_status">
				...
				</td><td  nowrap="nowrap" colspan="2" valign='top'><?php echo $sort_option_txt;?>&nbsp;in</td>
				<td width="16%" nowrap="nowrap" valign='top'><?php echo $sort_by_txt?></td>
				<td class="usermenucontentA" valign='top' colspan="4">	
		...
		function myenquiry_EnquiryDetails($enqid)
		{
			...
			$HTML_treemenu .=
				'<div class="treemenu">
					<a href="'.url_link('',1).'">'.stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']).'</a>
					<span>&raquo;</span><a href="">'.stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_MYENQUIRYHEADING']).'</a>
					<span>&raquo;</span>'.stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_DET_MAIN']).'
				</div>';
				echo $HTML_treemenu;
			?>
			...
			<tr><td class="shoppingcartcontent" colspan="4"><table cellpadding="3" cellspacing="4" border="0" width="100%" class="enquiry_detA">
