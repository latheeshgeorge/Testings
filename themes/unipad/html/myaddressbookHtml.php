	...
	class myaddressbook_Html
	{
		function Show_AddressBook(){
				...
				$HTML_treemenu = '<div class="treemenu">
									...
									<span>&raquo;</span>'.stripslash_normal($Captions_arr['ADDRESSBOOK']['TREE_MENU_ADDRESSBOOK']).'
								</div>';
								if($alert)
								{ 
								$HTML_alert .= 
				...
				<div class="reg_shlf_inner">
					...
					<table width="100%" border="0" cellpadding="3" cellspacing="0" class="reg_table">
					 <tr>
					   <td colspan="5">
						<table cellpadding="3" cellspacing="0" width="100%" class="userordertablestyleA">
						<tr>
						<td width="30%" class="usermenucontent">Contact Name  
						<input class="textfeild" type="text" name="contact_name" size="8" value="<?=$_REQUEST['contact_name']?>"  /></td>
						<td width="30%"  class="usermenucontent" >Contact Email
						<input class="textfeild" type="text" name="contact_email" size="8" value="<?=$_REQUEST['contact_email']?>"  /> </td>
						<td class="usermenucontentA" colspan="2">	
				...
				?>
				  <tr>
					<td align="center" colspan="5" class="usermenucontentA"> <div class="cart_shop_cont"><div class="address_addA"><input name="address_add" type="button" class="inner_btn_red" id="address_add" value="<?php echo stripslash_normal($Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_ADD'])?>" onclick="javascript:add_address(document.my_addressbook)" />	</div></div></td>
		...
		function Add_AddressBook(){
				...
				$HTML_treemenu = '<div class="treemenu">
									<a href="'.url_link('',1).'">'.stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']).'</a>
									<span>&raquo;</span><a href="'.url_link('myaddressbook.html',1).'">'.stripslash_normal($Captions_arr['ADDRESSBOOK']['TREE_MENU_ADDRESSBOOK']).'</a>
									<span>&raquo;</span>'.stripslash_normal($Captions_arr['ADDRESSBOOK']['TREE_MENU_ADD_ADDRESSBOOK']).'
								</div>';
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="2" class="reg_table">
				...
				<tr>
					...
					<td width="51%"  align="left" class="regi_txtfeildA" ><input type="text" name="faxnumber" value="<?=$_REQUEST['faxnumber'] ?>" maxlength="<?=$short?>"/></td>
				</tr>
				<td class="usermenucontentA" colspan="3">&nbsp;</td>	
				<td class="usermenucontentA" colspan="2" align="left">
				<div style="margin-right:64%">
						<div class="cart_shop_cont"><div class="address_addA">
										<input class="inner_btn_red" type="button" name="Submit" value=" <?php echo stripslash_normal($Captions_arr['ADDRESSBOOK']['ADD_ADDRESS']);?> " onclick="javascript:add_newaddress(document.add_address)" />
						</div></div>
			   </div>			
				</td>
				</table>
			...
			function Edit_AddressBook(){
				...
				$HTML_treemenu = '<div class="treemenu">
									<a href="'.url_link('',1).'">'.stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']).'</a>
									<span>&raquo;</span><a href="'.url_link('myaddressbook.html',1).'">'.stripslash_normal($Captions_arr['ADDRESSBOOK']['TREE_MENU_ADDRESSBOOK']).'</a>
									<span>&raquo;</span>'.stripslash_normal($Captions_arr['ADDRESSBOOK']['TREE_MENU_EDIT_ADDRESSBOOK']).'
								</div>';
			...
			<option value="M/S." <?=($customer_title=='M/S.')?"selected":''?>>M/S.</option>
		            ...
		            <tr>
					 <td  colspan="2"  align="right" class="regiconentA"><?php echo stripslash_normal($Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_FAX']);?> </td>
				     <td width="5%"  align="center" >:</td>
				     <td width="51%"  align="left" class="regi_txtfeildA"><input type="text" name="faxnumber" value="<?PHP echo $row['address_fax']; ?>"  maxlength="<?=$short?>"/></td>
					</tr>
