<?php
	...
	class components
	{
		...
		function mod_staticgroup($grp_array,$title)
		{
			...
			//echo "<br>Position in components - ".$position;
				...
				if ($cache_exists==false)
				{
                    ...
                    <ul>
                        ...
                        if(count($grp_array))
                        {
                            ...
                            ?>
                                <li>
                                <a href="<?php url_link('')?>" class="static_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?></a>
                                </li>
                            <?php
                            }
                            ...
                            ?>
                                <li>
                                <a href="<?php if ($row_pg['page_type']=='Page') url_static_page($row_pg['page_id'],$row_pg['title']); else echo $row_pg['page_link'];?>" class="static_menu" title="<?php echo stripslash_normal($row_pg['title'])?>" <?php echo $target?>><?php echo stripslash_normal($row_pg['title']);?></a>
                                </li>
                            <?php
                            }
                            ...
                            ?>
                                <li>
                                <a href="<?php url_link('sitemap.xml')?>" class="static_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP'])?></a>
                                </li>
                            <?php	
                            }
                            ...
                            ?>
                                <li>
                                <a href="<?php url_link('sitemap.html')?>" class="static_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SITEMAP'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SITEMAP'])?></a>
                                </li>
                            <?php		
                            }
                            ...
                            ?>
                                <li>
                                <a href="<?php url_link('saved-search.html')?>" class="static_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH'])?></a>
                                </li>
                            <?php		
                            }
                            ...
                            ?>
                                <li>
                                <a href="<?php url_link('help.html')?>" class="static_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HELP'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HELP'])?></a>
                                </li>
                            <?php
                            }
                            ...
                            ?>
                                <li>
                                <a href="<?php url_link('faq.html')?>" class="static_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_FAQ'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_FAQ'])?></a>
                                </li>
                            <?php
                            }
                            }
...
<?php
					...
					elseif ($position == 'bottom') // Case if value of position is bottom;
					{
						...
						<ul class="footerlinks">
								...
								if ($grpData['group_showsavedsearchlink']==1)
								{
									?>
									<li>
									<a href="<?php url_link('saved-search.html')?>" class="Category" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH'])?></a>
									</li>
									<?php			
								}
								?>
					...
					elseif ($position=='seo-section')
					{
							...
							$prev_grp = $grpData['group_id'];
								...
								?>
								<li>
								<a href="<?php url_link('')?>" class="general_links_div_link" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_HOME']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_HOME']?></a>
								</li>
							<?php		
								}
								while ($row_pg = $db->fetch_array($ret_pg))
							  ...
							  ?>
								<li>
								<a href="<?php if ($row_pg['page_type']=='Page') url_static_page($row_pg['page_id'],$row_pg['title']); else echo $row_pg['page_link'];?>" class="general_links_div_link" title="<?php echo stripslashes($row_pg['title'])?>" <?php echo $target?>><?php echo stripslashes($row_pg['title']);?></a>
								</li>
							<?php 
								}
								if ($grpData['group_showsitemaplink']==1)
							...
							?>
								<li>
								<a href="<?php url_link('sitemap.html')?>" class="general_links_div_link" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_SITEMAP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_SITEMAP']?></a>
								</li>
							<?php		
								}
								if ($grpData['group_showxmlsitemaplink']==1 )
							...
							?>
								<li>
								<a href="<?php url_link('sitemap.xml')?>" class="general_links_div_link" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP']?></a>
								</li>
							<?php		
								}
								if ($grpData['group_showhelplink']==1)
							...
							?>
								<li>
								<a href="<?php url_link('help.html')?>" class="general_links_div_link" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_HELP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_HELP']?></a>
								</li>
							<?php		
								}
								if ($grpData['group_showsavedsearchlink']==1)
								...
								?>
									<li>
									<a href="<?php url_link('saved-search.html')?>" class="general_links_div_link" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH']?></a>
									</li>
								<?php			
								}
							  ?>
		...
		function mod_quicksearch($title)
		{
            ...
            <div class="searchwrap">	                
                ...
                <div class="searchtext">
                	<input name="quick_search" type="text"  class="searchinput" id="quick_search" value="Search Properties" onblur="if(this.value=='') this.value='Search Properties';" onfocus="if(this.value=='Search Properties') this.value='';" />
                </div>
                <div class="searchbt">
                	<input name="button_submit_search" value="SEARCH" type="button" onclick="javascript:document.frm_quicksearch.submit()"  />
                </div>
...
?>
					<ul class="loglinks">                          	
                        <li><a href="<?php url_link('registration.html')?>" title="<?php echo stripslash_normal($Captions_arr['CUST_LOGIN']['CUSTOMER_REGISTER'])?>"><?=strtoupper(stripslash_normal($Captions_arr['CUST_LOGIN']['CUSTOMER_REGISTER']))?></a></li>
                        <li class="divider">|</li>
                        <li><a href="<?php url_link('custlogin.html')?>" title="<?php echo stripslash_normal($Captions_arr['CUST_LOGIN']['LOGIN'])?>"><?=strtoupper(stripslash_normal($Captions_arr['CUST_LOGIN']['LOGIN']))?></a></li>
					</ul>
<?php
*/
?>
...
function googleTranslateElementInit() {
  new google.translate.TranslateElement({pageLanguage: 'en', includedLanguages: 'en,es,fr,zh-CN', layout: google.translate.TranslateElement.InlineLayout.SIMPLE}, 'google_translate_element');
}
...
?>
					<ul class="loglinks"> 
						<a class="myacc" href="<?php url_link('login_home.html')?>">My Account</a>
						<?php
						/*
                    <?=stripslash_normal($Captions_arr['LOGIN_MENU']['WELCOME'])?> <span><?php echo str_replace($sr_arr,$rp_arr,get_session_var('ecom_login_customer_shortname'))?></span>
                    */?> 
                    </ul>
<?php			}
			}
				...
				foreach ($shelf_arr as $k=>$shelfData)
				{
					...
					if ($proceed)
					{
						...
						$sql_prod = "SELECT a.product_id,a.product_name,a.product_shortdesc,a.product_default_category_id,a.product_webprice,
											a.product_discount,a.product_discount_enteredasval,a.product_applytax,a.product_bonuspoints,a.product_variables_exists,a.product_variablesaddonprice_exists,a.price_normalprefix,a.price_normalsuffix,a.price_fromprefix,a.price_fromsuffix,
											a.product_saleicon_show, a.product_newicon_show,a.product_actualstock        									  
									FROM 
						...
						if ($db->num_rows($ret_prod))
						{
							if($shelfData['shelf_currentstyle']=='3rowspcl') // case of normal design layout
							{
								...
								$HTML_comptitle = $HTML_maindesc = $HTML_paging = $HTML_showall = '';
										...
										if ($title)
										{
											$HTML_comptitle =  "<div class='home_shelftitle'>".$title."</div>";
										}
                                            ...
                                            <?php
												...
												while($row_prod = $db->fetch_array($ret_prod))
												{
													...
													if ($shelfData['shelf_showimage']==1)// Check whether description is to be displayed
													{
														...
														//$HTML_image ='<div class="slidemainImg"><a href="'.url_root_image($tabimg_arr[0]['image_bigpath'],1).'" title="'.stripslash_normal($row_prod['product_name']).'" rel="lightbox[gallery-'.$row_prod['product_id'].']">';
														global $def_mainimg_id;
														$def_mainimg_id = $shelfData['shelf_id'].'_'.$row_prod['product_id'];
														...
														if(count($img_arr))
														{
															//$HTML_image .= show_image(url_root_image($img_arr[0][$pass_type],1),$row_prod['product_name'],$row_prod['product_name'],'',$row_prod['product_id'],1);
															$HTML_image .= "<img src='".url_root_image($img_arr[0][$pass_type],1)."' id='".$def_mainimg_id."' alt='".$row_prod['product_name']."'>";
														}
														else
														{
															// calling the function to get the default image
														...
														{
															$HTML_image .= '<div class="nowlet_cls"><img src="'.url_site_image('nowLet.png',1).'" alt="Now Let"></div>';
														}
							...
							if($shelfData['shelf_currentstyle']=='nor') // case of normal design layout
							{
								switch($shelfData['shelf_displaytype'])
								{
									...
									if($shelfData['shelf_description'] != "")
									{
										...
										echo $shelfData['shelf_description'];
									}
									?>
									<div class="property_shelf">
										...
										?>
											...
											<?php
													if($row_prod['product_actualstock']==0)
													{
														echo '<div class="nowlet_cls"><img src="'.url_site_image('nowLet.png',1).'" alt="Now Let"></div>';
													}
											?>
											</div>
											<?
											...
											<div class="titlewrap">
												<?php
												if($row_prod['product_actualstock']>0)
															$availability_msg = '<div class="green_available_home ">'.$Captions_arr['COMMON']['PRODDET_AVAIL_1_YEAR'].'</div>';
														else
															$availability_msg = '<div class="green_available_home ">'.$Captions_arr['COMMON']['PRODDET_AVAIL_2_YEAR'].'</div>';
														echo $availability_msg;	
												?>		
											</div>	
                                            <div class="titlewrap"> 
										...
										<div class="shlf_nor_showall">
                                    	<?php /*<a href="<?php  url_shelf_all($shelfData['shelf_id'],$shelfData['shelf_name'],-1)?>" class="spcl_shlf_showall" title="<?php echo stripslash_normal($Captions_arr['COMMON']['SHOW_ALL'])?>"><?php echo stripslash_normal($Captions_arr['COMMON']['SHOW_ALL'])?></a>*/?>
                                    	</div>
<?php									break;
								};	
							}	
							elseif($shelfData['shelf_currentstyle']=='3rowspcl_0ld') // case of christmas layout
							{
								switch($shelfData['shelf_displaytype'])
								{
								case '3row': 
									...
									<div class="intro_shelf">
										...
										while($row_prod = $db->fetch_array($ret_prod))
										{
											$cnt++;
											if($cnt == 3)
											echo "<div class='introwrapright'>";
											else
											echo "<div class='introwrap'>";
										...
										<?php /*?><div class="shlf_nor_showall">
                                    	<a href="<?php  url_shelf_all($shelfData['shelf_id'],$shelfData['shelf_name'],-1)?>" class="spcl_shlf_showall" title="<?php echo stripslash_normal($Captions_arr['COMMON']['SHOW_ALL'])?>"><?php echo stripslash_normal($Captions_arr['COMMON']['SHOW_ALL'])?></a>
                                    	</div><?php */?>
<?php									break;
...
<?php	
		...
		function mod_newsletter($title)
		{
			...
			?>
			<ul class="bannera2ds">
<li><a href="http://www.unipad.co.uk/callback.html"><img src="http://www.unipad.co.uk/images/www.unipad.co.uk/site_images/requestACallback.jpg" alt="Request A Call-back" width="300" height="143" usemap="#Map2" border="0" /></a></li>
<li>
 <div class="newsletter_bottom">
                            <form name="frm_newsletter" method="post" action="" class="frm_cls" onsubmit="return newsletter_validation(this)">
                                <div class="news_header"><span><?=stripslash_normal($Captions_arr['NEWS_LETTER']['NEWSCUSTOMER_DETAILS_HEADER'])?></span></div>
                                <div class="newsletter_input"> <input name="newsletter_email" type="text" class="newsletter_input_in" id="newsletter_email" value="Enter Email" onblur="if(document.frm_newsletter.newsletter_email.value=='') {document.frm_newsletter.newsletter_email.value='Enter Email'}" onclick="javascript:document.frm_newsletter.newsletter_email.value=''"  /></div>
                                <?php
							...
							?>
                                <div class="newsletter_submit"> <!--<img src="<?php /*url_site_image('news-login.gif')*/?>" width="77" height="22" /> --><input type="image" src="<?php url_site_image('news-login.gif')?>"  alt="Unipad News Sign Up"   /></div>
...
<?php 
		...
		function mod_adverts($advert_arr,$title)
		{
			...
			//echo $position;
			if ($position=='topband-left') // show the advert only if position is topband
			{ 
				foreach ($advert_arr as $d=>$k)
					{
						...
						switch ($k['advert_type'])
						{
							...
							?>
                              <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 672px; height: 397px; overflow: hidden;">
        	<?php
			...
			?>
            <div>
				<?php echo $link_start;?><img src="<?php echo url_root_image('rot/img/'.$row_rotate['rotate_image'],1);?>" alt="<?php echo stripslashes($alt_text)?>" title="<?php echo stripslashes($alt_text);?>" /> <?php echo $link_end;?>
                <div u="thumb"><?php echo stripslashes($alt_text);?></div>
            </div>
            <?php	}
				}
			?>
        ...
        <div u="thumbnavigator" class="sliderb-T" style="position: absolute; bottom: 0px; left: 0px; height:45px; width:674px;">
            <div style="position: absolute; display: block;
                background-color:#262626; top: 0px; left: 0px; width: 100%; height: 100%;">
            </div>
            <!-- Thumbnail Item Skin Begin -->
            <div u="slides">
                <div u="prototype" style="POSITION: absolute; WIDTH: 674px; HEIGHT: 45px; TOP: 0; LEFT: 0;">
                    <thumbnailtemplate style="font-family:arial; font-weight:bold; POSITION: absolute; WIDTH: 100%; HEIGHT: 100%; TOP: 0; LEFT: 0; color:#fff; line-height: 45px; font-size:16px; padding-left:10px;"></thumbnailtemplate>
                </div>
            </div>
  ...
  <?php	
			...
			else if ($position=='topband-right') // show the advert only if position is topband
			{ 
				foreach ($advert_arr as $d=>$k)
					{
						// Do the following only if caching is not enabled or cache does not exists
  ...
  <?php	
			...
			elseif ($position=='middleband-right') // show the advert only if position is bottomband
			{
				foreach ($advert_arr as $d=>$k)
					{
					 // Do the following only if caching is not enabled or cache does not exists
