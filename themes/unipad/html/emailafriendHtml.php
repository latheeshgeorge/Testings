...
/*############################################################################
	...
	class emailafriend_Html
	{
		...
		$HTML_treemenu .='<div class="treemenu">
							...
							<span>&raquo;</span><a href="'.url_product($product_id,$product_name,1).'">'.$product_name.'</a>
							<span>&raquo;</span>'.stripslash_normal($Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_TREEMENU_TITLE']).'
						</div>';
		echo $HTML_treemenu;
			if($alert)
				{ 
		  ...
		  <div class="reg_shlf_outr">
           ...
           <div class="reg_shlf_pdt_con">	
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="reg_table">
					...
					<tr>
					  <td width="23%" class="regiconentA"><?=stripslash_normal($Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_FRIEND_NAME'])?><br /></td>
					  <td width="77%" align="left" valign="middle" class="regi_txtfeildA"><input name="friend_name" type="text" class="addreivewinput" id="friend_name" size="32" value="<?=$_REQUEST['friend_name']?>"/></td>
					</tr>
					<tr>
