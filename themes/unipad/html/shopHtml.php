	  ...
	  <?php
			...
			$HTML_treemenu = '<div class="treemenu">';
								...
								$HTML_treemenu .='<span>&raquo;</span>
									...
									<span>&raquo;</span>'.$row_shop['shopbrand_name'].'';
								}
								else
								{
									$HTML_treemenu .='<span>&raquo;</span>
			...
			<div class="listwrap">
                <div class="property_shelf">
                	<h3><?php echo stripslashes($row_shop['shopbrand_name'])?></h3>
					<?php /*?><div class="cat_main_data"><?=$HTML_image.$HTML_catdesc;?></div><?php */?>
                    <div class="cat_main_data"><?=$HTML_shopdesc?></div>
			...
			$HTML_topcontent .= '<table class="productpagenavtable" border="0" cellpadding="0" cellspacing="0" width="100%">
								<tbody>
									<tr>
										...
										'.stripslash_normal($Captions_arr['SHOP_DETAILS']['SHOPDET_SORTBY']).'
										'.generateselectbox('shopdet_sortbytop',$selval_arr,$prodsort_by,'','',0,'',false,'shopdet_sortbytop').'
										'.generateselectbox('shopdet_sortordertop',$selord_arr,$prodsort_order,'','',0,'',false,'shopdet_sortordertop').'
										</td>
										<td class="productpagenavtext" align="right" valign="middle" width="37%">
										'.stripslash_normal($Captions_arr['SHOP_DETAILS']['SHOPDET_ITEMSPERPAGE']).'
										'.generateselectbox('shopdet_prodperpagetop',$perpage_arr,$prodperpage,'','',0,'',false,'shopdet_prodperpagetop').'
			...
			$HTML_bottomcontent	.=	'<table class="productpagenavtable" border="0" cellpadding="0" cellspacing="0" width="100%">
								<tbody>
									<tr>
										<td class="productpagenavtext" align="left"  valign="middle" width="63%">
										'.stripslash_normal($Captions_arr['SHOP_DETAILS']['SHOPDET_SORTBY']).'
										'.generateselectbox('shopdet_sortbybottom',$selval_arr,$prodsort_by,'','',0,'',false,'shopdet_sortbybottom').'
										'.generateselectbox('shopdet_sortorderbottom',$selord_arr,$prodsort_order,'','',0,'',false,'shopdet_sortorderbottom').'
										</td>
										<td class="productpagenavtext" align="right" valign="middle" width="37%">
										'.stripslash_normal($Captions_arr['SHOP_DETAILS']['SHOPDET_ITEMSPERPAGE']).'
										'.generateselectbox('shopdet_prodperpagebottom',$perpage_arr,$prodperpage,'','',0,'',false,'shopdet_prodperpagebottom').'
										<input type="button" name="submit_Page" value="'.stripslash_normal($Captions_arr['SHOP_DETAILS']['SHOPDET_GO']).'" class="nav_button" onclick="handle_shopdetailsdropdownval_sel(\''.url_shops($_REQUEST['shop_id'],$shop_det['shopbrand_name'],4).'\',\'shopdet_sortbybottom\',\'shopdet_sortorderbottom\',\'shopdet_prodperpagebottom\')" />
										</td>
									</tr>
								</tbody>
								</table>';
