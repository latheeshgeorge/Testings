...
/*############################################################################
	...
	class callback_Html
	{
		...
		<div class="treemenu">
					...
					<span>&raquo;</span>'.stripslash_normal($Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_TREEMENU_TITLE']).'
					</div>		
		';
		echo $HTML_treemenu;
			if($alert)
		...
		?>	
					...
					<? }?>
						<div class="reg_shlf_cont_div">
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0"  class="reg_table">
								<tr>
									<td width="18%" class="regiconentA"><?=stripslash_normal($Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_FIRSTNAME'])?><span class="redtext">*</span></td>
									<td width="82%" align="left" valign="middle" class="regi_txtfeildA"><input name="callback_fname" type="text" class="addreivewinput" id="callback_fname" size="39" value="<?=$_REQUEST['callback_fname']?>"
									/></td>
								</tr>
								<tr>
									<td width="" class="regiconentA"><?=stripslash_normal($Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_LASTNAME'])?><br /></td>
									<td width="" align="left" valign="middle" class="regi_txtfeildA"><input name="callback_lname" type="text" class="addreivewinput" id="callback_lname" size="39" value="<?=$_REQUEST['callback_lname']?>"
									/></td>
								</tr>
								<tr>
           ...
           <div class="reg_shlf_inner_cont">
				   ...
				   <table class="verification_code_table" width="100%" border="0" cellpadding="0" cellspacing="0">
					<tbody>
					<? if($Settings_arr['imageverification_req_callback']) {?>
					  
					    <tr>
					    <td align="left" width="19%" >&nbsp;</td>
					    <td  align="left" width="81%"> <img src="<?php url_verification_image('includes/vimg.php?size=4&amp;pass_vname=callback_Vimg&amp;bg=255 255 255&amp;brdr=255 255 255&fnt=255 0 0&circle=1')?>" border="0" alt="Image Verification" class="captcha"/> </td>
					    </tr>
					    <tr>
					    <td align="left" width="18%" class="regiconentA" ><?=stripslash_normal($Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_VERIFICATION_CODE'])?> </td>
					    <td>
							<?php
					  ...
					  <tr>
					    <td align="left"  colspan="2"> <div class="imgver_text"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_LETTER_LONG_TEXT'])?></div></td>
					    </tr>
					  <tr>
						...
						<? }?>
						 <tr>
						<td align="left"><div class="cart_shop_cont" style="float:left;"><div>
						<input type="hidden" name="action_purpose" id="action_purpose" value="send_callback">
						
						</div></div></td>
						<td align="left"><input name="callback_Submit" type="submit" class="inner_btn_red" id="callback_Submit" value="<?=stripslash_normal($Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_SEND_BUTTON'])?>"  /></td>
						</tr>
						<tr>
