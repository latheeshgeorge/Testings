...
?>
	...
	function mailinglist_mainsel()
	{
		...
		'<div class="treemenu">
			...
			<span>»</span>'.stripslash_normal($Captions_arr['CUST_REG']['REGISTRATION_TREEMENU_TITLE']).'
			</div>';
		echo $HTML_treemenu;
		?>
		...
		/*
		?>	
			 <div class="reg_top_txt_New"><div class="reg_top_txt_inside"><?=stripslash_normal($Captions_arr['CUST_REG']['ACCNT_TYPE'])?></div><div class="reg_top_txt_inside">
	...
	<div class="inner_con"  id="companydetails" style="display:none;" >
		 ...
		 <div class="reg_shlf_outr">
	  	 ...
	  	 <table class="reg_table" width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				{	
					...
					?>
						<tr>
							<td class="regiconentA" valign="middle" align="left" width="25%">
							<?php echo stripslashes($custstat_caption_map_array[$row_custstat['field_key']]); if($row_custstat['field_req']==1) { echo '&nbsp;<span class="redtext">*</span>';}?>							</td>
							<td align="left" valign="middle" class="regi_txtfeildA" width="75%">
							<?php
								$pass_class_arr['txtbox_cls'] 		= 'regiinput'; 
								$pass_class_arr['txtarea_cls'] 		= 'regiinput'; 
				...
				?>
              <tr>
                <td class="regiconentA" valign="middle" align="left" width="25%"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_EMAIL'])?><span class="redtext">*</span></td>
                <td align="left" valign="middle" class="regi_txtfeildA" width="75%"><input name="customer_email" type="text" class="regiinput" id="customer_email" size="25" value="<?=$_REQUEST['customer_email']?>" maxlength="<?=$medium?>"/></td>
              </tr>
			  <?php
			//section for custom registration form 
		  ...
		  ?>
           ...
           <div class="reg_shlf_inner">
            <div class="reg_shlf_inner_top"></div>
           <div class="reg_shlf_inner_cont">
		   <?php /*<div class="reg_shlf_hdr_outr"><div class="reg_shlf_hdr_in"><span><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_PERSONAL_DETAILS_PASSWORD'])?></span></div></div>*/?>
             <div class="reg_shlf_cont_div">
           <div class="reg_shlf_pdt_con">
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="reg_table">
            <tr>
              <td  align="left" valign="middle" class="regiconentA" width="25%"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_PASSWORD'])?><span class="redtext">*</span></td>
              <td  align="left" valign="middle" class="regi_txtfeildA" width="75%"><input name="customer_pwd" type="password" class="regiinput" id="customer_pwd" size="25" value="" /></td>
            </tr>
            <tr >
	  ...
	  ?>
		...
		?>
            ...
            <div>  <div class="reg_group_chk_main"> <input type="checkbox" name="customer_in_mailing_list" id="customer_in_mailing_list" value="1" onchange="maillinglist_onchange(this)" <?php if ($_REQUEST['customer_in_mailing_list']==1) echo 'checked="checked"';?> /></div><div class="reg_group_txt_main"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_RECEIVE_NEWSLETTER_HEADER'])?></div> </div> 
            </div>
				   ...
				   <table class="reg_shlf_inner_table" width="100%"  border="0" cellpadding="0" cellspacing="0">
					...
					?>
					  ...
					  <tr>
					    ...
					    <td width="74%" colspan="2" align="left">  <div class="imgver_text"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_LETTER_LONG_TEXT'])?></div></td>
				      </tr>
					  <tr>
					  ...
					  <tr>
						...
						<input type="submit" value="<?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_REGISTRATION_SAVE_BUTTON'])?>" class="inner_btn_red_xy" />
						</td>
					  </tr>
						<tr>
		...
		$j(document).ready(function() {
  		...
  		<form name="frm_custlogin_middle" id="frm_custlogin" method="post" action=""  class="frm_cls">
		<?php 
		...
		<? }?>
            ...
            <tr>
            <td class="login_inner_top_a"><?=$Captions_arr['CUST_LOGIN']['REGIS_CUST']?></td>
            <td class="login_inner_top_b"><?=$Captions_arr['CUST_LOGIN']['NEW_CUST']?></td>
            </tr>
            <tr>
                ...
                <div> <a href="javascript:validatemiddle_login(document.frm_custlogin_middle)"><img src="<? url_site_image('loin-inbt.gif')?>"  /></a></div>
                ...
                <div> <a href="<?php url_link('registration.html')?>"><img src="<? url_site_image('login-btb.gif')?>"  border="0" /></a></div>
                </td>
            </tr>
        </table>
		</form>
		...
		$HTML_img = $HTML_alert = $HTML_treemenu='';
				...
				'<div class="treemenu">
					<a href="'.url_link('',1).'">'.stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']).'</a>
					<span>»</span>'.stripslash_normal($Captions_arr['FORGOT_PASSWORD']['FORGOT_PWD_HEADER']).'
					</div>';
				echo $HTML_treemenu;
		?>
			...
			<div class="inner_header"><?php echo $mesgHeader;?></div>
				...
				<tr>
				<td width="12%" align="left" valign="middle" class="regiconent"><?=stripslash_normal($Captions_arr['FORGOT_PASSWORD']['FORGOT_PWD_LABEL'])?></td>
				<td width="88%" align="left" valign="middle" class="regiconent"><input name="forgotpwd_email" type="text" class="regiinput" id="forgotpwd_email" size="25" value=""  /></td>
				</tr>
				</table>
                <div class="forgot_buttom">
                <input name="action_purpose" id="action_purpose" type="hidden" value="ForgotPassword_send">
                <input name="forgotpassword_Submit" type="submit" class="inner_btn_red" id="forgotpassword_Submit" value="<?=stripslash_normal($Captions_arr['FORGOT_PASSWORD']['FORGOT_PWD_SUBMIT'])?>" />
                </div>
