<?php
			...
			<tr>
			   ...
			   <?php 
					...
					while($row_prod = $db->fetch_array($ret_prod))
					{
						...
						?>
							 <tr>
								<td colspan="3" align="center" valign="middle" class="combosep"><img src="<?php url_site_image('combosep.gif')?>" border="0" alt="combo deals" style="width:auto" /></td>
							</tr>
						<? 
					  	}
						$combo_pdt_cnt ++;
						...
						$sql_combination 	= "SELECT comb_id
												...
												WHERE 
													combo_products_comboprod_id = ".$row_prod['comboprod_id']. " ORDER BY comb_id ASC";
	...
	<?php
				...
				?>		
				<img id="combosel_<?php echo $comb_id?>" src="<?php url_site_image($sel_img)?>" border="0" onclick="handle_combo_combination_selection('<?php echo $ecom_hostname?>','combosel_<?php echo $comb_id?>','combprod_map_<?php echo $prodmap_id?>','<?php echo $prodmap_id?>','<?php echo $comb_id?>')"  style="width:auto"/>	
				<?php
				...
				{
				?>
				<img  src="<?php url_site_image('selected_img.gif')?>" border="0" / style="width:auto">
				<?php
				}	
				?>
				</li>
		...
		if($row_prod['product_bulkdiscount_allowed']=='Y' || $row_prod['product_freedelivery']==1)
		{
			...
			{
				?>
				<img src="<?php url_site_image('bulk-dis.gif')?>" alt="Bulk Discount" style="width:auto"/>
				<?php
			}
			if($row_prod['product_freedelivery']==1)
			{	
				?>
				<img src="<?php url_site_image('free-deli.gif')?>" alt="Free Delivery" style="width:auto"/>
				<?php
			}
			?>
			</div></li>
		...
		if($row_prod['product_newicon_show']==1)
		{
			...
			if($desc!='')
			{
				...
				?>
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="middle_combo_sub_table">
				<?php
				// Case of variables
					...
					?>
							<tr>
								<td align="left" valign="top" class="mid_comboshelfBtabletdA" colspan="2">
									<b><?php 
									...
									<tr>
									<td align="left" valign="top" class="mid_comboshelfBtabletdB" colspan="2">
								<b><?php
								if ($row_var['var_value_exists']==1)
								{
