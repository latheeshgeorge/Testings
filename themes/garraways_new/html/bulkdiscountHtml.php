									...
									<?php
										...
										?>
												...
												<div class="bulk_view_free"></div>
													<ul class="shelfBul">
																<li><span class="shelfAprodname">
																<div class="multibuy_name_div">
																<a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" title="<?php echo stripslashes($row_prod['product_name'])?>"><?php echo stripslashes($row_prod['product_name'])?></a></span>
																</div>
																</li>
													...
													<li>
																 ...
																 <li class="bulk_view">
																 <a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" title="<?php echo stripslashes($row_prod['product_name'])?>"><img style="width:auto;" src="<?php url_site_image('bulk-btn.gif')?>" border="0" alt="<?php echo stripslashes($row_prod['product_name'])?>" title="<?php echo stripslashes($row_prod['product_name'])?>"></a></li>
																</ul>
												</td>
											<?php
												$cur_col++;
