<?php
	...
	$HTML_loading_ajax = '<div class="proddet_loading_outer_div" style="height:15px;padding:5px 0 0 0;"><div id="proddet_loading_div_ajaxinner" style="display:none;padding:5px 0 0 0;">
		<img src="'.url_site_image('proddet_loading.gif',1).'" alt="loading..." style="width:43px;height:11px;align:left">
		</div></div>';
	...
	global $Captions_arr;
		...
		switch($mod)
		{
		  case 'Cart':
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="shoppingcarttable_id">
			<tr>
			...
			<td align="right" valign="middle"><a href="javascript:void(0)"><input name="continue_submit" class="buttonred_cartQ" id="continue_submit" value="View Cart"  type="button" onclick="show_cart_from_ajax()" ></a></td>
			</tr>
			</table>
			</form>
			</div>
