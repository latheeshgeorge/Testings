 ...
 ?>
	...
	<div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >>
	 ...
	 <input type="hidden" name="action_pricepurpose" value="insert_det" />
	              <table border="0" cellpadding="0" cellspacing="0" class="regitable" id="shoppingcarttable_id">
	   ...
	   <div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?=$Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_TREEMENU_TITLE']?></div>
		...
		function Show_Mypricepromise_requests()
		{
			...
			?>
					...
					<input type="hidden" name="search_click" value="search_click" />
							...
							<table width="100%" border="0" cellpadding="3" cellspacing="0"  class="reg_table" id="shoppingcarttable_id">
							<tr>
		...
		function Show_Mypricepromise_details($prom_id=0,$alert='')
		{
			...
			?>
				<table width="100%" border="0" cellspacing="0" cellpadding="1" class="reg_table" id="shoppingcarttable_id">
				<tr>
				<td colspan="5" align="left" valign="middle">
				<div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >>
