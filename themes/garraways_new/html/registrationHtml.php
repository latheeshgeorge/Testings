...
<div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?=$Captions_arr['CUST_REG']['REGISTRATION_TREEMENU_TITLE']?></div>
		...
		?>
				<tr>
					<td colspan="2" align="left" style="padding: 3px 3px 3px 10px;font-weight: normal;font-size: 14px;color: #000;">
						Sign up and take advantage of the benefits of being registered with Garraways.  This is FREE and allows you to start saving your <a href="http://www.garraways.co.uk/pg843/bonus-points.html" target="_blank" style="color:#000">bonus points</a> immediately.
						
						<?//=$Captions_arr['CUST_REG']['CUSTOMER_DESC']?></td>
				</tr>
		<?PHP
			}
		?>
	...
	<tr>
		...
		<tr>
			...
			<td align="left" valign="middle">
				<img src="<?php url_verification_image('includes/vimg.php?size=4&amp;pass_vname=registration_Vimg')?>" border="0" alt="Image Verification" style="width:auto"/>			</td>
		</tr><? }?>
		<tr>
		...
		<? }?>
          ...
          <tr>
		   ...
		   ?>
			...
			<input name="custenquirelogin_Submit" type="submit" class="buttonred_cartA" value="Login" <?php /*?>onclick="document.frm_custlogin_enquire.submit();"<?php */?> />
		   <?
		   } else {?>
			<input name="custenquirelogin_Submit" type="submit" class="buttonred_cartA" value="Login" <?php /*?>onclick="document.frm_custlogin.submit();"<?php */?> />
			<?php
			 } 
