<?php
	...
	class static_Html
	{
		...
		<?php
		if($row_statpage['page_id']!=50248 && $row_statpage['page_id']!=50252)
		{
		...
		<input type="hidden" name="fproduct_id" value="<?php echo $_REQUEST['product_id']?>" />
		 ...
		 ?>
			<table border="0" cellpadding="0" cellspacing="0" class="staticpagetable" id="shoppingcarttable_id">
			<tr>
			  <td class='staticpg_title'><h1><?php echo stripcslashes($row_statpage['title'])?></h1></td>
			</tr>  
			<tr>
