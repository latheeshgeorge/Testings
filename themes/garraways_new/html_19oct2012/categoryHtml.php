			  ...
			  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="categoreyimage">
				...
				<?php 
				   ...
				   <? if($custom_id)
						...
						{
				?>
							<a  href="javascript:download_pdf_common('<?php echo $_SERVER['HTTP_HOST']?>','<?php echo $_SERVER['REQUEST_URI']?>')" title="<?php echo $Captions_arr['CAT_DETAILS']['CATDET_DOWNLOADPDF']?>"><img src="<?php url_site_image('pdf_download.gif')?>" alt="<?php echo $Captions_arr['CAT_DETAILS']['CATDET_DOWNLOADPDF']?>" border="0" /></a>
				<?php	 
						}
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0" >
								...
								<td colspan="2" class="prod_list_name_td">
									<div class="prod_list_name">
										...
										{
										?>
											<div class="prod_list_name_link"><h1 class="shelfBprodname"><a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" title="<?php echo stripslashes($row_prod['product_name'])?>"><?php echo stripslashes($row_prod['product_name'])?></a></h1>
											</div>
										<? 
										}
