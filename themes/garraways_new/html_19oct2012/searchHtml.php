									...
									$prodcur_arr[] = $row_search;
								     ...
								     <td align="left" valign="top" class="<?php echo $cls?>">
										...
										<? //if($cat_det['product_showtitle']==1)// whether title is to be displayed
											 {?>
											<div class="prod_list_name_link"><h1 class="shelfBprodname"><a href="<?php url_product($row_search['product_id'],$row_search['product_name'],-1)?>" title="<?php echo stripslashes($row_search['product_name'])?>"><?php echo stripslashes($row_search['product_name'])?></a></h1>
											</div>
											<? 
											}
