	...
	if ($from_date or $to_date)
	{
		...
		//print_r($ord_array );
		  ...
		  <table width="100%" border="0" cellpadding="3" cellspacing="0" >
			  ...
			  <tr>
                <td colspan="8" align="left" valign="middle" class="pagingcontainertd" ><img src="<?php url_site_image('new_post.gif')?>"   border="0" title="New" />
            ...
            <td align="middle" valign="middle" class="ordertableheader"><?php echo $Captions_arr['ORDER']['ORDER_DATE']?></td>
          	 <td   align="left" valign="middle" class="ordertableheader"><?php echo $Captions_arr['ORDER']['ORDER_EMAIL']?></td>
	...
	<?php
	 ...
	 ?>
			  <tr onclick="window.location='index.php?req=orders&reqtype=order_det&order_id=<?php echo $row_select_ord['order_id']?>'" style="cursor:pointer" class="edithreflink_tronmouse" title="View Details" onmouseover="this.className='edithreflink_trmouseout'" onmouseout="this.className='edithreflink_tronmouse'">
			    ...
			    <td align="middle" valign="middle" class="<?=$cls?>" nowrap="nowrap"><a class='edittextlink' href='index.php?req=orders&reqtype=order_det&order_id=<?php echo $row_select_ord['order_id']?>'>View</a></td>
			  </tr>
			  <?php
			}	
		   ?>
  ...
  <tr>
    <td align="right" colspan="4" class="tdcolorgray_normal"><?php	
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="2">
		  <tr >
            <td align="left" class="<?php echo $cls?>" nowrap="nowrap"><div align="left">Product</div></td>
           ...
           <!-- <td class="<?php// echo $cls?>" align="center" nowrap="nowrap"><div align="center">Ord Qty</div></td> -->
            <td class="<?php echo $cls?>" align="right" nowrap="nowrap"><div align="right">Net</div></td>
          </tr>
...
<tr><td  width="100%" colspan="4">
  <table width="100%" border="0" cellpadding="1" cellspacing="1" id="enqDetails" <?PHP if(!$_REQUEST['ord_pg']) { ?> style="display:none;" <? } ?> >
    <tr class="userorderheader">
      <td colspan="6" align="right"><a href="javascript:newEnqury(document.frm_orderdetail)" class="edithreflink_x" > 
    ...
    <tr  class="userorderheader">
      <td colspan="6" class="userorderheader"  ><?php echo $Captions_arr['ORDER']['ORDER_ENQ_EXIST']?></td>
      </tr>
	  <?PHP 
    ...
    <td width="12%" class="ordertableheader" align="center" valign="top"></td>
    </tr>
	<?PHP if($num>0) {
	...
	?>
		    <tr onclick="window.location='index.php?req=orders&reqtype=enqposts&enqid=<?PHP echo $row['query_id']; ?>&order_id=<?PHP echo $_REQUEST['order_id']; ?>'" style="cursor:pointer" class="edithreflink_tronmouse" title="View Details" onmouseover="this.className='edithreflink_trmouseout'" onmouseout="this.className='edithreflink_tronmouse'">
		      ...
		      <td class="<?PHP  echo $cls; ?>" align="center" valign="top"><a class='edittextlink' href='index.php?req=orders&reqtype=enqposts&enqid=<?PHP echo $row['query_id']; ?>&order_id=<?PHP echo $_REQUEST['order_id']; ?>'>View</a></td>
		    </tr>
	...
	?> 
	  ...
	  <tr  class="ordertableheader">
          <td colspan="6" align="center" class="userorderheader" bgcolor="#FFFFFF"  > No Details Found </td>
      </tr> 
	  <?
		}//Else Ends Here
		?>
...
<? } ?>	
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="2">
    ...
    <tr>
      <td colspan="5" align="right" class="userorderheader"><a href="javascript:postDisplay(document.frm_enqposts)" class="edithreflink_x" > 
    ...
    <tr id="postDet2" style="display:none;"  class="ordertableheader">
      ...
      <tr>
        <td colspan="6" class="userorderheader"> <?php echo $Captions_arr['ORDER']['ORDER_ENQPOST_EXIST']?> </td>
        </tr>
      <tr>
