...
if($ecom_siteid==61 || $ecom_siteid==95)//local
{ 
...
?>
	...
	<tr>
		<td class="compleftcontainer" align="left" valign="top">
			<div class="left_transparent"></div>
<?php	// Showing the left components
		$position = 'left';
		include("Components.php");
?>		</td>
		
		<td class="compmiddlecontainer" align="left" valign="top">
<?php	// Showing the mainbody components
		$position = 'mainbodytop';
		include("Components.php");
?>
...
?>
		...
		<td class="comprighttcontainer" align="left" valign="top">
<?php	// Showing the left components
		$position = 'right';
		include("Components.php");
?>		</td>
