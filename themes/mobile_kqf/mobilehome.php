  	...
  	if($_REQUEST['req'] == 'prod_detail') 
		{
			...
			{
				echo "<script  type=\"text/javascript\" src=\"".url_head_link("images/".$ecom_hostname."/mobile_scripts/jquery.js",1)."\" ></script>\n";
				//echo "<script  type=\"text/javascript\" src=\"".url_head_link("images/".$ecom_hostname."/mobile_scripts/datepicker/jquery.ui.datepicker.js",1)."\" ></script>\n";
				//echo "<script  type=\"text/javascript\" src=\"".url_head_link("images/".$ecom_hostname."/mobile_scripts/datepicker/jquery-ui.multidatespicker.js",1)."\" ></script>\n";
			 echo "<script  type=\"text/javascript\" src=\"".url_head_link("images/".$ecom_hostname."/mobile_scripts/jquery-ui-1.10.1.custom.js",1)."\" ></script>\n";
