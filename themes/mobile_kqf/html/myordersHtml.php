			...
			<table  border="0" cellpadding="0" cellspacing="0" width="100%" class="userordertablestyleA">
				...
				<td nowrap="nowrap" >
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="search_areaTable">
						<tr>
							<td width="11%">
								<?php echo stripslash_normal($Captions_arr['ORDER']['ORDERID'])?></td>
							<td colspan="3"><input name="ord_id" type="text" class="textfeild_ord" id="ord_id" value="<?php echo $_REQUEST['ord_id']?>" size="6" /></td>
						</tr>
						
						<tr>
						  <td valign="middle"><?php echo stripslash_normal($Captions_arr['ORDER']['ORDER_BETDATE'])?></td>
						  <td colspan="3" valign="middle">&nbsp;</td>
					  </tr>
						<tr>
						  <td valign="middle"><input name="ord_fromdate" id="datepicker" class="textfeild_ord" type="text" size="10" value="<?php echo $_REQUEST['ord_fromdate']?>" /></td>
						  <td width="1%" style="text-align:center" valign="middle">&amp;</td>
						  <td width="71%" valign="middle"><input name="ord_todate" id="datepicker1" class="textfeild_ord" type="text" size="10" value="<?php echo $_REQUEST['ord_todate']?>" /></td>
				...
				<td nowrap="nowrap" >
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="search_areaTable">
						<tr>
							<td colspan="4" style="text-align:right"><?php echo $sort_option_txt;?>
							In
