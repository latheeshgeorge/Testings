...
<?php
		...
		function mod_quicksearch($title)
		{
			...
			?>
			 <form method="post" name="frm_quicksearch" class="frm_cls" action="<?php url_link('search.html')?>">
                   <input type="hidden" name="search_src" id="search_src" value=''/>
                   <input type="hidden" name="rdo_suboption" id="rdo_suboption" value='title_desc'/>
						

						<?php /*?><table border="0" cellspacing="0" cellpadding="0" class="ztable">
						<tr>
						<td class="ztable_l">   
						...
						<a href="<?php url_link('enquiry.html')?>" class="link_top_b" title="<?php echo stripslash_normal($Captions_arr['COMMON']['VIEW_ENQUIRY'])?>">View Enquiry</a>
						...
						<td class="curve_topA_s_D" valign="middle"><label>
							<?php
						$parent_arr = $this->generate_category_tree_kqf(0,0,true);
						...
						<td class="ztable_l">   
						<a href="#" class="link_top_a" onclick="gobackto_cart('<?php echo ($protectedUrl)?base64_encode($ecom_hostname):$ecom_hostname?>')"  title="<?php echo stripslash_normal($Captions_arr['COMMON']['VIEW_CART'])?>">View Cart</a>
						<?php /*<a href="<?php url_link('enquiry.html')?>" class="link_top_b" title="<?php echo stripslash_normal($Captions_arr['COMMON']['VIEW_ENQUIRY'])?>">View Enquiry</a> */ ?>
						<a href="#" class="link_top_c" onclick="handle_checkout_submit('<?php echo $ecom_hostname?>',0,'<?php echo $pass_tot?>')"  title="<?php echo stripslash_normal($Captions_arr['COMMON']['CHECK_OUT'])?>">Checkout</a></td>
						...
						<input type="submit" name="button2" id="button2" value="Submit" class="bblack"/>
						</td>
                  ...
                  <?php /*?><input type="hidden" name="cbo_keyword_look_option" value="any_word" id="cbo_keyword_look_option" /><?php */?>
		...
		function generate_category_tree_kqf($id,$level=0,$all=false,$only_cat=false,$select=false)
		{
		...
		function mod_customerlogin($title)
		{
			...
			<?php
				...
				{
			?>		<div class="bottomlogin">Already a customer? <a href="<?php url_link('custlogin.html')?>"><?=stripslash_normal($Captions_arr['CUST_LOGIN']['LOGIN'])?></a></div>
			<?php
				}
			}
			else
