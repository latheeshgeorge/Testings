	  ...
	  function wishlist_Showform()
	  {
		...
		<form method="post" name="frm_wishlist" class="frm_cls" action="<?php url_link('wishlist.html')?>">
		  ...
		  <?php 
				...
				?>
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class="gtableA">
								<tr>		
						<td colspan="3" class="tdbgrys">
				...
				<tr>
					<td align="left" valign="middle" class="cart_td_delete" colspan="3">
								<input type="button" name="button" id="button" onclick="if(confirm_message('<?=stripslash_javascript($Captions_arr['WISHLIST']['WISHLIST_DEL_CONFIRM']);?>')){document.frm_wishlist.wish_mod.value='delete_wishlist';document.frm_wishlist.wishlist_id.value='<?=$row_select_wish['wishlist_id']?>';document.frm_wishlist.submit();}" value="Delete" class="breda" />
					</td>
				</tr>
