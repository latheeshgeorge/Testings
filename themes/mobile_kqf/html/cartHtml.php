                ...
                <td class="tda"> 
                    ...
                    <tr>
						...
						*/ 
                        ...
                        <td class="tdbgrys"><span class="fbig"><?php echo print_price($products_arr['final_price'],true)?></span></td>
                    </tr>
                    <?php
                    /*
                    <tr>
...
<?php
                        ...
                        <td class="tdbgry"><?php echo print_price($cartData["totals"]["delivery"],true)?></td>
                        </tr>
                        <?php
                        }
                        ...
                        <td  class="tdbgry"><?php echo print_price($cartData["totals"]["extraShipping"],true)?></td>
                        </tr>
                        <?php	
                        }
                        ...
                        <td  class="tdbgry">(-) <? echo print_price($cartData["bonus"]["value"],true);?></td>
                        </tr>
                        <?php			
                        }
                        ...
                        ?>
                        <tr>
                            <td class="tdbgry"><?php echo $Captions_arr['CART']['CART_TOTAL_FINAL_COST']?>&nbsp; </td>
                            <td class="tdbgry"><?php echo print_price($cartData["totals"]["bonus_price"],true)?></td>
                        </tr>
                        <?php
                        }
                        ...
                        ?>
                        <tr>
                            <td class="tdbgry"><?php echo $Captions_arr['CART']['CART_LESS_AMT_LATER']?>&nbsp; </td>
                            <td class="tdbgry"><?php echo print_price($str_reduceval,true)?></td>
                        </tr>
                        <tr>
                            <td class="tdbgry"><?php echo $Captions_arr['CART']['CART_TOTAL_AMT_NOW']?>&nbsp; </td>
                            <td class="tdbgry"><?php echo print_price($rem_val,true)?>
       ...
       if($Settings_arr['date_compulsary']==1)
		...
		{   
			if($mod=='date')
			{
				...
				/*
				?>	
				<script type="text/javascript" src="http://<?php echo $ecom_hostname?>/images/<?php echo $ecom_hostname?>/mobile_scripts/datepicker/jquery-1.7.2.js"></script>
				<script type="text/javascript" src="http://<?php echo $ecom_hostname?>/images/<?php echo $ecom_hostname?>/mobile_scripts/datepicker/jquery.ui.core.js"></script>			
				<!--<script type="text/javascript" src="http://<?php echo $ecom_hostname?>/images/<?php echo $ecom_hostname?>/mobile_scripts/datepicker/jquery.ui.core.js"></script>-->
				<script type="text/javascript" src="http://<?php echo $ecom_hostname?>/images/<?php echo $ecom_hostname?>/mobile_scripts/datepicker/jquery.ui.datepicker.js"></script>
				<script type="text/javascript" src="http://<?php echo $ecom_hostname?>/images/<?php echo $ecom_hostname?>/mobile_scripts/datepicker/jquery-ui.multidatespicker.js"></script>
				 <script type="text/javascript">
		jQuery.noConflict();
		var $j = jQuery;
		...
		<link rel="stylesheet" type="text/css" href="http://<?php echo $ecom_hostname?>/images/<?php echo $ecom_hostname?>/mobile_css/datepicker/mdp.css">
		<link rel="stylesheet" type="text/css" href="http://<?php echo $ecom_hostname?>/images/<?php echo $ecom_hostname?>/mobile_css/datepicker/prettify.css">
		<?php
		/*
		<script type="text/javascript" src="http://<?php echo $ecom_hostname?>/images/<?php echo $ecom_hostname?>/mobile_scripts/datepicker/prettify.js"></script>
		<script type="text/javascript" src="http://<?php echo $ecom_hostname?>/images/<?php echo $ecom_hostname?>/mobile_scripts/datepicker/lang-css.js"></script>
		<script type="text/javascript">
		$(function() {
		prettyPrint();
		});
		...
		*/ 
		...
		if($db->num_rows($ret_cartdt)>0)
		{
				if($row_cartdt['date']!='0000-00-00')
				{ 
					$dateArrs1	=	explode("-",$row_cartdt['date']);
					$dateJAS1		.=	"defaultDate:";
					//echo "<pre>";print_r($dateArr);'
					$dateJAS1		.=	"'".$dateArrs[1]."/".$dateArrs[2]."/".$dateArrs[0]."'";
					$dateJAS1		.=	"";
				}
		}			
				//echo $dateJAS;
				...
				$ret_date_map 	  = $db->query($sql_date_map); 
								$ret_date_map1 	  = $db->query($sql_date_map); 
				...
				if($db->num_rows($ret_date_map1) > 0)
				{																
					
					
					$dateJSs1    = '';
					while($row_date1 = $db->fetch_array($ret_date_map1))
					{
						if($row_date1['date']!='0000-00-00')
						{
					$dateArr	=	array();
					$dateArr	=	explode("-",$row_date1['date']);
					//echo "<pre>";print_r($dateArr);
					$dateJSs1		.=	"\"".$dateArr[2]."-".intval($dateArr[1])."-".$dateArr[0]."\",";
						}
...
$(function() {
var unavailableDates = '<?php echo $dateJS1 ?>';
...
<?php		}
		...
		<tr>
		<td align="left" valign="top" width="" class="tdbgry">Select Delivery Date </td>
		</tr>
		<tr><td align="left" class="date_td"><div id="multipleDate"></div><br><input type="hidden" id="datesField" name="datesField" readonly="readonly"></td>
		</tr>
		</table>
				<?php
				/*
		...
		$j('#multipleDate').multiDatesPicker({
		altField: '#datesField',
		beforeShowDay: $j.datepicker.noSundays,
		//maxPicks: 10,			
		<?php echo $dateJS;?>
		<?php
		if($dateJAS!='')
		...
		*/ 	
			...
			{	//print_r($row_cartdet);
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td align="left" valign="top" width="33%" class="tdbgry">Select Delivery Time </td></tr>
					<tr>
							...
							?>
									...
									$head_class  	= '';
                                                  ...
                                                  <tr><td align="left" valign="middle" class="td" colspan="2">
														<?php echo stripslash_normal($Captions_arr['CART']['CART_IS_BILLING_ADDRESS_SAME'])?>
                                                        </td></tr>
													<tr>
                                                       <td align="left" valign="middle" class="td" colspan="2">
														<select name="checkout_account_same" onchange="handle_billingaddress_change('billing',document.frm_checkout)" class="yselect">
									...
									?>	
                                                    <tr id="checkout_billing_tr" style="display:none">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        $class_array['txtarea_cls'] = 'regiinput';
                                                                                            echo get_Field($row_checkout['field_key'],$saved_request,'','',$class_array);
                                                                                        ?>
                                                                                        </td>
                                                                                    </tr>
                                                                            <?php
									 ...
									 // check whether billing and shipping address can be different in the site.
                                                  ...
                                                  <tr><td align="left" valign="middle" class="td" colspan="2">
													...
													<tr>
                                                       <td align="left" valign="middle" class="td" colspan="2">
														<select name="checkout_billing_same" onchange="handle_billingaddress_change('delivery',document.frm_checkout)" class="yselect" >
													...
													//if(($billing_same=='N')) 
													{?> 
													<tr id="checkout_delivery_tr" style="display:none" >
									...
									<tr>
                                        <td colspan="2" class="td">
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="gtable">
                                                <tr>
                                                <td align="right" valign="middle" class="td"><?php echo stripslash_normal($Captions_arr['CART']['CART_TOTPRICE'])?>&nbsp;</td>
                                                ...
                                                ?>	
                                                        <tr>
                                                            <td  align="right" valign="middle" class="td"><?php echo stripslash_normal($Captions_arr['CART']['CART_GIFTWRAP_REQ'])?> (<?php echo print_price($row_gift['giftwrap_minprice'],true)?>)</td>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td  align="right" valign="middle" class="td"><?php echo stripslash_normal($Captions_arr['CART']['CART_GIFTWRAP_MSG'])?>(<?php echo print_price($row_gift['giftwrap_messageprice'],true)?>)</td>
                                                            <td  align="right" valign="middle" class="td"><span class="black"><?php echo stripslash_normal($Captions_arr['CART']['CART_YES'])?></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td  align="right" valign="middle" class="td"><?php echo stripslash_normal($Captions_arr['CART']['CART_MSG'])?></td>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td align="right" valign="middle" class="td"><?php echo stripslash_normal($Captions_arr['CART']['CART_RIBBON'])?>(<?php echo print_price($row_ribbon['ribbon_extraprice'],true)?>)</td>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td  align="right" valign="middle" class="td"><?php echo stripslash_normal($Captions_arr['CART']['CART_PAPER'])?>(<?php echo print_price($row_paper['paper_extraprice'],true)?>)</td>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td align="right" valign="middle" class="td"><?php echo stripslash_normal($Captions_arr['CART']['CART_CARDS'])?>(<?php echo print_price($row_card['card_extraprice'],true)?>)</td>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td align="right" valign="middle" class="td"><?php echo stripslash_normal($Captions_arr['CART']['CART_BOWS'])?>(<?php echo print_price($row_bow['bow_extraprice'],true)?>)</td>
                                                ...
                                                ?>
                                                  <tr>
                                                    <td align="right" valign="middle" class="td"><?php echo stripslash_normal($Captions_arr['CART']['CART_GIFTWRAP_TOTAL'])?></td>
                                                ...
                                                ?>	
                                                            <tr>
                                                                <td  align="right" valign="middle" class="td"><?php echo stripslash_normal($Captions_arr['CART']['CART_DELIVERY_LOC'])?></td>
                                                ...
                                                ?>	
                                                            <tr>
                                                                <td  align="right" valign="middle" class="td"><?php echo stripslash_normal($Captions_arr['CART']['CART_DELIVERY_OPT'])?></td>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td  align="right" valign="middle" class="td"><?php echo stripslash_normal($Captions_arr['CART']['CART_DELIVERY_SPLIT_ACTIVATED'])?></td>
                                                        <td  align="right" valign="middle" class="td"><span class="black"><?php echo stripslash_normal($Captions_arr['CART']['CART_YES'])?></span></td>
                                                    </tr>
                                                <?php	
                                                }
                                                ...
                                                { 
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td class="td"  align="rght" valign="middle">
                                                            <? 
                                                ...
                                                ?>
                                                  <tr>
                                                    <td align="right" valign="middle" class="td"><?php echo stripslash_normal($Captions_arr['CART']['CART_TOTAL_DELIVERY_CHARGES'])?></td>
                                                ...
                                                ?>
                                                 <tr>
                                                    <td align="right" valign="middle" class="tdy"><?php echo stripslash_normal($Captions_arr['CART']['CART_EXTRA_SHIPPING'])?></td>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td align="right" valign="middle" class="td"><div align="">
                                                        <?php echo stripslash_normal($Captions_arr['CART']['CART_TAX_CHARGE_APPLIED'])?>
                                                        <?	
                                                            foreach($cartData["tax"] as $tax)
                                                            {
                                                ...
                                                if ($cartData["customer"]["customer_bonus"]) // does current customer have bonus points
                                                {
                                                    ...
                                                    ?>
                                                      <tr>
                                                        <td align="right" valign="top" class="td"><?php echo stripslash_normal($Captions_arr['CART']['CART_SPENT_BONUS_POINTS_VALUE'])?> </td>
                                                ...
                                                ?>
                                                 <tr>
                                                    <td  align="right" valign="middle" class="td"><?php echo stripslash_normal($Captions_arr['CART']['CART_TOTAL_POINTS_EARN'])?>&nbsp;</td>
                                                ...
                                                ?>
                                                <tr>
                                                    <td  align="right" valign="middle" class="td"><?php echo stripslash_normal($Captions_arr['CART']['CART_LESS_AMT_LATER'])?>&nbsp; </td>
                                                    <td align="right" valign="middle" class="td"><span class="black"><?php echo print_price($str_reduceval,true)?></span></td>
                                                </tr>
                                                <tr>
                                                    <td  align="right" valign="middle" class="td"><?php echo stripslash_normal($Captions_arr['CART']['CART_TOTAL_AMT_NOW'])?>&nbsp; </td>
		...
		function validate_checkout_fields(frm)
		{
		 ...
		 window.onload = handle_billingaddress_change('onload','');
...
<?php */ /*?>		<tr>
		...
		?>
			...
			<div align="right" class="carterrormsg_span" ><a href="javascript: hide_instockmsg_div()"><img src="<?php url_site_image('close.png')?>" border="0" /></a></div>
		...
		?>
			...
			<div align="right" class="carterrormsg_span" ><a href="#" onclick="hide_instockmsg_div();document.frm_cart.cart_savepromotional.value=1;handle_form_submit(document.frm_cart,'save_commondetails','#a_prom')"><img src="<?php url_site_image('close.png')?>" border="0" /></a></div>
			<span class="carterrormsg_msg">
			<?php echo $msg?></span>
			</div>
		<?php	
