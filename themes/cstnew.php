...
# Modified On		: 
#################################################################*/
/*if($_SERVER['REMOTE_ADDR']=='182.72.159.170' or $_SERVER['REMOTE_ADDR']=='59.95.73.15' or $_SERVER['REMOTE_ADDR']=='117.241.48.140')
{
	
}	
else
{
	die("<div style='color:#FF0000;font-size:24px;text-align:center;width:100%;padding-top:150px;'>--- Website Under Construction ---</div>");
}*/
...
{	
	...
	case 'prod_detail':
		if($_REQUEST['prod_mod']=='comp_list')
			...
			include($ecom_themename.'/proddetail.php');
	break;
	case 'cart':// Cart page
