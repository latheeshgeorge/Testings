...
function validate_allforms(form){
	...
	if(topfrm){
			...
			<td colspan="2">
				<table width="100%" border="0" cellpadding="0" cellspacing="6" >
					...
					<tr>
					  ...
					  <td width="57%" align="left" valign="middle"><input name="customer_compname" type="text" class="regiinput" id="customer_compname" size="25" value="<?=$row_customer['customer_compname']?>"  /></td>
					</tr>
					...
					<tr>
						...
						<td align="left" valign="middle"><input name="customer_compregno" type="text" class="regiinput" id="customer_compregno" size="25" value="<?=$row_customer['customer_compregno']?>"  /></td>
					</tr>
					<tr>
						<td align="left" valign="middle" class="regiconent"><?=$Captions_arr['CUST_REG']['CUSTOMER_COMP_VATREGNO']?></td>
						<td align="left" valign="middle"><input name="customer_compvatregno" type="text" class="regiinput" id="customer_compvatregno" size="25" value="<?=$row_customer['customer_compvatregno']?>"/></td>
					</tr>
				</table>
			</td> 
		</tr>
		...
		<tr>
			...
			<td align="left" valign="middle"><input name="customer_fname" type="text" class="regiinput" id="customer_fname" size="25" value="<?=$row_customer['customer_fname']?>" /></td>
		</tr>
		<tr>
			<td align="left" valign="middle" class="regiconent"><?=$Captions_arr['CUST_REG']['CUSTOMER_MNAME']?></td>
			<td align="left" valign="middle">
		<input name="customer_mname" type="text" class="regiinput" id="customer_mname" size="25" value="<?=$row_customer['customer_mname']?>"  />   </td>
		</tr>
		<tr>
			<td align="left" valign="middle" class="regiconent"><?=$Captions_arr['CUST_REG']['CUSTOMER_SURNAME']?> </td>
			<td align="left" valign="middle"><input name="customer_surname" type="text" class="regiinput" id="customer_surname" size="25" value="<?=$row_customer['customer_surname']?>"  /></td>
		</tr>
		<tr>
			<td align="left" valign="middle" class="regiconent"><?=$Captions_arr['CUST_REG']['CUSTOMER_POSITION']?></td>
			<td align="left" valign="middle"><input name="customer_position" type="text" class="regiinput" id="customer_position" size="25" value="<?=$row_customer['customer_position']?>"  /></td>
		</tr>
		
		<tr>
			<td align="left" valign="middle" class="regiconent"><?=$Captions_arr['CUST_REG']['CUSTOMER_BUILDING_NAME']?></td>
			<td align="left" valign="middle"><input name="customer_buildingname" type="text" class="regiinput" id="customer_buildingname" size="25" value="<?=$row_customer['customer_buildingname']?>" /></td>
		</tr>
		<tr>
			<td align="left" valign="middle" class="regiconent"><?=$Captions_arr['CUST_REG']['CUSTOMER_STREET_NAME']?></td>
			<td align="left" valign="middle"><input name="customer_streetname" type="text" class="regiinput" id="customer_streetname" size="25" value="<?=$row_customer['customer_streetname']?>" /></td>
		</tr>
		<tr>
			<td align="left" valign="middle" class="regiconent"><?=$Captions_arr['CUST_REG']['CUSTOMER_TOWN_CITY']?></td>
			<td align="left" valign="middle"><input name="customer_towncity" type="text" class="regiinput" id="customer_towncity" size="25" value="<?=$row_customer['customer_towncity']?>" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td align="left" valign="middle">
		<?php 		
		$state_arr = array(0=>'-- Select State --',-1=>$Captions_arr['CUST_REG']['OTHER_STATE']);
		if($row_customer['country_id'])
						{
							$sql_state = "SELECT *
											...
											WHERE 
												...
												AND sites_site_id=$ecom_siteid AND state_hide=1";
							$ret_state = $db->query($sql_state);
							if ($db->num_rows($ret_state))
							{
								while($row_state = $db->fetch_array($ret_state))
		...
		<tr>
			...
			<td align="left" valign="middle"><input name="customer_phone" type="text" class="regiinput" id="customer_phone" size="25" value="<?=$row_customer['customer_phone']?>" /></td>
		</tr>
		<tr>
			<td align="left" valign="middle" class="regiconent"><?=$Captions_arr['CUST_REG']['CUSTOMER_FAX']?></td>
			<td align="left" valign="middle"><input name="customer_fax" type="text" class="regiinput" id="customer_fax" size="25" value="<?=$row_customer['customer_fax']?>" /></td>
		</tr>
		<tr>
			<td align="left" valign="middle" class="regiconent"><?=$Captions_arr['CUST_REG']['CUST_MOB']?></td>
			<td align="left" valign="middle"><input name="customer_mobile" type="text" class="regiinput" id="customer_mobile" size="25" value="<?=$row_customer['customer_mobile']?>" /></td>
		</tr>
		<tr>
			<td align="left" valign="middle" class="regiconent"><?=$Captions_arr['CUST_REG']['CUSTOMER_POSTCODE']?></td>
			<td align="left" valign="middle"><input name="customer_postcode" type="text" class="regiinput" id="customer_postcode" size="25" value="<?=$row_customer['customer_postcode']?>" /></td>
		</tr>
		
		<tr>
			<td align="left" valign="middle" class="regiconent"><?=$Captions_arr['CUST_REG']['CUSTOMER_EMAIL']?><span class="redtext">*</span></td>
			<td align="left" valign="middle"><input name="customer_email" type="text" class="regiinput" id="customer_email" size="25" value="<?=$row_customer['customer_email_7503']?>" /></td>
		</tr>
		<tr>
