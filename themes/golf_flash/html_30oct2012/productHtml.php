			...
			<div class="deat_img_outr">
			   ...
			   <div class="deat_pdt_icons">
				...
				<?=$HTML_bonus?>
				 ...
				 <? 
				if($ecom_siteid==96) // only for floorings online
				{
				...
				?>	
				  <tr>
					...
					<td align="left" valign="middle" class="varable_table_left">
						...
						{
							if($ecom_siteid==96) // case of flooringonline website
							{
...
?>
			...
			<div class='buyBinner_txt'><input type="text" class="det_qty_txt" name="qty"  value="<?php echo ($_REQUEST['qty'])?$_REQUEST['qty']:1?>" maxlength="2" <?php echo $onchange_function?> /></div>
<?php
		}
...
function show_special_qty_box($row_prod,$normal=false)
{
	...
	if($ecom_siteid==96 and $normal==false)
	{
		if($row_prod['product_variablecomboprice_allowed'] =='N' and  $row_prod['product_variablecombocommon_image_allowed']=='N')// and $row_prod['product_variablestock_allowed']=='N')
			$onchange_function      = " onChange='handle_normal_price_reload(\"".SITE_URL."\",\"".$_REQUEST['product_id']."\",\"".url_site_image('loading.gif',1)."\")'";
		else
	...
	if($showqty==1)// this decision is made in the main shop settings
	{
		...
		{
?>
<?php if($normal==true) { echo  $cur_qty_caption;}?> <input type="text" class="det_qty_txt" name="qty"  value="<?php echo ($_REQUEST['qty'])?$_REQUEST['qty']:1?>" maxlength="2" <?php echo $onchange_function?> /> <? if ($normal==false) { echo $cur_qty_caption?>  X <?php }?> 
<?php
		}
		elseif($row_prod['product_det_qty_type']=='DROP')
		{
