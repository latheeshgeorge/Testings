...
/*			// Check whether size chart details exists for current product
		   ...
		   $sql_prods = "SELECT product_sizechart_mainheading 
			...
			$HTML_treemenu = ' <div class="tree_menu_con_det">
								<div class="tree_menu_top_det"></div>
								<div class="tree_menu_mid_det">
								<div class="tree_menu_content">
								<ul class="tree_menu">'.generate_tree_menu(-1,$_REQUEST['product_id'],'','<li>','</li>').'
								</ul>
								</div>
								</div>
								<div class="tree_menu_bottom_det"></div>
								</div>';
			...
			if(in_array('mod_product_reviews',$inlineSiteComponents)) // Check whether the product review module is there for current site
			{
				...
				{
					$HTML_readrev = '<a href="'.url_link('readproductreview'.$_REQUEST['product_id'].'.html',1).'" rel="nofollow" title="'.stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_READREVIEW']).'"><img src="'.url_site_image('det-icon_05.gif',1).'" border="0" /> '.stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_READREVIEW']).'</a>';
				}
			}
			if($email_show==1)
			{
			...
			{ 
				$HTML_pdf = '<a href="javascript:download_pdf_common(\''.$_SERVER['HTTP_HOST'].'\',\''.$_SERVER['REQUEST_URI'].'\')" title="'.stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_DOWNLOADPDF']).'"><img src="'.url_site_image('det-icon_09.gif',1).'" border="0" /> '.stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_DOWNLOADPDF']).'</a>';
			}
			...
			if($was_price)
			{
				$HTML_price .= '<div class="deat_priceA" '.$was_microdata.'>'.$was_price.'</div>';
			}	
			if($cur_price)
			{
				$HTML_price .= '<div class="deat_priceB" '.$cur_microdata.'>'.$cur_price.'</div>';	
			}
			if($sav_price)
			{
			...
			if($in_combo==1 or $row_prod['product_freedelivery']==1 or $row_prod['product_show_pricepromise']==1)
			{
				$HTML_promise_buttons = '
										<div class="deat_button_outr">
										<div class="deat_cont_button">';
				if($in_combo==1)
				{
				...
				{
					$HTML_promise_buttons .= '<a href="'.url_link('freedelivery'.$row_prod['product_id'].'.html',1).'" title="Free Delivery"><img src="'. url_site_image('free.gif',1).'" border="0" /></a>';
				}
			...
			if ($Settings_arr['show_bookmarks'])
			{
				...
				if($ecom_siteid == 77) // only for shoot uk
				{
					$HTML_bottomblock .= '
								...
								js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=158683712433";
								fjs.parentNode.insertBefore(js, fjs);
								}(document, \'script\', \'facebook-jssdk\'));</script>
								<div class="fb-like" data-href="'.url_product($row_prod['product_id'],$row_prod['product_name'],1).'" data-send="false" data-layout="box_count" data-width="450" data-show-faces="false"></div>
								</div>
								';
				}
			...
			<?php /*?>jQuery.noConflict();
			var $j = jQuery;
			$j(document).ready(
				function(){
				$j("#mycatDiv").fadeOut(5000,function() {
	    			$j("#myprodDiv").show('fast');
				});
				
			});<?php */?>

			</script>
			<?php /*?><div id="mycatDiv">this is the category content. this is the content. this is the content. this is the content. this is the content. this is the content.
			this is the content.this is the content. this is the category content. this is the content. this is the content. this is the content. this is the content. this is the content.
			this is the content.this is the content. this is the category content. this is the content. this is the content. this is the content. this is the content. this is the content.
			this is the content.this is the content. this is the category content. this is the content. this is the content. this is the content. this is the content. this is the content.
			this is the content.this is the content.<br /><br />
			this is the category content. this is the content. this is the content. this is the content. this is the content. this is the content.
			this is the content.this is the content.this is the category content. this is the content. this is the content. this is the content. this is the content. this is the content.
			this is the content.this is the content.</div>
			
			<div id="myprodDiv" style="display:none">Product Div. this is the content. this is the content. this is the content. this is the content. this is the content.
			this is the content.this is the content. this is the category content. this is the content. this is the content. this is the content. this is the content. this is the content.
			this is the content.this is the content. this is the category content. this is the content. this is the content. this is the content. this is the content. this is the content.
			this is the content.this is the content. this is the category content. this is the content. this is the content. this is the content. this is the content. this is the content.
			this is the content.this is the content.<br /><br />
			this is the category content. this is the content. this is the content. this is the content. this is the content. this is the content.
			this is the content.this is the content.this is the category content. this is the content. this is the content. this is the content. this is the content. this is the content.
			this is the content.this is the content.</div><?php */?>
			<form method="post" name="ModelForm" id="ModelForm" action="<?php url_link('search_model.html')?>" class="frm_cls">
						<input type="hidden" name="req" value="search_model" />
						<input type="hidden" name="search_meth" value="ord_search" />
			...
			<div class="deat_outer" itemscope itemtype="http://schema.org/Product">
			<div class="deat_top"></div>
			<div class="deat_cont">
			<?=$HTML_treemenu?>
			<div class="deat_img_outr">
				<div class="deat_img_top"></div>
				<div class="deat_img_cont">
				<div class="deat_pdt_name"><h1 itemprop="name"><?php echo stripslash_normal($row_prod['product_name']);?></h1>
					<?php 
				 ...
				 <div class="deat_pdt_image"><div id="mainimage_holder"><?php $this->Show_Image_Normal($row_prod);?></div>
				 <?=$HTML_loading?>
				 </div>
				<div class="deat_pdt_com_outr">
				...
				<?=$HTML_bookmark?>
			 	...
			 	<div class="deat_cont_outr" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
					<meta itemprop="itemCondition" itemtype="http://schema.org/OfferItemCondition" content="http://schema.org/NewCondition"/>
					<meta itemprop="availability" content="http://schema.org/InStock"/>
				<div class="deat_cont_top"></div>
				<div class="deat_cont_cont">
			   <div class="deat_pdt_icons">
			   </div>
				...
				<?=$HTML_bonus?>
				 ...
				 if($enable_special_display == false)
				 {
					...
					if($ecom_siteid==96 and $this->do_show_calculator()) // only for floorings online
					{
						 $this-> show_ProductVariables_special($row_prod,'',$sizechart_heading);
					}
					else
					{ 
				 ...
				 if($ecom_siteid==96 and $this->do_show_calculator()) // only for floorings online
				 {
					// $this->show_special_qty_box($row_prod);
				 }?> 
				  <div class="deat_pdt_price">
				 <div id='pricetotal_holder'>
				 </div>
				 </div>
				...
				<?
				 ...
				 if($enable_special_display==true) // Call special display function
					{
						$var_listed = $this->show_ProductVariables_specialdisplay($row_prod);
					}
					else
					{
						 if($ecom_siteid==96 and $this->do_show_calculator())
						 	$buy_cls = 'deat_pdt_buy_right_new';
						else
							$buy_cls = 'deat_pdt_buy_right';
					?>
				 <div class="<?php echo $buy_cls?>">
				 <?php
						 if($ecom_siteid==96 and $this->do_show_calculator())
						 {
							if($glob_qty_displayed!=1)
							{
								echo '<div style="text-align:left">';
								$this->show_special_qty_box($row_prod,true);
								echo '</div>';
							}	
							 /*	$hide_qty = false;
							else*/
						...
						$this->show_buttons($row_prod,$hide_qty);
			...
			<?php
				if( $_REQUEST['searchmodelto_prod']==1)
				{
				?>
					<script type="text/javascript">
					function set_back_toprod()
					{
					   document.getElementById("ModelForm").submit();
					}
					</script>
					<div class="back_searchMod"><a href="#" onclick="set_back_toprod()">Back to product result</a></div>
				<?php
				}
				?>
			</div>
...
function show_more_images($row_prod,$exclude_tabid,$exclude_prodid)
{
	...
	?>	
		...
		<div class="det_thumbimg_nav"> <a href="#null" onmouseover="scrollDivLeft('containerB',<?php echo (count($prodimg_arr)*50)?>)" onmouseout="stopMe()"><img src="<?php url_site_image('thmbarwr.gif')?>"></a></div>
		</div>
		</div>	
	<?php
	}
}
function show_ProductVariables_special($row_prod,$pos='column',$sizechart_heading)
{
  ...
  ?>
		...
		if ($db->num_rows($ret_var) or $db->num_rows($ret_msg))
		{
			while ($row_var = $db->fetch_array($ret_var))
			{
				...
				?>	
						<tr>
						<td align="left" valign="top" class="varable_table_left"><?php echo $cur_qty_caption;?> : </td>
						</tr>
						<tr>
						<td align="left" valign="middle" class="varable_table_left">
                        <?php
						//if($var_cnts_sp==0)
							$this->show_special_qty_box($row_prod);
						$var_cnts_sp++;	
				...
				?>
				  <tr>
					<td align="left" valign="top" class="varable_table_left"><?php echo stripslash_normal($row_var['var_name'])?> : </td>
					</tr>
					<tr>
					<td align="left" valign="middle" class="varable_table_left">
                        <?php
						...
						{
							$onchange_function      = " onchange ='handle_show_prod_det_bulk_disc(\"main_img\",\"".SITE_URL."\",\"".$_REQUEST['product_id']."\",\"".url_site_image('loading.gif',1)."\")' ";
                            $onclick_var            = "main_img";
						}
						else
						{
							if($ecom_siteid==96 and $this->do_show_calculator()) // case of flooringonline website
							{
								// Check whether atleast one variable value of current variable have additional price
								$sql_varaddprice_check = "SELECT var_addprice
									FROM 
										product_variable_data 
									WHERE 
										product_variables_var_id =".$row_var['var_id']." 
										AND var_addprice>0 
									LIMIT 1";
								$ret_varaddprice_check = $db->query($sql_varaddprice_check);
								if ($db->num_rows($ret_varaddprice_check))
								{
									$onchange_function      = " onchange='handle_normal_price_reload(\"".SITE_URL."\",\"".$_REQUEST['product_id']."\",\"".url_site_image('loading.gif',1)."\")'";
									$onclick_var       		= '';
								}
								else
								{
						...
						if ($row_var['var_value_exists']==1)
						{
							...
							if($var_disp_type == 'OTHER')
							{
							  ...
							  {
						?>
									<select name="var_<?php echo $row_var['var_id']?>" id="var_<?php echo $row_var['var_id']?>" <?php echo $onchange_function?>  style="width:150px">
									<?php 
						...
						<?php
							  ...
							  else
							  {
									...
									$docroot 		= SITE_URL; 
									$prodid			= $_REQUEST['product_id'];
									$loading_gif 	= $normal_loading_gif = url_site_image('loading.gif',1);
									while ($row_vals = $db->fetch_array($ret_vals))
									{
										if($first_val=='')
										...
										$loading_gif 		= $normal_loading_gif;
										if($ecom_siteid==96 and $this->do_show_calculator())
										{
											if ($onclick_var=='')
											{
												$loading_gif = 'call_new_function';
											}	
										}
		...
		if($ecom_siteid==96 and $this->do_show_calculator())
		{
		if($row_prod['product_variablecomboprice_allowed'] =='N' and  $row_prod['product_variablecombocommon_image_allowed']=='N')// and $row_prod['product_variablestock_allowed']=='N')
		{
			// Check whether atleast one variable value have additional price set up
			$sql_addcheck = "SELECT var_value_id FROM product_variable_data a, product_variables b 
								WHERE 
									b.products_product_id = ".$_REQUEST['product_id']." 
									AND b.var_hide=0 
									AND a.product_variables_var_id = b.var_id 
									AND a.var_addprice>0 
								LIMIT 1";
			$ret_addcheck = $db->query($sql_addcheck);
			if($db->num_rows($ret_addcheck))
			{
				echo '<script type="text/javascript">
						handle_normal_price_reload("'.SITE_URL.'","'.$_REQUEST['product_id'].'","'.url_site_image('loading.gif',1).'");
				</script>';	
			}
		}
  ...
  ?>
		...
		if ($db->num_rows($ret_var) or $db->num_rows($ret_msg))
		{
			while ($row_var = $db->fetch_array($ret_var))
			{
				...
				?>	
				  <tr>
					<td align="right" valign="top" class="varable_table_left"><?php echo stripslash_normal($row_var['var_name'])?> : </td>
						...
						if ($row_var['var_value_exists']==1)
						{
							...
							if($var_disp_type == 'OTHER')
							{
							  ...
							  if($var_disp_type=='DROPDOWN')
							  {
									...
									if($ecom_siteid==83)
									{
										$dropsize = "style='width:270px;'";
									}
						?>
									<select name="var_<?php echo $row_var['var_id']?>" id="var_<?php echo $row_var['var_id']?>" <?php echo $onchange_function?> <?php echo $dropsize?>>
									<?php 
									while ($row_vals = $db->fetch_array($ret_vals))
									{
									?>
...
function show_buttons($row_prod,$hide_qty=false)
{
	...
	if($ecom_siteid == 96)
	{
		$class_arr = array ('deat_pdt_buyB'=>'deat_pdt_buyB_new',
											'deat_pdt_buyBinner'=>'deat_pdt_buyBinner_new',
											'buyBinner_qty'=>'buyBinner_qty_new',
											'buyBinner_txt'=>'buyBinner_txt_new',
											'det_qty_txt'=>'det_qty_txt_new',
											'buyBinner_link'=>'buyBinner_link_new',
											'det_buy_link'=>'det_buy_link_new'
											);
	}
	else
	{
		$class_arr = array ('deat_pdt_buyB'=>'deat_pdt_buyB',
										'deat_pdt_buyBinner'=>'deat_pdt_buyBinner',
										'buyBinner_qty'=>'buyBinner_qty',
										'buyBinner_txt'=>'buyBinner_txt',
										'det_qty_txt'=>'det_qty_txt',
										'buyBinner_link'=>'buyBinner_link',
										'det_buy_link'=>'det_buy_link'
										);
		}							
	...
	{
	?>	
		<div class="<?php echo $class_arr['deat_pdt_buyB']?>">
		<div class="<?php echo $class_arr['deat_pdt_buyBinner']?>">
	<?php	
	if($showqty==1 and $hide_qty!=true)// this decision is made in the main shop settings
	{
		if($row_prod['product_det_qty_type']=='NOR')
		{
?>
			<div class="<?php echo $class_arr['buyBinner_qty']?>"><?=$cur_qty_caption?></div>
			<div class='<?php echo $class_arr['buyBinner_txt']?>'><input type="text" class="<?php echo $class_arr['det_qty_txt']?>" name="qty"  value="<?php echo ($_REQUEST['qty'])?$_REQUEST['qty']:1?>" maxlength="2" <?php echo $onchange_function?> /></div>
<?php
		}
		elseif($row_prod['product_det_qty_type']=='DROP')
		{
			...
			{
			?>
				<div class='<?php echo $class_arr['buyBinner_txt']?>'>
				<select name="qty">
				<?php 
...
<?php
	...
	else
	{
		...
		{
		?>
			<div class="<?php echo $class_arr['buyBinner_link']?>"><a href="javascript:void(0);" class="<?php echo $class_arr['det_buy_link']?>" onclick="show_wait_button(this,'Please Wait...');document.frm_proddetails.fpurpose.value='Prod_Addcart';document.frm_proddetails.submit();"><?php echo stripslash_normal($Captions_arr['PROD_DETAILS'][$caption_key]);?></a></div>		
		<?php
		}
		else
		{
...
function old_show_special_qty_box($row_prod)
{
	global $Captions_arr,$showqty,$Settings_arr,$ecom_siteid,$db;
				if(check_IndividualSslActive())
				{
					$ecom_selfhttp = "https://";
				}
	...
	if($showqty==1)// this decision is made in the main shop settings
	{
		...
		{
?>
			<td align="right" valign="middle" class="varable_table_left"><?=$cur_qty_caption?> : </td>
			<td align="left" valign="middle" class="varable_table_right"><input type="text" class="det_qty_txt" name="qty"  value="<?php echo ($_REQUEST['qty'])?$_REQUEST['qty']:1?>" maxlength="2" <?php echo $onchange_function?> /></td>
<?php
		}
		elseif($row_prod['product_det_qty_type']=='DROP')
		{
...
function show_special_qty_box($row_prod,$normal=false)
{
	global $Captions_arr,$showqty,$Settings_arr,$ecom_siteid,$db,$global_qty_displayed,$glob_qty_displayed;
				if(check_IndividualSslActive())
				{
					$ecom_selfhttp = "https://";
				}
	...
	if($ecom_siteid==96 and $normal==false and $this->do_show_calculator())
	{
		if($row_prod['product_variablecomboprice_allowed'] =='N' and  $row_prod['product_variablecombocommon_image_allowed']=='N')// and $row_prod['product_variablestock_allowed']=='N')
			$onchange_function      = " onChange='handle_normal_price_reload(\"".SITE_URL."\",\"".$_REQUEST['product_id']."\",\"".url_site_image('loading.gif',1)."\")'";
		else
	...
	if($showqty==1)// this decision is made in the main shop settings
	{
		...
		{
?>
<?php if($normal==true) { echo  $cur_qty_caption;}?> <input type="text" class="det_qty_txt" name="qty"  value="<?php echo ($_REQUEST['qty'])?$_REQUEST['qty']:1?>" maxlength="4" <?php echo $onchange_function?> /> <? if ($normal==false) { //echo $cur_qty_caption?>  <?php  /*X*/?> <?php }?> Mts &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="refs" value="Refresh" style="background-color:#E33737;color:#FFF;"/>
<?php
		}
		elseif($row_prod['product_det_qty_type']=='DROP')
		{
			...
			?>
				...
				if($normal==false)
				{
					//echo $cur_qty_caption?>  <?php /*?>X <?php */?>
			<?php	
				}
			}				
		}
...
/* Code for ajax setting ends here */
	...
	function do_show_calculator()
	{
		...
		$show_calc_return = false;
		if($ecom_siteid==96)
		{
			$prodid = $_REQUEST['product_id'];
			/*$cur_cat_arr = array(
											'76096','76028','76029','76030','76041','76042','76043','76077','76080','76095','76337','76338','76339','76340','76341', // Carpets
											'76097','76082','76087','76266', // Vinyls
											'76048','76060','76069','76070','76088','76261','76267' // Luxury vinyl tile
										);*/
			$cur_cat_arr = array(
											'76096','76028','76029','76030','76041','76042','76043','76077','76080','76095','76337','76338','76339','76340','76341','76425','76452', // Carpets
											'76097','76082','76087','76266' // Vinyls
											,76426 //Contract Flooring
										);							
			$sql = "SELECT product_default_category_id FROM products WHERE product_id = $prodid AND sites_site_id = $ecom_siteid LIMIT 1";
			$ret = $db->query($sql);
			if($db->num_rows($ret))
			{
				$row = $db->fetch_array($ret);
				$curcatid = $row['product_default_category_id'];
				if(in_array($curcatid,$cur_cat_arr))
					$show_calc_return = true;
			}
		}
		return $show_calc_return;
	}
};	
?>
