						...
						<td  valign="middle">';
							...
							<div class="review_namebtn">
								...
								if($Captions_arr['PRODUCT_REVIEWS']['READ_PRODUCT_ADDREVIEW_LINK']){
								 echo '<div class="review_btn"><div><a href="'.url_link('writeproductreview'.$product_id.'.html',1).'" rel="nofollow">'.stripslash_normal($Captions_arr['PRODUCT_REVIEWS']['READ_PRODUCT_ADDREVIEW_LINK']).'</a></div></div>';
								}
							echo '</div>
						</td>
					</tr>
