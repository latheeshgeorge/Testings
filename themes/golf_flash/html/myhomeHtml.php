...
/*############################################################################
	...
	class myhome_Html
	{
		function Display_WelcomeMessage($mesgHeader,$Message)
		{
			...
			//$this->Show_Favourite_Products($used_val_arr,false);
		...
		{ 
			...
			{ 
				...
				list($row_last_login) 	= $db->fetch_array($ret_last_login);
						...
						echo '<div class="my_hm_shlf_outr">
						<div class="my_hm_shlf_hdrC">'.stripslash_normal($row_favcat['category_name']).'</div>
							<div class="my_hm_shlf_inner">
							<div class="my_hm_shlf_inner_top"></div>
								<div class="my_hm_shlf_inner_cont">
							   <div class="my_hm_shlf_hdrA_outr"><div class="my_hm_shlf_hdrA_in"><span><strong>'.str_replace('[category]',stripslash_normal($row_cat['category_name']),stripslash_normal($Captions_arr['LOGIN_HOME']['LOGIN_HOME_FAV_RECOMM_PROD'])).'</strong></span></div></div>
									<div class="my_hm_shlf_cont_div">
										<div class="my_hm_shlf_pdt_con">';
										?>										
										<div class="det_link_nav"><a href="#null" onmouseover="scrollDivRight('containerF<?=$row_favcat['category_id']?>')" onmouseout="stopMe()"><img src="<? url_site_image('arrow-left.gif')?>"></a></div>
											<div id="containerF<?=$row_favcat['category_id']?>" class="my_hm_shlf_pdt_inner">
												<div id="scroller">
												<?php
												if($db->num_rows($ret_prods_offers))
												{
													$cnts =$db->num_rows($ret_prods_offers);
													$this->Show_Products($ret_prods_offers,$prod_arr);
												}

											echo '</div>
											</div>
										<div class="det_link_nav"> <a href="#null" onmouseover="scrollDivLeft(\'containerF'.$row_favcat['category_id'].'\','.($cnts*70).')" onmouseout="stopMe()"><img src="'.url_site_image('arrow-right.gif',1).'"></a></div>
										</div>
									</div>
								</div>
							<div class="my_hm_shlf_inner_bottom"></div>
		...
		function Show_Favourite_Products($used_val_arr,$showtop=false)
		{
									...
									<div class="my_hm_shlf_cont_div">
										...
										<div class="det_link_nav"><a href="#null" onmouseover="scrollDivRight('containerFP')" onmouseout="stopMe()"><img src="<? url_site_image('arrow-left.gif')?>"></a></div>
											<div id="containerFP" class="my_hm_shlf_pdt_inner">
												...
												$this->Show_Products($ret_fav_products,$prod_arr1);
