						...
						<div class=" static_con">
							<ul>
								...
								if(count($grp_array))
								{
									...
									?>
										<li>
										<?php if ($ecom_siteid!=83) { echo "<h2>";}?> <a href="<?php url_link('')?>" class="static_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?></span></a><?php if ($ecom_siteid!=83) { echo "</h2>";}?>
										</li>
									<?php
									}
									...
									?>
										<li>
										<?php if ($ecom_siteid!=83) { echo "<h2>";}?> <a href="<?php if ($row_pg['page_type']=='Page') url_static_page($row_pg['page_id'],$row_pg['title']); else echo $row_pg['page_link'];?>" class="static_menu" title="<?php echo stripslash_normal($row_pg['title'])?>" <?php echo $target?>><span><?php echo stripslash_normal($row_pg['title']);?></span></a><?php if ($ecom_siteid!=83) { echo "</h2>";}?>
										</li>
									<?php
									}
									...
									?>
										<li>
										<?php if ($ecom_siteid!=83) { echo "<h2>";}?> <a href="<?php url_link('sitemap.xml')?>" class="static_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP'])?></span></a><?php if ($ecom_siteid!=83) { echo "</h2>";}?>
										</li>
									<?php	
									}
									...
									?>
										<li>
										<?php if ($ecom_siteid!=83) { echo "<h2>";}?> <a href="<?php url_link('sitemap.html')?>" class="static_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SITEMAP'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SITEMAP'])?></span></a><?php if ($ecom_siteid!=83) { echo "</h2>";}?>
										</li>
									<?php		
									}
									...
									?>
										<li>
										<?php if ($ecom_siteid!=83) { echo "<h2>";}?> <a href="<?php url_link('saved-search.html')?>" class="static_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH'])?></span></a><?php if ($ecom_siteid!=83) { echo "</h2>";}?>
										</li>
									<?php		
									}
									...
									?>
										<li>
										<?php if ($ecom_siteid!=83) { echo "<h2>";}?> <a href="<?php url_link('help.html')?>" class="static_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HELP'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HELP'])?></span></a></h2>
										</li>
									<?php
									}
									...
									?>
										<li>
										<?php if ($ecom_siteid!=83) { echo "<h2>";}?> <a href="<?php url_link('faq.html')?>" class="static_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_FAQ'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_FAQ'])?></span></a><?php if ($ecom_siteid!=83) { echo "</h2>";}?>
										</li>
									<?php
									}
									}
...
<?php
						...
						<div class="static_con_bottom">
							<ul >
								...
								if ($grpData['group_showhomelink']==1)
								{
									?>
									<li>
									<span><a href="<?php url_link('')?>" class="Category" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?></a></span>
									</li>
									<?php			
								}
									$show_top = 0;
								...
								$target = ($row_pg['page_link_newwindow']==1 and $row_pg['page_type']!='Page')?'target="_blank"':'';
									?>
									<li>
									<span><a href="<?php if ($row_pg['page_type']=='Page') url_static_page($row_pg['page_id'],$row_pg['title']); else echo $row_pg['page_link'];?>" class="bottomlink" title="<?php echo stripslash_normal($row_pg['title'])?>" <?php echo $target?>><?php echo stripslash_normal($row_pg['title']);?></a></span>
									</li>
									<?php
								}
								}
								...
								if ($grpData['group_showsitemaplink']==1)
								{
									?>
									<li>
									<span><a href="<?php url_link('sitemap.html')?>" class="Category" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SITEMAP'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SITEMAP'])?></a></span>
									</li>
									<?php			
								}
								if ($grpData['group_showxmlsitemaplink']==1 )
								{			
									?>
									<li>
									<span><a href="<?php url_link('sitemap.xml')?>" class="Category" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP'])?></a></span>
									</li>
									<?php									
								}
								if ($grpData['group_showfaqlink']==1)
								{
									?>
									<li>
									<span><a href="<?php url_link('faq.html')?>" class="Category" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_FAQ'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_FAQ'])?></a></span>
									</li>
									<?php			
								}
								if ($grpData['group_showhelplink']==1)
								{
									?>
									<li>
									<span><a href="<?php url_link('help.html')?>" class="Category" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HELP'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HELP'])?></a></span>
									</li>
									<?php			
								}
								if ($grpData['group_showsavedsearchlink']==1)
								{
									?>
									<li>
									<span><a href="<?php url_link('saved-search.html')?>" class="Category" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH'])?></a></span>
									</li>
									<?php			
								}
								?>
					...
					elseif ($position=='seo-section')
					{
							...
							$prev_grp = $grpData['group_id'];
								...
								?>
								<li>
								<span><a href="<?php url_link('')?>" class="general_links_div_link" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_HOME']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_HOME']?></a></span>
								</li>
							<?php		
								}
								while ($row_pg = $db->fetch_array($ret_pg))
							  ...
							  ?>
								<li>
								<span><a href="<?php if ($row_pg['page_type']=='Page') url_static_page($row_pg['page_id'],$row_pg['title']); else echo $row_pg['page_link'];?>" class="general_links_div_link" title="<?php echo stripslashes($row_pg['title'])?>" <?php echo $target?>><?php echo stripslashes($row_pg['title']);?></a></span>
								</li>
							<?php 
								}
								if ($grpData['group_showsitemaplink']==1)
							...
							?>
								<li>
								<span><a href="<?php url_link('sitemap.html')?>" class="general_links_div_link" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_SITEMAP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_SITEMAP']?></a></span>
								</li>
							<?php		
								}
								if ($grpData['group_showxmlsitemaplink']==1 )
							...
							?>
								<li>
								<span><a href="<?php url_link('sitemap.xml')?>" class="general_links_div_link" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP']?></a></span>
								</li>
							<?php		
								}
								if ($grpData['group_showhelplink']==1)
							...
							?>
								<li>
								<span><a href="<?php url_link('help.html')?>" class="general_links_div_link" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_HELP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_HELP']?></a></span>
								</li>
							<?php		
								}
								if ($grpData['group_showsavedsearchlink']==1)
								...
								?>
									<li>
									<span><a href="<?php url_link('saved-search.html')?>" class="general_links_div_link" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH']?></a></span>
									</li>
								<?php			
								}
							  ?>
									...
									if ($db->num_rows($ret_cat))
									{
										...
										if ($grpData['catgroup_show_subcat_indropdown']== 1 and $subcatdropdownsupport)// case if categories are to be shown in list menu
										{
											...
											<?php
												...
												{
											?>
												<li class="item1"><a href="<?php echo $ecom_selfhttp.$ecom_hostname?>/search_model.html" class="category_menu" title="PARTS FINDER"><span>PARTS FINDER</span></a></a>
											<?php
												}
											?>	
												</ul>
														...
														<ul  id="main_navigation"> 
															<?php
																...
																while ($row_cat = $db->fetch_array($ret_cat))
																{
																	?>
																	<li>
																	<span><a href="<?php url_category($row_cat['category_id'],$row_cat['category_name'],-1)?>" class="category_menu" title="<?php echo stripslash_normal($row_cat['category_name'])?>"><span><?php echo ucwords(stripslash_normal($row_cat['category_name']));?></span></a></span>
																<?php
																	// Check whether there exists first level subcategories for current category
																	$sql_subcat = "SELECT category_id,category_name 
																					FROM 
								...
								$sql_cat = "SELECT a.category_id,a.category_name,parent_id,b.category_displaytype,b.category_islink,a.category_subcatlisttype   
									...
									if ($db->num_rows($ret_cat))
									{
										...
										while ($row_cat = $db->fetch_array($ret_cat))
										{
											...
											?>
												<li>
												<a href="<?php url_category($row_cat['category_id'],$row_cat['category_name'],-1)?>" class="catelink" title="<?php echo stripslash_normal($row_cat['category_name'])?>"><?php echo ucwords(stripslash_normal($row_cat['category_name']));?></a>
												</li>
											<?php
											}
											...
											?>
												<li>
												<span class="subcategoryheader"><?php echo stripslash_normal($row_cat['category_name']);?></span>
												</li>
											<?											
											}
											...
											?>
												<li>
												<span class="subcategoryheader"><a href="<?php url_category($row_cat['category_id'],$row_cat['category_name'],-1)?>" class="subcategoryheaderlink" title="<?php echo stripslash_normal($row_cat['category_name'])?>"><?php echo ucwords(stripslash_normal($row_cat['category_name']));?></a></span>
											<?
												$entered = 1;
											}
											elseif($row_cat['category_displaytype']=='Heading' && !$row_cat['category_islink'])
											...
											?>
												<li>
												<span class="subcategoryheader"><?php echo ucwords(stripslash_normal($row_cat['category_name']));?></span>
											<?
											}
											...
											<?php
													...
													?>
													<li>
													<a href="<?php url_category($row_child['category_id'],$row_child['category_name'],-1)?>" title="<?php echo stripslash_normal($row_child['category_name'])?>" class="subcatelink"><?php echo ucwords(stripslash_normal($row_child['category_name']));?></a>
													</li>
											<?php		
														}
													}
...
<?php
		...
		{
			global $Captions_arr,$position,$ecom_hostname,$protectedUrl,$Settings_arr;
			if(check_IndividualSslActive())
			{
				$ecom_selfhttp = "https://";
			}
			...
			?>
				...
				<form method="post" name="frm_quicksearch" class="frm_cls" action="<?php url_link('search.html')?>">
				  <div class="search_inner">
					...
					<div class="search_advance"> <a href="<?php url_link('advancedsearch.html')?>" class="search_advance_lnk" title="<?php echo $Captions_arr['COMMON']['ADVANCED_SEARCH']?>"><?php echo $Captions_arr['COMMON']['ADVANCED_SEARCH']?></a> </div>
				  </div>
				  <input type="hidden" name="search_submit" value="search_submit" />
				</form>
				<div class="flashtop">
					<?php top_header_scroller()?>
				</div>
				</div>
		...
		{
			global $Captions_arr,$ecom_hostname,$inlineSiteComponents,$Settings_arr,$db,$ecom_siteid,$position,$loginUrl,$logoutUrl,$ecom_fb_enable;
			if(check_IndividualSslActive())
			{
				$ecom_selfhttp = "https://";
			}
...
<?php	
				...
				?>
					...
					<div class=" login_outr">
					  <div class="login_outr_txtdiv"><?php echo stripslash_normal($Captions_arr['CUST_LOGIN']['EMAIL'])?></div>
					  <div class="login_outr_txtdiv"><?php echo stripslash_normal($Captions_arr['CUST_LOGIN']['PASSWORD'])?></div>
					  <div class="login_outr_inputdiv">
						<input name="custlogin_uname" class="logininputA" id="custlogin_uname" size="10" type="text" />
					  </div>
					  <div class="login_outr_inputdiv">
						<input name="custlogin_pass" class="logininputA" id="custlogin_pass" size="10" type="password">
					  </div>
					  <div class="login_outr_button">
						<input name="custologin_Submit" type="submit" class="login_submit_btn_top" id="custologin_Submit_top" value="<?php echo $Captions_arr['CUST_LOGIN']['LOGIN']?>" />
					  </div>
					</div>
					...
					{
					?>
					  <div class="login_user_linkA"> <a href="<?php url_link('registration.html')?>" title="<?php echo stripslash_normal($Captions_arr['CUST_LOGIN']['NEW_USER'])?>"><?php echo stripslash_normal($Captions_arr['CUST_LOGIN']['NEW_USER'])?></a> </div>
					<?
					}
					if($hide_forgotpass==0) // check whether the forgot password link is disabled from main shop settings
					{
					?>
					  <div class="login_user_linkB"> <a href="<?php url_link('forgotpassword.html')?>" class="loginlink" title="<?php echo stripslash_normal($Captions_arr['CUST_LOGIN']['FORGOT_PASS'])?>"><?php echo stripslash_normal($Captions_arr['CUST_LOGIN']['FORGOT_PASS'])?></a> </div>
					<?
					}
					?>
					</div>
					...
					<?php
					if($ecom_siteid == 83) // asll.co.uk
					{
						?>
						<div class="socialwrap">
						<div class="facelike"><a href="https://www.facebook.com/AlliedSports" target="_blank"><img src="<?php url_site_image('facebook.png')?>" border="0"></a></div>
						<div class="twittericon"><a href="https://twitter.com/AlliedSportsLtd" target="_blank"><img src="<?php url_site_image('twitter.png')?>" border="0"></a></div>
						</div>
						<?php
					}
					?>
                    ...
                    <div class="fblogin_btn_topband"><a href="javascript:void(0);" onclick="javascript:window.open('<?php echo $loginUrl;?>','Login','width=500,height=300,resizable=no,scrollbars=no,toolbar=no,menubar=no,location=no,directories=no,status=no,copyhistory=no');"><img src="<?php echo url_site_image('facebook_logins.png');?>" /></a></div>
                    <?php } ?>
					...
					<div class="login_top"></div>
						<div class="login_middle">
                            ...
                            <?php /* FB login script */
								...
								{
							?>
							<li><h2><a href="<?php echo $logoutUrl; ?>" class="userloginmenulink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['LOGOUT'])?></a></h1></li>
							<?php
								}
								else
								{
							?>
							<li><h2>
                            	<a href="<?php url_link('logout.html')?>" class="userloginmenulink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['LOGOUT'])?></a>
                            </li></h2>                             
                            <?php
								}
							?>
				...
				<div class="cart_con">
				  ...
				  <div class="cart_btn">
					<ul class="cart_view_linkul">
					 <li> <a href="<?php url_link('enquiry.html')?>" class="cart_view_link" title="<?php echo stripslash_normal($Captions_arr['COMMON']['VIEW_ENQUIRY'])?>"><span><?php echo stripslash_normal($Captions_arr['COMMON']['VIEW_ENQUIRY'])?></span></a> </li>
					 <li> <a href="#" class="cart_view_link" onclick="handle_checkout_submit('<?php echo $ecom_hostname?>',0,'<?php echo $pass_tot?>')"  title="<?php echo stripslash_normal($Captions_arr['COMMON']['CHECK_OUT'])?>"><span><?php echo stripslash_normal($Captions_arr['COMMON']['CHECK_OUT'])?></span></a> </li>
					  <li> <a href="#" onclick="gobackto_cart('<?php echo ($protectedUrl)?base64_encode($ecom_hostname):$ecom_hostname?>')" class="cart_view_link" title="<?php echo stripslash_normal($Captions_arr['COMMON']['VIEW_CART'])?>"><span><?php echo stripslash_normal($Captions_arr['COMMON']['VIEW_CART'])?></span></a> </li>
					</ul>
				  </div >
				  <?php
					 if($ecom_siteid==80)
				  ...
				  ?>
					...
					<ul class="cart_view_linkulA">
						    <li><a href="<?php url_link('custlogin.html')?>" title="<?php echo stripslash_normal($Captions_arr['CUST_LOGIN']['LOGIN'])?>"><img src="<?php url_site_image('login-bt-new.png')?>"/></a></li>
								<li>
								<a href="<?php url_link('registration.html')?>" title="<?php echo stripslash_normal($Captions_arr['CUST_LOGIN']['NEW_USER'])?>"><img src="<?php url_site_image('signup_new.png')?>" \></a> 
							</li>
					</ul>
					</div>
					<?php
						...
						<div class="cart_btnA">
					<ul class="cart_view_linkulA">
						    <li><a href="<?php url_link('logout.html')?>" class="loginlink" title="<?=stripslash_normal($Captions_arr['LOGIN_MENU']['LOGOUT'])?>"><img src="<?php url_site_image('logout-bt-new.png')?>"/></a></li>
								<li>
								<a href="<?php url_link('login_home.html')?>" title="<?=stripslash_normal($Captions_arr['LOGIN_MENU']['MY_ACCOUNT'])?>"><img src="<?php url_site_image('my account.png')?>" \></a></a> 
							</li>
					</ul>
					</div>
								...
								switch($shelfData['shelf_displaytype'])
								{
									...
									<div class="spcl_shlf_lf_con">
										...
										?>
											...
											<?php
												if($ecom_siteid == 83) // override for asll website 
													$pass_type = 'image_iconpath';
												else
									...
									<div class="spcl_shlfA_lf_con">
										...
										?>
											...
											<div class="spcl_shlfA_pdt_top"></div>
												...
												{
												?>
												<div class="spcl_shlfA_pdt_left"><a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" title="<?php echo stripslash_normal($row_prod['product_name'])?>">
												<?php
													$pass_type = 'image_iconpath';
													// Calling the function to get the image to be shown
													$img_arr = get_imagelist('prod',$row_prod['product_id'],$pass_type,0,0,1);
												...
												{
													?>
												<div class="spcl_shlfA_pdt_mid_name"><a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>"  title="<?php echo stripslash_normal($row_prod['product_name'])?>"><?php echo stripslash_normal($row_prod['product_name'])?></a></div>
												<?
												}
												?>
												</div>
							...
							{	
								...
								elseif($position == 'top')
								{
									...
									if ($cache_exists==false)
									{
										...
										$HTML_Content = '';
										if($ecom_siteid==83) //asll website
			...
			<tr>
			  <td colspan="3" class="userloginmenuytop" >
                ...
                <?php /* FB login script */
					...
					{
				?>
				<li><h1><a href="<?php echo $logoutUrl; ?>" class="userloginmenuytoplink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['LOGOUT'])?></a></h1></li>
				<?php
					}
					else
					{
				?>
				<li><h1><a href="<?php url_link('logout.html')?>" class="userloginmenuytoplink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['LOGOUT'])?></a></li>
				<?php
					}
				?>
				<!--<li>
...
<?
		...
		{		
			...
			$rightImg	=	$ecom_selfhttp.$ecom_hostname."/images/".$ecom_hostname."/site_images/arrow-side.gif";
			$downImg	=	$ecom_selfhttp.$ecom_hostname."/images/".$ecom_hostname."/site_images/arrow-down.gif";
