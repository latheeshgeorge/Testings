...
/*############################################################################
	...
	class categ_group_Html
	{
		...
		?>
			...
			?>
					<tr>
						<td <?php echo ($row_featured['featured_showimage']==1)?'colspan="2"':''?> align="left" valign="top"><h2 class="featuredprodname"><a href="<?php url_product($row_featured['product_id'],$row_featured['product_name'],-1)?>" title="<?php echo stripslash_normal($row_featured['product_name'])?>"><?php echo stripslash_normal($row_featured['product_name'])?></a></h2></td>
					</tr>
			<?php
				}
			?>		
			...
			?>
					...
					?>
									<li>
										<h6 class="featuredproddes"><?php echo stripslash_normal($desc)?></h6>
									</li>
					<?php
								}
							}
					...
					<table border="0" cellspacing="0" cellpadding="0">
					  <tr>
						...
						<?php
							...
							show_addtocart_v5_ajax('frm_featured',$row_featured,$class_arr);
