			...
			if($alert)
			{
				...
				switch ($row_cat['category_subcatlistmethod'])
				{
					...
					?>
							...
							<div class="subcat_1row_outr">
							<div class="subcat_1row_pdt_outr">
							<div class="subcat_1row_pdt_top"></div>
							<div class="subcat_1row_pdt_btm">
							<div class="subcat_1row_pdt_image"><?=$HTML_image?></div>
							<div class="subcat_1row_pdt_name_outr">
							<div class="subcat_1row_pdt_name"><?=$HTML_subcatname?></div>
							<div class="subcat_1row_pdt_des"><?=$HTML_short_desc?></div>
							</div>
							</div>
							  </div>
					<?php
