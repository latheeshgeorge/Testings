					...
					<? }?>
						<div class="reg_shlf_cont_div">
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="3"  class="reg_table">
								...
								<?php 
								if(trim($Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_MORE_INFO'])!='')
								{
								?>
								<tr>
									<td colspan="2" align="center" style="color:#DA0909;font-size:11px; font-weight:bold;padding:10px 0;"><?php echo stripslashes(trim($Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_MORE_INFO']))?></td>
								</tr>	
								<?php
								}
								?>
