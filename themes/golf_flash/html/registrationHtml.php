...
/*############################################################################
	...
	class registration_Html
	{
		...
		{
			global $Captions_arr,$ecom_siteid,$db,$ecom_hostname,$vImage,$Settings_arr,$pagetype,$short,$long,$medium,$ecom_common_settings,$site_key;
			...
			//$recaptcha = recaptcha_get_html($site_key);
?>
	...
	<div class="inner_con"  id="companydetails" >
		 ...
		 <div class="reg_shlf_outr">
	  	 ...
	  	 <table class="reg_table" width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				{	
					...
					?>
						<tr>
							<td class="regiconentA" valign="middle" align="left" width="50%">
				...
				?>
              <tr>
                <td class="regiconentA" valign="middle" align="left" width="50%"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_EMAIL'])?><span class="redtext">*</span></td>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="reg_table">
            <tr>
              <td  align="left" valign="middle" class="regiconentA" width="50%"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_PASSWORD'])?><span class="redtext">*</span></td>
		  ...
		  //section for custom registration form 
			...
			?>
					...
					<?php
					 if($Settings_arr['imageverification_req_customreg'] and $ecom_siteid==83)
					 {
					?>
							<div class="reg_shlf_outr">
							<div class="reg_shlf_inner">
        ...
        grecaptcha.render('html_element', {
          'sitekey' : '<?php echo $site_key;?>'
			...
			function validate_allforms(frm)
			{
				...
				?>
				var letters = /^[A-Za-z]+$/;
					if(document.getElementById("customer_fname"))
					{
						if(frm.customer_fname.value.match(letters))
						{
							if(document.getElementById("customer_surname"))
							{ 
								if(frm.customer_surname.value.match(letters))
								{
								   return true;
								}
								else
								{
								  alert('Please input alphabet characters only for the Sur Name');
								  frm.customer_surname.focus();
								  return false;
								}
							}
							return true;
						...
						{
						 alert('Please input alphabet characters only for the First Name');
