           ...
           <div class="reg_shlf_pdt_con"> 
			...
			?>
			  ...
			  <tr>
				...
				<td align="left" valign="top" class="regi_txtfeildA"><textarea name="txt_enqaddress" cols="45" rows="4"><?=$_REQUEST['txt_enqaddress']?></textarea></td>
			  </tr>
			 <tr>
			  ...
			  <tr>
			   ...
			   <tr>
				...
				<td align="left" valign="top" class="regi_txtfeildA"><textarea name="cbo_enqtext" rows="8" cols="45"><?=$_REQUEST['cbo_enqtext']?></textarea></td>
			  </tr>
			  <tr>
				<td colspan="2">&nbsp;</td>
			  </tr>
