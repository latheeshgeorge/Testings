...
/*############################################################################
	...
	?>
		...
		<div class="tree_middle">
			...
			<li> <?=$Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_TREEMENU_TITLE']?></li>
			</ul>
			</div>
		</div>
		...
		<td colspan="2" align="left" valign="middle" class="gift-send-bg_td1">	
		<div class="shoppayment_type_div">
		<table width="100%" cellpadding="0" cellspacing="0" border="0">
		<tr>
...
?>		
		...
		<div class="tree_middle">
			...
			<ul>
			<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> </li>
			<li> <?=$Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_TREEMENU_PREVIEWTITLE']?></li>
			</ul>
			</div>
		</div>
		<div class="tree_bottom"></div>
...
<?php		
	...
	?>
		...
		<div class="tree_middle">
			...
			<ul>
			<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> </li>
			<li><?php echo $Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_FAILED_TITLE']?></li>
			</ul>
			</div>
		</div>
		<div class="tree_bottom"></div>
	...
	?>
		...
		<ul>
		<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> </li>
		<li><?php echo $Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_SPEND_HEADER']?></li>
		</ul>
		</div>
		</div>
		<div class="tree_bottom"></div>
	...
	?>
				...
				if($db->num_rows($ret_var))
				{
					...
					if($row_var['var_value_exists']==1)
					{
						...
						if ($db->num_rows($ret_val))
						{
							...
							echo '<td align="left" class="productvariabletdA">: '.stripslashes($row_val['var_value']).'
		...
		?>
			...
			<?php echo $Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_PROM_PRICE'];
		...
		<?php	
			...
			{
			?>
				<div><br><input type="button" class="buttonblackbuy" onclick="show_wait_button(this,'Please Wait...');document.<?php echo $frm_name?>.fpurpose.value='Prod_Addcart';document.<?php echo $frm_name?>.submit();" value="<?php echo stripslash_normal($Captions_arr['PROD_DETAILS'][$caption_key]);?>"/></div>
			<?php
			}
			?>
		</div>
