<?php
	...
	class myaddressbook_Html
	{
		...
		function Add_AddressBook(){
				...
				<ul>
				<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> </li>
				<li> <a href="<? url_link('myaddressbook.html');?>"><?php echo $Captions_arr['ADDRESSBOOK']['TREE_MENU_ADDRESSBOOK'];?></a> >> <?php echo $Captions_arr['ADDRESSBOOK']['TREE_MENU_ADD_ADDRESSBOOK']?></li>
				</ul>
				</div>
				</div>
				<div class="tree_bottom"></div>
			...
			<?php
				...
				?>
		            ...
		            <tr>
				     ...
				     <td width="75%"  align="left" ><input type="text" name="faxnumber" value="<?=$_REQUEST['faxnumber'] ?>" maxlength="<?=$short?>"/></td>
					</tr>
...
function add_newaddress(frm)
{
	...
	if(Validate_Form_Objects(frm,fieldRequired,fieldDescription,fieldEmail,fieldConfirm,fieldConfirmDesc,fieldNumeric,fieldSpecChars,fieldCharDesc)){
		...
		<div class="tree_middle">
			...
			<ul>
			<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> </li>
			<li><a href="<? url_link('myaddressbook.html');?>"><?php echo $Captions_arr['ADDRESSBOOK']['TREE_MENU_ADDRESSBOOK'];?></a> >> <?php echo $Captions_arr['ADDRESSBOOK']['TREE_MENU_EDIT_ADDRESSBOOK']?></li>
			</ul>
			</div>
		</div>
		<div class="tree_bottom"></div>
