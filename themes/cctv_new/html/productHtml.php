                  ...
                  <td><ul class="downloadul">
                    ...
                    <?php
						 ...
						 if($pdf_show==1) // Check whether the download pdf module is there for current site
							{  
							?>
								<li><span><a href="javascript:download_pdf();" class="productdetailslink"><img src="<?php url_site_image('download_pdfs.jpg')?>" border="0" title="<?php echo $Captions_arr['PROD_DETAILS']['PRODDET_DOWNLOADPDF'];?>"/></a></span></li>
							<?php
							}
								?>
					     </ul>
