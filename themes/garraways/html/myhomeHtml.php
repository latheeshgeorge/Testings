		...
		function Show_Favourite_Products($used_val_arr)
		{
			...
			<?php
				...
				switch($displaytype)
				{
					...
					?>
					<tr>
					<td colspan="3" align="right"><a href="<?php url_link('showfavprodall'.$custom_id.'.html')?>" class="middle_showall_link" title="<?php echo stripslash_normal($Captions_arr['COMMON']['SHOW_ALL'])?>"><? echo stripslash_normal($Captions_arr['COMMON']['SHOW_ALL'])?></a>
					</td>
					</tr>	
					<?php	
					break;
