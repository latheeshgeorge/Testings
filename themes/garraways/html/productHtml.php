...
<table border="0" cellpadding="0" cellspacing="0"	class="productdeatilstable">
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
					...
					if($ecom_siteid==61)
					{
						...
						if($row_prod['product_webprice']>1000 || $row_prod['product_webprice'] == 0)
						{ ?>
						<tr>
...
<?php
	...
	?>
					...
					<input type="text" class="quainput_big" name="qty" value="<?php echo ($_REQUEST['qty'])?$_REQUEST['qty']:1?>" maxlength="3" />
					</div>
<?php
				}
