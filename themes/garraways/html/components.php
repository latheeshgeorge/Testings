				...
				if ($db->num_rows($ret_main))
				{
					...
					<table class="bst_slr_table" border="0" cellpadding="0" cellspacing="0">
						<tbody>
							...
							?>
								<tr>
								<td colspan="2" class="bst_slr_td"><div class="bst_slr_header"><?php echo $title?></div></td>
								</tr>
							<?php
							}
							...
							?>
							<tr>
								<td align="center" class="bst_slr_td"><a href="<?php echo url_product($row_main['product_id'],$row_main['product_name'],-1)?>" title="<?php echo stripslash_normal($row_main['product_name'])?>">
								<?php
							...
							<tr>
								<td colspan="2" align="right" class="bst_slr_td">
