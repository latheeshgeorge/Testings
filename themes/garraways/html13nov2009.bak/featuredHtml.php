			...
			?>
					...
					<?php
							...
							if ($row_featured['featured_showprice']==1)// Check whether price is to be displayed
							{
								...
								$pass_arr['main_cls'] 		= 'bonus_point_feat';
								$pass_arr['caption_cls'] 	= 'bonus_point_feat_caption';
								$pass_arr['point_cls'] 		= 'bonus_point_feat_number';
								show_bonus_points_msg_multicolor($row_featured,$pass_arr);
							}	
					?>
						</ul>        
			<?php
					...
					?>
					<table border="0" cellspacing="0" cellpadding="0" class="feat_infolink">
					  <tr>
						<td>
