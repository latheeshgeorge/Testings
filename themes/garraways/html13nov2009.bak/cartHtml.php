	...
	class cart_Html
	{
		...
		?>	
		  ...
		  ?>
				...
				?>	
						 <tr>
						 <td width="53%" align="right" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_DELIVERY_LOC']?><a name="a_deliv">&nbsp;</a> </td>
		  ...
		  <?php
			...
			?>
				 <tr>
					<td colspan="3" align="right" valign="middle" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_TOTAL_POINTS_EARN']?>&nbsp;</td>
			...
			?>
				 <tr>
					<td colspan="3" align="right" valign="middle" class="shoppingcartcontent"><a name="bonus">&nbsp;</a><?php echo $Captions_arr['CART']['CART_SPENT_BONUS_POINTS']?>(<? print (int)(($cartData["customer"]['customer_bonus']-$cartData["bonus"]["spending"])); ?> &nbsp;<?php echo $Captions_arr['CART']['CART_REMAINING']?>)&nbsp;</td>
				  ...
				  <?php
					...
					?>
					  <tr>
						<td colspan="3" align="right" valign="top" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_SPENT_BONUS_POINTS_VALUE']?> </td>
			...
			<?php
				...
				if ($db->num_rows($ret_paytypes))
				{
					...
					?>	
							  ...
							  <table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
								  <td class="cart_payment_header" align="right" width="53%"><a name="a_pay">&nbsp;</a><?php echo $Captions_arr['CART']['CART_SEL_PAYTYPE']?></td>									
								  <td align="right" class="cart_payment_header"><?php
		...
		function validate_checkout_fields(frm)
		{
			...
			if(Validate_Form_Objects(frm,fieldRequired,fieldDescription,fieldEmail,fieldConfirm,fieldConfirmDesc,fieldNumeric))
			{
				if(frm.checkout_billing_same.value == 'N')
				{
					...
					{
						$chkout_Email_Str = implode(",",$chkoutdel_Email);
