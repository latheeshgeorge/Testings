				...
				?>
					...
					<td colspan="2" >
						<div class="form-group">
							<label><?php echo stripslash_normal($row_elem['element_label']);if($row_elem['mandatory']=='Y') { echo '<span class="redtext">&nbsp;*</span>';} ?></label><br>
						<label class="sr-only" for="form-<?php echo $row_checkout['field_key'];?>"><?php stripslash_normal($row_elem['element_label']); ?></label>
						<?php
