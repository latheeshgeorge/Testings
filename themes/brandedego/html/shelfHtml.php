...
<div class="page_nav_content"><ul>';//.'';
								...
								{ 									
									...
									{
										$cur_title = '<h1 class="h1-header-cls-bottompadding">'.$cur_title.'</h1>';
									}
								?>
...
.thumbGal li img{width:70%; text-align: center;}
         .gal-title {
    background: #000;
    text-align: center;
    color: #ffff;
...
<script>
    ...
    $('.close').click(function(){   
			...
			var parentTag = $( this ).parent().attr('id'); 
			  callPlayer(parentTag,'stopVideo');
...
$( "#myModalv" ).on('shown.bs.modal', function(e){
    $("iframe").each(function() {
		  var parentTag = $( this ).parent(0).attr('id'); 
              callPlayer(parentTag,'playVideo');      
});
});
...
$(".link").on('click', function(e) {
      ...
      $("iframe").each(function() {
		  var parentTag = $( this ).parent().attr('id'); 
              callPlayer(parentTag,'pauseVideo');

        
      
});
      callPlayer(divid,'playVideo');
    ...
    if (iframe) {
        ...
        iframe.contentWindow.postMessage(JSON.stringify({
            ...
            "id": frame_id
					...
					<!-- Modal HTML -->
					<div id="myModalv<?php echo $row_prod['product_id']?>" class="modal fade modalv">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">								
								<?php
								$sql_prod_videos = "SELECT video_id,video_title,video_script FROM product_videos WHERE products_product_id=".$row_prod['product_id']." AND sites_site_id=$ecom_siteid AND video_hide = 0";
								$ret_prod_videos = $db->query($sql_prod_videos);
								if($db->num_rows($ret_prod_videos)>0)
								{
									$vid_arr = array();
									$cnt_vd = 0;
								?>
							   <div class="content-container">
								   <?php
								   while($row_prod_videos = $db->fetch_array($ret_prod_videos))
								   {
									    $cnt_vd++;
									    if($cnt_vd==1)
									    {
									   ...
									   $vid_arr[$row_prod_videos['video_id']] = $row_prod_videos['video_title'];
									   preg_match('%(?:youtube(?:-nocookie)?\.com/(?:[^/]+/.+/|(?:v|e(?:mbed)?)/|.*[?&]v=)|youtu\.be/)([^"&?/ ]{11})%i', $row_prod_videos['video_script'], $match);
										$youtube_id = $match[1];
									   ?>
									   <div data-vid="<?php echo $youtube_id;?>" id="content<?php echo $row_prod['product_id'];?>_<?php echo $row_prod_videos['video_id'];?>"  class="embed-responsive embed-responsive-16by9" style="<?php echo $dsp; ?>" ><?php echo $row_prod_videos['video_script'];?></div>
									   <?php
								   }
								   ?>
								</div>	      
									...
									/*
									<ul class="thumbGal">
									<li><a href="javascript:void(0)"  data-rel="content1" class="link" onclick="document.getElementById('player1').style.display='block';document.getElementById('player2').style.display='none';document.getElementById('player3').style.display='none';document.getElementById('player4').style.display='none';"><img src="<?php echo url_site_image('video-pop-small.svg',1) ?>" alt="thumbnail" title="thumb" ><div class="gal-title">this is the title Video1</div></li>
									<li><a href="javascript:void(0)" data-rel="content2" class="link" onclick="document.getElementById('player1').style.display='none';document.getElementById('player2').style.display='block';document.getElementById('player3').style.display='none';document.getElementById('player4').style.display='none';" ><img src="<?php echo url_site_image('video-pop-small.svg',1) ?>" alt="thumbnail" title="thumb" ><div class="gal-title">this is the title Video2</div></li>
									<li><a href="javascript:void(0)" data-rel="content3" class="link" onclick="document.getElementById('player1').style.display='none';document.getElementById('player2').style.display='none';document.getElementById('player3').style.display='block';document.getElementById('player4').style.display='none';"><img src="<?php echo url_site_image('video-pop-small.svg',1) ?>"  alt="thumbnail" title="thumb" ><div class="gal-title">this is the title Video3</div></li> 
									<li><a href="javascript:void(0)"  data-rel="content4" class="link" onclick="document.getElementById('player1').style.display='none';document.getElementById('player2').style.display='none';document.getElementById('player3').style.display='block';document.getElementById('player4').style.display='none';"><img src="<?php echo url_site_image('video-pop-small.svg',1) ?>"  alt="thumbnail" title="thumb" ><div class="gal-title">this is the title Video3</div></li>
									</ul> 
									*/
									?> 
									<ul class="thumbGal">
									<?php 
									foreach($vid_arr as $kv=>$vt) 
									{
									?>
									<li><a href="javascript:void(0)"  data-rel="content<?php echo $row_prod['product_id'];?>_<?php echo $kv; ?>" class="link" ><img src="<?php echo url_site_image('video-pop.svg',1) ?>" alt="<?php echo $vt;?>" title="<?php echo $vt;?>" ><?php /*<div class="gal-title"><?php echo $vt;?></div> */?></a></li>
									<?php
									}
									?>
									</ul> 
									...
									<ul>
									<li>
									<div id="player11" class="youtube-playert" onclick="document.getElementById('player1').style.display='block';document.getElementById('player2').style.display='none';document.getElementById('player3').style.display='none';document.getElementById('player4').style.display='none';">Video1</div></li>
									<li>  <div id="player22" class="youtube-playert" onclick="document.getElementById('player1').style.display='none';document.getElementById('player2').style.display='block';document.getElementById('player3').style.display='none';document.getElementById('player4').style.display='none';" >Video2</div></li>
									<li>	  <div id="player33" onclick="document.getElementById('player1').style.display='none';document.getElementById('player2').style.display='none';document.getElementById('player3').style.display='block';document.getElementById('player4').style.display='none';">Video3</div></li>
									<li>	  <div id="player44" class="youtube-playert" onclick="document.getElementById('player1').style.display='none';document.getElementById('player2').style.display='none';document.getElementById('player3').style.display='none';document.getElementById('player4').style.display='block';">Video4</div></li>
									</ul>
									</div>
									*/
									?> 
									...
									{
									   echo "No active videos found for this product!!!";
									} 
									?>
							</div>
						</div>
					...
					<div class="clearfix"></div>		
										...
										?>
											<div class="gallery_propertyouter">
												...
												$sql_vid = "SELECT video_id,video_title,video_script FROM product_videos WHERE products_product_id=".$row_prod['product_id']." AND sites_site_id=$ecom_siteid AND video_hide = 0";
					$ret_vid = $db->query($sql_vid);
					if($db->num_rows($ret_vid)>0)
					{
					?>
					      <a href="#myModalv<?php echo $row_prod['product_id']?>" style="display:inline-block;text-align:center;text-transform:uppercase;font-size:11px;width:70px;"  class="More_videoclas"  data-toggle="modal">  <img  src="<?php echo url_site_image('video-pop.svg',1) ?>" class="mTSThumb" style="opacity: 1;" style="display:block;text-align:center;text-transform:uppercase;font-size:11px;float: left;width:70px;"  alt="product video">
					<div class="videoTitle" style="display:block;text-align:center;text-transform:uppercase;font-size:11px;float: left;width:70px;"><?php echo $db->num_rows($ret_vid); ?> Videos</div></a>
					<?php
					}
					?>
											</div>
