 ...
 ?>
           ...
           <div class="reg_shlf_pdt_con">
		    <table width="100%" border="0" cellpadding="0" cellspacing="3"  class="reg_table">
					...
					<tr>
					<td width="50%" align="left" valign="middle" class="regiconentA"><?=$Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_MANUFACT']?></td>
					<td class="regi_txtfeildA" width="50%" align="left" valign="middle">: <?=$row_prod['manufacture_id']?>
					<input type="hidden" name="prod_manufacture_id" id="prod_manufacture_id" value="<?=$row_prod['manufacture_id']?>" />
					</td>	
					</tr>
					<tr>
					<td width="50%" align="left" valign="middle" class="regiconentA"><?=$Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_MODEL']?></td>
					<td class="regi_txtfeildA" width="50%" align="left" valign="middle">: <?=$row_prod['product_model']?>
					<input class="hidden" type="hidden" name="prod_model" id="prod_model" value="<?=$row_prod['product_model']?>" />
					</td>	
					</tr>
					<tr>
					<td width="50%" align="left" valign="middle" class="regiconentA"><?=$Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_OUR_PRICE']?></td>
					<td class="regi_txtfeildA" width="50%" align="left" valign="middle">: <?=$row_prod['promise_price']?>
					<input type="hidden" name="prom_admin_price" id="prom_admin_price" value="<?=$row_prod['cleanpromise_price']?>" />
					</td>	
					</tr>
					<tr>
					<td width="50%" align="left" valign="middle" class="regiconentA"><?=$Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_REQ_QTY']?><span class="redtext">*</span></td>
					<td class="regi_txtfeildA" width="50%" align="left" valign="middle">
					...
					<table  width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
					<tr>
					<td width="50%" align="left" valign="middle" class="regiconentA"><?=$Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_WHAT_PRICE']?><span class="redtext">*</span><span style="float:right"><?php echo $current_currency_details['curr_sign_char']?>&nbsp;</span></td>
					<td class="regi_txtfeildA" width="50%" align="left" valign="middle">
					<input class="regiinput" type="text" name="prom_customer_price" id="prom_customer_price" value="" /> 
					(per item) 
					</td>	
					</tr>
					<tr>
					<td width="50%" align="left" valign="middle" class="regiconentA"><?=$Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_WHERE_SEE']?><span class="redtext">*</span></td>
					<td class="regi_txtfeildA" width="50%" align="left" valign="middle">
					...
					?>
								...
								<input name="pricepromise_submit" type="submit" class="inner_btn_red" id="Submit" value="<?=$Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_SUBMIT_REQ']?>"/>
								</div>
								</div>
								</div>
								</td>
		...
		?>
				...
				?>
					...
					<div class="reg_shlf_cont_div">
					<div class="reg_shlf_pdt_con">
					<table width="465" border="0" cellpadding="1" cellspacing="1" class="reg_table">
					<tbody>
					<tr>
		...
		function Show_Mypricepromise_requests()
		{
			...
			global $Captions_arr,$ecom_siteid,$db,$ecom_hostname,$vImage,$Settings_arr,$ecom_themename;
			...
			'<div class="tree_menu_conA">
			  ...
			  <div class="tree_menu_midA">
				<div class="tree_menu_content">
				  <ul class="tree_menu">
				<li><a href="'.url_link('',1).'">'.stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']).'</a></li>
				 <li>'.stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_DETAILS_HEADER']).'</li>
				</ul>
				  </div>
			  </div>
			  <div class="tree_menu_bottomA"></div>
        ...
        echo '<script type="text/javascript" src="'.$ecom_selfhttp.$ecom_hostname.'/themes/'.$ecom_themename.'/datepicker/js/jquery-1.8.2.js"></script>';
        echo '<script type="text/javascript" src="'.$ecom_selfhttp.$ecom_hostname.'/themes/'.$ecom_themename.'/datepicker/js/jquery-ui-1.9.1.custom.js"></script>';

		echo '<link rel="stylesheet" href="'.$ecom_selfhttp.$ecom_hostname.'/themes/'.$ecom_themename.'/datepicker/css/jquery-ui-1.9.1.custom.css" />';
    ...
    $j(function() {
        $j( "#datepicker" ).datepicker();
				...
				<div class="reg_shlf_inner">
					...
					<?php
					if($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_DETAILS_HEADER']){
					?>
					<div class="reg_shlf_hdr_outr"><div class="reg_shlf_hdr_in"><span><?=stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_DETAILS_HEADER'])?> </span></div></div>
					<? }?>
						<div class="reg_shlf_cont_div">
							<div class="reg_shlf_pdt_con">
							...
							<table  border="0" cellpadding="2" cellspacing="3" width="100%" class="userordertablestyleA">
							  <tr>
								<td width="11%" colspan="1" nowrap="nowrap" class="usermenucontent"><?php echo stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICEPROM_PRODNAME'])?></td>
								<td colspan="3" nowrap="nowrap" class="usermenucontent"><?php echo stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICEPROM_STATUS'])?></td>
								<td nowrap="nowrap" class="usermenucontent" >&nbsp;</td>
							    <td colspan="4" nowrap="nowrap" class="usermenucontent" >&nbsp;</td>
						      </tr>
							  <tr>
							    <td nowrap="nowrap" class="usermenucontent"><input name="prm_prodname" id="prm_prodname" type="text"  value="<?php echo $_REQUEST['prm_prodname']?>" /></td>
							    <td colspan="3" nowrap="nowrap" class="usermenucontent"><?php
							  ...
							  <tr>
								<td colspan="3" valign="top" nowrap="nowrap" class="usermenucontent"><input name="prm_fromdate" class="textfeild_ord" id="datepicker" type="text" size="8" value="<?php echo $_REQUEST['prm_fromdate']?>" />								  <?php echo stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICEPROM_AND'])?>								  <input name="prm_todate" class="textfeild_ord" id="datepicker1" type="text" size="8" value="<?php echo $_REQUEST['prm_todate']?>" />								</td>
								<td width="10%" nowrap="nowrap" valign="top"></td>
								<td width="7%" nowrap="nowrap" valign="top">&nbsp;</td>
								<td width="5%" nowrap="nowrap" class="usermenucontent" valign="top">&nbsp;</td>
								<td width="7%" nowrap="nowrap" valign="top">&nbsp;</td>
								<td class="usermenucontentA" width="38%">	
								<div class="cart_shop_cont"><div></div></div></td>
							  </tr>
							  <tr>
							    <td colspan="3" valign="top" nowrap="nowrap" class="usermenucontent"><?php echo stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_SORTBY'])?> <?php echo $sort_option_txt;?> <?php echo stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICEPROM_IN'])?> <?php echo $sort_by_txt?>							    </td>
							    <td nowrap="nowrap" valign="top"><input name="Search_go" type="submit" class="inner_btn_red" id="Search_go" value="Go" onclick="document.frm_promise.search_click.value=1" /></td>
							    <td nowrap="nowrap" valign="top">&nbsp;</td>
							    <td nowrap="nowrap" class="usermenucontent" valign="top">&nbsp;</td>
							    <td nowrap="nowrap" valign="top">&nbsp;</td>
							...
							<tr>
							<td  colspan="5" align="center" valign="middle" class="pagingcontainertd"><?php
						...
						?>			</td>
								...
								<tr>
									...
									<td align="left" width="50%" class="ordertableheader" colspan="3">
							...
							else
							{
								...
								?>
									<tr class="edithreflink_tronmouse">
										<td align="left" valign="middle" class="favcontent" colspan="3">
										...
										<td align="center" valign="middle" class="favcontent"><?php echo  price_promise_status($row_query['prom_status'])?>
										<br><?php echo $row_query['add_date'];?></td>
		...
		function Show_Mypricepromise_details($prom_id=0,$alert='')
		{
			...
			'<div class="tree_menu_conA">
			  ...
			  <div class="tree_menu_midA">
				<div class="tree_menu_content">
				  <ul class="tree_menu">
				<li><a href="'.url_link('',1).'">'.stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']).'</a></li>
				<li><a href="'.url_link('mypricepromise.html',1).'">'.stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_DETAILS_HEADER']).'</a></li>
				 <li>'.stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_DETAILS_HEADER_SUB']).'</li>
				</ul>
				  </div>
			  </div>
			  <div class="tree_menu_bottomA"></div>
			...
			?>
				...
				<div class="reg_shlf_cont_div">
				<div class="reg_shlf_pdt_con">
				<div class="reg_shlf_hdr_outr"><div class="reg_shlf_hdr_in"><span><?=stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_REQ_PROD_DET'])?> </span></div></div>	
				...
				<tr>
					...
					?>
						<tr>
						<td align="center" class="regicontentA" colspan="2">
							<?php echo $show_msg?>
						</td>
						</tr>
					<?php	
					...
					?>
						<tr>
							...
							<a href="<?php url_link('pricepromiseapproved'.$prom_id.'.html')?>" title="<?=stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICEPROM_ADD_TO_CART'])?>"><img src="<?php url_site_image('price_add_to_cart.gif')?>" title="<?=stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICEPROM_ADD_TO_CART'])?>" /></a>
							</td>
						</tr>	
					<?php
					}
				...
				<div class="reg_shlf_cont_div">
				<div class="reg_shlf_pdt_con">
				<div class="reg_shlf_hdr_outr"><div class="reg_shlf_hdr_in"><span><?=stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_ADM_APPROVED'])?></span></div></div>	
				<table width="100%" border="0" cellspacing="1" cellpadding="1" class="reg_table">
				<tr>
					<td align="center" class="ordertableheader" width="35%">
				...
				<div class="reg_shlf_cont_div">
				<div class="reg_shlf_pdt_con">
				<div class="reg_shlf_hdr_outr"><div class="reg_shlf_hdr_in"><span><?=stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_OTHER'])?></span></div></div>	
				<table width="100%" border="0" cellspacing="1" cellpadding="1" class="reg_table">
				<tr>
				...
				<div class="reg_shlf_outr">
						...
						<div class="reg_shlf_cont_div">
						<div class="reg_shlf_pdt_con">
						<div class="reg_shlf_hdr_outr"><div class="reg_shlf_hdr_in"><span><?=stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_USAGE_DET'])?></span></div></div>		
				<table width="100%" border="0" cellspacing="1" cellpadding="1" class="reg_table">
				<tr>
				<td align="left" width="40%" class="ordertabletdcolorB">
				...
				?>
						...
						<div class="reg_shlf_cont_div">
						<div class="reg_shlf_pdt_con">
						<div class="reg_shlf_hdr_outr"><div class="reg_shlf_hdr_in"><span><?=stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_ADMIN_NOTE'])?></span></div></div>		
						<table width="100%" border="0" cellspacing="1" cellpadding="1" class="reg_table">
						<tr>
				...
				if($db->num_rows($res_group))
				{
					while($row_group 		= $db->fetch_array($res_group))
					{
						...
						?>
							...
							<div class="reg_shlf_cont_div">
							<div class="reg_shlf_pdt_con">
							<div class="reg_shlf_hdr_outr"><div class="reg_shlf_hdr_in"><span><?php echo $row_group['field_section_name']?></span></div></div>	
							<table width="100%" border="0" cellspacing="1" cellpadding="1" class="reg_table">	
						<? 
						}
					 ?>
			...
			?>
				...
				<div class="reg_shlf_cont_div">
				<div class="reg_shlf_pdt_con">
				<div class="reg_shlf_hdr_outr"><div class="reg_shlf_hdr_in"><span><?=stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_CUST_POST_HEAD'])?></span></div></div>	
				<table width="100%" border="0" cellspacing="1" cellpadding="1" class="reg_table">
				<tr>
					<td align="right" colspan="5" class="ordertabletdcolorB">
						<a href="javascript:void(0)" onclick="document.getElementById('add_post').style.display=''"><?=stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_CUST_POST_ADD'])?></a>
					</td>
				</tr>
				<tr id="add_post" style="display:none">
					...
					<input type="hidden" name="add_post" id="add_post" value="1" />
						...
						<tr>
							<td align="left"><?=stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_CUST_POST_ENTER'])?></td>
							<td align="left"><textarea rows="3" cols="35" name="price_post"></textarea></td>
						</tr>
						<tr>
							<td align="center" colspan="4">
							<div class="cart_shop_cont"><div>
							 <input name="post_cancel" class="inner_btn_red" id="post_cancel" value="Cancel" onclick="document.getElementById('add_post').style.display='none'" type="button">
							</div></div>
							</td>
							<td align="center">
							<div class="cart_shop_cont"><div>
							<input name="post_go" class="inner_btn_red" id="post_go" value="Save Post" onclick="" type="submit">
							</div></div>
				...
				?>
						<tr>
						<td align="center" class="regicontentA" colspan="4">
						<? 
				...
				<?php
					...
					if($db->num_rows($ret_post))
					{
						...
						?>
							<tr>
								...
								<td align="center" class="ordertabletdcolorB">
								<a href="<?php url_link('mypricepromisepost'.$row_post['post_id'].'.html')?>?#disp_post<?php echo $row_post['post_id']?>"><?=stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_CUST_POST_DETAILS'])?></a>
								</td>
							</tr>
					...
					?>
						<tr>
						<td align="center" class="regicontentA" colspan="5">
