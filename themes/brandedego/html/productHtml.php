...
#myModalv .modal-title {
    margin: 0;
    line-height: 1.42857143;
    width: 90%;
    float: left;
}
#myModalv .modal-content {
    width: 100%;
    float: left;
}
.tabdetails {
...
-moz-box-shadow: 10px 10px 5px 0px rgba(0,0,0,0.08);}
					...
					<!-- Modal HTML -->
					<div id="myModalv" class="modal fade">
...
$(".link").on('click', function(e) {
      ...
      var divid = $(this).data('rel');
       $('li').not(this).removeClass('ThumActive');
      $(this).closest("li").addClass("ThumActive");
...
{
	global $db,$ecom_hostname,$ecom_themename,$ecom_hostname,$ecom_siteid;
	global $ecom_selfhttp;
	$show_normalimage = false;
	$prodimg_arr		= array();
	$pass_type 	= 'image_thumbpath';
		...
		else
		{
			...
			<?php 
				...
				<div id="gallery_09" class="more_images_wrapper" >
					...
					?>
					<li>						
					      <a href="#myModalv" class="More_videoclas"  data-toggle="modal">  <img  src="<?php echo url_site_image('video-pop.svg',1) ?>" class="mTSThumb" style="opacity: 1;" alt="product video"></a>
					<span class="videoTitle" style="display:block;text-align:center;text-transform:uppercase;font-size:11px;"><?php echo $db->num_rows($ret_vid); ?> Videos</span>
					</li>
					<?php
					}
					?>
			...
			$(document).ready(function() {
				...
				$('#content-1 .contentli img').click(function(){
					stop_mainslideshow();
