<?php
	...
	class myaddressbook_Html
	{
		function Show_AddressBook(){
					 ...
					 <tr>
					   <td colspan="5">
						...
						<div class="cart_shop_contAA"><div>
										<input name="address_search" type="button" class="inner_btn_red" id="address_search" value="Go" onclick="document.my_addressbook.submit()" />
						</div></div>
				      </td>
						<td  class="usermenucontentA" align="right">
						<?php
				...
				?>
				  <tr>
					<td align="center" colspan="5" class="usermenucontentA"> <div class="cart_shop_cont"><div><input name="address_add" type="button" class="inner_btn_red" id="address_add" value="<?php echo stripslash_normal($Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_ADD'])?>" onclick="javascript:add_address(document.my_addressbook)" />	</div></div></td>
