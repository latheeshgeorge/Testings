					...
					elseif ($position == 'bottom') // Case if value of position is bottom;
					{
						...
						<div class="static_con_bottom">
							<ul >
								...
								?>
								<li>
									<h4><a href="<?php url_link('enquiry.html')?>" class="cart_linklf_txt" title="<?php echo stripslash_normal($Captions_arr['COMMON']['VIEW_ENQUIRY'])?>"><span class="enquiry_bottom"><?php echo stripslash_normal($Captions_arr['COMMON']['VIEW_ENQUIRY'])?></span></a></h4></li>
