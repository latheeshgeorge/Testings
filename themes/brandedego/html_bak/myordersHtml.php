	...
	if ($from_date or $to_date)
	{
		...
		?>
			...
			<table  border="0" cellpadding="2" cellspacing="3" width="100%" class="userordertablestyleA">
			  ...
			  <tr>
				<td valign="" width="11%" nowrap="nowrap" class="usermenucontent"><input name="ord_fromdate" class="textfeild" type="text" size="8" value="<?php echo $_REQUEST['ord_fromdate']?>" /></td>
				<td valign="" width="6%" nowrap="nowrap"><a href="javascript:show_calendar('frm_orders.ord_fromdate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('show-calendar.gif')?>" width="24" height="22" border="0" /></a></td>
				<td valign="" width="5%" nowrap="nowrap" class="usermenucontent">and</td>
				<td valign="" width="11%" nowrap="nowrap" class="usermenucontent"><a href="javascript:show_calendar('frm_orders.ord_fromdate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;">
				  <input name="ord_todate" class="textfeild" id="ord_todate" type="text" size="8" value="<?php echo $_REQUEST['ord_todate']?>" />
				</a></td>
				<td valign="" width="10%" nowrap="nowrap"><a href="javascript:show_calendar('frm_orders.ord_todate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('show-calendar.gif')?>" width="24" height="22" border="0" /></a></td>
				<td valign="" width="7%" nowrap="nowrap"><?php echo $sort_option_txt;?></td>
				<td valign="" width="5%" nowrap="nowrap" class="usermenucontent">In</td>
				<td valign="" width="7%" nowrap="nowrap"><?php echo $sort_by_txt?></td>
				<td valign="" class="usermenucontentA" width="38%">	
...
if($insmsg)
	...
	<tr id="EnqId3" style="display:none;"  >
	  <td>&nbsp;</td>
	  <td>&nbsp;</td>
	  <td class="usermenucontentAz">	
						<div class="cart_shop_cont"><div>
										<input type="button" name="Submit" value="Add Enquiry" class="inner_btn_red_new" onclick="javascript:enqSub(document.frm_orderdetail)" />
...
<div class="reg_shlf_outr">
  ...
  <table width="100%" border="0" cellpadding="2" cellspacing="0" class="expandtable_cls">
    ...
    <tr id="postDet2" style="display:none;"  >
      <td colspan="2">&nbsp;</td>
	     <td colspan="3" class="usermenucontentAz">
