	...
	if ($from_date or $to_date)
	{
		...
		?>
			...
			<table  border="0" cellpadding="2" cellspacing="3" width="100%" class="userordertablestyleA">
			  ...
			  <tr>
				<td valign="" width="8%" nowrap="nowrap" class="usermenucontent"><input name="ord_fromdate" class="textfeild" type="text" size="8" value="<?php echo $_REQUEST['ord_fromdate']?>" /></td>
				...
				<td valign="" width="8%" nowrap="nowrap" class="usermenucontent"><a href="javascript:show_calendar('frm_orders.ord_fromdate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;">
				  <input name="ord_todate" class="textfeild" id="ord_todate" type="text" size="8" value="<?php echo $_REQUEST['ord_todate']?>" />
				</a></td>
				<td valign="" width="6%" nowrap="nowrap"><a href="javascript:show_calendar('frm_orders.ord_todate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('show-calendar.gif')?>" width="24" height="22" border="0" /></a></td>
