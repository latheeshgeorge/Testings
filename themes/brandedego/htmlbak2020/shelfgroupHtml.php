		...
		{ return;
			...
			if (count($shelfgroup_arr))
			{
				...
				?>
                    ...
                    <div class="shlf_b_con">   
                    <div class="shlf_b_top">
                    <ul class="shlf_b_protab">
                    <?php
                    ...
                    if($cnt == 1)
				    {    ?>                
                     <div class="shlf_b_bottom_first" id="sgtab_<?php echo $shelfData['shelf_id']; ?>_<?php echo $shelfgroup_id; ?>" > 
                     <?php
                     }
					 else
					 {
					  ?>                
                     <div class="shlf_b_bottom" id="sgtab_<?php echo $shelfData['shelf_id']; ?>_<?php echo $shelfgroup_id; ?>" > 
                     <?php
					 }
					 ?>
                    ...
                    <div class="shlf_b_nav"><a onmouseout="stopMe()" onmouseover="scrollDivRight('container<?php echo $shelfData['shelf_id']; ?>_<?php echo $shelfgroup_id; ?>')" href="#null"><img src="     <?php echo url_site_image('shlfbarw-l.gif');?>">
                    </a></div>
                    <div class="shlfb_thumb_outer" id="container<?php echo $shelfData['shelf_id']; ?>_<?php echo $shelfgroup_id; ?>">
                    ...
                    $HTML_title = '<div class="shlf_b_pdt_name"><a href="'.url_product($row_prod['product_id'],$row_prod['product_name'],1).'" title="'.stripslash_normal($row_prod['product_name']).'">'.stripslash_normal($row_prod['product_name']).'</a></div>';
                    ...
                    ?>  
                    <div class="shlf_b_pdt">
                    <div class="shlf_b_pdt_top">
						                    <?php echo $HTML_title; ?>

                    <div class="shlf_b_pdt_image"><?php echo $HTML_image; ?>
                    </div>
                    <div class="shlf_b_pdt_buy_otr">
                    <div class="shlf_b_pdt_buy"><a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'])?>" title="<?php echo stripslashes($row_prod['product_name'])?>"><?php echo stripslash_normal($Captions_arr['COMMON']['ADD_TO_CART'])?></a></div>
                                      <div class="shlf_b_pdt_info"><a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'])?>" title="<?php stripslash_normal($row_prod['product_name'])?>">More Info</a></div>

                   </div>
                                        <div class="shlf_b_pdt_price"><?php echo $HTML_price; ?></div>
                    ...
                    <div class="shlf_b_nav"><a href="#" onmouseover="scrollDivLeft('container<?php echo $shelfData['shelf_id']; ?>_<?php echo $shelfgroup_id; ?>',<?php echo $div_width?>)" onmouseout="stopMe()"><img src="<?php url_site_image('shlfbarw-r.gif')?>"  /></a></div>
                    </div>
                    </div>
                    <?php
                    }
