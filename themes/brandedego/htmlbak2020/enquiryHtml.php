	 ...
	 function Display_Message()
	 {
		...
		function myenquiry_Enquiry($custid)
		{
			...
			$HTML_treemenu .=
				...
				<tr>
				<td  colspan="3"><table cellpadding="2" cellspacing="5" width="100%"  class="userordertablestyleA"><tr>
				<td  align="left"  class="usermenucontent" valign="middle" width="8%">Date From</td><td  align="left" class="usermenucontent" valign="middle"  width="7%"> <input class="textfeild" type="text" name="srch_review_startdate" size="8" value="<?=$_REQUEST['srch_review_startdate']?>"  /></td><td width="6%" nowrap="nowrap"><a href="javascript:show_calendar('my_enquire.srch_review_startdate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('show-calendar.gif')?>" width="24" height="22" border="0" /></a></td><td  align="left"  class="usermenucontent" valign="middle" width="5%">Date To </td>
				<td  align="left"  class="usermenucontent" valign="top"  nowrap="nowrap" width="7%">  
				<input class="textfeild" type="text" name="srch_review_enddate" size="8" value="<?=$_REQUEST['srch_review_enddate']?>"  /></td><td width="" nowrap="nowrap" colspan="2" width="6%"><a href="javascript:show_calendar('my_enquire.srch_review_enddate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('show-calendar.gif')?>" width="24" height="22" border="0" /></a></td></tr>
				...
				<td class="usermenucontentA" valign='top'>	
						<div class="cart_shop_contAA"><div>
										<input name="clearenq_button" type="button" class="inner_btn_red" id="clearenq_button" value="Go" onclick="document.my_enquire.submit()" />
						</div></div>
				</td>
				</tr>
				</table>
