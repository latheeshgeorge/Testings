		...
		<form method="post" name="frm_wishlist" class="frm_cls" action="<?php url_link('wishlist.html')?>">
			...
			<div class="reg_shlf_outr">
              ...
              <? 
				...
				<td class="cart_table_header"><?php echo stripslash_normal($Captions_arr['WISHLIST']['WISHLIST_ITEM'])?> </td>
				<td class="cart_table_header">&nbsp;</td>
				<td class="cart_table_header" align="center"><?php echo stripslash_normal($Captions_arr['WISHLIST']['WISHLIST_PRICE'])?> </td>
				<td class="cart_table_header" align="center"><?php echo stripslash_normal($Captions_arr['WISHLIST']['WISHLIST_ACTION'])?></td>
