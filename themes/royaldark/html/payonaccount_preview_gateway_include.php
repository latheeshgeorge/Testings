...
switch($row_pay['pay_paymentmethod'])
{
	...
	case 'NOCHEX':
		...
		$return_order_arr['order_id']											= $_REQUEST['pass_nochex_orderid'];
			...
			$row_ord['cancel_url']				= 'http://'.$ecom_hostname.'/payonaccountpayment.html';
			$session_id							= $sessid;
	...
	break;
	case 'BARCLAYCARD': // case or burclaycard
		$button_maincaption 													= 'Confirm Pay On Account Payment';
		$pass_type																= 'payonaccount';
		$button_clickmsg														= 'Please wait...Loading '.getpaymentmethod_Name($row_pay['pay_paymentmethod']);
		$button_class															= 'buttonred_cart';
		$return_order_arr['payData']['gateway_addons']['shaincode']				= $_REQUEST['pass_barclaycard_shaincode'];
		$return_order_arr['payData']['gateway_addons']['pspid']					= $_REQUEST['pass_barclaycard_pspid'];
		$return_order_arr['payData']['gateway_addons']['language']				= $_REQUEST['pass_barclaycard_language'];
		$return_order_arr['payData']['gateway_addons']['catalogurl']			= $_REQUEST['pass_barclaycard_catalogurl'];
		$return_order_arr['payData']['gateway_addons']['logo']					= $_REQUEST['pass_barclaycard_logo'];
		$return_order_arr['payData']['gateway_addons']['title']					= $_REQUEST['pass_barclaycard_title'];
		$return_order_arr['payData']['gateway_addons']['bgcolor']				= $_REQUEST['pass_barclaycard_bgcolor'];
		$return_order_arr['payData']['gateway_addons']['txtcolor']				= $_REQUEST['pass_barclaycard_txtcolor'];
		$return_order_arr['payData']['gateway_addons']['buttonbg_color']		= $_REQUEST['pass_barclaycard_buttonbg_color'];
		$return_order_arr['payData']['gateway_addons']['buttontxt_color']		= $_REQUEST['pass_barclaycard_buttontxt_color'];
		$return_order_arr['payData']['gateway_addons']['fonttype']				= $_REQUEST['pass_barclaycard_fonttype'];
		$return_order_arr['payData']['gateway_addons']['curr_code']				= $_REQUEST['pass_barclaycard_curr_code'];
		$return_order_arr['payData']['gateway_addons']['pass_total']			= $_REQUEST['pass_barclaycard_total'];
		$return_order_arr['payData']['gateway_addons']['desc']					= $_REQUEST['pass_barclaycard_desc'];
		$return_order_arr['order_id']											= $_REQUEST['pass_barclaycard_orderid'];
		$session_id																= $sessid;
