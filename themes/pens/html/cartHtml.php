        ...
        <div class="cart_cont_inner_top"></div>
		 ...
		 if(!$cust_id and count($cartData['products']))
		  ...
		  ?>
			  ...
			  <tr>
				<td align="right" valign="middle"><input type="button" name="button2" id="button2" value="Submit"  class="cart_login_button" onclick="submit_cust_login('frm_cart');"/></td>
				</tr>
				<tr>
    ...
    <div class="cart_cont_inner_bottom"></div>
										...
										<div class="chk_credit_outr">
											...
											<tr>
												...
												<?php
													...
													?>
													<div class="cart_top_links">
														<div class="chk_back_btn"><div><a href="#" class="cart_blink" onclick="show_wait_button(this,'Please Wait...');gobackto_cart('<?php echo ($protectedUrl)? base64_encode($ecom_hostname):$ecom_hostname?>')"><?php echo stripslash_normal($Captions_arr['CART']['CART_BACK_CARTPAGE'])?></a></div></div> 
													</div>
												</td>
											</tr>
		...
		function validate_checkout_fields(frm)
		{
			...
			?>
				...
				document.getElementById('continue_checkout').value = 'loading ...';
		...
		<?php /*?><tr>
		<td  align="left" valign="middle" class="cart_td_normal">			
