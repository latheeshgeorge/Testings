										...
										if ($grpData['catgroup_show_subcat_indropdown']== 1 and $subcatdropdownsupport)// case if categories are to be shown in list menu
										{
											...
											?>
													...
													?>
														...
														{
														?>
															<li><a href="<?php url_category($row_subcat['category_id'],$row_subsubcat['category_name'],-1)?>"><?php echo stripslashes($row_subcat['category_name'])?></a></li>
														<?php
														}
														?>
														</ul>
...
<?php		
										...
										?>
											...
											{
											?>
												<div class="cat_brnd_header_topdrop"><?php echo stripslash_normal($title)?></div>
											<?php
											}
											?>
											<div class="shp_brnd_header_bottom"></div>
			...
			{ 
				...
				?>
                    ...
                    <?php /* FB login script */
						...
						{
						?>
						<div class="login_user_linkB"> <a href="<?php echo $logoutUrl;?>" class="loginlink" title="<?=stripslash_normal($Captions_arr['LOGIN_MENU']['LOGOUT'])?>"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['LOGOUT'])?></a> </div>
						<?php
							}
							else
							{
			...
			?>
					...
					<div class="login_top"></div>
						<div class="login_middle">
							...
							?>
							<li><h2>
                            	<a href="<?php echo $logoutUrl;?>" class="userloginmenulink" ><?=stripslash_normal($Captions_arr['LOGIN_MENU']['LOGOUT'])?></a>
                            </h2></li>
							<?php
								}
								else
