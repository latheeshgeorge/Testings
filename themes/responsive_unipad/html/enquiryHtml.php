		 ...
		 $prod_sql_det = "SELECT product_id,product_name,product_default_category_id,product_webprice,
		  ...
		  ?>
			  <tr>
				...
				<td align="left" class="Epricename">
									<a href="<?php echo url_product($row_prod_det['product_id'],$row_prod_det['product_name'])?>" title="<?php echo $row_prod_det['product_name']?>" class="Eshoppingcartprod_link"><?php echo $row_prod_det['product_name']?></a></br>
				<?php 
            ...
            <td colspan="4" align="right" valign="middle" class="shoppingcartcontent">
			  ...
			  ?>
				...
				<?php
					...
					{
				?>
				  <input name="continue_submit" type="button" class="btn-default-bt" id="continue_submit" value="Continue Browsing" onclick="show_wait_button(this,'Please Wait...');window.location='<?php echo $ps_url?>'" />
				<?php
					}
					else
						echo '&nbsp;';
