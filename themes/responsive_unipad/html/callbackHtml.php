...
/*############################################################################
	...
	class callback_Html
	{
        ...
        <div class="container-tree">
          <ul><li ><a  href="'.url_link('',1).'" title="'.stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']).'">'.stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']).'</a> &#8594; </li>
...
<div class="form-group">
				...
				?>
				<div class="" style="float:left;display:block;font-weight:bold;width:100%;text-align:left;padding-bottom:10px;"><span><?=stripslash_normal($Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_MESSAGE_TEXT'])?> </span></div>
				<? }?>
				</div>
				<div class="form-group">
				...
				while($row = $db->fetch_array($res)) {
					if($Settings_arr['default_country_id']==$row['country_id'])
					$selected = "selected";
					else
					$selected = "";
    ...
    <div class="'.CONTAINER_CLASS.'">
		...
		<div class="container-fluid1">
							...
							<table width="100%" border="0" cellspacing="4" cellpadding="0" class="reg_table">
								<tr>
								<td align="left" valign="middle" class="regicontentA"><div style="height:70px;">
<div class="alert-success callback-success"><?php echo $Message; ?></div></div></td>
								</tr>
							</table>
						</div>
		<?php	
