      ...
      <ul class="nav navbar-nav">
        <?php
                                    ...
                                    if ($grpData['group_showhomelink']==1)
                                    {
                                        ...
                                        <li class="active"><a href="<?php url_link('')?>" class="home_linkm"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?></a></li>
                                    ...
                                    function hansubmenu()
                                    {
										...
										if($(window).width()>757)
										{
											window.location = '<?php echo 'http://unipad.bshop4.co.uk/properties-pg50453.html'?>';
										}
										else
										*/
										?> 
                                    ...
                                    $target = ($row_pg['page_link_newwindow']==1 and $row_pg['page_type']!='Page')?'target="_blank"':'';
										...
										if(strtolower($row_pg['title'])=='properties')
										{
										?>	
											<li class="dropdown">
											<a data-toggle="dropdown" class="dropdown-toggle" href="#"><?php echo stripslash_normal($row_pg['title'])?> <b class="caret"></b></a>
												<ul role="menu" class="dropdown-menu">
													<li><a class="" href="https://www.unipad.co.uk/just-rooms-pg50458.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Just Rooms</a></li>
													<li><a class="" href="https://www.unipad.co.uk/1-bed-pads-pg50354.html"><i class="fa fa-caret-right" aria-hidden="true"></i> 1 Bed Pads</a></li>
													<li><a class="" href="https://www.unipad.co.uk/couples-pads-pg50459.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Couple Bed Pads</a></li>
													<li><a class="" href="https://www.unipad.co.uk/2-bed-pads-pg50355.html"><i class="fa fa-caret-right" aria-hidden="true"></i> 2 Bed Pads</a></li>
													<li><a class="" href="https://www.unipad.co.uk/4-bed-pads-pg50263.html"><i class="fa fa-caret-right" aria-hidden="true"></i> 4 Bed Pads</a></li>
													<li><a class="" href="https://www.unipad.co.uk/5-bed-pads-pg50264.html"><i class="fa fa-caret-right" aria-hidden="true"></i> 5 Bed Pads</a></li>
													<li><a class="" href="https://www.unipad.co.uk/6-bed-pads-pg50265.html"><i class="fa fa-caret-right" aria-hidden="true"></i> 6 Bed Pads</a></li>
													<li><a class="" href="https://www.unipad.co.uk/7-bed-pads-pg50266.html"><i class="fa fa-caret-right" aria-hidden="true"></i> 7 Bed Pads</a></li>
													<li><a class="" href="https://www.unipad.co.uk/8-bed-pads-pg50356.html"><i class="fa fa-caret-right" aria-hidden="true"></i> 8 Bed Pads</a></li>
													<li><a class="" href="https://www.unipad.co.uk/9-bed-pads-pg50357.html"><i class="fa fa-caret-right" aria-hidden="true"></i> 9 Bed Pads</a></li>
													<li><a class="" href="https://www.unipad.co.uk/view-all-pads-pg50351.html"><i class="fa fa-caret-right" aria-hidden="true"></i> View All Pads</a></li>
										...
										{
                                        ?>
                                        <li ><a href="<?php if ($row_pg['page_type']=='Page') url_static_page($row_pg['page_id'],$row_pg['title']); else echo $row_pg['page_link'];?>" class="linkred" title="<?php echo stripslash_normal($row_pg['title'])?>" <?php echo $target?>><?php echo stripslash_normal($row_pg['title']);?></a></li>
                                        <?php
										}
                                    }
                                    }
									...
									if ($db->num_rows($ret_cat))
									{
										...
										if ($grpData['catgroup_show_subcat_indropdown']== 1 and $subcatdropdownsupport)// case if categories are to be shown in list menu
										{
											...
											<?php
												...
												{
											?>
													<li class="item1"><a href="<?php url_category($row_cat['category_id'],$row_cat['category_name'],-1)?>" class="category_menu" title="<?php echo stripslash_normal($row_cat['category_name'])?>"><span><?php echo ucwords(stripslash_normal($row_cat['category_name']));?>1</span></a>
													<?php
...
<?php
		...
		$sort_by 	=  $Settings_arr['category_orderfield'];
				if($sort_by=='cname') $sort_by = 'a.category_name';
				$sort_by 	=  ($sort_by=='custom')?'b.category_order':$sort_by;				
				$sort_order =  $Settings_arr['category_orderby'];
				$sort_str	= " $sort_by $sort_order ";
		?>
		...
		<?php
		$prod_ids = $cat_ids = 1;
		 $sql_cat = "SELECT a.category_id,a.category_name 
		FROM 
			product_categorygroup_category b 
		INNER JOIN product_categories a ON a.category_id=b.category_id AND a.sites_site_id = $ecom_siteid
	    INNER JOIN product_categorygroup c ON c.catgroup_id	= b.catgroup_id AND catgroup_name ='searchdropdown'
	     ORDER BY 
			$sort_str
		";
		$ret_cat = $db->query($sql_cat);
	    $parent_arr[0] = '--Any Bed Pads--';

		while($row_cat=$db->fetch_array($ret_cat))
		{
			 $cat_id = $row_cat['category_id'];
			 $cat_name = $row_cat['category_name'];
		     $parent_arr[$cat_id] = $cat_name;
	    }
		/*
		$prod_ids = $cat_ids = 1;
		$sql_cat = "SELECT a.category_id,a.category_name 
		...
		$ret_cat = $db->query($sql_cat);
		*/ 
		$search_catid = ($_REQUEST['search_category_id'])?$_REQUEST['search_category_id']:0;
		?>
                ...
                <div class="input-group">
							<div class="input-group-btn search-panel">
								...
								<ul class="dropdown-menu" role="menu">
									...
									if(is_array($parent_arr))
									{
										...
										{
									?>
									  <li><a id="<?php echo $k;?>" href="#<?php echo $k;?>"><?php echo $v;?></a></li>
							...
							<input class="form-control" id="adv_quick_search" name="quick_search" value="<?=$_REQUEST['quick_search']?>" placeholder="Search .." type="text">
							<span class="input-group-btn">
								<button class="btn btn-default" name="search_submit2" type="submit"><span class="glyphicon glyphicon-search"></span></button>
							</span>
							</div>
...
/*
		 ...
		 <div class="reg_shlf_outr">
			 <div class="searchtop_head" >Student accommodation in Lancaster</div>		
			...
			<div class="searchfont_header">Looking For Student Pads </div>
			<div class="searchfont_text"><input name="quick_search" type="text"  id="adv_quick_search"  value="<?=$_REQUEST['quick_search']?>" placeholder="Search Unipad"  size="15" class="form-control"/>
			</div>
		
			<div class="searchfont_header_border"></div>
		...
		<div class="searchfont"><input name="search_submit2" type="submit" class="btn btn-block btn-lg btn-danger" id="search_submit" value="Start My Search" onclick="show_wait_button(this,'Please wait...')" /></div>
		 </div>
		 */
		 ?> 
			<?php
		...
		// Function which holds the display logic for quick search section
		// ####################################################################################################
		function mod_propsearch($title)
		{
			global $Captions_arr,$position,$ecom_hostname,$protectedUrl,$ecom_siteid,$ecom_siteid,$db,$ecom_hostname,$Settings_arr,$Captions_arr;;
			if($position=='topband')
			{ 		      
		    global $ecom_siteid,$db,$ecom_hostname,$Settings_arr,$Captions_arr;
		     $Captions_arr['SEARCH'] 	= getCaptions('SEARCH');
		     ?>		     
				<section class="search-sec" style="float:left;padding:10px; margin-top:10px;display:block;width:100%;">
					<div class="container">
						<form method="post" name="frm_propsearch" class="frm_cls" action="<?php url_link('propsearch.html')?>">
							<div class="row">
								<div class="col-lg-12">
									<div class="row">
										<div class="col-lg-3 col-md-3 col-sm-12 p-0">
											<select class="form-control search-slt" id="property_type<?php echo rand(1,100);?>" name="property_type">
											   <?php 
											   $sql_proptype = "SELECT * FROM settings_property_types WHERE property_sites_site_id =109 ORDER BY property_sortorder";
											   $ret_proptype = $db->query($sql_proptype); 
											   ?>
												<option value="">Property Type</option>
												<option value="-1" <?php if($_REQUEST['property_type']==-1){ echo "selected";} ?>>Any</option>
												<?php
												while($row_proptype = $db->fetch_array($ret_proptype)) 
												{
												?>
												<option value="<?php echo $row_proptype['property_type']?>" <?php if($_REQUEST['property_type']==$row_proptype['property_type']){ echo "selected";} ?>><?php echo $row_proptype['property_type']?></option>
												<?php
												}
												?>
											</select>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 p-0">
											<select class="form-control search-slt" id="property_nobedrooms<?php echo rand(1,100);?>" name="property_nobedrooms">
												<option value="0">Number of Bedrooms</option>
												<?php 
												  for($i=1;$i<10;$i++)
												  {
												  ?>
												  	<option value="<?php echo $i;?>" <?php if($_REQUEST['property_nobedrooms']==$i){ echo "selected";} ?> ><?php echo $i;?></option>
										...
										<div class="col-lg-3 col-md-3 col-sm-12 p-0">
											<select class="form-control search-slt" id="property_nobathrooms<?php echo rand(1,100);?>" name="property_nobathrooms">
												   <option value="0">Number of Bathrooms</option>
												   <?php 
												  for($i=1;$i<10;$i++)
												  {
												  ?>
												  	<option value="<?php echo $i;?>" <?php if($_REQUEST['property_nobathrooms']==$i){ echo "selected";} ?>><?php echo $i;?></option>
...
<div class="callbackicon">
	<a href="<?php echo url_link('callback.html')?>"><img src="<?php echo url_site_image('request_callback.svg');?>" alt="Request A Call-back"   style="border:0;width:88px;height:74px;" /></a>
</div>

<div class="callbackbt" onclick="window.location='<?php echo url_link('callback.html')?>'" style="cursor:pointer;">
request a callback

</div>
<div class="callback-detail">Click Here to Fill in your Details. We'll Call You Back.</div>

</div>
<div class="newsletter-box">

	<form class="form-signin" name="frm_newsletter" method="post"  onsubmit="return newsletter_validation(this)">
	<div class="newsletterhead">join mailing list</div> 
	<label class="sr-only">Email address</label>
	<input name="newsletter_email" type="text" id="newsletter_email" class="form-control inputtxt" placeholder="Enter Email" >
	<?php
	if($Settings_arr['imageverification_req_newsletter']) // if image verification is required
	{
	?>
		...
		<?php 
		// showing the textbox to enter the image verification code
		$vImage->showCodBox(1,'newsletter_Vimg','class="form-control formcode"'); 
		?>
		<div class="spamImg"><img src="<?php url_verification_image('includes/vimg.php?size=4&pass_vname=newsletter_Vimg&amp;bg=250%20109%2033')?>" style="border:0;" alt="Image Verification"/></div>
		<div class="warndetails">By entering this code you help us prevent spam and fake registrations</div>
		</div>
	<?php 
	}
	?>
	<input type="hidden" name="newsletter_Submit" value="1" />
	<button class="btn btn-lg btn-primary yellowbt" type="submit">Sign in</button>
	</form>
</div>
</div>     
...
<?php 
		...
		{ 
			...
			if ($position=='topband-left' ) // show the advert only if position is left or right
			{ 
				if (count($advert_arr))
				{
						...
						switch ($k['advert_type'])
						{
							...
							case 'TXT':
								$path = $k['advert_source'];
								 ...
								 $HTML_Content .='<div class="main-container"><div class="legacy-grid">
								<div class="row"> '.stripslash_normal($path).'</div>
							...
							$advert_ul_id = uniqid('advert_');
								...
								$ret_rotate = $db->query($sql_rotate);
									...
									$HTML_Content .= ' <div class="main-container"><header id="myCarousel" class="carousel slide">
									<!-- Indicators -->
									...
									<span>'.stripslashes($alt_text).'</span>
									</div>
												  </div>';
										$cnt++;
									}
...
<?php
			...
			if ($position=='topband-right' ) // show the advert only if position is left or right
			{
				if (count($advert_arr))
				{
					foreach ($advert_arr as $d=>$k)
