...
<div class="callwrap1">
<ul>
<li class="call_icon"><a href="tel:01524 888880" style="font-size:20px;"> 01524 888880
 </a></li>
</ul>
</div>
    ...
    .modal-content_det {
        width: 100%;
			...
			$(document).ready(function() {
						...
						var pWidth = $('#img01').innerWidth(); //use .outerWidth() if you want borders
						   ...
						   if(250 > x)
							{	
								...
								$('#modal_nextbtn').css('opacity',".3");*/
							}	
							else if(x>(pWidth-250))
							{
								$(this).css('cursor','pointer');
								/*$('#modal_prevbtn').css('opacity',".3");
				...
				/*$('#img01').mouseout(function(e){
					$('#modal_prevbtn').css('opacity',".3");
					$('#modal_nextbtn').css('opacity',".3");
				});
				$('#modal_prevbtn').mouseover(function(e){
					$('#modal_prevbtn').css('opacity',"1");
					$('#modal_nextbtn').css('opacity',".3");
				});
				$('#modal_prevbtn').mouseout(function(e){
					$('#modal_prevbtn').css('opacity',".3");
					$('#modal_nextbtn').css('opacity',".3");
				});
				$('#modal_nextbtn').mouseover(function(e){
					$('#modal_prevbtn').css('opacity',".3");
					$('#modal_nextbtn').css('opacity',"1");
				});
				$('#modal_nextbtn').mouseout(function(e){
					$('#modal_prevbtn').css('opacity',"1");
					$('#modal_nextbtn').css('opacity',".3");
				});*/
				...
				$('#mainimg_next').click(function(){
					stop_mainslideshow();
					mapzoomimage_main('right');
				});
				
				$('#mainimg_prev').click(function(){
					stop_mainslideshow();
					mapzoomimage_main('left');
				});
			...
			function mapzoomimage_main(navloc)
			{
			...
			<?php /*var touchStartCoords =  {'x':-1, 'y':-1}, // X and Y coordinates on mousedown or touchstart events.
			touchEndCoords = {'x':-1, 'y':-1},// X and Y coordinates on mouseup or touchend events.
			direction = 'undefined',// Swipe direction
			minDistanceXAxis = 20,// Min distance on mousemove or touchmove on the X axis
			maxDistanceYAxis = 30,// Max distance on mousemove or touchmove on the Y axis
			maxAllowedTime = 600,// Max allowed time between swipeStart and swipeEnd
			startTime = 0,// Time on swipeStart
			elapsedTime = 0,// Elapsed time between swipeStart and swipeEnd
			targetElement = document.getElementById('img01');// Element to delegate
...

			{
...

				{
...

					{
						...
						?>
						<div id="owl-demo-unipaddetlabel" class="owl-carousel">
						<?php
							...
							?>
								<div class="item">
									<div><img src="<?php url_site_image($label_image,-1)?>" />
						...
						<script type="text/javascript">
							...
							var owls = $("#owl-demo-unipaddetlabel");
								owls.owlCarousel({
									<?php /*items : 3, // items above 1000px browser width
