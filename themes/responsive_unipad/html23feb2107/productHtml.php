				...
				<div class="col-md-8 det">
					<?php
										...
										<?php		
											...
											if($row_prod['product_actualstock']>0)
													$availability_msg = '<span class="green_available_new">'.$Captions_arr['COMMON']['PRODDET_AVAIL_1_YEAR'].'</span>';
												else
...
<div class="callwrap">
<ul>
<li class="call_icon"><a href="#" style="font-size:20px;"> +44 1524 888880
 </a></li>
</ul>
</div>
<?php
	...
	?>
		<div class="Product_viewedcls" style="float:left;width:290px;color:red;">Viewed <?php echo $num_views;?> times today </div>
    <?php
	}
    ?>
</div>
    ...
    .modal-content_det {
        width: 100%;
			...
			<?php 
				...
				<div id="gallery_09" >
					...
					<span class="close_det" id="img_modal_close_det">&times;</span>
						...
						<a class="btn prevab glyphicon glyphicon-arrow-left btn btn-info"></a>
						<a class="btn nextab glyphicon glyphicon-arrow-right btn btn-info"></a>
						</div>
			...
			$(document).ready(function() {
				...
				$('#proddet_Modal').css('background-image', 'url("<?php echo url_site_image('loading.gif',1)?>")').css('background-repeat', 'no-repeat').css('background-position','top center');
			...
			function mapzoomimage_main(navloc)
			{
				...
				if(ob_inx!=-1)
				{
					...
					$('#mainimage_holder .owl-wrapper').trigger('owl.goTo', ob_inx);
					show_curindx = ob_inx;
				}
			}
						...
						<script type="text/javascript">
							...
							var owls = $("#owl-demo-unipaddetlabel");
								owls.owlCarousel({
									...
									<?php /* itemsDesktop : [1000,6], // items between 1000px and 901px
...
?>
  ...
  <style>
    ...
    $(document).ready(function() {
      ...
      owl.owlCarousel({pagination:false,scrollPerPage: true});
