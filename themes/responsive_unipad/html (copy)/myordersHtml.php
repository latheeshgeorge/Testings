<?php
	...
	if ($from_date or $to_date)
	{
		...
		$ord_array = array();
		$HTML_treemenu11 = '<div class="tree_menu_conA">
  ...
  ?>
    ...
    ?>    
			...
			<table  border="0" cellpadding="0" cellspacing="0" width="100%" class="userordertablestyleA">
				<tr>
				<td nowrap="nowrap" >
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="search_areaTable">
						...
						<tr>
							<td colspan="2">
								<?php echo stripslash_normal($Captions_arr['ORDER']['ORDERID'])?><br />
								<input name="ord_id" type="text" class="textfeild_ord" id="ord_id" value="<?php echo $_REQUEST['ord_id']?>" size="6" />
							</td>
							</tr>
							*/ ?> 
							<tr>
							<td>
								<?php echo stripslash_normal($Captions_arr['ORDER']['ORDER_BETDATE'])?><br />
							...
							<span class="span_and">and</span>
							  <input name="ord_todate" id="datepicker1" class="textfeild_ord form-control" id="" type="text" size="10" value="<?php echo $_REQUEST['ord_todate']?>" />
				...
				<td nowrap="nowrap" >
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="search_areaTable">
						<tr>
							...
							<input name="Search_go" type="submit" class="inner_btn_red btn btn-default to-log-in" id="Search_go" value="Go" onclick="document.frm_orders.search_click.value=1" />
							</td>
							<td></td>
							<td></td>
							<td>
			...
			<?php 
				   ...
				   $query_string 	= '&amp;ord_sort_by='.$_REQUEST['ord_sort_by'].'&amp;ord_fromdate='.$_REQUEST['ord_fromdate'].'&amp;ord_sort_order='.$_REQUEST['ord_sort_order'].'&amp;ord_todate='.$_REQUEST['ord_todate'];
					$paging = paging_footer_advanced($path,$query_string,$tot_cnt,$start_var['pg'],$start_var['pages'],'',$pg_variable,'Orders',$pageclass_arr); 
			...
			<?php
					if($paging['total_cnt'])
					{
						echo '<tr><td colspan="7" class="ordformtd"><div class="subcat_nav_pdt_no"><span>'.$paging['total_cnt'].'</span></div></td></tr>';				
					}
				}
				*/ 
			?>
			<tr>
			<td colspan="7" align="left" valign="middle" class="pagingcontainertd_normal" ><img src="<?php url_site_image('new_post.png')?>"   border="0" title="New" />
			...
			*/?> 
			<td align="middle" valign="middle" class="<?=$cls?>" nowrap="nowrap"><?php  echo getpaymentstatus_Name($row_select_ord['order_paystatus']); if($count_new==1){?> <img src="<?php url_site_image('new_post.png')?>"   border="0" title="New" /><? }?></td>
			</tr>
			<?php
			}	
	...
	$HTML_treemenu22 = '<div class="tree_menu_conA">
								  <div class="tree_menu_topA"></div>
								  <div class="tree_menu_midA">
									<div class="tree_menu_content">
									  <ul class="tree_menu">
...
if($insmsg)
	...
	<tr onclick="handle_expansionall('refunddet_imgtag','bill','<?PHP echo $ecom_hostname; ?>')">
	  ...
	  <tr>
		<td width="8%" class="userorderheadernew" ><img id="refunddet_imgtag" src="<?PHP echo url_site_image('icon-arrow-up.png'); ?>" border="0"  title="Click" style=""/></td>
		<td width="92%" align="left" class="userorderheadernew" colspan="3">Billing Details</td>
	  </tr>
	</table></td></tr>
	...
	<td colspan="4" align="left" valign="bottom"><table width="100%" border="0" cellspacing="1" cellpadding="1" class="myorder_deltable">
	  <tr>
		<td width="8%" class="userorderheadernew"><img id="billing_imgtag" src="<?PHP echo url_site_image('icon-arrow-up.png'); ?>" border="0"  title="Click" style=""/></td>
		<td width="92%" align="left" class="userorderheadernew">Delivery Details</td>
	  </tr>
	</table></td>
	</tr>
	...
	<td width="8%" class="userorderheadernew"><img id="Enquiry_imgtag" src="<?PHP if(!$_REQUEST['ord_pg']) { echo url_site_image('icon-arrow-up.png'); } else {  echo url_site_image('sel_tab_yes.gif'); } ?>" border="0"  title="Click" style=""/></td>
	 <td width="92%" align="left" class="userorderheadernew">Enquiry Details</td>
		</tr>
	</table>
	</td>
	</tr>
	...
	<?php
		...
		<tr>
			<td colspan="4" align="left" valign="bottom"><table width="100%" border="0" cellspacing="1" cellpadding="1">
			  <tr>
				<td width="3%" class="userorderheadernew"><img id="download_imgtag" src="<?PHP echo url_site_image('icon-arrow-down.png'); ?>" border="0" onclick="handle_expansionall(this,'downloads_table','<?PHP echo $ecom_hostname; ?>')" title="Click"/></td>
				...
				?>
					<tr class="edithreflink_tronmouse" title="<?php echo stripslash_normal($Captions_arr['MY_DOWNLOADS']['DOWN_DOWNLOAD'])?>" onmouseover="this.className='edithreflink_trmouseout'" onmouseout="this.className='edithreflink_tronmouse'">
					  ...
					  <?php
						...
						?>
								<a href="http://<?php echo $ecom_hostname?>/download_product.php?dld=<?php echo $dld?>" title="<?php echo stripslash_normal($Captions_arr['MY_DOWNLOADS']['DOWN_CLICK_DOWN']);?>"><img src="<?php url_site_image('download.gif')?>" alt="Click to Download" border="0" /></a>
						<?php
							}
							else
							{
