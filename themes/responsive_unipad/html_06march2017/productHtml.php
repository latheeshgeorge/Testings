		...
		?>
			<div class="row single">
				<div class="col-md-8 det">
				  ...
				  <div class="single_left" style="";>
					  <h2 style="padding-left:12px;"><?php echo stripslash_normal($row_prod['product_name']); ?> <strong> <?php 
					if($was_price)
...
<div class="callwrap">
<ul>
<li class='fb_call'><a href="https://www.messenger.com/t/unipadlancaster/" target="_blank"><img src='<?php url_site_image('floating_img.png')?>' border="0" alt="Speak With Unipad on Facebook Messenger"></a></li>
</ul>
...
<div id="social_share_div"><div class="sharethis-inline-share-buttons"></div>
</div>

</div>
<div class="callwrap1">
<ul>
<li class="call_icon"><a href="tel:01524888880" style="font-size:20px;"> 01524 888880
 </a></li>
</ul>
</div>
</div>
			...
			<input type="hidden" name="pagetype" id="pagetype" value="" />
					...
					<div class="deat_pdt_buy_right">
						<?php
						 ...
						 {
						 ?>
						 <input value="Arrange Viewing" name="Arrange Viewing" class="btncart btn btn-add-to-cart btn-lg sharp" id="<?php echo $row_prod['product_id']?>" type="button" onclick="show_wait_button(this,'Please Wait...');document.frm_proddetails.fpurpose.value='Prod_Enquire';document.frm_proddetails.submit();">
						<?php
						}
						else
						{
...
<div class="tabs-7">
	...
	<ul class="tabs">
		...
		?>
				<li <?php echo $cls_clsh;?>><a href="#tab<?php echo $cnt_tb;?>"><?php echo $v;?></a></li>
...
?>
			...
			$row_pp = $db->fetch_array($ret_pp);
											...
											{
										?>
												<div class="nowlet_cls_inner_new"><img src="<?php echo url_site_image('nowLet.png',1) ?>" alt="Now Let"></div>
										<?php		
											}
											if($row_pp['product_actualstock']>0)
											{
													$availability_msg = '<span class="red_available_new">'.$Captions_arr['COMMON']['PRODDET_AVAIL_1_YEAR'].'</span>';
											}
											else
											{	
													$availability_msg = '<span class="red_available_new">'.$Captions_arr['COMMON']['PRODDET_AVAIL_2_YEAR'].'</span>';
											}		
...
/* Add Animation */
/*.modal-content_det, #img_modal_caption_det {    
        ...
        width: 100%;
			...
			<?php 
				...
				<div id="gallery_09" >
					...
					<img class="modal-content_det" id="img01" src="" data-curidx="">
					</div>
					</div>	
					<div class="customNavigation">
					<a class="btn preva glyphicon glyphicon-arrow-left btn btn-info"></a>
					<a class="btn nexta glyphicon glyphicon-arrow-right btn btn-info"></a>
					</div>
					
					<div id="owl-demo-unipaddet" class="owl-carousel">
					<?php
					$cntg = 0; 
					$ind = 0;
			...
			$(document).ready(function() {
				...
				<?php /* Presetting the background image as loading image for modal window 
				...
				<?php /* Creating the carousel element */ ?>
				var owl = $("#owl-demo-unipaddet");
				...
				//chkobj = $("#owl-demo-unipaddet div:last-child img");
				
								

				<?php /* When clicked on any more image */ ?>
				$('#owl-demo-unipaddet .item img').click(function(){
					stop_mainslideshow();
				...
				$('#owl-demo-unipaddet .item img').hover(function(){
					$(this).animate({'opacity':'0.5'}, 100);
				});
				
				<?php /* Fadein more image on mouseout */ ?>
				$('#owl-demo-unipaddet .item img').mouseout(function(){
				...
				/*$('#modal_prevbtn').css('opacity',"1");
				$('#modal_nextbtn').css('opacity',"1");*/
				<?php /* Custom Navigation Events for more images*/ ?>
				// 
				var totwidth = 0;
				var lastwidth = parseInt($("#owl-demo-unipaddet img:last").css('width'))+300;
				var imgcntr = 0;
				$("#owl-demo-unipaddet img").each(function(){
					totwidth = totwidth + parseInt($(this).css('width'))+6;
					imgcntr++;
				});
					
				$("#owl-demo-unipaddet .owl-wrapper").css('width',totwidth);
				/*alert(totwidth);*/
				
				$(".nexta").click(function(){
					
					var spl = ($("#owl-demo-unipaddet .owl-wrapper").css('transform').split(','));
					var curvals = -1 * parseInt(spl[4]);
					if((curvals+lastwidth)<(totwidth))
					{
			...
			function mapzoomimage_main(navloc,imagesetonly)
			{
				...
				if(ob_inx!=-1)
				{
					...
					$('#zoom_09').animate({opacity:.7},'300',function(){
					...
					$('#zoom_09').attr('src',curobjs.attr('data-big'));
...

					{
						...
						$items_str = '';	
...

							{
								...
								{	$label_image	=	'icon_double_bed_no_name_p.png';		}

								if(strtolower(str_replace(' ','',$row_labels['label_name'])) == "bathroom")

								{	$label_image	=	'icon_bathroom_p.png';		}
 ...
 <div class="customNavigation1">
			...
			while($row_prod = $db->fetch_array($ret_prod))
			{
				...
				*/ ?> 
				...
				<a href="javascript:handletap('<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>','linked<?php echo $row_prod['product_id']?>')" title="<?php echo stripslashes($row_prod['product_name'])?>" <?php //echo getmicrodata_producturl()?> >
												<?php
												// Calling the function to get the image to be shown
  ...
  <style>
    ...
    $(document).ready(function() {
      ...
      $(".customNavigation1 .next").click(function(){
        owls.trigger('owl.next');
      })
      $(".customNavigation1 .prev").click(function(){
        owls.trigger('owl.prev');
      })
      $(".play").click(function(){
        owls.trigger('owl.play',1000);
      })
      $(".stop").click(function(){
        owls.trigger('owl.stop');
      })
