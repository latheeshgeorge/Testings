      ...
      <ul class="nav navbar-nav">
        <?php
                                    ...
                                    if ($grpData['group_showhomelink']==1)
                                    {
                                        ...
                                        <li class="active"><a href="<?php url_link('')?>" class="home_linkm"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?></a></a>
										...
										?>	
											...
											<a data-toggle="dropdown" class="dropdown-toggle" href="#"><?php echo stripslash_normal($row_pg['title'])?> <b class="caret"></b></a>
												<ul role="menu" class="dropdown-menu">
													<li><a class="" href="http://www.unipad.co.uk/just-rooms-pg50458.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Just Rooms</a></li>
													<li><a class="" href="http://www.unipad.co.uk/1-bed-pads-pg50354.html"><i class="fa fa-caret-right" aria-hidden="true"></i> 1 Bed Pads</a></li>
													<li><a class="" href="http://www.unipad.co.uk/couples-pads-pg50459.html"><i class="fa fa-caret-right" aria-hidden="true"></i> Couple Bed Pads</a></li>
													<li><a class="" href="http://www.unipad.co.uk/2-bed-pads-pg50355.html"><i class="fa fa-caret-right" aria-hidden="true"></i> 2 Bed Pads</a></li>
													<li><a class="" href="http://www.unipad.co.uk/4-bed-pads-pg50263.html"><i class="fa fa-caret-right" aria-hidden="true"></i> 4 Bed Pads</a></li>
													<li><a class="" href="http://www.unipad.co.uk/5-bed-pads-pg50264.html"><i class="fa fa-caret-right" aria-hidden="true"></i> 5 Bed Pads</a></li>
													<li><a class="" href="http://www.unipad.co.uk/6-bed-pads-pg50265.html"><i class="fa fa-caret-right" aria-hidden="true"></i> 6 Bed Pads</a></li>
													<li><a class="" href="http://unipad.bshop4.co.uk/7-bed-pads-pg50266.html"><i class="fa fa-caret-right" aria-hidden="true"></i> 7 Bed Pads</a></li>
													<li><a class="" href="http://www.unipad.co.uk/8-bed-pads-pg50356.html"><i class="fa fa-caret-right" aria-hidden="true"></i> 8 Bed Pads</a></li>
													<li><a class="" href="http://www.unipad.co.uk/9-bed-pads-pg50357.html"><i class="fa fa-caret-right" aria-hidden="true"></i> 9 Bed Pads</a></li>
													<li><a class="" href="http://unipad.bshop4.co.uk/view-all-pads-pg50461.html"><i class="fa fa-caret-right" aria-hidden="true"></i> View All Pads</a></li>
...
<div class="callbackicon">
	<a href="<?php echo url_link('callback.html')?>"><img src="<?php echo url_site_image('request_callback.png');?>" alt="Request A Call-back"   border="0" /></a>
</div>
...
<div class="newsletter-box">
	...
	?>
		...
		?>
		<div class="spamImg"><img src="<?php url_verification_image('includes/vimg.php?size=4&pass_vname=newsletter_Vimg&amp;bg=250 109 33')?>" border="0" alt="Image Verification"/></div>
