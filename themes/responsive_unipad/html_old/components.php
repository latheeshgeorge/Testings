			...
			?>
			 <form method="post" name="frm_quicksearch" class="frm_cls" action="<?php url_link('search.html')?>">
                   ...
                   <input type="hidden" name="rdo_suboption" id="rdo_suboption" value='title_desc'/>
						...
						<tr>
						<td class="ztable_l">   
						<a href="#" class="link_top" onclick="gobackto_cart('<?php echo ($protectedUrl)?base64_encode($ecom_hostname):$ecom_hostname?>')" class="cart_view_linkC" title="<?php echo stripslash_normal($Captions_arr['COMMON']['VIEW_CART'])?>">View Cart</a>
						<a href="<?php url_link('enquiry.html')?>" class="link_top" title="<?php echo stripslash_normal($Captions_arr['COMMON']['VIEW_ENQUIRY'])?>">View Enquiry</a>
						<a href="#" class="link_top" onclick="handle_checkout_submit('<?php echo $ecom_hostname?>',0,'<?php echo $pass_tot?>')"  title="<?php echo stripslash_normal($Captions_arr['COMMON']['CHECK_OUT'])?>">Checkout</a></td>
						...
						<tr>
						<td class="curve_topA_s" ><label>
						<input name="quick_search" type="text" class="input_s" id="quick_search"  value="<?php echo $_REQUEST['quick_search']?>"/>
						</label></td>
						<td class="td" ><input type="submit" name="button2" id="button2" value="Submit" class="bblack"/></td>
						</tr>
						</table>  
		...
		function mod_customerlogin($title)
		{
			...
			if (!$cust_id) // case customer is not logged in
			{
				...
				?>
					...
					<td class="tdz_l" >
					<a href="<?php url_link('custlogin.html')?>"><input type="submit" name="button3" id="button3" value="Login"  class="ibred"/></a>
			...
			?>
                                <tr>
                                	<td class="main_mid_a" ><span class="black"><a href="<?php url_link('myprofile.html')?>">MyAccount</a></span>&nbsp;||&nbsp;<span class="black"><a href="<?php url_link('login_home.html')?>">Myhome</a></span></td>
                                	<td class="main_mid_b" ><a href="<?php url_link('logout.html')?>"><input type="button" name="button3" id="button3" value="<?=stripslash_normal($Captions_arr['LOGIN_MENU']['LOGOUT'])?>"  class="bred"/></a></td>
                                </tr>
            <?php
			}
		}
