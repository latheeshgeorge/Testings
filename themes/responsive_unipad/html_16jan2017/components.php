...
<?php
		...
		<tr>
			...
			<td colspan="3" align="left" class="searchfont_header_border">Looking For Student Pads</td>
			</tr>
			<tr id="searchprod_tr<?php echo $prod_ids++?>">
		...
		<tr>
		<td colspan="3" align="center" class="searchfont"><input name="search_submit2" type="submit" class="buttongray_adv" id="search_submit" value="Start My Search" onclick="show_wait_button(this,'Please wait...')" /></td>
		</tr>
		</table>
		 </div>
		</form>
