                    ...
                    */ 
                    ...
                    if (count($cartData['products'])>0)
                    {
						...
						if($hide_direct_checkout_button==false)// today start
						{
							...
							{
								$HTML_bottomdesc .= "<div class='cart_checkout_div' align='right'><span class='red_msg'><a href=\"".url_link('custlogin.html',1)."?redirect_back=1&pagetype=cart\" title=\"Login\" class=\"cartlogin_link\">Please Click here login to continue to Checkout.</a></span></div>";
							}
						}// today start
						$HTML_bottomdesc .='</td>';
                    }
