...
function mailinglist_mainsel()
{
  ...
  $HTML_treemenu = '	<div class="breadcrump">
					<nav class="breadcrumb">
						 ...
						 <span class="breadcrumb-item active">'.stripslash_normal($Captions_arr['CUST_REG']['EDITPROFILE_TREEMENU_TITLE']).'</span>					</nav>
...
<label class="sr-onlyA" for="form-customer_pwd_cnf"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_CONF_PASSWORD'])?><span class="redtext">*</span></label>
  ...
  <input type="hidden" name="customer_referred_by" value="<?=$_REQUEST['customer_referred_by']?>">
  			...
  			<input type="submit" id="myprofile_Submit"  name="myprofile_Submit" class="btn btn-lg btn-primary btn-block regbt" value="<?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_REGISTRATION_SAVE_BUTTON'])?>"/></div>
  </fieldset>	 
...
function Show_Myconsent(){
		...
		'<div class="tree_menu_conA">
		  ...
		  $HTML_treemenu = '	<div class="breadcrump">
					<nav class="breadcrumb">
						 <a class="breadcrumb-item" href="'.url_link('',1).'" title="'.stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']).'">'.stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']).'</a>     
						 <span class="breadcrumb-item active">consent Form</span>					</nav>
...
<p>By following the simple instructions below, you can give us your permission for us to stay in touch. The form also helps us to know which forms of contact you prefer, and exactly what information you do and don't want to receive. 
					  ...
					  <tr>
					    ...
					    <td  align="left" class="regi_txtfeildA" width="40%">
			<select name="customer_title" class="form-control" id="customer_title" >
			...
			<option value="M/S." <?=($row_sql['customer_title']=='M/S.')?"selected":''?>>M/S.</option>
					  ...
					  <tr>
					    <td  colspan="2"  align="right" class="regi_txtfeildA" >First Name<span class="redtext">*</span> </td>
					    <td  align="center" >:</td>
					    <td  align="left" class="regi_txtfeildA"><input class="form-control" type="text" name="fname" value="<?=$fname; ?>" maxlength="<?=$short?>"/></td>
				    </tr> 
					 <tr>
					    <td  colspan="2"  align="right" class="regi_txtfeildA">Last Name<span class="redtext">*</span> </td>
					    <td  align="center" >:</td>
					    <td  align="left" class="regi_txtfeildA"><input class="form-control" type="text" name="lname" value="<?=$lname; ?>" maxlength="<?=$short?>"/></td>
				    </tr>
				      <tr>
					    <td  colspan="2"  align="right" >&nbsp;</td>
					    <td  align="center" >&nbsp;</td>
				    ...
				    <tr>
					  ...
					  <tr>
					    <td  colspan="2"  align="right" class="regi_txtfeildA">Email</td>
					    <td  align="center" >:</td>
					    <td  align="left" class="regi_txtfeildA1" width="40%">Yes&nbsp;<input class="form-control1" type="radio" name="through_email" <?php if($row_sql['through_email']==1){?> checked="checked" <?php }?>  value="1">&nbsp;&nbsp;&nbsp;&nbsp;No&nbsp;<input class="form-control1"  type="radio" <?php if($row_sql['through_email']==0){?> checked="checked" <?php }?> name="through_email"  value="0"></td>
				    </tr>
				     <tr>
					    <td  colspan="2"  align="right"class="regi_txtfeildA" >If Yes Enter Email Id</td>
					    <td  align="center" >:</td>
					    <td  align="left" class="regi_txtfeildA"><input type="text" class="form-control" name="email_id" value="<?=$row_sql['email_id'] ?>" maxlength="<?=$medium?>"/></td>
				    </tr>
				     <tr>
					    <td  colspan="2"  align="right" class="regi_txtfeildA" >Telephone</td>
					    <td  align="center" >:</td>
					    <td  align="left" class="regi_txtfeildA1">Yes&nbsp;<input type="radio" class="form-control1" name="through_phone" <?php if($row_sql['through_phone']==1){?> checked="checked" <?php }?>  value="1">&nbsp;&nbsp;&nbsp;&nbsp;No&nbsp;<input class="form-control1"  type="radio" name="through_phone"  <?php if($row_sql['through_phone']==0){?> checked="checked" <?php }?> value="0"></td>
				    </tr>
				     <tr>
					    <td  colspan="2"  align="right" class="regi_txtfeildA">If Yes Enter Phone Number</td>
					    <td  align="center" >:</td>
					    <td  align="left" class="regi_txtfeildA"><input type="text" class="form-control" name="phone_number" value="<?=$row_sql['phone_number'] ?>" maxlength="<?=$medium?>"/></td>
				    </tr>
				     <tr>
					    <td  colspan="2"  align="right" class="regi_txtfeildA">Post</td>
					    <td  align="center" >:</td>
					    <td  align="left" class="regi_txtfeildA1">Yes&nbsp;<input type="radio" class="form-control1" name="through_post" <?php if($row_sql['through_post']==1){?> checked="checked" <?php }?> value="1">&nbsp;&nbsp;&nbsp;&nbsp;No&nbsp;<input class="form-control1"  type="radio" name="through_post" <?php if($row_sql['through_post']==0){?> checked="checked" <?php }?>  value="0"></td>
				    </tr>
				     <tr>
					    <td  colspan="2"  align="right"  valign="top" class="regi_txtfeildA">If Yes Enter Address here</td>
					    <td  align="center" valign="top">:</td>
					    <td  align="left" class="regi_txtfeildA"><textarea  name="postal_address" class="form-control"  rows="5" cols="30" /><?=$row_sql['postal_address'] ?></textarea></td>
				    </tr>
				     <tr>
					    <td  colspan="2"  align="right" class="regi_txtfeildA">Text</td>
					    <td  align="center" >:</td>
					    <td  align="left" class="regi_txtfeildA1">Yes&nbsp;<input type="radio" class="form-control1" name="through_text" <?php if($row_sql['through_text']==1){?> checked="checked" <?php }?>  value="1">&nbsp;&nbsp;&nbsp;&nbsp;No&nbsp;<input class="form-control1"  type="radio" name="through_text" <?php if($row_sql['through_text']==0){?> checked="checked" <?php }?> value="0"></td>
				    </tr>
				     <tr>
					    <td  colspan="2"  align="right" class="regi_txtfeildA">If Yes Enter Text number</td>
					    <td  align="center" >:</td>
					    <td  align="left" class="regi_txtfeildA"><input type="text" class="form-control" name="text_number" value="<?=$row_sql['text_number'] ?>" maxlength="<?=$medium?>"/></td>
				    </tr>	
				      <tr>
					    <td  colspan="2"  align="right" >&nbsp;</td>
					    <td  align="center" >&nbsp;</td>
				    ...
				    <tr>
				      ...
				      <tr>
					    <td  colspan="3"  align="left" class="regi_txtfeildA">I give my permission for puregusto to send me the following.Please tick 'Yes' or 'No' for each option.</td>
					    
				    </tr>
				      <tr>
					    <td    align="right" width="50%" class="regi_txtfeildA">Special seasonal offers/discount codes/new product Range</td>
					    <td  align="center" valign="top" >:</td>
					    <td  align="left" valign="top" class="regi_txtfeildA1">Yes&nbsp;<input class="form-control1" type="radio" name="special_seasonal_offers" <?php if($row_sql['special_seasonal_offers']==1){?> checked="checked" <?php }?>   value="1">&nbsp;&nbsp;&nbsp;&nbsp;No&nbsp;<input  class="form-control1" type="radio" name="special_seasonal_offers"  <?php if($row_sql['special_seasonal_offers']==0){?> checked="checked" <?php }?> value="0"></td>
				    </tr>
				    <?php
				    /*
				       <tr>
...
If you decide to change your preferences, you can do so at any time. Please just call our customer services team on 0800 644 6650 during office hours Monday to Friday and let us know what you want us to do. For example, you can call us to update your contact details or you can opt out from communications altogether. Alternatively, you can let us know your wishes by email: <strong><a href="mailto:sales@Puregusto.co.uk">Sales@Puregusto.co.uk</a>.</strong></p>
<p><strong>Terms and Privacy:</strong></br>
PureGusto will keep your contact details safe. We will not share them with any other person or organisation. We will only contact you by the channels you have chosen (phone, email etc.) and we will only contact you about the subjects you have chosen. You may unsubscribe at any time. For more details, please see our privacy policy and data protection to see how we use and protect your data. <br/>
For more details, please check our <a href="https://www.puregusto.co.uk/gdpr-pg50546.html" target="_blank"><strong>data protection</strong></a> to see how we use and protect your data. 
</p>
</td>
						</tr>
				   <tr>
				     <td align="center" valign="middle" class="shoppingcartcontent" colspan="4" >
						 ...
						 <div class="one_col">
							 <input id="Submit" name="Submit" class="btn btn-lg btn-primary btn-block regbt" onclick="javascript:add_newconsent(document.add_address)" value="Save" type="button">
							 </div>
						 </td>
			        </tr>	
				</table>
