...
/*############################################################################
  ...
  $HTML_treemenu = '	<div class="breadcrump">
					<nav class="breadcrumb">
						 ...
						 <span class="breadcrumb-item active">'.stripslash_normal($Captions_arr['LOGIN_HOME']['LOGIN_HOME_TREE_MENU']).'</span>					</nav>
					...
					{   
						...
						?>                                                                         	
							   <div class="shelf-containerlist">  
								...
								?>
								<div class="row">
				<?php while($row_prod = $db->fetch_array($ret_shelf_myhome))
						{ 
						...
						<div class=" col-lg-4 col-md-6 col-sm-6">
							...
							<p class="product-info"><?php echo stripslash_normal(utf8_encode($row_prod['product_shortdesc'])); ?></p>
...
<div class="container">
	...
	?>
	<div class="row">
				<?php while($row_prod = $db->fetch_array($ret_prods))
						{ ?>
						<div class=" col-lg-4 col-md-6 col-sm-6">
							<div class="product-grid">
								  <div class="product-title"><a class="product_name_a" href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" title="<?php echo stripslashes($row_prod['product_name'])?>"><?php echo stripslashes($row_prod['product_name'])?></a></div>
