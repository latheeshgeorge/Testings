<?php
	...
	class shop_Html
	{
	  ...
	  <?php
			...
			if($_REQUEST['shop_id'])
			  {
			$HTML_icons .= '<a  href="javascript:download_pdf_stream()" title="'.stripslash_normal($Captions_arr['SHOP_DETAILS']['SHOPDET_DOWNLOADPDF']).'"><img src="'.url_site_image('pdfico.gif',1).'" alt="'.stripslash_normal($Captions_arr['SHOP_DETAILS']['SHOPDET_DOWNLOADPDF']).'" border="0" /></a>';
			}
