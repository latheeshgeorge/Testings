<?php
	...
	# Description 		: This is the compare products page for the theme.
	# Coded by 		: Sny
...
?>
 <div class="comp_con_main_compare">
	<div class="compright_compare">
	<div class="hdr_div_inner"></div>
	<?php
   ...
   ?>
 <div class="compbottom_compare"></div>
   </div>   
</div>
</div>
	  <?php
