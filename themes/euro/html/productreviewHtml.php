...
/*############################################################################
	...
	class productreview_Html
	{
		...
		?>
			...
			<div class="shelf_top"><?=$Captions_arr['PRODUCT_REVIEWS']['WRITE_PRODUCT_REVIEW_TREEMENU_TITLE']?></div>
			<div class="shelf_mid">
		...
		<?php }  
			...
			<?php 
				...
				$vImage->showCodBox(1,'prodreview_Vimg','class="Img_ver_txt"'); 
			?>
			</td>
			</tr>
			<? }?>
...
function validate_prodreview(frm)
{
	...
	function Show_Productreview()
		...
		<div class="shelf_main_con" >
		<div class="shelf_top"><?=$Captions_arr['PRODUCT_REVIEWS']['READ_PRODUCT_REVIEW_TREEMENU_TITLE']?></div>
		<div class="shelf_mid"><table width="100%" border="0" cellpadding="0" cellspacing="4" class="readreivewtable">
		<?php 
	...
	$ret_prodreview = $db->query($sql_prodreview);
        ...
        <tr>
          ...
          <td width="65%" align="left" valign="top" class="readreivewname">1<?=stripslashes($row_prodreview['review_author'])?> ( <?=$row_prodreview['reviewed_on']?>)</td>
        </tr>
        <tr>
          <td align="left" valign="top" class="readreivewcontent"><?=$Captions_arr['PRODUCT_REVIEWS']['READ_PRODUCT_REVIEW_REVIEW']?></td>
          <td align="left" valign="top">2<?=stripslashes($row_prodreview['review_details'])?></td>
        </tr>
        <tr>
		  ...
		  <? } for($k=$rating+1;$k<=5;$k++){?><img src="<? url_site_image('reviewstar_off.gif',0)?>" width="9" height="10" /><? }?>
		  </td>
        </tr>
		<?php 
			}
