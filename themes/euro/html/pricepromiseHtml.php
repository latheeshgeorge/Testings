<?php
	...
	# Description 	: Page which holds the display logic for price promise
	# Coded by 		: Sny
 ...
 ?>
		   <div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a>
				...
				{
				?>
				  >><a href="<?php url_product($product_id,$prod_name,-1)?>"><?=$prod_name?></a> 
				<? 
				 }
				?>>><?=$Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_TREEMENU_TITLE']?></div>
		   <div class="shelf_main_con" >
			<div class="shelf_top"><?=$Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_TREEMENU_TITLE']?></div>
			<div class="shelf_mid">
			 ...
			 <input type="hidden" name="action_pricepurpose" value="insert_det" />
						 <table width="100%" border="0" cellpadding="0" cellspacing="3"  class="regitable">
				...
				<tr>
					...
					<td class="regifontnormal" width="50%" align="left" valign="middle">: <?=$row_prod['manufacture_id']?>
					...
					<td class="regifontnormal" width="50%" align="left" valign="middle">: <?=$row_prod['product_model']?>
					...
					<td class="regifontnormal" width="50%" align="left" valign="middle">: <?=$row_prod['promise_price']?>
					...
					<td class="regifontnormal" width="50%" align="left" valign="middle">
					...
					<td class="regifontnormal" width="50%" align="left" valign="middle">
					<input class="regiinput" type="text" name="prom_customer_price" id="prom_customer_price" value="" size="5" /> <?=$Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_PER_ITEM']?> 
					</td>	
					</tr>
					<tr>
				...
				<?php
					...
					?>
						<tr>
						<td colspan="2" align="left" valign="top" class="staticpagecontent">
		...
		function Show_Mypricepromise_requests()
		{
			...
			?>
					<div class="shelf_main_con" >
					<div class="shelf_top"> <?=stripslashes($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_DETAILS_HEADER'])?></div>
					<div class="shelf_mid">
					...
					else
					{
						...
						?>
							<tr class="edithreflink_tronmouse">
								<td align="left" valign="middle" class="ordertabletdcolorB"><?php echo $i++;?>.</td>
								<td align="center" valign="middle" class="ordertabletdcolorB"><?php echo $row_query['add_date'];?></td>
								<td align="left" valign="middle" class="ordertabletdcolorB">
								...
								<td align="center" valign="middle" class="ordertabletdcolorB"><?php echo  price_promise_status($row_query['prom_status'])?></td>
								<td align="center" valign="middle" class="ordertabletdcolorB">
								<?php
		...
		function Show_Mypricepromise_details($prom_id=0,$alert='')
		{
			...
			?>
				...
				<tr>
					...
					?>
						<tr>
						<td align="left" class="ordertabletdcolorB">
					...
					?>
						<tr>
							<td align="right" class="ordertabletdcolorB">
