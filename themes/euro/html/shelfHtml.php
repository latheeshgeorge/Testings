							...
							if($shelfData['shelf_currentstyle']=='nor') // case of normal design layout
							{
								switch($shelfData['shelf_displaytype'])
								{
									...
									?>
										...
										{
										?>
											<div class="shelf_top" align="left"><?php echo $cur_title?></div>
										<?
										}
										?>
											<div class="shelf_mid">
										...
										{
										?>
											<div class="shelfdesc"><?php echo stripslashes($desc)?></div>
										<?php		
										}
									...
									?>
										...
										{
										?>
											<div class="shelfA_top" align="left"><?php echo $cur_title?></div>
										<?php
										}
										?>
