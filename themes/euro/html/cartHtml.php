<?php
	...
	class cart_Html
	{
		...
		?>	
			<div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?php echo $Captions_arr['CART']['CART_MAINHEADING']?></div>
			...
			<?php
				...
				?>
			  <tr>
				<td colspan="5" align="left" valign="middle" style="padding-top: 5px">
				<?php
			  ...
			  ?>
				...
				?>
				  ...
				  <input name="continue_submit" type="button" class="cart_continue" id="continue_submit" value="<?php echo $Captions_arr['CART']['CART_CONT_SHOP']?>" onclick="show_wait_button(this,'Please Wait...');window.location='<?php echo $ps_url?>'" />
				<?php
					}
					else
					{?>
			<input name="continue_submit" type="button" class="cart_continue" id="continue_submit" value="<?php echo $Captions_arr['CART']['CART_CONT_SHOP']?>" onclick="show_wait_button(this,'Please Wait...');window.location='http://<?php echo $ecom_hostname;?>'"/>
                            <?php
					}
				?>  
				  </div>
		  ...
		  else
		  {
			  ...
			  ?>
				  <tr>
					...
					?>
					<a href="<?php echo url_product($products_arr['product_id'],$products_arr['product_name'])?>" title="<?php echo $products_arr['product_name']?>" class="shoppingcartprod_link"><?php echo $products_arr['product_name']?></a>					</td>
		  ...
		  <?php
			...
			?>
				<tr>
					...
					<div class="logintobonus_div" align="right">
          ...
          <tr>
            <td colspan="6" align="right" valign="middle" class="shoppingcartcontent">
			  ...
			  ?>	
             		 ...
             		 <input name="continue_checkout" type="button" class="cart_checkout" id="continue_checkout" value="<?php echo $Captions_arr['CART']['CART_GO_CHKOUT']?>" onclick="handle_checkout_submit('<?php echo $ecom_hostname?>',0,'<?php echo $cartData["totals"]["bonus_price"]?>')" />
             		</div> 
			  <?php
			  	}
				else
		...
		?>	
			<div class="treemenu"><a href="http://<?php echo $ecom_hostname?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?php echo $Captions_arr['CART']['CART_CHECKOUTHEADING']?></div>
			<div class="cart_outer">
			<div class="cart_top"></div>
			<div class="cart_mid">		
...
//				$cont_class = 'shoppingcartcontent_noborder'; 
		...
		function Show_OrderPreview($return_order_arr)
		{
			...
			if($row_ord['order_paymentmethod']!='') // If payment method exits
			{
				...
				$auto_submit	= false;
		?>	
			<div class="treemenu"><a href="http://<?php echo $ecom_hostname?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?php echo $Captions_arr['CART']['CART_CHECKOUTPREVIEWHEADING']?></div>
			<div class="cart_outer">
			<div class="cart_top"></div>
			<div class="cart_mid">	
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="shoppingcarttable">
		...
		?>
			<div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?php echo $Captions_arr['CART']['CART_CHECKOUT_SUCCESS_TITLE']?></div>
			<div class="cart_outer">
			<div class="cart_top"></div>
			<div class="cart_mid">	
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="shoppingcarttable">
		...
		function Show_CheckoutFailed()
		{
			...
			$Captions_arr['CART'] 	= getCaptions('CART'); // Getting the captions to be used in this page
		?>
			<div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?php echo $Captions_arr['CART']['CART_CHECKOUT_FAILED_TITLE']?></div>
			<div class="cart_outer">
			<div class="cart_top"></div>
			<div class="cart_mid">	
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="shoppingcarttable">
