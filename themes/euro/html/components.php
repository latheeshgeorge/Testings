<?php
	...
	class components
	{
		...
		{
			global $position,$ecom_siteid,$db,$ecom_hostname,$Settings_arr,$Captions_arr,$ecom_themename;
			...
			switch($position)
			{
				...
				<?php
						...
						?>			
								...
								<?php 
								$position = 'top_special';
								global $components;
								include "themes/$ecom_themename/modules/mod_customerlogin.php"; 
								$position = 'top';
								?>
							</div>
						<?php
		...
		?>
				...
				<?php /*><div class="sh_cart_hdr">Shopping <span>Cart</span></div>*/?>
				<div class="sh_cart_hdr"><span><?php echo $title?></span></div>
		...
		function mod_customerlogin($title)
		{
			...
			if($position=='top_special')
			{
				if (!$cust_id) // case customer is not logged in
				{
				?>
					<div class="topmenulogin"><a href="<?php url_link('custlogin.html')?>"><img src="<?php url_site_image('meberslogin.gif')?>" border="0"/></a></div>
				<?php
				}
			}
			/*$cust_id 					= get_session_var("ecom_login_customer");
			...
			?>
				...
				<div class="login_banner">
					 ...
					 <a href="<?php url_link('registration.html')?>" title="<?php echo stripslash_normal($Captions_arr['CUST_LOGIN']['NEW_USER'])?>"><img src="<?php url_site_image('signup-btn.gif')?>" border="0" /></a>
					  </div>
		...
		?>
			 ...
			 <div class="left_con">
				<div class="left_top_callback"></div>
							<div class="left_mid_callback">		<a href="<?php url_link('callback.html')?>"><img src="<?php url_site_image('callback.gif')?>" border="0" alt="" /></a>
							</div>
						  <div class="left_bottom"><img class="imggfil" src="<?php url_site_image('protex.png')?>" alt="" border="0"></div>
				</div>
		<?php		
		}
		// ####################################################################################################
		...
		function mod_newsletter($title)
		{
			...
			if($Settings_arr['shownewsletter_as_banner']==1) // Decide whether customer login is to be displayed as banner or in normal style
			{
				?>
			<div class="left_con">
				<div class="left_top_newsltr"></div>
					<div class="left_mid_newsltr">
		   ...
		   ?>
			<div class="left_con">
			  <div class="left_top_gift"></div>
				<div class="left_mid_gift"><a href="<?php echo get_buyGiftVoucherURL()?>" class="buygiftvoucherheader" title="<?php echo $Captions_arr['GIFT_VOUCHER']['BUY_VOUCHER']?>"><img src=" <?php url_site_image('buy-gift.gif') ?>"  border="0"/></a></div>
			...
			<div class="left_con">
			 <div class="left_top_gift"></div>
			   <div class="left_mid_gift"> 
			 		 <a href="http://<?php echo $ecom_hostname?>/spend_voucher.html" class="buygiftvoucherheader" title="<?php echo $Captions_arr['GIFT_VOUCHER']['SPEND_VOUCHER_CLICK_HERE']?>"><img src="<?php url_site_image('use-gift.gif')?>"  border="0"/></a></div>
			   <div class="left_bottom"><img class="imggfil" src="<?php url_site_image('protex.png')?>"  border="0" alt="" /></div>
			</div> 
			  <?
			  }
						...
						$ret_shop = $db->query($sql_shop);
							if ($db->num_rows($ret_shop))
							{
								  if ($position == 'left') // ############## Left ##############
								  {
									...
									?>
									<div class="left_con">
									<div class="left_top_shpbrnd"></div>
									<div class="left_mid_shpbrnd">		<a href="<?php url_link('shopbybrand.html')?>"><img src="<?php url_site_image('shop-brnd-banner.gif')?>" border="0" title="Click Here" /></a>
									<?php
											if($groupData['shopbrandgroup_display_rotator']==1)
											{
												while ($row_shop = $db->fetch_array($ret_shop))
				  ...
				  <?php
						switch ($k['advert_type'])
						{
							case 'IMG':
								...
								$link = $k['advert_link'];
								echo '<div class="left_mid_protex">';
								if ($link!='')
								{
						?>
						...
						<?php		
							...
							case 'TXT':
								$path = $k['advert_source'];
								echo '<div class="left_mid_txt_ad">';
