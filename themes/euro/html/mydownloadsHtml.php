...
?>
		...
		<div class="shelf_top"><?=$Captions_arr['MY_DOWNLOADS']['DOWN_HEADER']?></div>
		<div class="shelf_mid">
		...
		<td colspan="3">
			...
			?>
			<tr>
			<td  colspan="8" align="center" valign="middle" class="pagingcontainertd">
			<?php
...
<div class="shelf_bottom"></div>	
		...
		?>
			<div class="shelf_main_con" >
		<div class="shelf_top"><?php		echo $mesgHeader;			?></div>
		<div class="shelf_mid">
