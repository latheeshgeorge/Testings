	...
	class featured_Html
	{
		...
		?>
			...
			if ($row_featured['featured_showshortdescription']==1)// Check whether description is to be displayed
			{
				...
				{
			?>		
				<li class="shlf_pdt_des">
				 <div class="fet_pdt_des"> 
  				<div class="fet_pdt_des_top"> <h6>	<?php echo stripslashes($desc)?></h6>
				</div>
				<div class="fet_pdt_des_bottom"></div>    
				</div>				
				</li>
			<?php
				}
