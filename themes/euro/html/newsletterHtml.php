...
/*############################################################################
	...
	class newsletter_Html
	{
		...
		<div class="shelf_main_con" >
			<div class="shelf_top"><?=stripslash_normal($Captions_arr['NEWS_LETTER']['NEWSLETTER_TREEMENU_TITLE'])?></div>
			<div class="shelf_mid">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="8"  class="regitable">
			...
			<tr>
				...
				<td align="left" valign="top" >
				<input name="newsletter_name" type="text" class="regiinput" id="newsletter_name" size="25" value="<?=$_REQUEST['newsletter_name']?>" />				</td>
			</tr>	
			<?php
			}
			?>		 
			<tr>
				...
				<td align="left" valign="top" >
				<input name="newsletter_email" type="text" class="regiinput" id="newsletter_email" size="25"  value="<?=$_REQUEST['newsletter_email']?>"/>				</td>
			</tr>
			<?php
			...
			<tr>
				...
				<td align="left" valign="top" >
				<input name="newsletter_phone" type="text" class="regiinput" id="newsletter_phone" size="25" value="<?=$_REQUEST['newsletter_phone']?>"/>				</td>
			</tr>
			<?php
			}
