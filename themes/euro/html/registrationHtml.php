...
function mailinglist_mainsel()
{
	...
	<div class="shelf_main_con" >
		<div class="shelf_top"><?=$Captions_arr['CUST_REG']['REGISTRATION_TREEMENU_TITLE']?></div>
		<div class="shelf_mid">
		...
		<tr>
			...
			$vImage->showCodBox(1,'registration_Vimg','class="Img_ver_txt"'); 
			?></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
	...
	<div class="shelf_bottom"></div>	
		...
		?>
		<div class="shelf_main_con">
		<div class="shelf_top"><?php echo $Captions_arr['CART']['CART_LOGIN']?></div>
		<div class="shelf_mid">
		<?php if($help_mstop!='')
			{
			?>
		<div class="login_inner_alert"> <?php echo $help_mstop;?> </div>
		<? }?>
		<form name="frm_custlogin" id="frm_custlogin" method="post" action="" onsubmit="return validate_login(this)" class="frm_cls">
		  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="login_inner_table">
		    ...
		    <tr>
		      <td class="login_inner_cnt"><div>
		        <input name="custlogin_uname" id="custlogin_uname" type="text" class="login_inner_input" size="40" />
		        </div>
		        <div>
		         <input name="custlogin_pass" id="custlogin_pass" type="password" class="login_inner_inputA" size="40" />
		          </div>
		        <div> <a href="javascript:document.frm_custlogin.submit()"><img src="<? url_site_image('loin-inbt.gif')?>"  border="0" /></a></div>
                 <div class="forgotpass"><a href="<?php url_link('forgotpassword.html')?>" class="lgn_txt_link"><?php echo stripslash_normal($Captions_arr['CUST_LOGIN']['FORGOT_PASS'])?></a></div>
                
                </td>
		      <td class="login_inner_right"><div><?php echo $Captions_arr['CUST_LOGIN']['NEW_CUST_TOP_MSG']?><br />
			   <?php
		        ...
		        <div> <a href="<?php url_link('registration.html')?>"><img src="<? url_site_image('login-btb.gif')?>"  border="0" /></a></div></td>
		      </tr>
