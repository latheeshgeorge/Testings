		...
		?>
			...
			if($shopid==0)
		        ...
		        $fetch_arr_admin 	= $db->fetch_array($res_admin);
					...
					{
						?>
						<div  class="staticpagecontent"><?php echo $fetch_arr_admin['general_shopsall_topcontent']?>
						</div>		
						<?php
					}
				}
				...
				<?php
					...
					{
						?>
						<div  class="staticpagecontent"><?php echo $fetch_arr_admin['general_shopsall_bottomcontent']?>
						</div>		
						<?php
					}
					?>
						...
						switch($shop_det['shopbrand_product_displaytype'])
						{
							...
							?>
								...
								?>
										...
										<?php
											if($shop_det['shopbrand_product_showtitle']==1)
											{
										?>
										...
										<?php
										  ...
										  <div class="shlfA_pdt_txt">
												...
												<?php
													...
													{
												?>	
													<li class='shlfA_pdt_bonus'><?php show_bonus_points_msg($row_prod,'bonus_point'); // Show bonus points?></li>
													<?php 
													}
													if($row_prod['product_saleicon_show']==1)
														{
