<?php
	...
	class wishlist_Html
	{
	  function wishlist_Showform()
	  {
		...
		?>
		<div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?php echo $Captions_arr['WISHLIST']['WISHLIST_MAINHEADING']?></div>
			<div class="shelf_main_con" >
		<div class="shelf_top"><?=$Captions_arr['MY_FAVORITES']['FAVORITES_CATEGORY_HEADING']?></div>
		<div class="shelf_mid">
		  ...
		  <?php
			  ...
			  <?php
				...
				?>
				<tr>
						<td align="center" valign="middle" class="shoppingcartcontent1" colspan="3">
