<?php
	...
	class components
	{
			...
			switch($position)
			{
				...
				if ($cache_exists==false)
				{
					...
					<?php
						...
						?>
									<li><h2> <a href="<?php url_link('')?>" class="static" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_HOME']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_HOME']?></a> </h2></li>
						<?php
							}
								...
								?>
										<li><h2> <a href="<?php if ($row_pg['page_type']=='Page') url_static_page($row_pg['page_id'],$row_pg['title']); else echo $row_pg['page_link'];?>" class="static" title="<?php echo stripslashes($row_pg['title'])?>" <?php echo $target?>><?php echo stripslashes($row_pg['title']);?></a></h2></li>
								<?php
								}
								if ($grpData['group_showsavedsearchlink']==1)
								{
					?>							
										<li><h2> <a href="<?php url_link('saved-search.html')?>" class="static" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH']?></a></h2></li>
					<?php		
								}
								if ($grpData['group_showsitemaplink']==1 )
								{
					?>							
										<li><h2> <a href="<?php url_link('sitemap.html')?>" class="static" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_SITEMAP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_SITEMAP']?></a></h2></li>
					<?php		
								}
								if ($grpData['group_showxmlsitemaplink']==1 )
								{
								?>
									<li><h2> <a href="<?php url_link('sitemap.xml')?>" class="static" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP']?></a></h2></li>
								<?php	
								}
								if ($grpData['group_showfaqlink']==1 )
								{
				?>		
									<li><h2> <a href="<?php url_link('faq.html')?>" class="static" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_FAQ']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_FAQ']?></a></h2></li>
				<?php
								}
								if ($grpData['group_showhelplink']==1 )
								{
				?>		
									<li><h2> <a href="<?php url_link('help.html')?>" class="static" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_HELP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_HELP']?></a></h2></li>
				<?php
								}
					...
					if ($position == 'bottom') // Case if value of position is bottom;
					{
						...
						<?php
							...
							foreach ($grp_array as $k=>$grpData)
							{
								...
								if($show_top==0)
								{
									...
									{
						?>
										<a href="<?php url_link('')?>" class="sta_bt_lnk" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_HOME']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_HOME']?></a>
						<?php			
									}
								}	
								...
								while ($row_pg = $db->fetch_array($ret_pg))
								{
									$target = ($row_pg['page_link_newwindow']==1 and $row_pg['page_type']!='Page')?'target="_blank"':'';
								?>
										<a href="<?php if ($row_pg['page_type']=='Page') url_static_page($row_pg['page_id'],$row_pg['title']); else echo $row_pg['page_link'];?>" class="sta_bt_lnk" title="<?php echo stripslashes($row_pg['title'])?>" <?php echo $target?>><?php echo stripslashes($row_pg['title']);?></a>
								<?php
								}
							}
						?>
						<?php			
									...
									{
						?>
										<a href="<?php url_link('sitemap.html')?>" class="sta_bt_lnk" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_SITEMAP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_SITEMAP']?></a>
						<?php			
									}
									if ($grpData['group_showxmlsitemaplink']==1 )
									{			
									?>
										<a href="<?php url_link('sitemap.xml')?>" class="sta_bt_lnk" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP']?></a>
									<?php									
									}
									if ($grpData['group_showfaqlink']==1)
									{
						?>
										<a href="<?php url_link('faq.html')?>" class="sta_bt_lnk" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_FAQ']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_FAQ']?></a>
						<?php			
									}
									if ($grpData['group_showhelplink']==1)
									{
						?>
										<a href="<?php url_link('help.html')?>" class="sta_bt_lnk" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_HELP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_HELP']?></a>
						<?php			
									}
									if ($grpData['group_showsavedsearchlink']==1)
									{
						?>
										<a href="<?php url_link('saved-search.html')?>" class="sta_bt_lnk" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH']?></a>
						<?php			
									}
						?>			
							</div>
					...
					elseif ($position=='left') // ############## Left ##############
					{
						...
						if(count($grp_array))
						{
							...
							foreach ($grp_array as $k=>$grpData)
							{
								...
								$cnt	= $db->num_rows($ret_pg);
								?>
								<div class="left_con_stat">
								<div class="left_top_stat"></div>
								<div class="left_mid_stat">
										<ul class="static">
								<?php
							        if($prev_grp != $grpData['group_id'])
										{
											...
											{
									?>
												 <li class="staticheader"><?php echo stripslashes($title)?></li>
									<?php
											}
										...
										{
									?>
												<li><h2><a href="<?php url_link('')?>" class="staticlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_HOME']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_HOME']?></a></h2></li>
									<?php		
										}
								while ($row_pg = $db->fetch_array($ret_pg))
								{
									$target = ($row_pg['page_link_newwindow']==1 and $row_pg['page_type']!='Page')?'target="_blank"':'';
								?>
									<li><h2><a href="<?php if ($row_pg['page_type']=='Page') url_static_page($row_pg['page_id'],$row_pg['title']); else echo $row_pg['page_link'];?>" class="catelink" title="<?php echo stripslashes($row_pg['title'])?>" <?php echo $target?>><?php echo stripslashes($row_pg['title']);?></a></h2></li>
								<?php
								}
								if ($grpData['group_showsitemaplink']==1)
								{
							?>
									<li><h2><a href="<?php url_link('sitemap.html')?>" class="staticlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_SITEMAP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_SITEMAP']?></a></h2></li>
							<?php		
								}
								if ($grpData['group_showxmlsitemaplink']==1 )
								{	
							?>
									<li><h2><a href="<?php url_link('sitemap.xml')?>" class="staticlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP']?></a></h2></li>
							<?php		
								}
								if ($grpData['group_showhelplink']==1)
								{
							?>
									<li><h2><a href="<?php url_link('help.html')?>" class="staticlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_HELP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_HELP']?></a></h2></li>
							<?php		
								}
								if ($grpData['group_showsavedsearchlink']==1)
								{
						?>
									<li><h2><a href="<?php url_link('saved-search.html')?>" class="staticlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH']?></a></h2></li>
						<?php			
								}
							}
						}
						?>
							...
							<div class="left_bottom"><img class="imggfil" src="<?php url_site_image('cat.png')?>"  border="0" alt="" /></div>
							</div>
					<?php
					}// End of left
					elseif($position == 'middle')
					{
						...
						if(count($grp_array))
						{
							...
							foreach ($grp_array as $k=>$grpData)
							{
								...
								<div class="sta_rt_top">Useful Links</div>
							        ...
							        if($prev_grp != $grpData['group_id'])
										{
											...
											{
									?>
												 <li class="sta_rt_top"><?php echo stripslashes($title)?></li>
									<?php
											}
											$prev_grp = $grpData['group_id'];
										}
							...
							if(count($grp_array))
							{
								...
								$sql_cat = "SELECT a.category_id,a.category_name,parent_id,b.category_displaytype,b.category_islink,a.category_subcatlisttype   
									...
									if ($db->num_rows($ret_cat))
									{
										...
										?>
											<div class="left_con">
											<div class="left_top_cat"></div>
											<div class="left_mid_cat">
													<ul class="category">
										<?php
											...
											{
											?>
												<li><h2><span class="subcategory_group"><a href="<?php url_category($row_cat['category_id'],$row_cat['category_name'],-1)?>" class="subcategory_group_link" title="<?php echo stripslashes($row_cat['category_name'])?>"><?php echo stripslashes($row_cat['category_name']);?></a></span></h2></li>
											<?
											}
											elseif($row_cat['category_displaytype']=='Heading' && !$row_cat['category_islink'])
											{
											?>
												 <li><h2><span class="subcategory_group"><?php echo stripslashes($row_cat['category_name']);?></span></h2></li>
											<?
											}
												...
												if ($row_cat['category_subcatlisttype']=='List' or $row_cat['category_subcatlisttype']=='Both')
												{
													...
													{	
														...
														<?php	
															...
															{
														?>
																	<li><h2><a href="<?php url_category($row_child['category_id'],$row_child['category_name'],-1)?>" title="<?php echo stripslashes($row_child['category_name'])?>" class="subcatelink"><?php echo stripslashes($row_child['category_name']);?></a></h2></li>
														<?php		
															}
														?>
															</ul>
		...
		function mod_quicksearch()
		{
			...
			if ($position=='left') // show only if position value is top
			{
				$items = get_session_var('cart_total_items');
				$cart_tot = print_price(get_session_var('cart_total'),true);
				$pass_tot = print_price(get_session_var('cart_total'),true,true);
		?>
				<div class="left_con">
				<div class="left_top_cart"></div>
				<div class="left_mid_cart">
				
				<div class="sh_cart_hdr">Shopping <span>Cart</span></div>
				<div class="cart_items"><?php echo $Captions_arr['COMMON']['ITEMS_IN_CART']?><?php echo ($items>0)?$items:0?></div>
				<div class="cart_items"><?php echo $Captions_arr['COMMON']['CART_TOTAL']?> <?php echo $cart_tot?></div>
				<div class="cart_link"><a href="#" onclick="gobackto_cart('<?php echo ($protectedUrl)?base64_encode($ecom_hostname):$ecom_hostname?>')" class="viewcart" title="<?php echo $Captions_arr['COMMON']['VIEW_CART']?>"><?php echo $Captions_arr['COMMON']['VIEW_CART']?></a> <?php /*?><a href="#" onclick="handle_checkout_submit('<?php echo $ecom_hostname?>',0)" title="<?php echo $Captions_arr['COMMON']['CHECK_OUT']?>" class="check_out" ><?php echo $Captions_arr['COMMON']['CHECK_OUT']?></a><?php */?>
				<a href="<?php url_link('enquiry.html')?>" class="viewcart" title="<?php echo $Captions_arr['COMMON']['VIEW_ENQUIRY']?>"><?php echo $Captions_arr['COMMON']['VIEW_ENQUIRY']?></a></div>
				</div>
				<div class="left_bottom"><img class="imggfil" src="<?php url_site_image('cart.png')?>"  border="0" alt="" /></div>
				</div>
				<?php /*?><tr>
					...
					<form method="post" name="frm_quicksearch" class="frm_cls" action="<?php url_link('search.html')?>">
					  <table border="0" cellspacing="0" cellpadding="0">
						<tr>
						  <td class="searchfont_top"><?php echo $Captions_arr['COMMON']['SEARCH']?></td>
		...
		?>
				...
				<div class="left_con">
				<div class="left_top_login"></div>
				<div class="left_mid_login">
		<?php   
		
				if ($title)
				{
		?>
					<div class="login_header"><?php echo $title?></div>
		<?php
				}
		?>		
				<div class="login_txt">Optional - not required to view our site</div>
				<div class="login_txtA"><?php echo $Captions_arr['CUST_LOGIN']['EMAIL']?></div>
					<div class="login_txtA"><input name="custlogin_uname" type="text" class="login_txt_bx" id="custlogin_uname" size="15" /></div>
				<div class="login_txtA"><?php echo $Captions_arr['CUST_LOGIN']['PASSWORD']?></div>
					<div class="login_txtA"><input name="custlogin_pass" type="password" class="login_txt_bx" id="custlogin_pass" size="15" /></div>
				<div  class="login_txtC" align="right"><input name="custologin_Submit" type="submit" class="login_txt_btn" id="custologin_Submit" value="<?php echo $Captions_arr['CUST_LOGIN']['LOGIN']?>" />
					</div>
					<div class="login_txtB">
					<?php
						if($hide_newuser==0) // check whether new user link is disabled from main shop settings
						{
					?>
							<a href="<?php url_link('registration.html')?>" title="<?php echo $Captions_arr['CUST_LOGIN']['NEW_USER']?>"><?php echo $Captions_arr['CUST_LOGIN']['NEW_USER']?></a>
					<?php
						}
						if($hide_forgotpass==0) // check whether the forgot password link is disabled from main shop settings
						{
					?>
							<a href="<?php url_link('forgotpassword.html')?>" title="<?php echo $Captions_arr['CUST_LOGIN']['FORGOT_PASS']?>"><?php echo $Captions_arr['CUST_LOGIN']['FORGOT_PASS']?></a>
					<?php
						}
					?>		
					</div>
				</div>
				<div class="left_bottom"><img class="imggfil" src="<?php url_site_image('login.png')?>"  alt="" />
				</div>
				</div>
		...
		<?php	
			...
			<div class="left_mid_cat">
					<ul class="category">
					<li><h2><a href="<?php url_link('login_home.html')?>" class="catelink"><?=$Captions_arr['LOGIN_MENU']['MY_HOME']?></a></h2></li>
					<li><h2><a href="<?php url_link('myprofile.html')?>" class="catelink"><?=$Captions_arr['LOGIN_MENU']['MY_PROFILE']?></a></h2></li>
					<li><h2><a href="<?php url_link('myenquiries.html')?>" class="catelink"><?=$Captions_arr['LOGIN_MENU']['MY_ENQUIRIES']?></a></h2></li>
					<li><h2><a href="<?php url_link('wishlist.html')?>" class="catelink"><?=$Captions_arr['LOGIN_MENU']['MY_WISHLIST']?></a></h2></li>
				<?php	
					$myfav_module = 'mod_myfavorites';
					if(in_array($myfav_module,$inlineSiteComponents)){
				?>
					<li><h2><a href="<?php url_link('myfavorites.html')?>" class="catelink"><?=$Captions_arr['LOGIN_MENU']['MY_FAVOURITE']?></a></h2></li>
				<? }	
					$myaddr_module = 'mod_myaddressbook';
					if(in_array($myaddr_module,$inlineSiteComponents)){
				?>
					<li><h2><a href="<?php url_link('myaddressbook.html')?>" class="catelink"><?=$Captions_arr['LOGIN_MENU']['MY_ADDRESSBOOK']?></a></h2></li>
				<? }?>
					<li><h2><a href="<?php url_link('myorders.html')?>" class="catelink"><?=$Captions_arr['LOGIN_MENU']['MY_ORDERS']?></a></h2></li>
				<?php
					...
					{
				?>	
						<li><h2><a href="<?php url_link('mydownloads.html')?>" class="catelink"><?=$Captions_arr['LOGIN_MENU']['MY_DOWNLOADS']?></a></h2></li>
				<?php
					}
				...
				?>	
						<li><h2><a href="<?php url_link('mypayonaccountpayment.html')?>" class="catelink"><?=$Captions_arr['LOGIN_MENU']['MY_PAYONACCDETAILS']?></a></h2></li>
				<?php
					}
				?>	
					<li><h2><a href="<?php url_link('logout.html')?>" class="catelink"><?=$Captions_arr['LOGIN_MENU']['LOGOUT']?></a></h2></li>
				</ul>
				</div>
				<div class="left_bottom_cat"><img class="imggfil" src="<?php url_site_image('cat.png')?>"  border="0" alt="" /></div>
				</div> 
			<?	
			*/}	
		}
		...
		{
		?>
			<div class="left_con_callback">
	         <div class="callback"><a href="<?php url_link('callback.html')?>"><img src="<?php url_site_image('callback.gif')?>" border="0" alt="" /></a></div>
    	     </div>
		<?php		
		}
		// ####################################################################################################
		...
		function mod_bestsellers($ret_main,$title,$display_id)
		{
			...
			if ($position=='left') // Best sellers is allowed in left or right panels
			{	
				if ($db->num_rows($ret_main))
				{
						...
						{
				?>
							<div class="left_con_best">
							<div class="left_top_comp_best"></div>
							<div class="left_mid_comp_best"><div class="component_left"><a href="<? url_link('bestsellers'.$display_id.'.html')?>" title="<?php echo $title?>"><?php echo $title?></a></div>
							</div>
							<div class="left_bottom"><img class="imggfil" src="<?php url_site_image('comp.png')?>"  border="0" alt="" /></div>
							</div>
				<?php	
						}
				}	
		...
		function mod_compare_products($ret_compare_pdts,$title='Compare PrOducts')
		{
			...
			{	
				...
				?>
				<div class="left_con_comp">
				<div class="left_top_comp"></div>
				<div class="left_mid_comp">
				<ul class="compare">
				<?php
				...
				<?php
							...
							{
				?>	
								<li><h2><span class="comp_delete_img"><img src="<?php url_site_image('delete.gif')?>" onclick="document.common_compare_list.remove_compareid.value=<?=$row_compare_pdts['product_id']?>; if(confirm('Are You sure You want to remove the product from the compare list')){ document.common_compare_list.submit()};" alt="Remove" title="Remove" /></span><span class="comp_prod_main_link"><a href="<?php url_product($row_compare_pdts['product_id'],$row_compare_pdts['product_name'],-1)?>" class="comparelink" title="<?php echo stripslashes($row_compare_pdts['product_name'])?>"><?php echo stripslashes($row_compare_pdts['product_name'])?></a></span></h2></li>
				...
				<?php
							...
							{	
				?>
								<li><h2><span class="comp_prod_links"><a href="<?php url_link('compare_products.html')?>" class="compare_link" title="<?php echo $Captions_arr['COMMON']['COMPARE_PRODUCTS']?>" target="_blank"><?php echo $Captions_arr['COMMON']['COMPARE_PRODUCTS']?></a></span> </h2> </li>
				<? 			
							}
				?>				
						</ul>
		...
		function mod_combo($comb_arr,$title)
		{
			...
			if ($position=='left')// Combo deal is allowed only in left or right panel
			{
						...
						if ($proceed)
						{
							...
							if ($cache_exists==false)
							{
								...
								if ($db->num_rows($ret_prod))
								{
									...
									{
						?>
										<div class="left_con_combo">
										<div class="left_top_combo"></div>
										<div class="left_mid_combo"><div class="component_left_combo"><a href="<?php url_combo($combData['combo_id'],$combData['combo_name'],-1)?>" title="<?php echo $title?>"><?php echo $title?></a></div>
										</div>
										<div class="left_bottom"><img class="imggfil" src="<?php url_site_image('comp.png')?>"  border="0" alt="" /></div>
										</div> 
						<?php
					...
					if ($proceed)
					{
						...
						if ($db->num_rows($ret_prod))
						{
							if($shelfData['shelf_currentstyle']=='nor') // case of normal design layout
							{
								...
								?>
										<div class="left_con_norshelf">
										<div class="left_top_norshelf"></div>
										<div class="left_mid_norshelf"><div class="component_left_norshelf"><a href="<?php  url_shelf_all($shelfData['shelf_id'],$shelfData['shelf_name'],-1)?>" title="<?php echo $title?>"><?php echo $title?></a></div>
										</div>
										<div class="left_bottom"><img class="imggfil" src="<?php url_site_image('comp.png')?>"  border="0" alt="" /></div>
										</div>
								<?php	
							...
							elseif($shelfData['shelf_currentstyle']=='christ') // case of christmas layout
							{
								...
								case '3row':
									?>
										<div class="left_con_christshelf">
										<div class="left_top__christshelf"></div>
										<div class="left_mid_christshelf"><div class="component_left_christshelf"><a href="<?php  url_shelf_all($shelfData['shelf_id'],$shelfData['shelf_name'],-1)?>" title="<?php echo $title?>"><?php echo $title?></a></div>
										</div>
										<div class="left_bottom"><img class="imggfil" src="<?php url_site_image('comp.png')?>"  border="0" alt="" /></div>
										</div>
								<?php		
							...
							elseif($shelfData['shelf_currentstyle']=='new') // case of new year layout
							{
								switch($shelfData['shelf_displaytype'])
								{
									...
									case '3row':
									?>
											<div class="left_con_newshelf">
											<div class="left_top_newshelf"></div>
											<div class="left_mid_newshelf"><div class="component_left_newshelf"><a href="<?php  url_shelf_all($shelfData['shelf_id'],$shelfData['shelf_name'],-1)?>" title="<?php echo $title?>"><?php echo $title?></a></div>
											</div>
											<div class="left_bottom"><img class="imggfil" src="<?php url_site_image('comp.png')?>"  border="0" alt="" /></div>
											</div>
									<?php	
		...
		?>
			...
			<div class="left_con">
			<div class="left_top_news"></div>
			<div class="left_mid_news">
			<?php
			if ($title)
			{
			?>		
				<div class="news_header"><?php echo $title?></div>
			<?php
			}
			if($Settings_arr['newsletter_title_req']==1)
			{
			?>	
			<div class="news_txt"><?php echo $Captions_arr['NEWS_LETTER']['TITLE']?></div>
			<div class="news_txt">
				<select name="newsletter_title" class="news_txt_bx" id="newsletter_title" >
			...
			{
			?>
			<div class="news_txt"><?php echo $Captions_arr['NEWS_LETTER']['NAME']?></div>
			<div class="news_txt"><input name="newsletter_name" type="text" class="news_txt_bx" id="newsletter_name" size="15" /></div>
			<?php
			}
			?>		 
			<div class="news_txt"><?php echo $Captions_arr['NEWS_LETTER']['EMAIL']?></div>
			<div class="news_txt"><input name="newsletter_email" type="text" class="news_txt_bx" id="newsletter_email" size="15" /></div>
			<?php
			if($Settings_arr['newsletter_phone_req']==1)
			{
			?>
			<div class="news_txt"><?php echo $Captions_arr['NEWS_LETTER']['PHONE']?></div>
			<div class="news_txt"><input name="newsletter_phone" type="text" class="news_txt_bx" id="newsletter_phone" size="15" /></div>
			<?php
			}
			...
			?>
					<div class="news_txt"><?php echo $Captions_arr['NEWS_LETTER']['GROUP']?></div>
					<div class="news_txt">
					<?php
			...
			{
			?>
				<div class="news_txt"><?=$Captions_arr['NEWS_LETTER']['ENTER_CODE']?>&nbsp;<span class="redtext">*</span></div>
				<div class="news_txt"><img src="<?php url_verification_image('includes/vimg.php?size=4&amp;pass_vname=newsletter_Vimg')?>" border="0" alt="Image Verification"/></div>
				<div class="news_txt">
			      <?php 
					// showing the textbox to enter the image verification code
					$vImage->showCodBox(1,'newsletter_Vimg','class="Img_ver_txt"'); 
					?>	
				</div>
		  <?php
			}
			?>
			<div class="news_txtA" align="right"><input name="newsletter_Submit" type="submit" class="buttongray" id="newsletter_Submit" value="<?php echo $Captions_arr['NEWS_LETTER']['SUBSCRIBE']?>" /></div>
			</div>
        	<div class="left_bottom"><img class="imggfil" src="<?php url_site_image('news.png')?>"  border="0" alt="" /></div>
	       	</div>
			</form>
		<?php
		}
		...
		?>
			...
			<div class="left_con">
        <div class="left_top_gift"></div>
        <div class="left_mid_gift">
			<div class="gift_hdr"><?php echo $title?></div>
			<div class="gift_txt"><?php echo $Captions_arr['GIFT_VOUCHER']['ENTER_VOUCHER']?></div>
			<div class="gift_txt"><div>
				<input name="cart_promotionalcode" type="text" class="gift_txt_bx" id="cart_promotionalcode_comp" size="15" />
				</div>
				<?php 
				...
				?>
				<div>
				<input name="compvoucher_Submit" type="submit" class="gift_btn" id="compvoucher_Submit" value="<?php echo $Captions_arr['GIFT_VOUCHER']['VOUCHER_GO']?>" />
				</div>
				<?php
				}
				?>
			...
			?>
			 ...
			 <div class="gift_txt"><?=$Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_VOUCHER_VERIFICATION_CODE']?>&nbsp;<span class="redtext">*</span></div>
			  <div class="gift_txt"><div><img src="<?php url_verification_image('includes/vimg.php?size=4&amp;pass_vname=buycompgiftvoucher_Vimg')?>" border="0" alt="Image Verification"/></div></div>
			   <div class="gift_txt"><div>
			      <?php 
					// showing the textbox to enter the image verification code
					$vImage->showCodBox(1,'buycompgiftvoucher_Vimg','class="Img_ver_txt"'); 
				?>
				</div>
				<div>
					<input name="compvoucher_Submit" type="submit" class="gift_btn" id="compvoucher_Submit" value="<?php echo $Captions_arr['GIFT_VOUCHER']['VOUCHER_GO']?>" />
		  ...
		  <?php
			...
			?>
			<div class="gift_txt"><a href="<?php echo get_buyGiftVoucherURL()?>" class="gift_buy" title="<?php echo $Captions_arr['GIFT_VOUCHER']['BUY_VOUCHER']?>"><?php echo $Captions_arr['GIFT_VOUCHER']['BUY_VOUCHER']?></a></div>
			 </div>
        <div class="left_bottom"><img class="imggfil" src="<?php url_site_image('gift.png')?>"  border="0" alt="" /></div>
        </div>
			</form>
		<?php	
		}
		...
		?>
			 ...
			 <?php
				...
				?>
						...
						<div class="left_con">
				        <div class="left_top_survey"></div>
        				<div class="left_mid_survey">
				<?php	
						if($title)
						{
				?>
						  <div class="survey_hdr"><?php echo $title?></div>
			 	<?php
			 			}
				?>		
						 	<div class="survey_qstn"><?php echo stripslashes($surveyData['survey_question'])?></div>
				  <?php
						...
						if ($db->num_rows($ret_surveyopt))
						{
							...
							{
				  ?>
							  <div class="survey_ans"><input name="survey_opt" type="radio" value="<?php echo $row_surveyopt['option_id']?>" />
								<?php echo stripslashes($row_surveyopt['option_text']);?></div>
			  <?php
							}
						}
			  ?>
				  <div class="survey_btn">
					...
					<input name="survey_Submit" type="submit" class="sry_btn" value="<?php echo $Captions_arr['SURVEY']['VOTE']?>" />
				  </div>
				  </div>
				 <div class="left_bottom"><img class="imggfil" src="<?php url_site_image('survey.png')?>"  border="0" alt="" /></div>
				 </div>
				   </form>
			 <?php
			 		}
					...
					foreach ($grp_array as $k=>$groupData)
					{
						...
						if ($proceed)
						{
							...
							if ($db->num_rows($ret_shop))
							{
								...
								?>
									<div class="left_con_brand">
									<div class="left_top_brand"></div>
									<div class="left_mid_brand">
									<ul class="brand">
								<?php
									while ($row_shop = $db->fetch_array($ret_shop))
									{
										if($prev_grp != $groupData['shopbrandgroup_id'])
										{
											...
											{
									?>
												<li class="brandheader"><?php echo stripslashes($title)?></li>
									<?php
											}
												$prev_grp = $groupData['shopbrandgroup_id'];
										}
									?>
										<li><h2><a href="<?php url_shops($row_shop['shopbrand_id'],$row_shop['shopbrand_name'],-1)?>" class="brandlink" title="<?php echo stripslashes($row_shop['shopbrand_name'])?>"><?php echo stripslashes($row_shop['shopbrand_name']);?></a></h2></li>
									<?php
											...
											if (($row_shop['shopbrand_id']==$_REQUEST['shop_id']) or ($row_shop['shopbrand_id']==$parent))
											{
											  ...
											  $comp_shop = $row_shop['shopbrand_id']; 
												...
												<?php	
													...
													{
												?>
															<li><h2><a href="<?php url_shops($row_child['shopbrand_id'],$row_child['shopbrand_name'],-1)?>" title="<?php echo stripslashes($row_child['shopbrand_name'])?>" class="sub_brandlink"><?php echo stripslashes($row_child['shopbrand_name']);?></a></h2></li>
												<?php		
													}
												?>
													</ul>
								...
								?>
									<div class="left_con_brand">
									 ...
									 <?php
										...
										{
										?>
											  <li class="brandheader"><?php echo $title?></li>
									  <?php
										}
									  ?>
									  <li><h2>
		...
		?>
				...
				<div class="left_con_recent">
				<div class="left_top_recent"></div>
				<div class="left_mid_recent">
				<ul class="recent">
			<?php
				if($title)
				{
			?>
				<li class="recentheader"><?php echo $title?></li>
			<?php
				}
					...
					foreach ($cookarray as $k=>$v)
					{
						...
						if ($db->num_rows($ret_prod))
						{
							...
							?>
								<li><h2>
										<a href="<?php echo url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" class="recentlink" title="<?php echo stripslashes($row_prod['product_name'])?>"><?php echo stripslashes($row_prod['product_name'])?></a>
									</h2>
									</li>
							<?php
							}		
				...
				<li><h2 align="right"><a href="#" class="recentlinkclear" title="<?php echo $Captions_arr['COMMON']['SHOW_ALL']?>" onclick="if(confirm('Are You sure You want to clear the recent product list')){ document.<?=$frm_name?>.submit()};"><?php echo $Captions_arr['COMMON']['COMON_RECENT']?></a></h2></li>
				</ul>
				</div>
				<div class="left_bottom"><img class="imggfil" src="<?php url_site_image('cat.png')?>"  border="0" alt="" /></div>
				</div>	
		...
		?>	
			<div class="left_con">
			<div class="left_top_review"></div>
			<div class="left_mid_review">
			 <img src="<?php url_site_image('site-rw.gif')?>" onclick="window.location='<?php url_link('sitereview.html');?>'"  alt="review" />
			</div>
			<div class="left_bottom"><img class="imggfil" src="<?php url_site_image('review.png')?>"  border="0" alt="" /></div>
			</div>
		<?php	
		}
		...
		?>
			<div class="left_con_prod">
        <div class="left_top_prod"></div>
        <div class="left_mid_prod">
         <ul class="product">
			<?php
				if($title)
				{
			?>
				<li class="productheader"><?php echo $title?></li>
			<?php
				}
					while ($row_prod = $db->fetch_array($ret_prod))
					{
				?>
						 <li><h2><a href="<?php echo url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" class="prodlink" title="<?php echo stripslashes($row_prod['product_name'])?>"><?php echo stripslashes($row_prod['product_name'])?></a></h2></li>
				<?php
					}
				?>					    
		</ul>
		...
		?>
			...
			<div class="left_top_stat"></div>
			<div class="left_mid_stat">
			 <?=$row_query['site_hits']?><br /><?php echo $Captions_arr['COMMON']['WEB_STATISTICS']?>
			</div>
			<div class="left_bottom"><img class="imggfil_stat" src="<?php url_site_image('review.png')?>"  border="0" alt="" /></div>
			</div>
		<?
		}
		function mod_ssl($title)
		{
			...
			?>	
							...
							<div class="left_mid_protex"><?php if($row_img['paymethod_ssl_imagelink']) {?><a href="#" onclick="window.open('<?=$row_img['paymethod_ssl_imagelink']?>','<?=str_replace(' ','_',$row_img['paymethod_name']) ?>','scrollbars=1,resizable=1,height=550,width=500,top=150,left=300');"><? }?><? show_image($img,1,1); //show_image(url_root_image($row_img['image_extralargepath'],1),'','')?>
					<?php if($row_img['paymethod_ssl_imagelink']) {?></a> <? }?></div>
				<?
					}
					else
					{
						...
						?>
							<div class="left_mid_protex"><?php if($row_img['paymethod_ssl_imagelink']) {?><a href="#"  onclick="window.open('<?=$row_img['paymethod_ssl_imagelink']?>','<?=str_replace(' ','_',$row_img['paymethod_name']) ?>','scrollbars=1,resizable=1,height=500,width=450,top=150,left=300');"><? }?><img src="<? url_site_image($img)?>" alt="<?=$row_img['paymethod_name']?>" title="<?php echo $title?>" border="0" />
						<?php if($row_img['paymethod_ssl_imagelink']) {?>	</a><? }?></div>
						<?
						}
					}
				...
				?>
				<div class="left_bottom"><img class="imggfil" src="<?php url_site_image('protex.png')?>"  border="0" alt="" /></div>
				</div>
				<?php
		}
		...
		{ //LOGIN_TOPMENU;
			global $db,$ecom_siteid,$ecom_hostname,$inlineSiteComponents,$Captions_arr;
			 ...
			 $cust_id 					= get_session_var("ecom_login_customer");
		?>
				<div class="top_cust_menu">
				<ul class="userloginmenuytopul"> 
				<li><h2><a href="<?php url_link('login_home.html')?>" class="userloginmenuytoplink"><?=$Captions_arr['LOGIN_MENU']['MY_HOME']?></a></h2></li>
				<li><h2><a href="<?php url_link('myprofile.html')?>" class="userloginmenuytoplink"><?=$Captions_arr['LOGIN_MENU']['MY_PROFILE']?></a></h2></li>
				<li><h2><a href="<?php url_link('myenquiries.html')?>" class="userloginmenuytoplink"><?=$Captions_arr['LOGIN_MENU']['MY_ENQUIRIES']?></a></h2></li>
				<li><h2><a href="<?php url_link('wishlist.html')?>" class="userloginmenuytoplink"><?=$Captions_arr['LOGIN_MENU']['MY_WISHLIST']?></a></h2></li>
				<?php	
					$myfav_module = 'mod_myfavorites';
					if(in_array($myfav_module,$inlineSiteComponents))
					{
				?>
					<li><h2><a href="<?php url_link('myfavorites.html')?>" class="userloginmenuytoplink"><?=$Captions_arr['LOGIN_MENU']['MY_FAVOURITE']?></a></h2></li>
				<?php
					}
					?>
					<? $myaddr_module = 'mod_myaddressbook';
					...
					{
				?>
					<li><h2><a href="<?php url_link('myaddressbook.html')?>" class="userloginmenuytoplink"><?=$Captions_arr['LOGIN_MENU']['MY_ADDRESSBOOK']?></a></h2></li>
				<?php
					}
				?>
				<li><h2><a href="<?php url_link('myorders.html')?>" class="userloginmenuytoplink"><?=$Captions_arr['LOGIN_MENU']['MY_ORDERS']?></a></h2></li>
				<?php 
					$sql_download	= "SELECT ord_down_id 
													FROM 
														order_product_downloadable_products  
					...
					{
				?>	
					<li><h2><a href="<?php url_link('mydownloads.html')?>" class="userloginmenuytoplink"><?=$Captions_arr['LOGIN_MENU']['MY_DOWNLOADS']?></a></h2></li>
				<?php
					}
				// check whether payon account link is to be displayed for current user
				$sql_usr = "SELECT customer_payonaccount_status 
				...
				{
				?>
 					<li><h2><a href="<?php url_link('mypayonaccountpayment.html')?>" class="userloginmenuytoplink"><?=$Captions_arr['LOGIN_MENU']['MY_PAYONACCDETAILS']?></a></h2></li>
				<?php
				}
				?>
				<li><h2><a href="<?php url_link('logout.html')?>" class="userloginmenuytoplink"><?=$Captions_arr['LOGIN_MENU']['LOGOUT']?></a></h2></li>
				</ul>          
				</div>
		<?php
		}
		...
		function mod_currencyselector($title)
		{
	  	...
	  	?>
	  		...
	  		<div class="left_con_curr">
			<div class="left_top_curr"></div>
			<div class="left_mid_curr">
			<ul class="currency">
			<?php
				if($title)
				{
			?>
				<li class="currencyheader"><?php echo $title?></li>
			<?php
				}
			?>	
			<li><h2>
		...
		function mod_preorder($ret_main,$title,$display_id)
		{
			...
			{	
				if ($db->num_rows($ret_main))
				{
						...
						{
				?>
							<div class="left_con_pre">
							<div class="left_top_pre"></div>
							<div class="left_mid_pre"><div class="component_left_pre"><a href="<? url_link('preorder'.$display_id.'.html')?>" title="<?php echo $title?>"><?php echo $title?></a></div>
							</div>
							<div class="left_bottom"><img class="imggfil" src="<?php url_site_image('comp.png')?>"  border="0" alt="" /></div>
							</div>
				<?php
