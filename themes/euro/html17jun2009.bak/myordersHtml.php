<?php
	...
	if ($from_date or $to_date)
	{
		...
		//print_r($ord_array );
			...
			<div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?php echo $Captions_arr['ORDER']['ORDER_MAINHEADING']?></div>	
			<div class="shelf_main_con" >
			<div class="shelf_top"><?php echo $Captions_arr['ORDER']['ORDER_MAINHEADING']?></div>
			<div class="shelf_mid">
		  <table width="100%" border="0" cellpadding="3" cellspacing="0" >
                ...
                <table  border="0" cellpadding="2" cellspacing="3" width="100%" class="userordertablestyleA">
                  ...
                  <tr>
                    ...
                    <td width="38%" nowrap="nowrap" class="usermenucontent">
                      <input name="Search_go" type="submit" class="cart_btn" id="Search_go" value="Go" onclick="document.frm_orders.search_click.value=1" />
                    </td>
                  </tr>
                  <!--<tr>
            ...
            <tr>
            <td align="middle" valign="middle" class="ordertableheader" width="4%" ><?php echo $Captions_arr['ORDER']['ORDER_ID']?></td>
            <td align="middle" valign="middle" class="ordertableheader" width="7%"><?php echo $Captions_arr['ORDER']['ORDER_DATE']?></td>
          	 <td   align="middle" valign="middle" class="ordertableheader" width="8%"><?php echo $Captions_arr['ORDER']['ORDER_EMAIL']?></td>
	         <td  align="middle" valign="middle" class="ordertableheader" width="5%" nowrap="nowrap"><?php echo $Captions_arr['ORDER']['ORDER_STATUS']?></td>
             <td  align="middle" valign="middle" class="ordertableheader" width="4%"><?php echo $Captions_arr['ORDER']['ORDER_TOTAL']?></td>
             <td  align="middle" valign="middle" class="ordertableheader" width="4%"><?php echo $Captions_arr['ORDER']['ORDER_REFUND']?></td>
            <td   align="middle" valign="middle" class="ordertableheader" width="4%"><?php echo $Captions_arr['ORDER']['ORDER_PAYSTAT']?></td>
		  </tr>
	<?php
	...
	<div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >>  <a href="<?php url_link('myorders.html')?>"><?php echo $Captions_arr['ORDER']['ORDER_MAINHEADING']; ?></a> >> <?php echo $Captions_arr['ORDER']['ORDER_DETAILS']?></div>
	<div class="shelf_main_con" >
	<div class="shelf_top"><?php echo $Captions_arr['ORDER']['ORDER_DETAILS']?></div>
	<div class="shelf_mid">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
  ...
  <tr>
    ...
    <td width="31%" align="left" valign="top" class="userordercontent"> 
	    <?php echo getorderstatus_Name($row_select_ord['order_status']);
			...
			{
				echo "<span id='cancelBut'>&nbsp;&nbsp;<input type=\"button\" name=\"cancel\" value=\" Cancel \" class=\"cart_btn\" onClick=\"javascript:ord_cancel(document.frm_orderdetail, '$row_select_ord[order_id]')\"></span>";				
			}	
  ...
  <tr id="cancelId" style="display:none;">
   <td colspan="4" width="14%" align="left" valign="middle" nowrap="nowrap" />
	...
	<input type="button" name="cancelSub" class="cart_btn" value=" Submit Cancel Reason " onclick="javascript:cancelSubmit(document.frm_orderdetail,'<?PHP echo $row_select_ord[order_id]; ?>')"/>
    </td>
  </tr>
  <?php 
			$srno++;
...
<tr><td  width="100%" colspan="4">
  <table width="100%" border="0" cellpadding="1" cellspacing="1" id="enqDetails" <?PHP if(!$_REQUEST['ord_pg']) { ?> style="display:none;" <? } ?> >
    ...
    <tr id="EnqId3" style="display:none;"  class="ordertableheader">
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td><input type="button" name="Submit" value="Add Enquiry" class="cart_btn" onclick="javascript:enqSub(document.frm_orderdetail)" />
...
<? } ?>	
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="2">
    ...
    <tr id="postDet2" style="display:none;"  class="ordertableheader">
      <td colspan="2">&nbsp;</td>
      <td colspan="3"><input type="button" name="Submit" value="Add New Post" onclick="javascript:postSub(document.frm_enqposts)" class="cart_btn" />
