<?php
	...
	class myaddressbook_Html
	{
		function Show_AddressBook(){
				...
				<div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?php echo $Captions_arr['ADDRESSBOOK']['TREE_MENU_ADDRESSBOOK']?></div>	
				<div class="shelf_main_con" >
				<div class="shelf_top"><?php echo $Captions_arr['ADDRESSBOOK']['TREE_MENU_ADDRESSBOOK']?></div>
				<div class="shelf_mid">	
				...
				?>
					  ...
					  <tr>
					    <td  align="center" class="pagingcontainertd" colspan="5">&nbsp;<input name="address_add" type="button" class="cart_btn" id="address_add" value="<?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_ADD']?>" onclick="javascript:add_address(document.my_addressbook)" />	</td>
		...
		function Add_AddressBook(){
				...
				$customer_id = get_session_var("ecom_login_customer"); // get customer id
					...
					<div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <a href="<? url_link('myaddressbook.html');?>"><?php echo $Captions_arr['ADDRESSBOOK']['TREE_MENU_ADDRESSBOOK'];?></a> >> <?php echo $Captions_arr['ADDRESSBOOK']['TREE_MENU_ADD_ADDRESSBOOK']?> </div>
					<div class="shelf_main_con" >
				<div class="shelf_top"><?php echo $Captions_arr['ADDRESSBOOK']['TREE_MENU_ADD_ADDRESSBOOK']?></div>
				<div class="shelf_mid">
		   ...
		   frm.submit();
			...
			function Edit_AddressBook(){
				...
				$customer_id = get_session_var("ecom_login_customer"); // get customer id
					...
					<div class="shelf_main_con" >
				<div class="shelf_top"><?php echo $Captions_arr['ADDRESSBOOK']['TREE_MENU_EDIT_ADDRESSBOOK']?></div>
				<div class="shelf_mid">
				  <table width="100%" border="0" cellpadding="0" cellspacing="2" class="shoppingcarttable">
					  <tr>
