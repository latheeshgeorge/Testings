...
function validate_allforms(form){
	...
	if(topfrm){
		...
		<div class="shelf_top"><?=$Captions_arr['CUST_REG']['EDITPROFILE_TREEMENU_TITLE']?></div>
		<div class="shelf_mid">
			...
			<td colspan="2">
				<table width="100%" border="0" cellpadding="0" cellspacing="6" >
					...
					<tr>
					  ...
					  <td width="57%" align="left" valign="middle"><input name="customer_compname" type="text" class="regiinput" id="customer_compname" size="25" value="<?=$row_customer['customer_compname']?>" maxlength="<?=$short?>"/></td>
					</tr>
		...
		if($row_customer['country_id'])
						{
					  	...
					  	echo generateselectbox('cbo_state',$state_arr,$row_customer['customer_statecounty']);*/?>
	...
	<?
		...
		<tr>
			...
			<td align="left" valign="middle"><input name="myprofile_Submit" type="submit" class="cart_btn" id="myprofile_Submit" value="<?=$Captions_arr['CUST_REG']['CUSTOMER_REGISTRATION_SAVE_BUTTON']?>" /></td>
		</tr>
	</table>
	</div>
