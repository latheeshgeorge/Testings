	...
	else
	{
		...
		<div class="ajx_det_main" >
		   ...
		   <div class="ajx_det_image">
			<?php
						echo '<div class="pro_det_image" id="mainimage_holder">';
...
function show_ProductVariables($row_prod,$pos='column')
{
	...
	<?php
			...
			?>
					<div class="ajx_var_mid">
					<div><?php echo $cur_qty_caption?></div>
					<div>
			<?php	
				...
				{
		?>
				<div><input type="text" class="quainput_det" name="qty"  value="<?php echo ($_REQUEST['qty'])?$_REQUEST['qty']:1?>" <?php echo $onchange_function?> /></div>
		<?php
				}
