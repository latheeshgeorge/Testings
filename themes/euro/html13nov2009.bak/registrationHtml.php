		...
		<table width="100%" border="0" cellspacing="4" cellpadding="0" class="regifontnormal">
		  ...
		  <tr>
			...
			<?php
			  ...
			  <table width="100%" border="0" cellspacing="4" cellpadding="0" >
          <tr>
            <td colspan="2" align="left" valign="middle" class="message_header">&nbsp;</td>
          </tr>
          <tr>
          ...
          <tr>
			...
			<input name="custcartlogin_Submit" type="submit" class="cart_btn" value="Login" onclick="document.frm_custlogin_cart.submit();" />
           <? }
		   elseif($pagetype == 'enquire')
		   {
		   ?>
		     <input type="hidden" name="enq_mod" value="show_enquiry" /> 
			<input name="custenquirelogin_Submit" type="submit" class="cart_btn" value="Login" onclick="document.frm_custlogin_enquire.submit();" />
		   <?
		   } else {?>
			<input name="custenquirelogin_Submit" type="submit" class="cart_btn" value="Login" onclick="document.frm_custlogin.submit();" />
			<? } ?>
			</td>
