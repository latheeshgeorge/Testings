<?php
	...
	class search_Html
	{
		...
		{
		  	global $ecom_siteid,$db,$ecom_hostname,$Settings_arr,$tot_cnt,$ecom_themeid,$default_layout,$Captions_arr,$prodperpage,$quick_search,$head_keywords,$row_desc;
							...
							if ($db->num_rows($ret_search))
							{
								...
								switch($Settings_arr['search_prodlisting'])
								{
								  ...
								  ?>
										...
										{
										?>
											<div class="shelf_top_desc"><?php echo stripslashes($top_content)?></div>
										<?php		
										}
										?>
								...
								<?
									...
									?>
										...
										{
									?>
											<div class="shelf_bottom_desc"><?php echo stripslashes($top_content)?></div>
									<?php		
										}
									?>
									<div class="shelf_sort_section_top">
