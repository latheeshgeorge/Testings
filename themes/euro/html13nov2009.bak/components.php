	...
	class components
	{
		...
		function mod_ssl($title)
		{
			...
			?>	
							...
							<div class="left_mid_protex"><? show_image($img,1,1);?></div>
				<?
					}
					else
					{
						...
						?>
							<div class="left_mid_protex"><img src="<? url_site_image($img)?>" alt="<?=$row_img['paymethod_name']?>" title="<?php echo $title?>" border="0" /></div>
						<?
						}
					}
				}
