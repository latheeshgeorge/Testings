			...
			?>
			 <form method="post" name="frm_quicksearch" class="frm_cls" action="<?php url_link('search.html')?>">
                   ...
                   <input type="hidden" name="rdo_suboption" id="rdo_suboption" value='title_desc'/>
						...
						<tr>
						<td  class="td_D" ><label>
							<input name="quick_search" type="text" class="input_s" id="quick_search"  value="SEARCH SHOOTUK" onFocus="if (this.value=='SEARCH SHOOTUK') this.value='';" onBlur="if (this.value=='') this.value='SEARCH SHOOTUK';"/>					
						</label></td>
