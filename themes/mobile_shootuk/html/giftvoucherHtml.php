			...
			<div class="gift_cont"> 
				<div class="gift_cont_inner"> 
					<div class="gift_cont_left_outr"> <div class="gift_cont_left_inner">
						...
						<tr>
							<td class="regi_txtfeildA"><?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_VOUCHER_VALUE_LABEL'])?>&nbsp;<span class="redtext">*</span> </td>
						</tr>
						<tr>
							<td  class="regi_txtfeildA"><div><?php echo $curr_sign?>&nbsp;<input name="voucher_value" type="text" class="regiinput" id="voucher_value" size="20" value="<?=$Saved_vouchervalues['voucher_value']?>"/></div><div> Please enter the value of voucher you wish to buy.</div></td>
						</tr>
						<tr>
							<td  class="regi_txtfeildA"> <?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_VOUCHER_NOOFDAYS_LABEL'])?>&nbsp;<span class="redtext">*</span></td>
						</tr>
						<tr>
							<td  class="regi_txtfeildA"><div><input name="voucher_noofdaysactive" type="text" class="regiinput" id="voucher_noofdaysactive" size="20" value="<?php echo $Saved_vouchervalues['voucher_activedays']?>"/></div><div><?php echo stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_VOUCHER_NOOFDAYS_STARTDATE_NOTE'])?></div></td>
						</tr>
						<?php
						...
						?>
						<tr>
							<td  class="regi_txtfeildA"><?=$Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_EMAIL_VOUCHER_MESSAGE_TEXT']?></td>
						</tr>
						<? }?>
						<tr>
							<td  class="regi_txtfeildA"> <?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_EMAIL_VOUCHER_TO_NAME_LABEL'])?>&nbsp;<span class="redtext">*</span></td>
						</tr>
						<tr>
						...
						<tr>
							<td  class="regi_txtfeildA">Email id&nbsp;<span class="redtext">*</span></td>
						</tr>
						<tr>
							<td  class="regi_txtfeildA"><input name="email_id" type="text" class="regiinput" id="email_id" size="20" value="<?php echo $Saved_vouchervalues['voucher_toemail']?>"/></td>
						</tr>
						<tr>
							<td  class="regi_txtfeildA"><?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_EMAIL_VOUCHER_TO_MESSAGE_LABEL'])?>&nbsp;<span class="redtext">*</span></td>
						</tr>
						<tr>
							<td  class="regi_txtfeildA"> <textarea name="email_message" type="text" class="regiinput" id="email_message" rows="8" cols="25"><?php echo $Saved_vouchervalues['voucher_tomessage']?></textarea></td>
						</tr>
						</table>
					</div>
								...
								<td  colspan="2">
									...
									{	
										...
										{			
											...
											?>
											<tr >
												<td  class="regi_txtfeildA" width="50%" align="left">
									...
									<tr>										
									<td class="regi_txtfeildA"  colspan="2" align="left"><?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_VOUCHER_VERIFICATION_CODE'])?>&nbsp;<span class="redtext">*</span></td>
									</tr>
									<tr>
										<td class="regi_txtfeildA" width="50%" align="left">&nbsp;</td>
										<td class="regi_txtfeildA" width="50%" align="left"><img src="<?php url_verification_image('includes/vimg.php?size=4&pass_vname=buygiftvoucher_Vimg&amp;bg=255 255 255&amp;brdr=255 255 255&fnt=255 0 0&circle=1')?>" border="0" alt="Image Verification" class="captcha"/></td>
									</tr>
									<tr>
										<td class="regi_txtfeildA" width="50%" align="left">&nbsp;</td>
										<td class="regi_txtfeildA" width="50%" align="left">
