<?php
	...
	class static_Html
	{
		...
		function Show_StaticPage($row_statpage)
		{
			...
			{
		?>
		<form method="post" name="frm_staticpage" id="frm_staticpage" action="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>" class="frm_cls">
		...
		<?php echo $HTML_treemenu;?>
			<table style="border:0" class="statictable">
			<tr>
