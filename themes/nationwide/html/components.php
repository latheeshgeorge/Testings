						...
						<div class=" static_con">
							<ul>
								...
								if(count($grp_array))
								{
									...
									?>
										<li>
										<div class='menuspan'><a href="<?php url_link('')?>" class="static_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?></span></a></div>
										</li>
									<?php
									}
									...
									?>
										<li>
										<div class='menuspan'><a href="<?php if ($row_pg['page_type']=='Page') url_static_page($row_pg['page_id'],$row_pg['title']); else echo $row_pg['page_link'];?>" class="static_menu" title="<?php echo stripslash_normal($row_pg['title'])?>" <?php echo $target?>><span><?php echo stripslash_normal($row_pg['title']);?></span></a></div>
										</li>
									<?php
									}
									...
									?>
										<li>
										<div class='menuspan'><a href="<?php url_link('sitemap.xml')?>" class="static_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP'])?></span></a></div>
										</li>
									<?php	
									}
									...
									?>
										<li>
										<div class='menuspan'><a href="<?php url_link('sitemap.html')?>" class="static_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SITEMAP'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SITEMAP'])?></span></a></div>
										</li>
									<?php		
									}
									...
									?>
										<li>
										<div class='menuspan'><a href="<?php url_link('saved-search.html')?>" class="static_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH'])?></span></a></div>
										</li>
									<?php		
									}
									...
									?>
										<li>
										<div class='menuspan'><a href="<?php url_link('help.html')?>" class="static_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HELP'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HELP'])?></span></a></div>
										</li>
									<?php
									}
									...
									?>
										<li>
										<div class='menuspan'><a href="<?php url_link('faq.html')?>" class="static_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_FAQ'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_FAQ'])?></span></a></div>
										</li>
									<?php
									}
									}
...
<?php
						...
						<div class="static_con_bottom">
							<ul >
								...
								if ($grpData['group_showhomelink']==1)
								{
									?>
									<li>
									<span class='menustatic_bottom'><a href="<?php url_link('')?>" class="Category" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?></a></span>
									</li>
									<?php			
								}
									$show_top = 0;
								...
								$target = ($row_pg['page_link_newwindow']==1 and $row_pg['page_type']!='Page')?'target="_blank"':'';
									?>
									<li>
									<span class='menustatic_bottom'><a href="<?php if ($row_pg['page_type']=='Page') url_static_page($row_pg['page_id'],$row_pg['title']); else echo $row_pg['page_link'];?>" class="bottomlink" title="<?php echo stripslash_normal($row_pg['title'])?>" <?php echo $target?>><?php echo stripslash_normal($row_pg['title']);?></a></span>
									</li>
									<?php
								}
								}
								...
								if ($grpData['group_showsitemaplink']==1)
								{
									?>
									<li>
									<span class='menustatic_bottom'><a href="<?php url_link('sitemap.html')?>" class="Category" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SITEMAP'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SITEMAP'])?></a></span>
									</li>
									<?php			
								}
								if ($grpData['group_showxmlsitemaplink']==1 )
								{			
									?>
									<li>
									<span class='menustatic_bottom'><a href="<?php url_link('sitemap.xml')?>" class="Category" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP'])?></a></span>
									</li>
									<?php									
								}
								if ($grpData['group_showfaqlink']==1)
								{
									?>
									<li>
									<span class='menustatic_bottom'><a href="<?php url_link('faq.html')?>" class="Category" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_FAQ'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_FAQ'])?></a></span>
									</li>
									<?php			
								}
								if ($grpData['group_showhelplink']==1)
								{
									?>
									<li>
									<span class='menustatic_bottom'><a href="<?php url_link('help.html')?>" class="Category" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HELP'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HELP'])?></a></span>
									</li>
									<?php			
								}
								if ($grpData['group_showsavedsearchlink']==1)
								{
									?>
									<li>
									<span class='menustatic_bottom'><a href="<?php url_link('saved-search.html')?>" class="Category" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH'])?></a></span>
									</li>
									<?php			
								}
								?>
					...
					elseif ($position=='seo-section')
					{
							...
							$prev_grp = $grpData['group_id'];
								...
								?>
								<li>
								<div class='vertlinks'><a href="<?php url_link('')?>" class="general_links_div_link" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_HOME']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_HOME']?></a></div>
								</li>
							<?php		
								}
								while ($row_pg = $db->fetch_array($ret_pg))
							  ...
							  ?>
								<li>
								<div class='vertlinks'><a href="<?php if ($row_pg['page_type']=='Page') url_static_page($row_pg['page_id'],$row_pg['title']); else echo $row_pg['page_link'];?>" class="general_links_div_link" title="<?php echo stripslashes($row_pg['title'])?>" <?php echo $target?>><?php echo stripslashes($row_pg['title']);?></a></div>
								</li>
							<?php 
								}
								if ($grpData['group_showsitemaplink']==1)
							...
							?>
								<li>
								<div class='vertlinks'><a href="<?php url_link('sitemap.html')?>" class="general_links_div_link" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_SITEMAP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_SITEMAP']?></a></div>
								</li>
							<?php		
								}
								if ($grpData['group_showxmlsitemaplink']==1 )
							...
							?>
								<li>
								<div class='vertlinks'><a href="<?php url_link('sitemap.xml')?>" class="general_links_div_link" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP']?></a></div>
								</li>
							<?php		
								}
								if ($grpData['group_showhelplink']==1)
							...
							?>
								<li>
								<div class='vertlinks'><a href="<?php url_link('help.html')?>" class="general_links_div_link" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_HELP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_HELP']?></a></div>
								</li>
							<?php		
								}
								if ($grpData['group_showsavedsearchlink']==1)
								...
								?>
									<li>
									<div class='vertlinks'><a href="<?php url_link('saved-search.html')?>" class="general_links_div_link" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH']?></a></div>
									</li>
								<?php			
								}
							  ?>
														...
														<ul  id="main_navigation"> 
															<?php
																...
																while ($row_cat = $db->fetch_array($ret_cat))
																{
																	?>
																	<li>
																	<div class='cattop_newcls'><a href="<?php url_category($row_cat['category_id'],$row_cat['category_name'],-1)?>" class="category_menu" title="<?php echo stripslash_normal($row_cat['category_name'])?>"><span><?php echo ucwords(stripslash_normal($row_cat['category_name']));?></span></a></div>
																<?php
																	// Check whether there exists first level subcategories for current category
																	$sql_subcat = "SELECT category_id,category_name 
																					FROM 
								...
								$sql_cat = "SELECT a.category_id,a.category_name,parent_id,b.category_displaytype,b.category_islink,a.category_subcatlisttype   
									...
									if ($db->num_rows($ret_cat))
									{
										...
										while ($row_cat = $db->fetch_array($ret_cat))
										{
											...
											?>
												<li>
												<a href="<?php url_category($row_cat['category_id'],$row_cat['category_name'],-1)?>" class="catelink" title="<?php echo str_replace('&','&amp;',stripslash_normal($row_cat['category_name']))?>"><?php echo ucwords(str_replace('&','&amp;',stripslash_normal($row_cat['category_name'])));?></a>
												</li>
											<?php
											}
											...
											<?php
													...
													?>
													<li>
													<a href="<?php url_category($row_child['category_id'],$row_child['category_name'],-1)?>" title="<?php echo str_replace('&','&amp;',stripslash_normal($row_child['category_name']))?>" class="subcatelink"><?php echo ucwords(str_replace('&','&amp;',stripslash_normal($row_child['category_name'])));?></a>
													</li>
											<?php		
														}
													?>
...
<?php
		...
		{
			global $Captions_arr,$ecom_hostname,$inlineSiteComponents,$Settings_arr,$db,$ecom_siteid,$position,$loginUrl,$ecom_fb_enable,$logoutUrl;
...
<?php
			...
			{ 
				...
				?>
					...
					<div class="login_user_linkB">
                    <?php /* FB login script */
					if($cust_fbid > 0)
					{
					?>
                    <a href="<?php echo $logoutUrl;?>" class="loginlink" title="<?=stripslash_normal($Captions_arr['LOGIN_MENU']['LOGOUT'])?>"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['LOGOUT'])?></a> 
					<?php
						}
						else
						{
					?><a href="<?php url_link('logout.html')?>" class="loginlink" title="<?=stripslash_normal($Captions_arr['LOGIN_MENU']['LOGOUT'])?>"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['LOGOUT'])?></a>
                    <?php
						}
                    ?></div>
					</div>
			...
			?>
					...
					<div class="login_top"></div>
						<div class="login_middle">
							...
							?>
                            <li>
							<h2><a href="<?php echo $logoutUrl;?>" class="userloginmenulink">
...
<?
	...
	<div class="cart_txt"> <?php echo stripslash_normal($Captions_arr['COMMON']['CART_TOTAL'])?> <span><?php echo $cart_tot?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo stripslash_normal($Captions_arr['COMMON']['ITEMS_IN_CART'])?> <span><?php echo  (get_session_var('cart_total_items'))?get_session_var('cart_total_items'):0?> </span></div>
              <div class="cart_btn">
                <ul class="cart_view_linkul">
                 <?php /*?><li> <a href="<?php url_link('enquiry.html')?>" class="cart_view_link" title="<?php echo stripslash_normal($Captions_arr['COMMON']['VIEW_ENQUIRY'])?>"><span><?php echo stripslash_normal($Captions_arr['COMMON']['VIEW_ENQUIRY'])?></span></a> </li><?php */?>
                 <li> <a href="#" class="cart_view_link_a" onclick="handle_checkout_submit('<?php echo $ecom_hostname?>',0,'<?php echo $pass_tot?>')"  title="<?php echo stripslash_normal($Captions_arr['COMMON']['CHECK_OUT'])?>"><span><?php echo stripslash_normal($Captions_arr['COMMON']['CHECK_OUT'])?></span></a> </li>
                  <li> <a href="#" onclick="gobackto_cart('<?php echo ($protectedUrl)?base64_encode($ecom_hostname):$ecom_hostname?>')" class="cart_view_link_b" title="<?php echo stripslash_normal($Captions_arr['COMMON']['VIEW_CART'])?>"><span><?php echo stripslash_normal($Captions_arr['COMMON']['VIEW_CART'])?></span></a> </li>
                </ul>
              </div >
            </div>  
    <?php
				...
				<div class="cart_lf_con">
				  ...
				  <div class="cart_lf_bottom">
					...
					<div class="cart_lf_outerA">
					 ...
					 <?php /*?> <div class="cart_lf_outerB"><a href="<?php url_link('enquiry.html')?>" class="cart_linklf_txt" title="<?php echo stripslash_normal($Captions_arr['COMMON']['VIEW_ENQUIRY'])?>"><span><?php echo stripslash_normal($Captions_arr['COMMON']['VIEW_ENQUIRY'])?></span></a></div><?php */?>
					   </div>
				  </div>
				</div>
			<?php
					...
					if ($proceed)
					{
						...
						if ($db->num_rows($ret_prod))
						{
							//if($shelfData['shelf_currentstyle']=='nor') // case of normal design layout
							{
								...
								{
									case '4row': // case of one in a row
									case '4rowall': // case of one in a row
									?>
...
<?php	
		...
		function mod_newsletter($title)
		{
			...
			?>
					...
					<form name="frm_newsletter" method="post" action="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>" class="frm_cls" onsubmit="return newsletter_validation(this)">
						<div class="newsletter_inner">
						  <div class="newsletter_input">
							<input name="newsletter_email" type="text" class="newsletterinput" id="newsletter_email" size="12" value="Email Address" onclick="if(document.frm_newsletter.newsletter_email.value=='Email Address'){ document.frm_newsletter.newsletter_email.value=''};" onblur="if(document.frm_newsletter.newsletter_email.value==''){ document.frm_newsletter.newsletter_email.value='Email Address'};" />
						  </div>
						  <?php 
							if($Settings_arr['imageverification_req_newsletter']) // if image verification is required
							{
							?>
							<div class="rt_newsletterimg" style="padding-top:5px;"><img src="<?php url_verification_image('includes/vimg.php?size=4&amp;pass_vname=newsletter_Vimg&amp;bg=143%20186%202')?>" style="border:0" alt="Image Verification"/> </div>
							<div class="rt_newsletterimg_input">
								<div style="display:block; width:100px;font-size:13px;">Enter Code</div>
							<?php 
								// showing the textbox to enter the image verification code
								$vImage->showCodBox(1,'newsletter_Vimg','class="img_input" id="newsletter_Vimg"'); 
							?>
							</div>
							<?php
							}
...
<?php
		...
		function mod_recentlyviewedproduct($cookval,$title)
		{
			...
			?>
				...
				<form name="<? echo $frm_name?>" id="<? echo $frm_name?>" action="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>" method="post">
		...
		function mod_adverts($advert_arr,$title)
		{
			...
			if ($position=='left' or $position=='right') // show the advert only if position is left or right
			{
				if (count($advert_arr))
				{
					...
					?>
						<div class="advert_comp_details" style="text-align:left">
  					<?php
						switch ($k['advert_type'])
						{
							...
							?>
  								<img src="<?php echo $path?>" alt="<?php echo stripslashes($k['advert_title'])?>" title="<?php echo stripslashes($k['advert_title'])?>" style="border:0" /> 
  							<?php		
								if ($link!='')
								{
							?>
			  ...
			  <td colspan="3" class="userloginmenuytop" >
			  	<ul class="userloginmenuytopul">
				   <?php /* FB login script */
                    ...
                    <li>
                        <h2>
                        <a href="<?php echo $logoutUrl;?>" class="userloginmenuytoplink">
                        <?=stripslash_normal($Captions_arr['LOGIN_MENU']['LOGOUT'])?>
                        </a>
                        </h2>
                      </li>
