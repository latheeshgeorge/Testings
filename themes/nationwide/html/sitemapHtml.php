...
?>
 ...
 //////////////***************LISTING OF STATIC PAGES ,CATEGORIES AND PRODUCTS FOR SITE MAP*************///////////////////
		if(is_array($_SESSION['site_map_links']))
		{
			...
			$saved_heading = false;
			?>
			<table style="width:100%;border:0" class="regitable">
			<?php
				$max_elements	=	50;
				$row_count = 0;
				$static_cnt=0; 
				...
				foreach($_SESSION['site_map_links'] as $link_key => $linkval)
				{
					if($link_key > $_REQUEST['start_key'])
					{
						...
						?>
							<td style="text-align:left;vertical-align:middle;width:50%;" class="sitemapcontents">
						...
						?>
						<tr>
						<td style="text-align:left;vertical-align:middle" colspan="2" class="sitemapcontents"><a href="<?php url_category($categ_id,$linkval["'site_map_categ_"."$categ_id'"],-1)?>" class="sitemapcatlink"><strong><?=$linkval["'site_map_categ_"."$categ_id'"]?></strong></a></td>
						</tr>
						<?
						$i=0;
						}
						...
						{ // Display the category name if the listing starts from any products
							...
							if($last_categid)
							{
								...
								?>
								<tr>
								<td style="text-align:left;vertical-align:middle" colspan="2" class="sitemapcontents"><a href="<?php url_category($last_categid,$last_categ_name,-1)?>" class="sitemapcatlink"><strong><?=$last_categ_name?></strong></a></td>
								</tr>
								<?
								$display_last_category = true;
							}
			...
			?>
				...
				<td style="text-align:center" class="pagingcontainertd_normal"> 
				<?php
