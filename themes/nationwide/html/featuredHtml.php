                    ...
                    <div class="featured_price">
                     <?=$HTML_price;?>
						...
						<?php
												...
												$class_arr['QTY']               = ' ';
												$class_arr['BTN_CLS']           = 'normal_shlfA_pdt_buy_btnZ';
												show_addtocart_v5_ajax($frm_name,$row_featured,$class_arr);
                      /*
						?>
						<a href="<?php url_product($row_featured['product_id'],$row_featured['product_name'],-1)?>"><img src="<?php url_site_image('fet-buy.gif')?>" /></a></div>
						*/
						?> 
                    </div>
                    </div>
