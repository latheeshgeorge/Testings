<?php
	/*#################################################################
	# Script Name 	: compare_products.php
	# Description 		: This is the product compare base page
	# Coded by 		: Sny
	...
	$split_span				= ''; // this variable is used to split the columns for items in top table
...
?>
  <tr>
    <td align="left" valign="top" class="maintable_compare_content_td_lef">&nbsp;</td>
    <td align="left" valign="top" class="maintable_compare_content_td">   
	<?php
    ...
    <td align="left" valign="top" class="maintable_compare_content_td_rightt">&nbsp;</td>
  </tr>
    <?php
