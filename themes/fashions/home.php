...
?>
  <tr>
    <td align="left" valign="top" class="maintable_home_content_td_left">&nbsp;</td>
    <td align="left" valign="top" class="maintable_home_content_td">   
    <div class="left_comp_op"></div>
    <div class="left_comp">
  <?php
    ...
    <div align="right" class="homepagecontents">
	<?php
    ...
    <td align="left" valign="top" class="maintable_home_content_td_right">&nbsp;</td>
  </tr>
    <?php
...
<div align="right" class="div-band">
<?php
	// Showing the middleband components
		$position = 'middleband';
		include("Components.php");
?>
</div>
