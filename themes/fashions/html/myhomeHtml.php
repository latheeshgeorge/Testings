...
/*############################################################################
	...
	class myhome_Html
	{
		...
		?>
			<div class="pro_det_treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?php echo  stripslash_normal($Captions_arr['LOGIN_HOME']['LOGIN_HOME_TREE_MENU'])?></div>
		...
		function Show_Recently_Purchased_Products_With_Categories($used_val_arr)
		{
			...
			<?php	
				for($i=0;$i<count($cur_cat_arr);$i++)
				{
					...
					{
			?>
						<div class="best_seller_heading"><?php echo stripslash_normal($row_cat['category_name'])?></div>
				<?php
						if($db->num_rows($ret_prods_offers))
						{
						?>
							<div class="pro_nav_products_home" align="center">
							<?php echo str_replace('[category]',stripslash_normal($row_cat['category_name']),stripslash_normal($Captions_arr['LOGIN_HOME']['LOGIN_HOME_RECENT_RECOMM_PROD']))?>
							</div>
							<?php	
							//*********************************************************
						...
						?>
							<div class="pro_nav_products_home" align="center">
							<?php echo str_replace('[category]',stripslash_normal($row_cat['category_name']),stripslash_normal($Captions_arr['LOGIN_HOME']['LOGIN_HOME_RECENT_NEW_PROD']))?>
							</div>
							<?php		
							//*******************************************************************
			...
			if ($db->num_rows($ret_favcat))
			{
				...
				list($row_last_login) 	= $db->fetch_array($ret_last_login);
						while ($row_favcat = $db->fetch_array($ret_favcat))
						{
							...
							{
						?>
								<div class="best_seller_heading"><?php echo stripslash_normal($row_favcat['category_name'])?></div>
						<?php
								if($db->num_rows($ret_prods_offers))
								{
								?>
									<div class="pro_nav_products_home" align="center"><?php echo str_replace('[category]',stripslash_normal($row_cat['category_name']),stripslash_normal($Captions_arr['LOGIN_HOME']['LOGIN_HOME_FAV_RECOMM_PROD']))?>
									</div>
									<?php	
									//*********************************************************
									// Show the list of products which have offers
								...
								{
								?>
									<div class="pro_nav_products_home" align="center"><?php echo str_replace('[category]', stripslash_normal($row_cat['category_name']),stripslash_normal($Captions_arr['LOGIN_HOME']['LOGIN_HOME_FAV_NEW_PROD']))?>
									</div>
									<?php		
									//*******************************************************************
									// Show the list of new products since last login in current category
								...
								?>
								<div class="middle_showall_div"><a href="<?php  url_category_all($row_favcat['category_id'],$row_favcat['category_name'],-1)?>" class="middle_showall_link" title="<?php echo stripslash_normal($Captions_arr['COMMON']['SHOW_ALL'])?>"><? echo stripslash_normal($Captions_arr['COMMON']['SHOW_ALL'])?></a>
								</div>
								<?php					
							}
						}
		...
		function Show_Favourite_Products($used_val_arr)
		{
			...
			{
			?>
				<div class="best_seller_heading"><?php echo stripslash_normal($Captions_arr['LOGIN_HOME']['LOGIN_HOME_FAV_PROD'])?></div>
			<?php
		...
		?>
				...
				?>
				<div class="middle_showall_div"><a href="<?php url_link('showfavprodall'.$custom_id.'.html')?>" class="middle_showall_link" title="<?php echo stripslash_normal($Captions_arr['COMMON']['SHOW_ALL'])?>"><? echo stripslash_normal($Captions_arr['COMMON']['SHOW_ALL'])?></a></div>
				<?php
			}	
			$used_val_arr['cats_arr'] = $cats_arr;
			$used_val_arr['prod_arr'] = $prod_arr;
			...
			if ($db->num_rows($ret_cats))
			{
				...
				while ($row_cats = $db->fetch_array($ret_cats) and $totcnt<3)
				{
					...
					if($db->num_rows($ret_prods_offers) or 	$db->num_rows($ret_prods_new))
					{
						$totcnt++;
				?>
						<div class="best_seller_heading"><?php echo stripslash_normal($row_cats['category_name'])?>
						</div>
				<?php
						if($db->num_rows($ret_prods_offers))
						{
						?>
							<div class="pro_nav_products_home" align="center"><?php echo str_replace('[category]',stripslash_normal($row_cat['category_name']),stripslash_normal($Captions_arr['LOGIN_HOME']['LOGIN_HOME_MOST_HITS_CAT_OFFER']))?>
							</div>	
							<?php	
							//*********************************************************
							// Show the list of products which have offers
						...
						{
						?>
							<div class="pro_nav_products_home" align="center"><?php echo str_replace('[category]', stripslash_normal($row_cat['category_name']),stripslash_normal($Captions_arr['LOGIN_HOME']['LOGIN_HOME_MOST_HITS_CAT_NEW']))?>
							</div>
							<?php		
							//*******************************************************************
							// Show the list of new products since last login in current category
						...
						?>
						<div class="middle_showall_div"><a href="<?php  url_category_all($row_cats['category_id'],$row_cats['category_name'],-1)?>" class="middle_showall_link" title="<?php echo stripslash_normal($Captions_arr['COMMON']['SHOW_ALL'])?>"><? echo stripslash_normal($Captions_arr['COMMON']['SHOW_ALL'])?></a>
						</div>
						<?php					
					}
				}
