	...
	if ($from_date or $to_date)
	{
		...
		//print_r($ord_array );
		  ...
		  <table width="100%" border="0" cellpadding="3" cellspacing="0" class="tbl_float" >
              ...
              <tr>
                <td colspan="7" align="center" valign="middle" class="pagingcontainertd" >
				<?php 
					$path = '';
					$query_string .= "";
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" class="tbl_float">
...
<? } ?>	
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="2">
	...
	<tr id="view_<?PHP echo $count; ?>" style="display:none;">
	 <td colspan="1"></td>
      <td colspan="4" class="viewPostdetails" nowrap="nowrap"><div align="left"><?PHP echo nl2br($postrow['post_details']); ?></div></td>
    </tr>
	<?PHP } ?>
		   <tr>
      <td colspan="5" class="pagingcontainertd" align="center">
