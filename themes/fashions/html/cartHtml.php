			  ...
			  ?>
				  <tr>
					...
					?>	
							...
							<div class="updatediv" align="left"><a href="#" class="update_link" onclick="if (confirm_message('<?php echo $Captions_arr['CART']['CART_ITEM_REM_MSG']?>')) {document.frm_cart.remcart_id.value='<?php echo $products_arr['cart_id']?>';handle_form_submit(document.frm_cart,'Remove_qty','#rem')}" title="<?php echo $Captions_arr['CART']['CART_REMOVE']?>"><img src='<?php url_site_image('cart_remove.gif')?>' border="0" alt="<?php echo $Captions_arr['CART']['CART_REMOVE']?>"></a></div>
					<?php	
						}
						else
						{
			...
			if (is_Feature_exists('mod_bonuspoints'))
			{
		      ...
		      $fetch_arr_admin 	= $db->fetch_array($res_admin);
			   if($fetch_arr_admin['bonus_point_details_content']!='')
			   {
				?>
			   <tr>
					<td colspan="6" align="right"><div class="cart_bonus_more"><a href="<?php url_link('bonuspoint_content.html')?>" title=""><img src="<?php url_site_image('bonusmoreinfo.gif')?>" border="0" /></a></div>
					</td>
				</tr>
			  <?php
			  }
					...
					?>
						 <tr>
						  ...
						  <?php
							...
							?>
							<tr>
								<td colspan="6" class="redtext" align="right"><?php echo str_replace('[min_points]',$Settings_arr['minimum_bonuspoints'],$Captions_arr['CART']['CART_MIN_BONUS_REQ'])?></td>
							</tr>
							<?php
							} 
				...
				?>
					<tr>
						<td class="shoppingcartcontent" colspan="6" align="right">
		  ...
		  else
		  {
			  ...
			  ?>
				  <tr>
					...
					<td align="right" valign="middle" class="shoppingcartpriceA"><?php echo print_price($products_arr['final_price'],true)?></td>
				  </tr>
				  <?php
			  }
		  ?>
...
//				$cont_class = 'shoppingcartcontent_noborder'; 
			...
			<?php	
				...
				/*elseif($cartData["payment"]["method"]['paymethod_key']=='GOOGLE_CHECKOUT') // section to handle the case of google checkout
				{
		...
		{
			/*global $ecom_siteid,$db,$ecom_hostname,$Settings_arr,$ecom_themeid,$default_layout,
					$Captions_arr,$inlineSiteComponents,$ecom_email,$ecom_common_settings,$ecom_testing;*/
			global $ecom_siteid,$db,$ecom_hostname,$Settings_arr,$ecom_themeid,$default_layout,
					$Captions_arr,$inlineSiteComponents,$sitesel_curr,$default_Currency_arr,$ecom_testing,$ecom_themename,$components,
					$ecom_common_settings;
			  ...
			  while($row_orddet = $db->fetch_array($ret_orddet))
			  {
				...
				?>
				  <tr>
					...
					<td align="left" valign="middle" class="shoppingcartpriceB"><?php echo print_price($row_orddet['order_retailprice'],true)?></td>
					...
					<td align="right" valign="middle" class="shoppingcartpriceA"><?php echo print_price($row_orddet['order_rowtotal'],true)?></td>
				  </tr>
				  <?php
				  	// If variables exists for current product, show it in the following section
					if ($vars_exists) 
