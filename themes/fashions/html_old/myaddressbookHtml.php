		...
		function Add_AddressBook(){
			...
			<?php
				...
				?>
					  ...
					  <tr>
					    <td  colspan="2"  align="left" ><?php echo $Captions_arr['ADDRESSBOOK']['TITLE'];?></td>
					    <td  align="center" >:</td>
					    <td  align="left" >
			...
			<option value="M/S." <?=($_REQUEST['customer_title']=='M/S.')?"selected":''?>>M/S.</option>
					  ...
					  <tr>
					    <td  colspan="2"  align="left" ><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_FNAME'];?><span class="redtext">*</span> </td>
					    <td  align="center" >:</td>
					    <td  align="left" ><input type="text" name="txt_fname" value="<?=$_REQUEST['txt_fname'] ?>" /></td>
				    </tr> 
					  <tr>
					    <td  colspan="2"  align="left" ><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_MNAME'];?></td>
					    <td  align="center" >:</td>
					    <td  align="left" ><input type="text" name="txt_mname" value="<?=$_REQUEST['txt_mname'] ?>"/></td>
				    </tr>
					  <tr>
					    <td  colspan="2"  align="left" ><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_LNAME'];?><span class="redtext">*</span> </td>
					    <td  align="center" >:</td>
					    <td  align="left" ><input type="text" name="txt_lname" value="<?=$_REQUEST['txt_lname'] ?>"/></td>
				    </tr>
					  <tr>
					    <td  colspan="2"  align="left" ><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_ADDRESS'];?></td>
					    <td  align="center" >:</td>
					    <td  align="left" ><textarea name="address" cols="25" rows="5"><?=$_REQUEST['address'] ?></textarea></td>
				    </tr>
				      <tr>
				        <td  colspan="2"  align="left" ><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_EMAIL'];?><span class="redtext">*</span></td>
				        <td  align="center" >:</td>
				        <td  align="left" ><input type="text" name="email" value="<?=$_REQUEST['email'] ?>"/></td>
			        </tr>
				      <tr>
				        <td  colspan="2"  align="left" ><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_PHONE'];?></td>
				        <td  align="center" >:</td>
				        <td  align="left" ><input type="text" name="phonenumber" value="<?=$_REQUEST['phonenumber'] ?>" /></td>
			        </tr>
			          <tr>
			            <td  colspan="2"  align="left" ><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_MOBILE'];?></td>
			            <td  align="center" >:</td>
			            <td  align="left" ><input type="text" name="mobnumber" value="<?=$_REQUEST['mobnumber'] ?>" /></td>
		            </tr>
		            <tr>
					 <td  colspan="2"  align="left" ><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_FAX'];?></td>
				     <td width="1%"  align="center" >:</td>
				     <td width="74%"  align="left" ><input type="text" name="faxnumber" value="<?=$_REQUEST['faxnumber'] ?>" /></td>
					</tr>
		   ...
		   frm.submit();
			...
			<option value="M/S." <?=($customer_title=='M/S.')?"selected":''?>>M/S.</option>
				      ...
				      <tr>
				        ...
				        <td  align="center" >:</td>
				        <td  align="left" ><input type="text" name="email" value="<?PHP echo $row['address_email']; ?>"  /></td>
			        </tr>
				      <tr>
				        <td  colspan="2"  align="right" ><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_PHONE'];?></td>
				        <td  align="center" >:</td> 
				        <td  align="left" ><input type="text" name="phonenumber" value="<?PHP echo $row['address_phone']; ?>" /></td>
			        </tr>
			          <tr>
			            <td  colspan="2"  align="right" ><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_MOBILE'];?></td>
			            <td  align="center" >:</td>
			            <td  align="left" ><input type="text" name="mobnumber" value="<?PHP echo $row['address_mobile']; ?>"  /></td>
		            </tr>
		            <tr>
					 <td  colspan="2"  align="right" ><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_FAX'];?> </td>
				     <td width="5%"  align="center" >:</td>
				     <td width="51%"  align="left" ><input type="text" name="faxnumber" value="<?PHP echo $row['address_fax']; ?>"  /></td>
					</tr>
