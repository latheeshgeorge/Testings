	...
	class enquiry_Html
	{
	  function enquiry_Showform()
	  {
		...
		$prod_array = array();
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbl_float">
			...
			if($db->num_rows($ret_select_enq))
				...
				?>
			<tr>
			  <td colspan="3" align="left" valign="middle" class="shoppingcartheader"><?php echo $Captions_arr['ENQUIRE']['ENQUIRE_MAINHEADING']?></div></td>
          ...
          <tr>
            <td align="left" valign="middle" class="shoppingcartheader" ><?php echo $Captions_arr['ENQUIRE']['ENQUIRE_ITEM']?></td>
            <td align="left" valign="middle" class="shoppingcartheader"><?php echo $Captions_arr['ENQUIRE']['ENQUIRE_PRICE']?></td>
            <td align="right" valign="middle" class="shoppingcartheader"><?php echo $Captions_arr['ENQUIRE']['ENQUIRE_NOTE']?></td>
		    <td align="right" valign="middle" class="shoppingcartheader"><?php echo $Captions_arr['ENQUIRE']['ENQUIRE_ACTION']?></td>
		  </tr>
		  <?php
		if($db->num_rows($ret_select_enq))
		{  
		while($row_select_enq = $db->fetch_array($ret_select_enq))
		{
		  ...
		  $prod_sql_det = "SELECT product_id,product_name,product_webprice FROM products 
		  ...
		  ?>
			  <tr>
				<td align="left" valign="middle" class="shoppingcartcontent" width="28%" >
				<?php 
					...
					?>
				<a href="<?php echo url_product($row_prod_det['product_id'],$row_prod_det['product_name'])?>" title="<?php echo $row_prod_det['product_name']?>" class="shoppingcartprod_link"><?php echo $row_prod_det['product_name']?></a>
				<?php
				...
				<td align="left" valign="middle" class="shoppingcartpriceB"  width="35%">
				<?php 
					...
					echo show_Price($row_prod_det,$price_class_arr,'other_3');//print_price($row_prod_det['product_webprice'])?></td>
				<td align="right" valign="middle" class="shoppingcartpriceA"><img src="<?php url_site_image('enquire_note.gif')?>" onclick="add_Enquire_notes(frm_enquire,'<?=$row_select_enq['enquiry_id']?>')" alt="Add Notes" title="Add Notes" /></td>
			    <td align="right" valign="middle" class="shoppingcartpriceA"><img src="<?php url_site_image('delete.gif')?>" onclick="if(confirm_message('Are you sure you want to Delete this Enquiry?')){document.frm_enquire.enq_mod.value='delete_enquiry';document.frm_enquire.enquiry_id.value='<?=$row_select_enq['enquiry_id']?>';document.frm_enquire.submit();}" alt="Delete" title="Delete" /></td>
			  </tr>
			  ...
			  <tr>
			 <td  align="left" valign="middle"   class="shoppingcartcontent" >Add Notes:<br /><textarea  name="enquirenote_<?=$row_select_enq['enquiry_id']?>" rows="5" cols="38" id="note_text_<?=$row_select_enq['enquiry_id']?>" ><? if($_REQUEST['enquirenote_'.$row_select_enq['enquiry_id']]) echo $_REQUEST['enquirenote_'.$row_select_enq['enquiry_id']];else echo $row_select_enq['enquiry_note'];?></textarea>&nbsp; <input name="buttonenqsaveone_<?=$row_select_enq['enquiry_id']?>" type="submit" class="buttonred_cart" id="buttonenqsaveone_<?=$row_select_enq['enquiry_id']?>" value="Save Note" /></td>
			 </tr></table></td>
			  </tr>
		  <?php
		  ...
		  <tr><td colspan="6" align="right" valign="middle">
         	 	...
         	 	<tr>
            		<td colspan="6" align="left" valign="middle" class="shoppingcartcontent">
						...
						<tr>
							<td class="shoppingcarttextlogin"><strong><?php echo $Captions_arr['CART']['CART_CUSTOMER_LOGIN']?></strong><a name="enqloginsec">&nbsp;</a></td>
							<td class="shoppingcarttextlogin">
							<?php
								if($Settings_arr['hide_newuser']==0) // check whether new user page is to be displayed
								{
							?>
							<span class="shoppingcartlogintdtext1"><strong><?php echo $Captions_arr['CART']['CART_NEW_USER']?> </strong></span>
							<?php
								}
								else
									echo '&nbsp;';
						...
						<tr>
							<td width="48%" align="left" valign="top" class="shoppingcartlogintd">
								<table width="100%" border="0" cellspacing="3" cellpadding="0">
								<tr>
								  <td colspan="2" class="shoppingcartlogintdtext1"><?php echo $Captions_arr['CART']['CART_SHOPPED_BEFORE']?>  </td>
								</tr>
								<tr>
								  <td width="29%" align="left" valign="middle"><?php echo $Captions_arr['CART']['CART_EMAIL']?></td>
								...
								<tr>
								  <td>&nbsp;</td>
								  <td><input name="custenquirelogin_Submit" type="submit" class="buttonred_cart" value="Login" onclick="document.frm_custlogin_enquire.pass_url.value = document.frm_enquire.pass_url.value" /></td>
								</tr>
								</table>
							</td>	
							<td width="52%" align="left" valign="top" class="shoppingcartlogintd">
								...
								?>
									...
									<tr>
										<td class="shoppingcartlogintdtext2"><?php echo $Captions_arr['CART']['CART_REGISTERED_CLICK_LINK']?></td>
									</tr>
									<tr>
										<td align="left"><input name="new_user_enquire" type="button" class="buttonred_cart" id="new_user_enquire" value="Sign Up" onclick="window.location='<?php url_link('registration.html?pagetype=enquire')?>'" /></td>
									</tr>
									</table>
								<?php
								}
...
function validate_Bottomregistration(frm)
{
	...
	else
	{
	  ...
	  <form method="post" name="frm_enquire_details" class="frm_cls" action="" onsubmit="return validate_allforms(this);">
			<input type="hidden" name="fpurpose" value="" />
	  <table width="100%" border="0" cellpadding="0" cellspacing="6" class="tbl_float">
	  <tr>
       ...
       <tr>
		...
		?>
                  ...
                  <tr>
                    ...
                    <td align="left" valign="top"><input name="txt_enqfname" value="<?=$row_cust['customer_fname']?>" type="text"></td>
                  </tr>
                  <tr>
                    <td class="regiconent" align="left" valign="top"><?=$Captions_arr['ENQUIRE']['ENQUIRE_DET_MNAME']?> </td>
                    <td align="left" valign="top"><input name="txt_enqmiddlename" value="<?=$row_cust['customer_mname']?>" type="text"></td>

                  </tr>
				   <tr>
                    <td class="regiconent" align="left" valign="top"><?=$Captions_arr['ENQUIRE']['ENQUIRE_DET_LNAME']?> </td>
                    <td align="left" valign="top"><input name="txt_enqlname" value="<?=$row_cust['customer_surname']?>" type="text"></td>
                  ...
                  <tr>
                    ...
                    <td align="left" valign="top"><input name="txt_enqpostcode" value="<?=$row_cust['customer_postcode']?>" type="text"></td>
                  </tr>
                  <tr>

                    <td class="regiconent" align="left" valign="top"><?=$Captions_arr['ENQUIRE']['ENQUIRE_DET_PHONE']?> <span class="redtext">*</span></td>
                    <td align="left" valign="top"><input name="txt_enqphone" value="<?=$row_cust['customer_phone']?>" type="text"></td>
                  </tr>
				  <tr>

                    <td class="regiconent" align="left" valign="top"><?=$Captions_arr['ENQUIRE']['ENQUIRE_DET_MOBILE']?></td>
                    <td align="left" valign="top"><input name="txt_enqmobile" value="<?=$row_cust['customer_mobile']?>" type="text"></td>
                  </tr>
                  <tr>
                    <td class="regiconent" align="left" valign="top"><?=$Captions_arr['ENQUIRE']['ENQUIRE_DET_FAX']?></td>
                    <td align="left" valign="top"><input name="txt_enqfax" value="<?=$row_cust['customer_fax']?>" type="text"></td>
                  </tr>
                  <tr>
                    <td class="regiconent" align="left" valign="top"><?=$Captions_arr['ENQUIRE']['ENQUIRE_DET_EMAIL']?><span class="redtext">*</span></td>
                    <td align="left" valign="top"><input name="txt_enqemail" value="<?=$row_cust['customer_email_7503']?>" type="text"></td>
                  </tr>
				   <tr>
...
<?php
						...
						echo generateselectbox('cbo_enqcountry',$country_arr,$row_cust['country_id'],'','showprofilestate(this.value)');	//showstate(this.value)
						?>						</td>
...
<?php 				$state_arr = array(-1=>'-- Select State --');
					if($row_cust['country_id'])
									...
									$state_arr[0] = '- Other -';
					  	echo generateselectbox('cbo_enqstate',$state_arr,$row_cust['customer_statecounty']);?></td>			
   ...
   <? 
	 ...
	 global $ecom_siteid,$db,$ecom_hostname,$Settings_arr,$ecom_themeid,$default_layout,$Captions_arr,$inlineSiteComponents;
		...
		?>
		<table width="100%" border="0" cellspacing="4" cellpadding="0" class="tbl_float">
      <tr>
        <td width="7%" align="left" valign="middle" class="shoppingcartheader" >
         <?php echo $header;?></td>
      
      </tr>
      <tr>
        <td align="left" valign="middle" class="shoppingcartcontent"><?php echo $message; ?></td>
		...
		function myenquiry_Enquiry($custid){
				...
				if($_REQUEST['srch_review_startdate'])
				{
				...
				if($_REQUEST['srch_review_enddate'])
				{
		...
		function myenquiry_EnquiryDetails($enqid)
		{
				...
				{
				$sqlpr = "select product_id,product_name,product_actualstock,product_weight,product_discount from products where product_id=".$rowp['products_product_id']."";	
