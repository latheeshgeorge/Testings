<?php
	...
	class shop_Html
	{
		...
		?>
		<div class="treemenu"><?php echo generate_shop_tree($row_shop['shopbrand_name']); // echo generate_tree($_REQUEST['shop_id'],-1)?></div>
				 ...
				 <tr>
		            ...
		            <input type="hidden" name="caturl" value="<? echo $url?>" />
                     ...
                     <input type='hidden' name='shop_id' value="<?=$_REQUEST['shop_id']?>"/>
				  	 <div class="categoreyimagediv" align="right"><a href="<?=url_Shop_PDF($_REQUEST['shop_id'],$row_shop['shopbrand_name'])?>" class="productdetailslink">
				  	 <!--<input name="catdetail_pdf" type="submit" class="buttonredpdf" id="catdetail_pdf" value="<?php //echo $Captions_arr['SHOP_DETAILS']['SHOPDET_DOWNLOADPDF']?>" />-->
					 <img src="<? url_site_image('pdf.gif')?>" border="0" alt="<?php echo $Captions_arr['SHOP_DETAILS']['SHOPDET_DOWNLOADPDF']?>" /></a></div>
				   </form>
				 	</td>
				 </tr>
		...
		?>
				...
				<?php	
					...
					{
				?>
						<td width="33%" align="left" valign="middle" class="subcategoreyimage" onmouseover="this.className='subcategory_hover'" onmouseout="this.className='subcategoreyimage'">
		...
		?>
                        ...
                        <option value="price" <?php echo ($prodsort_by=='price')?'selected="selected"':''?>><?php echo $Captions_arr['SHOP_DETAILS']['SHOPDET_PRICE']?></option>
                          ...
                          <select name="shopdet_sortordertop" id="shopdet_sortordertop">
                            ...
                            <option value="DESC" <?php echo ($prodsort_order=='DESC')?'selected="selected"':''?>><?php echo $Captions_arr['SHOP_DETAILS']['SHOPDET_HIGH2LOW']?></option>
                                                    </select><?php echo $Captions_arr['SHOP_DETAILS']['SHOPDET_ITEMSPERPAGE']?>
						<?php
			...
			<tr>
				...
				<?php
					...
					$product_compare_enabled = isProductCompareEnabled();
						switch($displaytype)
						{
							...
							?>
								...
								<?php
									...
									?>
										<tr>
											<td  class="pagingcontainertd" align="center">
											<?php 
												$path = '';
												$pageclass_arr['container'] = 'pagenavcontainer';
												$pageclass_arr['navvul']	= 'pagenavul';
