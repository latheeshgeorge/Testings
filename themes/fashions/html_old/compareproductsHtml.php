...
?>
				...
				<td align="left" valign="top" width="15%">&nbsp;</td>
				  ...
				  <tr>
					  <td align="left" valign="top">&nbsp;</td>
						...
						?>		
								...
								<?php
									...
									?>
										<?php
										 show_moreinfo($compare_arr['main'][$i],'product_info');
										...
										show_addtocart($compare_arr['main'][$i],$class_arr,$frm_name,false,$prefix,$suffix);
										?>
										</div>
								</form>
								</td>
					 ...
					 ?> 
						  <tr>
							<td colspan="6" align="left" valign="top" class="comparison_sec_header"><?php echo $Captions_arr['PROD_DETAILS']['PRODDET_COMPKEYFEATURE'];?></td>
						  </tr>
						  <?php 
