	...
	if ($from_date or $to_date)
	{
		...
		//print_r($ord_array );
		  ...
		  <table width="100%" border="0" cellpadding="3" cellspacing="0" class="tbl_float" >
			  <tr>
				<td colspan="12" align="left" valign="middle"><div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?php echo $Captions_arr['ORDERS']['ORDER_MAINHEADING']?></div>			    </td>
		      </tr>
              <tr>
                <td colspan="12" align="left" valign="middle"  ><br />
                <table  border="0" cellpadding="2" cellspacing="3" width="100%" class="userordertablestyleA">
                  <tr>
                    <td colspan="1" nowrap="nowrap" class="usermenucontent"><?php echo $Captions_arr['ORDERS']['ORDERID']?></td>
                    <td colspan="3" nowrap="nowrap" class="usermenucontent"><?php echo $Captions_arr['ORDERS']['ORDER_EMAIL']?></td>
				    <td colspan="5" nowrap="nowrap" class="usermenucontent" ><?php echo $Captions_arr['ORDERS']['ORDER_CUSTDET']?></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td colspan="5" nowrap="nowrap" class="usermenucontent"><?php echo $Captions_arr['ORDERS']['ORDER_BETDATE']?> </td>
                    <td colspan="4" nowrap="nowrap" class="usermenucontent"><?php echo $Captions_arr['ORDERS']['ORDER_SORTBY']?></td>
                  </tr>
                  <tr>
			  ...
			  <tr>
				...
				&nbsp;<?php echo $Captions_arr['ORDERS']['ORDER_NEWPOSTS']?></td>
			</tr>	 
            <tr>
            <td align="middle" valign="middle" class="ordertableheader" width="4%" ><?php echo $Captions_arr['ORDERS']['ORDER_ID']?></td>
            <td align="middle" valign="middle" class="ordertableheader" width="7%"><?php echo $Captions_arr['ORDERS']['ORDER_DATE']?></td>
          	 <td   align="middle" valign="middle" class="ordertableheader" width="8%"><?php echo $Captions_arr['ORDERS']['ORDER_EMAIL']?></td>
	         <td  align="middle" valign="middle" class="ordertableheader" width="5%" nowrap="nowrap"><?php echo $Captions_arr['ORDERS']['ORDER_STATUS']?></td>
             <td  align="middle" valign="middle" class="ordertableheader" width="4%"><?php echo $Captions_arr['ORDERS']['ORDER_TOTAL']?></td>
             <td  align="middle" valign="middle" class="ordertableheader" width="4%"><?php echo $Captions_arr['ORDERS']['ORDER_REFUND']?></td>
            <td   align="middle" valign="middle" class="ordertableheader" width="4%"><?php echo $Captions_arr['ORDERS']['ORDER_PAYSTAT']?></td>
		  </tr>
	<?php
		 ...
		 ?>
	        ...
	        <tr>
					<td align="center" valign="middle" class="shoppingcartcontent" colspan="12" >
						<?php echo $Captions_arr['ORDERS']['ORDER_NOTFOUNDORDER']?>		</td>
			</tr>	
		 <?
...
<tr><td  width="100%" colspan="4">
  <table width="100%" border="0" cellpadding="1" cellspacing="1" id="enqDetails" <?PHP if(!$_REQUEST['ord_pg']) { ?> style="display:none;" <? } ?> >
    ...
    <tr>
      ...
      <td width="42%" class="ordertableheader" align="center" valign="top"><?php echo $Captions_arr['ORDERS']['ORDER_DATE']?></td>
      <td width="23%" class="ordertableheader" align="left" valign="top"><?php echo $Captions_arr['ORDERS']['ORDER_ENQ_SUB']?></td>
      <td width="14%" class="ordertableheader" align="center" valign="top"><?php echo $Captions_arr['ORDERS']['ORDER_ENQ_STATUS']?></td>
      <td width="12%" class="ordertableheader" align="center" valign="top"><?php echo $Captions_arr['ORDERS']['ORDER_ENQ_NEWPOSTS']?></td>
    </tr>
	<?PHP if($num>0) {
				...
				?>
					<tr class="edithreflink_tronmouse" title="<?php echo $Captions_arr['MY_DOWNLOADS']['DOWN_DOWNLOAD']?>" onmouseover="this.className='edithreflink_trmouseout'" onmouseout="this.className='edithreflink_tronmouse'">
					  ...
					  <?php
						...
						<?php
							if($row_query['order_paystatus']=='Paid' and $force_hide_download_link==false)
							{
						...
						<?php
							...
							{
								if($row_query['order_paystatus']=='Paid')
								{
									if ($row_query['disabled']=='Y')
