<?php
	...
	class cart_Html
	{
		...
		?>
	    	...
	    	<td align="left" valign="top" class="cart_td">	
			...
			<?php
				...
				?>
			  <tr>
				<td colspan="5" align="left" valign="middle" class="shoppingcartheader"><?php echo $Captions_arr['CART']['CART_MAINHEADING']?></td>
			  ...
			  <tr>
				<td align="left" valign="middle" class="shoppingcartheader"><?php echo $Captions_arr['CART']['CART_ITEM']?></td>
				<td align="left" valign="middle" class="shoppingcartheader"><?php echo $Captions_arr['CART']['CART_PRICE']?></td>
				<td align="center" valign="middle" class="shoppingcartheader"><?php echo $Captions_arr['CART']['CART_AVAIL']?></td>
				<td align="center" valign="middle" class="shoppingcartheader"><?php echo $Captions_arr['CART']['CART_DISCOUNT']?></td>
				<td align="left" valign="middle" class="shoppingcartheader"><?php echo $Captions_arr['CART']['CART_QTY']?></td>
				<td align="right" valign="middle" class="shoppingcartheader"><?php echo $Captions_arr['CART']['CART_TOTAL']?></td>
			  </tr>
		  <?php
		  ...
		  else
		  {
			  ...
			  ?>
				  <tr>
					...
					?>
					<a href="<?php echo url_product($products_arr['product_id'],$products_arr['product_name'])?>" title="<?php echo $products_arr['product_name']?>" class="shoppingcartprod_link"><?php echo $products_arr['product_name']?></a>
					<?
						// If variables exists for current product, show it in the following section
						if ($products_arr['prod_vars'] or $products_arr['prod_msgs'] )  
							echo '<br/>';
					...
					<td align="left" valign="middle" class="shoppingcartpriceB"><?php echo print_price($products_arr['product_webprice'])?></td>
					...
					-<?php 
							...
							if ($products_arr["prom_prodcode_disc"] and $products_arr["savings"]["product"]) // Case if promotional code disc is there for current product
								echo $Captions_arr['CART']['CART_PROM_DISC'].' '.print_price($products_arr["savings"]["product"]);
							...
							{	
								...
								echo ' <br/>'.print_price($products_arr["savings"]["product"]);
							}
							elseif($products_arr['savings']['product_combo']) // Check whether combo discount is there
							{
								echo $Captions_arr['CART']['CART_COMBO_DISC'].'<br/> '.print_price($products_arr["savings"]["product_combo"]);
							}
							elseif($products_arr["savings"]["bulk"]) // Check whether bulk discount is there
							{
								echo $Captions_arr['CART']['CART_BULK_DISC'].' <br/>'.print_price($products_arr["savings"]["bulk"]);
							}
							else
								echo print_price($products_arr["savings"]["product"]);
					?>
					</td>
					<td align="left" valign="middle" class="shoppingcartcontent">
					<div class="updatediv" align="left"><input name="cart_qty_<?php echo $products_arr['cart_id']?>" type="text" id="cart_qty_<?php echo $products_arr['cart_id']?>" size="3" maxlength="3" value="<?php echo $products_arr["cart_qty"]?>" class="input_gray" />
					</div> 
					<div class="updatediv" align="left"><a href="#" onclick="document.frm_cart.remcart_id.value='<?php echo $products_arr['cart_id']?>';handle_form_submit(document.frm_cart,'Update_qty','#upd')" title="<?php echo $Captions_arr['CART']['CART_UPDATE']?>"><img src='<?php url_site_image('cart_update.gif')?>' border="0" alt="<?php echo $Captions_arr['CART']['CART_UPDATE']?>"></a>  <a href="#" class="update_link" onclick="if (confirm_message('<?php echo $Captions_arr['CART']['CART_ITEM_REM_MSG']?>')) {document.frm_cart.remcart_id.value='<?php echo $products_arr['cart_id']?>';handle_form_submit(document.frm_cart,'Remove_qty','#rem')}" title="<?php echo $Captions_arr['CART']['CART_REMOVE']?>"><img src='<?php url_site_image('cart_remove.gif')?>' border="0" alt="<?php echo $Captions_arr['CART']['CART_REMOVE']?>"></a></div></td>
					<td align="right" valign="middle" class="shoppingcartpriceA"><?php echo print_price($products_arr['final_price'])?></td>
				  </tr>
				  <?php
			  }
		  ?>
			 	<tr>
				<td align="right" valign="middle" class="shoppingcartcontent" colspan="5"><?php echo $Captions_arr['CART']['CART_TOTPRICE']?></td>
				<td align="right" valign="middle" class="shoppingcartpriceC"><?php echo print_price($cartData["totals"]["subtotal"])?></td>
			  </tr>
		  <?php
		  ...
		  ?>
				...
				{ 
					...
					?>
						<tr>
							...
							<? print print_price($cartData["delivery"]["group".$i]["cost"])?></td>
						</tr>
					<?
					}				
				} 
			...
			<tr>
				...
				<td align="right" valign="middle" class="shoppingcartpriceC"><?php echo print_price($cartData["totals"]["delivery"])?></td>
			  </tr>
			<?php
			}
			 ...
			 ?>
				 <tr>
					...
					<td align="right" valign="middle" class="shoppingcartpriceC"><?php echo print_price($cartData["totals"]["extraShipping"])?></td>
				  </tr>
			 <?php	
			 }
			 ...
			 ?>
					<tr>
						...
						<?	
							foreach($cartData["tax"] as $tax)
							{
								echo print_price($tax["charge"]); ?> <br />
						<?	
							}
						?>
						</td>
				...
				if (($row_cartdet['promotionalcode_id']!=0 or $row_cartdet['voucher_id']!=0))
				{
				 ?>
				  <tr>
					...
					<?php 
					if ($row_cartdet['promotionalcode_id']!=0 and $cartData["bonus"]['type']=='promotional' and $cartData['totals']['pro_type']!='product')
						echo ($cartData['totals']['lessval']>0)?print_price($cartData['totals']['lessval']):0;
					elseif($row_cartdet['voucher_id']!=0 and $cartData["bonus"]['type']=='voucher')
						echo ($cartData['totals']['lessval']>0)?print_price($cartData['totals']['lessval']):0;
					  ...
					  <table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
						  ...
						  <?php
							...
							?>
									<input name="cart_savepromotional" type="hidden" id="cart_savepromotional" value="0"/>	
								 	<input name="cancel_promotionalcode" type="button" class="buttonblack" id="cancel_promotionalcode" value="<?php echo $Captions_arr['CART']['CART_PROMO_CANCEL_BUTTON']?>" onclick="document.frm_cart.cart_savepromotional.value=1;handle_form_submit(document.frm_cart,'save_commondetails','#a_prom')" />
						  <?php
						  	}
						  	elseif ($cartData["bonus"]['type']=='')
							{
						  ?>
							  	...
							  	<input name="submit_promotionalcode" type="button" class="buttonblack" id="submit_promotionalcode" value="<?php echo $Captions_arr['CART']['CART_PROMO_GO']?>" onclick="document.frm_cart.cart_savepromotional.value=1;handle_form_submit(document.frm_cart,'save_commondetails','')" />
						  <?php
						  	}
						  ?>
		  ...
		  <?php
				  ...
				  <?php
					...
					?>
					  <tr>
						...
						<td colspan="2" align="right" valign="top" class="shoppingcartpriceC"><? echo print_price($cartData["bonus"]["value"]);?></td>
					  </tr>
			<?php	
					}
				}
			...
			?>
			  ...
			  <tr>
				...
				<td align="right" valign="middle" class="shoppingcartpriceC"><?php echo print_price($cartData["totals"]["bonus_price"])?></td>
			  </tr>
		  <?php
		  	}
			...
			?>
				<tr>
					...
					<td align="right" valign="middle" class="shoppingcartpriceC"><?php echo print_price($str_reduceval)?></td>
			  	</tr>
				<tr>
					<td colspan="5" align="right" valign="middle" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_TOTAL_AMT_NOW']?>&nbsp; </td>
					<td align="right" valign="middle" class="shoppingcartpriceC"><?php echo print_price($rem_val)?>
			...
			if($db->num_rows($ret_google))
			{
				...
				$google_exists = false;
			if($google_exists && $Captions_arr['CART']['CART_PAYMENT_MULTIPLE_MSG'])
			{	
		  ?>
		  		<tr>
					<td colspan="6" align="left" valign="middle" class="shoppingcartcontent">
			...
			<?php
				...
				if ($db->num_rows($ret_paytypes))
				{
						...
						if ($Settings_arr['paytype_listingtype']=='dropdown') // Case of payment listing type is to shown as drop downbox
						{
							...
							while ($row_paytypes = $db->fetch_array($ret_paytypes))
							{
								if($row_paytypes['paytype_code']=='pay_on_account')
								{
									...
									$add_text = '';
								$paymethod[$row_paytypes['paytype_id']] = stripslashes($row_paytypes['paytype_name']).$add_text;	
								if($row_paytypes['paytype_code']=='credit_card')
								{
									if($row_paytypes['paytype_id']==$row_cartdet['paytype_id'])
										$cc_exists = true;
					...
					?>	
							  ...
							  <table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
								  <td width="49%" align="center"><a name="a_pay">&nbsp;</a><?php echo $Captions_arr['CART']['CART_SEL_PAYTYPE']?></td>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
								  ...
								  ?>
										...
										<?php
											...
											?>
											<input class="shoppingcart_radio" type="radio" name="cart_paytype" id="cart_paytype" value="<?php echo $row_paytypes['paytype_id']?>" <?php echo ($row_paytypes['paytype_id']==$row_cartdet['paytype_id'])?'checked="checked"':''?> <?php echo $on_change?>/><?php echo stripslashes($row_paytypes['paytype_name']).$add_text?>
										</td>
								<?php
										$pay_cnt++;
							...
							?>
								<table width="100%" border="0" cellspacing="0" cellpadding="0" id="paymethod_id">
								  ...
								  ?>
										...
										<tr>
											<td align="left" valign="top" width="2%" class="shoppingcartcontent">
											<input class="shoppingcart_radio" type="radio" name="cart_paymethod" id="cart_paymethod" value="<?php echo $row_paymethods['paymethod_id']?>" <?php echo ($row_paymethods['paymethod_id']==$row_cartdet['paymethod_id'])?'checked="checked"':''?> />
											</td>
          ...
          <tr>
            <td colspan="6" align="right" valign="middle" class="shoppingcartcontent">
			  ...
			  ?>	
             		 ...
             		 <input name="continue_checkout" type="button" class="buttonred_cart" id="continue_checkout" value="<?php echo $Captions_arr['CART']['CART_GO_CHKOUT']?>" onclick="handle_checkout_submit('<?php echo $ecom_hostname?>',0)" />
             		</div> 
			  <?php
			  	}
				else
		...
		<?php
		  ...
		  ?>
				...
				<td colspan="6" align="left" valign="middle" class="shoppingcartcontent">
					<table width="100%" border="0" cellspacing="1" cellpadding="1">
					<tr>
						<td class="shoppingcartlogintdtext1" valign="top"><?php echo $Captions_arr['CART']['CART_SHOPPED_BEFORE']?>  </td>
					...
					<tr>
						<td colspan="2" align="right"><input name="custcartlogin_Submit" type="submit" class="buttonred_cart" value="<?php echo $Captions_arr['CART']['CART_LOGIN']?>" onClick="document.frm_custlogin_cart.pass_url.value = document.frm_cart.pass_url.value" /></td>
						<td align="right">
						<?php
						if($Settings_arr['hide_newuser']==0) // check whether new user page is to be displayed
						{
		...
		{
			global $ecom_siteid,$db,$ecom_hostname,$Settings_arr,$ecom_themeid,$default_layout,$Captions_arr,$inlineSiteComponents,$Settings_arr,$protectedUrl;
			$session_id 			= session_id();	// Get the session id for the current section
			$cust_id				= get_session_var("ecom_login_customer"); // Get the customer id from session
			$Captions_arr['CART'] 	= getCaptions('CART'); // Getting the captions to be used in this page
			...
			if($protectedUrl)
				$http = url_protected('checkout.html',1);
			else 	
		...
		?>	
			...
			<?php
				...
				?>
			  <tr>
				<td colspan="6" align="left" valign="middle" class="shoppingcartheader"><?php echo $Captions_arr['CART']['CART_CHECKOUTHEADING']?></div></td>
			  </tr>
			  <tr>
				<td align="left" valign="middle" class="shoppingcartheader"><?php echo $Captions_arr['CART']['CART_ITEM']?></td>
				<td align="left" valign="middle" class="shoppingcartheader"><?php echo $Captions_arr['CART']['CART_PRICE']?></td>
				<td align="center" valign="middle" class="shoppingcartheader"><?php echo $Captions_arr['CART']['CART_AVAIL']?></td>
				<td align="center" valign="middle" class="shoppingcartheader"><?php echo $Captions_arr['CART']['CART_DISCOUNT']?></td>
				<td align="center" valign="middle" class="shoppingcartheader"><?php echo $Captions_arr['CART']['CART_QTY']?></td>
				<td align="right" valign="middle" class="shoppingcartheader"><?php echo $Captions_arr['CART']['CART_TOTAL']?></td>
			  </tr>
		  <?php
		  if (count($cartData['products'])==0) // Done to show the message if no products in cart
			  ...
			  ?>
				  <tr>
					...
					-<?php 
							// if combo disc exists then that should be displayed otherwise the normal or promotional disc is to be shown
							if ($products_arr["prom_prodcode_disc"] and $products_arr["savings"]["product"]) // Case if promotional code disc is there for current product
								echo $Captions_arr['CART']['CART_PROM_DISC'].'<br/> '.print_price($products_arr["savings"]["product"]);
							elseif ($products_arr["cust_disc_type"] !='' and $products_arr["savings"]["product"]) // Case if promotional code disc is there for current product
							{	
								switch($products_arr['cust_disc_type'])
								{
					...
					<td align="center" valign="middle" class="shoppingcartcontent">
					<?php echo $products_arr["cart_qty"]?>
					</td>
					<td align="right" valign="middle" class="shoppingcartpriceA"><?php echo print_price($products_arr['final_price'])?></td>
				  </tr>
				  <?php
		  ...
		  <?php
			...
			?>	
						<tr>
						<td colspan="5" align="left" valign="middle" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_GIFTWRAP_REQ']?> (<?php echo print_price($row_gift['giftwrap_minprice'],true)?>)</td>
						<td colspan="1" align="right" valign="middle" class="shoppingcartcontent"><?php if ($row_cartdet['giftwrap_req']==1) echo 'Yes'?></td>
						</tr>
					<?php
					...
					?>
						<tr>
							<td colspan="5" align="left" valign="middle" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_GIFTWRAP_MSG']?>(<?php echo print_price($row_gift['giftwrap_messageprice'],true)?>)</td>
							<td colspan="1" align="right" valign="middle" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_YES']?></td>
						</tr>
						<tr>
							<td colspan="5" align="left" valign="middle" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_MSG']?></td>
							<td colspan="1" align="right" valign="middle" class="shoppingcartcontent"><?php echo nl2br(stripslashes($row_cartdet['giftwrap_msg']))?></td>
						</tr>
					<?php
						}
					...
					?>
						<tr>
							<td colspan="5" align="left" valign="middle" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_RIBBON']?>(<?php echo print_price($row_ribbon['ribbon_extraprice'],true)?>)</td>
							<td colspan="1" align="right" valign="middle" class="shoppingcartcontent"><?php echo stripslashes($row_ribbon['ribbon_name'])?></td>
						</tr>
					<?php	
						}
					...
					?>
						<tr>
							<td colspan="5" align="left" valign="middle" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_PAPER']?>(<?php echo print_price($row_paper['paper_extraprice'],true)?>)</td>
							<td colspan="1" align="right" valign="middle" class="shoppingcartcontent"><?php echo stripslashes($row_paper['paper_name'])?></td>
						</tr>
					<?php	
						}
					...
					?>
						<tr>
							<td colspan="5" align="left" valign="middle" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_CARDS']?>(<?php echo print_price($row_card['card_extraprice'],true)?>)</td>
							<td colspan="1" align="right" valign="middle" class="shoppingcartcontent"><?php echo stripslashes($row_card['card_name'])?></td>
						</tr>
					<?php	
						}
					...
					?>
						<tr>
							<td colspan="5" align="left" valign="middle" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_BOWS']?>(<?php echo print_price($row_bow['bow_extraprice'],true)?>)</td>
							<td colspan="1" align="right" valign="middle" class="shoppingcartcontent"><?php echo stripslashes($row_bow['bow_name'])?></td>
						</tr>
					<?php	
						}
			...
			if ($deliverydet_Arr['delivery_type'] != 'None') // Check whether any delivery method is selected for the site
			{
				...
				?>	
							<tr>
								<td colspan="5" align="left" valign="middle" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_DELIVERY_LOC']?></td>
								<td colspan="1" align="right" valign="middle" class="shoppingcartcontent"><?php echo stripslashes($row_loc['location_name'])?></td>
							</tr>
				<?php
						}
					}
				...
				?>	
							<tr>
								<td colspan="5" align="left" valign="middle" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_DELIVERY_OPT']?></td>
								<td colspan="1" align="right" valign="middle" class="shoppingcartcontent"><?php echo stripslashes($row_grp['delivery_group_name'])?></td>
							</tr>
				<?php
						}
					}	
				...
				?>
					<tr>
						<td colspan="5" align="left" valign="middle" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_DELIVERY_SPLIT_ACTIVATED']?></td>
						<td colspan="1" align="left" valign="middle" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_YES']?></td>
					</tr>
				<?php	
				}
				// Section to handle the case of split orders selected 
				...
				{ 
					...
					?>
						<tr>
							...
							<td class="shoppingcartcontent" colspan="3" align="left">
							<? print print_price($cartData["delivery"]["group".$i]["cost"])?>
							</td>
						</tr>
					<?
					}				
		  ...
		  <?php
			 ...
			 ?>
					<tr>
						...
						<td align="right" valign="top" class="shoppingcartpriceC">
						<?	
							echo print_price($cartData["totals"]["tax"]);
						?>						</td>
					</tr>
				<?php
			}
				...
				if (($row_cartdet['promotionalcode_id']!=0 or $row_cartdet['voucher_id']!=0))
				{
				 ?>
				  <tr>
					...
					<?php 
					if ($row_cartdet['promotionalcode_id']!=0 and $cartData["bonus"]['type']=='promotional' and $cartData['totals']['pro_type']!='product')
						echo print_price($cartData['totals']['lessval']);
					elseif($row_cartdet['voucher_id']!=0 and $cartData["bonus"]['type']=='voucher')
						echo print_price($cartData['totals']['lessval']);
					?></td>
				  </tr>
				...
				if ($cartData["customer"]["customer_bonus"]) // does current customer have bonus points
				{
					...
					?>
					  <tr>
						...
						<td align="right" valign="top" class="shoppingcartpriceC"><? echo print_price($cartData["bonus"]["value"]);?></td>
					  </tr>
			<?php	
					}
				}
...
//				$cont_class = 'shoppingcartcontent_noborder'; 
				...
				if(frm.checkoutpay_cardtype)
				{
					if(frm.checkoutpay_cardtype.value)
					{
						...
						if(objarr.length==4) /* if the value splitted to exactly 4 elements*/
						{
							...
							{
								alert('Credit card number should not contaion more than '+cc_count+' digits');
								frm.checkoutpay_cardnumber.focus();
								return false;
							}
		...
		?>	
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="shoppingcarttable">
			  <tr>
				<td colspan="6" align="left" valign="middle" class="shoppingcartheader"><?php echo $Captions_arr['CART']['CART_CHECKOUTPREVIEWHEADING']?></td>
			  </tr>
			  <tr>
				<td align="left" valign="middle" class="shoppingcartheader"><?php echo $Captions_arr['CART']['CART_ITEM']?></td>
				<td align="left" valign="middle" class="shoppingcartheader"><?php echo $Captions_arr['CART']['CART_PRICE']?></td>
		 ...
		 <?php
			  ...
			  while($row_orddet = $db->fetch_array($ret_orddet))
			  {
				...
				?>
				  <tr>
					...
					<td align="left" valign="middle" class="shoppingcartpriceB"><?php echo print_price($row_orddet['order_retailprice'])?></td>
					...
					-<?php 
							if ($row_orddet["order_discount"]>0)
							{
								...
								if ($row_orddet["order_discount_type"]=='promotional') // Case if promotional code disc is there for current product
									echo $Captions_arr['CART']['CART_PROM_DISC'].' '.print_price($row_orddet["order_discount"]);
								elseif($row_orddet["order_discount_type"]=='combo') // Check whether combo discount is there
								{
									echo $Captions_arr['CART']['CART_COMBO_DISC'].' '.print_price($row_orddet["order_discount"]);
								}
								elseif($row_orddet["order_discount_type"]=='bulk') // Check whether bulk discount is there
								{
									echo $Captions_arr['CART']['CART_BULK_DISC'].' '.print_price($row_orddet["order_discount"]);
								}
								else
									echo print_price($row_orddet["order_discount"]);
							}		
					?>
					</td>
					<td align="center" valign="middle" class="<?php echo $trmainclass?>">
					<?php echo $row_orddet["order_qty"]?>
					</td>
					<td align="right" valign="middle" class="shoppingcartpriceA"><?php echo print_price($row_orddet['order_rowtotal'])?></td>
				  </tr>
				  <?php
				  	// If variables exists for current product, show it in the following section
					if ($vars_exists) 
		  ...
		  <?php
			...
			?>	
						<tr>
						<td colspan="5" align="left" valign="middle" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_GIFTWRAP_REQ']?> (<?php echo print_price($row_ord['order_giftwrap_minprice'],true)?>)</td>
						<td colspan="1" align="right" valign="middle" class="shoppingcartcontent"><?php if ($row_ord['order_giftwrap']=='Y') echo 'Yes'?></td>
						</tr>
					<?php
					...
					?>
						<tr>
							<td colspan="5" align="left" valign="middle" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_GIFTWRAP_MSG']?>(<?php echo print_price($row_ord['order_giftwrap_message_charge'],true)?>)</td>
							<td colspan="1" align="right" valign="middle" class="shoppingcartcontent">Yes</td>
						</tr>
						<tr>
							<td colspan="5" align="left" valign="middle" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_MSG']?></td>
							<td colspan="1" align="right" valign="middle" class="shoppingcartcontent"><?php echo nl2br(stripslashes($row_ord['order_giftwrapmessage_text']))?></td>
						</tr>
					<?php
						}
					...
					?>
								<tr>
									...
									<td colspan="1" align="right" valign="middle" class="shoppingcartcontent"><?php echo stripslashes($row_giftwrap_det['giftwrap_name'])?></td>
								</tr>
					<?php		
							}
					?>
								<tr>
									<td colspan="5" align="right" valign="middle" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_GIFTWRAP_TOTAL']?></td>
									<td align="right" valign="middle" class="shoppingcartpriceC"><?php echo print_price($row_ord["order_giftwraptotal"])?></td>
								</tr>
					<?php		
						}
			}	
			...
			if ($row_ord['order_deliverytype'] != 'None') // Check whether any delivery method is selected for the site
			{
				...
				?>	
							<tr>
								<td colspan="5" align="left" valign="middle" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_DELIVERY_LOC']?></td>
								<td colspan="1" align="right" valign="middle" class="shoppingcartcontent"><?php echo stripslashes($row_ord['order_deliverylocation'])?></td>
							</tr>
				<?php
					}
					// Check whether any delivery group exists for the site
				...
				?>	
							<tr>
								<td colspan="5" align="left" valign="middle" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_DELIVERY_OPT']?></td>
								<td colspan="1" align="right" valign="middle" class="shoppingcartcontent"><?php echo stripslashes($row_ord['order_delivery_option'])?></td>
							</tr>
				<?php
					}	
				...
				?>
				  <tr>
					<td colspan="5" align="right" valign="middle" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_TOTAL_DELIVERY_CHARGES']?></td>
					<td align="right" valign="middle" class="shoppingcartpriceC"><?php echo print_price($row_ord["order_deliverytotal"])?></td>
				  </tr>
		  <?php
		  		}
		  	}
			 ...
			 ?>
				<tr>
					...
					<td align="right" valign="middle" class="shoppingcartpriceC">
					<?php 
						echo print_price($row_ord['order_customer_discount_value']);
					?>
					</td>
				</tr>
			 <?php
		  ...
		  <?php
			...
			if ($row_ord['order_bonuspoints_used']>0)
			{
				...
				?>
					  <tr>
						<td colspan="5" align="right" valign="top" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_SPENT_BONUS_POINTS_VALUE']?> </td>
						<td align="right" valign="top" class="shoppingcartpriceC"><? echo print_price($row_ord['order_bonuspoint_discount']);?></td>
					  </tr>
			<?php	
				}
			}
			...
			?>
			  ...
			  <tr>
				<td colspan="5" align="right" valign="middle" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_TOTAL_FINAL_COST']?>&nbsp; </td>
				<td align="right" valign="middle" class="shoppingcartpriceC"><?php echo print_price($row_ord['order_totalprice'])?></td>
			  </tr>
		  <?php
		  	}
			...
			?>
				<tr>
					<td colspan="5" align="right" valign="middle" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_LESS_AMT_LATER']?>&nbsp; </td>
					<td align="right" valign="middle" class="shoppingcartpriceC"><?php echo print_price($row_ord['order_deposit_amt'])?></td>
			  	</tr>
				<tr>
					<td colspan="5" align="right" valign="middle" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_TOTAL_AMT_NOW']?>&nbsp; </td>
			...
			<?php
				...
				$colspan_left 		= 1;
				$colspan_right		= 5;
				$left_class			= 'shoppingcartcontent_noborder';
				$right_class			= 'shoppingcartcontent_noborder';
		...
		?>	
			...
			<?php
				...
				?>
							<tr>
								<td align="left" colspan="1" class="shoppingcartcontent_noborder">
								<?php echo stripslashes($row_checkout['field_name'])?>
								</td>
								<td align="left" colspan="5" class="shoppingcartcontent_noborder">
								<?php
			...
			?>
			  <tr>
				<td colspan="1" align="left" valign="middle" class="shoppingcartcontent">			
		...
		{
			global $db,$ecom_hostname,$Captions_arr,$ecom_siteid,$ecom_isadword,$ecom_adword_conversionid,$ecom_adword_conversionlanguage,$ecom_adword_conversionformat,$ecom_adword_conversioncolor,$ecom_adword_conversionlabel;
			$show_downloadable_msg = '';
			if ($order_id>0)
			{
				// Get the grand total from orders table for current order
				$sql_ord = "SELECT order_totalprice,order_paystatus  
								FROM 
									orders 
								WHERE 
									order_id=".$order_id." 
				...
				if($db->num_rows($ret_ord))
				{
					...
					if($_SESSION['cpc_click_id'] > 0) {
						seo_revenue_report($total_price);
					}
		...
		?>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="shoppingcarttable">
			  <tr>
				<td align="left" valign="middle" class="shoppingcartheader"><?php echo $Captions_arr['CART']['CART_CHECKOUT_SUCCESS_TITLE']?></div></td>
			  </tr>
			  <tr>
			...
			?>
				 ...
				 <tr>
					...
					<a href="http://<?php echo $ecom_hostname; ?>/mydownloads.html" title="<?php echo $Captions_arr['CART']['CART_DOWNLOAD_LIST_LINK']?>" class="favoriteprodlink"><?php echo $Captions_arr['CART']['CART_DOWNLOADABLE_LINK']?> </a><?php echo $Captions_arr['CART']['CART_DOWNLOADABLE_LINK_CONT']?>.
					</td>
				</tr>
			<?php
				}			
		...
		?>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="shoppingcarttable">
			<tr>
				<td align="left" valign="middle" class="shoppingcartheader"><?php echo $Captions_arr['CART']['CART_CHECKOUT_FAILED_TITLE']?></div></td>
			</tr>
			<?php
				if($msg)
				{
