<?php
	...
	elseif ($bestseller_type == 0) // case of automatic picking
	{
		...
		$sql_best = "SELECT a.product_id,a.product_name,a.product_variablestock_allowed,a.product_show_cartlink,
							a.product_preorder_allowed,a.product_show_enquirelink,a.product_webstock,a.product_webprice,
							a.product_discount,a.product_discount_enteredasval,a.product_bulkdiscount_allowed,
							product_total_preorder_allowed,a.product_applytax,a.product_shortdesc,sum(b.order_qty) as totcnt ,
							a.product_stock_notification_required,a.product_alloworder_notinstock   
						FROM 
							products a,order_details b,orders p 
						WHERE 
								...
								switch($Settings_arr['bestseller_prodlisting'])
								{
									...
									?>
										...
										<?
											...
											{
										?>
											<div class="best_seller_heading"><?php echo stripslashes($Captions_arr['BEST_SELLERS']['BEST_SELLER_CAPTION']);?>
												</div>
										<?php		
											}
											if ($tot_cnt>0 )
