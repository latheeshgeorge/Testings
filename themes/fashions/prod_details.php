<?php
	/*#################################################################
	# Script Name 	: prod_details.php
	# Description 		: This is the page for product details
	# Coded by 		: Sny
	...
	{
		$split_span				= 'colspan="3"'; // this variable is used to split the columns for items in top table
	}	
...
<table class="maintable" border="0" cellspacing="0" cellpadding="0">
 <?php
	...
	?>
		<td align="left" valign="top" class="pro_det_right">
			<?php
			// Showing the right components
			$position = 'right';
			include("Components.php");
			?>
		</td>
