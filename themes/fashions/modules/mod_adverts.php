<?php
	...
	if($_REQUEST['product_id'])
	{
			$sql_advert = "SELECT a.advert_id,a.advert_source,a.advert_link,a.advert_target,
									...
									a.advert_rotate_speed,a.advert_rotate_height   
						FROM 
	...
	/*if (count($advert_arr)==0)
	{
		...
		$sql_advert = "SELECT a.advert_id,a.advert_source,a.advert_link,a.advert_target,
							...
							ORDER BY 
								a.advert_order ASC ";
		$ret_advert = $db->query($sql_advert);
		//$active_start_arr 	= explode(" ",$row_advert['advert_displaystartdate']);
		
		//$end_date_arr  =  split_date_new($active_end_arr[0]);
