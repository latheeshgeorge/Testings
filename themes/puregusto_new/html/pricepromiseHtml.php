		...
		<div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >>
		 ...
		 <?=stripslashes($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_TREEMENU_TITLE'])?></div>
				...
				?>
					...
					?>
					<tr>
					<td colspan="3"  align="right" ><input type="button" class="pricepromise_addtocart" value="<?=stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_ADD_TO_CART'])?>" name="price_AddtoCart" onclick="document.frm_priceAddcart.submit()" /></td>
					</tr>		
					</tbody></table>
					</div>
					</div>
			...
			?>
					...
					<input type="hidden" name="search_click" value="search_click" />
							...
							<table  border="0" cellpadding="2" cellspacing="3" width="100%" class="userordertablestyleA">
							  ...
							  <tr>
								<td width="11%" nowrap="nowrap" class="usermenucontent" valign="top"><input name="prm_fromdate" id="prm_fromdate" class="textfeild" type="text" size="8" value="<?php echo $_REQUEST['prm_fromdate']?>" /></td>
								<td width="6%" nowrap="nowrap" valign="top"><?php /*<a href="javascript:show_calendar('frm_promise.prm_fromdate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('show-calendar.gif')?>" width="24" height="22" border="0" /></a>*/?></td>
								...
								<td width="11%" nowrap="nowrap" class="usermenucontent" valign="top"><input name="prm_todate" id="prm_todate" class="textfeild" id="prm_todate" type="text" size="8" value="<?php echo $_REQUEST['prm_todate']?>" />
								<?php /*<a href="javascript:show_calendar('frm_promise.prm_fromdate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;">								</a>*/?></td>
								<td width="10%" nowrap="nowrap" valign="top"><?php /*<a href="javascript:show_calendar('frm_promise.prm_todate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('show-calendar.gif')?>" width="24" height="22" border="0" /></a>*/?></td>
							...
							<script type="text/javascript">
							  jQuery.noConflict();
									var $ajax_js = jQuery; 
									$ajax_js(function() {
											$ajax_js( "#prm_fromdate" ).datepicker({dateFormat: "dd-mm-yy"});
											$ajax_js( "#prm_todate" ).datepicker({dateFormat: "dd-mm-yy"});
								});
							</script>
