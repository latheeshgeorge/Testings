...
.mybackground { background:#eeee }
    ...
    $j(document).ready( function() {
        ...
        $j('#popupBoxClose').click( function() {           
         ...
         $j('.clickp').click( function() {
			 var id = this.id;
			 //var frm = "name-"+id;
			var formid = $j("#"+id).children("form")[0];
			var frm =formid.name;
             loadPopupBox(frm);
        });

        function unloadPopupBox() {    // TO Unload the Popupbox
			$j('#popup_box1').fadeOut("slow");
            $j('#popup_box').fadeOut("slow");
            $j("#container").css({ // this is just for style       
                "opacity": "1" 
            });
        }   
       <?php $pageq_read = 'add_tocart_ajax.php';?>
        function loadPopupBox(frm) {    // To Load the Popupbox
			var dataString = $j("#"+frm).serialize();
			$j.ajax({
			url: "../../../includes/base_files/<?=$pageq_read?>",
			type: 'POST',
			data: dataString,
			...
			$j('#popup_box1').fadeIn("slow");
			$j('#popup_box').fadeIn("slow");

			$j('#popup_box').html(data);
...
<div id="popup_box">    <!-- OUR PopupBox DIV-->
							...
							?>
								...
								<div class="<?php echo $maincls?>" id="hover<?php echo $row_prod['product_id']?>" >
<?php	
						...
						<?php				}
										...
										<div class="contenthover">
												...
												<div id="<?php echo $row_prod['product_id'] ?>" class="clickp">Quick View
										...
										$j('#hover<?php echo $row_prod['product_id']?>').contenthover({
