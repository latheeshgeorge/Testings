<?php
	...
	class cart_Html
	{
		...
		<script type="text/javascript">
		 function cust_login_submit()
		 {
			if(document.frm_cart.custlogin_uname.value=='Email' || document.frm_cart.custlogin_uname.value==' ')
			{ alert('Enter Valid Email Address'); 
			  return false;
			}
			  document.frm_custlogin_cart.custlogin_uname.value = document.frm_cart.custlogin_uname.value;
			  document.frm_custlogin_cart.custlogin_pass.value = document.frm_cart.custlogin_pass.value;
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td><table  border="0" cellpadding="0" cellspacing="0" class="tableCartA">
        <tbody>
			 <tr>
				<td colspan="7" align="left" valign="middle"><div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?php echo $Captions_arr['CART']['CART_MAINHEADING']?></div></td>
         ...
         <?php
			...
			<?php
				...
				?>
			   <tr><td colspan="6" align="left"><div class="shipTitleA">Your Shopping Basket</div>
			    ...
			    <?php
				 ...
				 ?>	</td></tr>
			  <tr><td colspan="7" align="left"><ul class="cart_band"><li><img src="<?php echo url_site_image('shopping-carts_active.jpg',1)?>"></li><li><img src="<?php echo url_site_image('billing-address.jpg',1)?>"></li><li><img src="<?php echo url_site_image('confirmation.jpg',1)?>"></li></ul></td></tr>
			           <tr>

            <td colspan="2" align="left" valign="middle" class="shoppingcartheaderA11"><?php echo $Captions_arr['CART']['CART_ITEM']?></td>
            <td  align="left" valign="middle" class="shoppingcartheaderB11"><?php echo $Captions_arr['CART']['CART_PRICE']?></td>
            <td  align="left" valign="middle" class="shoppingcartheaderC11"><?php echo $Captions_arr['CART']['CART_DISCOUNT']?></td>
            <td  align="center" valign="middle" class="shoppingcartheaderD11"><?php echo $Captions_arr['CART']['CART_QTY']?></td>
             <td  align="center" valign="middle" class="shoppingcartheaderD11">&nbsp;</td>
		  ...
		  if (count($cartData['products'])==0) // Done to show the message if no products in cart
		  {
			?>
				<tr>
					<td align="center" valign="middle" class="noproductsA" colspan="7">
		...
		// Following section iterate through the products in cart and show its list
			  ...
			  ?>
				  <tr>
					<td align="left" valign="top" class="shoppingcartcontentA_img">
					<?php 
					...
					?>
						...
						<?php
							...
							else
							{
								...
								$no_img = get_noimage('prod','image_iconpath'); 
								if ($no_img)
								{
					...
					<td  align="left" valign="top" class="shoppingcartcontentA_Name">
			  ...
			  <?php
				...
				?>
					...
					<div class="updatediv" align="center">
						<span class="span_up"><img src="<?php url_site_image('cart-plus.png') ?>" onclick="document.frm_cart.remcart_id.value='<?php echo $products_arr['cart_id']?>';document.frm_cart.cart_qty_<?php echo $products_arr['cart_id']?>.value=parseInt(document.frm_cart.cart_qty_<?php echo $products_arr['cart_id']?>.value)+1;handle_form_submit(document.frm_cart,'Update_qty','#upd');"></span><span class="span_min"><img src="<?php url_site_image('cart-remove.png') ?>" onclick="document.frm_cart.remcart_id.value='<?php echo $products_arr['cart_id']?>';document.frm_cart.cart_qty_<?php echo $products_arr['cart_id']?>.value=parseInt(document.frm_cart.cart_qty_<?php echo $products_arr['cart_id']?>.value)-1;handle_form_submit(document.frm_cart,'Update_qty','#upd');"></span></div>
					<?php
						}
					?>
					</td>
					<td align="center" valign="top" class="<?php echo $trmainclassB?>">
					<div class="div_del"><img src="<?php url_site_image('del-cart.jpg');?>" onclick="if (confirm_message('<?php echo $Captions_arr['CART']['CART_ITEM_REM_MSG']?>')) {document.frm_cart.remcart_id.value='<?php echo $products_arr['cart_id']?>';handle_form_submit(document.frm_cart,'Remove_qty','#rem')}"></div>
					</td>
    ...
    ?>
     <tr>
      <td valign="top">
		  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="bonus_table">
        <tr>
			<td valign="top">
			<?php
...
<?php
						  ...
						  ?>
							  	...
							  	<img src="<?php echo url_site_image('addcode_bt.jpg')?>"  border="0" onclick="document.frm_cart.cart_savepromotional.value=1;handle_form_submit(document.frm_cart,'save_commondetails','')"/>
						  <?php
						  	}
  ...
  ?>
   <?php
 		  ...
 		  <tr>
			  ...
			  <td valign="top" class="cust_regmiddle_td_right_cart">
          ...
          <tr>
            ...
            <td >
				<input name="custlogin_uname" id="custlogin_uname" type="text" class="inputA_new" size="40" value="Email" onfocus="if(document.frm_cart.custlogin_uname.value=='Email'){document.frm_cart.custlogin_uname.value=''}" onblur="if(document.frm_cart.custlogin_uname.value==''){document.frm_cart.custlogin_uname.value='Email'}" />
			</td>
         
            <td>
				<input name="custlogin_pass" id="custlogin_pass" type="text" class="inputA_new" size="40" value="Password" onfocus="if(document.frm_cart.custlogin_pass.value=='Password'){document.frm_cart.custlogin_pass.value='';document.frm_cart.custlogin_pass.type='Password';}" onblur="if(document.frm_cart.custlogin_pass.value==''){document.frm_cart.custlogin_pass.value='Password';document.frm_cart.custlogin_pass.type='text';}else{document.frm_cart.custlogin_pass.type='Password'}"  />
		   </td>
   
            <td> 
			
			<input name="custcartlogin_Submit" type="button" class="buttonred_cartA" value="Login" onclick="cust_login_submit();" />
			</td>
	      </tr>
		  <?php
			...
			?>
			  <tr>
				<td colspan="3">
					<span class="fpwd"><a href="<?php url_link('forgotpassword.html')?>" class="loginlink" title="<?php echo $Captions_arr['CUST_LOGIN']['FORGOT_PASS']?>"><?php echo $Captions_arr['CUST_LOGIN']['FORGOT_PASS']?></a></span>
					<span class="signup"><a href="<?php url_link('registration.html')?>" class="loginlink">Sign Up</a></span>
				</td>
			  </tr>
		  <?php
			}
		  ...
		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <div class="subtotalcartContent">
                <table width="100%" border="0" align="right" cellpadding="1" cellspacing="1" class="contentcarts">
                 <tr>
				<td align="right" valign="middle" class="colsubtotalz"  width=""><?php echo $Captions_arr['CART']['CART_TOTPRICE']?></td>
			...
			?>
			<tr>
				<td  width="" align="right" class="colsubtotalz"><?php echo $Captions_arr['CART']['CART_TOTAL_DELIVERY_CHARGES']?></td>
			...
			<?php
			 ...
			 ?>
				 <tr>
					<td width="" align="right" class="colsubtotalz"><?php echo $Captions_arr['CART']['CART_EXTRA_SHIPPING']?></td>
		   ...
		   // Section to show the tax details
			 ...
			 ?>
					<tr>
						<td width="" align="right" class="colsubtotalz">
			 ...
			 // Show the following only if any bonus point is spend
						...
						?>
						  <tr>
							<td width="" align="right" class="colsubtotalz"><?php echo $Captions_arr['CART']['CART_SPENT_BONUS_POINTS_VALUE']?> </td>
		  ...
		  <?php
		  	...
		  	*/ 
		  	if ($row_cartdet['promotionalcode_id']!=0 and $cartData["bonus"]['type']=='promotional' and $cartData['totals']['pro_type']!='product')
						$bonus_discp = ($cartData['totals']['lessval']>0)?print_price($cartData['totals']['lessval'],true):0;
					elseif($row_cartdet['voucher_id']!=0 and $cartData["bonus"]['type']=='voucher')
						$bonus_discp = ($cartData['totals']['lessval']>0)?print_price($cartData['totals']['lessval'],true):0;
			if ($row_cartdet['promotionalcode_id']!=0 and $cartData["bonus"]['type']=='promotional' and $cartData['totals']['pro_type']!='product')
					{
					?>
					<?php $bonus_disccapt =  $Captions_arr['CART']['CART_PROMOTIONAL_CODE_DISC']?>
					<?php
					}
					elseif($row_cartdet['voucher_id']!=0 and $cartData["bonus"]['type']=='voucher')
					{
					?>
					<?php $bonus_disccapt = $Captions_arr['CART']['CART_GIFTVOUCHER_DISC']?>
					<?php
					}			
			if($cartData['totals']['lessval']>0)
			{
			?>
			<tr>
					<td width="" align="right" class="colsubtotalz"><?php echo $bonus_disccapt ;?>&nbsp; </td>
					<td align="right" class="colsubtotalamt">
					<?php echo '(-) '.$bonus_discp;?></td>
			  	</tr>
			<?php
			}			
			...
			?>
				<tr>
					<td width="" align="right" class="colsubtotalz"><?php echo $Captions_arr['CART']['CART_LESS_AMT_LATER']?>&nbsp; </td>
					<td align="right" class="colsubtotalamt">
		  ...
		  <?php
			...
			*/ 
			// Running the qry to pick the payment types to be displayed
              ...
              <div class="subtotalcartzwrapA">
				  <div class="subtotalcartztopA"></div>
              <div class="subtotalcartzbgA">
              <div class="subtotalcartContentN"><div class="payTitle"><?php echo $Captions_arr['CART']['CART_SEL_PAYTYPE']?></div>
			...
			?>
				  ...
				  <div class="subtotalcartztopA"></div>
              <div class="subtotalcartzbgA">
              <div class="subtotalcartContentN"><div class="payTitle"><?php echo $Captions_arr['CART']['CART_SEL_PAYGATEWAY']?></div>
		    ...
		    else
		    {
		     ...
		     $on_changeA = "onclick=\"handle_checkout_submit('$ecom_hostname',0,'".$cartData["totals"]["bonus_price"]."');\"";
			  ...
			  ?>	
             		 ...
             		 <input name="continue_checkout" type="button" class="cart_Goto" id="continue_checkout" value="<?php echo $Captions_arr['CART']['CART_GO_CHKOUT']?>" <?php echo $on_changeA?> />
...
<input type="hidden" name="custlogin_uname" value="" />
<input type="hidden" name="custlogin_pass" value="" />
<input type="hidden" name="cart_mod" value="show_cart" /> 
<input type="hidden" name="pass_url" id="pass_url" value="<?php echo $ps_url?>" />
<input type="hidden" name="custcartlogin_Submit" value="1"/>
</form>
  <?php
...
<div class="customerboughtWrap">
	<div class="orderSummaryHead">Billing & Shipping Address</div>
	 <?php
			  if(count($cartData['payment']['method'])==0)
			  {
				?>
			<ul class="cart_bandCT"><li><img src="<?php echo url_site_image('shopping-cart.jpg',1)?>"></li><li><img src="<?php echo url_site_image('billing-address_active.jpg',1)?>"></li></ul>

				<?php  
			  }
			  else{
				  ?>
			<ul class="cart_bandCT"><li><img src="<?php echo url_site_image('shopping-cart.jpg',1)?>"></li><li><img src="<?php echo url_site_image('billing-address_active.jpg',1)?>"></li><li><img src="<?php echo url_site_image('confirmation.jpg',1)?>"></li></ul>
...
<div class="billsec">
<div class="billwrap">
<span class="title-shipping"><?php echo $Captions_arr['CART']['CART_FILL_BILLING_DETAILS']?></span>
<?php
...
<?php
			...
			if($show_cart_password==1)
			 ...
			 ?>			<li>
						...
						<li><?=$Captions_arr['CART']['PASS_PASSWORD']?></li>
						<li><input name="checkout_passwd" type="password" class="regiinput" id="checkout_passwd" size="25" value="" /></li>
						<li><?=$Captions_arr['CART']['CONF_PASS_PASSWORD']?></li>
						<li><input name="checkout_pwd_cnf" type="password" class="regiinput" id="checkout_pwd_cnf" size="25" value="" /></li>
													<?php
					}
?>
</ul>
...
<?php
 // check whether billing and shipping address can be different in the site.
			  ...
			  {
?>
<span class="title-shipping">Shipping Address</span>
<span class="samead-wrap">

<span class="check"><input id="checkout_billing_same" name="checkout_billing_same" type="checkbox" value="Y" onclick="javascript: handle_deliveryaddress_change(this);" <?php echo ($saved_checkoutvals['checkout_billing_same']=='Y')?"checked='checked'":""?> /></span>
<span class="chek-lists"><?php echo $Captions_arr['CART']['CART_IS_DELIVERY_ADDRESS_SAME']?></span>
</span>

<ul class="billwrapitem-line" id="checkout_delivery_tr" <?php echo (($saved_checkoutvals['checkout_billing_same']=='Y'))?'style="display:none"':''?>>
<span class="title-shippingA"><?php echo $Captions_arr['CART']['CART_FILL_DELIVERY_ADDRESS']?></span>
<?php
...
//				$cont_class = 'shoppingcartcontent_noborder';
			...
			?>
					...
					<ul class="billwrapitem">
						<li><?php echo $Captions_arr['CART']['CART_CREDIT_CARD_DETAILS']?></li>
						<?php
			...
			?>
						<ul class="billwrapitem">
							...
							<li><?php echo $Captions_arr['CART']['CART_ABLE_TO_BUY']?>
						</li>
						<?php	
						...
						?>
								...
								<li>
								<?php echo stripslashes($row_able['det_caption'])?></li>
						<?php
								$checked ='';
							}						
						?>
			...
			<?php	
				...
				else// case if credit card details not to be picked
				{
					...
					{	
						...
						?>
						<ul class="billwrapitem">
                       <li><?php echo $Captions_arr['CART']['CART_CHEQUE_DETAILS']?></li>
						<?php
							// Get the list of credit card static fields to be shown in the checkout out page in required order
							$sql_checkout = "SELECT field_det_id,field_key,field_name,field_req,field_error_msg   
											FROM 
...
<script type="text/javascript">
		function validate_checkout_fields(frm)
		{
			...
			{
				if(frm.checkout_billing_same.checked ==true)
				{
				}
				else
				{
...
?>						<tr>
							<td class="desc" valign="top" colspan="2">
               ...
               <tr>
						<td colspan="4">
						<table cellpadding="0" cellspacing="0" class="summaryTotals">						   
							<tbody>
							  <tr>
			...
			if ($deliverydet_Arr['delivery_type'] != 'None') // Check whether any delivery method is selected for the site
			{
				...
				?>	
							<tr>
								<td  align="right" valign="middle" class="totalsHead" colspan="2"><?php echo $Captions_arr['CART']['CART_DELIVERY_LOC']?>: <?php echo stripslashes($row_loc['location_name'])?></td>
							</tr>
				<?php
				**/
						}
		  ...
		  <?php
			...
			if (is_Feature_exists('mod_bonuspoints'))
			{
				/*if ($cartData["customer"]["customer_bonus"]) // does current customer have bonus points
				{
					...
					?>
					  <tr>
						<td  align="right" valign="middle" class="totalsHead"><?php echo $Captions_arr['CART']['CART_SPENT_BONUS_POINTS_VALUE']?>
						&nbsp;:&nbsp;<? echo '(-) '.print_price($cartData["bonus"]["value"],true);?></td>
					  </tr>
			<?php	
					}
				}*/
			...
			?>
				 <tr>
					<td  align="left" valign="middle" class="totalsHead"><?php echo $Captions_arr['CART']['CART_BONUS_DONATING']?>
					&nbsp;:&nbsp;<?php echo $cartData["bonus"]["donating"]?></td>
				  </tr>
			<?php	
			}*/
			/* Donate bonus End */
			...
			?>
				 <tr>
					<td  align="right" valign="middle" class="totalsHead"><?php echo $Captions_arr['CART']['CART_TOTAL_POINTS_EARN']?>
					&nbsp;:&nbsp;<?php echo $cartData["totals"]["bonus"]?></td>
				  </tr>
			<?php	
			}*/
			/*if ($deliverydet_Arr['delivery_type'] != 'None') // Check whether any delivery method is selected for the site
  ...
  <tr>
				<td colspan="5" align="right" valign="middle" class="cartterms">			
					...
					?>	
						...
						<div class="cart_continue_divCT" align="left">
	             <input name="backto_cart" type="button" class="buttonred_cart_continue_small" id="backto_cart" value="CART" onclick="show_wait_button(this,'Please Wait...');gobackto_cart('<?php echo ($protectedUrl)? base64_encode($ecom_hostname):$ecom_hostname?>')"/>
	         </div> 
			 ...
			 // Handling the case of login required before checkout.
			  ...
			  ?>	
					...
					?>
							<input name="continue_checkout" type="submit" class="cart_Goto" id="continue_checkout" value="<?php echo $checkout_caption?>"/>
					<?php
					}
					else
					{
		...
		?>	
			...
			?>
			 ...
			 ?> 
			 <tr><td colspan="5"><ul class="cart_band"><li><img src="<?php echo url_site_image('shopping-cart.jpg',1)?>"></li><li><img src="<?php echo url_site_image('billing-address.jpg',1)?>"></li><li><img src="<?php echo url_site_image('confirmation_active.jpg',1)?>"></li></ul></td></tr>

			
			  </table>
			 
<div class="cartcontentsWrap">
<div class="customerboughtWrap_preview">
<div class="customerboughtTop"></div>
...
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
			...
			{		
							?>
			<tr>
			<td align="left"  class="col1" width="25%">
			...
			<td align="left"  class="col2" width="75%">
			<?php
...
<?php
			...
			?>
                       <div class="cartrightmain">
						<div class="summarywrapbg"><div class="cartrightWrapper_preview">
						<div class="orderSummaryHead">Order Summary</div>
						<table class="orderSummaryTable">
						<tbody><tr>
						<td colspan="2" class="colHead"><?php echo $Captions_arr['CART']['CART_ITEM']?></td>
...
<?php
		  ...
		  ?>	
			    ...
			    <table cellspacing="0" cellpadding="0" class="ckeckout_right_preview" width="100%">	
