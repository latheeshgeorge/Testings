				  ...
				  <table width="100%" border="0" cellpadding="0" cellspacing="2" class="shoppingcarttable">
					 ...
					 <tr>
					   <td  colspan="3"><table cellpadding="2" cellspacing="3" width="100%"  class="userordertablestyleA"><tr>
						<td  align="left"  class="usermenucontent" valign="middle" width="18%">Date From</td><td  align="left" class="usermenucontent" valign="middle"  width="16%"> <input class="textfeild" type="text" name="srch_review_startdate" id="srch_review_startdate" size="8" value="<?=$_REQUEST['srch_review_startdate']?>" readonly="true"  /></td><td width="6%" nowrap="nowrap"><?php /*<a href="javascript:show_calendar('my_enquire.srch_review_startdate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('show-calendar.gif')?>" width="24" height="22" border="0" /></a>*/?></td><td  align="left"  class="usermenucontent" valign="middle" width="14%">Date To </td>
						<td  align="left"  class="usermenucontent" valign="top"  nowrap="nowrap" width="16%">  
               				 <input class="textfeild" type="text" name="srch_review_enddate" id="srch_review_enddate" size="8" value="<?=$_REQUEST['srch_review_enddate']?>"  readonly="true" /></td><td width="" nowrap="nowrap" colspan="2"><?php /*<a href="javascript:show_calendar('my_enquire.srch_review_enddate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('show-calendar.gif')?>" width="24" height="22" border="0" /></a>*/?></td></tr>
				...
				?>
				 ...
				 <script type="text/javascript">
				  jQuery.noConflict();
						var $ajax_js = jQuery; 
						$ajax_js(function() {
								$ajax_js( "#srch_review_startdate" ).datepicker({dateFormat: "dd-mm-yy"});
								$ajax_js( "#srch_review_enddate" ).datepicker({dateFormat: "dd-mm-yy"});
						});
				  </script>
				<?
		}		
