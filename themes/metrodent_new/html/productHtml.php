<?php
	...
	class product_Html
	{
		...
		function Show_ProductDetails($row_prod)
		{
			...
			$HTML_price = '<div class="deat_price" itemprop="offers" itemscope itemtype="http://schema.org/Offer">';
			$microdata_pricewas = $microdata_priceoff = '';
			
			if($cur_price)
			{
				$microdata_priceoff = ' itemprop="price"';
			}
			else
			{
				$microdata_pricewas = ' itemprop="price"';
			}	
			
			
			if($was_price)
				$HTML_price .= '<div class="deat_priceA"'.$microdata_pricewas.'>'.$was_price.'</div>';
			if($cur_price)
				$HTML_price .= '<div class="deat_priceB"'.$microdata_priceoff.'>'.$cur_price.'</div>';	
            ...
            <div class="det_cont_con" itemscope itemtype="http://schema.org/Product">
            ...
            <div class="det_name_con">
                <div class="det_name_otr">
                   ...
                   <div class="det_name_top"><h1 itemprop="name">
                ...
                <div class="det_price_otr">                    
                    <div class="buy_holder">
                        ...
                        {
                        ?>
                        <div class="deat_desc_otr" itemprop="description">
		...
		if ($show_normalimage)
		{
			...
			{ 
				...
				<?php
				 ...
				 global $microdata_img;
				 $microdata_img = 'itemprop="image"';
			...
			<div class="shlf_a_pdt_top"></div>
				...
				<div class="shlf_a_pdt_r">
					...
					<? /*=$HTML_desc*/ ?>
							...
							<div class="shlf_a_pdt_buy"><a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" class="det_buy_link">BUY NOW</a></div>
								
							</div>
				   </div>
				   
					<div class="shlf_a_pdt_more"><a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" class="det_buy_link" title="<?php echo stripslash_normal($row_prod['product_name'])?>" class="">More Info</a></div>
