		       ...
		       if($show_tprop == true)
				...
				<tr>
					<td valign="top" align="left" colspan="2">
						...
						?>
						<tr>
						<td <?php echo $leftwidth?> align="right" valign="<?php echo stripslash_normal($row_elem['element_valign'])?>" class="<?php echo $cont_class?>"><?php echo stripslash_normal($row_elem['element_label'])?><?php echo ($row_elem['mandatory']=='Y')?'<span class="redtext">*</span>':''?>
						<?php
