		 ...
		 <div class="reg_shlf_outr">
          ...
          ?>
           ...
           <?php
					...
					?>
					 <table width="100%" border="0" cellspacing="0" cellpadding="0" class="reg_table">
					  ...
					  <tr>
					    <td align="left" width="20%"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_REGISTRATION_CODE'])?> </td>
						...
						?><img src="<?php url_verification_image('includes/vimg.php?size=4&amp;pass_vname=registration_Vimg&amp;bg=255 255 255&amp;brdr=255 255 255&fnt=255 0 0&circle=1')?>" border="0" alt="Image Verification" class="captcha"/>	
					    <div class="imgver_textB"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_LETTER_SENS_CODE'])?></div>
					    </td>
					    </tr>
					  <tr>
					    
					    <td colspan="3" align="left">  <div class="reg_top_hdr_msg_small "><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_LETTER_LONG_TEXT'])?></div></td>
					    </tr>
					    </table>
						<?php
						}
           ...
           <div class="reg_shlf_inner">
            <div class="reg_shlf_inner_top"></div>
           <div class="reg_shlf_inner_cont">
		   <div class="reg_shlf_hdr_outr"><div class="reg_shlf_hdr_in"><span>Metrodent Account</span></div></div>
             <div class="reg_shlf_cont_div">
           <div class="reg_shlf_pdt_con">
          <table width="50%" border="0" cellspacing="0" cellpadding="0" class="reg_table1">
			  <tr >
              <td class="regiconentA" valign="middle" align="left">Would you like to apply for a Metrodent Account?</td>
              <td align="left" valign="middle" class="regi_txtfeildA">
				  <select id="metrodent_tradeaccount" name="metrodent_tradeaccount">
