...
*/														}
		...
		?>	
		<tr>
		<td align="center" valign="middle" class="cart_del_charge_left" colspan="2"><?php echo stripslash_normal($Captions_arr['CART']['CART_DELIVERY_LOC'])?>: <?php echo stripslash_normal($row_ord['order_deliverylocation'])?></td>
		</tr>
		<?php
		}
		// Check whether any delivery group exists for the site
		...
		?>	
		<tr>
		<td align="center" valign="middle" class="cart_del_charge_left" colspan="2"><?php echo stripslash_normal($Captions_arr['CART']['CART_DELIVERY_OPT'])?>: <?php echo stripslash_normal($row_ord['order_delivery_option'])?></td>
		</tr>
		<?php
		}	
