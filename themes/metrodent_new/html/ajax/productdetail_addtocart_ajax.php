...
<div class="det_det_otr">
            ...
            <div class="det_name_con">
                <div class="det_name_otr">
                   ...
                   <div class="det_name_top"><h1>
						<?php 	
							echo stripslash_normal($row_outerprods['product_name']); 		
	                    ?>
                    </h1></div>
	...
	if(trim($row_outerprods['product_intensivecode'])!='')
	{
	?>
	<div class="p_content_intensivecode"><?php echo stripslashes($row_outerprods['product_intensivecode'])?></div>
	<?php
	}
