		...
		?>
			...
			<div class="reg_shlf_outr">
			  ...
			  <tr>
			    ...
			    <td nowrap="nowrap" class="usermenucontent"><?php echo stripslash_normal($Captions_arr['ORDER']['ORDER_EMAIL'])?></td>
			    <td nowrap="nowrap" class="usermenucontent"><?php echo stripslash_normal($Captions_arr['ORDER']['ORDER_CUSTDET'])?></td>
			    </tr>
			  <tr>
				<td width="18%" colspan="1" nowrap="nowrap" class="usermenucontent"><input name="ord_id" type="text" class="textfeild" id="ord_id" value="<?php echo $_REQUEST['ord_id']?>" size="6" /></td>
				<td width="18%" nowrap="nowrap" class="usermenucontent"><input name="ord_email" id="ord_email" type="text"  value="<?php echo $_REQUEST['ord_email']?>" /></td>
				<td nowrap="nowrap" class="usermenucontent"><input type="text" class="textfeild" name="ord_name" id="ord_name" value="<?php echo $_REQUEST['ord_name']?>"/></td>
				</tr>
			  <tr>
			    <td colspan="2" nowrap="nowrap" class="usermenucontent"><?php echo stripslash_normal($Captions_arr['ORDER']['ORDER_BETDATE'])?></td>
			    <td nowrap="nowrap" class="usermenucontent"><?php echo stripslash_normal($Captions_arr['ORDER']['ORDER_SORTBY'])?> </td>
			    </tr>
			  <tr>
			    <td colspan="2" nowrap="nowrap" class="usermenucontent"><input name="ord_fromdate" class="textfeild" type="text" size="8" value="<?php echo $_REQUEST['ord_fromdate']?>" />
                  <a href="javascript:show_calendar('frm_orders.ord_fromdate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('show-calendar.gif')?>" width="24" height="22" border="0" /></a> and <a href="javascript:show_calendar('frm_orders.ord_fromdate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;">
                  <input name="ord_todate" class="textfeild" id="ord_todate" type="text" size="8" value="<?php echo $_REQUEST['ord_todate']?>" />
                                    </a><a href="javascript:show_calendar('frm_orders.ord_todate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('show-calendar.gif')?>" width="24" height="22" border="0" /></a></td>
			    <td nowrap="nowrap" class="usermenucontent"><?php echo $sort_option_txt;?> in <?php echo $sort_by_txt?>
		        <input name="Search_go" type="submit" class="inner_btn_red" id="Search_go" value="Go" onclick="document.frm_orders.search_click.value=1" /></td>
			    </tr>
			...
			<tr>
			<td colspan="8" align="center" valign="middle" class="pagingcontainertd_normal" ><?php 
													$path = '';
													$query_string .= "";
			$HTML_paging	= '';
			...
			if ($tot_cnt>0)
			{
				...
				$paging 		= paging_footer_advanced($path,$query_string,$tot_cnt,$start_var['pg'],$start_var['pages'],'',$pg_variable,'Orders(s)',$pageclass_arr);
		 ...
		 echo $HTML_paging;
			...
			<tr>
			<td colspan="8" align="left" valign="middle" class="pagingcontainertd_normal" ><img src="<?php url_site_image('new_post.gif')?>"   border="0" title="New" />
			...
			<td class="ordertableheader" width="1%">&nbsp;</td>
			</tr>
			<?php
			...
			<td align='center'  class='<?=$cls?>'><a href="index.php?req=orders&reqtype=order_det&order_id=<?php echo $row_select_ord['order_id']?>" title='View Order Details'>View</a></td>
			</tr>
			<?php
			}	
			?>
			<tr>
			<td align="center" valign="middle" class="pagingcontainertd_normal" colspan="8" >
			<?php 
				$path = '';
				$query_string .= "";
				//paging_footer($path,$query_string,$tot_cnt,$start_var['pg'],$start_var['pages'],'',$pg_variable,'Orders',$pageclass_arr); 	
			...
			<tr>
				<td align="center" valign="middle" class="shoppingcartcontent" colspan="8" >
...
if($insmsg)
	...
	<tr>
	  ...
	  <td align="left" valign="top"><?php echo "<span id='repeatBut'>&nbsp;&nbsp;<div class=\"cart_shop_cont\"><div><input type=\"button\" name=\"repeat_order\" value=\" Repeat Order \" class=\"inner_btn_red\" onClick=\"javascript:ord_repeat(document.frm_orderdetail, '$row_select_ord[order_id]')\"></div></div></span>";?></td>
	  </tr>
	<tr>
	...
	<td width="9%" align="left" valign="top" class="<?php echo $cls?>"> 
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
		  ...
		  <tr>  
			<td width="30%" align="left" class="<?PHP echo $cls;  ?>"><a class="edittextlink" href="<?php url_product($row_prods['products_product_id'],$row_prods['product_name'],-1)?>" title="<?php echo stripslash_normal($row_prod['product_name'])?>"><?php echo stripslash_normal($row_prods['product_name']); ?></a>&nbsp;
					<?php
						echo get_ProductVarandMessage($_REQUEST['order_id'],$row_prods['orderdet_id'],$row_prods['products_product_id']);
					?>	      </td>
			...
			<?php echo print_price_selected_currency($row_prods['order_retailprice'],$row_select_ord['order_currency_convertionrate'],$row_select_ord['order_currency_symbol'],true)?>			</td>
			...
			if($db->num_rows($ret_checkout))
			{
				...
				?>
									<td align="left" width="50%" >
										...
										<tr>
											<td align="left" width="25%" class="userordercontentbold_row">
											<?php echo $caption?>											</td>
											<td align="left" valign="middle" class="userordercontent_row">
											<?php echo $value?>											</td>
										</tr>
										</table>									</td>	
				<?php
	...
	<tr id="EnqId3" style="display:none;"  >
	  ...
	  <td>&nbsp;</td>
	  <td >	
		<input type="button" name="Submit" value="Add Enquiry" class="edithreflink_enquiry" onclick="javascript:enqSub(document.frm_orderdetail)" />
...
<div class="reg_shlf_outr">
  ...
  <table width="100%" border="0" cellpadding="2" cellspacing="0" class="expandtable_cls">
    ...
    <tr>
      ...
      <td nowrap="nowrap" class=" <?PHP echo $cls; ?>" align="center">&nbsp;<a href="#" onclick="javascript:view_post(document.frm_enqposts,'<?PHP echo $count; ?>')" > View </a></td>
    </tr>
...
function get_ProductVarandMessage($order_id,$orderdet_id,$prod_id=0)
{   
	global $db,$ecom_siteid;
	 $check_arr = is_grid_display_enabled_prod($prod_id);
