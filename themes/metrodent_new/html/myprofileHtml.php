...
function Show_Myconsent(){
			...
			<?php
				...
				if($ecom_siteid==103)
				{
			      $companyname = "Metrodent";
			      $phone = "01484 466700";
			      $Email = "sales@metrodent.com";
			      $gdpr_orl = "http://www.metrodentclinical.com/gdpr-pg50562.html";
			    }			    
				?>
				<tr>
...
For more details, please check our <a href="<?php echo $gdpr_orl;?>" target="_blank"><strong>data protection</strong></a> to see how we use and protect your data. 
				   ...
				   <tr>
				     <td align="center" valign="middle" class="regi_button_x" colspan="4" ><input class="inner_btn_red_x" type="button" name="Submit" value="Save" onclick="javascript:add_newconsent(document.add_address)" /></td>
