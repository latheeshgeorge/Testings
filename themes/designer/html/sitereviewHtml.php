	...
	class sitereview_Html
	{
		...
		<?php 
			 if($_REQUEST['alert1']==1 && !$alert){ ?>
				...
				<? }?>
				<tr>
				<td align="right" valign="top"><div class="review_save"><div><a href="#" onclick="javascript:validate_sitereview(document.frm_sitereview);"><?=stripslash_normal($Captions_arr['SITE_REVIEWS']['SITE_REVIEW_SAVE_BUTTON'])?></a></div>
				</div> </td>
				</tr>
				</table>
				</div>
