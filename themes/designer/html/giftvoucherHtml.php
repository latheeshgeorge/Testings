...
/*############################################################################
	...
	?>
			...
			<div class="gift_cont"> 
				<div class="gift_cont_inner"> 
					<div class="gift_cont_left_outr"> <div class="gift_cont_left_inner">
						...
						?>
						<tr>
							<td  class="gift_left_table_td"><br><br><?=$Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_EMAIL_VOUCHER_MESSAGE_TEXT']?></td>
						</tr>
						<? }?>
						<tr>
				...
				<div class="gift_cont_left_inner_bt"></div>
					...
					<div class="gift_cont_right_outr"> 
						<div class="gift_cont_right_inner">
							...
							?>
							 <tr>
								<td colspan="2" class="gift_right_table_hdr"><?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_VOUCHER_BUYERS_MESSAGE_TEXT'])?>
								</td>
							</tr>
							<? 
							}
							?>
							<tr><td align="center" colspan="2" style="color:#000000;font-weight:normal;"><span class='redtext'><?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_VOUCHER_BUYERS_COMPULSORY'])?></span></td></tr>
							<tr>
								<td  colspan="2">
		...
		<?php
		  ...
		  {
		  ?>
          <div style="width:100%;float:right; padding:5px 0">
           ...
           <tr>
                        ...
                        <input type='image' name='submit_express' src='<?php echo $button_img_path?>' border='0' align='top' alt='PayPal' onclick="return validate_buygiftvoucher_paypal(document.frm_buygiftvoucher)"/>
                        </td>
                        </tr>
           </table>
          </div>
	...
	*/
	...
	<?php	
		...
		<div class="normal_shlf_mid_mid">
						<?php 
						$HTML_comptitle ='<div class="normal_shlfB_desc_outr">'.stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_PROM_PRODUCTS']).'</div>';
						echo $HTML_comptitle;
						?>	
    ...
    $HTML_title = $HTML_image = $HTML_desc = '';
			...
			$HTML_price = $HTML_bulk= $HTML_bonus = $HTML_compare = $HTML_freedel= $HTML_bonus_bar = '';
				$HTML_title = '<div class="normal_shlfB_pdt_name_prom"><a href="'.url_product($row_prod['product_id'],$row_prod['product_name'],1).'" title="'.stripslash_normal($row_prod['product_name']).'">'.stripslash_normal($row_prod['product_name']).'</a></div>';
				...
				if ($var_exists==false)// Check whether description is to be displayed
						...
						{
							$HTML_price = show_Price($row_prod['prom_price'],$price_class_arr,'shelfcenter_3');
						}
		?>
