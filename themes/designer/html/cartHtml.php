                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="5" align="left" valign="top" class="cart_table_cnta"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <td class="cart_table_header"> <?php echo stripslash_normal($Captions_arr['CART']['CART_TOTAL'])?></td>
                                        </tr>
                                        <?php
                                        ...
                                        foreach ($cartData['products'] as $products_arr)
                                        {
                                            ...
                                            ?> <a href="#" class="update_link" onClick="if (confirm_message('<?php echo stripslash_normal($Captions_arr['CART']['CART_ITEM_REM_MSG'])?>')) {document.frm_cart.remcart_id.value='<?php echo $products_arr['cart_id']?>';handle_form_submit(document.frm_cart,'Remove_qty','#rem')}" title="<?php echo stripslash_normal($Captions_arr['CART']['CART_REMOVE'])?>"><img src='<?php url_site_image('delete-cart.gif')?>' border="0" alt="<?php echo stripslash_normal($Captions_arr['CART']['CART_REMOVE'])?>"></a> <br /></td>
                                               <td class="cart_td_name" valign="middle" align="left">
                                                ...
                                                if($Settings_arr["product_show_instock"]==1)
                                                {
                                                    ...
                                                    $preorder = check_Inpreorder($products_arr['product_id'],$products_arr['cart_id']);
                                                    if ($preorder['in_preorder']=='Y')
                                                    echo '<div class="nostock">'.stripslash_normal($Captions_arr['CART']['CART_AVAIL_ON']).'<br />'.$preorder['in_date'].'</div>';
                                                    else
                                                    {
                                                        if($products_arr['stock']>0 or $products_arr['product_alloworder_notinstock']=='Y')
                                                        echo '<div class="instock">'.stripslash_normal($Captions_arr['CART']['CART_IN_STOCK']).'</div>';
                                                    }	
                                                }
                                            ...
                                            <td class="cart_td_discnt" valign="middle" align="left"> <?php echo print_price($products_arr['product_webprice'],true)?> <span> <?php display_cart_discount($products_arr,$Captions_arr);?>
                                            </span></td>
                                            <td align="left" valign="middle" class="cart_td_price_bold"> <?php echo print_price($products_arr['final_price'],true)?></td>
                                            </tr>
                                            <?php
                                        ...
                                        if (count($cartData['products'])!=0) // Done to show the message if no products in cart
                                        {
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                              ...
                                              <!--  <tr>
                                                ...
                                                ?>	
													<tr>
                                                    <td colspan="2" align="left" valign="middle" class="cart_td_delry_errmsg"><a name="a_deliv">&nbsp;</a>
													<div style="display:none" id="cart_del_not_sel_tr" class="cart_td_delry_errmsg_div">
													<?php echo stripslash_normal($Captions_arr['CART']['CART_DELIVERY_LOC_MSG_DET'])?>
													</div>
                                                    </td>
                                                    </tr>
                                                    <tr>
                   ...
                   // $hide_direct_checkout_button = true; // today start
                    ...
                    ?>
                        ...
                        ?>
                        <tr>
                        <td align="right" valign="top" class="google_td" width="50%">
						<?php 
						if($ecom_siteid == 88) // skaterus
						{
							if(($totpaycnt>0) or ($google_exists and $google_recommended==0) or $hide_direct_checkout_button==false) // today start -- today end
						...
						?></td>
                        <td align="left" valign="middle" class="google_td">
...
*/														}
		...
		function validate_checkout_fields(frm)
		{
			...
			if(Validate_Form_Objects_new(frm,fieldRequired,fieldDescription,fieldEmail,fieldConfirm,fieldConfirmDesc,fieldNumeric))
			{
			...
			?>
					if(!Validate_Form_Objects_new(frm,fielddelRequired,fielddelDescription,fielddelEmail,fielddelConfirm,fielddelConfirmDesc,fielddelNumeric))
						return false;
				}
