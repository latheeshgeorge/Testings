...
/*############################################################################
  ...
  <tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="2" class="addproreivewtable">
        <tr>
          <td width="62%" align="left" valign="middle"><?=$Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_PRODUCT_TITLE']?>&nbsp;<span class="readreivewname"><?=$product_name?></span></td>
	  ...
	  <?php } ?>
  <tr>
    <td colspan="2" class="emailfriendtextnormal"><?=$Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_MESSAGE_TEXT']?> </td>
    </tr>
  <tr>
    <td width="23%" class="emailfriendtext"><?=$Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_FRIEND_NAME']?><br /></td>
  ...
  <tr>
    <td class="emailfriendtext"><?=$Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_FRIEND_EMAIL']?><span class="redtext">*</span> </td>
  ...
  <tr>
    <td class="emailfriendtext"><?=$Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_CUSTOMER_NAME']?> </td>
  ...
  <tr>
    <td class="emailfriendtext"><?=$Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_CUSTOMER_EMAIL']?> <span class="redtext">*</span></td>
  ...
  <tr>
    <td class="emailfriendtext"><?=$Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_CUSTOMER_MESSAGE']?></td>
  ...
  <tr>
    <td class="emailfriendtext"><?=$Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_VERIFICATION_CODE']?></td>
...
function validate_emailafriend(frm)
{
	...
	fieldDescription 	= Array("<?=add_slash($Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_ALERT_FRIEND_EMAIL'])?>","<?=add_slash($Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_ALERT_CUSTOMER_EMAIL'])?>");
