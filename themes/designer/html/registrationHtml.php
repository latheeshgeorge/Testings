           ...
           <div class="reg_shlf_inner_cont">
				   ...
				   <table class="reg_shlf_inner_table" width="100%" border="0" cellpadding="2" cellspacing="0">
					...
					?>
					  ...
					  <tr>
					    <td colspan="3" align="left" class="reg_code"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_REGISTRATION_CODE'])?> </td>
					    </tr>
					  <tr>
			...
			function validate_allforms(frm)
			{
				...
				?>
				if(Validate_Form_Objects_new(frm,fieldRequired,fieldDescription,fieldEmail,fieldConfirm,fieldConfirmDesc,fieldNumeric,fieldSpecChars,fieldCharDesc))
				{
					<?php 
