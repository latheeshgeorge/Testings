<?php
	...
	class product_Html
	{
		...
		function Show_ProductDetails($row_prod)
		{
			...
			$HTML_treemenu = ' <div class="tree_map_con"><div class="tree_menu_con_det">
			...
			function ajax_return_productdetailscontents() 
			{
				...
				if(req.readyState==4)
				{
					if(req.status==200)
					{
						...
						else if(document.getElementById('ajax_div_holder').value=='barcode_holder')
						{
							
							handle_show_prod_det_bulk_disc('stockdate_display',docroot,prod_id,loading_gif);
						}
           ...
           <div class="det_name_con">
                <div class="det_name_otr">
                   ...
                   <div class="det_name_top">
                    ...
                    <?php 
					$sql_mod_man 	= "SELECT product_id,manufacture_id,product_model         
									FROM 
										products 
									WHERE 
										 product_id =".$_REQUEST['product_id']." 		
									...
									LIMIT 
										1";
				$ret_mod_man = $db->query($sql_mod_man);
				if($db->num_rows($ret_mod_man))
				{
					$row_mod_main = $db->fetch_array($ret_mod_man);
				}	
					if($row_mod_main['manufacture_id']!='' || $row_mod_main['product_model']!='')
					{
					 ?>
                     <div class="productid_otr">
                     <?php
						if($row_mod_main['manufacture_id']!='')
						{
						?>
							<div class="det_pro_id"><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_MANID'])?>:&nbsp;<?=$row_mod_main['manufacture_id'] ?></div>
						<?
						}
						if($row_mod_main['product_model']!='')
						{
						?>
							<div class="det_pro_model"><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_MODEL'])?>:&nbsp;<?=$row_mod_main['product_model'] ?></div>
						<?php 
						}
						?>
                      </div>
            ...
            <div class="det_cont_con">
                ...
                <?=$HTML_loading?>
                    <div class="det_sub_imge">
                    	<div class="det_sub_imge_hdr"><img src="<?php url_site_image('zoom.gif')?>"></div>
            ...
            <div class="det_con_top"></div>
                ...
                ?> 
					...
					<div id="deat_date_no_stock_holder">
					<?php 
					$this->show_order_if_no_stock_date($row_prod);
					?>
					</div>
                ...
                <div class="det_con_bottom">
                    ...
                    <div class="det_label_bottom"></div>
                    </div>
 ...
 <div class="releated_pdt_con">
		...
		<div class="shlf_a_bottom">
            <div class="shlf_a_outer">
                ...
                <div id="containerA" class="shlf_thumb_outer">
                  ...
                  <?php
                    ...
                    if($row_prod['product_newicon_show']==1)
						{
							...
							//if($desc!='')
							//{
								  echo $HTML_new = '<div class="shlf_a_new"></div>';
                    ...
                    <div class="shlf_a_pdt_top"></div>
                        ...
                        <div class="shlf_a_pdt_l"> 
                          <div class="shlf_a_pdt_name"><a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" title="<?php echo stripslash_normal($row_prod['product_name'])?>"><?php echo stripslash_normal($row_prod['product_name'])?></a>
                          </div>
                          <div class="shlf_a_pdt_des"><?php// echo stripslash_normal($row_prod['product_shortdesc'])?></div>
                          <div class="shlf_a_pdt_buy_otr">
                              ...
                              <div class="shlf_a_pdt_buy"><a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>">BUY </a></div>
                          </div>
                      </div>
                      <div class="shlf_a_pdt_r">
                            <a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" title="<?php echo stripslash_normal($row_prod['product_name'])?>">		<?php
                            // Calling the function to get the image to be shown
                        ...
                        <div class="shlf_a_pdt_bottom">
         					<div class="shlf_a_pdt_more"> 
                              <a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" title="<?php echo stripslash_normal($row_prod['product_name'])?>"><img  src="<?php url_site_image('moreinfo-shlf.gif')?>"></a>
                            </div>
                        </div>
...
function show_order_if_no_stock_date($row_prod)
{
	$Captions_arr['PROD_DETAILS'] 	= getCaptions('PROD_DETAILS');
	$avail_date = get_proddet_available_date ($row_prod);
	if($avail_date)
	{
?>
		<div class="deat_date_no_stock_allow_order_div">
		<div class="deat_date_no_stock_allow_order_text">
		<?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_AVAIL_ON']).' '.$avail_date;?>
		</div>
		</div>
<?php
	}	
