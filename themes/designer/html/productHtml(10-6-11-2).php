			...
			<div class="det_cont_con">
				 ...
				 <div class="det_imge_otr">
                         ...
                         <div class="det_comp_con">
                            ...
                            <div class="det_comp_compare"> <?=$HTML_video;?><?=$HTML_compare?></div>
                        </div>
 ...
 <div class="releated_pdt_con">
            <div class="shlf_a_top">  
               <div class="shlf_a_hdr">
                   <table border="0" align="center" class="shlf_a_hdrtable">
                      <tbody><tr>
                        <td class="shlf_a_hdrl">releated producted</td>
                      ...
                      <div class="shlf_a_pdt_r">
                        ...
                        <div class="shlf_a_pdt_bottom">
         					<div class="shlf_a_pdt_more"> 
                              <a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" title="<?php echo stripslash_normal($row_prod['product_name'])?>"><img width="90" height="19" src="<?php url_site_image('moreinfo-shlf.gif')?>"></a>
                            </div>
                        </div>
