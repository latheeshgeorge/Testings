	...
	global $Captions_arr,$ecom_siteid,$db;
		...
		switch($mod)
		{
		  case 'Cart':
			...
			<tr>
			<td colspan="2" align="right" valign="top"  class="p_cart_top">asdasdsa<a href="javascript:void(0)" onclick="unloadQuickviewPopupBox()"><img src="<?php url_site_image('closeq.png')?>"  /></a></td>
			</tr>
			<tr>
