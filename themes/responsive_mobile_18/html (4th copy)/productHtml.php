		...
		/* Code for ajax setting ends here */
			...
			<input type="hidden" name="pagetype" id="pagetype" value="" />
                ...
                <div class="det_buy_link_newAicon"><img src="<?php url_site_image('iconsnew.jpg')?>" alt="Pay By Card"></div>
                 ...
                 ?>
                 								<div class='req_info_new_button1'><input type="button" id="data-modal-id" class="btnrequest btn btn-add-to-cart btn-lg sharp" value="Request Information"  alt="Request Information" style="cursor:pointer;"></div>
