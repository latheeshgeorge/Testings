...
<html >
<head>
<link href="http://<? echo $ecom_hostname; ?>/images/<? echo $ecom_hostname; ?>/bshop4_default.css" type="text/css" rel="stylesheet">
...
<TABLE style="BORDER-COLLAPSE: collapse" borderColor=#111111 cellSpacing=0 cellPadding=0 width=460 border=0> <tr>
  ...
  <IMG src="http://<? echo $ecom_hostname; ?>/images/<? echo $ecom_hostname; ?>/site_images/logo.gif" width="171" height="59" align="center">  </td>
 </tr>
 <TR>
