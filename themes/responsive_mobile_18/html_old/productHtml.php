	...
	?>	
            ...
            <?php
            	if($addto_cart_withajax == 1)
							{
								?>
								<div class="buyBinner_link"><input name="Buy Now" type="button" value="<?php echo stripslash_normal($Captions_arr['PROD_DETAILS'][$caption_key]);?>"  class="byellow" onclick="ajax_addto_cart_fromlist('add_prod_tocart_ajax','Prod_Addcart','frm_proddetails','<?php echo SITE_URL?>')"/></div>
