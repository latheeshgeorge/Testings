			...
			$comp_active = isProductCompareEnabled();
				...
				?>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ctable">
										...
										<?php
											echo '<a href="'.url_product($row_prod['product_id'],$row_prod['product_name'],1).'" title="'.stripslash_normal($row_prod['product_name']).'" class="linkbold">';
										?>
											<table width="100%" border="0" cellpadding="0" cellspacing="0"  class="pctable">
											<tr>
												<td colspan="2" class="pdt_name_x">																							
										<?php	//echo '<a href="'.url_product($row_prod['product_id'],$row_prod['product_name'],1).'" title="'.stripslash_normal($row_prod['product_name']).'" class="linkbold">';
												echo stripslash_normal($row_prod['product_name']);
												//echo '</a>';
										?>		</td>
											</tr>
											<tr >
