	...
	class product_Html
	{
		...
		function Show_ProductDetails($row_prod)
		{
			global $Captions_arr,$ecom_siteid,$db,$ecom_hostname,$ecom_themename,
					 $ecom_themeid,$default_layout,$inlineSiteComponents,$Settings_arr,$meta_arr,$ecom_twitteraccountId,$cookieval,$load_mobile_theme_arr,$site_key;
...
<?php
  ...
  echo $HTML_treemenu;
        ...
        $('#zoom_09').unbind('touchmove');";
				...
				?>
<div class="women_main container">
	...
	<div class="modal fade1 cart-list" id="myModal1" role="dialog">
			...
			<div class="modal-body">
				...
				<td align="left" class="modal_rightcls">
					...
					<input class="form-control1" type="checkbox" name="modal_urgent" id="modal_urgent" value="<?php echo $value;?>" <?php echo $checked;?>></td>
				</tr>
				<tr>
				...
				<tr>
				<td align="center" colspan="2"><input type="button" value="Submit Request" onclick="modal_handle()" class="modal_button" id="modal_button_cl"></td>
				<tr>
				<tr>
				<td colspan="2" align="center"><label></label></td>
								...
								<div class="modal fade1 cart-list" id="myModal2" role="dialog">
							<div class="modal-dialog ">
							<div class="modal-content">
							<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal">&times;</button>
...
<header>
			...
			<div class="modal-body">
				...
				?>
				<tr>
				<td  align="left" class="modal_leftcls">Product *</td>
				<td  align="left" class="modal_rightcls"><input type="text" class="form-control" placeholder="Product" name="modalq_product" id="modalq_product" value="<?php echo $_REQUEST['modalq_product']?>"> </td>
				</tr>
				
				<tr>
				<td  align="left" class="modal_leftcls">Lease Period *</td>
				<td  align="left" class="modal_rightcls">
				<?php
				$mdlq_period = $_REQUEST['modalq_period'];
				?>	
				<select id="modalq_period" name="modalq_period" class="form-control" >
				...
				<tr>
				<td  align="left" class="modal_leftcls">Contact Name *</td>
				<td  align="left" class="modal_rightcls"><input type="text" class="form-control" placeholder="Contact Name" name="modalq_contactname" id="modalq_contactname" value="<?php echo $_REQUEST['modalq_contactname']?>"> </td>
				</tr>
				
				<tr>
				<td  align="left" class="modal_leftcls">Email *</td>
				<td  align="left" class="modal_rightcls"><input type="text"  class="form-control" placeholder="Email" name="modalq_email" id="modalq_email" value="<?php echo $_REQUEST['modalq_email']?>"> </td>
				</tr>
				
				<tr>
				<td  align="left" class="modal_leftcls">Phone *</td>
				<td  align="left" class="modal_rightcls"><input type="text" class="form-control" placeholder="Phone" name="modalq_phone" id="modalq_phone" value="<?php echo $_REQUEST['modalq_phone']?>"> </td>
				</tr>
				
				<tr>
				<td  align="left" class="modal_leftcls">Business Name *</td>
				<td  align="left" class="modal_rightcls"><input type="text" class="form-control" placeholder="Business Name" name="modalq_businessname" id="modalq_businessname" value="<?php echo $_REQUEST['modalq_businessname']?>"> 
				
				</td>
				</tr>
				<tr>
				<td  align="left" class="modal_leftcls">	&nbsp;&nbsp;Business Type *&nbsp;</td>
				<td  align="left" class="modal_rightcls">
					<?php
				$mdlq_bstype = $_REQUEST['modalq_period'];
				?>	
					<select id="modalq_businesstype" name="modalq_businesstype" class="form-control">
				...
				<tr>
				<td  align="left" class="modal_leftcls">Trading Time (In years) 	</td>
				<td  align="left" class="modal_rightcls"><input type="text" class="form-control" placeholder="Trading Time (In years)" name="modalq_tradingtime" id="modalq_tradingtime" value="<?php echo $_REQUEST['modalq_tradingtime']?>"> </td>
				</tr>
				
				<tr>
				<td  align="left" class="modal_leftcls">Address *</td>
				<td  align="left" class="modal_rightcls"><input type="text" class="form-control" placeholder="Address" name="modalq_address1" id="modalq_address1" value="<?php echo $_REQUEST['modalq_address1']?>"> </td>
				</tr>
				<tr>
				<td  align="left" class="modal_leftcls">&nbsp;</td>
				<td  align="left" class="modal_rightcls"><input type="text" class="form-control" placeholder="Address" name="modalq_address2" id="modalq_address2" value="<?php echo $_REQUEST['modalq_address2']?>"> </td>
				</tr>
				<tr>
				<td  align="left" class="modal_leftcls">Town *</td>
				<td  align="left" class="modal_rightcls"><input type="text" class="form-control" placeholder="Town" name="modalq_town" id="modalq_town" value="<?php echo $_REQUEST['modalq_town']?>"> </td>
				</tr>
				
				<tr>
				<td  align="left" class="modal_leftcls">Post Code *</td>
				<td  align="left" class="modal_rightcls"><input type="text" class="form-control" placeholder="Post Code" name="modalq_postcode" id="modalq_postcode" value="<?php echo $_REQUEST['modalq_postcode']?>"> </td>
				</tr>
				
				<tr>
				<td  align="left" class="modal_leftcls">Comments</td>
				<td  align="left" class="modal_rightcls"><textarea class="form-control" name="modalq_comments" id="modalq_comments" row="10" cols="44"><?php echo $_REQUEST['modalq_postcode']?></textarea> </td>
				</tr>
				<tr>
				...
				<tr>
				<td align="center" colspan="2"><input type="button" value="Submit Request" onclick="modal_handle_quote()" class="modal_button" id="modal_quote_cl"></td>
				<tr>
				<tr>
				<td colspan="2" align="center"><label></label></td>
				</tr>
			...
			<input type="hidden" name="pagetype" id="pagetype" value="" />
					 				<div class="col-md-4 col-lg-4 col-sm-4 det col-xs-4 det">
				  <div class="single_left">
					...
					//if($row_prod['product_webprice']>695)
								...
								{
								?>
									<div class='req_info_new_button'><img id="request_leasequote-id" src="<?php url_site_image('request_leasequote.png')?>" alt="Request Lease Quote" style="cursor:pointer"></div>
								<?php
								}	
								?>
                ...
                <div class="det_buy_link_newAicon"><img src="<?php url_site_image('iconsnew.jpg')?>" alt="Pay By Card"></div>
                 ...
                 ?>
                 								<div class='req_info_new_button1'><input type="button"  class="btnrequest btn btn-add-to-cart btn-lg sharp" value="Request Information"  alt="Request Information" style="cursor:pointer;"></div>
                 								<?php /* <div class='req_info_new_button'><img id="data-modal-id" src="<?php url_site_image('request_info.svg')?>"  alt="Request Information" style="cursor:pointer;width:auto;height:50px"></div> */?>
...
<div class="tabs-7">
	...
	$tabs_arr		= $tabs_cont_arr	= array();
		...
		$tabs_content_arr[-4]	= stripslashes($row_prod['product_longdesc']);
		elseif ($row_prod['product_shortdesc'])
		$tabs_content_arr[-4]	= stripslashes($row_prod['product_shortdesc']);	
		   if (count($tabs_content_arr))
			{
				$tabs_arr 			= array (-4=>'Overview');
		...
		if($writereview_show == 11 or $readreview_show == 11)
			{
				...
				{ 
					...
					$tabs_arr[0] 			= 'Reviews ';//stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_SIZECHART_HEAD']);
					$tabs_content_arr[0]	= $review_content;
	  ...
	  if ($_REQUEST['prod_curtab'] and $row_prod['product_variablecombocommon_image_allowed']=='N')
	  {
		...
		if(count($tabimg_arr))
		{
			...
			?>
				...
				<div class="zoom-left">
				<img style="border:1px solid #e8e8e6;" id="zoom_09" src="<?php url_root_image($tabimg_arr[0]['image_bigpath'])?>" data-zoom-image="<?php url_root_image($tabimg_arr[0]['image_extralargepath'])?>" >
				<?php		  
