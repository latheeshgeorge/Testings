			...
			<div class="col-sm-4">
                   ...
                   <input type="hidden" name="rdo_suboption" id="rdo_suboption" value='title_desc'/>
	                        <div class="input-group search-box-pad" >
	                            <input type="text" class="form-control input-search" name="quick_search" id="quick_search" placeholder="SEARCH PRODUCTS">
						...
						source: "http://<?php echo $ecom_hostname ?>/includes/autocomplete_product_search_new.php",
						minLength: 1,
		...
		function mod_shoppingcart($title)
		{
			...
			?>
                        ...
                        <div  class="cart-lista" data-toggle="modal" data-target="#myModal">
                            ...
                            <span style="color:#fff;">CART&nbsp;</span><span class="badge"><?php echo  (get_session_var('cart_total_items'))?get_session_var('cart_total_items'):0?></span>
                        </div>
                        <?php 
