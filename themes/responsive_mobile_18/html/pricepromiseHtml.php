...
/*############################################################################
 ...
 ?>
		    ...
		    <table width="100%" border="0" cellpadding="0" cellspacing="3"  class="reg_table1">
					 <tr>
					...
					<div class="reg_shlf_hdr_outr"><div class="reg_shlf_hdr_in"><span style="padding-left:6px;"><?=$Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_THE_PROD_HEAD']?></span></div></div></td>
					</tr>
					<tr>
					...
					<tr>
					<td  align="left" class="shoppingcartheader">
					<div class="reg_shlf_hdr_outr"><div class="reg_shlf_hdr_in"><span style="padding-left:6px;"><?=$Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_PRICE_BEAT_HEAD']?></span></div></div></td>
					</tr>
					<tr>
					<td valign="top" align="left"  >
					<table  width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
					...
					?>
								...
								<tr>
    <td align="center"><div class="cart_top_links"><div class=" "><div style="margin-left:6px;">
		...
		?>
				...
				?>
					...
					<td  valign="middle"></td>
					<td  valign="top" align="left">
					<div class="review_pdta" align="left"><a href="<?php url_product($row_prom['products_product_id'],$row_prod['product_name'])?>"><?php echo stripslashes($row_prod['product_name'])?></a></div>
					<?php
					...
					<table width="100%" border="0" cellpadding="1" cellspacing="1" class="reg_table">
					<tbody>
						<tr>
					...
					<table width="100%" border="0" cellpadding="1" cellspacing="1" class="reg_table_admin">
					<tbody>
						<tr>
						<td colspan="3" align="left">
					...
					?>
					<tr>
					<td colspan="3"  align="left" ><input type="button" class=" " value="<?=stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_ADD_TO_CART'])?>" name="price_AddtoCart" onclick="document.frm_priceAddcart.submit()" /></td>
					</tr>		
					</tbody></table>
					</div>
					</div>
		...
		function Show_Mypricepromise_requests()
		{
			...
			$sort_option_txt 	= generateselectbox('prm_sort_by',$sort_options,$sort_by,'','',0,'form-control');
			$sort_by_txt		= generateselectbox('prm_sort_order',array('ASC' => 'ASC','DESC' => 'DESC'),$sort_order,'','',0,'form-control');
						...
						<div class="reg_shlf_cont_div">
                            ...
                            <table  border="0" cellpadding="2" cellspacing="3" width="100%" class="reg_table_top">
							 <tr><td colspan="5">&nbsp;</td></tr>
							  <tr>
								<td width="11%"  align="left" nowrap="nowrap" class="usermenucontent"><?php echo stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICEPROM_PRODNAME'])?></td>
								<td width="22%" nowrap="nowrap" class="usermenucontent">
									<input name="prm_prodname" id="prm_prodname" class="textfeild_ord form-control" type="text" size="10" value="<?php echo $_REQUEST['prm_prodname']?>" />
									</td>
							    <td width="7%" align="right" nowrap="nowrap" class="usermenucontent">Status</td>
							    <td width="27%"  align="left" nowrap="nowrap" class="usermenucontent"><?php
									$status_arr = array(''=>'Any','New'=>'Pending','Accept'=>'Accepted','Reject'=>'Rejected');
									echo generateselectbox('prm_status',$status_arr,$_REQUEST['prm_status'],'','',0,'form-control')
								?></td>
								<td width="10%">&nbsp;</td>
							  </tr>
							  <?php
							  /*
							  <tr>
							    <td nowrap="nowrap" class="usermenucontent" width="11%" align="left"><?php echo stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_BETDATE'])?></td>
						      ...
						      */
						      ?> 
							  <tr>
							    <td nowrap="nowrap" class="usermenucontent" width="11%"  align="left" ><?php echo stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_SORTBY'])?></td>
							    <td   width="19%"  class="usermenucontent"><?php echo $sort_option_txt;?> </td><td  align="right"  width="7%"  class="usermenucontent">Sort</td><td   width="19%"  class="usermenucontent"><?php echo $sort_by_txt?> </td>
						        <td width="29%" nowrap="nowrap" class="usermenucontent"><input name="Search_go" type="submit" class=" " id="Search_go" value="Go" onclick="document.frm_promise.search_click.value=1" /></td>
								<td width="10%">&nbsp;</td>
							...
							else
							{
								...
								?>
									<tr class="edithreflink_tronmouse">
										...
										{
										?>
											<a href="<?php url_link('pricepromiseapproved'.$row_query['prom_id'].'.html')?>" title="<?=stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICEPROM_ADD_TO_CART'])?>"><input type="button" value="<?=stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICEPROM_ADD_TO_CART'])?>" class="edithreflink" border="0" /></a>
										<?php
										}
										else
											echo ' -- ';
				...
				<tr>
					...
					?>
						<tr>
							...
							<a href="<?php url_link('pricepromiseapproved'.$prom_id.'.html')?>" title="<?=stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICEPROM_ADD_TO_CART'])?>">
							<input type="button" class=" " value="<?=stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_ADD_TO_CART'])?>"  />
							</a>
							</td>
						</tr>	
					<?php
			...
			?>
				...
				<tr id="add_post" style="display:none">
					...
					<input type="hidden" name="add_post" id="add_post" value="1" />
						...
						<tr>
							<td align="left" class="" valign="top" width="30%"><?=stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_CUST_POST_ENTER'])?></td>
							<td align="left"><textarea rows="3" cols="35" name="price_post" class="form-control"></textarea></td>
						</tr>
						<tr>
							<td align="center"  class="">
							<div class="cart_shop_cont"><div>
							 <input name="post_cancel" class=" " id="post_cancel" value="Cancel" onclick="document.getElementById('add_post').style.display='none'" type="button">
							</div></div>
							</td>
							<td align="left" class="">
							<input name="post_go" class=" " id="post_go" value="Save Post" onclick="" type="submit">
							</div></div>
