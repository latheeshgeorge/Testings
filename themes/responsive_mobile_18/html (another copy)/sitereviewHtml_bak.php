...
/*############################################################################
	...
	class sitereview_Html
	{
		...
		?>
			...
			?>	<tr>
				...
				<?php 
						  echo $Captions_arr['SITE_REVIEWS']['SITE_REVIEW_ADDED_SUCCESSFULLY'];
		...
		<?
		 if($Captions_arr['SITE_REVIEWS'][$alert]){
						  		echo "Error !! ". $Captions_arr['SITE_REVIEWS'][$alert];
						  }else{
						  		echo  "Error !! ". $alert;
						  }
		?>
		...
		?>
			<tr>
			<td width="41%" class="addreivewconent"><?=$Captions_arr['SITE_REVIEWS']['SITE_REVIEW_AUTHOR']?></td>
			<td width="59%" align="left" valign="middle"><input name="review_author" type="text" class="addreivewinput" id="review_author" size="39" /></td>
			</tr>
			<tr>
			<td width="41%" class="addreivewconent"><?=$Captions_arr['SITE_REVIEWS']['SITE_REVIEW_AUTHOR_EMAIL']?></td>
			...
			<tr>
			<td class="addreivewconent"><?=$Captions_arr['SITE_REVIEWS']['SITE_REVIEW_REVIEWTEXT']?></td>
	...
	<?php $ret_sitereview = $db->query($sql_sitereview);
