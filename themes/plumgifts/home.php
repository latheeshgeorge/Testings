...
?>
  ...
  <tr>
    <td align="left" valign="top" class="mainlefttd">
   ...
   <div class="left_main">
    ...
    <td align="left" valign="top" class="mainrighttd">
	...
	<div class="link_pdt_conts">
		...
		<div class="det_link_nav"><a onmouseout="stopMe()" onmouseover="scrollDivRight('containerA')" href="#null"><img src="<?php url_site_image('js-arrow-left.gif')?>"></a></div>
			<div class="det_link_pdt_inner" id="containerA">
		...
		<div class="det_link_nav_rt"> <a onmouseout="stopMe()" onmouseover="scrollDivLeft('containerA','830')" href="#null"><img src="<?php url_site_image('js-arrow-right.gif')?>"></a></div>
		</div>
	</div>
</div> 
    </td>
