	...
	if ($from_date or $to_date)
	{
		...
		//print_r($ord_array );
		  ...
		  <table width="100%" border="0" cellpadding="3" cellspacing="0" >
			  <tr>
				<td colspan="12" align="left" valign="middle"><div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?php echo $Captions_arr['ORDER']['ORDER_MAINHEADING']?></div>			    </td>
		      </tr>
              <tr>
                <td colspan="12" align="left" valign="middle"  ><br />
                <table  border="0" cellpadding="2" cellspacing="3" width="100%" class="userordertablestyleA">
                  <tr>
                    <td colspan="1" nowrap="nowrap" class="usermenucontent"><?php echo $Captions_arr['ORDER']['ORDERID']?></td>
                    <td colspan="3" nowrap="nowrap" class="usermenucontent"><?php echo $Captions_arr['ORDER']['ORDER_EMAIL']?></td>
				    <td colspan="5" nowrap="nowrap" class="usermenucontent" ><?php echo $Captions_arr['ORDER']['ORDER_CUSTDET']?></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td colspan="5" nowrap="nowrap" class="usermenucontent"><?php echo $Captions_arr['ORDER']['ORDER_BETDATE']?> </td>
                    <td colspan="4" nowrap="nowrap" class="usermenucontent"><?php echo $Captions_arr['ORDER']['ORDER_SORTBY']?></td>
                  </tr>
                  <tr>
                    <td width="11%" nowrap="nowrap" class="usermenucontent"><input name="ord_fromdate" id="ord_fromdate" class="textfeild" type="text" size="8" value="<?php echo $_REQUEST['ord_fromdate']?>" readonly="true" /></td>
                    <td width="6%" nowrap="nowrap"><?php /*<a href="javascript:show_calendar('frm_orders.ord_fromdate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('show-calendar.gif')?>" width="24" height="22" border="0" /></a>*/?></td>
                    <td width="5%" nowrap="nowrap" class="usermenucontent">and</td>
                    <td width="11%" nowrap="nowrap" class="usermenucontent">
                      <input name="ord_todate" class="textfeild" id="ord_todate" type="text" size="8" value="<?php echo $_REQUEST['ord_todate']?>"  readonly="true"/>
                    </a></td>
                    <td width="10%" nowrap="nowrap"><?php /*<a href="javascript:show_calendar('frm_orders.ord_todate');" onmouseover="window.status='Date Picker';return true;" onmouseout="window.status='';return true;"><img src="<?php url_site_image('show-calendar.gif')?>" width="24" height="22" border="0" /></a>*/?></td>
                    ...
                    <td width="38%" nowrap="nowrap" class="usermenucontent">
                      <input name="Search_go" type="submit" class="buttongray" id="Search_go" value="Go" onclick="document.frm_orders.search_click.value=1" />
                    </td>
                  </tr>
                  <!--<tr>
				  ...
				  jQuery.noConflict();
						var $ajax_js = jQuery; 
						$ajax_js(function() {
								$ajax_js( "#ord_fromdate" ).datepicker({dateFormat: "dd-mm-yy"});
								$ajax_js( "#ord_todate" ).datepicker({dateFormat: "dd-mm-yy"});
						});
				  </script>
                </td>
              </tr>
              <tr>
                <td colspan="7" align="center" valign="middle" class="pagingcontainertd" ><?php 
														$path = '';
														$query_string .= "";
			  ...
			  <tr>
                <td colspan="7" align="left" valign="middle" class="pagingcontainertd" ><img src="<?php url_site_image('new_post.gif')?>"   border="0" title="New" />
				&nbsp;<?php echo $Captions_arr['ORDER']['ORDER_NEWPOSTS']?></td>
			</tr>	 
            <tr>
            <td align="middle" valign="middle" class="ordertableheader"><?php echo $Captions_arr['ORDER']['ORDER_ID']?></td>
            <td align="middle" valign="middle" class="ordertableheader"><?php echo $Captions_arr['ORDER']['ORDER_DATE']?></td>
          	 <td   align="middle" valign="middle" class="ordertableheader"><?php echo $Captions_arr['ORDER']['ORDER_EMAIL']?></td>
	         <td  align="middle" valign="middle" class="ordertableheader"  nowrap="nowrap"><?php echo $Captions_arr['ORDER']['ORDER_STATUS']?></td>
             <td  align="middle" valign="middle" class="ordertableheader"><?php echo $Captions_arr['ORDER']['ORDER_TOTAL']?></td>
             <td  align="middle" valign="middle" class="ordertableheader"><?php echo $Captions_arr['ORDER']['ORDER_REFUND']?></td>
            <td   align="middle" valign="middle" class="ordertableheader"><?php echo $Captions_arr['ORDER']['ORDER_PAYSTAT']?></td>
		  </tr>
	<?php
	 ...
	 ?>
		   ...
		   ?>
		   <tr>
		        <td align="center" valign="middle" class="pagingcontainertd" colspan="12" >
				<?php 
					$path = '';
					$query_string .= "";
					paging_footer($path,$query_string,$tot_cnt,$start_var['pg'],$start_var['pages'],'',$pg_variable,'Orders',$pageclass_arr); 	
		 ...
		 ?>
	        ...
	        <tr>
					<td align="center" valign="middle" class="shoppingcartcontent" colspan="12" >
						<?php echo $Captions_arr['ORDER']['ORDER_NOTFOUNDORDER']?>		</td>
			</tr>	
		 <?
...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td colspan="4" align="left" valign="middle" class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >>  <a href="<?php url_link('myorders.html')?>"><?php echo $Captions_arr['ORDER']['ORDER_MAINHEADING']; ?></a> >> <?php echo $Captions_arr['ORDER']['ORDER_DETAILS']?></td>
  </tr>
  <tr>
    ...
    <td align="right" colspan="4" class="tdcolorgray_normal"><?php	
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="2">
          ...
          <?php
				...
				?>
          <tr>  
            <td width="30%" align="left" class="<?PHP echo $cls;  ?>"><a class="edittextlink" href="<?php url_product($row_prods['products_product_id'],$row_prods['product_name'],-1)?>" title="<?php echo stripslashes($row_prod['product_name'])?>"><?php echo stripslashes($row_prods['product_name']); ?></a>&nbsp;
					<?php
...
?>
	...
	<table width="100%" border="0">
	  ...
	  <?PHP
	   ...
	   ?>
      <tr>
        <td   class="<?PHP echo $cls;  ?>"><div align="left"><a class="edittextlink" href="<?php url_product($row_prods['products_product_id'],$row_prods['product_name'],-1)?>" title="<?php echo stripslashes($row_prod['product_name'])?>"><?php echo stripslashes($row_prods['product_name']);?></a>&nbsp;
			<?php
				echo get_ProductVarandMessage($_REQUEST['order_id'],$row_prods['orderdet_id']);
			?>		</div></td>
...
?>
          ...
          <tr>
            ...
            <td width="15%" align="center" class="<?php echo $cls?>"><?php 
								if ($row_prods['order_preorder']=='N')
								{
									...
									echo 'Available on <br/>'.dateFormat($row_prods['order_preorder_available_date'],'datetime');
							?>            </td>
            <td width="20%" class="<?php echo $cls?>" align="center"><?php  echo $row_prods['order_qty']; ?>
  ...
  <tr>
    <td align="right" colspan="4" class="tdcolorgray_normal"><table width="100%" border="0" cellspacing="1" cellpadding="1">
      <tr>
        <td colspan="6" align="right" class="myorderlabel">Sub Total</td>
        <td width="24%" colspan="2" align="right" class="myorderlabel"><?php echo print_price_selected_currency($row_select_ord['order_subtotal'],$row_select_ord['order_currency_convertionrate'],$row_select_ord['order_currency_symbol'],true)?></td>
      </tr>
      <tr>
        <td colspan="6" align="right" class="myorderlabel">+ Total Delivery Charge</td>
        <td colspan="2" align="right" class="myorderlabel"><?php echo print_price_selected_currency($row_select_ord['order_deliverytotal'],$row_select_ord['order_currency_convertionrate'],$row_select_ord['order_currency_symbol'],true)?></td>
      </tr>
      <tr>
        <td colspan="6" align="right" class="myorderlabel">+ Total Tax</td>
        <td colspan="2" align="right" class="myorderlabel"><?php echo print_price_selected_currency($row_select_ord['order_tax_total'],$row_select_ord['order_currency_convertionrate'],$row_select_ord['order_currency_symbol'],true)?></td>
      </tr>
      <tr>
        <td colspan="6" align="right" class="myorderlabel">+ Total Gift Wrap Charge</td>
        <td colspan="2" align="right" class="myorderlabel"><?php echo print_price_selected_currency($row_select_ord['order_giftwraptotal'],$row_select_ord['order_currency_convertionrate'],$row_select_ord['order_currency_symbol'],true)?></td>
      </tr>
      <?php
						...
						?>
      <tr>
        <td colspan="6" align="right" class="myorderlabel">- <?php echo $caption?></td>
        <td colspan="2" align="right" class="myorderlabel"><?php echo print_price_selected_currency($row_select_ord['order_customer_discount_value'],$row_select_ord['order_currency_convertionrate'],$row_select_ord['order_currency_symbol'],true)?></td>
      </tr>
      <?php
							}
						?>
      <?php
						...
						?>
      <tr>
        <td colspan="6" align="right" class="myorderlabel">- Bonus Points Discount (<?php echo $row_select_ord['order_bonuspoints_used']?> used)</td>
        <td colspan="2" align="right" class="myorderlabel"><?php echo print_price_selected_currency($row_select_ord['order_bonuspoint_discount'],$row_select_ord['order_currency_convertionrate'],$row_select_ord['order_currency_symbol'],true)?></td>
      </tr>
      <?php
							}
						?>
      <tr>
        <td colspan="6" align="center" class="myorderlabel">
		<?php
		
		if($row_select_ord['order_bonuspoint_inorder']>0)	
		{
			echo "Bonus Points Earned: ".$row_select_ord['order_bonuspoint_inorder'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
		}
		if($row_select_ord['order_bonuspoints_donated']>0)	
		{
			echo "Bonus Points Donated: ".$row_select_ord['order_bonuspoints_donated'];
		}
		?>
			&nbsp;</td>
        <td colspan="2" align="right" class="myorderlabel">------------------------------</td>
      </tr>
      <tr>
        <td colspan="6" align="right" class="myorderlabel">Grand Total</td>
        <td colspan="2" align="right" class="myorderlabel"><?php echo print_price_selected_currency($row_select_ord['order_totalprice'],$row_select_ord['order_currency_convertionrate'],$row_select_ord['order_currency_symbol'],true)?></td>
      </tr>
      <tr>
        <td colspan="6" align="right" class="myorderlabel">&nbsp;</td>
        <td colspan="2" align="right" class="myorderlabel">====================</td>
      </tr>
      <?php
						...
						?>
      <tr>
        <td colspan="6" align="right" class="myorderlabel">Total Refunded</td>
        <td colspan="2" align="right" class="myorderlabel"><?php echo print_price_selected_currency($row_select_ord['order_refundamt'],$row_select_ord['order_currency_convertionrate'],$row_select_ord['order_currency_symbol'],true)?></td>
      </tr>
      <tr>
        <td colspan="6" align="right" class="myorderlabel">Total Remaining after Refund</td>
        <td colspan="2" align="right" class="myorderlabel"><?php echo print_price_selected_currency(($row_select_ord['order_totalprice']-$row_select_ord['order_refundamt']),$row_select_ord['order_currency_convertionrate'],$row_select_ord['order_currency_symbol'],true)?></td>
      </tr>
      <tr>
        <td colspan="6" align="right" class="myorderlabel">&nbsp;</td>
        <td colspan="2" align="right" class="myorderlabel">====================</td>
...
?>
	...
	<table width="100%" border="0">
      ...
      <tr>
		...
		<a class="edittextlink" href="<?php url_product($row_prods['products_product_id'],$row_prods['product_name'],-1)?>" title="<?php echo stripslashes($row_prod['product_name'])?>"><?php echo stripslashes($row_prods['product_name']);?></a>&nbsp;
				<?php
				echo get_ProductVarandMessage($_REQUEST['order_id'],$row_prods['orderdet_id']);
				?>	
		</div></td>
		...
		<tr>
			...
			?>
					<tr>
						...
						<td align="left"  class="userordercontent" colspan="3"><?php echo ucwords(strtolower(stripslashes($row_ord['order_deliverytype'])))?></td>
...
<tr><td  width="100%" colspan="4">
  <table width="100%" border="0" cellpadding="1" cellspacing="1" id="enqDetails" <?PHP if(!$_REQUEST['ord_pg']) { ?> style="display:none;" <? } ?> >
    <tr class="userorderheader">
    ...
    <tr id="EnqId4" style="display:none;" >
      <td colspan="5" class="userorderheader"><?php echo $Captions_arr['ORDER']['ORDER_ENQ_PLACEENQ']; ?></td>
      </tr>
    ...
    <tr  class="userorderheader">
      <td colspan="5" class="userorderheader"  ><?php echo $Captions_arr['ORDER']['ORDER_ENQ_EXIST']?></td>
      </tr>
	  <?PHP 
    ...
    <tr>
      <td width="9%" class="ordertableheader" align="center" valign="top"><?php echo $Captions_arr['ORDER']['ORDER_ENQ_SLNO']?></td>
      <td width="42%" class="ordertableheader" align="center" valign="top"><?php echo $Captions_arr['ORDER']['ORDER_DATE']?></td>
      <td width="23%" class="ordertableheader" align="left" valign="top"><?php echo $Captions_arr['ORDER']['ORDER_ENQ_SUB']?></td>
      <td width="14%" class="ordertableheader" align="center" valign="top"><?php echo $Captions_arr['ORDER']['ORDER_ENQ_STATUS']?></td>
      <td width="12%" class="ordertableheader" align="center" valign="top"><?php echo $Captions_arr['ORDER']['ORDER_ENQ_NEWPOSTS']?></td>
    </tr>
	<?PHP if($num>0) {
		...
		<tr>
			<td colspan="4" align="left" valign="bottom"><table width="100%" border="0" cellspacing="1" cellpadding="1">
			  <tr>
				...
				<td width="97%" align="left" class="userorderheadernew"><?php echo $Captions_arr['MY_DOWNLOADS']['DOWN_ORD_DOWN']?></td>
			  </tr>
			</table></td>
		  </tr>
		<tr>
			...
			?>
				<tr>
					...
					<?php echo $Captions_arr['MY_DOWNLOADS']['DOWN_SLNO']?></td>
					<td align="left" width="24%" class="ordertableheader">
					<?php echo $Captions_arr['MY_DOWNLOADS']['DOWN_TITLE']?></td>
					<td align="center" width="14%" class="ordertableheader">
					<?php echo $Captions_arr['MY_DOWNLOADS']['DOWN_LIMIT']?></td>
					<td align="left" width="14%" class="ordertableheader">
					<?php echo $Captions_arr['MY_DOWNLOADS']['DOWN_START']?></td>
					<td align="left" width="23%" class="ordertableheader">
					<?php echo $Captions_arr['MY_DOWNLOADS']['DOWN_END']?></td>
				...
				<tr>
					...
					<?php echo $Captions_arr['MY_DOWNLOADS']['DOWN_NOT_FOUND']?>&nbsp;</td>
				</tr>
				<?php
				} else {
				$i=1;
				while ($row_query = $db->fetch_array($ret_download))
				{
					...
					if ($row_query['disabled']=='Y')
						$force_hide_download_link = true;
				?>
					<tr class="edithreflink_tronmouse" title="<?php echo $Captions_arr['MY_DOWNLOADS']['DOWN_DOWNLOAD']?>" onmouseover="this.className='edithreflink_trmouseout'" onmouseout="this.className='edithreflink_tronmouse'">
						<td align="left" valign="middle" class="favcontent"><?php echo $i++;?></td>
						<td align="left" valign="middle" class="favcontent"><?php echo  stripslashes($row_query['proddown_title'])?></a></td>
						...
						<?php 
							...
							{
								echo $Captions_arr['MY_DOWNLOADS']['DOWN_NA'];
							}
						?>						</td>
						<td align="center" valign="middle" class="favcontent">
						<?php
							if ($row_query['proddown_days_active']==1)
							{
								...
								{
									echo $Captions_arr['MY_DOWNLOADS']['DOWN_SET_PAY_SUCC'];
								}	
							}
							else
							{
					  ...
					  <?php
						...
						?>
								<a href="http://<?php echo $ecom_hostname?>/download_product.php?dld=<?php echo $dld?>" title="<?php echo $Captions_arr['MY_DOWNLOADS']['DOWN_CLICK_DOWN'];?>"><img src="<?php url_site_image('download.gif')?>" alt="Click to Download" border="0" /></a>
						<?php
							}
							else
							{
								...
								{
									if ($row_query['disabled']=='Y')
										$hint = $Captions_arr['MY_DOWNLOADS']['DOWN_DISABLE_ADM'];
									else
										$hint = $Captions_arr['MY_DOWNLOADS']['DOWN_EXP'];
								}	
								else
									$hint = $Captions_arr['MY_DOWNLOADS']['DOWN_PAY_NOT'];
						?>
						...
						{
						?>
							<a href="javascript:handle_downloadhistory('<?php echo $row_query['ord_down_id']?>')" title="<?php echo $Captions_arr['MY_DOWNLOADS']['DOWN_HSO_HIST'];?>">
							<img src="<?php url_site_image('download_viewhistory_enabled.gif')?>" alt="<?php echo $Captions_arr['MY_DOWNLOADS']['DOWN_HSO_HIST'];?>" border="0" title="<?php echo $Captions_arr['MY_DOWNLOADS']['DOWN_HSO_HIST'];?>" /></a>
						<?php
						}
						else
						{
						?>
							<img src="<?php url_site_image('download_viewhistory_disabled.gif')?>" alt="<?php echo $Captions_arr['MY_DOWNLOADS']['DOWN_NO_HIST'];?>" border="0" title="<?php echo $Captions_arr['MY_DOWNLOADS']['DOWN_NO_HIST'];?>"/>
						<?php
						}						
						?>						</td>
					</tr>
				...
				?>
						<tr id="downloadhistory_tr_<?php echo $row_query['ord_down_id']?>" style="display:none" >
							...
							<td colspan="3" align="center">
								<table width="100%" cellpadding="1" cellspacing="1" border="0">
								<tr>
									<td align="center" width="5%" class="ordertableheader"><?php echo $Captions_arr['MY_DOWNLOADS']['DOWN_HASH'];?></td>
									<td align="left" width="95%" class="ordertableheader"><?php echo $Captions_arr['MY_DOWNLOADS']['DOWN_DOWN_ON'];?></td>
								</tr>
								<?php
								$cnt = 1;
								...
								?>
								<tr>
									<td align="right" colspan="2" class="favcontent"><strong><?php echo $Captions_arr['MY_DOWNLOADS']['DOWN_TOT_DOWN'];?> <?php echo ($cnt-1)?></strong></td>
								</tr>
								</table>							</td>
						</tr>
				<?php
...
<? } ?>	
  <table width="100%" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td colspan="4" align="left" valign="middle" class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <a href="index.php?req=orders"><?php echo $Captions_arr['ORDER']['ORDER_MAINHEADING']; ?></a> >> <a href="index.php?req=orders&reqtype=order_det&order_id=<?php echo $_REQUEST['order_id']?>"><?php echo $Captions_arr['ORDER']['ORDER_DETAILS']; ?></a>  >> <?php echo $Captions_arr['ORDER']['ORDER_ENQ_POSTS']; ?>  </td>
  </tr>
  <tr><td>
  <table width="100%" border="0" cellpadding="0" cellspacing="2">
    <tr>
      <td colspan="5" align="left" class="userorderheader"><?=$Captions_arr['ORDER']['ORDER_ENQ_POSTHEAD']; ?></td>
    </tr>
    <tr>
    ...
    <tr id="postDet4" style="display:none;"  class="userorderheader">
      <td colspan="2">&nbsp;<strong><?php echo $Captions_arr['ORDER']['ORDER_ENQ_PLACEPOST']?></strong></td>
      <td colspan="3">&nbsp;</td>
    </tr>
    ...
    <tr id="postDet2" style="display:none;"  class="ordertableheader">
      ...
      <tr>
        <td colspan="5" class="userorderheader"> <?php echo $Captions_arr['ORDER']['ORDER_ENQPOST_EXIST']?> </td>
        </tr>
      <tr>
      <td width="9%" class="ordertableheader"><div align="center"><strong><?php echo $Captions_arr['ORDER']['ORDER_ENQ_SLNO']?></strong></div></td>
      <td width="18%" class="ordertableheader"><div align="center"><strong><?php echo $Captions_arr['ORDER']['ORDER_DATE']?></strong></div></td>
      <td width="14%" class="ordertableheader"><div align="center"><strong><?php echo $Captions_arr['ORDER']['ORDER_ENQ_POSTBY']?></strong></div></td>
      <td width="8%" class="ordertableheader"><div align="center"><strong><?php echo $Captions_arr['ORDER']['ORDER_ENQ_POSTNR']?></strong></div></td>
      <td width="8%" class="ordertableheader"><div align="center"><strong><?php echo $Captions_arr['ORDER']['ORDER_ENQ_POSTDET']?></strong></div></td>
    </tr>
	<?PHP
