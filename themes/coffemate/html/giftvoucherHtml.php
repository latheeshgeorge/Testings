...
/*############################################################################
	...
	class giftvoucher_Html
	{
		...
		{
			//global $Captions_arr,$ecom_siteid,$db,$ecom_hostname,$vImage,$Settings_arr,$alert,$protectedUrl;
	...
	?>
		...
		<?php 
		 ...
		 ?>
			<tr>
				<td colspan="2" class="message_header"><?=$Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_HEADER_TEXT']?>     </td>
			</tr>
	<? 
			}
...
?>
  ...
  <tr>
    <td class="emailfriendtextnormal" align="left"><?=$Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_VOUCHER_VERIFICATION_CODE_ABOVE']?>&nbsp;<span class="redtext">*</span></td>
                  ...
                  ?>
                   <tr>
    				<td colspan="2" align="right">
                     <table width='100%' cellpadding='0' cellspacing='0' border='0'>
                     <tr>
                        <td colspan="2" align="right" class="gift_mid_table_td"><input name="buygiftvoucher_Submit" type="button" class="buttongray" id="buygiftvoucher_Submit" value="Pay<?//=$Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_VOUCHER_BUY_BUTTON']?>" onclick="validate_buygiftvoucher(document.frm_buygiftvoucher)" /></td>
                    </tr>
                     </table>
                     </td>
					</tr>
...
?>		
	...
	<?php
		...
		?>
				<tr>
					<td colspan="2" align="right" class="emailfriendtextnormal">
						<input class='buttongray' type="button" name="submit_backhome" value="<?php echo $Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_PREVIEW_BACH_HOME']?>" onclick="window.location ='<?php url_link('')?>'" />
					</td>
				</tr>	
		<?php
			}	
...
<?php		
        ...
        <div class="gift_mid_middle" >
    	 <div class="gift_mid_des">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="gift_mid_table">
			 <tr>
				<td width="100%" class="message_header" align="left"><?php echo $Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_SPEND_HEADER']?></td>
			 </tr>
			<?php
			if($spend_alert)
			{
	...
	<?php	
		...
		?>	
			...
			<tr>
				<td class="gift_spend_table_td" valign="top">
			<?php
			if ($row_cartdet['voucher_id']!=0) // case if code is a gift voucher
			{
	...
	?>
		...
		<tr onmouseover="this.className='normalshelf_hover'" onmouseout="this.className='shelfBtabletd'">
				...
				?>
					...
					foreach ($var_arr as $k=>$v)
					{
						...
						if($db->num_rows($ret_var))
						{
							...
							$cls = ($var_cnts%2==0)?'productvariabletdA':'productvariabletdB';
							$var_cnts++;
							echo '<tr><td align="right" class="'.$cls.'" width="50%">';
			...
			{
			?>
				<div><br/><input type="button" class="buttongray" onclick="show_wait_button(this,'Please Wait...');document.<?php echo $frm_name?>.fpurpose.value='Prod_Addcart';document.<?php echo $frm_name?>.submit();" value="<?php echo stripslash_normal($Captions_arr['PROD_DETAILS'][$caption_key]);?>"/></div>
			<?php
			}
			?>	
