...
<div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?=$Captions_arr['CUST_REG']['REGISTRATION_TREEMENU_TITLE']?></div>
		...
		<tr>
			<td width="43%" align="right" valign="middle" class="regiconent"><?=$Captions_arr['CUST_REG']['ACCNT_TYPE']?></td>
			...
			<td colspan="2">
				<table width="100%" border="0" cellpadding="0" cellspacing="6" align="left" >
					...
					{	
						...
						?>
							 <tr>
								<td class="regiconent" valign="middle" width="43%" align="right">
		...
		// Get the list of static fields to be display for business accounts
				...
				{	
					...
					?>
						<tr>
							<td class="regiconent" valign="middle" align="left" width="43%">
	...
	<tr>
			...
			<table width="100%" border="0" cellspacing="4" cellpadding="0" class="regifontnormal_newsletter">
					...
					<td  align="left" valign="middle" width="96%"><b>
					<?=$Captions_arr['CUST_REG']['CUSTOMER_RECEIVE_NEWSLETTER_HEADER']?></b></td>  
...
<div class="cust_outwrapin">
	<? if($help_mstop!='')
		...
		<? }?>
		<div class="cust_headwrap">
		<?php echo $Captions_arr['CART']['CART_LOGIN']?>
		</div>
		<div class="cust_wemail">
		<input name="custlogin_uname" id="custlogin_unamew" type="text" class="inputA_new" size="40" value="Email" onfocus="if(document.getElementById('custlogin_unamew').value == 'Email'){ document.getElementById('custlogin_unamew').value=''; }"  onblur="if(document.getElementById('custlogin_unamew').value == ''){ document.getElementById('custlogin_unamew').value='Email'; }"/>
		</div>
		<div class="cust_wpassword">
		<input name="custlogin_pass" id="custlogin_passw" type="text" class="inputA_new" size="40" value="Password" onfocus="if(document.getElementById('custlogin_passw').value == 'Password'){ document.getElementById('custlogin_passw').value=''; document.getElementById('custlogin_passw').type='password';}"  onblur="if(document.getElementById('custlogin_passw').value == ''){ document.getElementById('custlogin_passw').value='Password';document.getElementById('custlogin_passw').type='text'; }else{document.getElementById('custlogin_passw').type='password';}"/>
		</div>
		<div class="wcust_submit">
		 <input type="hidden" name="redirect_back" value="<?PHP echo $redirect_back; ?>" /> 
			...
			<input name="custcartlogin_Submit" type="submit" class="cust_wsubmit" value="Login" onclick="document.frm_custlogin_cart.submit();" />
           <? }
		   ...
		   ?>
			...
			<input name="custenquirelogin_Submit" type="submit" class="cust_wsubmit" value="Login" onclick="document.frm_custlogin_enquire.submit();" />
		   <?
		   } else {?>
			<input name="custenquirelogin_Submit" type="submit" class="cust_wsubmit" value="Login" onclick="document.frm_custlogin.submit();" />
			<?php
			 } 
			  if($_REQUEST['pagetype']=='prodhtml')
			{
			 ...
			 <div class="wcust_links">
			  <span class="wnews_custlnk">
			  <a href="<?php url_link('registration.html')?>" class="loginlinkwl">Create New Account</a>
			  </span>
			  <?php
			//if($Settings_arr['hide_forgotpass']==0) // check whether the forgot password link is disabled from main shop settings
			{
			?>
			  <span class="wfpasswordlnk">
					<a href="<?php url_link('forgotpassword.html')?>" class="loginlinkwr" title="<?php echo $Captions_arr['CUST_LOGIN']['FORGOT_PASS']?>"><?php echo $Captions_arr['CUST_LOGIN']['FORGOT_PASS']?></a>
				</span>
      ...
      <tr>
        <td colspan="2" align="left" valign="middle" class="regiconent_forgot"><?=$Captions_arr['FORGOT_PASSWORD']['FORGOT_PWD_MESSAGE']?></td>
      </tr>
	 <tr>
        <td  align="left" valign="middle" class="regiconent_forgot"><?=$Captions_arr['FORGOT_PASSWORD']['FORGOT_PWD_LABEL']?></td>
		<td  align="left" valign="middle" class="regiconent_forgot"><input name="forgotpwd_email" type="text" class="regiinput" id="forgotpwd_email" size="25" value=""  /></td>
      </tr>
	  <tr>
	    <td  align="left" valign="middle" class="regiconent_forgot"><input name="action_purpose" id="action_purpose" type="hidden" value="ForgotPassword_send"></td>
	    <td align="left" valign="middle" class="regiconent_forgot"><input name="forgotpassword_Submit" type="submit" class="buttongray" id="forgotpassword_Submit" value="<?=$Captions_arr['FORGOT_PASSWORD']['FORGOT_PWD_SUBMIT']?>" /></td>
	    </tr>
           </table></form>
		<script type="text/javascript"> 
