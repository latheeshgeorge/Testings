...
?>
  <tr>
    <td colspan="2" class="message_surv"><?=$survey['survey_question']?> </td>
    </tr>
...
<?php   if($Captions_arr['SURVEY']['SURVEY_BACK_BUTTON']){?>
  <tr>
	...
	<? }?>
      ...
      <tr>
        <td align="left" valign="middle" class="message_surv" style="padding-bottom:20px;"><?php echo $Captions_arr['SURVEY']['SURVEY_SUCESS_MESSAGE']; ?></td>
	  ...
	  if($Captions_arr['SURVEY']['SURVEY_BACK_BUTTON'] && !$survey_displayresults){?>
		...
		?>
			...
			<tr>
			<td align="left" valign="middle" class="message_surv" style="padding-bottom:20px;"><?php echo $Captions_arr['SURVEY']['SURVEY_FAIL_MESSAGE']; ?></td>
