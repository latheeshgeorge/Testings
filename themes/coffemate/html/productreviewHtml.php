...
/*############################################################################
	...
	class productreview_Html
	{
		...
		<?php }  
			...
			<td align="left" valign="middle"><textarea name="review_details" cols="60" rows="6" class="addreivewinput" id="review_details"></textarea></td>
			</tr>
			<tr>
...
function validate_prodreview(frm)
{
	...
	function Show_Productreview()
		...
		<tr>
          <td colspan="2" class="message" align="center"><? echo stripslashes($Captions_arr['PRODUCT_REVIEWS']['WRITE_PRODUCT_REVIEW_ADDED_SUCCESSFULLY'])?></td>
        </tr>
