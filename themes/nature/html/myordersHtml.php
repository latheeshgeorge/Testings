<?php
	...
	if ($from_date or $to_date)
	{
		...
		?>
			...
			<li><?php echo stripslash_normal($Captions_arr['ORDER']['ORDER_MAINHEADING'])?></li>
			</ul>
			</div>
			<div class="inner_header"><?php echo stripslash_normal($Captions_arr['ORDER']['ORDER_MAINHEADING'])?></div>
			<div class="inner_con" >
			...
			<td   align="middle" valign="middle" class="ordertableheader" width="4%">&nbsp;</td>
			</tr>
			<?php
			...
			<td align="middle" valign="middle" class="<?=$cls?>"> <a href="index.php?req=orders&reqtype=order_det&order_id=<?php echo $row_select_ord['order_id']?>" title="View Details">View</a>	</td>
			</tr>
			<?php
			}	
			?>
	...
	<ul>
	<li><a href="<? url_link('');?>"><?=stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']);?></a> &gt;&gt;</li>
	<li><a href="<?php url_link('myorders.html')?>"><?php echo stripslash_normal($Captions_arr['ORDER']['ORDER_MAINHEADING']); ?></a> &gt;&gt;</li>
	<li> <?php echo stripslash_normal($Captions_arr['ORDER']['ORDER_DETAILS'])?></li>
	</ul>
	</div>
	<div class="inner_header"> <?php echo stripslash_normal($Captions_arr['ORDER']['ORDER_DETAILS'])?></div>
	<div class="inner_con" >
	<div class="inner_top"></div>
	<div class="inner_middle_cart">
...
<? } ?>
	...
	<tr  class="userorderheader">
	  <td colspan="5" class="userorderheader"  ><?php echo stripslash_normal($Captions_arr['ORDER']['ORDER_ENQ_EXIST'])?></td>
	  </tr>
	  <?PHP 
...
<ul>
<li><a href="<? url_link('');?>"><?=stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']);?></a> &gt;&gt;</li>
<li><a href="index.php?req=orders"><?php echo stripslash_normal($Captions_arr['ORDER']['ORDER_MAINHEADING']); ?></a>&gt;&gt;</li>
<li><a href="index.php?req=orders&reqtype=order_det&order_id=<?php echo $_REQUEST['order_id']?>"><?php echo stripslash_normal($Captions_arr['ORDER']['ORDER_DETAILS']); ?></a>&gt;&gt;</li>
<li><?php echo stripslash_normal($Captions_arr['ORDER']['ORDER_ENQ_POSTS']); ?></li>
</ul>
</div>
<div class="inner_header"><?php echo stripslash_normal($Captions_arr['ORDER']['ORDER_ENQ_POSTS']); ?></div>
<div class="inner_con" >
<div class="inner_top"></div>
<div class="inner_middle_cart">	
