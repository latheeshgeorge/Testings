...
?>
	...
	function mailinglist_mainsel()
	{
		...
		?>	
		<tr>
			<td width="33%" align="left" valign="top" class="regiconentA"><?=stripslash_normal($Captions_arr['CUST_REG']['ACCNT_TYPE'])?></td>
			<td width="67%" align="left" valign="top" class="regi_txtfeild">
	  ...
	  <div class="inner_con" >
        ...
        <div class="inner_middle">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr class="regitable">
              <td width="43%" align="left" valign="middle" class="regiconent"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_PASSWORD'])?><span class="redtext">*</span></td>
	  ...
	  <div class="inner_con_clr1" >
		...
		{
		global $Captions_arr,$ecom_siteid,$db,$ecom_hostname,$vImage,$Settings_arr,$pagetype,$loginUrl,$ecom_fb_enable;
