<?php
	...
	{
            function show_payonaccount_request($alert='',$hide_status=0)
            {
                global $insmsg, $ecom_siteid,$db,$ecom_hostname,$Settings_arr,$ecom_themeid,$default_layout,$Captions_arr,$inlineSiteComponents,$loginUrl,$ecom_fb_enable;
            ...
            ?>
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="statictable" >
                <tr>
                    <td  colspan="2" align="left" valign="middle"><div class="treemenu"><a href="<? url_link('');?>"><?=stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']);?></a> >> <?php echo stripslash_normal($Captions_arr['PAYONACC']['PAYONACCOUNT_MAINHEADING'])?></div></td>
                </tr>
                <? 
                if($alert!='')
                {
                ?>
                    <tr>
                        <td colspan="2" align="center" valign="middle" class="errormsg"><?php echo stripslash_normal($Captions_arr['PAYONACC'][$alert])?></td>
                    </tr>
                <?
                }
                ?>
                <?php 
                // Check whether payonaccount text is there or not
                if ($Captions_arr['PAYONACC']['PAYONACC_DESC']!='')
                {
                ?>
                    <tr>
                    <td align="left" colspan="2" class="shoppingcartcontent">
                    <div class="inner_con_clr1">
                    <div class="inner_clr1_top"></div>
                    <div class="inner_clr1_middle"> 
                    <?php
                        echo stripslashes($Captions_arr['PAYONACC']['PAYONACC_DESC']);
                    ?>
                    </div>
                ...
                <?php
                  ...
                  $allow_placerequest = false;
                // Check whether customer is logged in. If logged in check the status of payonaccount
                if($customer_id)
                {
                    // Get the payonaccount details of current customer
                    $sql_cust = "SELECT customer_payonaccount_status 
                                    FROM 
                                        customers 
                                    WHERE 
                    ...
                    if($db->num_rows($ret_cust))
                    {
                        ...
                        switch($row_cust['customer_payonaccount_status'])
                        {
                            case 'ACTIVE': // Currently Active
                                $show_status = $Captions_arr['PAYONACC']['PAYONACC_STAT_ACTIVE'];
                            break;
                            case 'INACTIVE': // Currently Inactive
                                $show_status = $Captions_arr['PAYONACC']['PAYONACC_STAT_INACTIVE'];
                            break;
                            case 'REQUESTED': // Already requested
                                $show_status = $Captions_arr['PAYONACC']['PAYONACC_STAT_REQUESTED'];
                            break;
                            case 'REJECTED': // Rejected by site admin
                                $show_status = $Captions_arr['PAYONACC']['PAYONACC_STAT_REJECTED'];
                            break;
                            case 'NO': // case if not yet requested
                                $allow_placerequest = true;
                            break;
                        }
                            if($allow_placerequest==true)
                            {
                        ?>
                                <tr>
                                <td align="center" colspan="2">
                                    <form name='frmpayonaccount_request' action='<?php url_link('payonaccount.html')?>' method="post">
                                    <input type='hidden' name='sub_action' id='sub_action' value='place_request'/>
                                    <input type='submit' name='payonaccount_request_place' id ='payonaccount_request_place' class='inner_btn_red' value='<?php echo $Captions_arr['PAYONACC']['PAYONACC_PLACE_REQUEST']?>'/>
                                    </form>
                                </td>
                                </tr>
                        <?php
                            }
                            elseif($hide_status==0)
                            {
                        ?>
                                <tr>
                                <td align="center" colspan="2" class="errormsg"> <?php echo $show_status?>
                                </td>
                                </tr>
                        <?php
                            }
		...
		<form name="frm_custlogin_payonacc" id="frm_custlogin_payonacc" method="post" action="" onsubmit="return validate_login(this)" class="frm_cls">
          ...
          <table class="lgn_table" width="100%" border="0" cellpadding="0" cellspacing="4">
            <tbody>
              ...
              <tr>
				...
				<div class="lgn_btn_innerA"><a href="<?php url_link('registration.html?pagetype=payonacc')?>"><img src="<?php url_site_image('new-account.gif')?>" border="0" /></a></div>
				</div>
	  ...
	  <div class="lgn_contnt_outr">
      <div class="lgn_contnt" >
        <div class="lgn_top"><?php echo stripslash_normal($Captions_arr['CUST_LOGIN']['LOGIN'])?></div>
          ...
          <table class="regifontnormal" width="100%" border="0" cellpadding="0" cellspacing="4">
            <tbody>
              ...
              <tr>
				...
				<div class="lgn_btn_innerA"><a href="javascript:document.frm_custlogin_payonacc.submit()"><img src="<?php echo url_site_image('login-img.gif')?>" border="0" /></a></div>
				</div></td>
              </tr>
		...
		<input type="hidden" name="action_purpose" value="show_middle" /> 
		<input type="hidden" name="pagetype" value="payonacc" /> 
		<input type="hidden" name="custpayonacclogin_Submit" value="Login" />
		</form>
                </td>
                </tr>
                <?php
            ...
            function show_Summary($alert='')
            {
				...
				$row_cust 		= $db->fetch_array($ret_cust);
				$cust_name	= stripslash_normal($row_cust['customer_title']).stripslash_normal($row_cust['customer_fname']).' '.stripslash_normal($row_cust['customer_mname']).' '.stripslash_normal($row_cust['customer_surname']);
			...
			<form name='frmpayonaccount_summary' action='<?php url_link('payonaccountpayment.html')?>' method="post">
				 ...
				 <table width="100%" border="0" cellpadding="3" cellspacing="0" class="pay_inner_table">
				  <tr>
					<td colspan="6" align="left" valign="middle"><div class="treemenu"><a href="<? url_link('');?>"><?=stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']);?></a> >> <?php echo stripslash_normal($Captions_arr['PAYONACC']['PAYONACCOUNT_MAINHEADING'])?></div>			    </td>
				  </tr>
				 <? 
				  if($alert!='')
				  {
				  ?>
				   <tr>
					<td colspan="6" align="center" valign="middle" class="errormsg"><?php echo stripslash_normal($Captions_arr['PAYONACC'][$alert])?></td>
				  </tr>
				 <? } ?>
				  <tr>
				  <td colspan="6" >
					  <table border="0" cellpadding="0" cellspacing="0" width="100%">
						  <tr>
							  <td width="13%" align="left" valign="middle" class="userordercontent"><?php echo stripslash_normal($Captions_arr['PAYONACC']['CREDIT_LIMIT'])?></td>
							  ...
							  <td width="26%" align="left" valign="middle" class="userordercontent"><?php echo stripslash_normal($Captions_arr['PAYONACC']['CURRENTACC_BALANCE'])?></td>
				 ...
				 $where_conditions = " WHERE 
				   ...
				   <td colspan="2"></td><!--onclick="window.location='<?php //url_link('payonaccountpayment.html')?>'"-->
					<td align="right"><div id="make_pay_top_div"><? if($row_cust['customer_payonaccount_usedlimit']>0){?><input  type="button" name="make_payment" value="<?php echo stripslash_normal($Captions_arr['PAYONACC']['MAKEPAY_BUTTON'])?>" class="buttonred_cart" onclick="handle_make_payment_top()" />
					<? }?></div></td>
					 <td colspan="2"><? if($numbillcount>0){?><input type="button" name="view_statements" title="View Statements" value="<?php echo stripslash_normal($Captions_arr['PAYONACC']['VIEWSTATEMENT_BUTTON'])?>" class="buttonred_cart" onclick="window.location='<?php url_link('accountviewbills.html')?>'" /><? }?>
					</td>
				   </tr>
				   <? }?>
				   <tr id="makepay_tr" style="display:none;">
					<td colspan="6" align="center">
						...
						<tr>
							...
							<td align="center" width="75%">
									<table cellspacing="4" cellpadding="4" border="0" width="100%" style="border:2px solid #BEBEBE">
										<tr>
										<td  align="left" valign="top" width="15%" colspan="2"  class="pagingcontainertd1">
										 <?php echo stripslash_normal($Captions_arr['PAYONACC']['MAKEPAY_FILLMSG'])?>  </td>
										
										</tr>
										<tr>
										<td  align="left" valign="top" width="15%" class="redtext" >
										 <?php echo stripslash_normal($Captions_arr['PAYONACC']['AMOUNT'])?><span class="redtext">*</span></td>
										 <td width="41%"  align="left"   >
										 <input name="pay_amt" type="text" id="pay_amt"  value=""/> 
										 </td>
										</tr>
										<tr>
										<td  align="left" valign="top" width="29%" class="redtext"  ><?php echo stripslash_normal($Captions_arr['PAYONACC']['ADDITIONAL_DETAILS'])?></td>
										<td align="left"   width="71%" ><textarea name="pay_additional_details" id="pay_additional_details" cols="30" rows="5"></textarea>
										  </td>
										</tr>
										<tr>
										  <td  valign="middle" align="center"  > <input name="Cancel" type="button" class="buttonred_cart" id="cancel" value="<?php echo stripslash_normal($Captions_arr['PAYONACC']['CANCEL_BUTTON'])?>" onclick="handle_make_payment_cancel()"  /></td>
										  <td  align="left" valign="middle"  ><input name="make_payment" type="button" class="buttonred_cart" id="make_payment" value="<?php echo stripslash_normal($Captions_arr['PAYONACC']['MAKEPAY_BUTTON'])?>" onclick="validate_payment(this.form)" /> </td>
										</tr>
								</table>
							  </td>
								<td width="14%" >&nbsp;</td>
					...
					<?php echo stripslash_normal($Captions_arr['PAYONACC']['UNBILLED_TRANSACTION'])?> 			
					</td>
					</tr>
				  <tr>
					<td align="middle" valign="middle" class="ordertableheader" ><?php echo stripslash_normal($Captions_arr['PAYONACC']['SLNO'])?></td>
					<td align="middle" valign="middle" class="ordertableheader" ><?php echo stripslash_normal($Captions_arr['PAYONACC']['PAYONACC_DATE'])?></td>
					 <td   align="middle" valign="middle" class="ordertableheader"><?php echo stripslash_normal($Captions_arr['PAYONACC']['PAYONACC_DETAIL'])?></td>
					 <td  align="middle" valign="middle" class="ordertableheader" ><?php echo stripslash_normal($Captions_arr['PAYONACC']['AMOUNT'])?></td>
			...
			$sql_payondetails = "SELECT pay_id,pay_date,customers_customer_id,pay_amount,pay_transaction_type,pay_details,orders_order_id,pay_additional_details  
					...
					{		
						...
						<tr onclick="" style="" class="edithreflink_tronmouse" title="View Details" onmouseover="this.className='edithreflink_trmouseout'" onmouseout="this.className='edithreflink_tronmouse'">
							...
							$ord_id = $row_payondetails['orders_order_id'];
							  ...
							  else
							  {
								...
								echo $link_from.stripslash_normal($row_payondetails['pay_details']).$link_to;
							  ?>	 	</td>
						...
						<?php
							...
							<?php
								echo nl2br(stripslash_normal($row_payondetails['pay_additional_details']));
							?>						</td>
							</tr>
				<?php
							}
					...
					?>
								 <tr>
										<td align="center" valign="middle" class="shoppingcartcontent" colspan="6" >
											<?php echo stripslash_normal($Captions_arr['PAYONACC']['PAYONACC_NOTFOUNDORDER'])?></td>
								</tr>
					<?
					}		
				?> 			
		  ...
		  ?>
		   <form method="post" name="frm_viewbills" class="frm_cls" action="<?php url_link('accountviewbills.html')?>">
				  <table width="100%" border="0" cellpadding="3" cellspacing="0" >
						  <tr>
							<td colspan="6" align="left" valign="middle"><div class="treemenu"><a href="<? url_link('');?>"><?=stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']);?></a> >> <a href="<? url_link('mypayonaccountpayment.html');?>"><?php echo stripslash_normal($Captions_arr['PAYONACC']['PAYONACCOUNT_MAINHEADING'])?></a> >> <?php echo stripslash_normal($Captions_arr['PAYONACC']['VIEWBILLS_MAINHEADING'])?></div>			    </td>
						  </tr>
						  <tr>
					<td colspan="12" align="left" valign="middle"  ><br />
					<table  border="0" cellpadding="2" cellspacing="3" width="100%" class="userordertablestyleA">
					  <tr>
						<td colspan="5" nowrap="nowrap" class="usermenucontent"><?php echo stripslash_normal($Captions_arr['PAYONACC']['VIEWBILLS_BETDATE'])?> </td>
						<td colspan="4" nowrap="nowrap" class="usermenucontent"><?php echo stripslash_normal($Captions_arr['PAYONACC']['VIEWBILLS_SORTBY'])?></td>
					  </tr>
					  <tr>
				  ...
				  <? }?>
						   <tr>
							<td align="middle" valign="middle" class="ordertableheader" width="10%" ><?php echo stripslash_normal($Captions_arr['PAYONACC']['SLNO'])?></td>
							<td align="middle" valign="middle" class="ordertableheader" ><?php echo stripslash_normal($Captions_arr['PAYONACC']['STATEMENT_DATE'])?></td>
							</tr> 
							<?
								if($numcount)
								{
								...
								?>
								 <tr>
										<td align="center" valign="middle" class="shoppingcartcontent" colspan="2" >
											<?php echo stripslash_normal($Captions_arr['PAYONACC']['VIEWBILLS_NOTFOUNDORDER'])?></td>
								</tr>
								<?
								}
								?>
			...
			else
			{
			  ...
			  $sql_comp 			= "SELECT customer_title,customer_fname,customer_mname,customer_surname,
					...
					?>
					 <table width="100%" border="0" cellpadding="3" cellspacing="0" >
						<tr>
								<td colspan="6" align="left" valign="middle"><div class="treemenu"><a href="<? url_link('');?>"><?=stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']);?></a> >> <a href="<? url_link('mypayonaccountpayment.html');?>">  <?php echo stripslash_normal($Captions_arr['PAYONACC']['PAYONACCOUNT_MAINHEADING'])?></a> >> <a href="<? url_link('accountviewbills.html');?>">  <?php echo stripslash_normal($Captions_arr['PAYONACC']['VIEWBILLS_MAINHEADING'])?></a> >> <?php echo stripslash_normal($Captions_arr['PAYONACC']['VIEWBILLS_STATEMENT_ON'])?> <?php echo dateFormat($closing_date,'datetime');?></div>			    </td>
						 </tr>
						  <tr>
							  <td colspan="6" >
								  <table border="0" cellpadding="0" cellspacing="0" width="100%">
									 ...
									 <tr>
										 <td colspan="2" class="prod_orderheader"><?php echo stripslash_normal($Captions_arr['PAYONACC']['CURRENTST_TRANSACTION_MESS'])?></td>
										 <td  class="prod_orderheader" align="right"><?php echo stripslash_normal($Captions_arr['PAYONACC']['VIEWBILLS_STATEMENT_ON'])?></td>
						...
						<tr onclick="" style="" class="edithreflink_tronmouse" title="View Details" onmouseover="this.className='edithreflink_trmouseout'" onmouseout="this.className='edithreflink_tronmouse'">
							...
							<td align="middle" valign="middle" class="<?=$cls?>" nowrap="nowrap"><?php echo print_price($row_payondetails['pay_amount']);?></td>
							 <td align="middle" valign="middle" class="<?=$cls?>" nowrap="nowrap"> <?php
							  ...
							  ?>
									<div id="accpaydet_<?php echo $row_payondetails['pay_id']?>" onClick="handle_accountdetails('<?php echo $row_payondetails['pay_id']?>')" style="padding-left:0px; cursor:pointer">
									<strong><? stripslash_normal($Captions_arr['PAYONACC']['SHOW_DETAILS'])?></strong> </div>						  
									<?php
							  }?>		</td>
						</tr>
						<?php
		...
		function take_payment_details()
		{
			...
			{
				$row_cust 					= $db->fetch_array($ret_cust);
				$cust_zipcode				= stripslash_normal($row_cust['customer_postcode']);
			}	
...
function handle_paytypeselect_payonaccount(obj)
{
	...
	else 
	{
		...
		else
		{
			...
			<div class="treemenu"><a href="<? url_link('');?>"><?=stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']);?></a> >> <?="Pay on Account Payment"?></div>
			...
			<tr>
				...
				<?php 
						if($Captions_arr['PAYONACC'][$alert])
							echo stripslash_normal($Captions_arr['PAYONACC'][$alert]);
						else
					  		echo $alert;
				?>
				</td>
		...
		<?php } ?>
  <tr>
    <td colspan="4" class="emailfriendtextheader"><?=stripslash_normal($Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_HEADER_TEXT'])?>      </td>
    </tr>
  <tr>
    <td width="33%" align="left" class="regiconent"><?php echo stripslash_normal($Captions_arr['PAYONACC']['CURRENTACC_BALANCE'])?> </td>
    <td width="22%" align="left" class="regiconent">:<?php echo print_price($row_cust['customer_payonaccount_usedlimit'])?> </td>
    <td width="27%" align="left" class="regiconent"><?php echo stripslash_normal($Captions_arr['PAYONACC']['CREDIT_LIMIT'])?></td>
    <td width="18%" align="left" class="regiconent">:<?php echo print_price($row_cust['customer_payonaccount_maxlimit'])?> </td>
  </tr>
  <tr>
    <td align="left" class="regiconent"><?php echo stripslash_normal($Captions_arr['PAYONACC']['LAST_STATE_BALANCE'])?> </td>
    <td align="left" class="regiconent">:<?php echo print_price($prev_balance)?> </td>
    <td align="left" class="regiconent"><?php echo stripslash_normal($Captions_arr['PAYONACC']['CREDIT_REMAINING'])?> </td>
  ...
  <tr>
    <td align="left" class="regiconent"><?php echo stripslash_normal($Captions_arr['PAYONACC']['AMT_BEING_PAID'])?> </td>
  ...
  ?>
		<tr>
		<td align="left" class="regiconent" valign="top"><?php echo stripslash_normal($Captions_arr['PAYONACC']['ADDITIONAL_DETAILS'])?> </td>
  ...
  <tr>
    <td colspan="4" align="center" class="regiconent">&nbsp;</td>
	 ...
	 ?>
  <tr>
    <td colspan="4" align="center" class="regiconent"><img src="<?php url_verification_image('includes/vimg.php?size=4&pass_vname=payonaccountpayment_Vimg&amp;bg=143 186 2')?>" border="0" alt="Image Verification"/>&nbsp;	</td>
    </tr>
  <tr>
    <td colspan="6" align="center" class="regiconent"><?=stripslash_normal($Captions_arr['PAYONACC']['PAYON_VERIFICATION_CODE'])?>&nbsp;<span class="redtext">*</span><span class="emailfriendtext">
	  <?php 
		// showing the textbox to enter the image verification code
		$vImage->showCodBox(1,'payonaccountpayment_Vimg','class="img_input"'); 
	?>
	</span> </td>
    </tr>
  <? }?>
  ...
  ?>
  <tr>
  	<td colspan="4" align="left" class="google_header_text"><?php echo stripslash_normal($Captions_arr['PAYONACC'] ['PAYON_PAYMENT_MULTIPLE_MSG'])?>
  	</td>
  </tr>
 <?php
 }
...
?>
  ...
  <td colspan="2">
					...
					?>
							  <div class="shoppaymentdiv">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
								  <tr>
									<td colspan="<?php echo $pay_maxcnt?>" class="cart_payment_header"><?php echo stripslash_normal($Captions_arr['PAYONACC']['PAYON_SEL_PAYTYPE'])?></td>
								  </tr>
								  <tr>
								  <?php
									echo '<script type="text/javascript">
								  ...
								  ?>
										...
										<input class="shoppingcart_radio" type="radio" name="payonaccount_paytype" id="payonaccount_paytype" value="<?php echo $row_paytypes['paytype_id']?>" onclick="<?php echo $paytype_onclick?>" <?php echo ($_REQUEST['payonaccount_paytype']==$row_paytypes['paytype_id'])?'checked="checked"':''?> /><?php echo stripslash_normal($row_paytypes['paytype_caption'])?>										</td>
								<?php
										$pay_cnt++;
		...
		else
		{
			...
			<tr id="payonaccount_paymethod_tr" style="display:<?php echo $paymethoddisp_none?>">
				...
				<div class="shoppayment_type_div">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td colspan="<?php echo $pay_maxcnt?>" class="cart_payment_header"><?php echo stripslash_normal($Captions_arr['PAYONACC']['PAYON_SEL_PAYGATEWAY'])?></td>
					  </tr>
					  <tr>
					  <?php
	...
	<td colspan="2" align="left" valign="middle">	
		<table width="100%" cellpadding="1" cellspacing="1" border="0">
		<tr>
			<td colspan="2" align="left" class="shoppingcartheader"><?php echo stripslash_normal($Captions_arr['PAYONACC']['PAY_ON_CHEQUE_DETAILS'])?></td>
		</tr>
		<?php
		...
		?>
				<tr>
					...
					<?php echo stripslash_normal($row_checkout['field_name']); if($row_checkout['field_req']==1) { echo '&nbsp;<span class="redtext">*</span>';}?>					</td>
					<td align="left" width="50%" class="emailfriendtextnormal" valign="top">
					<?php
	...
	<tr id="payonaccount_self_tr" style="display:<?php echo $self_disp?>">
		...
		<table width="100%" cellpadding="1" cellspacing="1" border="0">
		<tr>
			<td colspan="2" align="left" class="shoppingcartheader"><?php echo stripslash_normal($Captions_arr['PAYONACC']['PAYON_CREDIT_CARD_DETAILS'])?></td>
		</tr>
		<?php
	...
	?>
	 <tr>
    <td colspan="4" align="right" class="emailfriendtext"><input name="payonaccount_payment_Submit" type="submit" class="inner_btn_red" id="payonaccount_payment_Submit" value="<?="Make Payment"?>"/></td>
    </tr>
	<?php
	}
        }
	...
	?>	
		...
		function Show_payonaccountFailed()
		{
			...
			if($db->num_rows($ret_cart))
			{
				...
				$msg		= stripslash_normal(trim($row_cart['pay_error_msg']));
			}
		...
		?>
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="shoppingcarttable">
			<tr>
				<td align="left" valign="middle"><div class="treemenu"><a href="<? url_link('');?>"><?=stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']);?></a> >> <?php echo stripslash_normal($Captions_arr['PAYONACC']['PAYON_FAILED_TITLE'])?></div></td>
			</tr>
			<?php
				if($msg)
				{
			...
			?>
					<tr>
						<td align="left" class="shoppingcartcontent_indent_highlight">
						<?php echo stripslash_normal($Captions_arr['PAYONACC']['PAYON_FAILED_MSG'])?><br /><br />
						<?php
						if($_REQUEST['error'])
						{
							echo $_REQUEST['error'];
		...
		*/
		function Show_payonaccountPreview($return_pay_arr,$alert='',$just_for_display=false)
		{
			...
			{
				echo '<script type="text/javascript">window.location = "'.$ecom_selfhttp.$ecom_hostname.'/payonaccountpayment.html?rt=1"</script>';
				exit;
			}
			...
			switch($row_pay['pay_paymentmethod'])
			{
				...
				case 'NOCHEX':
				?>
				<div class="treemenu"><a href="<? url_link('');?>"><?=stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']);?></a>  >><a href="<? url_link('mypayonaccountpayment.html');?>"> <?=stripslash_normal($Captions_arr['PAYONACC']['PAYONACCOUNT_MAINHEADING'])?></a> >> <?=stripslash_normal($Captions_arr['PAYONACC']['PAYON_BUY_TREEMENU_PREVIEWTITLE'])?></div>
				<?php				
				break;
				default
			?>
	...
	?>		
			...
			?>
				<tr>
				<td colspan="2" class="shoppingcartheader"><?=stripslash_normal($Captions_arr['PAYONACC']['PAYON_VAL_PREVIEW_MESSAGE_TEXT'])?> </td>
				</tr>
			<?php
			}
			?>
			<tr>
				<td width="40%" class="regiconent" id="vouch_caption_td"><?=stripslash_normal($Captions_arr['PAYONACC']['PAY_AMT_LABEL'])?></td>
				<td width="60%" align="left" valign="middle" class="regiconent"><?php echo print_price($row_pay['pay_amount'])?></td>
			</tr>
			<?php
			...
			?>
					<tr>
					<td width="40%" class="regiconent" id="vouch_caption_td" valign="top"><?="Additional Details"?></td>
					<td width="60%" align="left" valign="middle" class="regiconent"><?php echo nl2br($row_pay['pay_additional_details'])?></td>
					</tr>
			<?php
				}
			?>		
			<tr>
				<td align="left" width="40%" class="regiconent" valign="top">
				<?=stripslash_normal($Captions_arr['PAYONACC']['PAYON_PAYMENT_TYPE'])?>
				</td>
				<td align="left" width="60%" class="regiconent">
			...
			?>
					<tr>
						<td align="left" width="40%" class="regiconent" valign="top">
						<?=stripslash_normal($Captions_arr['PAYONACC']['PAYON_PAYMENT_METHOD'])?>
						</td>
						<td align="left" width="60%" class="regiconent">
			...
			?>
					<tr>
						<td colspan="2" align="right" class="emailfriendtextnormal">
							<input type="button" name="submit_backhome" value="<?php echo stripslash_normal($Captions_arr['PAYONACC']['PAYON_PREVIEW_BACH_HOME'])?>" onclick="window.location ='<?php url_link('')?>'" />
						</td>
					</tr>	
			<?php
				}	
