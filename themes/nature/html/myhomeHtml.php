								...
								if($allow_discount==1)
								{
									...
									<tr>
									 ...
									 <tr>
									   ...
									   <div class="mid_shlf_con" >
										...
										<div class="mid_shlf_pdt_name"><a href="<?php url_product($row_products_id['product_id'],$row_products_id['product_name'],-1)?>" title="<?php echo stripslash_normal($row_products_id['product_name'])?>"><?php echo stripslash_normal($row_products_id['product_name'])?></a></div>
									...
									<? 
										...
										?>
											...
											<?php	dislplayCompareButton($row_products_id['product_id']);?>
											</div>
										<?php	
										}
										?>
										...
										<?php
											...
											echo stripslash_normal($row_products_id['product_shortdesc']);
										
											$module_name = 'mod_product_reviews';
											if(in_array($module_name,$inlineSiteComponents))
											{
												if($row_products_id['product_averagerating']>=0)
												{
											?>
												<div class="mid_shlf_pdt_rate">
												<?php
													display_rating($row_products_id['product_averagerating']);
													?>
												</div>
											<?php
												}
										...
										if($row_products_id['product_bulkdiscount_allowed']=='Y')
										{
										?>
											<div class="mid_shlf_pdt_bulk"><img src="<?php url_site_image('bulk-discount.gif')?>" alt="Bulk Discount"/></div>
										<?php
										}
										if($row_products_id['product_saleicon_show']==1)
										{
											$desc = stripslash_normal(trim($row_products_id['product_saleicon_text']));
											if($desc!='')
											{
										?>	
										...
										if($row_products_id['product_newicon_show']==1)
										{
											$desc = stripslash_normal(trim($row_products_id['product_newicon_text']));
											if($desc!='')
											{
										?>
										...
										<input type="hidden" name="fproduct_url" value="<?php url_product($row_products_id['product_id'],$row_products_id['product_name'])?>" />
											...
											<div class="mid_shlf_info_btn"><?php show_moreinfo($row_products_id,'mid_shlf_info_link')?></div>
											...
											<?php
												...
												show_addtocart_v5_ajax($frm_name,$row_products_id,$class_arr);
