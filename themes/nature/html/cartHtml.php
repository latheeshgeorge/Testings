<?php
	...
	class cart_Html
	{
				...
				<?php
					...
					if ($cust_id) // Case logged in 
					{
					  echo stripslash_normal($Captions_arr['CART']['CART_LOGGED_IN_AS']); echo "&nbsp;".$cartData['customer']['customer_title']." ".$cartData['customer']['customer_surname'].'!';?>
						<br />
						<? echo stripslash_normal($Captions_arr['CART']['CART_IF_YOU_NOT_LOG']);?> <a href="<?php echo $ecom_selfhttp.$ecom_hostname?>/logout.html?rets=1" title="Logout" class="cartlogin_link"><? echo stripslash_normal($Captions_arr['CART']['CART_HERE']);?></a><? echo "&nbsp;". stripslash_normal($Captions_arr['CART']['CART_TO_LOGOUT']);?> 
					<?php
					}
		...
		<?php
			  ...
			  ?>
				  <tr>
					...
					<?php	
						...
						{
					?>
							<div class="updatediv" align="center"><input name="cart_qty_<?php echo $products_arr['cart_id']?>" type="text" id="cart_qty_<?php echo $products_arr['cart_id']?>" size="5" maxlength="4" value="<?php echo $products_arr["cart_qty"]?>" style="width:25px;" class="cart_inputA" />
							</div> 
		  ...
		  ?>
				...
				?>	
				   ...
				   ?>
					   <tr>
						 <td align="left" class="shoppingcartcontent"><?php echo stripslash_normal($Captions_arr['CART']['CART_DELIVERY_OPT'])?> </td>
		  ...
		  <?php
			...
			if (is_Feature_exists('mod_bonuspoints') and $ecom_siteid!=97)
			{
		...
		<?php
		if($ecom_siteid == 99)  // case of innhousebrewery website
		{
		?>	
		<tr>
		<td align="center" colspan="6" style='padding: 10px 0'>
			<img src="<?php url_site_image('no-delivery_banner.gif')?>"/>
		</td>
		</tr>	
		<?php
		}
            ...
            <td colspan="6" align="right" valign="middle" class="shoppingcartcontent">
			  ...
			  ?>
				...
				<?php
					...
					{
				?>
				               		 <button  onclick="show_wait_button(this,'Please Wait...');window.location='<?php echo $ps_url?>'" class="inner_btn_red">Continue Shopping</button>
				...
				<?php
					...
					{
				?>
				  				    <button  onclick="show_wait_button(this,'Please Wait...');window.location='<?php url_link('')?>'" class="inner_btn_red">Continue Shopping</button>
			  ...
			  ?>	
             		 ...
             		 <button  onclick="handle_checkout_submit('<?php echo $ecom_hostname?>',0,'<?php echo $cartData["totals"]["bonus_price"]?>')" class="inner_btn_red">Checkout</button>
             		</div> 
			  <?php
			  	}
				else
          ...
          <table class="regifontnormal" width="100%" border="0" cellpadding="0" cellspacing="4">
            <tbody>
              ...
              <tr>
				...
				<div class="lgn_btn">
				<div class="lgn_btn_inner"><img src="<?php url_site_image('loginicn1.gif')?>" /></div>
              ...
              <tr>
                <td colspan="2" align="left" valign="middle" class="lgn_table_td">
                 <!--FB Login Button -->
                <div class="fblogin_btn_sml">
                    <a href="javascript:void(0);" onclick="javascript:window.open('<?php echo $loginUrl;?>','Login','width=500,height=300,resizable=no,scrollbars=no,toolbar=no,menubar=no,location=no,directories=no,status=no,copyhistory=no');" class="fblogin_link"><img src="<?php echo url_site_image('facebook_logins.png');?>" /></a>
                </div>
                    </td>
                </tr>
                <?php } ?>
