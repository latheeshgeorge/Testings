   ...
   $sql_dyn = "SELECT section_id,section_name,section_to_specific_products,message,hide_heading  
	...
	if ($curposnum)
	{
	   $spclass =($spanclass)?$spanclass:'reg_header';
		...
		<table width="100%" align="left" border="0" cellpadding="0" cellspacing="0">
		 ...
		 <tr >
          <td colspan="<?php echo $colspan?>" align="left" valign="middle" >
		  <table width="100%" border="0" cellspacing="<?PHP echo  $cellspacing ?>" cellpadding="0"  align="left" >
	<?php	
		if($texttd_class!='')
	...
	?>
				...
				<?php
					...
					if($row_dyn['hide_heading']==0 and ($cur_pos=='Top' || $cur_pos=='Bottom'))
					{
				?>
						<tr>
						<td colspan="2" align="left" class="<?php echo $head_class?>"><?php echo $specialhead_tag_start.stripslash_normal($row_dyn['section_name']).$specialhead_tag_end?></span></span></td>
						</tr>
				<?php
					}	
					if($row_dyn['message']!='')
