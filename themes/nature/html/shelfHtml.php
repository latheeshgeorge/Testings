								...
								switch($shelfData['shelf_displaytype'])
								{
									...
									?>
									   ...
									   <div class="mid_shlf2_hdr_bottom"></div>
										...
										{
										?>
										<div class="mid_shlf2_desc"><?php echo stripslashes($desc)?></div>
										<?php
										}
										if ($tot_cnt>0 and ($_REQUEST['req']!='') and $tot_cnt>$prodperpage)
										{
							...
							elseif($shelfData['shelf_currentstyle']=='special1') // case of special layout 1
							{
								switch($shelfData['shelf_displaytype'])
								{
									...
									<? 
											...
											{
										?>
												<div class="christmas_proddesB"><?php echo stripslashes($desc)?></div>
										<?php		
											}
										...
										<?php
												...
												?>
													...
													{
													?>
														<div class="mid_shlfA_pdt_name"><a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" title="<?php echo stripslash_normal($row_prod['product_name'])?>"><?php echo stripslash_normal($row_prod['product_name'])?></a></div>
													<?php
													}
													?>
													...
													if ($shelfData['shelf_showimage']==1)// Check whether description is to be displayed
													{
													 ...
													 // $pass_type = 'image_gallerythumbpath';
													 	//$pass_type = 'image_gallerythumbpath';
														//echo get_default_imagetype('midshelf');
													?>
									...
									?>
										...
										{
									?>
											<div class="shelfAproddes"><?php echo stripslashes($desc)?></div>
									<?php		
										}
										if ($tot_cnt>0 and ($_REQUEST['req']!=''))
										{
