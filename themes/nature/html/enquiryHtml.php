<?php
	...
	class enquiry_Html
	{
	  ...
	  {
	    global $ecom_siteid,$db,$ecom_hostname,$Settings_arr,$ecom_themeid,$default_layout,$Captions_arr,$inlineSiteComponents,$loginUrl,$ecom_fb_enable;
		...
		<li><?php echo stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_MAINHEADING'])?></li>
		</ul>
		</div>
		<div class="inner_header"><?php echo stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_MAINHEADING'])?></div>
		...
		<div class="inner_middle_cart">			
				  ...
				  <td colspan="3" align="left" valign="middle" class="cartlogin_msg">
					...
					if ($cust_id) // Case logged in 
					{
					  echo stripslash_normal($Captions_arr['CART']['CART_LOGGED_IN_AS']); echo "&nbsp;".$cartData['customer']['customer_title']." ".$cartData['customer']['customer_fname']." ".$cartData['customer']['customer_mname']." ".$cartData['customer']['customer_surame'];?>
						<br />
						<? echo stripslash_normal($Captions_arr['CART']['CART_IF_YOU_NOT_LOG']);?> <a href="<?php echo $ecom_selfhttp.$ecom_hostname?>/logout.html?rets=2" title="Logout" class="cartlogin_link"><? echo stripslash_normal($Captions_arr['CART']['CART_HERE']);?></a><? echo "&nbsp;". stripslash_normal($Captions_arr['CART']['CART_TO_LOGOUT']);?> 
					<?php
					}
					else // Case not logged in
					{
					?>
						<?php echo stripslash_normal($Captions_arr['CART']['CART_NOT_LOGGED_IN']); ?> <a href="<?php url_link('custlogin.html')?>?redirect_back=1&pagetype=enquire" title="Login" class="cartlogin_link"><? echo stripslash_normal($Captions_arr['CART']['CART_HERE']);?></a><? echo "&nbsp;". stripslash_normal($Captions_arr['CART']['CART_TO_LOGIN']);?> 
					<?php
					}
          ...
          <tr>
            <td align="left" valign="middle" class="shoppingcartheaderleft" ><?php echo stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_ITEM'])?></td>
            <td align="left" valign="middle" class="shoppingcartheaderA" ><?php echo stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_VARIABLE'])?></td>
			<td align="left" valign="middle" class="shoppingcartheaderA" ><?php echo stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_PRICE'])?></td>
            <td align="right" valign="middle" class="shoppingcartheaderA"><?php echo stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_NOTE'])?></td>
		    <td align="right" valign="middle" class="shoppingcartheaderright"><?php echo stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_ACTION'])?></td>
		  </tr>
		  <?php
		if($db->num_rows($ret_select_enq))
		{  
		...
		while($row_select_enq = $db->fetch_array($ret_select_enq))
		{
			...
			?>
			<tr>
			<td align="left" valign="middle" class="<?=$cur_class?>">
			<?php 
				...
				?>
			<a href="<?php echo url_product($row_prod_det['product_id'],$row_prod_det['product_name'])?>" title="<?php echo $row_prod_det['product_name']?>" class="cart_pdt_link"><?php echo $row_prod_det['product_name']?></a></td>
			<td align="left" valign="middle" class="<?=$cur_class?>"  >
			 <?php
			...
			<td align="right" valign="middle" class="<?=$cur_class?>"><img src="<?php url_site_image('enquire_note.gif')?>" onclick="add_Enquire_notes(frm_enquire,'<?=$row_select_enq['enquiry_id']?>')" alt="Add Notes" title="Add Notes" /></td>
			<td align="right" valign="middle" class="<?=$cur_class?>"><img src="<?php url_site_image('delete.gif')?>" onclick="if(confirm_message('Are you sure you want to Delete this Enquiry?')){document.frm_enquire.enq_mod.value='delete_enquiry';document.frm_enquire.enquiry_id.value='<?=$row_select_enq['enquiry_id']?>';document.frm_enquire.submit();}" alt="Delete" title="Delete" /></td>
			</tr>
			<tr id="add_note_tr_<?=$row_select_enq['enquiry_id']?>" style="display:none" >
			<td colspan="5" >
			<table border="0" cellpadding="0" cellspacing="0" width="100%" >
			<tr>
			<td  align="left" valign="middle"   class="<?=$cur_class?>" >Add Notes:<br /><textarea  name="enquirenote_<?=$row_select_enq['enquiry_id']?>" rows="5" cols="38" id="note_text_<?=$row_select_enq['enquiry_id']?>" ><? if($_REQUEST['enquirenote_'.$row_select_enq['enquiry_id']]) echo $_REQUEST['enquirenote_'.$row_select_enq['enquiry_id']];else echo $row_select_enq['enquiry_note'];?></textarea>&nbsp; <input name="buttonenqsaveone_<?=$row_select_enq['enquiry_id']?>" type="submit" class="cart_btn" id="buttonenqsaveone_<?=$row_select_enq['enquiry_id']?>" value="Save Note" /></td>
			</tr>
			</table>
			</td>
			</tr>
...
?>
		   ...
		   <tr>
			  ...
			  ?>
				...
				<?php
					...
					{
				?>
				  <input name="continue_submit" type="button" class="cart_btn" id="continue_submit" value="Continue Shopping" onclick="show_wait_button(this,'Please Wait...');window.location='<?php echo $ps_url?>'" />
				<?php
					}
					else
						echo '&nbsp;';
				...
				<input name="buttonenq1" type="button" class="cart_btn" id="buttonenq1" value="Submit Enquiry" onclick="location.href='<?php url_link('fillenquiry.html')?>'"/>
				</div> 
				  ...
				  <table class="regifontnormal" width="100%" border="0" cellpadding="0" cellspacing="4">
					<tbody>
					  ...
					  <tr>
						...
						<div class="lgn_btn_innerA"><a href="javascript:document.frm_custlogin_enquire.submit()"><img src="<?php echo url_site_image('login-img.gif')?>" border="0" /></a></div>
						</div></td>
					  </tr>
	...
	function enquiry_Fillform($alert,$cust_id,$prod_cart_arr)
	{
		  ...
		  ?>
			...
			<ul>
			<li><a href="<? url_link('');?>"><?=stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']);?></a> &gt;&gt;</li>
			<li><a href="<? url_link('enquiry.html');?>"><?=stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_MAINHEADING']);?></a> &gt;&gt;</li>
			<li><?=stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_DET_MAIN'])?></li>
			</ul>
			</div>
			<div class="inner_header"><?=stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_DET_MAIN'])?></div>
		<?php
		 if($alert)
		 { ?>
		 <div class="inner_con" >
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="regitable">
			...
			<?php /*?><tr>
				<td align="left" class="regifontnormal">&nbsp;<span class="redtext">*</span>&nbsp;<b><?=stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_DET_REQ'])?></b>
			</td>
			</tr><?php */?>
			</table>
			</div>
	...
	<?php		
	   ...
	   ?>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="regitable">
			<?php
				//section for custom registration form 
				$cur_pos 				= 'TopInStatic';
				$section_typ			= 'enquire'; 
			...
			?>
			  <tr>
				<td width="43%" class="regiconent" align="left" valign="top" ><?=stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_DET_TITLE'])?>&nbsp;<span class="redtext">*</span></td>

			   <td width="57%" align="left" valign="top" class="regi_txtfeild" ><select name="cbo_enqtitle" id="cbo_enqtitle"><option value="" >Select</option><option value="Mr." <? if($row_cust['customer_title']=='Mr.') echo "selected"; else echo '';?>>Mr.</option><option value="Ms." <? if($row_cust['customer_title']=='Ms.') echo "selected"; else echo '';?>>Ms.</option><option value="Mrs." <? if($row_cust['customer_title']=='Mrs.') echo "selected"; else echo '';?>>Mrs.</option>
			  ...
			  <tr>
				<td class="regiconent" align="left" valign="top" width="33%"><?=stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_DET_FNAME'])?><span class="redtext">*</span></td>

				<td align="left" valign="top" class="regi_txtfeild"><input name="txt_enqfname" value="<?=$row_cust['customer_fname']?>" type="text" maxlength="<?=$short?>"></td>
			  </tr>
			  <tr>
				<td class="regiconent" align="left" valign="top"><?=stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_DET_MNAME'])?></td>
				<td align="left" valign="top" class="regi_txtfeild"><input name="txt_enqmiddlename" value="<?=$row_cust['customer_mname']?>" type="text" maxlength="<?=$short?>"></td>

			  </tr>
			   <tr>
				<td class="regiconent" align="left" valign="top"><?=stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_DET_LNAME'])?><span class="redtext">*</span></td>
				<td align="left" valign="top" class="regi_txtfeild"><input name="txt_enqlname" value="<?=$row_cust['customer_surname']?>" type="text" maxlength="<?=$short?>"></td>

			  </tr>
			  <tr>
				<td class="regiconent" align="left" valign="top"><?=stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_DET_ADDRESS'])?></td>
				<td align="left" valign="top" class="regi_txtfeild"><textarea name="txt_enqaddress" cols="25" rows="4"><?=$_REQUEST['txt_enqaddress']?></textarea></td>
			  </tr>
			 <tr>

				<td class="regiconent" align="left" valign="top"><?=stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_DET_COUNTRY'])?></td>
			  ...
			  <tr>
				<td class="regiconent" align="left" valign="top"><?=stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_DET_STATE'])?> </td>
				<td align="left" valign="top" class="regi_txtfeild">
					<input type="text" name="cbo_enqstate" id="cbo_enqstate" value = "<?php echo $row_cust['customer_statecounty']?>"  maxlength="<?=$medium?>"/>
				</td>			
			  </tr>
			  <tr>
				<td class="regiconent" align="left" valign="top"><?=stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_DET_PCODE'])?> </td>
				<td align="left" valign="top" class="regi_txtfeild"><input name="txt_enqpostcode" value="<?=$row_cust['customer_postcode']?>" type="text" maxlength="<?=$short?>"></td>
			  </tr>
			  <tr>

				<td class="regiconent" align="left" valign="top"><?=stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_DET_PHONE'])?> <span class="redtext">*</span></td>
				<td align="left" valign="top" class="regi_txtfeild"><input name="txt_enqphone" value="<?=$row_cust['customer_phone']?>" type="text" maxlength="<?=$short?>"></td>
			  </tr>
			  <tr>

				<td class="regiconent" align="left" valign="top"><?=stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_DET_MOBILE'])?></td>
				<td align="left" valign="top" class="regi_txtfeild"><input name="txt_enqmobile" value="<?=$row_cust['customer_mobile']?>" type="text" maxlength="<?=$short?>"></td>
			  </tr>
			  <tr>
				<td class="regiconent" align="left" valign="top"><?=stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_DET_FAX'])?></td>
				<td align="left" valign="top" class="regi_txtfeild"><input name="txt_enqfax" value="<?=$row_cust['customer_fax']?>" type="text" maxlength="<?=$short?>"></td>
			  </tr>
			  <tr>
				<td class="regiconent" align="left" valign="top"><?=stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_DET_EMAIL'])?><span class="redtext">*</span></td>
				<td align="left" valign="top" class="regi_txtfeild"><input name="txt_enqemail" value="<?=$row_cust['customer_email_7503']?>" type="text"  maxlength="<?=$medium?>"></td>
			  </tr>
			   
			   <tr>
				<td class="regiconent" align="left" valign="top"><?=stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_DET_ADDTEXT'])?></td>
				<td align="left" valign="top" class="regi_txtfeild"><textarea name="cbo_enqtext" rows="2" cols="30"><?=$_REQUEST['cbo_enqtext']?></textarea></td>
			  </tr>
			  <tr>
				<td colspan="2">&nbsp;</td>
			  </tr>
			...
			<input name="enquiry_submit" type="submit" class="cart_btn" id="enquiry_submit" value="Save Details" />
			</td>
			</tr>
			</table>	
			</div>
	 ...
	 function Display_Message()
	 {
		...
		function myenquiry_Enquiry($custid)
		{
			...
			$prod_array = array();
				...
				<ul>
				<li><a href="<? url_link('');?>"><?=stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']);?></a> &gt;&gt;</li>
				<li><?php echo stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_MYENQUIRYHEADING'])?></li>
				</ul>
				</div>
				<div class="inner_header"><?php echo stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_MYENQUIRYHEADING'])?></div>
				<div class="inner_con" >
				<div class="inner_top"></div>
				<div class="inner_middle_cart">	
				...
				<td class="usermenucontent">	<input name="clearenq_button" type="button" class="cart_btn" id="clearenq_button" value="<?php echo stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_SEARCH'])?>" onclick="document.my_enquire.submit()" />
				</td>
				</tr>
				</table>
				</td> 
