	...
	class myaddressbook_Html
	{
		function Show_AddressBook(){
				...
				$address_array = array();
					...
					<li><?php echo stripslash_normal($Captions_arr['ADDRESSBOOK']['TREE_MENU_ADDRESSBOOK'])?></li>
					</ul>
					</div>
					<div class="inner_header"><?php echo stripslash_normal($Captions_arr['ADDRESSBOOK']['TREE_MENU_ADDRESSBOOK'])?></div>
					<div class="inner_con" >
					...
					?>
					 <tr>
					   <td colspan="5">
						<table cellpadding="2" cellspacing="3" width="100%" class="userordertablestyleA">
						<tr>
						...
						<td  class="usermenucontent" align="left">	<input name="address_search" type="button" class="cart_btn" id="address_search" value="<?php echo stripslash_normal($Captions_arr['ADDRESSBOOK']['ADDERSSBOOK_SEARCH_BUTTON'])?>" onclick="document.my_addressbook.submit()" />	
						</td>
						<td  class="usermenucontent" align="right">
						<?php
						if($db->num_rows($ret_list_addressbook))
						{
						?>
							<input name="clearaddr_button" type="button" class="cart_btn" id="clearaddr_button" value="<?php echo stripslash_normal($Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_DELETE'])?>" onclick="address_delete_all(document.my_addressbook)" />
						<?php
						}
						?>
						</td>
				 ...
				 ?>
				   <tr>
						<td align="center" valign="middle" class="shoppingcartcontent" colspan="5" >
							<?php echo stripslash_normal($Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_NOTFOUND'])?>
						</td>	
				   </tr>	
				 <?
				...
				?>
				  <tr>
					<td align="center" colspan="5"><input name="address_add" type="button" class="cart_btn" id="address_add" value="<?php echo stripslash_normal($Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_ADD'])?>" onclick="javascript:add_address(document.my_addressbook)" />	</td>
		...
		function Add_AddressBook(){
				...
				$customer_id = get_session_var("ecom_login_customer"); // get customer id
					...
					<ul>
					<li><a href="<? url_link('');?>"><?=stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']);?></a> &gt;&gt;</li>
					<li><a href="<? url_link('myaddressbook.html');?>"><?php echo stripslash_normal($Captions_arr['ADDRESSBOOK']['TREE_MENU_ADDRESSBOOK']);?></a> &gt;&gt;</li>
					<li><?php echo stripslash_normal($Captions_arr['ADDRESSBOOK']['TREE_MENU_ADD_ADDRESSBOOK'])?></li>
					</ul>
					</div>
			<div class="inner_header"><?php echo stripslash_normal($Captions_arr['ADDRESSBOOK']['TREE_MENU_ADD_ADDRESSBOOK'])?></div>
			<div class="inner_con" >
	        <div class="inner_top"></div>
    	    <div class="inner_middle_cart">		
			...
			?>
				<tr>
					<td  colspan="2"  align="right" ><?php echo stripslash_normal($Captions_arr['ADDRESSBOOK']['TITLE']);?></td>
					<td  align="center" >:</td>
					<td  align="left" >
				...
				<tr>
					<td  colspan="2"  align="right" ><?php echo stripslash_normal($Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_FNAME']);?><span class="redtext">*</span> </td>
					<td  align="center" >:</td>
					<td  align="left" ><input type="text" name="txt_fname" value="<?=$_REQUEST['txt_fname'] ?>" maxlength="<?=$short?>"/></td>
				</tr> 
				<tr>
					<td  colspan="2"  align="right" ><?php echo stripslash_normal($Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_MNAME']);?></td>
					<td  align="center" >:</td>
					<td  align="left" ><input type="text" name="txt_mname" value="<?=$_REQUEST['txt_mname'] ?>" maxlength="<?=$short?>"/></td>
				</tr>
				<tr>
					<td  colspan="2"  align="right" ><?php echo stripslash_normal($Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_LNAME']);?><span class="redtext">*</span> </td>
					<td  align="center" >:</td>
					<td  align="left" ><input type="text" name="txt_lname" value="<?=$_REQUEST['txt_lname'] ?>" maxlength="<?=$short?>"/></td>
				</tr>
				<tr>
					<td  colspan="2"  align="right" ><?php echo stripslash_normal($Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_ADDRESS']);?></td>
					<td  align="center" >:</td>
					<td  align="left" ><textarea name="address" cols="25" rows="5"><?=$_REQUEST['address'] ?></textarea></td>
				</tr>
				<tr>
					<td  colspan="2"  align="right" ><?php echo stripslash_normal($Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_EMAIL']);?><span class="redtext">*</span></td>
					<td  align="center" >:</td>
					<td  align="left" ><input type="text" name="email" value="<?=$_REQUEST['email'] ?>" maxlength="<?=$medium?>"/></td>
				</tr>
				<tr>
					<td  colspan="2"  align="right" ><?php echo stripslash_normal($Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_PHONE']);?></td>
					<td  align="center" >:</td>
					<td  align="left" ><input type="text" name="phonenumber" value="<?=$_REQUEST['phonenumber'] ?>" maxlength="<?=$short?>"/></td>
				</tr>
				<tr>
					<td  colspan="2"  align="right" ><?php echo stripslash_normal($Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_MOBILE']);?></td>
					<td  align="center" >:</td>
					<td  align="left" ><input type="text" name="mobnumber" value="<?=$_REQUEST['mobnumber'] ?>" maxlength="<?=$short?>"/></td>
				</tr>
				<tr>
					<td  colspan="2"  align="right" ><?php echo stripslash_normal($Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_FAX']);?></td>
					<td width="5%"  align="center" >:</td>
					<td width="51%"  align="left" ><input type="text" name="faxnumber" value="<?=$_REQUEST['faxnumber'] ?>" maxlength="<?=$short?>"/></td>
				</tr>
				<tr>
					<td align="center" valign="middle" class="shoppingcartcontent" colspan="4" ><input class="cart_btn" type="button" name="Submit" value=" <?php echo stripslash_normal($Captions_arr['ADDRESSBOOK']['ADD_ADDRESS']);?> " onclick="javascript:add_newaddress(document.add_address)" /></td>
				</tr>	
				</table>
			...
			function Edit_AddressBook(){
				...
				$customer_id = get_session_var("ecom_login_customer"); // get customer id
					...
					<li><a href="<? url_link('');?>"><?=stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']);?></a> &gt;&gt;</li>
					<li><a href="<? url_link('myaddressbook.html');?>"><?php echo stripslash_normal($Captions_arr['ADDRESSBOOK']['TREE_MENU_ADDRESSBOOK']);?></a></li>
					<li><?php echo stripslash_normal($Captions_arr['ADDRESSBOOK']['TREE_MENU_EDIT_ADDRESSBOOK'])?></li>
					</ul>
					</div>
					<div class="inner_header"><?php echo stripslash_normal($Captions_arr['ADDRESSBOOK']['TREE_MENU_EDIT_ADDRESSBOOK'])?></div>
					<div class="inner_con" >
					<div class="inner_top"></div>
					<div class="inner_middle_cart">	
				 	 <table width="100%" border="0" cellpadding="0" cellspacing="2" class="shoppingcarttable">
			...
			<option value="M/S." <?=($customer_title=='M/S.')?"selected":''?>>M/S.</option>
				   ...
				   <tr>
				     <td align="center" valign="middle" class="shoppingcartcontent" colspan="4" ><input class="cart_btn" type="button" name="Submit" value=" <?=stripslash_normal($Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_UPDATE'])?> " onclick="javascript:update_newaddress(document.edit_address)" /></td>
			        </tr>	
				</table>
				</div>
				<div class="inner_contnt_bottom"></div>
