<?php
	...
	class category_Html
	{
	  ...
	  ?>
	  <div class="catinner_contnt_hdr"><h1><?php echo $row_cat['category_name']?></h1></div>
	  ...
	  function download_pdf() {
	   ...
	   <? 
		...
		{
	?>
			<a  href="javascript:download_pdf_common('<?=$_SERVER['HTTP_HOST']?>','<?=$_SERVER['REQUEST_URI']?>')" title="<?php echo stripslash_normal($Captions_arr['CAT_DETAILS']['CATDET_DOWNLOADPDF'])?>"><img src="<?php url_site_image('list-pdf.gif')?>" alt="<?php echo stripslash_normal($Captions_arr['CAT_DETAILS']['CATDET_DOWNLOADPDF'])?>" border="0" /></a>
	...
	?> 
					...
					?>
							...
							if($row_cat['category_showname']==1)
							{
						  	?>
								<div class="mid_shlf_pdt_name">
									<a href="<?php url_category($row_subcat['category_id'],$row_subcat['category_name'],-1)?>" title="<?php echo stripslash_normal($row_subcat['category_name'])?>"><?php echo stripslash_normal($row_subcat['category_name'])?></a>
								</div>
							<?php
							}
							?>
							...
							?>
								<div class="mid_shlf_pdt_des">
							  		<?php echo stripslash_normal($row_subcat['category_shortdescription']);?>
								</div>
							<?php
							}
							?>			
		...
		?>
			...
			<div class="lst_nav">
			<ul>
			<li><div><?php echo stripslash_normal($Captions_arr['CAT_DETAILS']['CATDET_SORTBY'])?></div></li>
			<li>
			...
			<li>
			<div>
			<?php echo stripslash_normal($Captions_arr['CAT_DETAILS']['CATDET_ITEMSPERPAGE'])?></div>
			</li>
			<li>
			<?php
			...
			switch($cat_det['product_displaytype'])
			{
				...
				?>
					...
					?>
						...
						$class_arr['ENQUIRE']		= 'mid_shlf_buy_linkB';
