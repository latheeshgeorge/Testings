<?php
	...
	class components
	{
						...
						if(count($grp_array))
						{
							...
							foreach ($grp_array as $k=>$grpData)
							{
								...
								$cnt = $db->num_rows($ret_pg);
									...
									{
					?>		
										<li><?php echo $h2_start;?> <a href="<?php url_link('help.html')?>" class="sta_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HELP'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HELP'])?></span></a><?php echo $h2_stop;?></li>
					<?php
									}
									if ($grpData['group_showfaqlink']==1 )
									{
					?>		
										<li><?php echo $h2_start;?> <a href="<?php url_link('faq.html')?>" class="sta_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_FAQ'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_FAQ'])?></span></a><?php echo $h2_stop;?></li>
					<?php
									}
									if ($grpData['group_showxmlsitemaplink']==1 )
									{
									?>
										<li><?php echo $h2_start;?> <a href="<?php url_link('sitemap.xml')?>" class="sta_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP'])?></span></a><?php echo $h2_stop;?></li>
									<?php	
									}
									...
									{
					?>							
										<li><?php echo $h2_start;?> <a href="<?php url_link('sitemap.html')?>" class="sta_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SITEMAP'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SITEMAP'])?></span></a><?php echo $h2_stop;?></li>
					<?php		
									}
									if ($grpData['group_showsavedsearchlink']==1)
									{
					?>							
										<li><?php echo $h2_start;?> <a href="<?php url_link('saved-search.html')?>" class="sta_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH'])?></span></a><?php echo $h2_stop;?></li>
					<?php		
									}
								...
								?>
										<li><?php echo $h2_start;?> <a href="<?php if ($row_pg['page_type']=='Page') url_static_page($row_pg['page_id'],$row_pg['title']); else echo $row_pg['page_link'];?>" class="sta_menu" title="<?php echo stripslash_normal($row_pg['title'])?>" <?php echo $target?>><span><?php echo stripslash_normal($row_pg['title']);?></span></a><?php echo $h2_stop;?></li>
								<?php
								}
						...
						?>
									<li><?php echo $h2_start;?> <a href="<?php url_link('')?>" class="sta_menu" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?>"><span><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?></span></a><?php echo $h2_stop;?></li>
						<?php
								}
						}		
						?>			
											...
											<div class="toparea_cat_menu">
												...
												<?php
													while ($row_cat = $db->fetch_array($ret_cat))
													{
														...
														?>
														<li><?php echo $h2_start?><a href="<?php url_category($row_cat['category_id'],$row_cat['category_name'],-1)?>" class="cat_menu" title="<?php echo stripslash_normal($row_cat['category_name'])?>"><span><?php echo ucwords(stripslash_normal($row_cat['category_name']));?></span></a><?php echo $h2_stop?></li>
														<?
													}
												?>
												</ul>
										 ...
										 <div class="lf_catgry">
											<div class="lf_catgry_top"></div>
												<div class="lf_catgry_middle">
													...
													{
													?>
														 <li><h2><span class="subcategoryheader"><a href="<?php url_category($row_cat['category_id'],$row_cat['category_name'],-1)?>" class="subcategoryheaderlink" title="<?php echo stripslash_normal($row_cat['category_name'])?>"><?php echo ucwords(stripslash_normal($row_cat['category_name']));?></a></span></h2></li>
													<?
													}
													elseif($row_cat['category_displaytype']=='Heading' && !$row_cat['category_islink'])
													{
													?>
														 <li><h2><span class="subcategoryheader"><?php echo ucwords(stripslash_normal($row_cat['category_name']));?></span></h2></li>
													<?
													}
														...
														if ($row_cat['category_subcatlisttype']=='List' or $row_cat['category_subcatlisttype']=='Both')
														{
															...
															{	
																...
																if ($db->num_rows($ret_child))
																{
																	...
																	{
																?>
																			<li><h2><a href="<?php url_category($row_child['category_id'],$row_child['category_name'],-1)?>" title="<?php echo stripslash_normal($row_child['category_name'])?>" class="subcategoryheaderlink"><?php echo ucwords(stripslash_normal($row_child['category_name']));?></a></h2></li>
																<?php		
																	}
																}
															}
                ...
                <div class="cart_conlf">
                    ...
                    <div class="cart_middlelf">
                     <div class="cart_hdrlf"><?php echo $title?></div>
                      ...
                      <div class="cart_btnlf"><a href="#" class="cart_linklf" onclick="handle_checkout_submit('<?php echo $ecom_hostname?>',0,'<?php echo $pass_tot?>')"  title="<?php echo stripslash_normal($Captions_arr['COMMON']['CHECK_OUT'])?>"><span><?php echo stripslash_normal($Captions_arr['COMMON']['CHECK_OUT'])?></span></a>
                      <a href="#" onclick="gobackto_cart('<?php echo ($protectedUrl)?base64_encode($ecom_hostname):$ecom_hostname?>')" class="cart_linklf" title="<?php echo stripslash_normal($Captions_arr['COMMON']['VIEW_CART'])?>"><span><?php echo stripslash_normal($Captions_arr['COMMON']['VIEW_CART'])?></span></a>
                      <a href="<?php url_link('enquiry.html')?>" class="cart_linklf" title="<?php echo stripslash_normal($Captions_arr['COMMON']['VIEW_ENQUIRY'])?>"><span><?php echo stripslash_normal($Captions_arr['COMMON']['VIEW_ENQUIRY'])?></span></a></div>
                    </div>
                    <div class="cart_bottomlf"></div>
                </div>
            </div>
			<?php
			}
		...
		{
			global $Captions_arr,$ecom_hostname,$inlineSiteComponents,$Settings_arr,$db,$ecom_siteid,$loginUrl,$ecom_fb_enable,$logoutUrl;
			 ...
			 <div class="user_menu_lf_top"></div>
			  <div class="user_menu_lf_middle">
				<ul class="userloginmenu"> 
						...
						<li><h2><a href="<?php url_link('myenquiries.html')?>" class="userloginmenulink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['MY_ENQUIRIES'])?></a></h2></li>
						<li><h2><a href="<?php url_link('wishlist.html')?>" class="userloginmenulink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['MY_WISHLIST'])?></a></h2></li>
					<?php	
					...
					?>	
						<li><h2><a href="<?php url_link('mypricepromise.html')?>" class="userloginmenulink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['MY_PRICE_PROMISE'])?></a></h2></li>
                        <?php /* FB login script */
						if($cust_fbid > 0)
						{
						?>
						<li><h2><a href="<?php echo $logoutUrl;?>" class="userloginmenulink" ><?=stripslash_normal($Captions_arr['LOGIN_MENU']['LOGOUT'])?></a></h2></li>
						<?php
							}
							else
							{
									...
									while ($row_main = $db->fetch_array($ret_main))
									{
										...
										<div class="bestseller_pdt_middle">
											<div class="bestseller_name"><a href="<?php url_product($row_main['product_id'],$row_main['product_name'],-1)?>" title="<?php echo stripslash_normal($row_main['product_name'])?>" class="best_comp_name_link"><?php echo stripslash_normal($row_main['product_name'])?></a>
												...
												{
													if($price_arr['no_price_condition'])
													{
														if($price_arr['no_price_caption'])
														{
															echo $price_arr['no_price_caption'];
														}
													}
												}	
												?>
							...
							elseif($shelfData['shelf_currentstyle']=='special1') // case of christmas layout
							{
								...
								case '2row':
									...
									<div class="spl_shlf_pdt">
										...
										{
											if($price_arr['no_price_condition']==1)
											{
												if($price_arr['no_price_caption'])
												{
													echo $price_arr['no_price_caption'];
...
<a href="http://medicine-seller-register.mhra.gov.uk/search-registry/740" [^] target="_blank">
<img src="https://pclportal.mhra.gov.uk/analytics/logo-preview-medium.png" [^] />
</a>
</div> 
				</div>
				<?php
		...
		function mod_spendvoucher($title)
		{
			...
			?>
		      <div class="gift_use"> 
			  <a href="<?php echo $ecom_selfhttp.$ecom_hostname?>/spend_voucher.html" class="buygiftvoucherheader" title="<?php echo stripslash_normal($Captions_arr['GIFT_VOUCHER']['SPEND_VOUCHER_CLICK_HERE'])?>"><img src="<?php url_site_image('use-gift.gif')?>" /></a></div>
			  <?
			  }
			  ?>
		<?php	
...
// Function to support the image rotate in shop by brand menu
		...
		?>
				...
				<div class="recent_view_top"></div>
					<div class="recent_view_middle">
							<?php
							if($title)
							{
							?>
									<div class="recent_view_hdr"><?php echo $title ?></div>
							<? 
							}o
							?>
							<div class="recent_view_images">
							<?php
		...
		?>
			<tr>
				...
				?>
				<li><h2>
                	<a href="<?php echo $logoutUrl; ?>" class="userloginmenuytoplink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['LOGOUT'])?></a>
                </h2></li>
				<?php
					}
					else
				...
				?>
				<li><h2>
                	<a href="<?php url_link('logout.html')?>" class="userloginmenuytoplink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['LOGOUT'])?></a>
                </h2></li>
                <?php
					}
					if($ecom_siteid!=99)
					{
                ?>
				<li><h2><a href="<?php url_link('mypricepromise.html')?>" class="userloginmenuytoplink"><?=$Captions_arr['LOGIN_MENU']['MY_PRICE_PROMISE']?></a></h2></li>
				<?php
					}
				?>
				...
				<?php
					...
					?>
				<li><h2><a href="<?php url_link('wishlist.html')?>" class="userloginmenuytoplink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['MY_WISHLIST'])?></a></h2></li>
				<li><h2><a href="<?php url_link('myenquiries.html')?>" class="userloginmenuytoplink"><?=stripslash_normal($Captions_arr['LOGIN_MENU']['MY_ENQUIRIES'])?></a></h2></li>
                <?php /* FB login script */
					if($cust_fbid <= 0)
					{
				?>
