						...
						if($Settings_arr['comp_showdesc']==1)
						{
							if($row_prod['product_averagerating'])
							{
								$rate = '';
									...
									{
										$rate .= '<img src="'.url_site_image('star-green.gif',1).'" border="0" alt="review image" />&nbsp;'; 
									}
									for ($x=$row_prod['product_averagerating'];$x<5;$x++)
									{
										$rate .= '<img src="'.url_site_image('star-white.gif',1).'" border="0"  alt="review image"/>&nbsp;'; 
									}
...
?>
				...
				<td align="left" valign="top" width="15%">&nbsp;</td>
					  ...
					  <?php
						...
						{
						?>
							<td align="left" valign="top" class="prod_comparison_name"><a href="<?php url_product($compare_arr['main'][$i]['product_id'],"'".$compare_arr['main'][$i]['product_name']."'",-1)?>" title="<?php echo stripslash_normal($compare_arr['main'][$i]['product_name'])?>" class="prod_comparison_name"><?php echo stripslash_normal($compare_arr['main'][$i]['product_name'])?></a></td>
						<?php
						}
						?>	
					</tr>
				  <tr>
								...
								<?php
									...
									<div class="compare_infodiv">
										...
										<?php
											...
											$class_arr['BTN_CLS']           = 'quantity_infolink';
					  ...
					  ?>
							  <tr>
								<td align="left" valign="top" class="comparison_mainheader"><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_COMPPRICE']);?></td>
								  <?php
									for ($i=0;$i<$num_products;$i++)
									{
					  ...
					  ?>
						  <tr>
							<td align="left" valign="top" class="comparison_mainheader"><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_COMPSTOCK']);?></td>
							 <?php
								for ($i=0;$i<$num_products;$i++)
								{
									$cls = ($i==0)?'comparison_contentA':'comparison_contentB';
					 ...
					 ?> 
						  <tr>
							<td colspan="<?php echo $num_products+1?>" align="left" valign="top" class="comparison_sec_header"><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_COMPKEYFEATURE']);?></td>
						  </tr>
						  <?php 
						...
						?>						  
						  <tr>
							<td colspan="<?php echo $num_products+1?>" align="left" valign="top" class="comparison_sec_header"><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_COMPGENFEATURE']);?></td>
						  </tr>
						  <?php 
						 } 
						  	if($desc==1)
						  ...
						  ?>
							  <tr>
								  <td align="left" valign="top" class="comparison_mainheader"><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_COMPDESC']);?></td>
								  <?php
									for ($i=0;$i<$num_products;$i++)
									{
										$cls = ($i==0)?'comparison_contentA':'comparison_contentB';
					 ...
					 <tr>
					  ...
					  // Check whether the product review module is active for the site
						...
						?>
					  <tr>
						<td align="left" valign="top" class="comparison_mainheader"><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_REVIEW_CAPTION']);?></td>
						 <?php
							for ($i=0;$i<$num_products;$i++)
							{
								$cls = ($i==0)?'comparison_contentA':'comparison_contentB';
