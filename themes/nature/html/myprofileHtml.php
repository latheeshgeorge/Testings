...
function mailinglist_mainsel()
{
	...
	if(atleast_one)
	  ...
	  <div class="inner_header"><?=stripslash_normal($Captions_arr['CUST_REG']['EDITPROFILE_TREEMENU_TITLE'])?></div>
	 <div class="inner_con_clr1" >
		...
		?>	<tr>
			<td width="33%" align="left" valign="middle" class="regiconentA"><?=stripslash_normal($Captions_arr['CUST_REG']['ACCNT_TYPE'])?></td>
			<td width="67%" align="left" valign="middle" class="regi_txtfeild1"><select name="customer_accounttype" class="regiinput" id="customer_account_type" onchange="showAccountTypeDetails(this);" >
        ...
        <div class="inner_middle">
          <table width="100%" align="left" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td colspan="2" class="regiheader"><span class="reg_header"><span><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_COMPANY_DETAILS_HEADER_EDIT'])?> </span></span></td>
					</tr>
					<?php
	  ...
	  <div class="inner_con" >
	   ...
	   <table class="regitable" width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td colspan="2" class="regiheader"><span class="reg_header"><span><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_PERSONAL_DETAILS_HEADER_EDIT'])?></span></span></td>
		</tr>
		<?php
				//section for custom registration form 
	   ...
	   <div class="inner_con" >
        ...
        <div class="inner_middle">
		  ...
		  <tr>
			<td align="left" valign="middle" class="regiconent"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_EMAIL'])?><span class="redtext">*</span></td>
		 ...
		 <tr >
			<td align="left" valign="middle" class="regiconent"  width="33%"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_PASSWORD'])?></td>
			<td align="left" valign="middle" class="regi_txtfeild" width="67%"><input name="customer_pwd" type="password" class="regiinput" id="customer_pwd" size="25" value="" /></td>
		</tr>	
		 <tr >
			<td align="left" valign="middle" class="regiconent"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_CONF_PASSWORD'])?> </td>
	...
	{		
		...
		?>
		 <div class="inner_con_clr1" >
	          ...
	          <table class="regi_tableA" width="100%" border="0" cellpadding="0" cellspacing="0">
	            <tbody>
	                ...
	                <td width="4%" align="left" valign="middle"><img src="<?php url_site_image('re-icn.gif')?>" width="72" height="52" /></td>
						...
						<?=stripslash_normal($Captions_arr['CUST_REG']['REQUEST_PAYONACC'])?></td>
			...
			?>	
					...
					<tbody>
						<tr>
						<td   align="left" valign="middle" colspan="2" class="regiheader"><?=stripslash_normal($Captions_arr['PAYONACC']['MY_PAYONACCDETAILS']);?> 
						</td>
						</tr>
						<tr>
						<td   align="left" valign="middle" width="33%" class="regiconent" ><?=stripslash_normal($Captions_arr['CUST_REG']['REQUEST_PAYONACCSTATUS'])?>					  </td>
						<td  align="left" valign="middle" width="67%" >:&nbsp;&nbsp;&nbsp;&nbsp;<?=$row_customer['customer_payonaccount_status']?>					</td>
						</tr>
						<? if($row_customer['customer_payonaccount_maxlimit']>0)
						{?>
						<tr>
						<td   align="left" valign="middle" width="33%" class="regiconent"><?=stripslash_normal($Captions_arr['CUST_REG']['REQUEST_PAYONACCLIMIT'])?>					  </td>
						<td  align="left" valign="middle" width="67%">:&nbsp;&nbsp;&nbsp;&nbsp;<?=print_price($row_customer['customer_payonaccount_maxlimit'])?>					</td>
						</tr>
						<? }
						...
						?>
						<tr>
						<td   align="left" valign="middle" class="regiconent"><?=stripslash_normal($Captions_arr['CUST_REG']['REQUEST_PAYONCREDITBALANCE'])?>
						  </td>
						...
						{?>
						<tr>
						<td   align="left" valign="middle" class="regiconent" ><?=stripslash_normal($Captions_arr['CUST_REG']['REQUEST_PAYONACCBALANCE'])?>
						  </td>
						...
						{?>
						<tr>
						<td   align="left" valign="middle" class="regiconent"><?=stripslash_normal($Captions_arr['CUST_REG']['CUST_REJECT_REASON'])?>
						  </td>
						...
						{?>
						<tr>
						<td   align="left" valign="middle" class="regiconent"><?=stripslash_normal($Captions_arr['CUST_REG']['REQUEST_PAYONBILLDATE'])?>
						  </td>
						...
						?>
						<tr>
						<td   align="left" valign="middle" class="regiconent"><?=stripslash_normal($Captions_arr['CUST_REG']['REQUEST_PAYONSTATEMENTDATE'])?>
						  </td>
		...
		if($Settings_arr['show_custreg_newanddiscprod_newsletter_checkbox']==1)
		{
		?>
	    <div class="inner_con_clr1" >
        <div class="inner_clr1_top"></div>
	...
	<?
		...
		if($Settings_arr['show_custreg_newslettergroup_checkbox']==1)
		{	
	...
	<td colspan="3">
		<table width="100%" border="0" cellspacing="4" cellpadding="0">
			<tr>
				 <td valign="middle" width="4%" align="left"><img src="<?php url_site_image('re-icn-group.gif')?>" width="61" height="53" /></td>
				<td   align="left" valign="middle" width="3%">
		...
		<tr>
			...
			?>
				<td   align="left" valign="middle" width="3%">
					<input type="checkbox" name="newsletergroup[]" id="newsletergroup[]" value="<?=$customer_grp['custgroup_id']?>" onchange="mailinglist_mainsel()" <? if(in_array($customer_grp['custgroup_id'],$arr_assigned)) echo "checked";?> /></td>
...
<?php	
	...
	function Show_Myconsent(){
			...
			<?php
				...
				if($ecom_siteid==99)
				{
			      $companyname = "Inn House Brewery";
			      $phone = "01413393479";
			      $Email = "info@innhousebrewery.co.uk";
			      $gdpr_orl = "http://www.innhousebrewery.co.uk/pg50557/gdpr.html";
			    }
			    else if($ecom_siteid==53)
			    {
				$companyname = "healthstore";
				$phone = "01625 876115";
				$Email = "sales@healthstore.uk.com";
				$gdpr_orl = "https://www.healthstore.uk.com/pg50548/gdpr.html";
				}
				else if($ecom_siteid==90)
				{
				$companyname = "healthlab";
				$phone = "08451302133";
				$Email = "";
				$gdpr_orl = "http://www.healthlab.co.uk/gdpr-pg50558.html";

				}
				else if($ecom_siteid==97)
				{
				   $companyname = "Watermill Designs";
				    $phone = "44 +(0)1797 252 173";
					$Email = "sales@watermilldesigns.co.uk";
					$gdpr_orl = "http://www.watermilldesigns.co.uk/pg50561/gdpr.html";

				}
				else if($ecom_siteid==98)
				{
					$companyname = "Bob Lane";
					$phone = "01922 410156	";
					$Email = "sales@theturner.co.uk";
					$gdpr_orl = "http://www.theturner.co.uk/gdpr-pg50560.html";
			...
			<option value="M/S." <?=($row_sql['customer_title']=='M/S.')?"selected":''?>>M/S.</option>
				    ...
				    <tr>
					    <td  colspan="4"  align="left" >
							<table width="100%" border="0" cellpadding="0" cellspacing="2" class="shoppingcarttable">
				      <tr>
					    <td  colspan="3"  align="left" >I give my permission for <?php echo $companyname;?> to send me the following.Please tick 'Yes' or 'No' for each option.</td>
...
If you decide to change your preferences, you can do so at any time. Please just call our customer services team on <?php echo $phone;?> during office hours Monday to Friday and let us know what you want us to do. For example, you can call us to update your contact details or you can opt out from communications altogether. Alternatively, you can let us know your wishes by email: <strong><a href="mailto:<?php echo $Email;?>"><?php echo $Email;?></a>.</strong></p>
<p><strong>Terms and Privacy:</strong></br>
<?php echo $companyname;?> will keep your contact details safe. We will not share them with any other person or organisation. We will only contact you by the channels you have chosen (phone, email etc.) and we will only contact you about the subjects you have chosen. You may unsubscribe at any time. For more details, please see our privacy policy and data protection to see how we use and protect your data. <br/>
For more details, please check our <a href="<?php echo $gdpr_orl;?>" target="_blank"><strong>data protection</strong></a> to see how we use and protect your data. 
</p>
</td>
						</tr>
				   <tr>
