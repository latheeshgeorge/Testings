<?php
	/*#################################################################
	# Script Name 	: checkout.php
	# Description 	: This is the special page for the theme.
	# Coded by      : Sny
	# Created on	: 12-Aug-2009
	# Modified by	: Sny
	# Modified On	: 7-Jan-2010
	#################################################################*/
	// Layout Type
	$default_layout 		= 'prod_detail';
...
echo "
    ...
    echo "
        ...
        <td  align=\"left\" valign=\"top\" class=\"mainmiddletd_details\">
            <div class=\"det_mid_con\" >
            <div class=\"det_mid_con_top\"></div>
            <div class=\"det_mid_con_middle\">";
    ...
    echo "
            ...
            <div class=\"det_mid_con_bottom\"></div>
            </div>
	</td>
    </tr>";
