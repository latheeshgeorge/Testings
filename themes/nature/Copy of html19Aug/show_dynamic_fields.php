<?php
	...
	?>
				...
				?>
						<tr>
						<td colspan="2" align="left" class="<?php echo $head_class?>"><?php echo $specialhead_tag_start.stripslashes($row_dyn['section_name']).$specialhead_tag_end?></td>
						</tr>
				<?php
					}		
				?>	
				...
				<td valign="top" align="left"  >
					...
					?>
							<tr>
							  ...
							  <td <?php echo $textcls?> width="<?php echo $cont_rightwidth?>" align="<?php echo stripslashes($row_elem['element_align'])?>" valign="<?php echo stripslashes($row_elem['element_valign'])?>"     >
							<?php
