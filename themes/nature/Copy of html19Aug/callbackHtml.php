...
/*############################################################################
	...
	class callback_Html
	{
		...
		?>
			...
			<div class="treemenu"><a href="<? url_link('');?>"><?=stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']);?></a> >> <?=stripslash_normal($Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_TREEMENU_TITLE'])?></div>
		...
		if($Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_HEADER_TEXT']){
		 ?>
  <tr>
    <td colspan="2" class="emailfriendtextheader"><?=stripslash_normal($Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_HEADER_TEXT'])?>     </td>
    </tr>
	<? }
			if($Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_MESSAGE_TEXT']){
?>
  <tr>
    <td colspan="2" class="emailfriendtextnormal"><?=stripslash_normal($Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_MESSAGE_TEXT'])?> </td>
    </tr>
	<? }?>
  <tr>
    <td width="38%" class="emailfriendtext"><?=stripslash_normal($Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_FIRSTNAME'])?><span class="redtext">*</span></td>
  ...
  <tr>
    <td width="38%" class="emailfriendtext"><?=stripslash_normal($Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_LASTNAME'])?><br /></td>
  ...
  <tr>
    <td class="emailfriendtext"><?=stripslash_normal($Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_EMAIL'])?><span class="redtext">*</span> </td>
  ...
  <tr>
    <td class="emailfriendtext"><?=stripslash_normal($Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_COUNTRY'])?> </td>
...
<!--      <input name="callback_country" type="text" class="addreivewinput" id="callback_country" size="18" value="<?=$_REQUEST['callback_country']?>"/>
 -->    </label></td>
  ...
  <tr>
    <td class="emailfriendtext"><?=stripslash_normal($Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_PHONE'])?> <span class="redtext">*</span></td>
  ...
  <tr>
    <td class="emailfriendtext"><?=stripslash_normal($Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_COMMENTS'])?></td>
  ...
  <tr>
    <td class="emailfriendtext"><?=stripslash_normal($Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_VERIFICATION_CODE'])?><span class="redtext">*</span></td>
  ...
  <tr>
    <td colspan="2" align="center" class="emailfriendtext"><input type="hidden" name="action_purpose" id="action_purpose" value="send_callback">      <input name="callback_Submit" type="submit" class="buttongray" id="callback_Submit" value="<?=stripslash_normal($Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_SEND_BUTTON'])?>" /></td>
    </tr>
</table>
			</form>
...
function validate_callback(frm)
{
	...
	else
	{
	  ...
	  if($Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_BACK_TO_HOME']){?>
			 <tr>
          <td  colspan="2" align="left" valign="top"  class="link" ><a href="<?php url_link('')?>" title="" class="link"><?=stripslash_normal($Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_BACK_TO_HOME'])?></a></td>
        </tr>
		<? }?>
        </table>
		<?php	
