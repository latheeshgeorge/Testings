...
/*############################################################################
	...
	?>
		...
		<div class="treemenu"><a href="<? url_link('');?>"><?=stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']);?></a> >> <?php echo stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_TREEMENU_TITLE'])?></div>
		...
		<tr>
			<td width="100%" class="gift_buy_header"><?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_TREEMENU_TITLE'])?></td>
		</tr>
		<?php 
		if($alert)
		{ 
		...
		?>
			<tr>
				<td class="gift-hed-bg_td"><div class="gift-hed-bg"><?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_HEADER_TEXT'])?></div></td>
			</tr>
		<? 
		}
		?>
		...
		<tr class="gift_mid_table">
			<td align="left" valign="top" class="gift-send-inner_hed" id="vouch_caption_td"><?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_VOUCHER_VALUE_LABEL'])?>&nbsp;<span class="redtext">*</span></td>
			<td class="gift-send-inner_hed" valign="top" align="left">&nbsp;<?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_VOUCHER_NOOFDAYS_LABEL'])?>&nbsp;<span class="redtext">*</span></td>
		</tr>
		<tr class="gift_mid_table">
		...
		?>
		<tr>
		<td colspan="2" class="gift-send-inner_hed"><strong><?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_EMAIL_VOUCHER_MESSAGE_TEXT'])?></strong> </td>
		</tr>
		<?php
		}
		?>
		<tr>
		<td align="left" valign="top" class="gift-send-inner_hed"><?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_EMAIL_VOUCHER_TO_NAME_LABEL'])?>&nbsp;<span class="redtext">*</span></td>
		...
		<tr>
		<td colspan="2" align="left" valign="top" class="gift-send-inner_hed"><?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_EMAIL_VOUCHER_TO_MESSAGE_LABEL'])?>&nbsp;<span class="redtext">*</span></td>
		</tr>
		<tr>
		...
		?>
		 	<tr>
				<td class="gift-hed-bg_td"><div class="gift-hed-bg"><?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_VOUCHER_BUYERS_MESSAGE_TEXT'])?></div></td>
			</tr>
		<? 
		}
		?>
		...
		<tr class="gift_mid_table">
		<td class="gift-send-inner_cnt" align="left"><?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_VOUCHER_VERIFICATION_CODE'])?>&nbsp;<span class="redtext">*</span></td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
		<td colspan="<?php echo $pay_maxcnt?>" class="gift-hed-bg_td"><div class="gift-hed-bg"><?php echo stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_SEL_PAYTYPE'])?></div></td>
		</tr>
		<tr class="gift_mid_table">
		<?php
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
		<td colspan="<?php echo $pay_maxcnt?>" class="gift-hed-bg_td"><div class="gift-hed-bg"><?php echo stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_SEL_PAYGATEWAY'])?></div></td>
		</tr>
		<tr>
		<?php
		...
		<table width="100%" cellpadding="0" cellspacing="0" border="0">
		<tr>
		<td class="gift-hed-bg_td" colspan="2"><div class="gift-hed-bg"><?php echo stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_CHEQUE_DETAILS'])?></div>     </td>
		</tr>
		<?php
		...
		<table width="100%" cellpadding="0" cellspacing="0" border="0">
		<tr>
		<td class="gift-hed-bg_td" colspan="2"><div class="gift-hed-bg"><?php echo stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_CREDIT_CARD_DETAILS'])?></div>     </td>
		</tr>
		<?php
		...
		<tr>
		<td colspan="2" align="center" class="gift_mid_table_td"><input name="buygiftvoucher_Submit" type="button" class="gift_buy_btn" id="buygiftvoucher_Submit" value="<?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_VOUCHER_BUY_BUTTON'])?>" onclick="validate_buygiftvoucher(document.frm_buygiftvoucher)" /></td>
		</tr>
		</table>		</div>
		</div>
...
?>		
		<div class="treemenu"><a href="<? url_link('');?>"><?=stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']);?></a> >> <?php echo stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_TREEMENU_PREVIEWTITLE'])?></div>
		<div class="gift_mid_con">
        <div class="gift_mid_top"></div>
        <div class="gift_mid_middle" >
     	<div class="gift_mid_des">
		<table width="100%" border="0" cellpadding="0" cellspacing="3"  class="gift_mid_table">
		<tr>
			<td width="100%" class="gift_buy_header" colspan="2"><?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_TREEMENU_PREVIEWTITLE'])?></td>
		</tr>
		<?php 
			if($alert)
			{ 
		...
		?>
			<tr>
				<td class="gift-hed-bg_td" colspan="2"><div class="gift-hed-bg"><?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_VOUCHER_VALUE_PREVIEW_MESSAGE_TEXT'])?></div>     </td>
			</tr>
		<?php
		}
		...
		?>
		<tr class="gift_mid_table">
		<td class="gift-send-inner_cnt" id="vouch_caption_td" width="45%"><?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_VOUCHER_PERCENT_LABEL'])?></td>
		...
		?>		
			<tr class="gift_mid_table">
				<td class="gift-send-inner_cnt"><?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_VOUCHER_NOOFDAYS_LABEL'])?></td>
				<td align="left" valign="middle" class="gift-send-inner_cnt">: <?php echo $row_vouch['voucher_activedays']?></td>
			</tr>
			<tr class="gift_mid_table">
			<td colspan="2" align="center" valign="middle" class="redtext"><?php echo stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_VOUCHER_NOOFDAYS_STARTDATE_NOTE'])?></td>
			</tr>
		<?php
			}
		...
		<td colspan="2">
			...
			?>
				<tr>
				<td colspan="2" class="shoppingcartheader"><?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_EMAIL_VOUCHER_MESSAGE_TEXT'])?> </td>
				</tr>
			<?php
			}
			?>
			<tr class="gift_mid_table">
				<td class="gift-send-inner_cnt" width="45%"><?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_EMAIL_VOUCHER_TO_NAME_LABEL'])?></td>
				<td align="left" valign="middle" class="gift-send-inner_cnt">: <?php echo stripslashes($row_vouch_cust['voucher_toname'])?></td>
			</tr>
			<tr class="gift_mid_table">
				<td class="gift-send-inner_cnt"><?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_EMAIL_VOUCHER_TO_EMAIL_LABEL'])?></td>
				<td align="left" valign="middle" class="gift-send-inner_cnt">: <?php echo stripslashes($row_vouch_cust['voucher_toemail'])?></td>
			</tr>
			<tr class="gift_mid_table">
				<td class="gift-send-inner_cnt" valign="top"><?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_EMAIL_VOUCHER_TO_MESSAGE_LABEL'])?></td>
		...
		?>
			<tr>
				<td class="gift-hed-bg_td" colspan="2"><div class="gift-hed-bg"><?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_VOUCHER_BUYERS_PREVIEW_MESSAGE_TEXT'])?> </div>     </td>
			</tr>
		<?
		}?>
		<?php
	...
	<?php
		...
		?>
				<tr class="gift_mid_table">
					<td colspan="2" align="right" class="gift-send-inner_cnt">
						<input type="button" name="submit_backhome" value="<?php echo stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_PREVIEW_BACH_HOME'])?>" onclick="window.location ='<?php url_link('')?>'" />
					</td>
				</tr>	
		<?php
			}	
...
<?php		
	...
	?>
		...
		<tr>
			<td align="left" valign="middle"><div class="treemenu"><a href="<? url_link('');?>"><?=stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']);?></a> >> <?php echo stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_FAILED_TITLE'])?></div></td>
		</tr>
		<?php
			if($msg)
			{
	...
	{
		global $db,$ecom_hostname,$Captions_arr,$ecom_siteid,$spend_alert,$Settings_arr,$vImage;
		$sess_id 	= session_id();
		$cust_id	= get_session_var("ecom_login_customer"); // Get the customer id from session
		$Captions_arr['GIFT_VOUCHER'] 	= getCaptions('GIFT_VOUCHER'); // Getting the captions to be used in this page
	...
	?>
		...
		<div class="treemenu"><a href="<? url_link('');?>"><?=stripslash_normal($Captions_arr['COMMON']['TREE_MENU_HOME_LINK']);?></a> >> <?php echo stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_SPEND_HEADER'])?></div>
		<div class="gift_mid_con">
        <div class="gift_mid_top"></div>
        <div class="gift_mid_middle" >
    	 <div class="gift_mid_des">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="gift_mid_table">
			 <tr>
				<td width="100%" class="gift_spend_header"><?php echo stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_SPEND_HEADER'])?></td>
			 </tr>
			<?php
			if($spend_alert)
			{
	...
	?>			
				...
				<tr class="gift_mid_table">
				  <td align="left" valign="middle" class="gift_user_fontA" id="vouch_caption_td"><?php echo stripslash_normal($Captions_arr['GIFT_VOUCHER']['ENTER_VOUCHER'])?><span class="redtext">*</span> </td>
				...
				<?php 
					...
					{
					?>
					<input name="compvoucher_Submit" type="submit" class="gift_user_btn" id="compvoucher_Submit" value="<?php echo stripslash_normal($Captions_arr['GIFT_VOUCHER']['VOUCHER_GO'])?>" />
					<?php
					}
					?>
				  </td>
				...
				?>
				  ...
				  <tr>
					<td align="left" class="gift_user_fontA"><?=stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_VOUCHER_VERIFICATION_CODE'])?>&nbsp;<span class="redtext">*</span></td>
		...
		?>	
			<tr>
				...
				<form method="post" action="" id="frm_giftcode_cancel" name="frm_giftcode_cancel">
					...
					<input type="button" name="cancel_spend_gift_button" id="cancel_spend_gift_button" value="<?php echo $cancel_caption?>" class="buttongray" onclick="if(confirm('<?php echo stripslash_javascript($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_CANCEL_CONF'])?>')) { document.frm_giftcode_cancel.submit()}"/>
				</form>
				</td>
			</tr>
			<tr>
			...
			?>
				...
				<tr>
					<td width="50%" align="left" class="gift_user_fontA"><?php echo stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_NUMBER'])?></td>
					<td align="left" class="gift_user_fontB">: <?php echo stripslashes($row_gift['voucher_number'])?></td>
				</tr>
				<tr>
					<td align="left" class="gift_user_fontA"><?php echo stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_VALID_TILL'])?></td>
				...
				<tr>
					<td align="left" class="gift_user_fontA"><?php echo stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_NUMBER_TIMES'])?></td>
			...
			?>
				<table width="100%" border="0" cellspacing="1" cellpadding="1">
				<tr>
					<td width="40%" align="left" class="gift_user_fontA"><?php echo stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_PROM_CODE'])?></td>
				...
				<tr>
					<td align="left" class="gift_user_fontA"><?php echo stripslash_normal($Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_CODE_MAX_TIMES'])?></td>
					<td align="left" class="gift_user_fontB">: 
					<?php 
