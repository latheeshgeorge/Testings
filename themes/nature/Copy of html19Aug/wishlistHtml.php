		...
		<form method="post" name="frm_wishlist" class="frm_cls" action="<?php url_link('wishlist.html')?>">
			...
			<div class="treemenu">
			  <ul>
				...
				<li><?php echo $Captions_arr['WISHLIST']['WISHLIST_MAINHEADING']?></li>
			  </ul>
			</div>
			...
			if($db->num_rows($ret_select_wish))
              ...
              <? 
					if($Settings_arr['empty_wishlist']==1)
					{
						...
						{
					?>
							<input name="clearenq_button" type="button" class="cart_btn" id="clearenq_button" value="<?php echo $Captions_arr['WISHLIST']['WISHLIST_CLEAR']?>" onclick="if(confirm_message('<? echo $Captions_arr['WISHLIST']['WISHLIST_CLEARALLMSG']?>')){document.frm_wishlist.wish_mod.value='clear_wishlist';document.frm_wishlist.submit();}" />
					<?php
						}
				    }
				 ?>	</td>
			   ...
			   <tr>
					<td align="left" valign="middle" class="shoppingcartheaderA" ><?php echo $Captions_arr['WISHLIST']['WISHLIST_ITEM']?></td>
					<td align="center" valign="middle" class="shoppingcartheaderA"><?php echo $Captions_arr['WISHLIST']['WISHLIST_PRICE']?></td>
					<td align="center" valign="middle" class="shoppingcartheaderA"><?php echo $Captions_arr['WISHLIST']['WISHLIST_ACTION']?></td>
		 	  </tr>
		  <?php
				if($db->num_rows($ret_select_wish))
				{  
				...
				?>
				  <tr>
					...
					<td align="center" valign="middle" class="<?=$cur_class?>"  width="50%">
					<?php
				...
				<?php
					  ...
					  ?>
						<tr>
							<td align="left" valign="middle" colspan="3" class="<?php echo $cur_class?>">
							<?
			  ...
			  if($_REQUEST['fproduct_id']){?>
				...
				if($custom_id) // ** Show the wishlist button only if logged in 
					{
			  ?>
						<input name="submit_wishlist" type="button" class="cart_btn" id="submit_wishlist" value="<?php echo $Captions_arr['WISHLIST']['WISHLIST_BUYNOW'];?>"  onclick="return select_products();"  />
			  <?php
					}
					?>
					</td>
