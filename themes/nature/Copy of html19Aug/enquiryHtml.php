		...
		<div class="inner_middle_cart">			
		  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="shoppingcarttable">
			...
			<tr>
			  ...
			  <td width="9%" align="left" valign="middle" class="">
				<?php
          ...
          <tr>
            <td align="left" valign="middle" class="shoppingcartheaderA" ><?php echo stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_ITEM'])?></td>
		    ...
		    <td align="right" valign="middle" class="shoppingcartheaderA"><?php echo stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_ACTION'])?></td>
		  </tr>
		  <?php
		if($db->num_rows($ret_select_enq))
		{  
			...
			while($row_select_enq = $db->fetch_array($ret_select_enq))
			{
			 ...
			 $prod_sql_det = "SELECT product_id,product_name,product_default_category_id,product_webprice,
			  ...
			  ?>
				  <tr>
					<td align="left" valign="middle" class="<?=$cur_class?>" width="28%" >
					<?php 
					...
					<td align="left" valign="middle" class="<?=$cur_class?>"  width="35%">
					<?php 
	   ...
	   ?>
			...
			?>
			  <tr>
			   ...
			   <td width="57%" align="left" valign="top" class="regi_txtfeild" ><select name="cbo_enqtitle" id="cbo_enqtitle"><option value="" >Select</option><option value="Mr." <? if($row_cust['customer_title']=='Mr.') echo "selected"; else echo '';?>>Mr.</option><option value="Ms." <? if($row_cust['customer_title']=='Ms.') echo "selected"; else echo '';?>>Ms.</option><option value="Mrs." <? if($row_cust['customer_title']=='Mrs.') echo "selected"; else echo '';?>>Mrs.</option><option value="M/s." <? if($row_cust['customer_title']=='M/s.') echo "selected"; else echo '';?>>M/s.</option></select></td>
			  </tr>
			  <tr>
