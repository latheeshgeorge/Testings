						...
						if($Settings_arr['comp_showdesc']==1)
						{
							if($row_prod['product_averagerating'])
							{
								$rate = '';
									...
									for ($x=$row_prod['product_averagerating'];$x<10;$x++)
									{
...
?>
				...
				<td align="left" valign="top" width="15%">&nbsp;</td>
				  ...
				  <tr>
					 ...
					 ?> 
						  <tr>
							<td colspan="4" align="left" valign="top" class="comparison_sec_header"><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_COMPKEYFEATURE']);?></td>
						  </tr>
						  <?php 
						...
						?>						  
						  <tr>
							<td colspan="4" align="left" valign="top" class="comparison_sec_header"><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_COMPGENFEATURE']);?></td>
						  </tr>
						  <?php 
						 } 
						  	if($desc==1)
