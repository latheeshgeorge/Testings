<?php
	...
	class category_Html
	{
	  ...
	  ?>
	   ...
	   <? 
		...
		{
	?>
			<a  href="<?=url_Cat_PDF($_REQUEST['category_id'],$row_cat['category_name'])?>" title="<?php echo stripslash_normal($Captions_arr['CAT_DETAILS']['CATDET_DOWNLOADPDF'])?>"><img src="<?php url_site_image('list-pdf.gif')?>" alt="<?php echo stripslash_normal($Captions_arr['CAT_DETAILS']['CATDET_DOWNLOADPDF'])?>" border="0" /></a>
	<?php	 
		}
	...
	?> 
		...
		?>
				...
				switch ($row_cat['category_subcatlistmethod'])
				{
					...
					?>
							...
							<input type='hidden' name='category_id' value="<?=$_REQUEST['category_id']?>"/>
							 <?php
							  ...
							  ?>
								 ...
								 <a href="<?php url_category($row_subcat['category_id'],$row_subcat['category_name'],-1)?>" class="subcategoreynamelink" title="<?php echo stripslashes($row_subcat['category_name'])?>">
								 <?php
							...
							{
						  ?>
								<div class="subcategoreynamelink"><a href="<?php url_category($row_subcat['category_id'],$row_subcat['category_name'],-1)?>" title="<?php echo stripslashes($row_subcat['category_name'])?>"><?php echo stripslashes($row_subcat['category_name'])?></a></div>
						<?php
							}
						?>
							</form>	
		...
		?>
			...
			<div class="lst_nav">
			<ul>
			<li><?php echo stripslash_normal($Captions_arr['CAT_DETAILS']['CATDET_SORTBY'])?></li>
			<li>
			...
			<li>
			<?php echo stripslash_normal($Captions_arr['CAT_DETAILS']['CATDET_ITEMSPERPAGE'])?>
			</li>
			<li>
			<?php
			...
			<input type="button" name="submit_Page" value="<?php echo stripslash_normal($Captions_arr['CAT_DETAILS']['CATDET_GO'])?>" class="buttonred" onclick="handle_categorydetailsdropdownval_sel('<?php echo url_category($_REQUEST['category_id'],$catname,4,$_REQUEST['catgroup_id'],0)?>','catdet_sortbytop','catdet_sortordertop','catdet_prodperpagetop')" />
			</li>
			</ul>
			</div>
