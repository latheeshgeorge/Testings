...
/*############################################################################
	...
	class featured_Html
	{
		...
		?>
			...
			{
			?>
			<div class="fetrdpdt_name"><a href="<?php url_product($row_featured['product_id'],$row_featured['product_name'],-1)?>" title="<?php echo stripslashes($row_featured['product_name'])?>"><?php echo stripslashes($row_featured['product_name'])?></a></div>
			<?php
			}
			?>
			<?php 
			...
			{
			?>
			<div class="fetrdpdt_hdr"><?php echo stripslashes($title)?></div>    
			<?php
			}
			?>
			</div>
