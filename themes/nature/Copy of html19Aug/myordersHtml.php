<?php
	...
	if ($from_date or $to_date)
	{
		...
		?>
			...
			<li><a href="<? url_link('myaddressbook.html');?>"><?php echo $Captions_arr['ADDRESSBOOK']['TREE_MENU_ADDRESSBOOK'];?></a> &gt;&gt;</li>
			<li><?php echo $Captions_arr['ORDER']['ORDER_MAINHEADING']?></li>
			</ul>
			</div>
			<div class="inner_header"><?php echo $Captions_arr['ORDER']['ORDER_MAINHEADING']?></div>
			<div class="inner_con" >
			...
			?>
			<tr>
			<td align="center" valign="middle" class="pagingcontainertd_normal" colspan="12" >
			<?php 
				$path = '';
				$query_string .= "";
				paging_footer($path,$query_string,$tot_cnt,$start_var['pg'],$start_var['pages'],'',$pg_variable,'Orders',$pageclass_arr); 	
	...
	<ul>
	<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> &gt;&gt;</li>
	<li><a href="<?php url_link('myorders.html')?>"><?php echo $Captions_arr['ORDER']['ORDER_MAINHEADING']; ?></a> &gt;&gt;</li>
	<li> <?php echo $Captions_arr['ORDER']['ORDER_DETAILS']?></li>
	</ul>
	</div>
	<div class="inner_header"> <?php echo $Captions_arr['ORDER']['ORDER_DETAILS']?></div>
	<div class="inner_con" >
	<div class="inner_top"></div>
	<div class="inner_middle_cart">
...
<ul>
<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> &gt;&gt;</li>
<li><a href="index.php?req=orders"><?php echo $Captions_arr['ORDER']['ORDER_MAINHEADING']; ?></a>&gt;&gt;</li>
<li><a href="index.php?req=orders&reqtype=order_det&order_id=<?php echo $_REQUEST['order_id']?>"><?php echo $Captions_arr['ORDER']['ORDER_DETAILS']; ?></a>&gt;&gt;</li>
<li><?php echo $Captions_arr['ORDER']['ORDER_ENQ_POSTS']; ?></li>
</ul>
</div>
<div class="inner_header"><?php echo $Captions_arr['ORDER']['ORDER_ENQ_POSTS']; ?></div>
<div class="inner_con" >
<div class="inner_top"></div>
<div class="inner_middle_cart">	
