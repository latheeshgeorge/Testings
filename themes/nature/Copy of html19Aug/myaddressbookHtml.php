	...
	class myaddressbook_Html
	{
		function Show_AddressBook(){
				...
				$address_array = array();
					...
					<li><?php echo $Captions_arr['ADDRESSBOOK']['TREE_MENU_ADDRESSBOOK']?></li>
					</ul>
					</div>
					<div class="inner_header"><?php echo $Captions_arr['ADDRESSBOOK']['TREE_MENU_ADDRESSBOOK']?></div>
					<div class="inner_con" >
					...
					?>
					 <tr>
					   <td colspan="5">
						...
						<td  class="usermenucontent" align="left">	<input name="address_search" type="button" class="cart_btn" id="address_search" value="<?php echo $Captions_arr['ADDRESSBOOK']['ADDERSSBOOK_SEARCH_BUTTON']?>" onclick="document.my_addressbook.submit()" />	
						</td>
						...
						{
						?>
							<input name="clearaddr_button" type="button" class="cart_btn" id="clearaddr_button" value="<?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_DELETE']?>" onclick="address_delete_all(document.my_addressbook)" />
						<?php
						}
						?>
						</td>
				...
				?>
				  <tr>
					<td align="center" colspan="5"><input name="address_add" type="button" class="cart_btn" id="address_add" value="<?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_ADD']?>" onclick="javascript:add_address(document.my_addressbook)" />	</td>
		...
		function Add_AddressBook(){
				...
				$customer_id = get_session_var("ecom_login_customer"); // get customer id
					...
					<li><?php echo $Captions_arr['ADDRESSBOOK']['TREE_MENU_ADD_ADDRESSBOOK']?></li>
					</ul>
					</div>
			<div class="inner_header"><?php echo $Captions_arr['ADDRESSBOOK']['TREE_MENU_ADD_ADDRESSBOOK']?></div>
			<div class="inner_con" >
	        <div class="inner_top"></div>
    	    <div class="inner_middle_cart">		
			...
			?>
				...
				<tr>
					<td align="center" valign="middle" class="shoppingcartcontent" colspan="4" ><input class="cart_btn" type="button" name="Submit" value=" <?php echo $Captions_arr['ADDRESSBOOK']['ADD_ADDRESS'];?> " onclick="javascript:add_newaddress(document.add_address)" /></td>
				</tr>	
				</table>
			...
			function Edit_AddressBook(){
				...
				$customer_id = get_session_var("ecom_login_customer"); // get customer id
					...
					<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> &gt;&gt;</li>
					<li><a href="<? url_link('myaddressbook.html');?>"><?php echo $Captions_arr['ADDRESSBOOK']['TREE_MENU_ADDRESSBOOK'];?></a></li>
					<li><?php echo $Captions_arr['ADDRESSBOOK']['TREE_MENU_EDIT_ADDRESSBOOK']?></li>
					</ul>
					</div>
					<div class="inner_header"><?php echo $Captions_arr['ADDRESSBOOK']['TREE_MENU_EDIT_ADDRESSBOOK']?></div>
					<div class="inner_con" >
					<div class="inner_top"></div>
					<div class="inner_middle_cart">	
				 	 <table width="100%" border="0" cellpadding="0" cellspacing="2" class="shoppingcarttable">
			...
			<option value="M/S." <?=($customer_title=='M/S.')?"selected":''?>>M/S.</option>
				   ...
				   <tr>
				     <td align="center" valign="middle" class="shoppingcartcontent" colspan="4" ><input class="cart_btn" type="button" name="Submit" value=" <?=$Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_UPDATE']?> " onclick="javascript:update_newaddress(document.edit_address)" /></td>
			        </tr>	
				</table>
				</div>
				<div class="inner_contnt_bottom"></div>
