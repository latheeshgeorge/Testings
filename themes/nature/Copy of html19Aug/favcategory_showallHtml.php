<?php
	...
	class categoryshowall_Html
	{
		...
		function Show_favcatproducts($catid,$catname)
		{
			...
			?>
			<div class="mid_shlf_hdr_middle"><h1><a href="<?php url_category($catid,$catname,-1,$_REQUEST['catgroup_id'],0)?>" class="categoreyname_headerlink" title="<?php echo stripslashes($catname)?>"><?php echo stripslashes($catname)?></a></h1></div>
			<?php
			...
			{ 
				...
				<div class="mid_shlf_con" >
					...
					?>
						...
						<div class="mid_shlf_pdt_name"><a href="<?php url_product($product_array['product_id'],$product_array['product_name'],-1)?>" title="<?php echo stripslashes($product_array['product_name'])?>"><?php echo stripslashes($product_array['product_name'])?></a></div>
						...
						<?php
							echo stripslashes($product_array['product_shortdesc']);
							
						$module_name = 'mod_product_reviews';
						if(in_array($module_name,$inlineSiteComponents))
						{
							if($product_array['product_averaterating']>=0)
							{
							?>
							<div class="mid_shlf_pdt_rate">
							<?php
							for ($i=0;$i<$product_array['product_averagerating'];$i++)
							{
