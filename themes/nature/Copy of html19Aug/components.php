<?php
	...
	class components
	{
						...
						if(count($grp_array))
						{
							...
							foreach ($grp_array as $k=>$grpData)
							{
								...
								$cnt = $db->num_rows($ret_pg);
									...
									{
					?>		
										<li><h2> <a href="<?php url_link('help.html')?>" class="sta_menu" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_HELP']?>"><span><?php echo $Captions_arr['STATIC_PAGES']['STAT_HELP']?></span></a></h2></li>
					<?php
									}
									if ($grpData['group_showfaqlink']==1 )
									{
					?>		
										<li><h2> <a href="<?php url_link('faq.html')?>" class="sta_menu" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_FAQ']?>"><span><?php echo $Captions_arr['STATIC_PAGES']['STAT_FAQ']?></span></a></h2></li>
					<?php
									}
									if ($grpData['group_showxmlsitemaplink']==1 )
									{
									?>
										<li><h2> <a href="<?php url_link('sitemap.xml')?>" class="sta_menu" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP']?>"><span><?php echo $Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP']?></span></a></h2></li>
									<?php	
									}
									...
									{
					?>							
										<li><h2> <a href="<?php url_link('sitemap.html')?>" class="sta_menu" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_SITEMAP']?>"><span><?php echo $Captions_arr['STATIC_PAGES']['STAT_SITEMAP']?></span></a></h2></li>
					<?php		
									}
									if ($grpData['group_showsavedsearchlink']==1)
									{
					?>							
										<li><h2> <a href="<?php url_link('saved-search.html')?>" class="sta_menu" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH']?>"><span><?php echo $Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH']?></span></a></h2></li>
					<?php		
									}
								...
								?>
										<li><h2> <a href="<?php if ($row_pg['page_type']=='Page') url_static_page($row_pg['page_id'],$row_pg['title']); else echo $row_pg['page_link'];?>" class="sta_menu" title="<?php echo stripslashes($row_pg['title'])?>" <?php echo $target?>><span><?php echo stripslashes($row_pg['title']);?></span></a></h2></li>
								<?php
								}
						...
						?>
									<li><h2> <a href="<?php url_link('')?>" class="sta_menu" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_HOME']?>"><span><?php echo $Captions_arr['STATIC_PAGES']['STAT_HOME']?></span></a></h2></li>
						<?php
								}
						}		
						?>			
										...
										?>
											<div class="toparea_cat_menu">
												...
												<?php
													...
													{
														?>
														<li><h2><a href="<?php url_category($row_cat['category_id'],$row_cat['category_name'],-1)?>" class="cat_menu" title="<?php echo stripslashes($row_cat['category_name'])?>"><span><?php echo ucwords(stripslashes($row_cat['category_name']));?></span></a></h2></li>
														<?
													}
												?>
												</ul>
									...
									if ($db->num_rows($ret_cat))
									{
										...
										<?php
											while ($row_cat = $db->fetch_array($ret_cat))
											{
												$startpnt++;
										?>
														<li><h3><a href="<?php url_category($row_cat['category_id'],$row_cat['category_name'],-1)?>" class="bottomlink" title="<?php echo stripslashes($row_cat['category_name'])?>"><?php echo ucwords(stripslashes($row_cat['category_name']));?></a></h3></li>
										<?php
											}
										?>
											</ul>
														...
														if ($row_cat['category_subcatlisttype']=='List' or $row_cat['category_subcatlisttype']=='Both')
														{
															...
															{	
																...
																if ($db->num_rows($ret_child))
																{
																	...
																	{
																?>
																			<li><h2><a href="<?php url_category($row_child['category_id'],$row_child['category_name'],-1)?>" title="<?php echo stripslashes($row_child['category_name'])?>" class="subcategoryheaderlink"><?php echo ucwords(stripslashes($row_child['category_name']));?></a></h2></li>
																<?php		
																	}
																}
															}
		...
		function mod_quicksearch()
		{
			...
			<div class="cart_conlf">
				...
				<div class="cart_middlelf">
				 <div class="cart_hdrlf">Shopping Cart</div>
				  <div class="cart_itemlf"><?php echo $Captions_arr['COMMON']['CART_TOTAL']?> <?php echo $cart_tot?></div>
				  <div class="cart_itemlf"><?php echo $Captions_arr['COMMON']['ITEMS_IN_CART']?><?php echo  (get_session_var('cart_total_items'))?get_session_var('cart_total_items'):0?></div>
				  <div class="cart_btnlf"><a href="#" class="cart_linklf" onclick="handle_checkout_submit('<?php echo $ecom_hostname?>',0,'<?php echo $pass_tot?>')"  title="<?php echo $Captions_arr['COMMON']['CHECK_OUT']?>"><span><?php echo $Captions_arr['COMMON']['CHECK_OUT']?></span></a>
				  <a href="#" onclick="gobackto_cart('<?php echo ($protectedUrl)?base64_encode($ecom_hostname):$ecom_hostname?>')" class="cart_linklf" title="<?php echo $Captions_arr['COMMON']['VIEW_CART']?>"><span><?php echo $Captions_arr['COMMON']['VIEW_CART']?></span></a>
				  <a href="<?php url_link('enquiry.html')?>" class="cart_linklf" title="<?php echo $Captions_arr['COMMON']['VIEW_ENQUIRY']?>"><span><?php echo $Captions_arr['COMMON']['VIEW_ENQUIRY']?></span></a></div>
				</div>
			...
			?>
				<div class="login_con">
				   <div class="login_banner">
					 <div class="signup_btn"><a href="<?php url_link('registration.html')?>" title="<?php echo $Captions_arr['CUST_LOGIN']['NEW_USER']?>"><img src="<?php url_site_image('signup-btn.gif')?>" /></a></div>
					...
					<div class="login_middle">
					 <table class="logintable" border="0" cellpadding="0" cellspacing="0">
						...
						<?php   
							...
							<tr>
								<td>&nbsp;</td>
								<td class="logintablecontentright" align="right" valign="top"> <input name="custologin_Submit" class="buttongray" id="custologin_Submit" value="<?php echo $Captions_arr['CUST_LOGIN']['LOGIN']?>" type="submit">
								</td>
							</tr>
							<tr>
							...
							<div class="bestsellers_top"></div>
								<div class="bestsellers_middle">
									...
									while ($row_main = $db->fetch_array($ret_main))
									{
										...
										<div class="bestsellers_buy"><a href="<?php url_product($row_main['product_id'],$row_main['product_name'],-1)?>" title="<?php echo stripslashes($row_main['product_name'])?>" class="best_comp_name_link"><?php echo $Captions_arr['COMMON']['COMMON_BUY_NOW']?></a></div>
												
												 <div class="bestseller_pdt_top"></div>
										<div class="bestseller_pdt_middle">
											<div class="bestseller_name"><a href="<?php url_product($row_main['product_id'],$row_main['product_name'],-1)?>" title="<?php echo stripslashes($row_main['product_name'])?>" class="best_comp_name_link"><?php echo stripslashes($row_main['product_name'])?></a>
										   </div>
									...
									<? }?>
								<div class="bestseller_show"><a href="<? url_link('bestsellers'.$display_id.'.html')?>" class="bestseller_showall" title="<?php echo $Captions_arr['COMMON']['SHOW_ALL']?>"><?php echo $Captions_arr['COMMON']['SHOW_ALL']?></a></div>
								</div>
								...
								<div class="compare_div">
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="0" class="compare_table">
										...
										<tr>
											...
											<a href="<?php url_product($row_compare_pdts['product_id'],$row_compare_pdts['product_name'],-1)?>" class="comparelink" title="<?php echo stripslashes($row_compare_pdts['product_name'])?>"><?php echo stripslashes($row_compare_pdts['product_name'])?></a>
											</td>
										</tr>				
			...
			if ($position=='left' or $position =='right')// Combo deal is allowed only in left or right panel
			{
				...
				{	
						...
						?>
                                   ...
                                   <a href="<?php url_combo($combData['combo_id'],$combData['combo_name'],-1)?>" title="<?php echo $Captions_arr['COMMON']['SHOW_DEAL']?>">													<?php
									...
									<a href="<?php url_combo($combData['combo_id'],$combData['combo_name'],-1)?>" class="lf-combodeal-showall" title="<?php echo $Captions_arr['COMMON']['SHOW_DEAL']?>"><?php echo $Captions_arr['COMMON']['SHOW_DEAL']?></a>
									</div> 
								...
								switch($shelfData['shelf_displaytype'])
								{
									...
									<div class="normal_shlf">
										...
										while($row_prod = $db->fetch_array($ret_prod))
										{
											...
											{
											?>
												<div class="normal_shlf_name"><a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" class="normal_lf_link" title="<?php echo stripslashes($row_prod['product_name'])?>"><?php echo stripslashes($row_prod['product_name'])?></a></div>
											<? 
											}
										...
										?>
											<div class="normal_shlf_show"><a href="<?php  url_shelf_all($shelfData['shelf_id'],$shelfData['shelf_name'],-1)?>" class="normal_shlf_showall" title="<?php echo $Captions_arr['COMMON']['SHOW_ALL']?>"><?php echo $Captions_arr['COMMON']['SHOW_ALL']?></a></div>
											</div>
							...
							elseif($shelfData['shelf_currentstyle']=='special1') // case of christmas layout
							{
								...
								case '2row':
									...
									<div class="spl_shlf_pdt">
										<div class="spl_shlf_buy"><a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" class="normal_name_link" title="<?php echo stripslashes($row_prod['product_name'])?>"><?php echo $Captions_arr['COMMON']['COMMON_BUY_NOW']?></a></div>
										...
										{
										?>
											<div class="spl_shlf_name"><a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>"  title="<?php echo stripslashes($row_prod['product_name'])?>"><?php echo stripslashes($row_prod['product_name'])?></a></div>
										<? 
										}
										?>
										</div>
									...
									<? }?>
									<div class="spl_shlf_show"><a href="<?php  url_shelf_all($shelfData['shelf_id'],$shelfData['shelf_name'],-1)?>" class="spl_shlf_showall" title="<?php echo $Captions_arr['COMMON']['SHOW_ALL']?>"><?php echo $Captions_arr['COMMON']['SHOW_ALL']?></a></div>	
									</div>
		...
		function mod_newsletter($title)
		{
			...
			{
				?>
				<a href="<?php url_link('newsletter.html')?>">newsletterbanner<img src="<?php url_site_image('newsletter_banner.jpg')?>" border="0" /></a>
				<?php
			}
			else
			{
        ...
        <table class="rt_newslettertable" border="0" cellpadding="0" cellspacing="0">
						...
						?>	
						  <tr>
								<td class="rt_newslettertd"><?php echo $Captions_arr['NEWS_LETTER']['TITLE']?></td>
						...
						?>
						<tr>
							<td class="rt_newslettertd"><?php echo $Captions_arr['NEWS_LETTER']['NAME']?></td>
							<td align="left" valign="top" class="rt_newslettertd">
						...
						?>		 
						<tr>
							<td class="rt_newslettertd"><?php echo $Captions_arr['NEWS_LETTER']['EMAIL']?></td>
							<td align="left" valign="top" class="rt_newslettertd">
						...
						?>
						<tr>
							<td class="rt_newslettertd"><?php echo $Captions_arr['NEWS_LETTER']['PHONE']?></td>
							<td align="left" valign="top" class="rt_newslettertd">
						...
						?>
							<tr>
								<td colspan="2" valign="top" class="rt_newslettertd"><?php echo $Captions_arr['NEWS_LETTER']['GROUP']?></td>
							</tr>
							<tr>
						...
						?>
						  <tr>
							<td align="left" colspan="2" class="rt_newslettertd"><?=$Captions_arr['NEWS_LETTER']['ENTER_CODE']?>&nbsp;<span class="redtext">*</span></td>
						  </tr>
						  <tr>
							 <td align="left" valign="middle" colspan="2" class="rt_newslettertd"><img src="<?php url_verification_image('includes/vimg.php?size=4&pass_vname=newsletter_Vimg')?>" border="0" alt="Image Verification"/></td>
						  </tr>
						  <tr>
							<td  colspan="2" align="left" class="rt_newslettertd">
							  <?php 
								// showing the textbox to enter the image verification code
								$vImage->showCodBox(1,'newsletter_Vimg','class="rt_newsletterinput"'); 
							?>				</td>
		...
		function mod_giftvoucher($title)
		{
		   ...
		   ?>
			<div class="gift_buy"><a href="<?php echo get_buyGiftVoucherURL()?>" class="buygiftvoucherheader" title="<?php echo $Captions_arr['GIFT_VOUCHER']['BUY_VOUCHER']?>"><img src=" <?php url_site_image('buy-gift.gif') ?>" /></a></div>
		<?php	
		}
		// ####################################################################################################
			 ...
			 <?php
				...
				?>
						...
						<div class="sry_stas">
							...
							<input name="survey_Submit" type="submit" class="sry_btn" value="<?php echo $Captions_arr['SURVEY']['VOTE']?>" /></td>
							</tr>
						   </tbody></table>
							</div>
											...
											<div class="shop_brand_top"></div>
												<div class="shop_brand_middle">
													...
													<?php
														...
														?>
															 <li><h2><a href="<?php url_shops($row_shop['shopbrand_id'],$row_shop['shopbrand_name'],-1)?>" class="shop_brand_link" title="<?php echo stripslashes($row_shop['shopbrand_name'])?>"><?php echo stripslashes($row_shop['shopbrand_name']);?></a></h2></li>
														<?php
		...
		<div class="web_stas">
			<div class="web_stas_top"></div>
				...
				<?php
					...
					?>
					<div class="stcs_txtB"><span class="webstatisticsA">"<?=$row_query['site_hits']?>"</span><br /><?php echo $Captions_arr['COMMON']['WEB_STATISTICS']?></div>
				</div>
					...
					<div class="preorder_top"></div>
						...
						<?php
							...
							<?
								...
								{	
									while ($row_main = $db->fetch_array($ret_main))
									{
										...
										<div class="preorder_pdt">
											...
											<div class="preorder_name"><a href="<?php echo url_product($row_main['product_id'],$row_main['product_name'],-1)?>" class="preordprodlink" title="<?php echo stripslashes($row_main['product_name'])?>"><?php echo stripslashes($row_main['product_name'])?></a></div>
										    </div>
								...
								?>
							<div class="preorder_show"><a href="<? url_link('preorder'.$display_id.'.html')?>" class="preorder_showall" title="<?php echo $Captions_arr['COMMON']['SHOW_ALL']?>" ><?php echo $Captions_arr['COMMON']['SHOW_ALL']?></a></div>	
						</div>
