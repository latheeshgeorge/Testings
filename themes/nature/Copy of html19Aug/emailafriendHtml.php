...
/*############################################################################
	...
	class emailafriend_Html
	{
		...
		?>
			...
			<div class="inner_con" >
				...
				<?php } ?>
				<tr>
				<td colspan="2" class="regiconentA"><?=stripslash_normal($Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_HEADER_TEXT'])?>
				</td>
				</tr>
				</table>
				</div>
	...
	if($Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_PRODUCT_TITLE']) { ?>
		...
		<tr>
		  <td width="62%" align="left" valign="middle" class="regiconentA"><?=stripslash_normal($Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_PRODUCT_TITLE'])?>&nbsp;<span class="readreivewname"><h1><?=$product_name?></h1></span></td>
						...
						<table class="regifontnormal" width="100%" border="0" cellpadding="0" cellspacing="0">
							<tbody>
								<tr class="regitable">
									...
									<td align="left" valign="middle" class="regi_txtfeild"><img src="<?php url_verification_image('includes/vimg.php?size=3&amp;pass_vname=emailafriend_Vimg')?>" border="0" alt="Image Verification"/></td>
								</tr>
								<tr>
	 ...
	 <div class="inner_con" >
		...
		<table class="regifontnormal" width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td class="regiconent"><input type="hidden" name="action_purpose" id="action_purpose" value="send_emailafriend"  /></td>
				<td align="left" valign="middle" class="regi_button"><input name="emailafriend_Submit" type="submit" class="inner_button_red" id="emailafriend_Submit" value="<?=stripslash_normal($Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_SEND_BUTTON'])?>" onclick="show_wait_button(this,'Please wait...')"/></td>
			</tr>
			</table>
			</div>
		<div class="inner_bottom"></div>
	...
	else
	{
		...
		?>
			...
			if($Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_BACK_TO_DETAILS_LINK']){?>
			 <tr>
			<td  colspan="2" align="left" valign="top"  class="regicontentA" ><a href="<?php url_product($product_id,'',-1)?>" title="<?php echo stripslashes($row_prod['product_name'])?>" class="message_backlink"><?=stripslash_normal($Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_BACK_TO_DETAILS_LINK'])?></a></td>
			</tr>
			<? }?>
			</table>
			</div>
