	...
	class cart_Html
	{
		...
		?>	
			...
			<?php
			  ...
			  <tr>
				<td align="left" valign="middle" class="shoppingcartheaderA"><?php echo stripslash_normal($Captions_arr['CART']['CART_ITEM'])?></td>
				...
				<td align="center" valign="middle" class="shoppingcartheaderA"><?php echo stripslash_normal($Captions_arr['CART']['CART_DISCOUNT'])?></td>
				<td align="center" valign="middle" class="shoppingcartheaderA"><?php echo stripslash_normal($Captions_arr['CART']['CART_QTY'])?></td>
				<td align="right" valign="middle" class="shoppingcartheaderA"><?php echo stripslash_normal($Captions_arr['CART']['CART_TOTAL'])?></td>
			  </tr>
		  <?php
		  ...
		  ?>
				...
				?>	
						 <tr>
						 <td width="53%" align="left" class="shoppingcartcontent"><?php echo stripslash_normal($Captions_arr['CART']['CART_DELIVERY_LOC'])?><a name="a_deliv">&nbsp;</a> </td>
		  ...
		  <?php
			...
			?>
				 <tr>
					<td colspan="4" align="right" valign="middle" class="shoppingcartpricebdr"><?php echo stripslash_normal($Captions_arr['CART']['CART_TOTAL_POINTS_EARN'])?>&nbsp;</td>
			...
			?>
				 <tr>
					<td colspan="4" align="right" valign="middle" class="shoppingcartpricebdr"><a name="bonus">&nbsp;</a><?php echo stripslash_normal($Captions_arr['CART']['CART_SPENT_BONUS_POINTS'])?>(<? print (int)(($cartData["customer"]['customer_bonus']-$cartData["bonus"]["spending"])); ?> &nbsp;<?php echo stripslash_normal($Captions_arr['CART']['CART_REMAINING'])?>)&nbsp;</td>
				  ...
				  <?php
					...
					?>
					  <tr>
						<td colspan="4" align="right" valign="top" class="shoppingcartpricebdr"><?php echo stripslash_normal($Captions_arr['CART']['CART_SPENT_BONUS_POINTS_VALUE'])?> </td>
				...
				if ($db->num_rows($ret_paytypes))
				{
					...
					?>	
							  ...
							  <table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
								  <td width="49%" align="center" class="cart_payment_header"><a name="a_pay">&nbsp;</a><?php echo stripslash_normal($Captions_arr['CART']['CART_SEL_PAYTYPE'])?></td>
      ...
      <div class="lgn_contnt" >
          ...
          <table class="regifontnormal" width="100%" border="0" cellpadding="0" cellspacing="4">
            <tbody>
              ...
              <tr>
				...
				<div class="lgn_btn_innerA"><br /><br /><a href="javascript:document.frm_custlogin_cart.submit()"><img src="<?php echo url_site_image('login-img.gif')?>" border="0" /></a></div>
				</div></td>
              </tr>
            </tbody>
          </table>
		...
		?>	
		  ...
		  <?php
			...
			?>	
						<tr>
						<td colspan="3" align="left" valign="middle" class="shoppingcartcontent"><?php echo stripslash_normal($Captions_arr['CART']['CART_GIFTWRAP_REQ'])?> (<?php echo print_price($row_gift['giftwrap_minprice'],true)?>)</td>
					...
					?>
						...
						<tr>
							...
							<td colspan="3" align="left" valign="middle" class="shoppingcartcontent_indent"><?php echo nl2br(stripslashes($row_cartdet['giftwrap_msg']))?></td>
						</tr>
					<?php
						}
					...
					?>
						<tr>
							...
							<td colspan="3" align="left" valign="middle" class="shoppingcartcontent_indent"><?php echo stripslashes($row_ribbon['ribbon_name'])?></td>
						</tr>
					<?php	
						}
					...
					?>
						<tr>
							...
							<td colspan="3" align="left" valign="middle" class="shoppingcartcontent_indent"><?php echo stripslashes($row_paper['paper_name'])?></td>
						</tr>
					<?php	
						}
					...
					?>
						<tr>
							...
							<td colspan="3" align="left" valign="middle" class="shoppingcartcontent_indent"><?php echo stripslashes($row_card['card_name'])?></td>
						</tr>
					<?php	
						}
					...
					?>
						<tr>
							...
							<td colspan="3" align="left" valign="middle" class="shoppingcartcontent_indent"><?php echo stripslashes($row_bow['bow_name'])?></td>
						</tr>
					<?php	
						}
			...
			if ($deliverydet_Arr['delivery_type'] != 'None') // Check whether any delivery method is selected for the site
			{
				...
				?>	
							<tr>
								...
								<td colspan="3" align="left" valign="middle" class="shoppingcartcontent_indent"><?php echo stripslashes($row_loc['location_name'])?></td>
							</tr>
				<?php
						}
					}
				...
				?>	
							<tr>
								...
								<td colspan="3" align="left" valign="middle" class="shoppingcartcontent_indent"><?php echo stripslashes($row_grp['delivery_group_name'])?></td>
							</tr>
				<?php
						}
					}	
		  ...
		  <?php
			...
			?>
				 <tr>
					<td colspan="3" align="left" valign="middle" class="shoppingcartcontent"><?php echo stripslash_normal($Captions_arr['CART']['CART_TOTAL_POINTS_EARN'])?>&nbsp;</td>
		...
		?>
			...
			<tr>
				<td colspan="6" align="left" class="shoppingcartheader"><?php echo stripslash_normal($Captions_arr['CART']['CART_FILL_BILLING_DETAILS'])?></td>
			</tr>
			<?php
			 ...
			 // check whether billing and shipping address can be different in the site.
			  ...
			  ?>
				...
				<tr id="checkout_delivery_tr">
					...
					<table width="100%" cellpadding="1" cellspacing="1" border="0">
					<tr>
					<td colspan="2" align="left" class="shoppingcartheader"><?php echo stripslash_normal($Captions_arr['CART']['CART_FILL_DELIVERY_ADDRESS'])?></td>
					</tr>	
						<?php
...
//				$cont_class = 'shoppingcartcontent_noborder'; 
			...
			?>
					 <tr>
						...
						<table width="100%" cellpadding="1" cellspacing="1" border="0">
						<tr>
						<td colspan="2" align="left" class="shoppingcartheader"><?php echo stripslash_normal($Captions_arr['CART']['CART_CREDIT_CARD_DETAILS'])?></td>
						</tr>
						<?php
			...
			<?php	
				...
				else// case if credit card details not to be picked
				{
					...
					{	
						...
						<table width="100%" cellpadding="1" cellspacing="1" border="0">
						<tr>
						<td colspan="2" align="left" class="shoppingcartheader"><?php echo stripslash_normal($Captions_arr['CART']['CART_CHEQUE_DETAILS'])?></td>
						</tr>
						<?php
							// Get the list of credit card static fields to be shown in the checkout out page in required order
							$sql_checkout = "SELECT field_det_id,field_key,field_name,field_req,field_error_msg   
            ...
            <div class="cart_continue_div" align="left">
			 ...
			 // Handling the case of login required before checkout.
			  ...
			  ?>	
					...
					{
					?>
						<input name="continue_checkout" type="submit" class="cart_btn" id="continue_checkout" value="<?php echo $checkout_caption?>"/>
					<?php
					}
					else
					{
		...
		?>	<div class="treemenu">
			...
			<div class="inner_header"><?php echo stripslash_normal($Captions_arr['CART']['CART_CHECKOUTPREVIEWHEADING'])?></div>
			<div class="inner_con" >
	        <div class="inner_top"></div>
    	    <div class="inner_middle_cart">	
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="shoppingcarttable">
		  ...
		  <?php
			...
			?>	
					...
					?>
						...
						<tr>
							<td colspan="3" align="left" valign="middle" class="shoppingcartcontent_indent"><?php echo stripslash_normal($Captions_arr['CART']['CART_MSG'])?></td>
							<td colspan="3" align="left" valign="middle" class="shoppingcartcontent_indent"><?php echo nl2br(stripslashes($row_ord['order_giftwrapmessage_text']))?></td>
						</tr>
					<?php
						}
					...
					?>
								<tr>
									...
									<td colspan="3" align="left" valign="middle" class="shoppingcartcontent_indent"><?php echo stripslashes($row_giftwrap_det['giftwrap_name'])?></td>
								</tr>
					<?php		
							}
					?>
		...
		?>	
			<tr>
				<td colspan="6" align="left" class="shoppingcartheader"><?php echo stripslash_normal($Captions_arr['CART']['CART_BILL_DETAILS'])?></td>
			</tr>
			<?php
					// Including the file to show the dynamic fields for orders to the give position of static fields
					$cur_pos 		= 'TopInStatic';
				...
				?>
							<tr>
								<td align="left" colspan="3" class="shoppingcartcontent">
			...
			<?php
				...
				?>
				<tr>
					<td colspan="6" align="left" valign="middle" class="shoppingcartheader_noborder"><?php echo stripslash_normal($Captions_arr['CART']['DELIVERY_ADDRESS'])?></td>
				</tr>	
				<?php
					// Get the list of billing address static fields to be shown in the checkout out page in required order
					$sql_checkout = "SELECT field_name,field_orgname 
			...
			?>
			  <tr>
				<td colspan="3" align="left" valign="middle" class="shoppingcartcontent">			
					<?php echo stripslash_normal($Captions_arr['CART']['CART_PAYMENT_TYPE'])?>
				</td>
				<td colspan="3" align="left" valign="middle" class="shoppingcartcontent">			
				<?php 
			  ...
			  ?>
				  <tr>
					<td colspan="3" align="left" valign="middle" class="shoppingcartcontent">			
						<?php echo stripslash_normal($Captions_arr['CART']['CART_GATEWAY_USED'])?>
					</td>
					<td colspan="3" align="left" valign="middle" class="shoppingcartcontent">			
					<?php 
		...
		?>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="shoppingcarttable">
			  ...
			  <tr>
				...
				<?php echo stripslash_normal($Captions_arr['CART']['CART_CHECKOUT_SUCCESS_MSG'])?>
				</td>
			</tr>
			<?php 
