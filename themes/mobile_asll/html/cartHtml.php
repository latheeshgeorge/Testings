							...
							?>
									...
									<tr>
                                        <td colspan="2" class="td">
                                                ...
                                                {
                                                ?>
                                               <input class="shoppingcart_radio" type="checkbox" name="cart_terms" id="cart_terms" value="1" /><?php echo stripslash_normal($Captions_arr['CART']['CART_ACCEPT_TERMS_CONDITIONS'])?>
                                                <?php	
                                                }
                                                ?>	
                                                </td>
		...
		function Show_CheckoutSuccess($order_id=0)
		{
			...
			*/
			if($ecom_isadword)
			{
				if ($order_id>0)
				{
					if($ecom_siteid==83) // case of asll
					{
					?>
