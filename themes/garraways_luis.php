 ...
 if($_REQUEST['modal_control']==111) // case of sending email for Request information from product details page
 {
	...
	else
	{
	 $error_val = "Robot verification failed, please try again.";	
		...
		//$ret_err = mail_Phpmaler($address, "Request Information - $ecom_hostname",$message,$_REQUEST["modal_email"],$ecom_hostname,$email_headers);
 ...
 if($_REQUEST['modal_control']==444) // case of sending email for Request information from product details page
 {
	...
	else
	{
	 $error_val = "Robot verification failed, please try again.";	
		...
		//$ret_err = mail_Phpmaler($address, "Request Lease Quote - $ecom_hostname",$message,$_REQUEST["modalq_email"],$ecom_hostname,$email_headers);
...
if ($_REQUEST['ContactUs_Submitted']==1)
{
	...
	if($show_error=="")
	{
		...
		//$ret_err = mail_Phpmaler($address, "Contact Us Form",$message,$_REQUEST["emailaddress"],"puregusto.co.uk",$email_headers);
