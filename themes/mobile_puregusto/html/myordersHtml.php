					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="search_areaTable">
						<tr>
							...
							<td>
								...
								<input name="ord_fromdate" id="datepicker" class="textfeild_ord" type="text" size="10" value="<?php echo $_REQUEST['ord_fromdate']?>" />
							and
							  <input name="ord_todate" id="datepicker1" class="textfeild_ord" id="" type="text" size="10" value="<?php echo $_REQUEST['ord_todate']?>" />
...
if($insmsg)
	...
	<tr>
	<td colspan="7" align="right" style="padding:0 6px 0 0;">
		<span id='repeatBut'>&nbsp;&nbsp;<div class="cart_shop_cont"><div><input type="button" name="repeat_order" value=" Repeat Order" class="inner_btn_red" onClick="javascript:ord_repeat(document.frm_orderdetail, '<?php echo $row_select_ord['order_id']?>')"></div></div></span>&nbsp;&nbsp;
	</td>
	</tr>
	<?php
	...
	<td align="right" colspan="4" class="tdcolorgray_normal"><?php	
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
		  <tr >
			...
			*/?>
			<td class="<?php echo $cls?>" align="center" nowrap="nowrap"><div >Sale Price</div></td>
			<td class="<?php echo $cls?>" align="center" nowrap="nowrap"><div >Qty</div></td>
	...
	<tr onclick="handle_expansionall('refunddet_imgtag','bill','<?PHP echo $ecom_hostname; ?>')">
	  ...
	  <tr>
		<td width="3%" class="userorderheadernew" ><img id="refunddet_imgtag" src="<?PHP echo url_site_image('sel_tab_no.gif'); ?>" border="0"  title="Click"/></td>
	...
	<td colspan="4" align="left" valign="bottom"><table width="100%" border="0" cellspacing="1" cellpadding="1">
	  <tr>
		<td width="3%" class="userorderheadernew"><img id="billing_imgtag" src="<?PHP echo url_site_image('sel_tab_no.gif'); ?>" border="0"  title="Click"/></td>
	...
	<td width="3%" class="userorderheadernew"><img id="Enquiry_imgtag" src="<?PHP if(!$_REQUEST['ord_pg']) { echo url_site_image('sel_tab_no.gif'); } else {  echo url_site_image('sel_tab_yes.gif'); } ?>" border="0"  title="Click"/></td>
	...
	<tr id="EnqId1" style="display:none;" >
	  ...
	  <td colspan="3" ><input type="text" name="txt_enqtitle" size="15" /></td>
	</tr>
	<tr id="EnqId2" style="display:none;" >
	  <td colspan="3">&nbsp;Enquiry Content</td>
	  <td colspan="3"><textarea name="txt_enquiry" cols="15" rows="6"></textarea>       
	   &nbsp;&nbsp;<br/>        </td>
	  </tr>
...
<div class="reg_shlf_outr">
  ...
  <table width="100%" border="0" cellpadding="2" cellspacing="0" class="expandtable_cls">
    ...
    <tr id="postDet1"   style="display:none;" >
      ...
      <td colspan="3"><br/><textarea name="txt_post" cols="15" rows="6"></textarea>        &nbsp;</td>
    </tr>
    <tr id="postDet2" style="display:none;"  >
      <td colspan="2">&nbsp;</td>
	     <td colspan="3" >
		<div><input type="button" name="Submit" value="Add New Post" onclick="javascript:postSub(document.frm_enqposts)" class="inner_btn_red" />	</div>
