...
/*############################################################################
	...
	class emailafriend_Html
	{
		...
		{
			global $Captions_arr,$ecom_siteid,$db,$ecom_hostname,$vImage,$Settings_arr,$product_id,$product_name,$alert,$publickey,$privatekey;
			
			$captcha_code = '<div><div class="g-recaptcha" data-sitekey="'.$publickey.'"></div></div>';
