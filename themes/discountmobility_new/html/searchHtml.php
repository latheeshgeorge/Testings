<?php
	...
	class search_Html
	{
		...
		function Show_Search($search_sql,$tot_cnt,$sql_relate,$from_filter=false)
		{
			...
			if($Settings_arr['product_orderby_search']==48)
			{
			 $Settings_arr['product_orderby_search'] = 100;
			}
			...
			<tr>
								...
								while ($row_search = $db->fetch_array($ret_search))
								{
									...
									$price_bal2 = show_Price($row_search,$price_class_arr,'other_3',false,5);
...
<?php
												...
												{
													?>
																<div class="featureimgqrap_three_column"><a href="<?php url_product($row_search['product_id'],$row_search['product_name'],-1)?>" title="<?php echo stripslashes($row_search['product_name'])?>" <?php echo getmicrodata_producturl()?> class="product_image" >
																	<?php
										...
										<?php			
												...
												/*alert('here');*/
													$("#finpermonth_<?php echo $row_search['product_id']?>").html("&pound;"+(my_fd_obj.m_inst).toFixed(2));
						...
						<?php				}
										...
										<?php
													...
													<?php			$class_arr['ADD_TO_CART']       = '';
																	...
																	if($row_search['product_discontinue']==1)
																	{
