				...
				?>
					<tr class="edithreflink_tronmouse" title="<?php echo $Captions_arr['MY_DOWNLOADS']['DOWN_DOWNLOAD']?>" onmouseover="this.className='edithreflink_trmouseout'" onmouseout="this.className='edithreflink_tronmouse'">
					  ...
					  <?php
						...
						?>
								<a href="<?php echo $ecom_selfhttp.$ecom_hostname?>/download_product.php?dld=<?php echo $dld?>" title="<?php echo $Captions_arr['MY_DOWNLOADS']['DOWN_CLICK_DOWN'];?>"><img src="<?php url_site_image('download.gif')?>" alt="Click to Download" border="0" /></a>
						<?php
							}
							else
							{
