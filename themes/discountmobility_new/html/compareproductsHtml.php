...
?>
				...
				<td align="left" valign="top" width="15%">&nbsp;</td>
					  ...
					  <?php
						...
						{
						?>
							<td align="left" valign="middle" class="prod_comparison_name"><a href="<?php url_product($compare_arr['main'][$i]['product_id'],"'".$compare_arr['main'][$i]['product_name']."'",-1)?>" title="<?php echo stripslashes($compare_arr['main'][$i]['product_name'])?>" class="prod_comparison_name"><?php echo stripslashes($compare_arr['main'][$i]['product_name'])?></a></td>
						<?php
						}
						?>	
					</tr>
				  <tr>
					  <td align="left" valign="top">&nbsp;</td>
						...
						{
						?>		
								<td align="left" valign="middle"  class="prod_comparison_buy">
					  ...
					  ?>
							  <tr>
								<td align="left" valign="middle" class="comparison_mainheader"><?php echo $Captions_arr['PROD_DETAILS']['PRODDET_COMPPRICE'];?></td>
								  <?php
									for ($i=0;$i<$num_products;$i++)
									{
					  ...
					  ?>
						  <tr>
							<td align="left" valign="middle" class="comparison_mainheader"><?php echo $Captions_arr['PROD_DETAILS']['PRODDET_COMPSTOCK'];?></td>
							 <?php
								for ($i=0;$i<$num_products;$i++)
								{
									$cls = ($i==0)?'comparison_contentA':'comparison_contentB';
					 ...
					 ?> 
						  ...
						  ?>
							  <tr>
								<td align="left" valign="middle" class="comparison_mainheader"><?php echo $v?></td>
								<?php
									for ($i=0;$i<$num_products;$i++)
									{
										$cls = ($i==0)?'comparison_contentA':'comparison_contentB';
						...
						?>						  
						  <tr>
							<td colspan="4" align="left" valign="middle" class="comparison_sec_header"><?php echo $Captions_arr['PROD_DETAILS']['PRODDET_COMPGENFEATURE'];?></td>
						  </tr>
						  <?php 
						 } 
						  	if($desc==1)
						  ...
						  ?>
							  <tr>
								  <td align="left" valign="middle" class="comparison_mainheader"><?php echo $Captions_arr['PROD_DETAILS']['PRODDET_COMPDESC'];?></td>
								  <?php
									for ($i=0;$i<$num_products;$i++)
									{
										$cls = ($i==0)?'comparison_contentA':'comparison_contentB';
									?>
										  <td align="left" valign="middle" class="<?php echo $cls?>"><?php echo stripslashes($compare_arr['description'][$i])?></td>
									<?php
									}
									?>	  
								</tr>
					  <?php
						...
						?>
							...
							<tr>
							<td align="left" valign="middle" class="comparison_mainheader"><?php echo $Captions_arr['PROD_DETAILS']['PRODDET_COMPVAR'];?></td>
							<?php
							for ($i=0;$i<$num_products;$i++)
							{
								$cls = ($i==0)?'comparison_contentA':'comparison_contentB';
					  ...
					  ?>
						   <tr>
							<td align="left" valign="middle" class="comparison_mainheader"><?php echo $Captions_arr['PROD_DETAILS']['PRODDET_COMPBULK'];?></td>
							 <?php
								for ($i=0;$i<$num_products;$i++)
								{
									$cls = ($i==0)?'comparison_contentA':'comparison_contentB';
					  ...
					  ?>
					  <tr>
						<td align="left" valign="middle" class="comparison_mainheader"><?php echo $Captions_arr['PROD_DETAILS']['PRODDET_COMPWEIGHT'];?></td>
						 <?php
							for ($i=0;$i<$num_products;$i++)
							{
								$cls = ($i==0)?'comparison_contentA':'comparison_contentB';
					  ...
					  ?>
					 <tr>
						<td align="left" valign="middle" class="comparison_mainheader"><?php echo $Captions_arr['PROD_DETAILS']['PRODDET_COMPSHIP'];?></td>
						 <?php
							for ($i=0;$i<$num_products;$i++)
							{
								$cls = ($i==0)?'comparison_contentA':'comparison_contentB';
					  ...
					  ?>
						  <tr>
							<td align="left" valign="middle" class="comparison_mainheader"><?php echo $Captions_arr['PROD_DETAILS']['PRODDET_COMPMANUFACT'];?></td>
							 <?php
								for ($i=0;$i<$num_products;$i++)
								{
									$cls = ($i==0)?'comparison_contentA':'comparison_contentB';
					  ...
					  ?>
							<tr>
							<td align="left" valign="middle" class="comparison_mainheader"><?php echo $Captions_arr['PROD_DETAILS']['PRODDET_COMPMODEL'];?></td>
							 <?php
								for ($i=0;$i<$num_products;$i++)
								{
									$cls = ($i==0)?'comparison_contentA':'comparison_contentB';
					  ...
					  ?>
						   <tr>
							<td align="left" valign="middle" class="comparison_mainheader"><?php echo $Captions_arr['PROD_DETAILS']['PRODDET_COMPPOINTS'];?></td>
							 <?php
								for ($i=0;$i<$num_products;$i++)
								{
									$cls = ($i==0)?'comparison_contentA':'comparison_contentB';
					  ...
					  // Check whether the product review module is active for the site
						...
						?>
					  <tr>
						<td align="left" valign="middle" class="comparison_mainheader"><?php echo $Captions_arr['PROD_DETAILS']['PRODDET_REVIEW_CAPTION'];?></td>
						 <?php
							for ($i=0;$i<$num_products;$i++)
							{
								$cls = ($i==0)?'comparison_contentA':'comparison_contentB';
