...
<?php							$max_col = 2;
								...
								while($row_prod = $db->fetch_array($ret_products_id))
								{
									...
									{	$cls = "prod_list_td"; $clsTble = "prod_list_td_tbl";	}
									else
									{	$cls = "prod_list_td_r"; $clsTble = "prod_list_td_tbl_r";	}
...
<?php		}
		...
		?>
			...
			?>
			window.location = '<?php echo $ecom_selfhttp.$ecom_hostname?>/custlogin.html';
			</script>
		<?php	
		}
