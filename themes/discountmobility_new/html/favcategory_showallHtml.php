...
<?php
												...
												{
													?>
																<div class="featureimgqrap_three_column"><a href="<?php url_product($product_array['product_id'],$product_array['product_name'],-1)?>" title="<?php echo stripslashes($product_array['product_name'])?>" <?php echo getmicrodata_producturl()?> class="product_image" >
																	<?php
																...
																<a href="<?php url_product($product_array['product_id'],$product_array['product_name'],-1)?>" title="<?php echo stripslashes($product_array['product_name'])?>"><span <?php echo getmicrodata_productname()?>><?php echo stripslashes($product_array['product_name'])?></span></a>
																</h1>
						...
						<?php				}
										...
										<div class="list_more_div">
												<?php show_moreinfo($product_array,'list_more')?>
												</div>
						...
						<ul class="shelfBul">
									...
									if($product_array['product_bonuspoints'] > 0)
									{
										echo '<div class="prod_list_bonusB">
												...
												<span class="bonus_point_number_c">
													<span>'.stripslash_normal($product_array['PROD_DETAILS']['PRODDET_BONUSPOINTSB']).'</span></span>
												</div>';
									}
							?>
									</li>
							...
							<?php			
								...
								if(in_array($module_name,$inlineSiteComponents))
								{
									...
									<?php
									display_rating($product_array['product_averagerating'],0,'star-green.png','star-white.png');
									?>
									</div>
									<?php
									}
