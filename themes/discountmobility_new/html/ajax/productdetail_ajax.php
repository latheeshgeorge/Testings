	   ...
	   $sql_prods = "SELECT product_sizechart_mainheading 
		...
		?>
			...
			if ($db->num_rows($ret_video))
			{
				...
				{
				?>						<li><a class="downloadlink" href="<?php echo $ecom_selfhttp.$ecom_hostname?>/product_download.php?attach_id=<?php echo $row_video['attachment_id']?>" title="<?php echo $Captions_arr['PROD_DETAILS']['PRODDET_CLICKDOWNLOAD'];?>"><?php echo $cnts++?>. <?php echo stripslashes($row_video['attachment_title'])?></a></li>
				<?php			
				}
				?>					</ul>
				</li>
			...
			if ($db->num_rows($ret_audio))
			{
				...
				{
					?>		<li><a href="<?php echo $ecom_selfhttp.$ecom_hostname?>/product_download.php?attach_id=<?php echo $row_audio['attachment_id']?>" class="downloadlink" title="<?php echo $Captions_arr['PROD_DETAILS']['PRODDET_CLICKDOWNLOAD'];?>"><?php echo $cnts++?>. <?php echo stripslashes($row_audio['attachment_title'])?></a></li>
					<?php			
				}
				?>	</ul>
				</li>
			...
			if ($db->num_rows($ret_pdf))
			{
				...
				{
					?>						<li>
					<a href="<?php echo $ecom_selfhttp.$ecom_hostname?>/product_download.php?attach_id=<?php echo $row_pdf['attachment_id']?>" class="downloadlink" title="<?php echo $Captions_arr['PROD_DETAILS']['PRODDET_CLICKDOWNLOAD'];?>"><?php echo $cnts++?>. </a>
					<a href="<?php echo $ecom_selfhttp.$ecom_hostname?>/product_download.php?attach_id=<?php echo $row_pdf['attachment_id']?>" class="downloadlink" title="<?php echo $Captions_arr['PROD_DETAILS']['PRODDET_CLICKDOWNLOAD'];?>"><?php echo stripslashes($row_pdf['attachment_title'])?></a>
					</li>
					<?php			
				}
				?>					</ul>
			...
			if ($db->num_rows($ret_other))
			{
				...
				{
					?>						<li><a href="<?php echo $ecom_selfhttp.$ecom_hostname?>/product_download.php?attach_id=<?php echo $row_other['attachment_id']?>" class="downloadlink" title="<?php echo $Captions_arr['PROD_DETAILS']['PRODDET_CLICKDOWNLOAD'];?>"><?php echo $cnts++?>. <?php echo stripslashes($row_other['attachment_title'])?></a></li>
					<?php			
				}
				?>					</ul>
				</li>
		...
		function show_link_variable($prod_id,$val_id,$var_id)
		{
			...
			if($val_id>0)
			{
				...
				if ($db->num_rows($ret_val))
				{
					...
					if($row_val['var_value']=='Free 12 months RTB Warranty')
					{
						echo "&nbsp;<a class='facts_class trigger_popup_fricc'>Warranty</a>";
					}
					if(count($tc_return_arr))
					{
						echo "&nbsp;<a class='facts_class' href='javascript:show_pdf_new(\"".$tc_return_arr['key']."\")'>Key Facts</a>";
						if($tc_return_arr['typ']=='3m')
							$cap = 'TOB';
						else
							$cap = 'IDD';
						echo "&nbsp;<a class='facts_class' href='javascript:show_pdf_new(\"".$tc_return_arr['link']."\")'>".$cap."</a>";	
					}
				}
			}
		}	
