...
?>
			<tr>
				<td colspan="5" align="left" class="shoppingcartheaderP"><?php echo stripslashes($row_dynamic['section_name'])?></td>
			</tr>
<?php		
...
?>		
			<tr>
				<td colspan="2" align="right" valign="middle" class="col1" >
				<?php echo stripslashes($row_dynamic['dynamic_label']); ?>
				</td>
				<td colspan="3" align="left" valign="middle" class="col2" >
