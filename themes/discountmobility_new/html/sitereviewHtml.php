...
/*############################################################################
	...
	$str_rparr1 = array();
		$str_rparr2 = array();
			...
			$str_rparr1 = array('2010','2011','2012','2013');
			$str_rparr2 = array('2014','2014','2015','2015');
			$review_date = '';//str_replace($str_rparr1,$str_rparr2,$row_sitereview['reviewed_on']);
		?>
        ...
        <tr>
          ...
          <td width="65%" align="left" valign="top" class="readreivewname"><?=stripslashes($row_sitereview['review_author'])?>  <?=$review_date?></td>
        </tr>
        <tr>
