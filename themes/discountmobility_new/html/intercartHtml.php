...
<?php
			...
			<?php
				...
				?>
			  <tr>
				<td  align="left" valign="middle"><div class="treemenu"><a href="<?php echo $ecom_selfhttp.$ecom_hostname?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> Shopping Cart</div></td>
			  </tr>
					</table>
