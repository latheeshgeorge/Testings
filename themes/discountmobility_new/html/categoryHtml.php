<?php
	...
	class category_Html
	{
	 ...
	 <div id="content" class="content" style="background-color:#fff" >
        <table style="border:0;border-spacing: 0;border-collapse: collapse;width:100%" class="shelfAtable" >
		<tr>
        <td <?php /*colspan="3"*/?>> 
       ...
       ?>
        ...
        <tr>
          <td <?php /*colspan="3"*/?>>
			  <table style="border:0;border-spacing: 0;border-collapse: collapse;width:100%" class="categoreyimage">
			    <?php
			    ...
			    ?>
			    <tr>
						<td style="width:28%;text-align:left;vertical-align:top"  class="categoreyimagetdA">
						<?PHP
		...
		if ($db->num_rows($ret_inline))
		{
			while ($row_inline = $db->fetch_array($ret_inline))
			{
				...
				?>			
				<tr>
						<td style="width:28%;text-align:left;vertical-align:top"  class="categoreyimagetd">
						<?php
				...
				<?php 
					...
					?>
						...
						<form method="post" name="frm_catedetails" id="frm_catedetails" action="<?php echo $ecom_selfhttp.$ecom_hostname.$_SERVER['REQUEST_URI']?>" class="frm_cls">
			 ...
			 <?php
					...
					?>
						<tr>
							<td style="text-align:left;vertical-align:bottom" <?php echo ($img_support)?'colspan="2"':''?> class="moreimages">
							<?php echo $Captions_arr['CAT_DETAILS']['CATDET_MOREIMAGES']?>
							</td>
						</tr>	
						<tr>
							<td style="text-align:left;vertical-align:bottom" <?php echo ($img_support)?'colspan="2"':''?>  class="">
								<table style="border:0;border-spacing: 0;border-collapse: collapse;width:100%">
								<tr>
								<?php
									$maximg_col = 3;
									$curimg_col = 0;
									...
									{
										?>
										<td style="vertical-align:bottom" class="moreimages_td"><a href="<?php url_root_image($v['image_extralargepath'])?>" title="<?php echo $row_cat['category_name']?>"  rel='lightbox[gallery]'>
        ...
        <tr>
			<td <?php /*colspan="3"*/?> style="text-align:center">
				<?php 
		...
		<?php
			...
			if($prodshow)// Checks whether products to be shown in the middle area
			{
				...
				{ 
					...
					if($Settings_arr['product_maxcntperpage']==48)
					{
					 $Settings_arr['product_maxcntperpage'] = 100;
					}
		...
		?>
			 <table style="border:0;border-spacing: 0;border-collapse: collapse;width:100%" class="categoreyimage">	 
			<tr>
				<td style="text-align:left;vertical-align:top"  class="categoreyimagetd"><?php echo $cat_desc;?></td>
			</tr>
			</table>
		<?php 	
		}
		...
		?>
			  	<table style="border:0;border-spacing:2px;border-collapse: collapse;width:100%" class="subcategoreytable">
				
				<tr>
				  <td colspan="3" style="text-align:left;vertical-align:middle" class="subcategoreyheader">
				  <?php
				...
				?>
						<tr>
							<td colspan="3" style="text-align:center;vertical-align:middle" class="red_msg">
							- <?php echo $alert?> -
							</td>
						</tr>
				<?php
					...
					switch ($row_cat['category_subcatlistmethod'])
					{
						...
						<tr>
							...
							?>
								<tr>
								<td style="text-align:left;width:33%" class="subcategoreyimage">
								<?php
								...
								<td style="text-align:left" class="subcategoreyimage">
								<?php
								...
								<?php
									...
									{
										if($row_subcat['category_shortdescription']!='')
										{
											echo '<h6 class="shelfBproddes">';
											if($row_cat['category_showname']==1)
												echo '<br/>';
						...
						?>
								<td style="width:33%;text-align:center;vertical-align:middle" class="subcategoreyimage" onmouseover="this.className='subcategory_hover'" onmouseout="this.className='subcategoreyimage'">
				  ...
				  <?php 
								 ...
								 <?php
								  ...
								  <?php
									...
									{
								  ?>
								 <a href="<?php url_category($row_subcat['category_id'],$row_subcat['category_name'],-1)?>" class="subcategoreynamelink" title="<?php echo stripslashes($row_subcat['category_name'])?>">View <?php echo stripslashes($row_subcat['category_name'])?></a>
								 <?php
									}
								 ?>
								<?php
		...
		{
			global $ecom_siteid,$db,$Settings_arr,$Captions_arr,$inlineSiteComponents,$compare_button_displayed,$inlineSiteComponents;
			...
			/*
		?>
				<div id="loader_img" class="loader_img" style="display:none;"><img src="<?php url_site_image('loading.gif')?>"/></div>
                <!--<div id="loader_img" class="loader_img" ><img src="<?php url_site_image('proddet_loading.gif'); ?>" alt="loading..." width="43px" height="11px;align:left"></div>-->
            */ ?>
            ...
            <div id="loader_img" class="refine_loading_div_ajax" style="height:15px;display:none;padding:5px;" ><img src="<?php url_site_image('ajax-loader_cart.gif')?>" alt="Loading, please wait.."/></div>

            <table style="border:0;border-spacing: 0;border-collapse: collapse;width:100%">
			
			<tr>
				<td  style="text-align:left;vertical-align:top" class="shelfAheader_A">
					<table style="border:0;border-spacing: 0;border-collapse: collapse;width:100%" class="productpagenavtable">
					<tr>
						<td class="productpagenavtext">&nbsp;<?php echo paging_show_totalcount($tot_cnt,'Product(s)',$start_var['pg'],$start_var['pages'])?></td>
						<td style="width:40%;height:30;text-align:right;vertical-align:middle" class="productpagenavtext"><?php echo $Captions_arr['CAT_DETAILS']['CATDET_SORTBY']?>
						...
						<td style="width:32%;text-align:right;vertical-align:middle" class="productpagenavtext">
			...
			<tr>
				...
				<?php
						...
						<?php
							...
							?>
								<tr>
									<td colspan="3" class="pagingcontainertd" style="text-align:center">
...
<?php	//echo "<pre>";print_r($cat_det);
						...
						<?php				}
							...
							<?php
								...
								?>
									<tr>
										<td <?php /*colspan="3"*/?> class="pagingcontainertd" style="text-align:center">
										<?php 
										$path = '';
										$pageclass_arr['container'] = 'pagenavcontainer';
										$pageclass_arr['navvul']	= 'pagenavul';
			...
			<tr>
				<td  style="text-align:left;vertical-align:top" class="shelfAheader_A">
					<table style="border:0;border-spacing: 0;border-collapse: collapse;width:100%" class="productpagenavtable">
					<tr>
						<td style="width:63%;height:30;text-align:right;vertical-align:middle" class="productpagenavtext"><?php echo $Captions_arr['CAT_DETAILS']['CATDET_SORTBY']?><select name="catdet_sortbybottom" id="catdet_sortbybottom">
                           <option value="custom" <?php echo ($prodsort_by=='custom')?'selected="selected"':''?>><?php echo $Captions_arr['CAT_DETAILS']['CATDET_DEFAULT']?></option>
						    <option value="product_name" <?php echo ($prodsort_by=='product_name')?'selected="selected"':''?>><?php echo $Captions_arr['CAT_DETAILS']['CATDET_PRODNAME']?></option>
                            <option value="price" <?php echo ($prodsort_by=='price')?'selected="selected"':''?>><?php echo $Captions_arr['CAT_DETAILS']['CATDET_PRICE']?></option>
                    	    <option value="product_id" <?php echo ($prodsort_by=='product_id')?'selected="selected"':''?>><?php echo $Captions_arr['CAT_DETAILS']['SHOPDET_DATEADDED']?></option>
						...
						<td style="width:37%;text-align:right;vertical-align:middle" class="productpagenavtext"><?php echo $Captions_arr['CAT_DETAILS']['CATDET_ITEMSPERPAGE']?>
		...
		?>
			...
			?>
				...
				<tr>
					<td <?php /*colspan="3"*/?> align="left" valign="top" class="featuredheader"><?php echo $title?></td>
				</tr>
			<?php
				} ?>
				<tr>
	  ...
	  ?>
		<a href="<?php url_category($row_category['category_id'],$row_category['category_name'],-1)?>" class="subcategoreyimage" title="<?php echo stripslashes($row_category['category_name'])?>">
				...
				<?php
					...
					if ($cur_col<$max_col)
						echo '<td colspan="'.($max_col-$cur_col).'" class="subcategoreyimage1">&nbsp;</td>';
				?>	
				</tr>
			  </table>
				</form>	
