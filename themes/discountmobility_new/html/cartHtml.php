      ...
      <td><table  border="0" cellpadding="0" cellspacing="0" class="tableCartA">
        <tbody>
         <?php
		  ...
		  {
			  $sql_del = "DELETE FROM cart_supportdetails WHERE sites_site_id = $ecom_siteid AND session_id='".$session_id."' LIMIT 1";
			  $db->query($sql_del);
			?>
				<tr>
				   ...
				   ?>
					   <tr>
						 <td align="right" class="shoppingcartcontent">
							 <?php /* model display for the delivery option text*/?>
							 <span class="readdelivery_info" id="readdelivery_info">Read Delivery Info </span>
							 <style>
.modal {
...
.close:focus {
	...
	.readdelivery_info {     font-size: 12px;    cursor: pointer;}
 	 .modal-content p {    width: 94%;      font-size: 13px;}
input#chk_18over{width:44px;height:75px;padding:1px;}
...
window.onclick = function(event) {
    if (event.target == modal) {
        modal.style.display = "none";
							 ...
							 <span class="shoppingcartpriceOtr"><?php echo $Captions_arr['CART']['CART_DELIVERY_OPT']?></span>  
						  ...
						  <br>
	<div style="padding:7px;color:#1786AB;width:100%;text-align:center;font-weight:bold;">FREE DELIVERY on orders over &pound;49.99 to UK mainland, excluding the Far Northern Scottish Highlands, Scottish Isles, Isle of Man, Channel Isles & Northern Ireland.</br>
Please Phone 01245 905144 For delivery costs to the these excluded destination.</div>
						  </td>
					   </tr>
					<?php
					}
...
<div></div>
  ...
  <?php
  	...
  	$show_bonus_main_div 	= true;
			...
			//commented for the requirement for client. 
			$Settings_arr['cust_allowspendbonuspoints'] =0;
										...
										while ($row_paytypes = $db->fetch_array($ret_paytypes))
										{
											...
											?>	
												...
												<td class="<?php echo $classB;?>" align="left">
													<?php 													
													echo stripslashes($row_paytypes['paytype_caption']).$add_text?>
													</td>	
												<?php
												$pay_cnt++;
								 ...
								 if($finance_available==true)
		  	{
				...
				if($db->num_rows($ret_pcheck))
				{
					...
					<tr>
						...
						<tr>
						<td style="padding-left:25px;font-weight:bold;" colspan="2">
							(Please tick the qualifying questions to continue to checkout)
							
						</td>
						</tr>
						<tr>
						<td style="padding-left:25px;width:1%">
						...
						<tr>
						<td colspan="2" style="padding-left:25px;padding-top:6px;">
							*&nbsp;Applications from students (unless employed at least 16 hours per week or claiming a Disability Living Allowance), unemployed and unemployed single house persons will not be considered &nbsp;*&nbsp;<br/><br/>
							<span style="font-size:16px;font-weight:bold;">&nbsp;*&nbsp;If you do not meet the above requirements, consider asking a family member or relative to apply for credit on your behalf. All deliveries will be to the name and address of the person who applied for the finance. &nbsp;*&nbsp;</span>
						</td>
						</tr>
						<tr>
						<td colspan="2" style="padding-left:25px;padding-top:6px;">
...
if($_REQUEST['alert1']==1)
			...
			<?php
				...
				?>
			  <tr>
				<td colspan="5" align="left" valign="middle"><div class="treemenu"><a href="<?php echo $ecom_selfhttp.$ecom_hostname?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?php echo $Captions_arr['CART']['CART_CHECKOUTHEADING']?></div></td>
			  </tr>
			  </table>
...
<div class="shipwrap">
<div class="shipTitle"><?php
//echo $cartData['payment']['type'].'testhere';
    if($cartData['payment']['type']=='credit_card')
    {
		$Captions_arr['CART']['CART_FILL_BILLING_DETAILS'] = "<strong>Card Holder Name & Address Details</strong>";
	}
 echo $Captions_arr['CART']['CART_FILL_BILLING_DETAILS']?></div>
...
// Check whether any delivery group exists for the site
  ...
  <tr>
			 ...
			 // Handling the case of login required before checkout.
			  ...
			  ?>	
			  		<div class="cart_checkout_div" align="right">
						<p style="float:right; width:300px;padding:10px;text-align:left;font-weight:bold;font-size:15px;">By clicking on the continue button you are giving your consent for us to store your data. Your data will be stored safely and not passed onto any third parties.</p>
					<?php
					$prev_req = 0;
		...
		?>	
			...
			?>
			  <tr>
				<td colspan="5" align="left" valign="middle"><div class="treemenu"><a href="<?php echo $ecom_selfhttp.$ecom_hostname?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?php echo $Captions_arr['CART']['CART_CHECKOUTPREVIEWHEADING']?></div></td>
			  </tr>
			 <?php
			 }
			 ?> 
...
?>
  ...
  <table border="0" width="100%" cellpadding="0" cellspacing="0" class="bordercontA">
		...
		?>
			...
			?>
				<tr>
					<td align="left" class="shoppingcartcontent_indent_highlight" style="font-size:20px;">
						
					<?php 
					$fpos = strpos(strtolower($msg),'invalid');
					if($fpos===false)
					{
						echo $msg;
					}	
					...
					{
						echo "<br><br>Sorry, We are Not able to process your order. <br><br>Please contact a member of our finance application team on Tel: 01245 905144 (9am - 5pm)
or email: online.enquiries@discount-mobility.co.uk to arrange a call back.<br><br>";
					}
			...
			?>
					<tr>
				<td align="left" class="shoppingcartcontent_indent_highlight" style="font-size:20px;">
				<?php echo str_replace('Please','<br/><br/>Please',$Captions_arr['CART']['CART_CHECKOUT_FAILED_MSG'])?><br /><br />
				<?php
				if($_REQUEST['error']) 
				{
					echo $_REQUEST['error'];
