<?php
	...
	class Homepage_Html
	{
		...
		?>
		<form method="post" name="frm_homepage" id="frm_homepage" action="<?php echo $ecom_selfhttp.$ecom_hostname?>" class="frm_cls">
		<input type="hidden" name="fpurpose" value="" />
			<table style="border:0;border-spacing: 0;border-collapse: collapse;" class="staticpagetable">
			<!--
			<tr>
			  <td colspan="2" align="left" class="staticpageheader"><?php echo stripslashes($cur_title)?></td>
			  </tr>
			  -->
			<tr>
			  <td style="vertical-align:top" class="homepagecontent"><div class="homepagecontent_div">
			  <?php 
