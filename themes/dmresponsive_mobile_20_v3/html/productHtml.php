  ...
  <div class="modal-dialog">
    <div class="modal-content">
		<div class="modal-header">
					...
					<header><button type="button" class="close" data-dismiss="modal">×</button></header>
				</div>
      <div class="modal-body">
<table width="100%" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td align="center" class="relf_heading">DON'T PAY VAT ON YOUR PRODUCTS</td>
  </tr>
  <tr>
    <td align="center" class="relf_question">What is Discount Mobility VAT Relief?</td>
  </tr>
  <tr>
    <td align="center" class="relf_text">If you or the person you are buying a product for, is 'chronically sick 
  or disabled' then you may be entitled to 0% VAT (VAT Relief). This may mean 
  that you can save 20% off of your purchase. </td>
  </tr>
  <tr>
    <td align="center" class="relf_text">When purchasing through the Discount Mobility online checkout you will have an 
  option to select which medical condition you, or the person you are buying 
  for, suffer from. </td>
  </tr>
  <tr>
    <td align="center" class="relf_text">Conditions include Arthritis, Diabetes, Dementia and many more.
  A full list is provided during the checkout</td>
  </tr>
  <tr>
    <td align="center" class="relf_text">If you have any queries whether you are eligible, please contact one of our 
  expert advisors on</td>
  </tr>
  <tr>
    <td align="center" class="relf_phone">01245 905144</td>
  </tr>  
</table>
</div>
</div>
...
<div class="row ">
		<div class="col-md-3 proddet_left">
						<?php
		$position = 'left';
				include("Components.php");
			?>	
					</div>	 
        <div class="col-md-6 detailtop">
...
<p><?php echo stripslash_normal(utf8_encode(replace_unwanted_quotes($row_prod['product_shortdesc']))); ?></p>
 ...
 <meta itemprop="price" content="<?php echo str_replace($csr_arr,$crp_arr,$cur_price_micro)?>" />
			...
			echo $price_bal;
			//$price_bal3 = show_Price($row_prod,$price_class_arr,'prod_detail',false,5);
...
?></div>
<?/*
<script  type="text/javascript" src="https://test.dekopay.com/js/libraries/jquery/jquery-3.3.1.min11.js"></script> 
  ...
  <p> <div class="addwrap">
    ...
    */
	...
	<?php
		...
		<div class="">
			<?php
			$this->show_summary($mod="summary",$row_prod['product_id'],$row_prod,$writereview_show,$readreview_show);
			/*
	  ...
	  */ 
        ...
        <div class="col-md-3 proddet_right">
			<?PHP
			$position = 'right';
			include("Components.php");
			?>
...
function show_summary($mod="summary",$prod_id,$row_prod = array(),$writereview_show = 0,$readreview_show = 0)
{		
		...
		if($db->num_rows($ret_tab))
		{
			...
			?>
			<?php 	   
		echo   " <link href=\"".url_head_link("images/".$ecom_hostname."/css/tabcontent.css",1)."\" rel=\"stylesheet\">";

 echo "<script type=\"text/javascript\" src=\"".url_head_link("images/".$ecom_hostname."/scripts/jquery.multipurpose_tabcontent.js",1)."\"></script>";
?>
		<script type="text/javascript">
        $(document).ready(function() {
	  ...
	  if (count($tabs_arr))
		{
            ...
            <ul class="tab_list">
			    ...
			    ?>
			    <li class="<?php echo $active?>"><?php echo $v_tabtitle?></li>
				<?php
				}
				//if($curtab==0)
				//$curtab=$sel_tabid;
            ...
            <div class="content_wrapper">
				...
				foreach ($tabs_content_arr as $k_tabcontid=>$v_tabcontent)
				{
					...
					?>
					 <div class="tab_content1 <?php echo $class1?>">
                    <p><?php 
                    if($k_tabcontid == -4)
					{
			...
			while($row_prod = $db->fetch_array($ret_prod))
			{
					...
					<?php $frm_name = uniqid('catdet_'); ?>
													...
													<?php			$class_arr['ADD_TO_CART']       = 'btn btn-outline-secondary addbt';
																	...
																	$class_arr['ENQUIRE']           = 'btncart addcartbtn btncart addcartbtn btn btn-outline-secondary enqbt';
																	$class_arr['QTY_DIV']           = '';
																	$class_arr['QTY']               = 'form-control qty_txt';
																	$class_arr['BTN_CLS']     = 'btn btn-outline-secondary addbt';
...
function show_offer_buttons($row_prod)
{
	...
	$in_combo = is_product_in_any_valid_combo($row_prod);
		...
		<div class="pdIconWrap"><img src="<?php url_site_image('3_months_insurance.png')?>" alt="" border="0"></div>
		<?php
		}
		?>

		
		<div class="pdIconWrap"><img src="<?php url_site_image('engineered.png')?>" alt="" border="0"></div>
		<div class="pdIconWrap"><img src="<?php url_site_image('vat_exempt.png')?>" alt="" border="0"></div>
		<?php
