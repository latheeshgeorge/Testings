	...
	class emailafriend_Html
	{
		...
		?>
		  <div class="inner-bg">
				...
				?>
				<div class="reg_shlf_hdr_outr"><div class="reg_shlf_hdr_in"><span><?=stripslash_normal($Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_HEADER_TEXT'])?> </span></div></div>
				<? }?>
				...
				<input type="submit" id="emailafriend_Submit" name="emailafriend_Submit" class="btn-default topcart-bt" value="<?=stripslash_normal($Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_SEND_BUTTON'])?>"/>
				</div>
				</div>
				</div>
				</div>
