 ...
 ?>
		...
		?>
				...
				?>
					...
					?>
					<tr>
					<td colspan="3"  align="left" ><input type="button" class="redbutton" value="<?=stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_ADD_TO_CART'])?>" name="price_AddtoCart" onclick="document.frm_priceAddcart.submit()" /></td>
					</tr>		
					</tbody></table>
					</div>
					</div>
                            ...
                            <table  border="0" cellpadding="2" cellspacing="3" width="100%" class="reg_table_top">
						      ...
						      */
							  ...
							  <tr>
						        ...
						        <td width="29%" nowrap="nowrap" class="usermenucontent"><input name="Search_go" type="submit" class="redbutton" id="Search_go" value="Go" onclick="document.frm_promise.search_click.value=1" /></td>
								<td width="10%">&nbsp;</td>
				...
				<tr>
					...
					?>
						<tr>
							...
							<input type="button" class="redbutton" value="<?=stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_ADD_TO_CART'])?>"  />
							</a>
							</td>
						</tr>	
					<?php
					...
					<input type="hidden" name="add_post" id="add_post" value="1" />
						...
						<tr>
							...
							<div class="cart_shop_cont"><div>
							 <input name="post_cancel" class="redbutton" id="post_cancel" value="Cancel" onclick="document.getElementById('add_post').style.display='none'" type="button">
							</div></div>
							</td>
							<td align="left" class="">
							<input name="post_go" class="redbutton" id="post_go" value="Save Post" onclick="" type="submit">
							</div></div>
