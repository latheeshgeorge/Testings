		...
		//print_r($prod_array );
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="shoppingcarttable">
			...
			if($db->num_rows($ret_select_enq))
				...
				?>
			<tr>
			  <td colspan="3" align="left" valign="middle"><div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?php echo $Captions_arr['ENQUIRE']['ENQUIRE_MAINHEADING']?></div></td>
