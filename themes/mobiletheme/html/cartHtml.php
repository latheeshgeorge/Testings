	...
	class cart_Html
	{
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ctable">
            ...
            <tr>
                <td class="tda"> 
                    ...
                    <tr>
                        <td colspan="2" class="tdbgry"><a href="<?php echo url_product($products_arr['product_id'],$products_arr['product_name'])?>" title="<?php echo $products_arr['product_name']?>" ><?php echo $products_arr['product_name']?></a></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="tdbgry"><span class="fbig"><?php echo print_price($products_arr['final_price'],true)?></span></td>
                    </tr>
                    <tr>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="gtable">
                        ...
                        ?>	
                        <tr>
                        <td class="tdbgry" colspan="2"><?php echo stripslash_normal($Captions_arr['CART']['CART_DELIVERY_LOC'])?>
                        <a name="a_deliv">&nbsp;</a> </td>
                        </tr>
                        <tr>
                        <td class="tdbgry">&nbsp;</td>
                        ...
                        ?>
                        <tr>
                        <td colspan="2" class="tdbgry"><?php echo stripslash_normal($Captions_arr['CART']['CART_DELIVERY_OPT'])?>
                        </td>
                        </tr>
                        <tr>
                        <td class="tdbgry">&nbsp;</td>
                    ...
                    if ($db->num_rows($ret_paytypes))
                    {
                    	...
                    	else
						{
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class="gtable">
                                <tr>
                                    <td class="td"><a name="a_pay">&nbsp;</a><?php echo stripslash_normal($Captions_arr['CART']['CART_SEL_PAYTYPE'])?>
                                    <?php
                    ...
                    if (count($cartData['products'])>0)
                    {
                    $HTML_bottomdesc .= "<table width='100%' border='0' cellspacing='0' cellpadding='0' class='ftable'>
                    <tr>
                    ...
                    if($show_checkoutbutton==true)	
                    {
                    $HTML_bottomdesc .= '<div class="cart_shop_chkout"><div> <a href="#" onClick="handle_checkout_submit(\''.$ecom_hostname.'\',0,\''.$cartData["totals"]["bonus_price"].'\')"><input name="'.stripslash_normal($Captions_arr['CART']['CART_GO_CHKOUT']).'" type="button" value="'.stripslash_normal($Captions_arr['CART']['CART_GO_CHKOUT']).'"  class="byellow"/></a></div></div>';
                    }
                    else
                    {
                    ...
                    <tr>
                    <td class='td' align='center'>";
                    $HTML_bottomdesc .= '<div class="cart_shop_cont"><div><a href="#" onClick="show_wait_button(this,\'Please Wait...\');window.location=\''.$ps_url.'\'"><input name="'.stripslash_normal($Captions_arr['CART']['CART_GO_CHKOUT']).'" type="button" value="'.stripslash_normal($Captions_arr['CART']['CART_CONT_SHOP']).'"  class="byellow"/></a></div></div>';
                    $HTML_bottomdesc .='</td>
                    </tr>
                    </table>';
                    }
                                                  ...
                                                  <tr><td align="left" valign="middle" class="td" colspan="2">
													...
													<tr>
                                                       <td align="left" valign="middle" class="td" colspan="2">
														<select name="checkout_account_same" onchange="handle_billingaddress_change(document.frm_checkout)" class="yselect">
									...
									?>	
														    ...
														    $sql_checkout = "SELECT field_det_id,field_key,field_name,field_req,field_error_msg   
                                                                        ...
                                                                        {						
                                                                            ...
                                                                            {		
                                                                                ...
                                                                                ?>
                                                                                <input type="hidden" name="<?php echo $row_checkout['field_key']; ?>" value="<?php echo $field_name_get; ?>" />
                                                                            <?php
                                                                            }
                                                                        }
									 ...
									 // check whether billing and shipping address can be different in the site.
                                                  ...
                                                  <tr><td align="left" valign="middle" class="td" colspan="2">
													...
													<tr>
                                                       <td align="left" valign="middle" class="td" colspan="2">
														<select name="checkout_billing_same" onchange="handle_deliveryaddress_change(document.frm_checkout)" class="yselect" >
                                        ...
                                        <td colspan="2" class="td">
                                                ...
                                                ?>
                                                 <tr>
                                                    ...
                                                    <td  align="left" valign="middle" class="td">: <span class="black"><?php echo $cartData["totals"]["bonus"]?></span></td>
                                                  </tr>
                                                <?php	
                                                }
                                                // show the total final price
                                                ...
                                                <tr>
                                                <td  align="right" valign="middle" class="td"><?php echo stripslash_normal($Captions_arr['CART']['CART_TOTAL_FINAL_COST'])?>&nbsp; </td>
                                                <td align="right" valign="middle" class="td"><span class="black"><?php echo print_price($cartData["totals"]["bonus_price"],true)?></span></td>
                                                </tr>
                                                <tr>
                                                ...
                                                ?>
                                                <div class="chk_paymnt_btn"><div> <input name="continue_checkout" type="submit" class="byellow" id="continue_checkout" value="<?php echo $checkout_caption?>"/></div></div>
                                                <?php
                                                }
                                                else
                                                {
		...
		else
		{
			echo "&nbsp;&nbsp;".$row_orddet["order_qty"];
														...
														?>	</td>
			<td class="tdbgry"><span class="fbig"><?php echo print_price($row_orddet['order_rowtotal'],true)?><span></span></span></td>
		  </tr>
		<?php
		}
		?>	
