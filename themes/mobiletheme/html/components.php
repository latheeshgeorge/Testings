			...
			switch($position)
			{
				...
				if ($cache_exists==false)
				{
					...
					if ($position == 'bottom') // Case if value of position is bottom;
					{
						...
						?>
						  <tr>
                             <td align="left" valign="top" class="main_mid">
		...
		function mod_quicksearch($title)
		{
			...
			?>
                   ...
                   <input type="hidden" name="rdo_suboption" id="rdo_suboption" value='title_desc'/>
                    ...
                    <tr>
                    <td class="curve_top" ><label>
                    <input name="quick_search" type="text" class="input" id="quick_search"  value="<?php echo $_REQUEST['quick_search']?>"/>
                    </label></td>
                    <td class="td" >
                    <input class="bblack" name="button_submit_search" type="submit" src="<?php url_site_image('search-btn.gif')?>"  />
                    </td>
                    </tr>
                    ...
                    <tr>
                    <td colspan="2" class="curve_bottom" ><label>
                      ...
                      <input type="hidden" name="rdo_mainoption" value="prod" id="rdo_mainoption" />
                       <?php /* ?><input type="hidden" name="quick_search" value="<?php echo $_REQUEST['quick_search'];?>" id="quick_search" />
                       <?php */ ?>
                      <?php 
                      /*
                      <input type="submit" name="button" id="button" value="Submit" class="bblue" />
                      * <?php */ ?>
                    </label></td>
                    </tr>
                    <!--<input type="hidden" name="search_src" id="search_src" value='advanced'/>
		...
		function mod_customerlogin($title)
		{
			...
			if (!$cust_id) // case customer is not logged in
			{
				...
				?>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="btable">
                                <tr>
                                	<td class="td" ><span class="black">My Account</span></td>
                                	<td class="td" ><a href="<?php url_link('custlogin.html')?>"><input type="button" name="button3" id="button3" value="<?php echo $Captions_arr['CUST_LOGIN']['MOBLOGIN']?>"  class="bred"/></a></td>
                                </tr>
                                <tr>
                              	  	<td colspan="2" class="td"><?php echo $Captions_arr['CUST_LOGIN']['LOGIN_MOBMESS']?></td>
                                </tr>
                            </table>
				<?
				}
			...
			?>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="btable">
                                <tr>
                                	<td class="td" ><span class="black">My Account</span></td>
                                	<td class="td" ><a href="<?php url_link('logout.html')?>"><input type="button" name="button3" id="button3" value="<?=stripslash_normal($Captions_arr['LOGIN_MENU']['LOGOUT'])?>"  class="bred"/></a></td>
                                </tr>
                            </table>
            <?php
			}
