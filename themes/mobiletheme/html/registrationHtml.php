...
?>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="btable">
      <tr>
        <td class="td" ><span class="black"><?php echo stripslash_normal($Captions_arr['CART']['CART_LOGIN'])?></td>
        </tr>
      <tr>
      ...
      <tr>
        <td class="td"><a href="<?php url_link('registration.html')?>">New to bShop4? Please register online at www.bshop4.co.uk</a></td>
      </tr>
    </table>
		  </form>
		<?php	
		...
		?>
			...
			<div class="inner_clr1_middle">
				...
				<tr>
				<td  align="left" valign="middle" class="regiconent"><?=stripslash_normal($Captions_arr['FORGOT_PASSWORD']['FORGOT_PWD_LABEL'])?></td>
				</tr>
				<tr>
				<td colspan="2" align="left" valign="middle" class="regiconent"><input name="forgotpwd_email" type="text" class="regiinput" id="forgotpwd_email" size="25" value=""  /></td>
				</tr>
				<tr>
