		...
		if ($db->num_rows($ret_search))
		{
			...
			case '3row': 
				...
				echo $HTML_treemenu;
					...
					?>
                            <table width="100%" border="0" class="htable">
                            <tr><td class="ttcnt" colspan="2">
                            <?php 
                           		 if($paging['total_cnt'])
								echo $HTML_totcnt = '<div class="subcat_nav_pdt_no"><span>'.$paging['total_cnt'].'</span></div>';
								?>
                            </td></tr>
                            <tr>
                                <td align="right"><?php echo stripslash_normal($Captions_arr['SEARCH']['SEARCH_SORT'])."&nbsp;";
                                ...
                                echo generateselectbox('searchprod_sortbytop',$selval_arr,$prodsort_by,'','',0,'',false,'searchprod_sortbytop');
                            ...
                            <tr>
                                ...
                                &nbsp;<input type="button" name="submit_Page" value="<?php echo stripslash_normal($Captions_arr['SEARCH']['SEARCH_GO'])?>" class="nav_button" onclick="handle_searchdropdownval_sel('<?php echo $ecom_hostname;?>','searchprod_sortbytop','searchprod_sortordertop','searchprod_prodperpagetop',<?php echo $search_category_id; ?>)" />
