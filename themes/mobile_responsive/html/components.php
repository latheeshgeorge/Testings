		...
		function mod_staticgroup($grp_array,$title)
		{
			...
			switch($position)
			{
				...
				{				
					...
					if ($position == 'mobiletop') // Case if value of position is bottom;
					{ 
						if(count($grp_array))
						{
						?>
                                    ...
                                    $target = ($row_pg['page_link_newwindow']==1 and $row_pg['page_type']!='Page')?'target="_blank"':'';
										...
										?>	
											...
											<ul class="nav collapse" role="menu" aria-labelledby="allprobbtn-1" style="display:none" id="allpropsubmenu1">
												...
												<li><a class="fa fa-caret-right" href="http://www.unipad.co.uk/couples-pads-pg50459.html"> Couples Pads</a></li>
												...
												<li><a class="fa fa-caret-right" href="http://www.unipad.co.uk/7-bed-pads-pg50266.html"> 7 Bed Pads</a></li>
                                    ...
                                    ?>
                                     <li>
										<a href="https://m.facebook.com/unipadlancaster"><img src="<?php url_site_image('facebook.png')?>" width="173" height="21" alt="findus"></a>
									</li>
									<?php /*
									 <li>
						...
						<nav class="navbar navbar-default">
						  <div class="container-fluid">
							...
							<ul class="nav navbar-nav">      
                                    ...
                                    {
                                        ?>
                                       <li class="active"> <a href="<?php url_link('')?>" class="bottombandstatic" title="<?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?>"><?php echo stripslash_normal($Captions_arr['STATIC_PAGES']['STAT_HOME'])?></a></li>
			...
			?>
			 <form method="post" name="frm_quicksearch" class="frm_cls" action="<?php url_link('search.html')?>">
                   ...
                   <input type="hidden" name="rdo_suboption" id="rdo_suboption" value='title_desc'/>
						...
						<?php /*<a href="#" class="link_top_a" onclick="gobackto_cart('<?php echo ($protectedUrl)?base64_encode($ecom_hostname):$ecom_hostname?>')"  title="<?php echo stripslash_normal($Captions_arr['COMMON']['VIEW_CART'])?>">View Cart</a>
						...
						*/ ?>
						...
						<tr>
						<td  class="td_D" ><label>
							<input name="quick_search" type="text" class="input_s" id="quick_search"  value="SEARCH PUREGUSTO" onFocus="if (this.value=='SEARCH PUREGUSTO') this.value='';" onBlur="if (this.value=='') this.value='SEARCH PUREGUSTO';"/>					
						</label></td>
                  ...
                  <input type="hidden" name="cbo_keyword_look_option" value="any_word" id="cbo_keyword_look_option" />
		...
		function mod_newsletter($title)
		{
			...
			if($position=='bottomband')
			{
					...
					<form name="frm_newsletter" method="post" action="" class="frm_cls" onsubmit="return newsletter_validation(this)">
							            ...
							            <label for="inputEmail"><?=stripslash_normal($Captions_arr['NEWS_LETTER']['NEWSCUSTOMER_DETAILS_HEADER'])?></label>

							<input name="newsletter_email" type="text" class="newsletter_input_in form-control" id="newsletter_email" value="Enter Email" onblur="if(document.frm_newsletter.newsletter_email.value=='') {document.frm_newsletter.newsletter_email.value='Enter Email'}" onclick="if(document.frm_newsletter.newsletter_email.value=='Enter Email'){javascript:document.frm_newsletter.newsletter_email.value=''}"  />
							        </div>
						  ...
						  <?php 
							...
							{
							?>
							<img class="img_verify" src="<?php url_verification_image('includes/vimg.php?size=4&pass_vname=newsletter_Vimg&amp;bg=221 214 196')?>" border="0" alt="Image Verification"/>
							<?php 
								// showing the textbox to enter the image verification code
								$vImage->showCodBox(1,'newsletter_Vimg','class="img_input form-control" value="Enter The verification code" onblur="if(document.frm_newsletter.newsletter_Vimg.value==\'\') {document.frm_newsletter.newsletter_Vimg.value=\'Enter The verification code\'}" onclick="javascript:document.frm_newsletter.newsletter_Vimg.value=\'\'"'); 
							?>
							<?php
							}
							?>
							<input name="newsletter_Submit" type="submit" value="GO" type="submit" class="btn btn-default to-log-in" />
					</form>
					  </div>
             <?php
			}
