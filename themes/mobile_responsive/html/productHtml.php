		...
		function Show_ProductDetails($row_prod)
		{
	        ...
	        */
			...
			<div class="row"><a href="#" class="product-title"> <?PHP echo stripslash_normal($row_prod['product_name']);?></a></div>
				...
				<?php /*<div class="sp-loading"><img src="<?php url_site_image('sp-loading.gif')?>" alt=""></div> */?>
		 <div id="mainimage_holder" class="normal_img">
		 <div class="newicons_container_outer">
							
							<?php
								//print_r($row_prod);
								$sql_sttk = "SELECT product_actualstock FROM products WHERE product_id = ".$row_prod['product_id']." LIMIT 1";
								$ret_sttr = $db->query($sql_sttk);
								if($db->num_rows($ret_sttr))
								{
									$row_sttr = $db->fetch_array($ret_sttr);
									$row_prod['product_actualstock'] = $row_sttr['product_actualstock'];
			...
			/*if($row_pp['product_actualstock']>0)
				...
				$availability_msg = '<span class="green_availableP">'.$Captions_arr['COMMON']['PRODDET_AVAIL_2_YEAR'].'</span>';
			echo $availability_msg;	*/		                      
...
<div class="clearfix"></div>
				...
				$this->show_buttons_new($row_prod);
...
if ($row_prod['product_show_enquirelink']==1)
			{
				$HTML_enquiry = '<li>
					...
					<span class="glyphicon-class"><a href="javascript:void()" onclick="document.frm_proddetails.fpurpose.value=\'Prod_Enquire\';document.frm_proddetails.submit();" class="link_viewp">Arrange to View</a></span>
				</li>';			
			}
//echo $HTML_enquiry;
if($email_show==1)
{
	$HTML_email = '<li>
					...
					<span class="glyphicon-class"><a href="'.url_link('emailafriend'.$_REQUEST['product_id'].'.html',1).'" title="'.stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_EMAILFRIEND']).'" class="link_viewp"> Send to Friend</a></span>
				</li>';
}	
echo $HTML_email;
	$HTML_callback = '<li>
					<span class="glyphicon glyphicon-earphone"></span>
					<span class="glyphicon-class"><a href="http://'.$ecom_hostname.'/callback.html" onclick="req_callback(this)" title="Request A Call Back" class="link_viewp"> Request A Call Back</a></span>
				</li>';
		echo $HTML_callback1;
...
echo $HTML_faq1;
$HTML_facebook1 = '<li class=\'fb_call\'><a href="https://www.facebook.com/messages/unipadlancaster" target="_blank"><img src='.url_site_image('floating_img.png',1).' border="0" alt="Speak With Unipad on Facebook Messenger"></a></li>';
 $HTML_facebook = '<li>
					<span class="fa fa-facebook"></span>
					<span class="glyphicon-class"><a href="https://www.facebook.com/messages/unipadlancaster" title="Speak With Unipad on Facebook Messenger" class="link_viewp"> <span style="padding-top:3px">&nbsp;Facebook Messenger</span></a></span>
				</li>';

echo $HTML_facebook;
$phone_number = '<li>
					<span class="glyphicon glyphicon-phone-alt"></span>
					<span class="glyphicon-class"><a href="tel:+44 07872 377266" class="link_viewp">Call Us</a></span>
				</li>';
echo $phone_number;		
/*		
...
?>
				...
				<ul class="phone-number"><li>
					<span class="glyphicon glyphicon-phone-alt"></span>
					<span><a href="tel:+44 1524 888880" class="link_viewp">+44 1524 888880</a></span>
				</li></ul>
				*/
				?> 
				</div>
	...
	global $db,$ecom_siteid,$ecom_hostname,$ecom_themename;	
	  ...
	  if ($_REQUEST['prod_curtab'] and $row_prod['product_variablecombocommon_image_allowed']=='N')
	  {
		...
		if(count($tabimg_arr))
		{
			...
			?><ul id="Gallery">
				<li>
			<a href="<?php url_root_image($tabimg_arr[0]['image_bigpath'])?>" title="<?php echo $row_prod['product_name']?>"  >
			<?php
		...
		if ($show_normalimage)
		{
			...
			if(count($prodimg_arr))
			{
				...
				<ul id="Gallery">
				<li>
				<a href="<?php url_root_image($prodimg_arr[0]['image_bigpath'])?>"  title="<?=$row_prod['product_name']?>">
				<?php
...
function show_more_images1($row_prod,$exclude_tabid,$exclude_prodid,$return_count = false)
{
	global $db,$ecom_hostname,$ecom_themename;
	?>
	<?php
...
function show_buttons_new($row_prod)
{
	...
	?>	
		<div class="deat_pdt_buyB">
		<div class="deat_pdt_buyBinner_book">
<div class="buyBinner_link"><a href="#" class="btn btn-default add-to-cart" onClick="show_wait_button(this,'Please Wait...');document.frm_proddetails.fpurpose.value='Prod_Enquire';document.frm_proddetails.submit();"><i class="fa"></i>Arrange A Viewing</a></div>
</div>
</div>
<?php
	}	
...
<ul class=\"featurelist\">";
							...
							$ret_val	.= "<li><img src=".url_site_image($label_image,1)." alt=\"".$row_labels['label_name']."\"/>
