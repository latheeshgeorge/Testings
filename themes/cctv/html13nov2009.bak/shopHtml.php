<?php
	...
	class shop_Html
	{
		...
		<div class="pro_det_treemenu">
		  <ul>
			<li><?php echo generate_shop_tree($row_shop['shopbrand_name']);?></li>
		  </ul>
		</div>
		</div>
		...
		?>
				...
				<?php	
					...
					{
				?>
						<td width="33%" align="center" valign="middle" class="subshopimage" onmouseover="this.className='subshop_hover'" onmouseout="this.className='subshopimage'">
