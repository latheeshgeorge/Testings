<?php
	...
	function show_combo_product_details($row_prod,$keepselected=false)
	{
		...
		?>
			...
			<td class="mid_shelfB_top_mid"><a href="<?php url_product($row_prod['product_id'],stripslashes($row_prod['product_name']),-1)?>" title="<?php echo stripslashes($row_prod['product_name'])?>" class="prod_infolink"><?php echo stripslashes($row_prod['product_name'])?></a></td>
		...
		<?php
			$frm_name = uniqid('combo_');
		?>	
			
			<div class="infodiv">
				<div class="infodivleft">	
				<?php /*?><input type="hidden" class="quainput" name="qty_<?=$row_prod['product_id']?>"  value="1" /><?php */?>
