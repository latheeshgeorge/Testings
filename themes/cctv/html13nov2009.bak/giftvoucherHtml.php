								...
								$prod_compare_enabled 	= isProductCompareEnabled();
									...
									?>
										...
										<tr>
												...
												<ul class="shelfBul">
												<li class="shelfBstrikeprice">
												<?php echo $Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_RETAIL_PRICE']?> 
												<?php 
												echo print_price($row_prod['product_webprice']);
												?>
												</li>                   
												<li class="shelfBnormalprice">
												<?php echo $Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_PROM_PRICE']?>
												<?php 
												echo print_price($row_prod['product_price']);
												?>
												</li> 
												<?php
												$diff = ($row_prod['product_webprice']-$row_prod['product_price']);
												if($diff>0)
												{
												?>
												<li class="shelfByousaveprice">
												<?php echo $Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_YOUSAVE_PRICE']?> <?php echo print_price($diff);?>
												</li>
												<?php
												}
												?>
										...
										?>
											...
											while($row_prod = $db->fetch_array($ret_prod))
											{
												...
												<tr>
													...
													<?php $frm_name = uniqid('giftvouch_'); ?>
