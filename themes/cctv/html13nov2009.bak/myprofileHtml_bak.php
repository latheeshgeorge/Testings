...
function validate_allforms(form){
	...
	if(topfrm){
		...
		<tr>
			...
			<td align="left" valign="middle"><input name="customer_fname" type="text" class="regiinput" id="customer_fname" size="15" value="<?=$row_customer['customer_fname']?>" /></td>
		</tr>
		<tr>
			<td align="left" valign="middle" class="regiconent"><?=$Captions_arr['CUST_REG']['CUSTOMER_MNAME']?></td>
			<td align="left" valign="middle">
		<input name="customer_mname" type="text" class="regiinput" id="customer_mname" size="15" value="<?=$row_customer['customer_mname']?>"  />   </td>
		</tr>
		<tr>
			<td align="left" valign="middle" class="regiconent"><?=$Captions_arr['CUST_REG']['CUSTOMER_SURNAME']?> </td>
			<td align="left" valign="middle"><input name="customer_surname" type="text" class="regiinput" id="customer_surname" size="15" value="<?=$row_customer['customer_surname']?>"  /></td>
		</tr>
		<tr>
			<td align="left" valign="middle" class="regiconent"><?=$Captions_arr['CUST_REG']['CUSTOMER_POSITION']?></td>
			<td align="left" valign="middle"><input name="customer_position" type="text" class="regiinput" id="customer_position" size="15" value="<?=$row_customer['customer_position']?>"  /></td>
		</tr>
			...
			<td colspan="2">
				<table width="100%" border="0" cellpadding="0" cellspacing="6" >
					...
					<tr>
					  ...
					  <td width="60%" align="left" valign="middle"><input name="customer_compname" type="text" class="regiinput" id="customer_compname" size="15" value="<?=$row_customer['customer_compname']?>"  /></td>
					</tr>
					...
					<tr>
						...
						<td align="left" valign="middle"><input name="customer_compregno" type="text" class="regiinput" id="customer_compregno" size="15" value="<?=$row_customer['customer_compregno']?>"  /></td>
					</tr>
					<tr>
						<td align="left" valign="middle" class="regiconent"><?=$Captions_arr['CUST_REG']['CUSTOMER_COMP_VATREGNO']?></td>
						<td align="left" valign="middle"><input name="customer_compvatregno" type="text" class="regiinput" id="customer_compvatregno" size="15" value="<?=$row_customer['customer_compvatregno']?>"/></td>
					</tr>
				</table>
			</td> 
		</tr>
		<tr>
			...
			<td align="left" valign="middle"><input name="customer_buildingname" type="text" class="regiinput" id="customer_buildingname" size="15" value="<?=$row_customer['customer_buildingname']?>" /></td>
		</tr>
		<tr>
			<td align="left" valign="middle" class="regiconent"><?=$Captions_arr['CUST_REG']['CUSTOMER_STREET_NAME']?></td>
			<td align="left" valign="middle"><input name="customer_streetname" type="text" class="regiinput" id="customer_streetname" size="15" value="<?=$row_customer['customer_streetname']?>" /></td>
		</tr>
		<tr>
			<td align="left" valign="middle" class="regiconent"><?=$Captions_arr['CUST_REG']['CUSTOMER_TOWN_CITY']?></td>
			<td align="left" valign="middle"><input name="customer_towncity" type="text" class="regiinput" id="customer_towncity" size="15" value="<?=$row_customer['customer_towncity']?>" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td align="left" valign="middle">
		<?php 		
		$state_arr = array(-1=>'-- Select State --');
		if($row_customer['country_id'])
						{
							$sql_state = "SELECT *
											 FROM 
											 	general_settings_site_state 
											WHERE 
												general_settings_site_country_country_id=".$row_customer['country_id']."
												AND sites_site_id=$ecom_siteid AND state_hide=0";
							$ret_state = $db->query($sql_state);
							if ($db->num_rows($ret_state))
							{
								while($row_state = $db->fetch_array($ret_state))
					  	...
					  	echo generateselectbox('cbo_state',$state_arr,$row_customer['customer_statecounty']);?></td>
		</tr>
		<tr>
			<td align="left" valign="middle" class="regiconent"><?=$Captions_arr['CUST_REG']['CUSTOMER_PHONE']?><span class="redtext">*</span></td>
			<td align="left" valign="middle"><input name="customer_phone" type="text" class="regiinput" id="customer_phone" size="15" value="<?=$row_customer['customer_phone']?>" /></td>
		</tr>
		<tr>
			<td align="left" valign="middle" class="regiconent"><?=$Captions_arr['CUST_REG']['CUSTOMER_FAX']?></td>
			<td align="left" valign="middle"><input name="customer_fax" type="text" class="regiinput" id="customer_fax" size="15" value="<?=$row_customer['customer_fax']?>" /></td>
		</tr>
		<tr>
			<td align="left" valign="middle" class="regiconent"><?=$Captions_arr['CUST_REG']['CUSTOMER_POSTCODE']?></td>
			<td align="left" valign="middle"><input name="customer_postcode" type="text" class="regiinput" id="customer_postcode" size="15" value="<?=$row_customer['customer_postcode']?>" /></td>
		</tr>
		
		<tr>
			<td align="left" valign="middle" class="regiconent"><?=$Captions_arr['CUST_REG']['CUSTOMER_EMAIL']?><span class="redtext">*</span></td>
			<td align="left" valign="middle"><input name="customer_email" type="text" class="regiinput" id="customer_email" size="15" value="<?=$row_customer['customer_email_7503']?>" /></td>
		</tr>
		<tr>
		...
		echo $sql_customer_grp = "SELECT cg.custgroup_id,cg.custgroup_name ,cgm.custgroup_id as selected_grp
								FROM 
									customer_newsletter_group cg left join customer_newsletter_group_customers_map cgm on(cgm.custgroup_id=cg.custgroup_id)
									AND cgm.customer_id=$customer_id 
								WHERE 
									cg.custgroup_active = 1 AND cg.sites_site_id=".$ecom_siteid;
		$ret_customer_grp = $db->query($sql_customer_grp);
		if($db->num_rows($ret_customer_grp)){
		?>
		
		<tr>
			<td colspan="2" align="left" valign="top" class="regiconentred"><?=$Captions_arr['CUST_REG']['CUSTOMER_RECEIVE_NEWSLETTER_HEADER']?></td>
		</tr>
		<tr>
			...
			<table width="100%" border="0" cellspacing="4" cellpadding="0" class="regifontnormal">
					...
					?>
						<td   align="left" valign="middle" width="3%">
							...
							<input type="checkbox" name="newsletergroup[]" id="newsletergroup[]" value="<?=$customer_grp['custgroup_id']?>" <?=($customer_grp['custgroup_id']==$customer_grp['selected_grp'])?"checked":""?> />
