		  ...
		  <tr>
			...
			<?php
			  ...
			  <tr>
				...
				<td width="54%"><input name="custlogin_uname" id="custlogin_uname" type="text" class="inputA" size="35" /></td>
			  </tr>
			  <tr>
				<td align="right" valign="middle" class="regiconent"><?php echo $Captions_arr['CART']['CART_PASSWORD']?></td>
				<td><input name="custlogin_pass" id="custlogin_pass" type="password" class="inputA" size="35" /></td>
			  </tr>
			  <tr>
				<td>&nbsp;</td>
				<td> 
