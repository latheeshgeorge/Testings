	...
	<?php
							if(trim($search_desc)) {
									$top_content = $search_desc;
											...
											<? } 
										?>
				<div class="search_topcontent" align="left"><?php echo stripslashes($top_content)?></div>
										<div class="lst_nav">
     			   <ul>
					<li><?php echo $Captions_arr['SEARCH']['SEARCH_SORT']?>
					    ...
					    <li><?php echo $Captions_arr['SEARCH']['SEARCH_ITEMS'] ?>
					    ...
					    <li>
									   ...
									   <?php
										...
										{
										?>
											<div class="shelfAheader" align="left"><?php echo $cur_title?></div>
										<?php
										}
								  ...
								  switch($Settings_arr['search_prodlisting'])
									{
										 ...
										 // case of one in a row for normal
											...
											while ($row_search = $db->fetch_array($ret_search))
											{
												...
												<tr>
													...
													<td class="mid_shelfB_top_mid"><a href="<?php url_product($row_search['product_id'],$row_search['product_name'],-1)?>" title="<?php echo stripslashes($row_search['product_name'])?>" class="prod_infolink"><?php echo stripslashes($row_search['product_name'])?></a></td>
									 ...
									 <? 
									  ...
									  ?>
										...
										if ($tot_cnt>0 )if ($tot_cnt>0 and ($_REQUEST['req']!=''))
										{
									?>
									<div class="pagingcontainertd_outer" align="center">
												<div class="pagingcontainertd_lf" align="center">
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="0"  class="mid_shelfA_table">
										<tr>
											...
											<td class="mid_shelfA_top_mid"><a href="<?php url_product($row_search['product_id'],$row_search['product_name'],-1)?>" title="<?php echo stripslashes($row_search['product_name'])?>" class="prod_infolink"><?php echo stripslashes($row_search['product_name'])?></a></td>
								...
								<form method="post" action="<?php url_link('manage_products.html')?>" name='<?php echo $frm_name?>' id="<?php echo $frm_name?>" class="frm_cls" onsubmit="return product_enterkey(this,<?php echo $row_search['product_id']?>)">
										...
										<div class="infodivleft_shlfA"><?php show_moreinfo($row_search,'infolink')?></div>
										...
										<?php
											...
											?>
												<tr>
													...
													<div class="tree_bottom"></div></div></td>
												</tr>
											<?php
											}
											//$pass_type = 'image_iconpath';
										    $pass_type = get_default_imagetype('search_cat');
											$max_col = 3;
											$cur_col = 0;
											?>
											<tr>
											...
											while ($row_search = $db->fetch_array($ret_search))
											{
												...
												<td class="subcategoreyimage" onmouseover="this.className='subcategory_hover'" onmouseout="this.className='subcategoreyimage'" valign="middle" width="33%" align="center">
														  ...
														  ?>
															<a href="<?php url_category($row_search['category_id'],$row_search['category_name'],-1)?>" title="<?php echo stripslashes($row_search['category_name'])?>">
															 <?php
															  ...
															  ?>
														<a href="<?php url_category($row_search['category_id'],$row_search['category_name'],-1)?>" title="<?php echo stripslashes($row_search['category_name'])?>" class="subcategoreynamelink"><?php echo stripslashes($row_search['category_name'])?></a>
			...
			<div class="tree_top"></div>
				<div class="tree_middle">
					<div class="pro_det_treemenu">
						<ul>
						<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> &gt;&gt; </li>
						<li> <?php echo $Captions_arr['SEARCH']['SEARCH_ADVANCED_SEARCH'];?> </li>
						</ul>
					</div>
				</div>
			<div class="tree_bottom"></div>
