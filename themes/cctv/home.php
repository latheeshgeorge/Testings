...
//the below meta tag is added for the verification of the site WMT google verification so should not removed
?>
<meta name="google-site-verification" content="o6P_0h7dMi7TqlNVkw-fJebVbp0b2jiscyH9zd6UMts" />
<!-- Facebook Pixel Code -->
<script>
...
fbq('init', '1038463422978181'); 
fbq('track', 'PageView');
</script>
<noscript>
<img height="1" width="1" 
src="https://www.facebook.com/tr?id=1038463422978181&ev=PageView&noscript=1"/>
</noscript>
</head>
<body>
<center>
...
<table width="200" border="0" cellpadding="0" cellspacing="0" class="main">
...
?>
<tr>
  <td align="center" valign="top" class="mainmiddletd" >
...
?>
		...
		<script src="<?php echo $ecom_selfhttp ?>www.google-analytics.com/urchin.js" type="text/javascript">
		</script>
		<script type="text/javascript">
