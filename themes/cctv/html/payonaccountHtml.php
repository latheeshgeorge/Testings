            ...
            ?>
               <div class="tree_con">
				...
				<div class="tree_middle">
					...
					<li> <?php echo stripslash_normal($Captions_arr['PAYONACC']['PAYONACCOUNT_MAINHEADING'])?></li>
					</ul>
					</div>
				</div>
                    ...
                    if($db->num_rows($ret_cust))
                    {
                        ...
                        ?>
                                ...
                                <td align="center" colspan="2">
                                    ...
                                    <input type='submit' name='payonaccount_request_place' id ='payonaccount_request_place' value='<?php echo $Captions_arr['PAYONACC']['PAYONACC_PLACE_REQUEST']?>' class="cart_btn"/>
                                    </form>
                                </td>
                                </tr>
                        <?php
		  ...
		  function show_Summary($alert='')
		  {
			...
			<form name='frmpayonaccount_summary' action='<?php url_link('payonaccountpayment.html')?>' method="post">
				...
				<div class="tree_middle">
					...
					<ul>
					<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> </li>
					<li> <?php echo $Captions_arr['PAYONACC']['PAYONACCOUNT_MAINHEADING']?></li>
					</ul>
					</div>
				</div>
				<div class="tree_bottom"></div>
		  ...
		  ?>
		   ...
		   <div class="tree_con">
				...
				<div class="tree_middle">
					...
					<ul>
					<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> </li>
					<li> <a href="<? url_link('mypayonaccountpayment.html');?>"><?php echo $Captions_arr['PAYONACC']['PAYONACCOUNT_MAINHEADING']?></a> >> <?php echo $Captions_arr['PAYONACC']['VIEWBILLS_MAINHEADING']?></li>
					</ul>
					</div>
				</div>
				<div class="tree_bottom"></div>
			...
			else
			{
			  ...
			  $sql_comp 			= "SELECT customer_title,customer_fname,customer_mname,customer_surname,
					...
					<div class="tree_middle">
						...
						<ul>
						<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> </li>
						<li> <a href="<? url_link('mypayonaccountpayment.html');?>">  <?php echo $Captions_arr['PAYONACC']['PAYONACCOUNT_MAINHEADING']?></a> >> <a href="<? url_link('accountviewbills.html');?>">  <?php echo $Captions_arr['PAYONACC']['VIEWBILLS_MAINHEADING']?></a> >> <?php echo $Captions_arr['PAYONACC']['VIEWBILLS_STATEMENT_ON']?> <?php echo dateFormat($closing_date,'datetime');?></li>
						</ul>
						</div>
					</div>
					<div class="tree_bottom"></div>
  ...
  <td colspan="2">
	...
	?>	
		...
		<div class="tree_middle">
			...
			<ul>
			<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> </li>
			<li><?php echo $Captions_arr['PAYONACC']['PAYON_FAILED_TITLE']?></li>
			</ul>
			</div>
		</div>
		<div class="tree_bottom"></div>
		...
		*/
		...
		<div class="tree_middle">
			...
			switch($row_pay['pay_paymentmethod'])
			{
				...
				?>
				<li><a href="<? url_link('mypayonaccountpayment.html');?>"> <?=$Captions_arr['PAYONACC']['PAYONACCOUNT_MAINHEADING']?></a> >> <?=$Captions_arr['PAYONACC']['PAYON_BUY_TREEMENU_PREVIEWTITLE']?></li>
