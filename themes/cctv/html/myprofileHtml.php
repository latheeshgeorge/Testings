...
function mailinglist_mainsel()
{
	...
	if(atleast_one)
		...
		<tr>
			...
			<td width="56%" align="left" valign="middle"><select name="customer_accounttype" class="regiinput" id="customer_account_type" onchange="showAccountTypeDetails(this);" >
					...
					{	
						...
						?>
							 <tr>
								...
								<td width="56%" align="left" valign="middle" class="regi_txtfeild">
								<?php
			...
			<table width="100%" border="0" cellspacing="4" cellpadding="0" class="regifontnormal">
					...
					?>
						<td   align="left" valign="middle" width="3%">
							...
							<input type="checkbox" name="newsletergroup[]" id="newsletergroup[]" value="<?=$customer_grp['custgroup_id']?>" onchange="mailinglist_mainsel()" <? if(in_array($customer_grp['custgroup_id'],$arr_assigned)) echo "checked"; //($customer_grp['custgroup_id']==$customer_grp['selected_grp'])?"checked":""?> />						</td>
			...
			<option value="M/S." <?=($row_sql['customer_title']=='M/S.')?"selected":''?>>M/S.</option>
				    ...
				    <tr>
					    <td  colspan="4"  align="left" >
							<table width="100%" border="0" cellpadding="0" cellspacing="2" class="shoppingcarttable">
				      <tr>
					    <td  colspan="3"  align="left" >I give my permission for cctv to send me the following.Please tick 'Yes' or 'No' for each option.</td>
...
If you decide to change your preferences, you can do so at any time. Please just call our customer services team on 01748 811991 during office hours Monday to Friday and let us know what you want us to do. For example, you can call us to update your contact details or you can opt out from communications altogether. Alternatively, you can let us know your wishes by email: <strong><a href="mailto:sales@cctvfirst.co.uk">sales@cctvfirst.co.uk</a>.</strong></p>
<p><strong>Terms and Privacy:</strong></br>
Cctv will keep your contact details safe. We will not share them with any other person or organisation. We will only contact you by the channels you have chosen (phone, email etc.) and we will only contact you about the subjects you have chosen. You may unsubscribe at any time. For more details, please see our privacy policy and data protection to see how we use and protect your data. <br/>
For more details, please check our <a href="https://www.cctvfirst.co.uk/gdpr-pg50552.html" target="_blank"><strong>data protection</strong></a> to see how we use and protect your data. 
</p>
</td>
						</tr>
				   <tr>
