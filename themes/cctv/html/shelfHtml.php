						...
						if ($db->num_rows($ret_prod))
						{
						    ...
						    else
							{
							    if($shelfData['shelf_displaytype']=='3row')
								 $shelfData['shelf_displaytype']='2row';
							}		
							...
							{ 
								switch($shelfData['shelf_displaytype'])
								{
									...
									?>
											...
											<td align="left" valign="top" class="mid_spclA_prod_table_des">
												...
												<?php
													...
													if ($shelfData['shelf_showbonuspoints']==1)// Check whether description is to be displayed
													{
														show_bonus_points_msg($row_prod,'bonus_point'); // Show bonus points
													}
									...
									*/?> 
									...
									if($_REQUEST['req']=='')
									{
										$class_n = 'n_spcl_shlf_table_pdt_td_new';
									}
									else
									{
										$class_n = 'n_spcl_shlf_table_pdt_td';
									}
									?>
										<td class="<?php echo $class_n?>" valign="top">
										<table width="100%" border="0" cellspacing="0" cellpadding="0" class="n_spcl_shlf_table_pdt_table">
										<tr>
											<td class="mid_shelfA_christ">
											<?php
											if ($shelfData['shelf_showtitle']==1)// Check whether description is to be displayed
											{
											?>
