<?php
	...
	<div class="tree_middle">
		...
		<ul>
		<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> </li>
		<li> <a href="<?php url_link('myorders.html')?>"><?php echo $Captions_arr['ORDER']['ORDER_MAINHEADING']; ?></a> >> <?php echo $Captions_arr['ORDER']['ORDER_DETAILS']?></li>
		</ul>
		</div>
	</div>
	<div class="tree_bottom"></div>
...
<div class="tree_middle">
	...
	<ul>
	<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> </li>
	<li> <a href="index.php?req=orders"><?php echo $Captions_arr['ORDER']['ORDER_MAINHEADING']; ?></a> >> <a href="index.php?req=orders&reqtype=order_det&order_id=<?php echo $_REQUEST['order_id']?>"><?php echo $Captions_arr['ORDER']['ORDER_DETAILS']; ?></a>  >> <?php echo $Captions_arr['ORDER']['ORDER_ENQ_POSTS']; ?> </li>
	</ul>
	</div>
</div>
<div class="tree_bottom"></div>
