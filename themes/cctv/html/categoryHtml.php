												...
												<tr>
														...
														<td class="shelfB_cnts" valign="top">
															...
															<?php
																...
																?>
																<?php 
																if($cat_det['product_showshortdescription']==1)// whether description is to be displayed
																{
																	?>		 
							...
							case '2row': // case of three in a row for normal
									...
									<tr>
										...
										<tr>
											...
											<ul class="shelfAul">
											<?php
											if($cat_det['product_showimage']==1)// whether title is to be displayed
											{
											?>													
											<li class="shelfAimg">
										...
										<?php $frm_name = uniqid('catedetprod_'); ?>
