	...
	<div class="tree_con">
      ...
      <tr>
		...
		<div class="tree_con">
				...
				<li><?=stripslashes($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_TREEMENU_TITLE'])?></li>
				</ul>
				</div>
				</div>
				<div class="tree_bottom"></div>
		...
		function Show_Mypricepromise_requests()
		{
			...
			?>		
					...
					<ul>
					<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> &gt;&gt; </li>
					<li> <?php echo $Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_DETAILS_HEADER']?> </li>
					</ul>
					</div>
					</div>
					<div class="tree_bottom"></div>
					...
					<input type="hidden" name="search_click" value="search_click" />
							...
							<tr>
							<td  colspan="5" align="center" valign="middle" class="pagingcontainertdA"><?php
		...
		function Show_Mypricepromise_details($prom_id=0,$alert='')
		{
			...
			?>
				...
				<li><?php echo stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_DETAILS_HEADER_SUB'])?></li>
				</ul>
				</div>
				</div>
				<div class="tree_bottom"></div>
