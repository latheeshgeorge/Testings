...
?>
<tr>
  <td colspan="4" ><div id="sizechart_close_div2" class="sizechart_close" align="RIGHT"> <a href="javascript:window.close()" title="Click to Close"><img src="<?php url_site_image('sizechart_close.gif')?>" width="22" height="22"></a></div></td>
</tr>
</tbody></table>
</body>
</html>
