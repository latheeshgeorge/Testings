            ...
            <td class="det_table_name" colspan="2">
              ...
              <tr>
                <td class="td">
					...
					{
					?>	
					<div class="details_offer"><img src="<?php url_site_image('sss.png')?>" style="width:auto"  /></div>
					<?php				
					}
					?>
	  ...
	  if ($_REQUEST['prod_curtab'] and $row_prod['product_variablecombocommon_image_allowed']=='N')
	  {
		...
		if ($show_normalimage)
		{
			...
			if(count($prodimg_arr))
			{
				...
				<?php
				show_image_mobile(url_root_image($prodimg_arr[0][$pass_type],1),$row_prod['product_name'],$row_prod['product_name'],'','',0,'');
				?>
				</a>
				</li></ul>
				<?php
