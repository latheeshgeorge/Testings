<?php
	...
	if ($from_date or $to_date)
	{
		...
		//print_r($ord_array );
		  ...
		  <table width="100%" border="0" cellpadding="3" cellspacing="0" >
              ...
              <tr>
                <td colspan="7" align="center" valign="middle" class="pagingcontainertdA" ><?php 
														$path = '';
														$query_string .= "";
			  ...
			  <tr>
                <td colspan="7" align="left" valign="middle" class="pagingcontainertdA" ><img src="<?php url_site_image('new_post.gif')?>"   border="0" title="New" />
	...
	<?php
	 ...
	 ?>
		   ...
		   ?>
		   <tr>
		        <td align="center" valign="middle" class="pagingcontainertdA" colspan="12" >
				<?php 
					$path = '';
					$query_string .= "";
					paging_footer($path,$query_string,$tot_cnt,$start_var['pg'],$start_var['pages'],'',$pg_variable,'Orders',$pageclass_arr); 	
...
<tr><td  width="100%" colspan="4">
  <table width="100%" border="0" cellpadding="1" cellspacing="1" id="enqDetails" <?PHP if(!$_REQUEST['ord_pg']) { ?> style="display:none;" <? } ?> >
	...
	?> 
	  <tr>
	      <td colspan="5" class="pagingcontainertdA" align="center"> 
		  <?php 
		     $path = '';
		     $query_string .= "";
