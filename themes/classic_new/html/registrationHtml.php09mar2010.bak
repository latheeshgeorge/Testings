...
<div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?=$Captions_arr['CUST_REG']['REGISTRATION_TREEMENU_TITLE']?></div>
		...
		<?php 		///$state_arr = array(0=>'-- Select State --',-1=>$Captions_arr['CUST_REG']['OTHER_STATE']);
					  	///echo generateselectbox('cbo_state',$state_arr,0);?>
		...
		<td colspan="2" valign="top" align="left">
			<table width="100%" border="0" cellspacing="4" cellpadding="0" class="regifontnormal_newsletter">
					...
					<?=$Captions_arr['CUST_REG']['REQUEST_NEWS_RECEIVE_NEWPROD'] //RECEIVING_NEWSLETTER?></b></td>  
		...
		else // case if newsletter groups does not exists
		{
		?>
			<tr>
			<td align="left" valign="top" class="" colspan="2">
      ...
      <tr>
       ...
       <div class="inner_contnt" >
        ...
        <div class="lgn_msg_middle">
         <?php echo stripslash_normal($Captions_arr['CUST_LOGIN']['TOP_MSG'])?>
        </div>
          ...
          <table class="regifontnormal" width="100%" border="0" cellpadding="0" cellspacing="4">
            <tbody>
              ...
              <tr>
				...
				?>
				<div class="lgn_btn">
				<a href="javascript:document.frm_custlogin.submit()"><img src="<?php echo url_site_image('login-btn-new.gif')?>" border="0" /></a>
				</div></td>
              </tr>
            </tbody>
          </table>
