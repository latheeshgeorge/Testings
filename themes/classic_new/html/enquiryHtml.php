	  ...
	  function enquiry_Showform()
	  {
			...
			<tr>
			 ...
			 <tr>
			   ...
			   <?php
				 ...
				 ?>	
          <tr>
            <td align="left" valign="middle" class="shoppingcartheaderA" width="44%" ><?php echo $Captions_arr['ENQUIRE']['ENQUIRE_ITEM']?></td>
            <td align="center" valign="middle" class="shoppingcartheaderA" width="19%"><?php echo $Captions_arr['ENQUIRE']['ENQUIRE_PRICE']?></td>
            <td align="right" valign="middle" class="shoppingcartheaderA" width="10%"><?php echo $Captions_arr['ENQUIRE']['ENQUIRE_NOTE']?></td>
		    <td align="right" valign="middle" class="shoppingcartheaderA" width="10%"><?php echo $Captions_arr['ENQUIRE']['ENQUIRE_ACTION']?></td>
		  </tr>
		  <?php
		if($db->num_rows($ret_select_enq))
		{  
		while($row_select_enq = $db->fetch_array($ret_select_enq))
		{
		 ...
		 $prod_sql_det = "SELECT product_id,product_name,product_default_category_id,product_webprice,
		  ...
		  ?>
			  <tr>
				<td align="left" valign="middle" class="<?=$trmainclass?>" width="44%" >
				<?php 
				...
				<td align="center" valign="middle" class="<?=$tdpriceBclass?>"  width="19%">
				<?php 
					...
					?></td>
				<td align="right" valign="middle" class="<?=$tdpriceAclass?>" width="10%"><img src="<?php url_site_image('enquire_note.gif')?>" onclick="add_Enquire_notes(frm_enquire,'<?=$row_select_enq['enquiry_id']?>')" alt="Add Notes" title="Add Notes" /></td>
			    <td align="right" valign="middle" class="<?=$tdpriceAclass?>" width="10%"><img src="<?php url_site_image('delete.gif')?>" onclick="if(confirm_message('Are you sure you want to Delete this Enquiry?')){document.frm_enquire.enq_mod.value='delete_enquiry';document.frm_enquire.enquiry_id.value='<?=$row_select_enq['enquiry_id']?>';document.frm_enquire.submit();}" alt="Delete" title="Delete" /></td>
			  </tr>
