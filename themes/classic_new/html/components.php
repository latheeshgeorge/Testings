	...
	class components
	{
						...
						if(count($grp_array))
						{
							...
							foreach ($grp_array as $k=>$grpData)
							{
								...
								$cnt = $db->num_rows($ret_pg);
									...
									{
					?>		
										<li><span> <a href="<?php url_link('help.html')?>" class="static" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_HELP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_HELP']?></a></span></li>
					<?php
									}
									if ($grpData['group_showfaqlink']==1 )
									{
					?>		
										<li><span> <a href="<?php url_link('faq.html')?>" class="static" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_FAQ']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_FAQ']?></a></span></li>
					<?php
									}
									if ($grpData['group_showxmlsitemaplink']==1 )
									{
									?>
										<li><span> <a href="<?php url_link('sitemap.xml')?>" class="static" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP']?></a></span></li>
									<?php	
									}
									...
									{
					?>							
										<li><span> <a href="<?php url_link('sitemap.html')?>" class="static" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_SITEMAP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_SITEMAP']?></a></span></li>
					<?php		
									}
									if ($grpData['group_showsavedsearchlink']==1)
									{
					?>							
										<li><span> <a href="<?php url_link('saved-search.html')?>" class="static" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH']?></a></span></li>
					<?php		
									}
								...
								?>
										<li><span> <a href="<?php if ($row_pg['page_type']=='Page') url_static_page($row_pg['page_id'],str_replace('&','&amp;',$row_pg['title'])); else echo $row_pg['page_link'];?>" class="static" title="<?php echo stripslashes(str_replace('&','&amp;',$row_pg['title']))?>" <?php echo $target?>><?php echo stripslashes(str_replace('&','&amp;',$row_pg['title']));?></a></span></li>
								<?php
								}
						...
						?>
									<li><span> <a href="<?php url_link('')?>" class="static" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_HOME']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_HOME']?></a> </span></li>
						<?php
								}
								//$show_bottom=1;	
							}
					...
					if ($position == 'bottom') // Case if value of position is bottom;
					{
						...
						<?php
							...
							foreach ($grp_array as $k=>$grpData)
							{
								...
								if($show_top==0)
								{
									...
									{
						?>
										<li><span><a href="<?php url_link('')?>" class="bottomlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_HOME']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_HOME']?></a></span></li>
						<?php			
									}
										$show_top = 0;
								}	
								...
								while ($row_pg = $db->fetch_array($ret_pg))
								{
									$target = ($row_pg['page_link_newwindow']==1 and $row_pg['page_type']!='Page')?'target="_blank"':'';
								?>
										<li><span><a href="<?php if ($row_pg['page_type']=='Page') url_static_page($row_pg['page_id'],$row_pg['title']); else echo $row_pg['page_link'];?>" class="bottomlink" title="<?php echo stripslashes($row_pg['title'])?>" <?php echo $target?>><?php echo stripslashes($row_pg['title']);?></a></span></li>
								<?php
								}
							}
						?>
						<?php			
								//if($show_bottom==0)
								{
									...
									{
						?>
										<li><span><a href="<?php url_link('sitemap.html')?>" class="bottomlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_SITEMAP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_SITEMAP']?></a></span></li>
						<?php			
									}
									if ($grpData['group_showxmlsitemaplink']==1 )
									{			
									?>
										<li><span><a href="<?php url_link('sitemap.xml')?>" class="bottomlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP']?></a></span></li>
									<?php									
									}
									if ($grpData['group_showfaqlink']==1)
									{
						?>
										<li><span><a href="<?php url_link('faq.html')?>" class="bottomlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_FAQ']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_FAQ']?></a></span></li>
						<?php			
									}
									if ($grpData['group_showhelplink']==1)
									{
						?>
										<li><span><a href="<?php url_link('help.html')?>" class="bottomlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_HELP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_HELP']?></a></span></li>
						<?php			
									}
									if ($grpData['group_showsavedsearchlink']==1)
									{
						?>
										<li><span><a href="<?php url_link('saved-search.html')?>" class="bottomlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH']?></a></span></li>
						<?php			
									}
									//$show_bottom = 1;
								}	
							   ...
							   // if($show_top==0)
										{
											...
											{
									?>
												<li><span><a href="<?php url_link('')?>" class="staticleftlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_HOME']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_HOME']?></a></span></li>
									<?php		
											}
											//$show_top = 1;
										}	
								...
								?>
									...
									?>
										...
										<li><span><a href="<?php if ($row_pg['page_type']=='Page') url_static_page($row_pg['page_id'],$row_pg['title']); else echo $row_pg['page_link'];?>" class="staticleftlink" title="<?php echo stripslashes($row_pg['title'])?>" <?php echo $target?>><?php echo stripslashes($row_pg['title']);?></a></span></li>
								<?php
								}
								//if($show_bottom==0)
								{
									...
									{
							?>
										<li><span><a href="<?php url_link('sitemap.html')?>" class="staticleftlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_SITEMAP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_SITEMAP']?></a></span></li>
							<?php		
									}
									if ($grpData['group_showxmlsitemaplink']==1 )
									{	
							?>
										<li><span><a href="<?php url_link('sitemap.xml')?>" class="staticleftlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP']?></a></span></li>
							<?php		
									}
									if ($grpData['group_showhelplink']==1)
									{
							?>
										<li><span><a href="<?php url_link('help.html')?>" class="staticleftlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_HELP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_HELP']?></a></span></li>
							<?php		
									}
									if ($grpData['group_showsavedsearchlink']==1)
									{
						?>
										<li><span><a href="<?php url_link('saved-search.html')?>" class="staticleftlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH']?></a></span></li>
						<?php			
									}
									//$show_bottom = 1;
								}	
			...
			switch($position)
			{
				...
				if ($cache_exists==false)
				{
					...
					// ############## Top ##############
						...
						elseif ($position=='left' or $position=='right') // ############## Left or Right ##############
						{
							$prev_grp = 0;
							if(count($grp_array))
							{
								...
								$sql_cat = "SELECT a.category_id,a.category_name,parent_id,b.category_displaytype,b.category_islink,a.category_subcatlisttype   
									...
									if ($db->num_rows($ret_cat))
									{
										...
										<?php
											while ($row_cat = $db->fetch_array($ret_cat))
											{
												if($prev_grp != $grpData['catgroup_id'])
												{
													...
													{
											?>
														<li><div class="categoryheader"><?php echo stripslashes($title)?></div></li>
											<?php
													}
											...
											{
											?>
												 <li><span class="linklefthead"><a href="<?php url_category($row_cat['category_id'],$row_cat['category_name'],-1)?>" class="catelink" title="<?php echo stripslashes($row_cat['category_name'])?>"><?php echo stripslashes($row_cat['category_name']);?></a></span></li>
											<?php
											}
											elseif($row_cat['category_displaytype']=='Normal' && !$row_cat['category_islink'])
											{
											?>
												 <li><span class="linklefthead"><?php echo stripslashes($row_cat['category_name']);?></h1></li>
											<?											
											}
											elseif($row_cat['category_displaytype']=='Heading' && $row_cat['category_islink'])
											{
											?>
												 <li><span class="linklefthead"><span class="subcategoryheader"><a href="<?php url_category($row_cat['category_id'],$row_cat['category_name'],-1)?>" class="subcategoryheaderlink" title="<?php echo stripslashes($row_cat['category_name'])?>"><?php echo stripslashes($row_cat['category_name']);?></a></span></span></li>
											<?
											}
											elseif($row_cat['category_displaytype']=='Heading' && !$row_cat['category_islink'])
											{
											?>
												 <li><span class="linklefthead"><span class="subcategoryheader"><?php echo stripslashes($row_cat['category_name']);?></span></span></li>
											<?
											}
										...
										else
										{
											if ($grpData['catgroup_hidename']==0) // Decide whether or not to show the groupname
											{
												echo '<ul class="category"><span class="categoryheader">'.$title.'</span>';
											}
										?>
											<li><span class="linklefthead">
		...
		?>
				<tr>
					...
					<div class="topcart" align="right">
					<ul class="topcartlink">
					 <li class="cartitem"><?php echo $Captions_arr['COMMON']['CART_TOTAL']?> <?php echo $cart_tot?></li>
					 <li class="cartprice"><?php echo $Captions_arr['COMMON']['ITEMS_IN_CART']?><?php echo (get_session_var('cart_total_items')>0)?get_session_var('cart_total_items'):0;?></li>
					 <li>
					 <a href="#" onclick="handle_checkout_submit('<?php echo $ecom_hostname?>',0,'<?php echo $pass_tot?>')" class="check_out" title="<?php echo $Captions_arr['COMMON']['CHECK_OUT']?>"><?php echo $Captions_arr['COMMON']['CHECK_OUT']?></a>
					 </li>
					  <li>
					  <a href="#" onclick="gobackto_cart('<?php echo ($protectedUrl)?base64_encode($ecom_hostname):$ecom_hostname?>')" class="viewcart" title="<?php echo $Captions_arr['COMMON']['VIEW_CART']?>"><?php echo $Captions_arr['COMMON']['VIEW_CART']?></a>
					 </li>
					 <li>
					 <a href="<?php url_link('enquiry.html')?>" class="view_enq" title="<?php echo $Captions_arr['COMMON']['VIEW_ENQUIRY']?>"><?php echo $Captions_arr['COMMON']['VIEW_ENQUIRY']?></a>
					 </li>
					  </ul>  
					</div>
					</td>
		...
		function mod_customerlogin($title)
		{
			...
			if (!$cust_id) // case customer is not logged in
			{
				...
				{
				?>
					<table border="0" cellpadding="0" cellspacing="0" class="login_con_table">
					<tr>
						<td>
						<div class="login_con">
						   <div class="login_banner">
							 <div class="signup_btn"><a href="<?php url_link('registration.html')?>" title="<?php echo stripslash_normal($Captions_arr['CUST_LOGIN']['NEW_USER'])?>"><img src="<?php url_site_image('signup-btn.gif')?>" alt="Sign up" /></a></div>
							 <div class="login_btn"><a href="<?php url_link('custlogin.html')?>"><img src="<?php url_site_image('login-btn.gif')?>" alt="Login" /></a></div>
						   </div>
						</div>
						</td>
					</tr>
		...
		<?php
			...
			?>
				...
				?>	
					<li><h1><a href="<?php url_link('mypricepromise.html')?>" class="userloginmenulink"><?=$Captions_arr['LOGIN_MENU']['MY_PRICE_PROMISE']?></a></h1></li>
		...
		function mod_bestsellers($ret_main,$title,$display_id)
		{
			...
			{	
				...
				{
				?>
					<div class="best_slr_div" >				
					<?php
					if($title) // check whether title exists
					{
					?>
						<div class="best_slr_header"><?php echo $title?></div>
					<?php
					}
					while ($row_main = $db->fetch_array($ret_main))
					{
					?>	
						<div class="best_slr_div_inner">
						<div class="best_slr_div_pdt" >
						<div class="best_slr_pdt_left"><a href="<?php echo url_product($row_main['product_id'],$row_main['product_name'],-1)?>" title="<?php echo stripslash_normal($row_main['product_name'])?>">
							<?php
						...
						<div class="best_slr_pdt_right">
						<div class="best_slr_name"><a href="<?php url_product($row_main['product_id'],$row_main['product_name'],-1)?>" class="best_slr_name_link" title="<?php echo stripslashes($row_main['product_name'])?>"><?php echo stripslashes($row_main['product_name'])?></a></div>
						<div class="best_slr_price"><?php
						...
						<div class="best_slr_buy" onclick="window.location='<?php url_product($row_main['product_id'],$row_main['product_name'],-1)?>'"></div>	
						</div>	 
						</div>
					<?php
					}		
					?>
						<div class="best_slr_shwall_div" ><a href="<? url_link('bestsellers'.$display_id.'.html')?>" class="best_slr_pdt_showall" title="<?php echo $Captions_arr['COMMON']['SHOW_ALL']?>"><?php echo $Captions_arr['COMMON']['SHOW_ALL']?></a></div>
					</div>				<?php	
				}	
			}	
		}
			...
			if ($position=='left' or $position =='right')// Combo deal is allowed only in left or right panel
			{
				...
				{	
						...
						?>
											...
											{
											?>	
												<div class="lf_combodeal_top"><?=$title?></div>
											<?php
											}
											?>
											...
											<div class="lf_combodeal_bottom"><a href="<?php url_combo($combData['combo_id'],$combData['combo_name'],-1)?>" class="lf-combodeal-showall" title="<?php echo stripslash_normal($Captions_arr['COMMON']['SHOW_DEAL'])?>"><?php echo stripslash_normal($Captions_arr['COMMON']['SHOW_DEAL'])?></a></div>
											</div>
						<?php	
									}
								}
						...
						if ($db->num_rows($ret_prod))
						{
							if($shelfData['shelf_currentstyle']=='nor') // case of normal design layout
							{
								switch($shelfData['shelf_displaytype'])
								{
									...
									?>
									<div class="noraml_lft_div" >
									<?php
									if ($title)
									{
									?>
									<div class="noraml_lft_header"><?php echo stripslash_normal($title)?></div>
									<?php
									}
									while($row_prod = $db->fetch_array($ret_prod))
									{
									?>
										<div class="noraml_lft_div_inner">
										<div class="noraml_lft_div_pdt" >
										<?php
										if($shelfData['shelf_showimage']==1) // whether image is to be displayed
										{
										?>
											<div class="noraml_lft_pdt_left">
											<a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" title="<?php echo stripslashes($row_prod['product_name'])?>">
											<?php
												// Calling the function to get the type of image to shown for current 
												$pass_type = 'image_iconpath';//get_default_imagetype('combshelf');
												// Calling the function to get the image to be shown
												$img_arr = get_imagelist('prod',$row_prod['product_id'],$pass_type,0,0,1);
												if(count($img_arr))
												{
										...
										?>
										<div class="noraml_lft_pdt_right">
										<?php
										if($shelfData['shelf_showtitle']==1)// whether title is to be displayed
										{
										?>
										<div class="noraml_lft_name">
										<a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" class="noraml_lft_name_link" title="<?php echo stripslashes($row_prod['product_name'])?>"><?php echo stripslashes($row_prod['product_name'])?></a>
										</div>
										<?php
										}
										?>
										<div class="noraml_lft_name_price">
										<?php 
										...
										<div class="noraml_lft_pdt_buy">
										<a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" class="noraml_lft_buy_link">Enquire</a></div>
										</div>	  	
										</div>
									<?php
									}
									?>	
									<div class="noraml_lft_shwall_td" >
									<a href="<?php  url_shelf_all($shelfData['shelf_id'],$shelfData['shelf_name'],-1)?>" class="spcl3_lft_pdt_showall" title="<?php echo $Captions_arr['COMMON']['SHOW_ALL']?>"><?php echo $Captions_arr['COMMON']['SHOW_ALL']?></a>
									</div>
									</div>
									<?php	
									break;
							...
							elseif($shelfData['shelf_currentstyle']=='christ') // case of christmas layout
							{
								...
								case '3row':
								?>
								<div class="spcl2_lft_div" >
								<?php
								if ($title)
								{
								?>	
								<div class="spcl2_lft_header"><?php echo stripslash_normal($title)?></div>
								<?php
								}
								while($row_prod = $db->fetch_array($ret_prod))
								{
								?>
									<div class="spcl2_lft_div_inner">
									<div class="spcl2_lft_div_pdt" >
								...
								?>
								<div class="spcl2_lft_shwall_td" >
								<a href="<?php  url_shelf_all($shelfData['shelf_id'],$shelfData['shelf_name'],-1)?>" class="spcl2_lft_pdt_showall" title="<?php echo $Captions_arr['COMMON']['SHOW_ALL']?>"><?php echo $Captions_arr['COMMON']['SHOW_ALL']?></a>
								</div>
								</div>
									<?php	
								break;
							...
							elseif($shelfData['shelf_currentstyle']=='new') // case of new year layout
							{
								...
								case '3row':
								?>
								<div class="spcl3_lft_div" >
								<?php
								if ($title)
								{
								?>
								<div class="spcl3_lft_header"><?php echo stripslashes($title)?></div>
								<?php
								}
								while($row_prod = $db->fetch_array($ret_prod))
								{
								?>
									<div class="spcl3_lft_div_inner">
									<div class="spcl3_lft_div_pdt" >
									<div class="spcl3_lft_pdt_left">
									<?php
									if($shelfData['shelf_showimage']==1) // whether image is to be displayed
									{
									?>
									...
									<div class="spcl3_lft_pdt_right">
									<div class="spcl3_lft_buy_link">
									<a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" title="<?php echo stripslashes($row_prod['product_name'])?>">
									<img src="<?php url_site_image('spl2-left-buy.gif')?>" border="0" />
									</a>
									</div>
									<div class="spcl3_lft_name_price">
									<?php
									...
									<div class="spcl3_lft_pdt_name">
									<a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" class="spcl3_lft_name_link" title="<?php echo stripslashes($row_prod['product_name'])?>"><?php echo stripslashes($row_prod['product_name'])?></a>
									</div>
									</div>	  	
									</div>
								<?php
		...
		function mod_newsletter($title)
		{
			...
			{
				?>
				<table border="0" cellpadding="0" cellspacing="0" class="nws_div_table">
				<tr><td>
				<div class="nws_div">
	...
	function mod_giftvoucher($title)
		{
		   ...
		   ?>
			<table border="0" cellpadding="0" cellspacing="0" class="gift_buytable">
				<tr><td>
		...
		function mod_spendvoucher($title)
		{
			...
			{
			?>
			<table border="0" cellpadding="0" cellspacing="0" class="gift_usetable">
			<tr><td>
		      <div class="gift_use"> 
						...
						if($cache_exists!=true)
						{
							$sql_shop = "SELECT a.shopbrand_id,a.shopbrand_name,shopbrand_parent_id,
								...
								if ($db->num_rows($ret_shop))
								{
												 ...
												 <?php
												  ...
												  <tr>
													<td class="shopbybrandheader">
													  <label>
														<select name="prodshopgroup_<?php echo $groupData['shopbrandgroup_id']?>" onchange="handle_dropdownval_sel(this.value)" class="shopbybrand_dropdown">
															<option value="">-- <?php echo $Captions_arr['COMMON']['SELECT']?> -- </option>
												<?php
															// Case if categories are to be shown in dropdown box
															while ($row_shop = $db->fetch_array($ret_shop))
										...
										?>
										<tr>
										<td colspan="3" align="right" valign="top" class="maintopshop">
		...
		?>	
			<div class="recent_view_middle">
				...
				<div class="recent_view_bottom"><a href="#" class="recent_view-showall" title="<?php echo $Captions_arr['COMMON']['SHOW_ALL']?>" onclick="if(confirm('Are You sure You want to clear the recent product list')){ document.<?=$frm_name?>.submit()};"><?php echo $Captions_arr['COMMON']['COMON_RECENT']?></a></div>
				</div>
			</form>
		<?php		
		}
							...
							?>
								...
								if($db->num_rows($ret_rotate))
								{
								   $HTML_Content .= '<script type="text/javascript">
									...
									$HTML_Content .= '<ul id="'.$advert_ul_id.'" class="innerfade_left">';
			...
			<?
					...
					elseif ($position =='bottom')
					{
                        ...
                        ?>
							...
							<tr>
							<td align="center" colspan="3" style="padding:8px" id="bottom_ssl_td">
                            	<div class="bottom_ssl_div_l">
                            	<img src="<? url_site_image('ssl_main_image_bottom.gif')?>" alt="Secure Payment" title="<?php echo $title?>" border="0" />
                            	</div>
                            	<div class="bottom_ssl_div_r">
								<!-- PayPal Logo --><table border="0" cellpadding="10" cellspacing="0" align="center"><tr><td align="center"></td></tr><tr><td align="center"><a href="https://www.paypal.com/uk/webapps/mpp/paypal-popup" title="How PayPal Works" onclick="javascript:window.open('https://www.paypal.com/uk/webapps/mpp/paypal-popup','WIPaypal','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=1060, height=700'); return false;"><img src="https://www.paypalobjects.com/webstatic/mktg/Logo/pp-logo-100px.png" border="0" alt="PayPal Logo" style="border:0"></a></td></tr></table><!-- PayPal Logo -->
								</div>	
							</td>
							</tr>
                        <?
		...
		function mod_preorder($ret_main,$title,$display_id)
		{
			...
			{	
				if ($db->num_rows($ret_main))
				{
						...
						{
				?>
						<div class="pre_odr_div" >	
								<?php
								if($title) // check whether title exists
								{
								?>
								<div class="pre_odr_header"><?php echo $title?></div>
								<?php
								}
								while ($row_main = $db->fetch_array($ret_main))
								{
								...
								?>	
								<div class="pre_odr_div_inner">
									<div class="pre_odr_div_pdt" >
											<div class="pre_odr_pdt_left"><a href="<?php echo url_product($row_main['product_id'],$row_main['product_name'],-1)?>" title="<?php echo stripslash_normal($row_main['product_name'])?>">
											<?php
												// Calling the function to get the type of image to shown for current 
												$pass_type = 'image_iconpath';
												// Calling the function to get the image to be shown
											...
											<div class="pre_odr_pdt_right">
												<div class="pre_odr_name"><a href="<?php url_product($row_main['product_id'],$row_main['product_name'],-1)?>" class="pre_odr_name_link" title="<?php echo stripslashes($row_main['product_name'])?>"><?php echo stripslashes($row_main['product_name'])?></a></div>
											</div>
											<div class="pre_odr_price">
												<?php
												$price_arr =  show_Price($row_main,array(),'compshelf',false,3);
												if($price_arr['discounted_price'])
												echo $price_arr['discounted_price'];
								...
								?>
								<div class="pre_odr_shwall_td" ><a href="<? url_link('preorder'.$display_id.'.html')?>" class="pre_odr_pdt_showall" title="<?php echo $Captions_arr['COMMON']['SHOW_ALL']?>" <?php /*onclick="document.bestseller_component_left<?=$display_id?>.submit();"*/?>><?php echo $Captions_arr['COMMON']['SHOW_ALL']?></a></div>
							</div>
