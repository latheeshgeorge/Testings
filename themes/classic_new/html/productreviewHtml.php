...
/*############################################################################
	...
	class productreview_Html
	{
		...
		?>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="3"  class="readreivewtable">
			<?php if($alert){ ?>
			<tr>
				<td colspan="2" class="errormsg" align="center">
				<?php 
						  if($Captions_arr['PRODUCT_REVIEWS'][$alert]){
						  		echo "Error !! ". stripslashes($Captions_arr['PRODUCT_REVIEWS'][$alert]);
						  }else{
		...
		<tr>
          <td colspan="2" class="message_header"><?=stripslash_normal($Captions_arr['PRODUCT_REVIEWS']['WRITE_PRODUCT_REVIEW_READREVIEW_TITLE'])?></td>
        </tr>
		<?php }  
			if($Captions_arr['PRODUCT_REVIEWS']['PRODUCT_REVIEW_READREVIEW_TITLE']) {?>
			<tr>
			<td colspan="2" class="addreivewheader"><?=stripslash_normal($Captions_arr['PRODUCT_REVIEWS']['WRITE_PRODUCT_REVIEW_ADDREVIEW_TITLE'])?></td>
			</tr>	<?php } ?>	
			<tr>
			<td width="41%" class="addreivewconent"><?=stripslash_normal($Captions_arr['PRODUCT_REVIEWS']['WRITE_PRODUCT_REVIEW_AUTHOR'])?></td>
			<td width="59%" align="left" valign="middle"><input name="review_author" type="text" class="addreivewinput" id="review_author" size="39" /></td>
			</tr>
			<tr>
			<td width="41%" class="addreivewconent"><?=stripslash_normal($Captions_arr['PRODUCT_REVIEWS']['WRITE_PRODUCT_REVIEW_AUTHOR_EMAIL'])?></td>
			...
			<tr>
			<td class="addreivewconent"><?=stripslash_normal($Captions_arr['PRODUCT_REVIEWS']['WRITE_PRODUCT_REVIEW_REVIEWTEXT'])?></td>
			...
			<tr>
			<td class="addreivewconent"><?=stripslash_normal($Captions_arr['PRODUCT_REVIEWS']['WRITE_PRODUCT_REVIEW_RATING'])?></td>
			...
			<tr>
			<td class="addreivewconent"><?=stripslash_normal($Captions_arr['PRODUCT_REVIEWS']['WRITE_PRODUCT_REVIEW_VERIFICATIONCODE'])?></td>
...
function validate_prodreview(frm)
{
	...
	function Show_Productreview()
		...
		global $Captions_arr,$ecom_siteid,$db,$ecom_hostname,$Settings_arr,$product_id,$product_name;
			/*$sql_order_limit = "SELECT prodreview_ord_fld,prodreview_ord_orderby,productreview_maxcntperpage 
		...
		<tr>
          <td colspan="2" class="message_header"><?=stripslash_normal($Captions_arr['PRODUCT_REVIEWS']['READ_PRODUCT_REVIEW_READREVIEW_TITLE'])?></td>
        </tr>	
		<?php 
		if($_REQUEST['alert']==1)
		{
		...
		<tr>
          <td colspan="2" class="message" align="center"><?=stripslash_normal($Captions_arr['PRODUCT_REVIEWS']['WRITE_PRODUCT_REVIEW_ADDED_SUCCESSFULLY'])?></td>
        </tr>
		
		<?php } 
		}
		if($Captions_arr['PRODUCT_REVIEWS']['READ_PRODUCT_ADDREVIEW_LINK'] || $Captions_arr['PRODUCT_REVIEWS']['READ_PRODUCT_REVIEW_BACK_TO_DETAILS_LINK']){?>
		<tr>
          <td   align="left" valign="top"  class="addreivewconent" ><a href="<?php url_product($product_id,'',-1)?>" title="<?php echo stripslashes($row_prod['product_name'])?>" class="message_backlink"><?=stripslash_normal($Captions_arr['PRODUCT_REVIEWS']['READ_PRODUCT_REVIEW_BACK_TO_DETAILS_LINK'])?></a></td>
      	 <td  align="left" valign="top"  class="addreivewconent" >
	...
	$ret_prodreview = $db->query($sql_prodreview);
        ...
        <tr>
          <td width="35%" align="left" valign="top"  class="readreivewicon" ><?=stripslash_normal($Captions_arr['PRODUCT_REVIEWS']['READ_PRODUCT_REVIEW_AUTHOR'])?></td>
          <td width="65%" align="left" valign="top" class="readreivewname"><?=stripslashes($row_prodreview['review_author'])?> ( <?=$row_prodreview['reviewed_on']?>)</td>
        </tr>
        <tr>
          <td align="left" valign="top" class="readreivewcontent"><?=stripslash_normal($Captions_arr['PRODUCT_REVIEWS']['READ_PRODUCT_REVIEW_REVIEW'])?></td>
          <td align="left" valign="top"><?=stripslashes($row_prodreview['review_details'])?></td>
        </tr>
        <tr>
          <td align="left" valign="top" class="readreivewcontent"><?=stripslash_normal($Captions_arr['PRODUCT_REVIEWS']['READ_PRODUCT_REVIEW_RATING'])?></td>
		...
		<tr>
			...
			?>
			 <tr>
          <td  colspan="2" align="center" valign="top"  class="addreivewconent" ><?php echo stripslash_normal($Captions_arr['PRODUCT_REVIEWS']['READ_PRODUCT_NO_REVIEW_MSG']);
		  ?></td>
        </tr>
			<?
			}
