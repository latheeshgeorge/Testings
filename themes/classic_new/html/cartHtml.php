		  ...
		  ?>
			...
			<tr>
				...
				?>	
				   ...
				   $sql_euvat = "SELECT * FROM euvat_values_more WHERE sites_site_id = $ecom_siteid ORDER BY sort_order";
				...
				<td align="right" valign="middle" class="shoppingcartcontent"  colspan="4"><?php echo stripslash_normal($Captions_arr['CART']['CART_COMP_NUM'])?>&nbsp;</td>
				<td align="right" valign="middle" class="shoppingcartcontent"><input type="text" class="cart_inputA" name="company_number" value="<?php echo $row_cartdet['company_number']?>"></td>
				</tr>		
			<?php	
		    }
...
// Show the payment type and payment method sections only if total amount > 0
		...
		<?php
		  ...
		  ?>
		  		...
		  		<table width="100%" border="0" cellspacing="4" cellpadding="0" class="regifontnormal" style="float:left">
 		  <tr>
			...
			<?php
				...
				<a href="<?php url_link('registration.html')?>" class="buttongray" style="text-decoration:none">Create New Account&nbsp;</a>
				</div>
				 </td>
				</tr>
				  </table>
          ...
          <tr>
            ...
            <td width="54%"><input name="custlogin_uname" id="custlogin_uname" type="text" class="inputA_new" size="10" /></td>
          </tr>
          <tr>
            <td align="right" valign="middle" class="regiconent"><?php echo $Captions_arr['CART']['CART_PASSWORD']?></td>
            <td><input name="custlogin_pass" id="custlogin_pass" type="password" class="inputA_new" size="10" /></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td> 
		  ...
		  <input type="hidden" name="pass_url" id="pass_url" value="<?php echo $ps_url?>" />
		  	<input type="hidden" name="cart_mod" value="show_cart" /> 
			<input name="custcartlogin_Submit" type="submit" class="buttongray" value="Login" onclick="document.frm_custlogin_cart.submit();" />
			</td>
	      </tr>
		  <?php
...
//				$cont_class = 'shoppingcartcontent_noborder'; 
			...
			?>
			  <tr>
				<td colspan="5" align="center" valign="middle" class="cartterms">			
					 <?php
						if($Settings_arr['terms_and_condition_at_checkout'])
						{
					?>
							<br /><input class="shoppingcart_radio" type="checkbox" name="cart_terms" id="cart_terms" value="1" />
							<?php 
								if($ecom_siteid==60)
								{
								?>
									<a href="http://<?php echo $ecom_hostname?>/terms-pg49201.html" title="Terms and Conditions" style="color:#AC0000; font-size:11px; font-weight:bold" target="_blank"><?php echo $Captions_arr['CART']['CART_ACCEPT_TERMS_CONDITIONS']?></a></td>
								<?php
								}
								else
									echo $Captions_arr['CART']['CART_ACCEPT_TERMS_CONDITIONS']?>
					<?php	
						}
					?>	
				</td>
			...
			*/
			if($ecom_isadword)
			{
				...
				?>
						...
						<!-- Yell Code for purchase Conversion Page -->
						<script type="text/javascript">
						var hostProtocol = (("https:" == document.location.protocol) ? "https" : "http");
						document.write('<scr'+'ipt src="', hostProtocol+'://5035.xg4ken.com/media/getpx.php?cid=5b1d7fa6-8248-478a-9f8e-ae3735487208','"type="text/JavaScript"><\/scr'+'ipt>');
						</script>
						<script type="text/javascript">
						var params = new Array();
						params[0]='id=5b1d7fa6-8248-478a-9f8e-ae3735487208';
						params[1]='type=purchase';
						params[2]='val=<?=$total_price?>';
						params[3]='orderId=<?=$order_id?>';
						params[4]='promoCode=';
						params[5]='valueCurrency=GBP';
						params[6]='GCID='; //For Live Tracking only
						params[7]='kw='; //For Live Tracking only
						params[8]='product='; //For Live Tracking only
						k_trackevent(params,'5035');
						</script>
						<noscript>
						<img src="https://5035.xg4ken.com/media/redir.php?track=1&token=5b1d7fa6-8248-478a-9f8e-ae3735487208&type=purchase&val=<?php echo $total_price?>&orderId=<?php echo $order_id?>&promoCode=&valueCurrency=GBP&GCID=&kw=&product=" width="1" height="1"/>
						</noscript>
