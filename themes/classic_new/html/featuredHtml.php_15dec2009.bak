	...
	class featured_Html
	{
		...
		?>
			...
			<?php
				...
				{
			?>
		    		<div class="featuredheader"><?php echo stripslash_normal($title)?></div>
			<?php
				}
			?>
				<div class="featuredinner"> 
				<div class="featured_offer"></div>
				...
				<td width="56%" align="left" valign="top" class="featuredprodname">
					...
					{
					?>
						<a href="<?php url_product($row_featured['product_id'],$row_featured['product_name'],-1)?>" class="featuredprodnamelink" title="<?php echo stripslashes($row_featured['product_name'])?>"><?php echo stripslashes($row_featured['product_name'])?></a>
					<?php
					}
					?>
				</td>
				...
				<tr>
				<td width="4%" align="left" valign="top" class="featuredbuytd"><img src="<?php url_site_image('fet-but-left.gif')?>" width="11" height="47" /></td>
				...
				?>
					...
					<?php 
						$price_arr =  show_Price($row_featured,array(),'shelfcenter_1',false,3);
				...
				<a href="<?php url_product($row_featured['product_id'],$row_featured['product_name'],-1)?>" title="<?php echo stripslashes($row_featured['product_name'])?>"><img src="<?php url_site_image('fet-buy.gif')?>" width="115" height="31" border="0" /></a></td>
				<td width="4%" align="right" valign="top" class="featuredbuytd"><img src="<?php url_site_image('fet-but-right.gif')?>" width="11" height="47" /></td>
				</tr>
				</table></td>
				</tr>
				<?php
