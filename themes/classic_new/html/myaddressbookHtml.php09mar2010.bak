	...
	class myaddressbook_Html
	{
		function Show_AddressBook(){
				...
				?>
					  ...
					  <tr>
					    <td  align="center" class="pagingcontainertdA" colspan="5">&nbsp;<input name="address_add" type="button" class="buttonred_cart" id="address_add" value="<?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_ADD']?>" onclick="javascript:add_address(document.my_addressbook)" />	</td>
