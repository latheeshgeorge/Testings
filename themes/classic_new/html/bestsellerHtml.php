							...
							$querystring = ""; // if any additional query string required specify it over here
								switch($Settings_arr['bestseller_prodlisting'])
								{
									...
									?>
										...
										{
										?>
											<div class="shelfBheader"><?php echo stripslashes($Captions_arr['BEST_SELLERS']['BEST_SELLER_CAPTION']);?></div> 
										<?php
										}
										if($tot_cnt>0)
										{
									...
									{
									?>
									<div class="shelfAheader"><?php echo stripslash_normal($Captions_arr['BEST_SELLERS']['BEST_SELLER_CAPTION'])?></div>
									<?
									}
