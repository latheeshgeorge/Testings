	  ...
	  function wishlist_Showform()
	  {
		...
		<form method="post" name="frm_wishlist" class="frm_cls" action="<?php url_link('wishlist.html')?>">
			...
			if($db->num_rows($ret_select_wish))
				...
				<tr>
				<td align="left" colspan="5"  valign="middle"><div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?php echo $Captions_arr['WISHLIST']['WISHLIST_MAINHEADING']?></div></td>
			  	</tr>
              ...
              <? 
					if($Settings_arr['empty_wishlist']==1)
					{
		  			...
		  			?>
			   <tr>
				<td align="right" valign="middle" class="shoppingcartcontent" colspan="5">
				 ...
				 ?>	
			   <tr>
			   		<td align="left" valign="middle" class="ordertableheader" ><?php echo $Captions_arr['WISHLIST']['WISHLIST_SLNO']?></td>
					<td align="left" valign="middle" class="ordertableheader" ><?php echo $Captions_arr['WISHLIST']['WISHLIST_ITEM']?></td>
					<td align="left" valign="middle" class="ordertableheader" ><?php echo $Captions_arr['WISHLIST']['WISHLIST_VARIABLES']?></td>
		  ...
		  $cnt=0;
				...
				?>
				  <tr>
				  <td align="left" valign="middle" class="<?=$trmainclass?>"  ><?php echo $cnt ?>.</td>
					<td align="left" valign="middle" class="<?=$trmainclass?>" width="28%" colspan="2" >
					<?php 
			  ...
			  if($_REQUEST['fproduct_id']){?>
				...
				<td align="center" valign="middle" colspan="3" class="shoppingcartcontent_noborder">
				<?
