<?php
	...
	<?php /*?>	<form method="post" name="frm_special_comp" id="frm_special_comp" action="<?php url_productcompare($prodId,$_REQUEST['product_id'],'','')?>#comp_prods" class="frm_cls">
		...
		?>
		<tr>
		<td colspan="2" class="productdeheader" align="left"><?php echo stripslashes($row_prod['product_name'])?>
		<?php
		...
		{
		?>
			<div class="bonus_det"><?php echo $Captions_arr['PROD_DETAILS']['PRODDET_BONUSPOINTS'].' '.$row_prod['product_bonuspoints']?></div>
		<?php
		}
	...
	<?php
		...
		{
		?>
			<img src="<?php url_site_image('add-to-wishlist.gif')?>" alt="<?php echo $Captions_arr['PROD_DETAILS']['PRODDET_ADDWISHLIST'];?>" title="<?php echo $Captions_arr['PROD_DETAILS']['PRODDET_ADDWISHLIST'];?>" onclick="window.location='<?php url_link('custlogin.html')?>'"/>
		<?php
		}
	?>			
	<?php
	...
	?>
		...
		?>
			...
			{
			?>
				<a href="<?php url_link('pricepromise'.$row_prod['product_id'].'.html')?>"><img src="<?php url_site_image('price-promise.gif')?>" /></a>
			<?php
			}
	...
	<?php	
		...
		?>
				<div class="shelfBtable">
					<div class="shelfBheader"><?php echo stripslashes($Captions_arr['PROD_DETAILS']['PRODDET_PEOPLE_INTERESTED']);?></div> 
				<?php
		...
		?>
			...
			<div class="shelfAheader"><?php echo $Captions_arr['PROD_DETAILS']['PRODDET_PEOPLE_INTERESTED'];?></div>
			<?
			$max_col = 3;
			$cur_col = 0;
			$prodcur_arr = array();	
		...
		function show_ProductLabels($label_arr)
		{
			...
			?>
				...
				<tr>
				<td colspan="2" class="keyfeature_header"><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['PRODDET_KEY_FEATURES'])?></td>
				</tr>
				<?php
					$i=1;
					foreach($label_arr as $k=>$v)
					{
						...
						?>
							<tr>
								<td align="left" valign="middle" class="<?php echo $clss?>" width="40%"><?php echo stripslash_normal($v['label_name'])?></td>
