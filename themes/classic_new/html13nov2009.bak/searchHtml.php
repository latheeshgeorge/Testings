<?php
	...
	class search_Html
	{
		...
		{
		  	global $ecom_siteid,$db,$ecom_hostname,$Settings_arr,$tot_cnt,$ecom_themeid,$default_layout,
					$Captions_arr,$prodperpage,$quick_search,$head_keywords,$row_desc,$inlineSiteComponents;
				        ...
				        if ($_REQUEST['req']!='')// LIMIT for products is applied only if not displayed in home page
						{
							...
							if ($db->num_rows($ret_search))
							{
								...
								?>
										...
										{
										?>
											<div class="shelfBheader"><?php echo stripslashes($top_content);?></div> 
										<?php
										}
										?>
										<div class="productsearch_navigation">
									...
									{
									?>
										<div class="shelfAheader"><?php echo stripslash_normal($top_content)?></div>
									<?
									}
									?>
									<div class="productsearch_navigation">
