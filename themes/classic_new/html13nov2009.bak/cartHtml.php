		...
		?>	
			  ...
			  ?>
				  <tr>
					...
					<?php	
						...
						{
					?>
					<div class="updatediv" align="center"><input name="cart_qty_<?php echo $products_arr['cart_id']?>" type="text" id="cart_qty_<?php echo $products_arr['cart_id']?>" size="4" maxlength="4" value="<?php echo $products_arr["cart_qty"]?>" style="width:27px;" />
					</div> 
		  ...
		  <?php
			...
			?>
			  ...
			  <tr>
				<td colspan="5" align="right" valign="middle" class="shoppingcartcontent"><b><?php echo $Captions_arr['CART']['CART_TOTAL_FINAL_COST']?>&nbsp;</b> </td>
				<td align="right" valign="middle" class="shoppingcartpriceC"><b><?php echo print_price($cartData["totals"]["bonus_price"],true)?></b></td>
			  </tr>
		  <?php
		  	}
		 ...
		 <?php
		  ...
		  <?php
			...
			?>
			  ...
			  <tr>
				<td colspan="5" align="right" valign="middle" class="shoppingcartcontent"><b><?php echo $Captions_arr['CART']['CART_TOTAL_FINAL_COST']?>&nbsp;</b> </td>
				<td align="right" valign="middle" class="shoppingcartpriceC"><b><?php echo print_price($row_ord['order_totalprice'],true)?></b></td>
			  </tr>
		  <?php
		  	}
