...
/*############################################################################
	...
	class myhome_Html
	{
										...
										<?php
											...
											?>
													...
													<input type='hidden' name='category_id' value="<?=$_REQUEST['category_id']?>"/>
														 ...
														 <a href="<?php url_category($row_subcat['category_id'],$row_subcat['category_name'],-1)?>" class="subcategoreynamelink" title="<?php echo stripslash_normal($row_subcat['category_name'])?>">
														 <?php
														...
														?>
															...
															<div class="subcategoreynamelink"><a href="<?php url_category($row_subcat['category_id'],$row_subcat['category_name'],-1)?>" title="<?php echo stripslash_normal($row_subcat['category_name'])?>"><?php echo stripslash_normal($row_subcat['category_name'])?></a></div>
													</form>	
												  </div>
											<?php
													$cur_col++;
		...
		function Show_Recently_Purchased_Products_With_Categories($used_val_arr)
		{
			...
			?>
						<tr>
							...
							<div class="shelfBtable">
							<div class="shelfBheader"><?php echo stripslash_normal($row_cat['category_name'])?></div> 
							</div>
							</td>
						</tr>
				<?php
						...
						?>
							<?php /*?><tr>
							<td align="left" class="myhome_offer_subhead"><?php echo stripslash_normal($Captions_arr['LOGIN_HOME']['LOGIN_HOME_RECENT_OFFER'])?>
							</td>
							</tr><?php */?>
							<tr>
						...
						?>
							<?php /*?><tr>
								<td align="left" class="myhome_offer_subhead"><?php echo stripslash_normal($Captions_arr['LOGIN_HOME']['LOGIN_HOME_RECENT_NEW'])?>
								</td>
							</tr><?php */?>
							<tr>
					...
					<?php	
						...
						?>
								<tr>
									<td align="left">
									<div class="shelfBtable">
									<div class="shelfBheader"><?php echo stripslash_normal($row_favcat['category_name'])?></div> 
									</div>
									</td>
								</tr>
						<?php
								...
								?>
									<?php /*?><tr>
										<td align="left" class="myhome_offer_subhead"><?php echo stripslash_normal($Captions_arr['LOGIN_HOME']['LOGIN_HOME_FAV_OFFER'])?>
										</td>
									</tr><?php */?>
									<tr>
								...
								?>
									<?php /*?><tr>
										<td align="left" class="myhome_offer_subhead"><?php echo stripslash_normal($Captions_arr['LOGIN_HOME']['LOGIN_HOME_FAV_NEW'])?>
										</td>
									</tr><?php */?>
									<tr>
		...
		?>
				...
				<?php
				if($row_products_id['product_freedelivery']==1)	
				{
				?>
		...
		function Show_Favourite_Products($used_val_arr)
		{
			...
			<tr>
				...
				<div class="shelfBtable">
				<div class="shelfBheader"><?php echo stripslash_normal($Captions_arr['LOGIN_HOME']['LOGIN_HOME_FAV_PROD'])?></div> 
				</div>
				</td>
			</tr>
			<tr>
					...
					<?php	
						...
						?>
								<tr>
									<td align="left">
									<div class="shelfBtable">
									<div class="shelfBheader"><?php echo stripslash_normal($row_cats['category_name'])?></div> 
									</div>
									</td>
								</tr>
						<?php
								...
								?>
									<tr>
										<td align="left" class="myhome_offer_subhead"><?php echo stripslash_normal($Captions_arr['LOGIN_HOME']['LOGIN_HOME_MOST_HITS_CAT_NEWPROD'])?>
										</td>
									</tr>
									<tr>
