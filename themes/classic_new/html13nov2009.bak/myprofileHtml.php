	...
	<tr>
		<td colspan="2" valign="top" align="left">
			<table width="100%" border="0" cellspacing="4" cellpadding="0" class="regifontnormal_newsletter">
					...
					<b><?=$Captions_arr['CUST_REG']['REQUEST_PAYONACC']?></b></td>
		...
		<td colspan="2" valign="top" align="center" >
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="regifontnormal_newsletter"  >
					<tr>
	...
	<tr>
			...
			<table width="100%" border="0" cellspacing="4" cellpadding="0" class="regifontnormal_newsletter">
					<tr>
						...
						</td><td  align="left" valign="middle" width="97%"><b>
							<?=$Captions_arr['CUST_REG']['REQUEST_NEWS_RECEIVE_NEWPROD']?></b>
						</td>
					</tr>
				</table>			</td>
		</tr>
