		  ...
		  ?>
				...
				?>	
					...
					?>	 
							...
							<table class="countrylist_table" cellpadding='0' cellspacing='1' border='0' align='right'>
							<tr>
				   ...
				   ?>
					   <tr>
						 <td align="right" class="shoppingcartdelgroup" colspan='2'><?php echo $Captions_arr['CART']['CART_DELIVERY_OPT']?>
						  <?php
					...
					if ($cartData["customer"]["customer_bonus"] and $Settings_arr['cust_allowspendbonuspoints']==1) // does current customer have bonus points
					{
						...
						?>
						 <tr>
							...
							<td colspan="4" align="left" valign="middle" class="shoppingcartpriceC">
