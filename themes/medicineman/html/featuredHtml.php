                  ...
                  <tr>
					...
					<?php
					    ...
					    <?php
						  ...
						  ?>
						<div class="featuredbuydiv"> <a href="<?php url_product($row_featured['product_id'],$row_featured['product_name'],-1)?>" title="<?php echo stripslash_normal($row_featured['product_name'])?>"><img src="<?php url_site_image('fet-buy.gif')?>" alt="Buy Now" title="Buy Now" border="0" /></a></div>
					<?php
                    ...
                    <td width="56%" align="left" valign="top" class="featuredprodbnr">&nbsp;</td>
                  </tr>
                </table>
		      </div>
		</div>
