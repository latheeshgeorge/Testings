...
<table border="0" cellpadding="0" cellspacing="0"	class="productdeatilstable">
	...
	?>
	<tr>
	<td colspan="2" align="left" class="productdeheader"><h1><?php echo stripslashes($row_prod['product_name'])?></h1>
	<?php
	if ($Settings_arr['proddet_showbarcode']==1)
	{
	?>
		 ...
		 ?>
                ...
                <td colspan="2" align="right" class="productdeheader">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <td width="2%" align="right" valign="top"
                            class="productdetails_img_td"><img src="<?php url_site_image('pro_link_det_right.gif')?>" title="right" alt="right" /></td>
                        </tr>
                    </table>
                </td>
            </tr>
          <?php				
				...
				{ 
                    ...
                    <tr>
					<td align="left" valign="top" class="productdetd" colspan="2"><div id="moreimage_holder">
					<?php
					...
					?>
						...
						?>
							<a href="javascript:showsizechartPopup('<?php echo $row_prod['product_id']?>','<?php echo $ecom_hostname?>','<?php echo $ecom_themename?>')" title="<?php echo stripslash_normal($sizechartmain_title)?>">
							<div class="size_btnPA"><img src="<?php  url_site_image("sizechart-btn.gif")?>"  border="0"/>		</div></a>
						<?php
						}
					   if($sizechart_heading['size_Availvalues']==false && $row_prod['product_commonsizechart_link']!='')
						{
				...
				if ($row_prod['product_variable_in_newrow']==0 or $var_listed == false) // if flash not set and also variable not set to show in new row
				{
			?>
                <tr>
	...
	<tr>
		<td colspan="2" align="left" class="productdetd_main"><?php
          ...
          <tr>
		<td colspan="2" align="left" class="productdetd">
		<?php $this->show_product_downloads($row_prod['product_id']);?>
		</td>
	</tr>
	<tr>
