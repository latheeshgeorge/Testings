...
<input type="hidden" name="ajax_div_holder" id="ajax_div_holder"
	value="" /> <script type="text/javascript">
		...
		<?php
			...
			{
				echo "$.noConflict(); /* This is done to avoid error in light box due to the usage of $ in jquery*/";
			}
			?>
...
<table border="0" cellpadding="0" cellspacing="0"	class="productdeatilstable">
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
				...
				<td align="left" valign="top" class="productdetd">
						...
						?>
							...
							<div class="size_btn">size chart		</div></a>
						<?php
						 }
						}
		...
		<td colspan="2" align="left" class="productdetd">
				<?php
						$this->show_offer_buttons($row_prod);
						$this->show_ProductLabels($_REQUEST['product_id'],'col');
				?>
            </td>
	</tr>
          <?php
		...
		<td colspan="3" class="pro_de_shelfBheader" align="left"><?php echo $Captions_arr['PROD_DETAILS']['PRODDET_PEOPLE_INTERESTED'];?></td>
			...
			?>
				<tr onmouseover="this.className='normalshelf_hover'" onmouseout="this.className='shelfBtabletd'">
					...
					<td align="center" valign="middle" class="shelfBtabletd"><a	href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" title="<?php echo stripslashes($row_prod['product_name'])?>">
						<?php
					...
					<td align="left" valign="middle" class="shelfBtabletd">
						...
						?>
							...
							<input type="text" class="quainput" name="qty" value="1" /></div>
						<?php
						}
						?>
...
<table border="0" cellpadding="0" cellspacing="0" class="shelfAtable">
	...
	<tr>
		...
		<ul class="shelfBul">
			...
			<li><a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" title="<?php echo stripslashes($row_prod['product_name'])?>">
									<?php
										// Calling the function to get the image to be shown
										$img_arr = get_imagelist('prod',$row_prod['product_id'],$pass_type,0,0,1);
										if(count($img_arr))
...
<?php
		...
		function show_BulkDiscounts($row_prod,$var_arr=array())
		{
			...
			<div class="bulk_con" id="bulkdisc_holder">
	          <div class="bulk_top"><span><?php echo $Captions_arr['PROD_DETAILS']['BULK_DISC_HEAD']?></span></div>
...
<?php
		...
		?>
          <div class="det_btn_con">				<?php
				...
				{
				?>	
					<a href="<?php url_link('freedelivery'.$row_prod['product_id'].'.html')?>" title="Free Delivery"><img src="<?php url_site_image('free-del.gif')?>" border="0" /></a>
				<?php
				}
	...
	?>
					...
					<input type="text" class="quainput_big" name="qty" value="<?php echo ($_REQUEST['qty'])?$_REQUEST['qty']:1?>" maxlength="2" />
					</div>
<?php
				}
