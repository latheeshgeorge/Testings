				...
				foreach ($shelf_arr as $k=>$shelfData)
				{
					...
					if ($proceed)
					{
						...
						if ($db->num_rows($ret_prod))
						{
							...
							if($shelfData['shelf_currentstyle']=='nor' or $shelfData['shelf_currentstyle']=='sp3') // case of normal design layout or bestseller like display
							{ 
													...
													<ul class="shelfBul">
														...
														<?php
															...
															/*if($row_prod['product_newicon_show']==1)
															{
																...
																{
																?>	
																	<li><div class="mid_shlf2_pdt_new"><?php echo $desc?></div></li>
																<?php
																}
															}
*/
