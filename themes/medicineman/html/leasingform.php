...
<link href="http://<? print $ecom_hostname ?>/images/<? echo $ecom_hostname; ?>/<? echo $ecom_theme_name; ?>.css" type="text/css" rel="stylesheet">
...
<P align=center><IMG src="http://<? print $ecom_hostname ?>/images/<? print $ecom_hostname ?>/site_images/logo.gif"></P>
...
<div align="center">
            ...
            <table width="588" border="0" id="table1">
                        ...
                        <tr>
                                    ...
                                    <img border="0" src="http://<? echo $ecom_hostname; ?>/images/<? echo $ecom_hostname; ?>/big/swirlstop.jpg" width="14" height="16"> Fast 
                                    ...
                                    <img border="0" src="http://<? echo $ecom_hostname; ?>/images/<? echo $ecom_hostname; ?>/big/swirlstop.jpg" width="14" height="16"> 100% Tax 
                        ...
                        <tr>
                                    ...
                                    <img border="0" src="http://<? echo $ecom_hostname; ?>/images/<? echo $ecom_hostname; ?>/big/swirlstop.jpg" width="14" height="16"> Improve 

                                    Your Cash Flow By Spreading Payments</FONT></td>

                                    <td width="239" height="22"><FONT face=Verdana size=2>

                                    <img border="0" src="http://<? echo $ecom_hostname; ?>/images/<? echo $ecom_hostname; ?>/big/swirlstop.jpg" width="14" height="16"> Fixed, 
                        ...
                        <tr>
                                    ...
                                    <img border="0" src="http://<? echo $ecom_hostname; ?>/images/<? echo $ecom_hostname; ?>/big/swirlstop.jpg" width="14" height="16"> Lease 

                                    Purchase Means You Own The Machine</FONT></td>

                                    <td width="239"><FONT face=Verdana size=2>

                                    <img border="0" src="http://<? echo $ecom_hostname; ?>/images/<? echo $ecom_hostname; ?>/big/swirlstop.jpg" width="14" height="16"> You 
