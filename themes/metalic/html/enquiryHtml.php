		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="shoppingcarttable">
			...
			<tr>
			  ...
			  <div class="pro_det_treemenu" align="left"> <ul>
							<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a>>></li> <li><?php echo $Captions_arr['ENQUIRE']['ENQUIRE_MAINHEADING']?></li></ul></div>
		  ...
		  ?>
			  <tr>
				...
				<?php 
						...
						$price_class_arr['normal_class'] 	= 'shoppingcartpriceA';
	...
	else
	{
	  ...
	  <form method="post" name="frm_enquire_details" class="frm_cls" action="" onsubmit="return validate_allforms(this);">
			<input type="hidden" name="fpurpose" value="" />
					...
					<div class="pro_det_treemenu" align="left"> <ul>
							<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a>>></li> <li><a href="<? url_link('enquiry.html');?>"><?=$Captions_arr['ENQUIRE']['ENQUIRE_MAINHEADING'];?></a> >> </li><li><?=$Captions_arr['ENQUIRE']['ENQUIRE_DET_MAIN']?></li></ul></div>
		...
		function myenquiry_Enquiry($custid){
				...
				$prod_array = array();
				  ...
				  <table width="100%" border="0" cellpadding="0" cellspacing="2" class="shoppingcarttable">
					  <tr>
						<td  align="left" valign="middle" colspan="3"><div class="pro_det_treemenu" align="left"> <ul>
							<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a>>></li> <li><?php echo $Captions_arr['ENQUIRE']['ENQUIRE_MYENQUIRYHEADING']?></li></ul></div>
						</td>
