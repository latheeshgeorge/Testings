...
<?php   if($Captions_arr['SURVEY']['SURVEY_BACK_BUTTON']){?>
  <tr>
	...
	<? }?>
		...
		?>
<?php /*?>					<div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?=$Captions_arr['SURVEY']['SURVEY_TREEMENU_TITLE']?></div>
<?php */?>		 
<div class="pro_det_treemenu" align="left"> <ul>
							<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a>>></li> <li><?php echo $Captions_arr['SURVEY']['SURVEY_TREEMENU_TITLE']?></li></ul></div>
