...
/*############################################################################
	...
	class callback_Html
	{
		...
		<div class="pro_det_treemenu" align="left"> <ul>
							<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a>>></li><li><?=$Captions_arr['REQUEST_A_CALLBACK']['CALLBACK_REQUEST_TREEMENU_TITLE']?></li></ul></div>
...
<!--      <input name="callback_country" type="text" class="addreivewinput" id="callback_country" size="18" value="<?=$_REQUEST['callback_country']?>"/>
 -->    </label></td>
  ...
  <tr>
    ...
    <td align="left" valign="middle" class="emailfriendtext"><textarea name="callback_comments" cols="38" rows="5" class="addreivewinput" id="callback_comments"><?=$_REQUEST['callback_comments']?></textarea></td>
  </tr>
