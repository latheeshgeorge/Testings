<?php
	...
	class shop_Html
	{
		...
		?>
			<tr>
			<td colspan="3" align="center">
			<table class="categoreyimage" width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
			<td colspan="3" align="left" class="categoreyimagetd">
				...
				<?php
						...
						switch($shop_det['shopbrand_product_displaytype'])
						{
							...
							?>
								...
								<div class="shelf_1row_img"><? if ($shop_det['shopbrand_product_showimage']==1)// Check whether description is to be displayed
								{?>
