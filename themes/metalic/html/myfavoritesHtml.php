...
<input type="hidden" name="fpurpose" id="fpurpose" value="" />
		<div class="pro_det_treemenu" align="left"> <ul>
							<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a>>></li> <li><?php echo $Captions_arr['MY_FAVORITES']['FAVORITES_TREEMENU_TITLE']?></li></ul></div>
		<table width="100%" border="0" cellpadding="0" cellspacing="4"  class="shoppingcarttable" >
