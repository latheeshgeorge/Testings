			...
			<td valign="top"  class="tdcolorgray">
				...
				?>
						<tr>
						  ...
						  <td <?php echo $rightwidth?> width="56%" align="<?php echo stripslashes($row_elem['element_align'])?>" valign="<?php echo stripslashes($row_elem['element_valign'])?>" class="shoppingcartcontent_noborder">: <?php echo stripslashes($row_elem['reg_val'])?>&nbsp;</td>
						</tr>
				<?php  }
					}
				?>
