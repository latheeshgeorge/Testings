...
/*############################################################################
	...
	class productreview_Html
	{
		...
		<div class="pro_det_treemenu" align="left"> <ul>
							<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a>>></li> <li><a href="<?php url_product($product_id,$product_name,-1)?>"><?=$product_name?></a>  >></li><li><?=$Captions_arr['PRODUCT_REVIEWS']['WRITE_PRODUCT_REVIEW_TREEMENU_TITLE']?></li></ul></div>
		...
		<tr>
          <td colspan="2" class="message_header"><?=$Captions_arr['PRODUCT_REVIEWS']['WRITE_PRODUCT_REVIEW_READREVIEW_TITLE']?></td>
        </tr>
		<?php }  
			...
			<tr>
			<td width="44%" class="addreivewconent"><?=$Captions_arr['PRODUCT_REVIEWS']['WRITE_PRODUCT_REVIEW_AUTHOR']?></td>
			<td width="56%" align="left" valign="middle"><input name="review_author" type="text" class="addreivewinput" id="review_author" size="39" /></td>
			</tr>
			<tr>
			<td width="44%" class="addreivewconent"><?=$Captions_arr['PRODUCT_REVIEWS']['WRITE_PRODUCT_REVIEW_AUTHOR_EMAIL']?></td>
			<td width="56%" align="left" valign="middle"><input name="review_author_email" type="text" class="addreivewinput" id="review_author_email" size="39" /></td>
			</tr>
			<tr>
...
function validate_prodreview(frm)
{
	...
	function Show_Productreview()
		...
		?>
		<div class="pro_det_treemenu" align="left"> <ul>
							<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a>>></li> <li><a href="<?php url_product($product_id,$product_name,-1)?>"><?=$product_name?></a>  >></li><li><?=$Captions_arr['PRODUCT_REVIEWS']['READ_PRODUCT_REVIEW_TREEMENU_TITLE']?></li></ul></div>
		...
		<tr>
          <td colspan="2" class="message_header"><?=$Captions_arr['PRODUCT_REVIEWS']['READ_PRODUCT_REVIEW_READREVIEW_TITLE']?></td>
        </tr>	
		<?php 
		if($_REQUEST['alert']==1)
		{
		...
		<tr>
          <td colspan="2" class="message" align="center"><?=stripslashes($Captions_arr['PRODUCT_REVIEWS']['WRITE_PRODUCT_REVIEW_ADDED_SUCCESSFULLY'])?></td>
        </tr>
