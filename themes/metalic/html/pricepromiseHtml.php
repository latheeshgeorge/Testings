...
/*############################################################################
 ...
 ?>
		...
		<td colspan="2">
			...
			<ul>
			<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a>  &gt;&gt;</li> <? if($product_id){?> <li><a href="<?php url_product($product_id,$prod_name,-1)?>"><?=$prod_name?></a>  &gt;&gt;</li> <? }?>  <li><?=$Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_TREEMENU_TITLE']?></li>
			</ul>
			</div>
		  </td>
		</tr>
		...
		<tr>
					...
					<td class="regvalue" width="50%" align="left" valign="middle">: <?=$row_prod['manufacture_id']?>
					...
					<td class="regvalue" width="50%" align="left" valign="middle">: <?=$row_prod['product_model']?>
					...
					<td class="regvalue" width="50%" align="left" valign="middle">: <?=$row_prod['promise_price']?>
					...
					<td class="regvalue" width="50%" align="left" valign="middle">
		...
		<?php
				 ...
				 if ($db->num_rows($ret_elem))//Section for count of elements from show_dynamic_fields.php
					...
					?>
					  ...
					  <input name="pricepromise_submit" type="submit" class="buttongray" id="pricepromise_submit" value="<?=$Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_SUBMIT_REQ']?>"/>
			...
			?>
					...
					<input type="hidden" name="search_click" value="search_click" />
							...
							<td colspan="5">
								<div class="pro_det_treemenu">
								<ul>
								<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a>  &gt;&gt;</li> <li><?=$Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_DETAILS_HEADER']?></li>
								</ul>
								</div>
							  </td>
							</tr>
		...
		function Show_Mypricepromise_details($prom_id=0,$alert='')
		{
			...
			?>
				...
				<li><a href="<?php url_link('mypricepromise.html')?>"><?=stripslashes($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_DETAILS_HEADER'])?></a> >></li>
				<li><?php echo stripslash_normal($Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_DETAILS_HEADER_SUB'])?></li></ul>
				</div>
				</td>
				</tr>
				<tr>
