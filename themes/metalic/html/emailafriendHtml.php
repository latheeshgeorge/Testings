...
/*############################################################################
	...
	class emailafriend_Html
	{
		...
		?>
      	...
      	<div class="pro_det_treemenu" align="left"> <ul>
							<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a>>></li> <li><a href="<?php url_product($product_id,$product_name,-1)?>"><?=$product_name?></a>  >></li><li><?=$Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_TREEMENU_TITLE']?></li></ul></div>
  ...
  <tr>
    <td width="31%" class="emailfriendtext"><?=stripslashes($Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_FRIEND_NAME'])?><br /></td>
    <td width="69%" align="left" valign="middle" class="emailfriendtext"><input name="friend_name" type="text" class="addreivewinput" id="friend_name" size="32" value="<?=$_REQUEST['friend_name']?>"
	/></td>
  </tr>
  <tr>
