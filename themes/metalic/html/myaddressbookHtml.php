				  ...
				  <table width="100%" border="0" cellpadding="0" cellspacing="2"  >
					  <tr>
						...
						<div class="pro_det_treemenu" align="left"> <ul>
							<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a>>></li> <li><?php echo $Captions_arr['ADDRESSBOOK']['TREE_MENU_ADDRESSBOOK']?></li></ul></div>
					  </tr>
		...
		function Add_AddressBook(){
				  ...
				  <table width="100%" border="0" cellpadding="0" cellspacing="2" class="shoppingcarttable">
					  <tr>
						<td  align="left" valign="middle" colspan="6">
						 <div class="pro_det_treemenu" align="left"> <ul>
							<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a>>></li> <li> <a href="<? url_link('myaddressbook.html');?>"><?php echo $Captions_arr['ADDRESSBOOK']['TREE_MENU_ADDRESSBOOK'];?></a> >></li><li> <?php echo $Captions_arr['ADDRESSBOOK']['TREE_MENU_ADD_ADDRESSBOOK']?></li></ul></div>
						</td>
					  </tr>
			...
			<?php
				...
				?>
					  ...
					  <tr>
					    <td  colspan="2"  align="right" class="regiconent" ><?php echo $Captions_arr['ADDRESSBOOK']['TITLE'];?></td>
					    <td  align="center" class="regiconent" >:</td>
			...
			<option value="M/S." <?=($_REQUEST['customer_title']=='M/S.')?"selected":''?>>M/S.</option>
					  ...
					  <tr>
					    <td  colspan="2"  align="right"  class="regiconent"><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_FNAME'];?><span class="redtext">*</span> </td>
					    <td  align="center" class="regiconent">:</td>
					    <td  align="left" class="regiconent"><input type="text" name="txt_fname" value="<?=$_REQUEST['txt_fname'] ?>" maxlength="<?=$short?>"/></td>
				    </tr> 
					  <tr>
					    <td  colspan="2"  align="right" class="regiconent"><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_MNAME'];?></td>
					    <td  align="center" class="regiconent">:</td>
					    <td  align="left" class="regiconent"><input type="text" name="txt_mname" value="<?=$_REQUEST['txt_mname'] ?>" maxlength="<?=$short?>"/></td>
				    </tr>
					  <tr>
					    <td  colspan="2"  align="right" class="regiconent"><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_LNAME'];?><span class="redtext">*</span> </td>
					    <td  align="center" class="regiconent">:</td>
					    <td  align="left" class="regiconent"><input type="text" name="txt_lname" value="<?=$_REQUEST['txt_lname'] ?>" maxlength="<?=$short?>"/></td>
				    </tr>
					  <tr>
					    <td  colspan="2"  align="right" class="regiconent"><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_ADDRESS'];?></td>
					    <td  align="center" class="regiconent">:</td>
					    <td  align="left" class="regiconent"><textarea name="address" cols="25" rows="5"><?=$_REQUEST['address'] ?></textarea></td>
				    </tr>
				      <tr>
				        <td  colspan="2"  align="right" class="regiconent"><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_EMAIL'];?><span class="redtext">*</span></td>
				        <td  align="center" class="regiconent">:</td>
				        <td  align="left" class="regiconent"><input type="text" name="email" value="<?=$_REQUEST['email'] ?>" maxlength="<?=$medium?>"/></td>
			        </tr>
				      <tr>
				        <td  colspan="2"  align="right" class="regiconent"><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_PHONE'];?></td>
				        <td  align="center" class="regiconent">:</td>
				        <td  align="left" class="regiconent"><input type="text" name="phonenumber" value="<?=$_REQUEST['phonenumber'] ?>" maxlength="<?=$short?>"/></td>
			        </tr>
			          <tr>
			            <td  colspan="2"  align="right" class="regiconent"><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_MOBILE'];?></td>
			            <td  align="center" class="regiconent">:</td>
			            <td  align="left" class="regiconent"><input type="text" name="mobnumber" value="<?=$_REQUEST['mobnumber'] ?>" maxlength="<?=$short?>"/></td>
		            </tr>
		            <tr>
					 <td  colspan="2"  align="right" class="regiconent"><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_FAX'];?></td>
				     <td width="5%"  align="center" class="regiconent">:</td>
				     <td width="51%"  align="left" class="regiconent"><input type="text" name="faxnumber" value="<?=$_REQUEST['faxnumber'] ?>" maxlength="<?=$short?>"/></td>
					</tr>
				   ...
				   <tr>
				     <td align="center" valign="middle" class="shoppingcartcontent" colspan="4" ><input class="buttonred_cart" type="button" name="Submit" value=" <?php echo $Captions_arr['ADDRESSBOOK']['ADD_ADDRESS'];?> " onclick="javascript:add_newaddress(document.add_address)" /></td>
			        </tr>	
				</table>
				</form>	
				<script language="javascript">
		   ...
		   frm.submit();
			...
			<option value="M/S." <?=($customer_title=='M/S.')?"selected":''?>>M/S.</option>
					  ...
					  <tr>
					    <td  colspan="2"  align="right" class="regiconent"><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_FNAME'];?> <span class="redtext">*</span> </td>
					    <td  align="center" class="regiconent">:</td>
					    <td  align="left" class="regiconent"><input type="text" name="txt_fname" value="<?PHP echo $row['address_fname']; ?>" maxlength="<?=$short?>"/></td>
				    </tr> 
					  <tr>
					    <td  colspan="2"  align="right" class="regiconent"><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_MNAME'];?>  </td>
					    <td  align="center" class="regiconent">:</td>
					    <td  align="left" class="regiconent"><input type="text" name="txt_mname" value="<?PHP echo $row['address_mname']; ?>" maxlength="<?=$short?>"/></td>
				    </tr>
					  <tr>
					    <td  colspan="2"  align="right" class="regiconent"><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_LNAME'];?><span class="redtext">*</span> </td>
					    <td  align="center" class="regiconent">:</td>
					    <td  align="left" class="regiconent"><input type="text" name="txt_lname" value="<?PHP echo $row['address_lname']; ?>" maxlength="<?=$short?>"/></td>
				    </tr>
					  <tr>
					    <td  colspan="2"  align="right" class="regiconent"><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_ADDRESS'];?></td>
					    <td  align="center" class="regiconent">:</td>
					    <td  align="left" class="regiconent"><textarea name="address" cols="25" rows="5"><?PHP echo $row['address_address']; ?></textarea></td>
				    </tr>
				      <tr>
				        <td  colspan="2"  align="right" class="regiconent"><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_EMAIL'];?><span class="redtext">*</span></td>
				        <td  align="center" class="regiconent">:</td>
				        <td  align="left" class="regiconent"><input type="text" name="email" value="<?PHP echo $row['address_email']; ?>"  maxlength="<?=$medium?>"/></td>
			        </tr>
				      <tr>
				        <td  colspan="2"  align="right" class="regiconent"><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_PHONE'];?></td>
				        <td  align="center" class="regiconent">:</td> 
				        <td  align="left" class="regiconent"><input type="text" name="phonenumber" value="<?PHP echo $row['address_phone']; ?>" maxlength="<?=$short?>"/></td>
			        </tr>
			          <tr>
			            <td  colspan="2"  align="right" class="regiconent"><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_MOBILE'];?></td>
			            <td  align="center" class="regiconent">:</td>
			            <td  align="left" class="regiconent"><input type="text" name="mobnumber" value="<?PHP echo $row['address_mobile']; ?>"  maxlength="<?=$short?>"/></td>
		            </tr>
		            <tr>
					 <td  colspan="2"  align="right" class="regiconent"><?php echo $Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_FAX'];?> </td>
				     <td width="5%"  align="center" class="regiconent">:</td>
				     <td width="51%"  align="left" class="regiconent"><input type="text" name="faxnumber" value="<?PHP echo $row['address_fax']; ?>"  maxlength="<?=$short?>"/></td>
					</tr>
				   ...
				   <tr>
				     <td align="center" valign="middle" class="shoppingcartcontent" colspan="4" ><input class="buttonred_cart" type="button" name="Submit" value=" <?=$Captions_arr['ADDRESSBOOK']['ADDRESSBOOK_UPDATE']?> " onclick="javascript:update_newaddress(document.edit_address)" /></td>
			        </tr>	
				</table>
				</form>	
				<script language="javascript">
