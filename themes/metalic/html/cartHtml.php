			...
			<?php
			  ...
			  <tr>
				...
				<div class="pro_det_treemenu" align="left"> <ul>
							<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a>>></li> <li><?php echo $Captions_arr['CART']['CART_MAINHEADING']?></li></ul></div>
				</td>
		...
		<?php
		  ...
		  ?>
         	 	...
         	 	<tr>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="1">
<tr>
	<td class="shoppingcartcontent" valign="top"><b><?php echo $Captions_arr['CART']['CART_SHOPPED_BEFORE']?>?</b><br />Please enter your details below to sign in  </td>
	<td width="34%" class="shoppingcartcontent">&nbsp;</td>
	<td width="45%" class="shoppingcartcontent" valign="top">
	<?php
		...
		?>	
			...
			<?php
			  ...
			  <tr>
				<td colspan="6" align="left" valign="middle">
				<div class="pro_det_treemenu" align="left"> <ul>
							<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a>>></li> <li><?php echo $Captions_arr['CART']['CART_CHECKOUTHEADING']?></li></ul></div>
				</td>
			  </tr>
			  <tr>
				<td align="left" valign="middle" class="shoppingcartheader"><?php echo $Captions_arr['CART']['CART_ITEM']?></td>
...
//				$cont_class = 'shoppingcartcontent_noborder'; 
		...
		?>	
			...
			?>
			  <tr>
				<td colspan="6" align="left" valign="middle">
				<div class="pro_det_treemenu" align="left"> <ul>
							<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a>>></li> <li><?php echo $Captions_arr['CART']['CART_CHECKOUTPREVIEWHEADING']?></li></ul></div>
				</td>
			  </tr>
		...
		?>
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="shoppingcarttable">
			  <tr>
				...
				<div class="pro_det_treemenu" align="left"> <ul>
							<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a>>></li> <li><?php echo $Captions_arr['CART']['CART_CHECKOUT_SUCCESS_TITLE']?></li></ul></div>
				</td>
			  </tr>
			  <tr>
		...
		?>
			...
			<tr>
				<td align="left" valign="middle">
				<div class="pro_det_treemenu" align="left"> <ul>
							<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a>>></li> <li><?php echo $Captions_arr['CART']['CART_CHECKOUT_FAILED_TITLE']?></li></ul></div>
				</td>
			</tr>
			<?php
				if($msg)
