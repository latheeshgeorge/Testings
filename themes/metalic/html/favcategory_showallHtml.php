	...
	class categoryshowall_Html
	{
		...
		function Show_favcatproducts($catid,$catname)
		{
			...
			<?
				...
				{
				?>
				<div class="shelf_1row_header"><a href="<?php url_category($catid,$catname,-1,$_REQUEST['catgroup_id'],0)?>" class="categoreyname_headerlink" title="<?php echo stripslashes($catname)?>"><?php echo stripslashes($catname)?></a></div>
		 ...
		 $prodcurtd_arr[] = $product_array;
			...
			?>
			                  <div class="shelf_main">        
											...
											<div class="shelf_1row_name"><a href="<?php url_product($product_array['product_id'],$product_array['product_name'],-1)?>" title="<?php echo stripslashes($product_array['product_name'])?>"><?php echo stripslashes($product_array['product_name'])?></a></div>
												
											<div class="shelf_1row_content"><?php echo stripslashes($product_array['product_shortdesc'])?> </div>
											...
											<input type="hidden" name="fproduct_url" value="<?php url_product($product_array['product_id'],$product_array['product_name'])?>" />							
											  <ul class="shelf_button">
												<li class="shelf_button_li">
												  <div class="more_div">
												   <?php show_moreinfo($product_array,'button_yellow')?>
												  </div>
												 <?php
													$class_arr 					= array();
													...
													show_addtocart($product_array,$class_arr,$frm_name,'','','',$class_div)
												  ?>
												</li>
											  </ul>
											</form>
			  ...
			  <?php /*?><tr onmouseover="this.className='normalshelf_hover'" onmouseout="this.className='shelfBtabletd'">
