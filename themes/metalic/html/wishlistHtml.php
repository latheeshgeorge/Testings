		...
		<form method="post" name="frm_wishlist" class="frm_cls" action="<?php url_link('wishlist.html')?>">
			...
			if($db->num_rows($ret_select_wish))
				...
				<div class="pro_det_treemenu" align="left"> <ul>
							<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a>>></li> <li><?php echo $Captions_arr['WISHLIST']['WISHLIST_MAINHEADING']?></li></ul></div>
			  ...
			  <td colspan="3">&nbsp;
			   ...
			   <tr>
					<td align="left" valign="middle" class="shoppingcartheader" ><?php echo $Captions_arr['WISHLIST']['WISHLIST_ITEM']?></td>
					<td align="center" valign="middle" class="shoppingcartheader"><?php echo $Captions_arr['WISHLIST']['WISHLIST_PRICE']?></td>
					<td align="center" valign="middle" class="shoppingcartheader"><?php echo $Captions_arr['WISHLIST']['WISHLIST_ACTION']?></td>
		 	  </tr>
		  <?php
				if($db->num_rows($ret_select_wish))
				{  
