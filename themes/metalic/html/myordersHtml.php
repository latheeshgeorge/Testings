	...
	if ($from_date or $to_date)
	{
		...
		//print_r($ord_array );
		  ...
		  <table width="100%" border="0" cellpadding="3" cellspacing="0" >
			  <tr>
				<td colspan="12" align="left" valign="middle"><div class="pro_det_treemenu" align="left"> <ul>
							<li><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a>>></li> <li><?php echo $Captions_arr['ORDER']['ORDER_MAINHEADING']?></li></ul></div>
				</td>
		      </tr>
              <tr>
