...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="main">
  ...
  include(ORG_DOCROOT."/themes/$ecom_themename/modules/mod_header.php");
 ?>
  <tr>
    <td align="center" valign="top" class="content_main" style="background:url(<?php echo $header_arr['img']?>);background-repeat:no-repeat;"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="content_table">
     <?
	...
	?>
	    <tr>
          <td align="left" valign="top" class="content_table_left">
	  <?php
	...
	?>
          ...
          <td align="left" valign="top" class="content_table_right">
		  <?php
	  	// Showing the left components
		 $position = 'right_col2';
		include("Components.php");
