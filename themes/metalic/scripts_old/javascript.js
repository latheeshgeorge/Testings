...

{
	...
	if(document.getElementById('newsletter_Vimg')) {
		...
		fieldRequired 		= Array('newsletter_title','newsletter_name','newsletter_email','newsletter_Vimg'); /*   */

		fieldDescription 	= Array('Title','Name','Email Id','Image Verification Code');

	} else {

		fieldRequired 		= Array('newsletter_title','newsletter_name','newsletter_email');

		fieldDescription 	= Array('Title','Name','Email Id');
