...
function handle_expland_comp(obj,id)
{
	curobj = eval ("document.getElementById('"+id+"')");
	if (curobj.style.display=='block') /* Case if currently in expanded mode, so collapse*/
	{
		obj.className 			= 'shelf_default';
		curobj.style.display 	= 'none';
	}
	else /* Case if currently in collapsed mode, so expand*/
	{
		obj.className 			= 'shelf_select';	
