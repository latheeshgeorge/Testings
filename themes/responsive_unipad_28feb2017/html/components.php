					...
					{ 
						...
						?>
                                    ...
                                    if ($grpData['group_showhomelink']==1)
                                    {
                                        ...
                                        <li class="is-active"><a href="<?php url_link('')?>" class="home_linkm"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> <span class="glyphicon-class"></span></a></a>
                                    ...
                                    $target = ($row_pg['page_link_newwindow']==1 and $row_pg['page_type']!='Page')?'target="_blank"':'';
										...
										{
										?>	
											<li><a href="javascript:hansubmenu()" class="linkred"><?php echo stripslash_normal($row_pg['title'])?><b class="caret" id="caret_menu" style="display:none"></b></a>
											<ul class="nav1 collapse" role="menu" aria-labelledby="allprobbtn-1" style="display:none;" id="allpropsubmenu1">
												<li><a class="fa fa-caret-right" href="http://www.unipad.co.uk/just-rooms-pg50458.html"> Just Rooms</a></li>
												<li><a class="fa fa-caret-right" href="http://www.unipad.co.uk/1-bed-pads-pg50354.html"> 1 Bed Pads</a></li>
												<li><a class="fa fa-caret-right" href="http://www.unipad.co.uk/couples-pads-pg50459.html"> Couple Bed Pads</a></li>
												...
												<li><a class="fa fa-caret-right" href="http://unipad.bshop4.co.uk/view-all-pads-pg50461.html"> View All Pads</a></li>
											</ul>
											</li>
										<?php	
										}
				...
				/*
			       ...
			       <div class="newsletter_bottom">
                            ...
                            */
                            ?>
                            <ul class="bannerads">
<li class="callback_ads_li"><a href="<?php echo url_link('callback.html')?>"><img src="<?php echo url_site_image('requestACallback.png');?>" alt="Request A Call-back"  usemap="#Map2" border="0" /></a><span class="reqacallback">Request a callback</span></li>
<li class="callback_news_li"
 <div class="newsletter_bottom_new">
                            <form name="frm_newsletter" method="post" action="" class="frm_cls" onsubmit="return newsletter_validation(this)">
                                <div class="news_header_new"><span><?=stripslash_normal($Captions_arr['NEWS_LETTER']['NEWSCUSTOMER_DETAILS_HEADER'])?></span></div>
                                <div class="newsletter_input_new"> <input name="newsletter_email" type="text" class="newsletter_input_in" id="newsletter_email" value="Enter Email" onblur="if(document.frm_newsletter.newsletter_email.value=='') {document.frm_newsletter.newsletter_email.value='Enter Email'}" onclick="javascript:document.frm_newsletter.newsletter_email.value=''"  />
                                 <?php
							if($Settings_arr['imageverification_req_newsletter']) // if image verification is required
							{
							?>
