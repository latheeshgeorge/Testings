...
<div class="zoom-wrapper">
<div class="zoom-left">
	<a class="fancybox" href="<?php echo url_root_image($prodimg_arr[0]['image_extralargepath'],1)?>" data-fancybox-group="gall_1" title="<?php echo stripslashes($row_prod['product_name'])?>" alt="<?php echo stripslashes($row_prod['product_name'])?>">
<img style="border:1px solid #e8e8e6;" id="zoom_09" src="<?php url_root_image($prodimg_arr[0]['image_bigpath'])?>"  width="411">
</a><?php 
		...
		else
		{
			...
			?>
				...
				{ 
					$cntg++;
				?>
				<a class="fancybox" href="<?php echo url_root_image($v['image_extralargepath'],1)?>" data-fancybox-group="gall_1" title="<?php echo stripslashes($v['product_name'])?>" alt="<?php echo stripslashes($v['product_name'])?>">
				<?php
