...
define("IMG_SIZE",3);
define("CONTAINER_CLASS",'container-fluid');
					...
					while ($row_grp = $db->fetch_array($ret_grp))
					{
						...
						{ 	
							...
							while($row_labels = $db->fetch_array($ret_labels))
							{
								...
								{	$label_image	=	'icon_double_bed_no_name.svg';	
									if($mod['source'] == 'shelf' || $mod['source'] == 'list')
									{
										$label_image ="";
									$shelf_img 		= 	'icon_double_bed_no_name.svg';	
									$shelf_label_name = $label_name;
									$shlf_imgstr .= "<div class='mainfeat'>
									<span class=\"market-title\"><img src=\"".url_site_image($shelf_img,1)."\" alt=\"".$label_name."\"></span>
									<span class=\"market-xst\">".$shelf_label_name."</span></div>";
								    }          
								}
								if(strtolower(str_replace(' ','',$row_labels['label_name'])) == "bathroom")
								{	$label_image	=	'icon_bathroom.svg';
									if($mod['source'] == 'shelf' || $mod['source'] == 'list')
									{
									$label_image ="";
									$shelf_img 		= 	'icon_bathroom.svg';
									$shelf_label_name = $label_name;
									$shlf_imgstr .= "<div class='mainfeat'>
									<span class=\"market-title\"><img src=\"".url_site_image($shelf_img,1)."\" alt=\"".$label_name."\"></span>
									<span class=\"market-xst\">".$shelf_label_name."</span></div>";								    }
								...
								{	$label_image	=	'feature_body_jet.svg';		}
								if(strtolower(str_replace(' ','',$row_labels['label_name'])) == "citycentre")

								{	$label_image	=	'feature_city_centre.svg';	
									
									if($mod['source'] == 'list' || $mod['source'] == 'shelf')
									{
										$label_image ="";
									$shelf_img 		= 	'feature_city_centre.svg';
									$shelf_label_name = $label_name;
									$shlf_imgstr .= "<div class='mainfeat'>
									<span class=\"market-title\"><img src=\"".url_site_image($shelf_img,1)."\" alt=\"".$label_name."\"></span>
									<span class=\"market-xst\">".$shelf_label_name."</span></div>";
								...
								{	$label_image	=	'icon_ensuit.svg';	
									if($mod['source'] == 'list' || $mod['source'] == 'shelf')
									{
										$label_image ="";
									$shelf_img 		= 	'icon_ensuit.svg';
									$shelf_label_name = $label_name;
									$shlf_imgstr .= "<div class='mainfeat'>
									<span class=\"market-title\"><img src=\"".url_site_image($shelf_img,1)."\" alt=\"".$label_name."\"></span>
									<span class=\"market-xst\">".$shelf_label_name."</span></div>";
								...
								if(strtolower(str_replace(' ','',$row_labels['label_name'])) == "sportsgym")
								{
									...
									{
										$label_image ="";
									$shelf_img 		= 	'feature_Gym_centre_p.svg';
									$shelf_label_name = $label_name;
									$shlf_imgstr .= "<div class='mainfeat'>
									<span class=\"market-title\"><img src=\"".url_site_image($shelf_img,1)."\" alt=\"".$label_name."\"></span>
									<span class=\"market-xst\">".$shelf_label_name."</span></div>";
								...
								if(strtolower(str_replace(' ','',$row_labels['label_name'])) == "weeklycleaningservice" )
								...
								*/ 
								...
								{	$label_image	=	'feature_fibre.svg';		}
								if(strtolower(str_replace(' ','',$row_labels['label_name'])) == "wirelessinternet")
								{	$label_image	=	'feature_WIFI.svg';		}
								//if(strtolower(str_replace(' ','',$row_labels['label_name'])) == "lettingperiod")
								//{	$label_image	=	'feature_50_week.svg';		
									/*if($mod['source'] == 'list' || $mod['source'] == 'shelf')
									{
										$label_image ="";
									$shelf_img 		= 	'feature_50_week.svg';
									$shelf_label_name = $label_name;
									$shlf_imgstr .= "<li>
									<span class=\"market-title\"><img src=\"".url_site_image($shelf_img,1)."\"></span>
								...
								if($row_labels['label_name']!="Walkable" and $label_image!='')
								{
									/*if(strtolower(str_replace(' ','',$row_labels['label_name'])) == "monthlycleaningservice")
									{
										...
										{
											$imageall_str .=  "<li>
											<span class=\"market-title\"><img src=\"".url_site_image($label_image,1)."\" alt=\"".$label_name."\"></span>
							...
							if($shlf_imgstr !='')
								...
								echo "<div class=\"shlf_imgstr_outer\"><div class=\"mobile-home-nav\">".$shlf_imgstr."</div></div>";
								/*if($imageall_str!='')
								{
							...
							<ul class=\"mobile-home-nav\">";
								...
								*/
								...
								?>
  <div class="dropdown">
    <button class="btn sample btn-lg btn-sample dropdown-toggle" id="menu<?php echo $prod_id.$num;?>" type="button" data-toggle="dropdown"><?php echo $heading_featur;?>
    <span class="caret"></span></button>
    <ul class="dropdown-menu mobile-home-nav" role="menu" aria-labelledby="menu<?php echo $prod_id.$num;?>">
      <?php echo $imageall_str;?>      
    </ul>
  </div>
								<?php
							} 
...
function show_MoreImages_Unipad($row_prod,$exclude_tabid=0,$exclude_prodid=0)
{
	...
	?>	
		...
		<div class="det_thumbimg_nav"><a href="#null" onmouseover="scrollDivRight('containerB-<?=$row_prod['product_id']?>')" onmouseout="stopMe()"><img src="<?php url_site_image('shlf-arw-l.gif')?>"></a></div>
		<div id="containerB-<?=$row_prod['product_id']?>" class="det_thumbimg_inner">
			...
			?>
				<div class="det_thumbimg_pdt">
					...
					?>
					<img src="<?php echo url_root_image($v[$pass_type],1)?>" id ="<?php echo $moreimg_id?>" data-extra="<?php echo url_root_image($v['image_thumbpath'],1)?>">
					</a>
					</div>
				</div>
			<?php
		...
		<div class="det_thumbimg_nav"> <a href="#null" onmouseover="scrollDivLeft('containerB-<?=$row_prod['product_id']?>',<?php echo (count($prodimg_arr)*90)?>)" onmouseout="stopMe()"><img src="<?php url_site_image('shlf-arw-r.gif')?>"></a></div>
		</div>
		</div>	
	<?php
	}
