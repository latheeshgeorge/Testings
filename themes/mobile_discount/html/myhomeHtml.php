		...
		<tr>
			...
			<td class="shlf_td_1row_desc">
				<div class="shlf_table_1row_otr"> 
					...
					<a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" title="<?php echo stripslashes($row_prod['product_name']);?>" class="shlf_1row_link"><?php echo stripslash_normal($row_prod['product_name']);?></a></div> 
