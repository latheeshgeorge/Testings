<?php
	...
	class cart_Html
	{
		...
		{ 
			...
			{
				$this->show_error_msg($cart_alert,$_REQUEST['ver']);
				$cart_alert = '';
			}	
                ...
                <td class="tda"> 
								...
								foreach($products_arr["prod_vars"] as $productVars)
                                {
                                    if (trim($productVars['var_value'])!='')
									{
										...
										if(count($tc_return_arr))
										{
											...
											{
													$caption = "I have read and agree to the <a style='color:#000;' href='javascript:show_pdf_new(\"".$tc_return_arr['key']."\")'>Key Facts</a> and <a style='color:#000;' href='javascript:show_pdf_new(\"".$tc_return_arr['link']."\")'>TOB</a>";
											}
											else
											{
													$caption = "I have read and agree to the <a style='color:#000;' href='javascript:show_pdf_new(\"".$tc_return_arr['key']."\")'>Key Facts</a> and <a style='color:#000;' href='javascript:show_pdf_new(\"".$tc_return_arr['link']."\")'>IDD</a>";
											}
                    ...
                    */ 
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="gtable">
                        ...
                        ?>
                        <tr>
                        <td  class="tdbgry"><span class="readdelivery_info" id="readdelivery_info">Read Delivery Info &nbsp;- &nbsp;</span><?php echo stripslash_normal($Captions_arr['CART']['CART_DELIVERY_OPT'])?>
                         <style>
.modal {
...
.close:focus {
	...
	.readdelivery_info {     font-size: 12px;    cursor: pointer;}
	 
	
</style>
<div id="myModaldisc" class="modal">

  <!-- Modal content -->
  <div class="modal-content">
    <span class="close">&times;</span>
    <p>Please Note: Some Mobility Products Can Be Heavy To Lift, And The Free Standard Delivery Service Will Be By Courier Service To Your Doorstep Only. It Will Be Your Own Responsibility To Move The Mobility Product Into Your Own Home Or Place Of Storage. Please Ensure That You Have Made Arrangements for Your Delivery Option.
Alternatively Select Engineered Delivery During Checkout, And a Discount Mobility Engineer Will Deliver and Install Your Mobility Product In Your Home For You</p>
  </div>

</div>
<script>
// Get the modal
var modal = document.getElementById('myModaldisc');

// Get the button that opens the modal
var btn = document.getElementById("readdelivery_info");
            ...
            <div class="cartbgdisable">
             ...
             ?>
              ...
              <div class="disableshipwrap">
				...
				?>	
						 <tr>
						 <td class="tdbgry"><span class="shoppingcartpriceOtr"><?php echo $Captions_arr['CART']['CART_DISABILITY']?></span></td>
						 </tr>
						 <tr>
						 <td class="tdbgry"> 
...
If you need further clarification please feel free to contact the team at any time on the number 01245 905 144 and our advisors will gladly be of assistance to you.
		  ...
		  <?php
                        ...
                        <tr>
                            ...
                            <td class="tdbgry" align="right"><span class="fbig"><?php echo print_price($cartData["totals"]["bonus_price"],true)?></span></td>
                        </tr>
                        <?php
                        }
                        ...
                        <tr>
                            ...
                            <td class="tdbgry" align="right"><?php echo print_price($str_reduceval,true)?></td>
                        </tr>
                        <tr>
                            <td class="tdbgry"><?php echo $Captions_arr['CART']['CART_TOTAL_AMT_NOW']?>&nbsp; </td>
                            <td class="tdbgry" align="right"><?php echo print_price($rem_val,true)?>
                    ...
                    if ($db->num_rows($ret_paytypes))
                    {
                    	...
                    	else
						{
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class="gtable">
                                ...
                                <tr>
                                    <td class="td_paymentmaintd">
                                    <table width='100%' cellpadding='0' cellspacing='0' border='0'>

								<?php
								
								//echo "paytype code - ".$row_cartdet['paytype_id'];echo "<br><br><br>";
								$tenper_deposit = 0;
								$fiftyper_deposit = 0;
								 // Settings condition commented
								 //if($finance_available==true)
		  	{
				...
				if($db->num_rows($ret_pcheck))
				{
					...
					<tr>
						<td colspan="6" align="left" valign="middle">
							<br><br>
						<table style="width:100%;border:0;background-color:#fff;">
						<tr>
						<td style="font-size:11px;font-weight:bold;" colspan="2">
						Will I Qualify for Credit?<br/><br/>We can only consider your finance application if:
						</td>
						</tr>
						<tr>
						<td style="padding-left:8px;font-weight:bold;" colspan="2">
						...
						<td class="">
							You are 18 or over, and employed at least 16 hours per week.<br>
						...
						<tr>
						<td colspan="2" style="padding-left:8px;padding-top:6px;">
							*&nbsp; Applications from students (unless employed at least 16 hours per week), unemployed and unemployed single house persons will not be considered &nbsp;*&nbsp;<br/><br/>
							<span style='font-size:11px;font-weight:bold;'>*&nbsp;If you do not meet the above requirements, consider asking a family member or relative to apply for credit on your behalf&nbsp;*</span>
						</td>
						</tr>
...
.finwrap3Year{
	...
	height:233px;
	background:#e2fcf1;
	padding:6px 0px 0px 5px;	margin-right:10px;	padding-top:15px;
}
...
.finwrap4Year{
	...
	height:233px;
	background:#ebf5fe;
	padding:6px 0px 30px 5px;	margin-right:10px;	padding-top:15px;
}
...
<script  type="text/javascript" src="https://test.dekopay.com/js/libraries/jquery/jquery-3.3.1.min.js"></script>
		...
		function Show_Checkout()
		{
			...
			if($row_cartdet['paytype_id']==3)
	        {  
				$sql_verific = "SELECT invoice_verification_code FROM general_settings_sites_common_onoff WHERE sites_site_id = 104 ";
										$ret_verific =  $db->query($sql_verific);
										$row_verific = $db->fetch_array($ret_verific);
										$verific_code = $row_verific['invoice_verification_code'];
    				/*if($row_cartdet['invoice_verification_code']=='')
    				{						
					echo "<form method='post' action='http://$ecom_hostname/cart.html' id='cart_invalid_verification' name='cart_invalid_verification'><input type='hidden' name='hold_section' value='#incomp' size='1'/><div style='position:absolute; left:0;top:0;padding:5px;background-color:#CC0000;color:#FFFFFF;font-size:12px;font-weight:bold'>Loading...</div></form><script type='text/javascript'>document.cart_invalid_verification.submit();</script>";
					exit;
					}
					else 
					*/
					if(trim($row_cartdet['invoice_verification_code'])!=$verific_code || $row_cartdet['invoice_verification_code']=='')
					{
 					echo "<form method='post' action='".$ecom_selfhttp."$ecom_hostname/cart.html?ver=1' id='cart_invalid_verification' name='cart_invalid_verification'><input type='hidden' name='hold_section' value='#incomp' size='1'/><div style='position:absolute; left:0;top:0;padding:5px;background-color:#CC0000;color:#FFFFFF;font-size:12px;font-weight:bold'>Loading...</div></form><script type='text/javascript'>document.cart_invalid_verification.submit();</script>";
					exit;
					}
			}
									...
									?>	
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        $class_array['txtarea_cls'] = 'regiinput';
                                                                                            echo get_Field($row_checkout['field_key'],$saved_checkoutvals,'','',$class_array);
                                                                                        ?>
                                                                                        </td>
                                                                                    </tr>
                                                                            <?php
									 ...
									 // check whether billing and shipping address can be different in the site.
                                                  ...
                                                  <tr><td align="left" valign="middle" class="td" colspan="2">
													...
													<tr>
                                                       <td align="left" valign="middle" class="td" colspan="2">
														<select name="checkout_billing_same" onchange="handle_billingaddress_change('delivery',document.frm_checkout,0)" class="yselect" >
                                        ...
                                        <td colspan="2" class="td">
                                                      ...
                                                      <tr>
                                                        <td class="tdbgry"><?php echo stripslash_normal($Captions_arr['CART']['CART_QTY'])?>:<?php 
                                                                                                    ...
                                                                                                    ?>	</td>
                                                        <td class="tdbgry" align="right"><span class="fbig"><?php echo print_price($products_arr['final_price'],true)?><span></span></span></td>
                                                      </tr>
													</tbody></table>
													<?php
                                                }
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="gtable">
                                                <tr>
                                                <td align="left" valign="middle" class="td_final"><?php echo stripslash_normal($Captions_arr['CART']['CART_TOTPRICE'])?>&nbsp;</td>
                                                <td align="right" valign="middle" class="tdbgry"><span class="fbig"><?php echo print_price($cartData["totals"]["subtotal"],true)?></span></td>
                                                </tr>
                                                <tr>
                                                <td colspan="2">
                                                ...
                                                ?>	
                                                            <tr>
                                                                <td  align="left" valign="middle" class="td" colspan="2"><?php echo stripslash_normal($Captions_arr['CART']['CART_DELIVERY_LOC'])?> : <span class="black"><?php echo stripslash_normal($row_loc['location_name'])?></span></td>
                                                            </tr>
                                                <?php
                                                        }
                                                    }
                                                ...
                                                ?>	
                                                            <tr>
                                                                <td  align="left" valign="middle" class="td" colspan="2"><?php echo stripslash_normal($Captions_arr['CART']['CART_DELIVERY_OPT'])?> : <span class="black"><?php echo stripslash_normal($row_grp['delivery_group_name'])?></span></td>
                                                            </tr>
                                                <?php
                                                        }
                                                    }	
                                                ...
                                                ?>
                                                 <tr>
                                                    <td  align="left" valign="middle" class="td" colspan="2"><?php echo stripslash_normal($Captions_arr['CART']['CART_TOTAL_POINTS_EARN'])?> : <span class="black"><?php echo $cartData["totals"]["bonus"]?></span></td>
                                                  </tr>
                                                <?php	
                                                }
                                                // show the total final price
												...
												<tr>
												<td  align="left" valign="middle" class="td" colspan="2">		
												<?php echo $Captions_arr['CART']['CART_PAYMENT_TYPE']?>&nbsp;:&nbsp;<?php echo getpaymenttype_Name($cartData['payment']['type']);?>
												</td>
												</tr>
												<?php
												...
												?>
													<tr>
													<td  align="left" valign="middle" class="td" colspan="2">		
													<?php echo $Captions_arr['CART']['CART_GATEWAY_USED']?>&nbsp;:&nbsp;<?php echo getpaymentmethod_Name($cartData['payment']['method']['paymethod_key']);?>
													</td>
													</tr>
												<?php
												}
												...
												?>
													<tr>
													<td  align="left" valign="middle" class="td" colspan="2">		
													<?php echo $Captions_arr['CART']['CART_FINANCE_OPT']?>&nbsp;:&nbsp;<?php echo $fname_checkout;?>
													</td>
													</tr>
												<?php
												}
												...
												?>
														<tr>
														<td  align="left" valign="middle" class="td" colspan="2">		
														<?php echo $Captions_arr['CART']['CART_DISABILITY_CAPTION']?>&nbsp;:&nbsp;<?php echo stripslashes($row_disb['type']);?>
														</td>
														</tr>
												<?php
													}
                                                ...
                                                <td  align="left" valign="middle" class="cartterms">	
													 <p style="padding:15px 10px 15px 10px;font-weight:bold">By clicking on the checkout button you are giving your consent for us to store your data. Your data will be stored safely and not passed onto any third parties</p>		
                                                <?php
    ...
    font-weight: bold;
		...
		order_gift_voucher_number,promotional_code_code_id,promotional_code_code_number,disable_id  
		FROM 
		orders 
		WHERE 
		...
		else
		{
			echo "&nbsp;&nbsp;".$row_orddet["order_qty"];
														...
														?>	</td>
			<td class="tdbgry" align="right"><span class="fbig"><?php echo print_price($row_orddet['order_rowtotal'],true)?></span></td>
		  </tr>
		<?php
		}
		?>	
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" >
		<tr>
		<td align="right" valign="middle" class="td_final"><?php echo stripslash_normal($Captions_arr['CART']['CART_TOTPRICE'])?>&nbsp;</td>
		<td align="right" valign="middle" class="tdbgry"><span class="fbig"><?php echo print_price($row_ord["order_subtotal"],true)?></span></td>
		</tr>
		 <?php
		...
		?>	
		<tr>
		<td align="left" valign="middle" class="cart_td_normal" colspan="2"><?php echo stripslash_normal($Captions_arr['CART']['CART_DELIVERY_LOC'])?>: <span class="black"><?php echo stripslash_normal($row_ord['order_deliverylocation'])?></span></td>
		</tr>
		<?php
		}
		// Check whether any delivery group exists for the site
		...
		?>	
		<tr>
		<td align="left" valign="middle" class="cart_td_normal" colspan="2"><?php echo stripslash_normal($Captions_arr['CART']['CART_DELIVERY_OPT'])?>: <span class="black"><?php echo stripslash_normal($row_ord['order_delivery_option'])?></span></td>
		</tr>
		<?php
		}	
		...
		?>
		<tr>
		<td align="left" valign="middle" class="cart_td_normal" colspan="2"><?php echo stripslash_normal($Captions_arr['CART']['CART_TOTAL_POINTS_EARN'])?>: <span class="black">: <?php echo $row_ord["order_bonuspoint_inorder"]?></span></td>
		</tr>
		<?php	
		}
		// show the total final price
...
<?php /*?>		<tr>
		...
		function show_error_msg($msg,$ver=0)
		{
			global $Captions_arr;
		...
		?>
			...
			?>
			<span class="carterrormsg_msg">
			Verification code Incorrect for Invoice!!!
			<?php
			}
			?>
			</div>
