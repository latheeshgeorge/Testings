	   ...
	   ?>
           ...
           <div class="reg_shlf_pdt_con"> 
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="reg_table">
			  ...
			  <tr>
				<td class="regi_txtfeildA" align="left" valign="top"><?=stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_DET_ADDRESS'])?>  <span class="redtext">*</span></td>
				</tr>
				<tr>
			  ...
			  * <?php */?>
			  <tr>
				<td class="regi_txtfeildA" align="left" valign="top"><?=stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_DET_STATE'])?>  <span class="redtext">*</span></td>
				</tr>
				<tr>
				<td align="left" valign="top" class="regi_txtfeildA">
			  ...
			  <tr>
				<td class="regi_txtfeildA" align="left" valign="top"><?=stripslash_normal($Captions_arr['ENQUIRE']['ENQUIRE_DET_PCODE'])?>  <span class="redtext">*</span></td>
				</tr>
				<tr>
  ...
  ?>
    ...
    function expand_date()
    {
		    ...
		    document.getElementById("datetrtd").className += " ordoptionsA";
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="search_areaTable">
						...
						Date between<br />
					<input name="srch_review_startdate" id="datepicker" class="textfeild_ord" type="text" size="10" value="<?php echo $_REQUEST['srch_review_startdate']?>" />
					 and 
		...
		function myenquiry_EnquiryDetails($enqid)
		{
			...
			<td  align="right"   class="shoppingcartcontent" width="28%">Date:</td><td align="left"  class="enquiryheaderAb" width="20%"><?=$row_enq['added_date']?></td>
			<td class="td_blank">&nbsp;</td>
			<td  align="right"   class="shoppingcartcontent" width="25%">Status:</td><td align="left" class="enquiryheaderAb"><?=$row_enq['enquiry_status']?></td>
			<td class="td_blank">&nbsp;</td>
