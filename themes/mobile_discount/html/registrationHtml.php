...
?>
	...
	<div class="inner_con"  id="companydetails" style="display:none;" >
            ...
            <tbody>
			  <?php
					...
					{	
						...
						?>
							 <tr>
								<td class="regi_txtfeildA" valign="middle" align="left" colspan="2">
		 ...
		 <div class="reg_shlf_outr">
	  	 ...
	  	 <table class="reg_table" width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				?>
              <tr>
                <td class="regi_txtfeildA" valign="middle" align="left" colspan="2"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_EMAIL'])?><span class="redtext">*</span></td>
                </tr>
                <tr>
					<td width="10px">&nbsp;</td>
                <td align="left" valign="middle" class="regi_txtfeildA"><input name="customer_email" type="text" class="regiinput" id="customer_email" size="25" value="<?=$_REQUEST['customer_email']?>" maxlength="<?=$medium?>"/></td>
              </tr>
			  <?php
			//section for custom registration form 
		  ...
		  ?>
           ...
           <div class="reg_shlf_inner">
            <div class="reg_shlf_inner_top"></div>
           <div class="reg_shlf_inner_cont">
		   <div class="reg_shlf_hdr_outr"></div>
             <div class="reg_shlf_cont_div">
           <div class="reg_shlf_pdt_con">
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="reg_table">
            <tr>
              <td  colspan="2" align="left" valign="middle" class="regi_txtfeildA"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_PASSWORD'])?><span class="redtext">*</span></td>
              </tr>
              <tr>
				 <td width="10px">&nbsp;</td>	
              <td  align="left" valign="middle" class="regi_txtfeildA"><input name="customer_pwd" type="password" class="regiinput" id="customer_pwd" size="25" value="" /></td>
            </tr>
            <tr >
              <td colspan="2" class="regi_txtfeildA" valign="middle" align="left"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_CONF_PASSWORD'])?><span class="redtext">*</span></td>
             </tr>
             <tr>
				 <td width="10px">&nbsp;</td>	
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="btable_a">
      ...
      <input type="hidden" name="redirect_back" value="<?PHP echo $redirect_back; ?>" /> 
				...
				?>
      <tr>
        <td class="td"><input type="password" name="custlogin_pass" id="custlogin_pass" class="input" value=""/></td>
      </tr>
      <tr>
      ...
      <tr>
		...
		?>
			...
			<div class="inner_clr1_middle">
				...
				<tr>
				<td align="left" valign="middle" class="regiconent" colspan="2">
                <input name="action_purpose" id="action_purpose" type="hidden" value="ForgotPassword_send">
                <input name="forgotpassword_Submit" type="submit" class="buttongray" id="forgotpassword_Submit" value="<?=stripslash_normal($Captions_arr['FORGOT_PASSWORD']['FORGOT_PWD_SUBMIT'])?>" /></td>
				</tr>
				</table>
			</div>
