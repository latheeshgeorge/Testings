<?php
		...
		function Show_ProductDetails($row_prod)
		{
			...
			<?php 
				...
				if($db->num_rows($ret_getc))
				{
					...
					<script type="text/javascript" src="<? echo $ecom_selfhttp.$ecom_hostname?>/images/<? echo $ecom_hostname?>/mobile_scripts/tinybox.js"></script>
    ...
    <script type="text/javascript">
			T$('testclick1').onclick = function(){TINY.box.show('<?php echo $ecom_selfhttp.$ecom_hostname?>/images/<?php echo $ecom_hostname?>/mobile_otherfiles/vat-relief.html',1,600,400,1)}
		</script>
        <?php
...
<tr class="details_expand_cont" style="display:none;" id="<?php echo "tab-".$row_tab['tab_id'];?>-cont">
	<td><?php echo stripslashes(utf8_encode($row_tab['tab_content']));?></td>
</tr>
<?php
		}
	}
            ...
            elseif($row_prod['product_det_qty_type']=='DROP')
            {
               ...
               <div class="class_qty_sel">
				...
				$colspan = 1;
							...
							{
							?>
								<div class="buyBinner_linkAB"><div class="buyBinner_link_in"><a href="#buyshow"><input name="Buy Now" type="button" value="<?php echo stripslash_normal($Captions_arr['PROD_DETAILS'][$caption_key]);?>"  class="byellow_n" onclick="ajax_addto_cart_fromlist('add_prod_tocart_ajax','Prod_Addcart','frm_proddetails','<?php echo SITE_URL?>')"/></a></div></div>
