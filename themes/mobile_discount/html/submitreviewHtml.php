<?php
	...
	class submitreview_Html
	{
					...
					if($db->num_rows($res_submitted) > 0)
					{
						...
						if($_POST['order_id'] > 0)
						{
						    ...
						    { //echo "test out";
								...
								echo '<div class="id_missing_success">You have successfully submitted the review. Thank you!!!</div>';
							}
						}
						else
						{
		...
		<?php		}
				...
				{
		?>			<div class="id_missing_error">Sorry! Invalid Parameter</div>
		<?php	}
			}
			else
			{
		...
		?>		<script language="javascript">
				...
				<?php /*<div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> Submit Review</div> */?>
		...
		<?php	if($alert != ""){
		?>		<tr>
					<td height="30" align="left" valign="middle" colspan="2"><div class="id_missing_error"><?php echo $alert;?></div></td>
				</tr>
		<?php	}
		?>		<tr>
					<td width="4%" height="30" align="center" valign="middle" class="submit_review_title">#</td>
					<td width="41%" height="30" align="left" valign="middle" class="submit_review_title">Product Name </td>
					<?php /*<td width="50%" height="30" align="left" valign="middle" class="submit_review_title">Add Review </td> */?>
				</tr>
		<?php		while($row_products = $db->fetch_array($res_products))
					{
						$product_id = $row_products['products_product_id'];							
		?>		<tr>
					<td height="35" align="center" valign="top" class="submit_review_firstline"><?php echo $rowCnt;?></td>
					<td height="35" align="left" valign="top" class="submit_review_firstline"><a href="<?php url_product($product_id,'',-1)?>" title="<?php echo stripslashes($row_products['product_name'])?>" class="submit_prodlink"><?php echo $row_products['product_name'];?></a>
					...
					<tr>
					<td height="35" align="left" valign="top" class="submit_review_text" colspan="2" style="padding-left:15px;">
						<div style="font-weight:bold;">Your Review</div> <textarea cols="35" rows="5" name="product_reviews[]" class="submit_review_textA" id="product_reviews_<?php echo $rowCnt;?>"></textarea>
		...
		?>		<tr class="submit_review_button">
					<?php /*<td align="center" valign="middle">&nbsp;</td>
