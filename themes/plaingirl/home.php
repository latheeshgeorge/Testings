...
<head>
	...
	})(window,document,'script','dataLayer','GTM-T8S3V6V');</script>
	<!-- End Google Tag Manager -->
	<meta name="google-site-verification" content="00w_9TQeRlPH0m3L9seHKGjNNmGJD7fjaGgM05hF-jY" /> 
	<?php	
	}
	
	     // Check whether top table exists for current site. If exists then include it
        $pixelcode="./images/".$ecom_hostname."/otherfiles/pixelcode.php";
        if(file_exists($pixelcode))
        {
                include("$pixelcode");
        }
...
<?php */ ?> 
<meta name="facebook-domain-verification" content="syqfa92owbfh05r5f4sugksmyszxai" />
</head>
...
?>
	...
	<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-T8S3V6V"
