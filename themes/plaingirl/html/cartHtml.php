                ...
                <form method="post" name="frm_cart"  id="frm_cart" class="frm_cls" action="<?php url_link('cart.html')?>">
                    ...
                    <table class="cart_tableA" width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tbody><tr>
                            ...
                            {
                                $HTML_topdesc .= '<div class="cart_shop_contA"><div><a href="#" onClick="show_wait_button(this,\'Please Wait...\');window.location=\''.$ps_url.'\'">'.stripslash_normal($Captions_arr['CART']['CART_CONT_SHOP']).'</a></div></div>';
                            }
                            else
                            $HTML_topdesc .= '&nbsp;';
                            $HTML_topdesc .= '</div>';
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td colspan="5" align="left" valign="top" class="cart_table_cnta"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        foreach ($cartData['products'] as $products_arr)
                                        {
                                            ...
                                            ?> <a href="#" class="update_link" onClick="if (confirm_message('<?php echo stripslash_normal($Captions_arr['CART']['CART_ITEM_REM_MSG'])?>')) {document.frm_cart.remcart_id.value='<?php echo $products_arr['cart_id']?>';handle_form_submit(document.frm_cart,'Remove_qty','#rem')}" title="<?php echo stripslash_normal($Captions_arr['CART']['CART_REMOVE'])?>"><img src='<?php url_site_image('delete-cart.gif')?>' border="0" alt="<?php echo stripslash_normal($Captions_arr['CART']['CART_REMOVE'])?>"></a> <br /></td>
                                               <td class="cart_td_name" valign="middle" align="left">
                                            ...
                                            <td class="cart_td_stockin" valign="middle" align="left">
                                                <?php
                                            ...
                                            <td class="cart_td_discnt" valign="middle" align="left"> <?php echo print_price($products_arr['product_webprice'],true)?>  
											<?php 
											$disp_arr = display_cart_discount($products_arr,$Captions_arr,true);
											//if($_SERVER['REMOTE_ADDR']=='112.133.248.119')
											{
											//print_r($disp_arr);
											$disp_promo = true;
										    if($disp_arr['caption'])
											{
												if(strpos($disp_arr['caption'],"Combo"))
												{
												  $disp_promo = false;
												  $disp_promo_to++;
												  //echo "combohere";
                                            ...
                                            <td align="right" valign="middle" class="cart_td_price_bold"> <?php echo print_price($products_arr['final_price'],true)?></td>
                                            </tr>
                                            <?php
										...
										?>
										<tr>
										<td class="cart_totalA" colspan="3">&nbsp;</td>
                                    ...
                                    <td align="left" valign="top" class="cart_table_cnts">
                                        <?php
                                        if (count($cartData['products'])!=0) // Done to show the message if no products in cart
                                        {
                                            ?>
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                            ...
                                                            if($proceed_bonus)
                                                            {
                                                                ...
                                                                if($cust_id) // case if logged in
                                                                {
                                                                    ...
                                                                    {  
                                                                        ...
                                                                        ?>
                                                                           <tr>
                                                                           <td colspan="3" class="cart_bonus_tdB"><a name="bonus">&nbsp;</a><?php echo stripslash_normal($Captions_arr['CART']['CART_SPENT_BONUS_POINTS'])?>(<? print (int)(($cartData["customer"]['customer_bonus']-$cartData["bonus"]["spending"])); ?> &nbsp;<?php echo stripslash_normal($Captions_arr['CART']['CART_REMAINING'])?>)
                                                                           </td>
                                                                           </tr>
                                                                            <tr>
                                                                                <td width="71%" class="cart_bonus_tdB">&nbsp;
                                                                                </td>
                                                                                <td width="29%">
                                              ...
                                              <!--  <tr>
                                                ...
                                                ?>	
                                                    <tr>
                                                    <td colspan="2" align="left" valign="middle" class="cart_td_delry"><?php echo stripslash_normal($Captions_arr['CART']['CART_DELIVERY_LOC'])?>
                                                    <a name="a_deliv">&nbsp;</a> </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" valign="middle" colspan="2"><?php
                    ...
                    <tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="cartlogin">
							 <tr>
							<td align="left" valign="middle" class="cart_login_text">Email Id</td>
                        
                        </tr>
                        <tr>
							
                        <td align="left" valign="middle"><input type="text" name="custlogin_uname" id="custlogin_uname_main"  value=""  class="cart_inputA"/></td>
                        </tr>
                        <tr>
							<td align="left" valign="middle" class="cart_login_text">Password</td>
                       
                        </tr>
                        <tr>
							
                        <td align="left" valign="middle"><input type="password" name="custlogin_pass" id="custlogin_pass_main"  value="" class="cart_inputA"  /></td>
                        </tr>
                        <tr>
                    ...
                    <td align="left" valign="top" class="cart_pay_td" >
						...
						?>
							...
							?>
															...
															{		
																...
																?>
																	<tr>
																		...
																		if($row_checkout['field_key']=='checkout_fax')
																		{
																			echo str_replace('size="30"','size="30" maxlength="20" ',get_Field($row_checkout['field_key'],$saved_checkoutvals,$cartData['customer'],'',$class_array));		
																		}
																		else
																		{
									...
									<td align="right" valign="top"class="chk_td_chkout">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr >
												<td class="cart_table_header" colspan="3" align="left"><?php echo stripslash_normal($Captions_arr['CART']['CART_ITEM'])?> </td>
												<td class="cart_table_header"><?php echo stripslash_normal($Captions_arr['CART']['CART_QTY'])?></td>
												...
												<td colspan="6" align="right" valign="top" class="chk_td_price">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														...
														if ($deliverydet_Arr['delivery_type'] != 'None') // Check whether any delivery method is selected for the site
														{
															...
															?>	
																		<tr>
																			<td  align="right" valign="top" class="cart_del_charge"><?php echo stripslash_normal($Captions_arr['CART']['CART_DELIVERY_LOC'])?></td>
																			<td  align="right" valign="top" class="cart_td_normal"><?php echo stripslash_normal($row_loc['location_name'])?></td>
																		</tr>
															<?php
																	}
																}
															...
															?>	
																		<tr>
																			<td  align="right" valign="top" class="cart_del_charge"><?php echo stripslash_normal($Captions_arr['CART']['CART_DELIVERY_OPT'])?></td>
																			<td  align="right" valign="top" class="cart_td_normal"><?php echo stripslash_normal($row_grp['delivery_group_name'])?></td>
																		</tr>
															<?php
																	}
																}	
...
*/														}
		...
		function validate_checkout_fields(frm)
		{
			...
			?>
				...
				?>
				var re = /^[+a-zA-Z0-9- ]*$/;
				if(document.getElementById('checkout_fax').value!='')
				{
					if(!re.test(document.getElementById('checkout_fax').value)) {
					alert("Error: Input contains invalid characters!");
					document.getElementById('checkout_fax').focus();
					return false;
					}
				}
				if(frm.checkout_billing_same.value == 'N')
				{
					if(document.getElementById('checkoutdelivery_fax').value!='')
					{
						if(!re.test(document.getElementById('checkoutdelivery_fax').value)) {
						alert("Error: Fax contains invalid characters!");
						document.getElementById('checkoutdelivery_fax').focus();
						return false;
						}
					}
				}	
...
<?php /*?>		<tr>
		...
		function Show_CheckoutSuccess($order_id=0)
		{
			...
			if($ecom_siteid==100 and $order_id>0) // dincwear
			{
			?>
				<!-- Facebook Conversion Code for Checkouts - Emma Bright 1 -->
				<script>(function() {
				...
				window._fbq.push(['track', '6027054903859', {'value':'<?=$total_price?>','currency':'GBP'}]);
				</script>
				<noscript><img height="1" width="1" alt="" style="display:none" src="https://www.facebook.com/tr?ev=6027054903859&amp;cd[value]=<?=$total_price?>&amp;cd[currency]=GBP&amp;noscript=1" [^] /></noscript> 
			<?php	
			
				if ($order_id>0)
				{
					// find the total quantity
					$sql_totqty = "SELECT sum(order_qty) as totqty FROM order_details WHERE orders_order_id=$order_id";
					$ret_totqty = $db->query($sql_totqty);
					if($db->num_rows($ret_totqty))
					{
						$row_totqty = $db->fetch_array($ret_totqty);
						$total_qty = $row_totqty['totqty'];
						if($total_qty>0)
						{
						?>
							<script src="//platform.twitter.com/oct.js" type="text/javascript"></script>
							<script type="text/javascript">twttr.conversion.trackPid('nu4u6', { tw_sale_amount: <?php echo $total_price?>, tw_order_quantity: <?php echo $total_qty?> });</script>
							<noscript>
							<img height="1" width="1" style="display:none;" alt="" src="https://analytics.twitter.com/i/adsct?txn_id=nu4u6&p_id=Twitter&tw_sale_amount=<?php echo $total_price?>&tw_order_quantity=<?php echo $total_qty?>" />
							<img height="1" width="1" style="display:none;" alt="" src="//t.co/i/adsct?txn_id=nu4u6&p_id=Twitter&tw_sale_amount=<?php echo $total_price?>&tw_order_quantity=<?php echo $total_qty?>" />
							</noscript>
						<?php
						}	
					}	
			...
			*/
			...
			{
			?>
				<!-- Google Code for All Website Conversions Conversion Page --> <script type="text/javascript">
				/* <![CDATA[ */
				var google_conversion_id = 982761572;
				var google_conversion_language = "en";
				var google_conversion_format = "3";
				var google_conversion_color = "ffffff";
				var google_conversion_label = "Wc3CCO7Q4W8Q5IDP1AM"; 
				var google_conversion_value = <?=$total_price?>; 
				...
				src="//www.googleadservices.com/pagead/conversion/982761572/?value=<?=$total_price?>&amp;currency_code=GBP&amp;label=Wc3CCO7Q4W8Q5IDP1AM&amp;guid=ON&amp;script=0"/>
				</div>
				</noscript>
