		...
		function Show_Products($ret_prod,$tot_cnt,$start_var,$cat_det,$def_orderfield,$def_orderby)
		{
			...
			//{
				...
				<div class="pdt_list_pdt_buy_otr">
					...
					<div class="pdt_list_pdt_moreA"><a class="" title="<?php echo trim(stripslashes($row_prod['product_name']))?>" href="<?php url_product($row_prod['product_id'],$row_prod['product_name'])?>">More Info</a></div>
					<?php
					/*
