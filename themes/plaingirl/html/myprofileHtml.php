 ...
 <div class="reg_top_outr">
	...
	<div class="inner_con"  id="companydetails" style="display:none;" >
	   ...
	   <table  width="100%" border="0" cellpadding="0" cellspacing="0" class="reg_table">
           <tbody>
				...
				?>
						<tr>
							<td  valign="middle" align="left" width="50%" class="regiconentA">
				...
				?>
		<tr>
			<td align="left" valign="middle" class="regiconentA" width="50%"><?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_EMAIL'])?><span class="redtext">*</span></td>
	...
	<?
		...
		<td class="regi_button_x" >
					...
					<input name="myprofile_Submit" type="submit" class="inner_btn_red_x" id="myprofile_Submit" value="<?=stripslash_normal($Captions_arr['CUST_REG']['CUSTOMER_REGISTRATION_SAVE_BUTTON'])?>" />
			...
			<option value="M/S." <?=($row_sql['customer_title']=='M/S.')?"selected":''?>>M/S.</option>
				    ...
				    <tr>
					    <td  colspan="4"  align="left" >
							<table width="100%" border="0" cellpadding="0" cellspacing="2" class="shoppingcarttable">
				      <tr>
					    <td  colspan="3"  align="left" >I give my permission for Dincwear to send me the following.Please tick 'Yes' or 'No' for each option.</td>
...
If you decide to change your preferences, you can do so at any time. Please just call our customer services team on 02071000743 during office hours Monday to Friday and let us know what you want us to do. For example, you can call us to update your contact details or you can opt out from communications altogether. Alternatively, you can let us know your wishes by email: <strong><a href="mailto:info@dincweardance.com">info@dincweardance.com</a>.</strong></p>
<p><strong>Terms and Privacy:</strong></br>
Dincwear  will keep your contact details safe. We will not share them with any other person or organisation. We will only contact you by the channels you have chosen (phone, email etc.) and we will only contact you about the subjects you have chosen. You may unsubscribe at any time. For more details, please see our privacy policy and data protection to see how we use and protect your data. <br/>
For more details, please check our <a href="http://www.dincweardance.com/gdpr-pg50556.html" target="_blank"><strong>data protection</strong></a> to see how we use and protect your data. 
</p>
</td>
						</tr>
				   <tr>
<td class="regi_button" colspan="4" >
				<div class="cart_top_links"><div class="cart_shop_cont"><div>
					<input name="Submit" type="button" class="inner_btn_red"  value="Save" onclick="javascript:add_newconsent(document.add_address)" />
				</div>
				</div>
			</div>
		</td>			        </tr>	
