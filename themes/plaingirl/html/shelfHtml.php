					...
					if ($proceed)
					{
						...
						else
						{
							$HTML_rating = '&nbsp;';
											...
											<div class="pdt_list_pdt_more"><a class="" title="<?php echo stripcslashes(trim($row_prod['product_name']))?>" href="<?php url_product($row_prod['product_id'],$row_prod['product_name'])?>">More Info</a></div>
												</div>   
