		...
		if ($db->num_rows($ret_search))
		{
			...
			$HTML_topcontent .= '
								...
								<div class="pdt_list_pdt_price"><?=$HTML_price?></div>
															<div class="pdt_list_pdt_moreA"><a class="" title="<?php echo stripslashes(trim($row_prod['product_name']))?>" href="<?php url_product($row_prod['product_id'],$row_prod['product_name'])?>">More Info</a></div>
