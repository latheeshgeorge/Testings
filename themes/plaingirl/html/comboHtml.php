				...
				$sql_prod = "SELECT a.product_id,a.product_name,a.product_variablestock_allowed,a.product_show_cartlink,
					...
					if ($db->num_rows($ret_prod))
					{
						...
						if($proceed_combo)
						{
							...
							if($combo_id!=178)
							 {
								$HTML_bundleprice .='<div class="combo_yousave">';
								...
								$HTML_bundleprice .='</div>';
													...
													$HTML_bundleprice .='<div class="combo_mainprice">'.stripslash_normal($Captions_arr['COMBO']['COMBO_BUNDLE_PRICE']).' '.print_price($bundle_price,true,false).'
													</div>
													<div class="combo_btn">
						...
						<?php
							...
							{    
								...
								<?php	
									...
									<div class="combo_pdt_priceB">
										<?php
								    if($combo_id!=178)
									{ 
										?>
										<?php echo $Captions_arr['COMBO']['COMBO_BUNDLE_SAVE']?> 
									<?php 
					            ...
					            <?php
									...
									{ 
										...
										echo $Captions_arr['COMBO']['COMBO_BUNDLE_SAVE']; 
										$save_price = $combprice_arr[$row_prod['product_id']] - $row_prod['combo_discount'];
										echo print_price($save_price,true,false);
									}
								?>	
