			...
			if($db->num_rows($ret_fav_products)>0)
			{
				switch($displaytype)
				{
					...
					?>
						<table border="0" cellpadding="0" cellspacing="0" class="shelfAtable">
						<tr>
							<td class="newshelfBheader" align="left" colspan="2"><?php echo stripslash_normal($Captions_arr['LOGIN_HOME']['LOGIN_HOME_FAV_PROD'])?></td>
						</tr>
						<?php
						$max_col = 2;
						$cur_col = 0;
				...
				<?php
						...
						?>
						<tr>
							<td align="right" colspan="2"><div class="middle_showall_div"><h6 align="right"><a href="<?php url_link('showfavprodall'.$custom_id.'.html')?>" class="middle_showall_link" title="<?php echo stripslash_normal($Captions_arr['COMMON']['SHOW_ALL'])?>"><? echo stripslash_normal($Captions_arr['COMMON']['SHOW_ALL'])?></a></h6></div></td>
						</tr>
						</table>						
					<?php
					break;
