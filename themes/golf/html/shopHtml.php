<?php
	...
	class shop_Html
	{
        ...
        <tr>
          <td colspan="3" >
			  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="categoreyimage">
				...
				?>
				<tr>
				<td align="center"><h1 class="shelfheader"><?php echo $row_shop['shopbrand_name'];?></h1>
				</td>
				</tr>
				<tr>
		...
		?>
			<tr>
	  		<td align="left" valign="top"  class="categorydetailstext" colspan="3">
										...
										?>
                               				<td class="newshelfAtabletd" onmouseover="this.className='newshelfAtabletd_hover'" onmouseout="this.className='newshelfAtabletd'" align="left" valign="top">												
													...
													?>
																...
																<li>
																	<?php
																	if($shop_det['shopbrand_product_showprice']==1)// whether title is to be displayed
																	{
																		$price_class_arr['ul_class'] 		= 'shelfBul';
