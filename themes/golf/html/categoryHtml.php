        ...
        <tr>
          <td colspan="3" >
			  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="categoreyimage">
			   <tr>
			  <td align="center"><h1><a href="<?php url_category($row_cat['category_id'],$row_cat['category_name'],-1)?>" class="subcategoreynamelink" title="<?php echo stripslashes($row_cat['category_name'])?>"><?php echo ucwords(stripslashes($row_cat['category_name']))?></a></h1></td> 
			   </tr>
				<tr>
						...
						<tr>
							...
							<input type='hidden' name='category_id' value="<?=$_REQUEST['category_id']?>"/>
								...
								if($img_support && $row_cat['category_showimage']==1  && $subcategory_showimagetype!='None' ) // ** Show sub category image only if catimage module is there for the site subcategoreynamelink
									{
								  ?>
										<a href="<?php url_category($row_subcat['category_id'],$row_subcat['category_name'],-1,$_REQUEST['catgroup_id'],0)?>"  title="<?php echo stripslashes($row_subcat['category_name'])?>" class="subcategoreyimage">
								 <?php
