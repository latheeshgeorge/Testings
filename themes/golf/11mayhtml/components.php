...
-->						<?php			
		...
		?>
				<tr>
					...
					<ul class="topcartlink">
					 ...
					 <li><a href="#" onclick="handle_checkout_submit('<?php echo $ecom_hostname?>',0)" class="viewcart" title="<?php echo $Captions_arr['COMMON']['CHECK_OUT']?>"><?php echo $Captions_arr['COMMON']['CHECK_OUT']?></a></li>
		...
		function mod_bestsellers($ret_main,$title,$display_id)
		{
			...
			{	
				if ($db->num_rows($ret_main))
				{
						...
						{
				?>
						<table class="new_best_seller_table" border="0" cellpadding="0" cellspacing="0">
				<?php
							if($title) // check whether title exists
							{
				?>
								<tr>
								<td class="new_best_seller_header"><?php echo $title?></td>
								</tr>	
				<?php
							}
				...
				?>	
								<tr>
								<td class="new_best_seller_name"><a href="<?php url_product($row_main['product_id'],$row_main['product_name'],-1)?>" class="christmas_comp_offertableprolink" title="<?php echo stripslashes($row_main['product_name'])?>"><?php echo stripslashes($row_main['product_name'])?></a></td>
								</tr>
								<tr>
								<td>
								...
								<tr>
									<td>
									<?php
										$price_class_arr['ul_class'] 		= 'new_best_seller_offerul';
										$price_class_arr['normal_class'] 	= 'new_best_seller_offernormalprice';
										$price_class_arr['strike_class'] 	= 'new_best_seller_offerstrikeprice';
										$price_class_arr['yousave_class'] 	= 'new_best_seller_offeryousaveprice';
										$price_class_arr['discount_class'] 	= 'new_best_seller_offerdiscountprice';
										echo show_Price($row_main,$price_class_arr,'compshelf');
									?>	
									</td>
								</tr>
				...
				?>
								<tr>
								<td class="new_best_seller_bottom" align="right"><a href="<? url_link('bestsellers'.$display_id.'.html')?>" class="new_best_seller_showall" title="<?php echo $Captions_arr['COMMON']['SHOW_ALL']?>"><?php echo $Captions_arr['COMMON']['SHOW_ALL']?></a></td>
								</tr>
								</table>
		...
		function mod_combo($comb_arr,$title)
		{
			...
			if ($position=='left' or $position =='right')// Combo deal is allowed only in left or right panel
			{
				...
				{	
						...
						?>	
											<li><h1 align="right"> <a href="<?php url_combo($combData['combo_id'],$combData['combo_name'],-1)?>" class="showall" title="<?php echo $Captions_arr['COMMON']['SHOW_DEAL']?>"><?php echo $Captions_arr['COMMON']['SHOW_DEAL']?></a> </h1> </li>
										</ul> 
						<?php	
									}
		...
		function mod_preorder($ret_main,$title,$display_id)
		{
			...
			{	
				...
				?>
								<li><h1 align="right"><a href="<? url_link('preorder'.$display_id.'.html')?>" class="showall" title="<?php echo $Captions_arr['COMMON']['SHOW_ALL']?>"><?php echo $Captions_arr['COMMON']['SHOW_ALL']?></a> </h1> </li>
							</ul>
				<?php	
						}
				}	
