		...
		function mod_customerlogin($title)
		{
			...
			?>
				<table border="0" cellpadding="0" cellspacing="0" class="logintable">
					 <td class="signup_btn"><a href="<?php url_link('registration.html')?>" title="<?php echo stripslash_normal($Captions_arr['CUST_LOGIN']['NEW_USER'])?>"><img src="<?php url_site_image('signup-btn.gif')?>" /></a></td>
					 <td class="login_btn"><a href="<?php url_link('custlogin.html')?>"><img src="<?php url_site_image('login-btn.gif')?>" /></a></td>
				</table>
			<?php
			}
			else
					...
					if ($proceed)
					{
						...
						if ($db->num_rows($ret_prod))
						{
							if($shelfData['shelf_currentstyle']=='nor') // case of normal design layout
							{
								switch($shelfData['shelf_displaytype'])
								{
									...
									<table class="normal_lf_table" border="0" cellpadding="0" cellspacing="0">
										...
										?>	
										<tr>
										  <td class="normal_lf_header"><?php  echo $title?>
											  </td>
										</tr>
										<? }
										while($row_prod = $db->fetch_array($ret_prod))
										...
										<tr>
										  ...
										  <div class="normal_lf_pdt_name"><a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" class="normal_lf_link" title="<?php echo stripslashes($row_prod['product_name'])?>"><?php echo stripslashes($row_prod['product_name'])?></a></div>
										  <?php
							...
							elseif($shelfData['shelf_currentstyle']=='christ') // case of christmas layout
							{
								...
								<div class="normal_header"><?php echo $title?></div>
								</td>
								</tr>	
					                      <?php
											}
								...
								<a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" class="normal_name_link" title="<?php echo stripslashes($row_prod['product_name'])?>"><?php echo stripslashes($row_prod['product_name'])?></a></div>
							...
							elseif($shelfData['shelf_currentstyle']=='new') // case of new year layout
							{
								...
								?>
								<tr>
								<td class="spcl2_lft_header"><?php echo $title?>	</td>
								</tr>
								<? }?>	
								<? while($row_prod = $db->fetch_array($ret_prod))
								{?>
								...
								{
								?>	
								<a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" class="spcl2_lft_name_link" title="<?php echo stripslashes($row_prod['product_name'])?>"><?php echo stripslashes($row_prod['product_name'])?></a>
								<? }?></div>
