...
/*############################################################################
	...
	class featured_Html
	{
		...
		?>
			...
			?>
					<tr>
						<td <?php echo ($row_featured['featured_showimage']==1)?'colspan="2"':''?> align="left" valign="top"><h2 class="featuredprodname"><a href="<?php url_product($row_featured['product_id'],$row_featured['product_name'],-1)?>" title="<?php echo stripslashes($row_featured['product_name'])?>"><?php echo stripslashes($row_featured['product_name'])?></a></h2></td>
					</tr>
			<?php
				}
			?>		
