	...
	class product_Html
	{
		...
		function handle_image_swap(src_id)
		{
			...
			if (src_id)
			{
				...
				srcobj.src =  img_path + 'gallerythumb/'+imglocal_arr[destindex];
		 ...
		 ?>
          ...
          <?php				
				...
				{ 
					...
					<div><br /><b><?php echo stripslash_normal($Captions_arr['PROD_DETAILS']['BOOKMARK_HEADING'])?></b><br />
		  ...
		  <?php
          if(count($heading) && count($sizevalue)) // check whether size chart is set to show in a pop up window
		    {
				?>
          <tr>
	...
	<?php	
		...
		?>
			...
			<script type="text/javascript">
				...
				<table border="0" cellpadding="0" cellspacing="0" class="shelfBtable">
				<tr>
					<td colspan="3" class="pro_de_shelfBheader" align="left"><a name="comp_prods"></a><h1><?php echo $Captions_arr['PROD_DETAILS']['PRODDET_COMPARE_HEAD'];?></h1></td>
				</tr>
				<tr>
				...
				?>	
					  <table width="100%" border="0" cellpadding="0" cellspacing="3" class="productdethumbtable">
						...
						?>
							...
							<?php
								 show_image(url_root_image($v['image_gallerythumbpath'],1),$title,$title,'preview');
							?>
							</a>
							</li>
						<?php
