...
?>
 ...
 //////////////***************LISTING OF STATIC PAGES ,CATEGORIES AND PRODUCTS FOR SITE MAP*************///////////////////
		...
		<td align="left" valign="middle" class="sitemapcontents" width="50%">
		<a href="<?php url_product($pdt_id,$sitemap_products['product_name'],-1)?>" class="sitemapprodlink" title="<?php echo stripslashes($linkval["'site_map_prod_"."$pdt_id'"])?>"> <?=$linkval["'site_map_prod_"."$pdt_id'"]?>
			</a>
		</td>
		<?
		$i++;
