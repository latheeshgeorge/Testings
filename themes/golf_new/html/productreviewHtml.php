...
/*############################################################################
	...
	class productreview_Html
	{
		...
		?>
			...
			<div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <a href="<?php url_product($product_id,$product_name,-1)?>"><?=stripslashes($product_name)?></a>  >> <?=$Captions_arr['PRODUCT_REVIEWS']['WRITE_PRODUCT_REVIEW_TREEMENU_TITLE']?></div>
			...
			$sql_prodreview         = "SELECT review_id,DATE_FORMAT(review_date,'%e-%b-%Y : %r') as reviewed_on,
										...
										WHERE  
									  	...
									  	ORDER BY  
											...
											$Limitprodreviews";
		?>
		<div class="treemenu"><a href="<? url_link('');?>">Home</a> >> <a href="<?php url_product($product_id,$product_name,-1)?>"><?=stripslashes($product_name)?></a>  >> <?=$Captions_arr['PRODUCT_REVIEWS']['READ_PRODUCT_REVIEW_TREEMENU_TITLE']?></div>
