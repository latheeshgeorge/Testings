...
/*############################################################################
	...
	?>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" class="gift_mid_table">
		<tr >
		...
		?>
		 <tr>
	  	<td class="gift_mid_table_td">
		<div class="shoppaymentdiv1">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="gift_mid_table">
		<tr>
		...
		<div class="shoppayment_type_div1">
		<?php
		$pay_maxcnt 	= 2;
		$pay_cnt		= 0;
		?>
		...
		<tr>
		<td colspan="2" align="right" class="gift_mid_table_td"><input name="buygiftvoucher_Submit" type="button" class="gift_buy_btn" id="buygiftvoucher_Submit" value="<?=$Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_BUY_VOUCHER_BUY_BUTTON']?>" onclick="validate_buygiftvoucher(document.frm_buygiftvoucher)" /></td>
		</tr>
		</table>		</div>
		</div>
...
?>		
	...
	<?php
		...
		?>
				<tr >
					<td colspan="2" align="right" class="gift-send-inner_cnt">
						<input type="button" class='buttongray' name="submit_backhome" value="<?php echo $Captions_arr['GIFT_VOUCHER']['GIFT_VOUCHER_PREVIEW_BACH_HOME']?>" onclick="window.location ='<?php url_link('')?>'" />
					</td>
				</tr>	
		<?php
			}	
