<?php
	...
	<?php	
		if($texttd_class!='')
		 ...
		 if($section_typ=='pricepromise' and $cur_pos=='Top')
		  {
		 ?>
		 		<tr>
					<td colspan="2" align="left" class="<?php echo $head_class?>"><?php echo $specialhead_tag_start.'The Product'.$specialhead_tag_end?></span></span></td>
				</tr>
				<tr>
					<td colspan="2" align="left" class="regifontnormal"><?php echo stripslash_normal($row_dyn['message'])?></td>
				</tr>
				<tr>
				<td valign="top" align="left"  >
					<table  width="100%" border="0" cellspacing="<?php echo $cellspacing?>" cellpadding="<?php echo $cellpadding?>" align="left">
					<tr>
						<td width="<?php echo $cont_leftwidth?>" align="left" valign="middle" class="<?php echo $cont_class?>">Manafacturer<span class="redtext">*</span></td>
						<td <?php echo $textcls?> width="<?php echo $cont_rightwidth?>" align="left" valign="middle">
						<input class="regiinput" type="text" name="pricepromisefield_manufact" id="pricepromisefield_manufact" value="<?=$row_prod['manufacture_id']?>" />
						</td>	
					</tr>
					<tr>
						<td width="<?php echo $cont_leftwidth?>" align="left" valign="middle" class="<?php echo $cont_class?>">Model<span class="redtext">*</span></td>
						<td <?php echo $textcls?> width="<?php echo $cont_rightwidth?>" align="left" valign="middle">
						<input class="regiinput" type="text" name="pricepromisefield_model" id="pricepromisefield_model" value="<?=$row_prod['product_model']?>" />
						</td>	
					</tr>
					<tr>
						<td width="<?php echo $cont_leftwidth?>" align="left" valign="middle" class="<?php echo $cont_class?>">Our Price<span class="redtext">*</span></td>
						<td <?php echo $textcls?> width="<?php echo $cont_rightwidth?>" align="left" valign="middle">
						<input class="regiinput" type="text" name="pricepromisefield_ourprice" id="pricepromisefield_ourprice" value="<?=$row_prod['promise_price']?>" />
						</td>	
					</tr>
					 </table>
				 </td>
