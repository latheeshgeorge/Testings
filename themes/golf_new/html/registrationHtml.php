...
<div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?=$Captions_arr['CUST_REG']['REGISTRATION_TREEMENU_TITLE']?></div>
		...
		<td colspan="2" valign="top" align="left">
			<table width="100%" border="0" cellspacing="4" cellpadding="0" class="regifontnormal_newsletter">
					...
					<b><?=$Captions_arr['CUST_REG']['PAY_ON_ACCOUNT']?></b></td>
		...
		<td colspan="2" valign="top" align="left">
			<table width="100%" border="0" cellspacing="4" cellpadding="0" class="regifontnormal_newsletter">
					...
					<td  align="left" valign="middle" width="96%">
					<b><?=$Captions_arr['CUST_REG']['REQUEST_NEWS_RECEIVE_NEWPROD'] //RECEIVING_NEWSLETTER?></b></td>  
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="4" cellpadding="0" class="regifontnormal_newsletter">
					...
					<td  align="left" valign="middle" width="96%">
					<b><?=$Captions_arr['CUST_REG']['CUSTOMER_RECEIVE_NEWSLETTER_HEADER']?></b></td>  
      ...
      <tr>
        ...
        <div class="lgn_msg_top"></div>
			...
			{
			 ?>
			 <div class="lgn_msg_middle"><?php echo $help_mstop;?></div>
			 <?php
			}
			?>
            ...
            <tbody>
              <tr>
                ...
                <td width="76%" align="left" valign="middle" class="lgn_table_td"><label>
                  <input type="text" name="custlogin_uname" id="custlogin_uname" class="lgn_txt_middle" value="" />
                </label></td>
              </tr>
              <tr>
                <td align="left" valign="middle" class="lgn_table_td"><?php echo stripslash_normal($Captions_arr['CART']['CART_PASSWORD'])?></td>
                <td align="left" valign="middle" class="lgn_table_td"><input type="password" name="custlogin_pass" id="custlogin_pass" class="lgn_txt_middle" value=""/></td>
              </tr>
              <tr>
              ...
              <tr>
				...
				?>
				<div class="lgn_btn">
				<a href="javascript:document.frm_custlogin_middle.submit()"><img src="<?php echo url_site_image('login-btn-new.gif')?>" border="0" /></a>
				</div></td>
              </tr>
