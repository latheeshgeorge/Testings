...
/*############################################################################
	...
	class emailafriend_Html
	{
		...
		?>
			<div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <a href="<?php url_product($product_id,$product_name,-1)?>"><?=stripslashes($product_name)?></a>  >> <?=$Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_TREEMENU_TITLE']?></div>
  ...
  <tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="2" class="addproreivewtable">
        <tr>
          <td width="62%" align="left" valign="middle"><?=stripslashes($Captions_arr['EMAIL_A_FRIEND']['EMAIL_FRIEND_PRODUCT_TITLE'])?>&nbsp;<span class="readreivewname"><h1><?=$product_name?></h1></span></td>
