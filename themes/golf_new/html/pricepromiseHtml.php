	 ...
	 <input type="hidden" name="action_pricepurpose" value="insert_det" />
	              <table border="0" cellpadding="0" cellspacing="0" class="regitable">
					<? if($fetch_arr_admin['pricepromise_topcontent']!='')
					 ...
					 ?>
						<tr>
						<td  class="message_header"><?=$Captions_arr['PRICE_PROMISE']['PRICE_PROMISE_TREEMENU_TITLE']?></td></tr>
						<tr>
					...
					<td class="regiconent" width="50%" align="left" valign="middle">: <?=$row_prod['manufacture_id']?>
					...
					<td class="regiconent" width="50%" align="left" valign="middle">: <?=$row_prod['product_model']?>
					...
					<td class="regiconent" width="50%" align="left" valign="middle">: <?=$row_prod['promise_price']?>
					...
					<td class="regiconent" width="50%" align="left" valign="middle">
