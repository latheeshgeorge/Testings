								...
								<?php
									...
									<div class="buy_main">
										...
										<?php
											...
											show_addtocart($compare_arr['main'][$i],$class_arr,$frm_name,false,'','','add_divlink',0)
										?>
										</div></div>
										<div class="shlf_info_btn"><div class="shlf_info_btnleft"><?php show_moreinfo($compare_arr['main'][$i],'link_buy')?></div></div>
									</div>
								</form>
								</td>
						<?php
