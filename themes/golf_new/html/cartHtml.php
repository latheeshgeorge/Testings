<?php
	...
	class cart_Html
	{
		...
		?>	
			...
			<div class="treemenu_special"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?php echo $Captions_arr['CART']['CART_MAINHEADING']?></div>
			<?php
				if (count($cartData['products'])>0)
				{
				?>
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="shoppingcarttable_clear">
			<tr>
				...
				<td width="9%" align="left" valign="middle" class="shoppingcartheaderAB">
				<?php
			...
			<?php
			  ...
			  <tr>
				...
				?>
				<td align="center" valign="middle" class="shoppingcartheaderA" <?php echo ($Settings_arr["product_show_instock"]==0)?'colspan="2"':''?>><?php echo $Captions_arr['CART']['CART_DISCOUNT']?></td>
		  ...
		  else
		  {
			  ...
			  ?>
				  <tr>
					...
					?>
					<td align="center" valign="middle" class="<?php echo $tdpriceBclass?>" <?php echo ($Settings_arr["product_show_instock"]==0)?'colspan="2"':''?>>
					-<?php 
		  ...
		  ?>
			 	<tr>
				<td align="right" valign="middle" class="shoppingcartcontent_total" colspan="5"><strong><?php echo $Captions_arr['CART']['CART_TOTPRICE']?>:</strong></td>
		  ...
		  ?>
				...
				?>	
					   <tr>
						 <td  colspan="2" align="right" class="shoppingcartcontent_delivery"><?php echo $Captions_arr['CART']['CART_DELIVERY_LOC']?><a name="a_deliv">&nbsp;</a> 
							<?php
				   ...
				   ?>
					   <tr>
						 <td align="right" class="shoppingcartcontent" colspan="2"><?php echo $Captions_arr['CART']['CART_DELIVERY_OPT']?> 
						  <?php
			 ...
			 ?>
				...
				if (($row_cartdet['promotionalcode_id']!=0 or $row_cartdet['voucher_id']!=0))
				{
				   ...
				   $cart_promdesc='';
					...
					{
					 $cart_promdesc = $Captions_arr['CART']['CART_PROMOTIONAL_CODE_DISC'];
					}
					elseif($row_cartdet['voucher_id']!=0 and $cartData["bonus"]['type']=='voucher')
					{
					 $cart_promdesc = $Captions_arr['CART']['CART_GIFTVOUCHER_DISC'];
					}
				
					if($row_cartdet['promotionalcode_id']!=0 and $cartData["bonus"]['type']=='promotional' and $cartData['totals']['pro_type']!='product')
						$cart_prom_price = ($cartData['totals']['lessval']>0)?print_price($cartData['totals']['lessval'],true):0;
					elseif($row_cartdet['voucher_id']!=0 and $cartData["bonus"]['type']=='voucher')
						$cart_prom_price = ($cartData['totals']['lessval']>0)?print_price($cartData['totals']['lessval'],true):0;
					if($cart_promdesc!='' || $cart_prom_price!=0)
					{
					?>
						  <tr>
				  ...
				  <tr>
					<td colspan="6" align="left" valign="middle"><div class="shopprodiv">
					  <table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
						  <td width="78%" align="right" class="shoppingcartcontent"><a name="a_prom">&nbsp;</a>
						  <?php	
						 	if ($cartData["bonus"]['type']=='promotional' or $cartData['totals']['promotional_type']=='product')
							{
							 echo $Captions_arr['CART']['CART_PROMO_CANCEL'];
							}
							elseif($cartData["bonus"]['type']=='voucher')
							{
							 echo $Captions_arr['CART']['CART_VOUCHER_CANCEL'];
							}
							elseif ($cartData["bonus"]['type']=='')
							{
						 		echo $Captions_arr['CART']['CART_PROMO_CAP'];
						  	}
						  ?>						  </td>
						  <td width="22%" align="right" class="shoppingcartcontent">
						  <?php
		  ...
		  <?php
			...
			if (is_Feature_exists('mod_bonuspoints') and $ecom_siteid != 72)
			{
			...
			// Bonus Points Earned
				...
				?>
					 <tr>
						<td colspan="1" align="left" valign="middle" class="shoppingcartcontent"><a name="bonus">&nbsp;</a><?php echo $Captions_arr['CART']['CART_SPENT_BONUS_POINTS']?>(<? print (int)(($cartData["customer"]['customer_bonus']-$cartData["bonus"]["spending"])); ?> &nbsp;<?php echo $Captions_arr['CART']['CART_REMAINING']?>)&nbsp;</td>
			...
			?>
			  <tr>
				<td colspan="5" align="right" valign="middle" class="shoppingcartcontent_total"><strong><?php echo $Captions_arr['CART']['CART_TOTAL_FINAL_COST']?>:&nbsp;</strong> </td>
				<td align="right" valign="middle" class="shoppingcartpriceC" colspan="1"><?php echo print_price($cartData["totals"]["bonus_price"],true)?></td>
			  </tr>
		  <?php
		  	}
			...
			?>
				...
				<tr>
					<td colspan="5" align="right" valign="middle" class="shoppingcartcontent_total"><strong><?php echo $Captions_arr['CART']['CART_TOTAL_AMT_NOW']?>:&nbsp; </strong></td>
		  ...
		  ?>
		  		<tr>
					<td colspan="6" align="right" valign="middle" class="google_header_text">
					<?php 
			...
			<?php
				...
				if ($db->num_rows($ret_paytypes))
				{
					...
					?>	
							  ...
							  <table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
									   <td   align="right" class="shoppingcartcontent_delivery"><a name="a_pay">&nbsp;</a><?php echo $Captions_arr['CART']['CART_SEL_PAYTYPE']?> 
									<?php
					  ...
					  <tr>
						<td colspan="6" align="left" valign="middle">
							<?php
								...
								$pay_cnt	= 0;
							?>
								<table width="100%" border="0" cellspacing="0" cellpadding="0" id="paymethod_id" class="paytype_table_cart">
								  <tr>
								  ...
								  ?>
										...
										<tr>
											<td align="left" valign="top" width="2%" class="payradio_cls">
											...
											<td align="left" class="payradio_caption">
          ...
          <tr>
            <td colspan="6" align="right" valign="middle" class="shoppingcartcontent">
			  ...
			  <?php
				...
				//if($ecom_siteid!=72) // case of discount-mobility.co.uk
				{
					if($show_checkoutbutton==true)	
					{
						if($ecom_siteid==72)
						{
							if(!$cust_id)
							{
								$btn_msg = 'Checkout as guest';
							}
							else
								$btn_msg = $Captions_arr['CART']['CART_GO_CHKOUT_DISCMOB'];
						}	
						else
							$btn_msg = $Captions_arr['CART']['CART_GO_CHKOUT'];
			  ?>	
			  		<div class="cart_checkout_div"  align='right'>
             		 <input name="continue_checkout" type="button" class="buttonred_cart" id="continue_checkout" value="<?php echo $btn_msg ?>" onclick="handle_checkout_submit('<?php echo $ecom_hostname?>',0,'<?php echo $cartData["totals"]["bonus_price"]?>')" />
             		</div> 
			  <?php
					}
					else
			...
			?>
				...
				?>
					<tr>
						...
						<td align="right" valign="middle" class="google_td">
						<input type='image' name='submit' src='https://www.paypal.com/en_US/i/btn/btn_xpressCheckout.gif' border='0' align='top' alt='PayPal' onclick="handle_checkout_submit('<?php echo $ecom_hostname?>',2,'<?php echo $cartData["totals"]["bonus_price"]?>')" style="border:0px"/>
						</td>
					</tr>	
				</table>
			<?php 	
		}
		if($Captions_arr['CART']['CHECKTOUT_DISCMOB_CARECO_MSG']!='')
			{	
		  ?>
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="shoppingcarttable">
		  		<tr>
					<td colspan="6" align="center" valign="middle" class="google_header_text">
					<?php 
						echo $Captions_arr['CART']['CHECKTOUT_DISCMOB_CARECO_MSG'];
					?>
					</td>
				</tr>		
				</table>
		...
		<table class="lgn_table_outer" width="100%" border="0" cellpadding="0" cellspacing="0">
            <tbody>
              <tr>
			   <td align="left" valign="top" class="lgn_table_td_outerA">	
        ...
        <div class="lgn_middle">
          <table class="lgn_table" width="100%" border="0" cellpadding="0" cellspacing="4">
            <tbody>
              ...
              <tr>
                <td align="left" valign="top" class="lgn_table_td">
	  ...
	  <td align="left" valign="top" class="lgn_table_td_outer">	
	  <div class="lgn_contnt_outr">
      <div class="lgn_contnt" >
          ...
          <table class="regifontnormal" width="100%" border="0" cellpadding="0" cellspacing="4">
            <tbody>
              ...
              <tr>
				...
				<div class="lgn_btn">
				<a href="javascript:document.frm_custlogin_cart.submit()"><img src="<?php echo url_site_image('login-btn-new.gif')?>" border="0" /></a>
				</div></td>
              </tr>
		...
		?>	
			...
			<div class="treemenu_special"><a href="http://<?php echo $ecom_hostname?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?php echo $Captions_arr['CART']['CART_CHECKOUTHEADING']?></div>
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="shoppingcarttable">
			<?php
				if($cart_alert and count($cartData['products'])>0)
				{
		  ...
		  ?>
				...
				<td align="right" valign="middle" class="shoppingcartcontent">&nbsp;</td>
				<td align="right" valign="middle" class="shoppingcartcontent">&nbsp;</td>
				<td align="right" valign="middle" class="shoppingcartcontent" colspan="2"><strong><?php echo $Captions_arr['CART']['CART_TOTPRICE']?>:</strong>&nbsp;</td>
				<td align="right" valign="middle" class="shoppingcartpriceC"><?php echo print_price($cartData["totals"]["subtotal"],true)?></td>
			  </tr>
		  <?php
		  		$module_name = 'mod_giftwrap';
			...
			if ($deliverydet_Arr['delivery_type'] != 'None') // Check whether any delivery method is selected for the site
			{
				...
				?>	
							<tr>
								<td colspan="3" align="right" valign="middle" class="shoppingcheck_delivery"><?php echo $Captions_arr['CART']['CART_DELIVERY_LOC']?></td>
								<td colspan="3" align="center" valign="middle" class="shoppingcheck_delivery"><?php echo stripslashes($row_loc['location_name'])?></td>
							</tr>
				<?php
						}
					}
		  ...
		  <?php
			...
			?>
				 <tr>
					<td colspan="5" align="right" valign="middle" class="shoppingcartcontent"><?php echo $Captions_arr['CART']['CART_TOTAL_POINTS_EARN']?>&nbsp;</td>
					<td colspan="1" align="right" valign="middle" class="shoppingcartpriceC"><?php echo $cartData["totals"]["bonus"]?></td>
				  </tr>
			<?php	
			}
		  	// show the total final price
			...
			?>
			  ...
			  <tr>
				<td colspan="5" align="right" valign="middle" class="shoppingcartcontent"><strong><?php echo $Captions_arr['CART']['CART_TOTAL_FINAL_COST']?>:</strong>&nbsp; </td>
		  ...
		  ?>
				...
				<td colspan="6" align="left" >&nbsp;	
			  	  ...
			  	  <tr>
				<td colspan="6" align="right" class="shoppingcartcontent" >	
		...
		?>
			...
			<tr>
				<td colspan="6" align="left" class="regiheader"><?php echo $Captions_arr['CART']['CART_FILL_BILLING_DETAILS']?></td>
			</tr>
			<?php
		   ...
		   <tr>
			 ...
			 // check whether billing and shipping address can be different in the site.
			  ...
			  ?>
				...
				<tr id="checkout_delivery_tr">
					...
					<table width="100%" cellpadding="1" cellspacing="1" border="0">
					<tr>
					<td colspan="2" align="left" class="regiheader"><?php echo $Captions_arr['CART']['CART_FILL_DELIVERY_ADDRESS']?></td>
					</tr>	
						<?php
			...
			?>
					 <tr>
						...
						<table width="100%" cellpadding="1" cellspacing="1" border="0">
						<tr>
						<td colspan="2" align="left" class="regiheader"><?php echo $Captions_arr['CART']['CART_CREDIT_CARD_DETAILS']?></td>
						</tr>
						<?php
			...
			?>
					<tr>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td colspan="2" align="left" class="regiheader">
			...
			<?php	
				...
				else// case if credit card details not to be picked
				{
					...
					{	
						...
						<table width="100%" cellpadding="1" cellspacing="1" border="0">
						<tr>
						<td colspan="2" align="left" class="regiheader"><?php echo $Captions_arr['CART']['CART_CHEQUE_DETAILS']?></td>
						</tr>
						<?php
							// Get the list of credit card static fields to be shown in the checkout out page in required order
							$sql_checkout = "SELECT field_det_id,field_key,field_name,field_req,field_error_msg   
		  ...
		  <?php
				if($checkout_caption=='Place Invoice')
				{
					if($Captions_arr['CART']['CART_INVOICE_MSG_MORE']!='')
					{
					?>
					<tr>
						<td align="center" colspan="6" class="red_msg"><?php echo $Captions_arr['CART']['CART_INVOICE_MSG_MORE']?></td>
					</tr>
					<?php	
					}
				}
		 ...
		 <?php
		  ...
		  <?php
			...
			?>
				...
				<tr>
					<td colspan="5" align="right" valign="middle" class="shoppingcartcontent"><strong><?php echo $Captions_arr['CART']['CART_TOTAL_AMT_NOW']?>:</strong>&nbsp; </td>
					<td align="right" valign="middle" class="shoppingcartpriceC"><?php echo print_price($rem_val,true)?>
					</td>
			  	</tr>
			<?php
			...
			<?php
				...
				?>
							<tr>
								...
								<td align="left" colspan="4">: <?php echo stripslashes($row_ord[$row_checkout['field_orgname']]);
								?>
								</td>
							</tr>
				<?php
			...
			<?php
				...
				?>
							<tr>
								...
								<td align="left" colspan="4">: <?php echo stripslashes($row_del[$row_checkout['field_orgname']]);
								?>
								</td>
							</tr>
				<?php
			...
			*/
			if($ecom_isadword)
			{
				...
				?>
						...
						<noscript>
						<?php /*<img height=1 width=1 border=0 src="https://www.googleadservices.com/pagead/conversion/<?php echo $ecom_adword_conversionid?>/imp.gif?value=<?=$total_price?>&label=<?php echo $ecom_adword_conversionlabel?>&script=0">
						*/?>
						<img height="1" width="1" style="border-style:none;" alt="" src="http://www.googleadservices.com/pagead/conversion/<?php echo $ecom_adword_conversionid?>/?value=<?=$total_price?>&amp;label=<?php echo $ecom_adword_conversionlabel?>&amp;guid=ON&amp;script=0"/>
						</noscript>
			<?php		
			...
			if($ecom_siteid==72 and $order_id>0) // discount mobility
			{
				?>
				<script type="text/javascript">
				<!--
		...
		?>
		<div class="treemenu_special"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?php echo $Captions_arr['CART']['CART_CHECKOUT_SUCCESS_TITLE']?></div>
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="shoppingcarttable">
			  <tr>
		...
		function Show_NoChexCommonSuccess()
		{
			...
			$Captions_arr['CART'] 	= getCaptions('CART'); // Getting the captions to be used in this page
		?>
		<div class="treemenu"><a href="<? url_link('');?>" title="<?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> >> <?php echo $Captions_arr['CART']['CART_NOCHEXCHECKOUT_SUCCESS']?></div>
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="shoppingcarttable">
			<tr>
