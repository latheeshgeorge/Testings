<?php
	...
	<?php
	 ...
	 ?>
		   ...
		   ?>
		   <tr>
		        <td align="center" valign="middle" class="pagingcontainertd" colspan="7" >
				<?php 
					$path = '';
					$query_string .= "";
					paging_footer($path,$query_string,$tot_cnt,$start_var['pg'],$start_var['pages'],'',$pg_variable,'Orders',$pageclass_arr); 	
...
?>
  ...
  <?php
   ...
   <tr>
	...
	<tr id="billDetails" style="display:none;">
	<td colspan="4">
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
		<?php
			$max_cols	= 1;
		...
		<tr>
			...
			?>
				...
				while ($row_query = $db->fetch_array($ret_download))
				{
					...
					$sql_history = "SELECT DATE_FORMAT(track_date ,'%d-%m-%Y %h:%i:%s %p') as download_date 
												FROM 
