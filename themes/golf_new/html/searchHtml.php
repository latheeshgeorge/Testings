							...
							if(trim($search_desc)) {
									   ...
									   ?>
										...
										<?php
											...
											while ($row_search = $db->fetch_array($ret_search))
											{
												...
												<h2 class="newshelfBprodname"><a href="<?php url_product($row_search['product_id'],$row_search['product_name'],-1)?>" title="<?php echo stripslashes($row_search['product_name'])?>"><?php echo stripslashes($row_search['product_name'])?></a></h2>
												
												<h6 class="newshelfBproddes"><?php echo stripslashes($row_search['product_shortdesc'])?></h6>
															<?php
												...
												if($row_search['product_bulkdiscount_allowed']=='Y'  || $row_search['product_freedelivery']==1 )
												{
												?>
													<div class="shlf_sale">
												...
												<a href="<?php url_product($row_search['product_id'],$row_search['product_name'],-1)?>" title="<?php echo stripslashes($row_search['product_name'])?>">
																				<?php
																					...
																					if(count($img_arr))
																					{
																						show_image(url_root_image($img_arr[0][$pass_type],1),$row_search['product_name'],$row_search['product_name'],'newshelfBimg');
																					}
																					else
																					{
																						...
																						if ($no_img)
																						{
																							show_image($no_img,$row_search['product_name'],$row_search['product_name'],'newshelfBimg');
																						}	
																					}	
																				?>
																				</a>
											...
											<div class="buy_main">
												...
												<?php
														...
														show_addtocart($row_search,$class_arr,$frm_name,false,'','','add_divlink',0)
													?></div>
												</div>      
												<div class="shlf_info_btn"><div class="shlf_info_btnleft">
												<?php show_moreinfo($row_search,'info_buy')?>
												</div></div>   
												</div>											
                               ...
                               <td class="newshelfAtabletd" onmouseover="this.className='newshelfAtabletd_hover'" onmouseout="this.className='newshelfAtabletd'" align="left" valign="top">												
													<ul class="shelfAul">
																...
																<li><h2 class="shelfAprodname"><a href="<?php url_product($row_search['product_id'],$row_search['product_name'],-1)?>" title="<?php echo stripslashes($row_search['product_name'])?>"><?php echo stripslashes($row_search['product_name'])?></a></h2></li>
														...
														if($row_search['product_freedelivery']==1 || $row_search['product_bulkdiscount_allowed']=='Y')
														{
															?>
															<li class="shlf_sale">
																<?php
														...
														?>
															<li><h6 class="shelfAproddes"><?php echo stripslashes($row_search['product_shortdesc'])?></h6></li>
													</ul>
														  ...
														  ?>
															<a href="<?php url_category($row_search['category_id'],$row_search['category_name'],-1)?>" title="<?php echo stripslashes($row_search['category_name'])?>">
															 <?php
															  ...
															  ?>
														<h2 class="shelfBprodname"><a href="<?php url_category($row_search['category_id'],$row_search['category_name'],-1)?>" title="<?php echo stripslashes($row_search['category_name'])?>"><?php echo stripslashes($row_search['category_name'])?></a></h2>
													  </td>
													  <td colspan="2" class="cat_srh_rslt">
