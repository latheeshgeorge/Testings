<?php
	...
	class components
	{
			...
			switch($position)
			{
				...
				if ($cache_exists==false)
				{
					...
					if ($position == 'bottom') // Case if value of position is bottom;
					{
						...
						?>
							<tr>
								<td colspan="3" align="center" valign="top" class="bottomstat">
						...
						<?php
							...
							foreach ($grp_array as $k=>$grpData)
							{
								...
								if($show_top==0)
								{
									...
									{
						?>
										<li><h2><a href="<?php url_link('')?>" class="bottomlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_HOME']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_HOME']?></a></h2></li>
						<?php			
									}
										$show_top = 0;
								}	
								...
								while ($row_pg = $db->fetch_array($ret_pg))
								{
									$target = ($row_pg['page_link_newwindow']==1 and $row_pg['page_type']!='Page')?'target="_blank"':'';
								?>
										<li><h2><a href="<?php if ($row_pg['page_type']=='Page') url_static_page($row_pg['page_id'],$row_pg['title']); else echo $row_pg['page_link'];?>" class="bottomlink" title="<?php echo stripslashes($row_pg['title'])?>" <?php echo $target?>><?php echo stripslashes($row_pg['title']);?></a></h2></li>
								<?php
								}
							}
						?>
						<?php			
									...
									{
						?>
										<li><h2><a href="<?php url_link('sitemap.html')?>" class="bottomlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_SITEMAP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_SITEMAP']?></a></h2></li>
						<?php			
									}
									if ($grpData['group_showxmlsitemaplink']==1 )
									{			
									?>
										<li><h2><a href="<?php url_link('sitemap.xml')?>" class="bottomlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_XMLSITEMAP']?></a></h2></li>
									<?php									
									}
									if ($grpData['group_showfaqlink']==1)
									{
						?>
										<li><h2><a href="<?php url_link('faq.html')?>" class="bottomlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_FAQ']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_FAQ']?></a></h2></li>
						<?php			
									}
									if ($grpData['group_showhelplink']==1)
									{
						?>
										<li><h2><a href="<?php url_link('help.html')?>" class="bottomlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_HELP']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_HELP']?></a></h2></li>
						<?php			
									}
									if ($grpData['group_showsavedsearchlink']==1)
									{
						?>
										<li><h2><a href="<?php url_link('saved-search.html')?>" class="bottomlink" title="<?php echo $Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH']?>"><?php echo $Captions_arr['STATIC_PAGES']['STAT_SAVEDSEARCH']?></a></h2></li>
						<?php			
									}
						?>			
							</ul>
					...
					?>
						<tr>
                        <td colspan="3" class="general_links" align="center" valign="top">
								...
								foreach ($grp_array as $k=>$grpData)
								{
									...
									if ($db->num_rows($ret_cat))
									{
										...
										<?php
											...
											{
										?>
												<li><h2><a href="<?php url_category($row_cat['category_id'],$row_cat['category_name'],-1)?>" class="categorytoplink" title="<?php echo stripslashes($row_cat['category_name'])?>"><?php echo ucwords(stripslashes($row_cat['category_name']));?></a></h2></li>
										<?
											}
										?>
													</ul>
							...
							if(count($grp_array))
							{
								...
								foreach ($grp_array as $k=>$grpData)
								{
									...
									if ($db->num_rows($ret_cat))
									{
										...
										?>
											<tr>
												<td colspan="3" align="center" valign="top" class="bottomcat">
												<div class="bottom_div">
								                <ul class="bottomlinks">
										<?php
											while ($row_cat = $db->fetch_array($ret_cat))
											{
												$startpnt++;
										?>
														<li><h2><a href="<?php url_category($row_cat['category_id'],$row_cat['category_name'],-1)?>" class="bottomlink" title="<?php echo stripslashes($row_cat['category_name'])?>"><?php echo ucwords(stripslashes($row_cat['category_name']));?></a></h2></li>
										<?php
											}
										?>
												</ul>
								...
								$sql_cat = "SELECT a.category_id,a.category_name,parent_id,b.category_displaytype,b.category_islink,a.category_subcatlisttype   
									...
									if ($db->num_rows($ret_cat))
									{
										...
										<?php
											while ($row_cat = $db->fetch_array($ret_cat))
											{
												if($prev_grp != $grpData['catgroup_id'])
												{
													...
													{
											?>
														<li class="categoryheader"><h2><?php echo stripslashes($title)?></h2></li>
											<?php
													}
											...
											{
											?>
												 <li><h2><a href="<?php url_category($row_cat['category_id'],$row_cat['category_name'],-1)?>" class="catelink" title="<?php echo stripslashes($row_cat['category_name'])?>"><?php echo ucwords(stripslashes($row_cat['category_name']));?></a></h2></li>
											<?php
											}
											...
											{
											?>
												 <li><h2><span class="subcategoryheader"><a href="<?php url_category($row_cat['category_id'],$row_cat['category_name'],-1)?>" class="subcategoryheaderlink" title="<?php echo stripslashes($row_cat['category_name'])?>"><?php echo ucwords(stripslashes($row_cat['category_name']));?></a></span></h2></li>
											<?
											}
											elseif($row_cat['category_displaytype']=='Heading' && !$row_cat['category_islink'])
											{
											?>
												 <li><h2><span class="subcategoryheader"><?php echo ucwords(stripslashes($row_cat['category_name']));?></span></h2></li>
											<?
											}
												...
												if ($row_cat['category_subcatlisttype']=='List' or $row_cat['category_subcatlisttype']=='Both')
												{
													...
													{	
														...
														<?php	
															...
															{
														?>
																	<li><h2><a href="<?php url_category($row_child['category_id'],$row_child['category_name'],-1)?>" title="<?php echo stripslashes($row_child['category_name'])?>" class="catelink"><?php echo ucwords(stripslashes($row_child['category_name']));?></a></h2></li>
														<?php		
															}
														?>
															</ul>
										...
										else
										{
											if ($grpData['catgroup_hidename']==0) // Decide whether or not to show the groupname
											{
												echo '<ul class="category"><li class="categoryheader"><h2>'.$title.'</h2></li>';
											}
										?>
											<li>
										...
										<?php
											while ($row_cat = $db->fetch_array($ret_cat))
											{
												if($prev_grp != $grpData['catgroup_id'])
												{
													...
													{
										?>
														<li class="categoryheaderright"><h2><?php echo stripslashes($title)?></h2></li>
										<?php
													}
														$prev_grp = $grpData['catgroup_id'];
												}
												...
												if ($row_cat['category_subcatlisttype']=='List' or $row_cat['category_subcatlisttype']=='Both')
												{
													if (($row_cat['category_id']==$_REQUEST['category_id']) or ($row_cat['category_id']==$parent))
													{
														...
														<?php	
															...
															{
														?>
																<li><h2><a href="<?php url_category($row_child['category_id'],$row_child['category_name'],-1)?>" title="<?php echo stripslashes($row_child['category_name'])?>" class="catelinkright"><?php echo ucwords(stripslashes($row_child['category_name']));?></a></h2></li>
														<?php		
															}
														?>
															</ul>
		...
		?>
				<tr>
					...
					<ul class="topcartlink">
					 ...
					 <li><?php echo $Captions_arr['COMMON']['ITEMS_IN_CART']?><?php echo  (get_session_var('cart_total_items'))?get_session_var('cart_total_items'):0?></li>
					 <li><a href="#" onclick="handle_checkout_submit('<?php echo $ecom_hostname?>',0,'<?php echo $pass_tot?>')" class="viewcheckout" title="<?php echo $Captions_arr['COMMON']['CHECK_OUT']?>"><?php echo $Captions_arr['COMMON']['CHECK_OUT']?></a></li>
					  ...
					  <li><a href="<?php url_link('enquiry.html')?>" class="viewenquiry" title="<?php echo $Captions_arr['COMMON']['VIEW_ENQUIRY']?>"><?php echo $Captions_arr['COMMON']['VIEW_ENQUIRY']?></a></li>
					  </ul>  
					</div>
                    </div>
					</td>
		...
		{
			global $Captions_arr,$ecom_hostname,$inlineSiteComponents,$Settings_arr,$db,$ecom_siteid,$loginUrl,$logoutUrl,$ecom_fb_enable;
		...
		<?php	
			...
			?>
				<ul class="userloginmenu">  
					<li><h2><a href="<?php url_link('login_home.html')?>" class="userloginmenulink"><?=$Captions_arr['LOGIN_MENU']['MY_HOME']?></a></h2></li>
                    <?php /* FB login script */
						if($cust_fbid <= 0)
						{
					?>
					<li><h2><a href="<?php url_link('myprofile.html')?>" class="userloginmenulink"><?=$Captions_arr['LOGIN_MENU']['MY_PROFILE']?></a></h2></li>
                    <?php
						}
					?>
					<li><h2><a href="<?php url_link('myenquiries.html')?>" class="userloginmenulink"><?=$Captions_arr['LOGIN_MENU']['MY_ENQUIRIES']?></a></h2></li>
					<li><h2><a href="<?php url_link('wishlist.html')?>" class="userloginmenulink"><?=$Captions_arr['LOGIN_MENU']['MY_WISHLIST']?></a></h2></li>
				<?php	
					$myfav_module = 'mod_myfavorites';
					if(in_array($myfav_module,$inlineSiteComponents)){
				?>
					<li><h2><a href="<?php url_link('myfavorites.html')?>" class="userloginmenulink"><?=$Captions_arr['LOGIN_MENU']['MY_FAVOURITE']?></a></h2></li>
				<? }	
					$myaddr_module = 'mod_myaddressbook';
					if(in_array($myaddr_module,$inlineSiteComponents)){
				?>
					<li><h2><a href="<?php url_link('myaddressbook.html')?>" class="userloginmenulink"><?=$Captions_arr['LOGIN_MENU']['MY_ADDRESSBOOK']?></a></h2></li>
				<? }?>
					<li><h2><a href="<?php url_link('myorders.html')?>" class="userloginmenulink"><?=$Captions_arr['LOGIN_MENU']['MY_ORDERS']?></a></h2></li>
				<?php
					...
					{
				?>	
						<li><h2><a href="<?php url_link('mydownloads.html')?>" class="userloginmenulink"><?=$Captions_arr['LOGIN_MENU']['MY_DOWNLOADS']?></a></h2></li>
				<?php
					}
				...
				?>	
						<li><h2><a href="<?php url_link('mypayonaccountpayment.html')?>" class="userloginmenulink"><?=$Captions_arr['LOGIN_MENU']['MY_PAYONACCDETAILS']?></a></h2></li>
				<?php
					}
				?>	
					<li><h2><a href="<?php url_link('mypricepromise.html')?>" class="userloginmenulink"><?=$Captions_arr['LOGIN_MENU']['MY_PRICE_PROMISE']?></a></h2></li>
                    <?php /* FB login script */
						if($cust_fbid > 0)
						{
					?>
					<li><h2><a href="<?php echo $logoutUrl; ?>" class="userloginmenulink"><?=$Captions_arr['LOGIN_MENU']['LOGOUT']?></a></h1></li>
					<?php
						}
						else
						{
					?>
					<li><h2><a href="<?php url_link('logout.html')?>" class="userloginmenulink"><?=$Captions_arr['LOGIN_MENU']['LOGOUT']?></a></h2></li>
                    <?php
						}
					?>
				</ul> 
		...
		function mod_bestsellers($ret_main,$title,$display_id)
		{
			...
			{	
				if ($db->num_rows($ret_main))
				{
						...
						{
				?>
						<table class="bst_table" border="0" cellpadding="0" cellspacing="0">
							<tbody>
							<?php
							...
							?>
							<tr>
							<td class="bst_table_td">
							
							<div class="bst_header"><?php echo $title?></div>
							<div class="bst_header_bottom"></div>
							...
							while ($row_main = $db->fetch_array($ret_main))
								...
								<tr>
								<td class="bst_table_td">
										<div class="bst_pdt_top">
										
										<div class="bst_pdt_img"> 
										...
										<div class="bst_pdt_name"><?php show_moreinfo($row_main,'bst_link')?></div>
										</div>
										<div class="best_comp_pdt_name">
<a href="<?php url_product($row_main['product_id'],$row_main['product_name'],-1)?>" title="<?php echo stripslashes($row_main['product_name'])?>" class="best_comp_name_link"><?php echo stripslashes($row_main['product_name'])?></a>
</div>
										<div class="bst_pdt_price">
											<?php
							...
							<tr>
							<td class="bst_table_td" align="right"><a href="<? url_link('bestsellers'.$display_id.'.html')?>" class="bst_showall" title="<?php echo $Captions_arr['COMMON']['SHOW_ALL']?>"><?php echo $Captions_arr['COMMON']['SHOW_ALL']?></a></td>
							</tr>
							</tbody>
						</table>
		...
		function mod_compare_products($ret_compare_pdts,$title='Compare PrOducts')
		{
			...
			{	
				...
				<?php
							...
							{
				?>
								<li class="compareproductssheader"><?php echo $title?></li>
				<?php
							}
							while ($row_compare_pdts = $db->fetch_array($ret_compare_pdts))
							{
				?>	
								<li><h2><img src="<?php url_site_image('delete.gif')?>" onclick="document.common_compare_list.remove_compareid.value=<?=$row_compare_pdts['product_id']?>; if(confirm('Are You sure You want to remove the product from the compare list')){ document.common_compare_list.submit()};" alt="Remove" title="Remove" />&nbsp;<a href="<?php url_product($row_compare_pdts['product_id'],$row_compare_pdts['product_name'],-1)?>" class="compareproductslink" title="<?php echo stripslashes($row_compare_pdts['product_name'])?>"><?php echo stripslashes($row_compare_pdts['product_name'])?></a></h2></li>
				...
				<?php
							...
							{	
				?>
								<li><h2 align="right"> <a href="<?php url_link('compare_products.html')?>" class="showall" title="<?php echo $Captions_arr['COMMON']['COMPARE_PRODUCTS']?>" target="_blank"><?php echo $Captions_arr['COMMON']['COMPARE_PRODUCTS']?></a> </h2> </li>
				<? 			
							}
				?>				
							</ul></form>
			...
			if ($position=='left' or $position =='right')// Combo deal is allowed only in left or right panel
			{
				...
				{	
						...
						?>
									...
									{
									?>	
									<div class="lf_combodeal_top"><? echo $title?></div>
									<?php
									}
									...
									<a href="<?php url_combo($combData['combo_id'],$combData['combo_name'],-1)?>"  title="<?php echo $Captions_arr['COMMON']['SHOW_DEAL']?>">
													<?php
														// Calling the function to get the type of image to shown for current 
									...
									<?php if($cnt>0 && $cnt%3!=0 && $cnt!=$totcnt)
													   { 
													  ?>
									<div class="lf_combodeal_plus"></div>															<?php 
														}
														?>
									...
									<div class="lf_combodeal_bottom"><a href="<?php url_combo($combData['combo_id'],$combData['combo_name'],-1)?>" class="lf-combodeal-showall" title="<?php echo $Captions_arr['COMMON']['SHOW_DEAL']?>"><?php echo $Captions_arr['COMMON']['SHOW_DEAL']?></a></div>
									</div> 
						<?php	
									}
								}
						...
						if ($db->num_rows($ret_prod))
						{
							if($shelfData['shelf_currentstyle']=='nor') // case of normal design layout
							{
								switch($shelfData['shelf_displaytype'])
								{
									...
									?>
									<table class="normal_lf_table" border="0" cellpadding="0" cellspacing="0">
										<tbody>
										<?php
										if ($title)
										{
										?>	
										<tr>
										  <td class="normal_lf_header"><h2><?php  echo $title?></h2>
											  </td>
										</tr>
										<? }
										while($row_prod = $db->fetch_array($ret_prod))
										...
										?>
										<tr>
										  <td class="normal_lf_table_td">
										  <div class="normal_lf_pdt_name"><h3><a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" class="normal_lf_link" title="<?php echo stripslashes($row_prod['product_name'])?>"><?php echo stripslashes($row_prod['product_name'])?></a></h3></div>
										  <?php
										  if($shelfData['shelf_showimage']==1) // whether image is to be displayed
											{
											?>
											  <div class="normal_lf_pdt_name"> <a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" title="<?php echo stripslashes($row_prod['product_name'])?>">
											<?php
										...
										{
										?>
										<div class="normal_lf_pdt_price">
										<span class="normal_lf_pdtnormalprice">
										<?php
										...
										<? }?>
										<tr>
										  <td class="normal_lf_table_td" align="right"><a href="<?php  url_shelf_all($shelfData['shelf_id'],$shelfData['shelf_name'],-1)?>" class="bst_showall" title="<?php echo $Captions_arr['COMMON']['SHOW_ALL']?>"><?php echo $Captions_arr['COMMON']['SHOW_ALL']?></a></td>
										</tr>
										</tbody>
										</table>
									<?php	
							...
							elseif($shelfData['shelf_currentstyle']=='christ') // case of christmas layout
							{
								...
								case '3row':
									?>
										<table class="normal_table" border="0" cellpadding="0" cellspacing="0">
												<tbody>
												<?php
											if ($title)
											{
											?>
												<tr>
								<td class="normal_table_td">
								<div class="normal_header"><h2><?php echo $title?></h2></div>
								</td>
								</tr>	
					                      <?php
											}
								...
								<div class="normal_pdt_top"></div>
								<div class="normal_pdt_mid">
								<?php
								if($shelfData['shelf_showimage']==1) // whether image is to be displayed
												{
												?>
								...
								if($shelfData['shelf_showtitle']==1)// whether title is to be displayed
												{
								?>
								<div class="normal_pdt_name">
								<h3><a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" class="normal_name_link" title="<?php echo stripslashes($row_prod['product_name'])?>"><?php echo stripslashes($row_prod['product_name'])?></a></h3></div>
								
								<? }?>
								</div>
								<div class="normal_pdt_buy">
								<div class="normal_pdt_price"><?php //show_moreinfo($row_prod,'normal_pdt_link')?>
								<?php
																	$class_arr 					= array();
																	$class_arr['ADD_TO_CART']	= 'normal_pdt_link';
																	$class_arr['PREORDER']		= 'normal_pdt_link';
																	$class_arr['ENQUIRE']		= 'normal_pdt_link';
																	//show_addtocart($row_prod,$class_arr,$frm_name,false,'<div class="normal_pdt_info">','</div>','',1)
								...
								<? }?>
												...
												<tr>
								<td class="normal_table_td" align="right"><a href="<?php  url_shelf_all($shelfData['shelf_id'],$shelfData['shelf_name'],-1)?>" class="bst_showall" title="<?php echo $Captions_arr['COMMON']['SHOW_ALL']?>"><?php echo $Captions_arr['COMMON']['SHOW_ALL']?></a></td>
								</tr>
								</tbody></table>
									<?php	
								break;
							...
							elseif($shelfData['shelf_currentstyle']=='new') // case of new year layout
							{
								...
								case '3row':
								?>
								<table class="spcl2_lft_table" border="0" cellpadding="0" cellspacing="0">
								<tbody>
								<?php
								if ($title)
								{
								?>
								<tr>
								<td class="spcl2_lft_header"><h2><?php echo $title?></h2></td>
								</tr>
								<? }?>	
								<? while($row_prod = $db->fetch_array($ret_prod))
								{?>
								<tr>
								<td class="spcl2_lft_table_td">
								
								<div class="spcl2_lft_pdt_left">
								<?php
											if ($shelfData['shelf_showprice']==1)// Check whether description is to be displayed
											{
												...
												<span class="spcl2_lft_pdt_price" ><? echo ($price_arr['discounted_price']!='')?$price_arr['discounted_price']:$price_arr['base_price'];?></span> 
											
												<? 
											}?>
								</div>
								<div class="spcl2_lft_pdt_right">
								<?php
								if($shelfData['shelf_showimage']==1) // whether image is to be displayed
								{
								?>
								...
								?></div><div class="spcl2_lft_pdt_name">
								<?php
								if($shelfData['shelf_showtitle']==1)// whether title is to be displayed
								{
								?>	
								<h3><a href="<?php url_product($row_prod['product_id'],$row_prod['product_name'],-1)?>" class="spcl2_lft_name_link" title="<?php echo stripslashes($row_prod['product_name'])?>"><?php echo stripslashes($row_prod['product_name'])?></a></h3>
								<? }?></div>
								...
								<? }?>
								<tr>
								<td class="spcl2_lft_shwall_td" align="right"><a href="<?php  url_shelf_all($shelfData['shelf_id'],$shelfData['shelf_name'],-1)?>" class="spcl2_lft_pdt_showall" title="<?php echo $Captions_arr['COMMON']['SHOW_ALL']?>"><?php echo $Captions_arr['COMMON']['SHOW_ALL']?></a></td>
								</tr>
								</tbody>
								</table>
								<?php	
		...
		function mod_giftvoucher($title)
		{
		   ...
		   ?>
			<div class="left_gift_buy"><a href="<?php echo get_buyGiftVoucherURL()?>" class="buygiftvoucherheader" title="<?php echo $Captions_arr['GIFT_VOUCHER']['BUY_VOUCHER']?>"><img src=" <?php url_site_image('buy-gift.gif') ?>" /></a></div>
		<?php	
		}
		// ####################################################################################################
		...
		function mod_spendvoucher($title)
		{
			...
			?>
			  ...
			  <a href="http://<?php echo $ecom_hostname?>/spend_voucher.html" class="buygiftvoucherheader" title="<?php echo $Captions_arr['GIFT_VOUCHER']['SPEND_VOUCHER_CLICK_HERE']?>"><img src="<?php url_site_image('use-gift.gif')?>" /></a></div>
			  <?
			  }
			  ?>
		<?php	
				...
				if(count($grp_array))
				{
					...
					foreach ($grp_array as $k=>$groupData)
					{
						...
						$ret_shop = $db->query($sql_shop);
							...
							{
								   $groupData['shopbrandgroup_listtype'] ='Dropdown';
									if ($position == 'left' or $position == 'right') // ############## Left ##############
									{
									// Check the listing type for shop in product shop group
										...
										<?php
											...
											?>
												 <li><h2><a href="<?php url_shops($row_shop['shopbrand_id'],$row_shop['shopbrand_name'],-1)?>" class="shopleftlink" title="<?php echo stripslashes($row_shop['shopbrand_name'])?>"><?php echo stripslashes($row_shop['shopbrand_name']);?></a></h2></li>
											<?php
													...
													if (($row_shop['shopbrand_id']==$_REQUEST['shop_id']) or ($row_shop['shopbrand_id']==$parent))
													{
													  ...
													  $comp_shop = $row_shop['shopbrand_id']; 
														...
														<?php	
															...
															{
														?>
																	<li><h2><a href="<?php url_shops($row_child['shopbrand_id'],$row_child['shopbrand_name'],-1)?>" title="<?php echo stripslashes($row_child['shopbrand_name'])?>" class="shopleftlink"><?php echo stripslashes($row_child['shopbrand_name']);?></a></h2></li>
														<?php		
															}
														?>
															</ul>
		...
		function mod_adverts($advert_arr,$title)
		{
			...
			if ($position=='left' or $position=='right') // show the advert only if position is left or right
			{
				if (count($advert_arr))
				{
					...
					<?php	
							if($title and $k['advert_type']!='ROTATE')
							{
					?>
							  <tr>
		...
		?>
			...
			<tr>
				...
				?>					    
                        ...
                        <tr>
                            <td>
                            <div class="cart_btnlf">
                                <a href="<?php  url_category($_REQUEST['category_id'],$row_cats['category_name'],-1)?>" class="cart_linklf" title="<?php echo $Captions_arr['COMMON']['SHOW_PROD_ALL']?>"><span><?php echo $Captions_arr['COMMON']['SHOW_PROD_ALL']?></span></a>
                                </div>
		...
		?>
			...
			?>
			<tr>
				    <td align="right" class="webstatistics"><span class="webstatisticsA">"<?=$row_query['site_hits']?>"</span><br /><?php echo $Captions_arr['COMMON']['WEB_STATISTICS']?></td>
				</tr>	
			</table>
		<?
		}
		function mod_ssl($title)
                {
					...
					{
                ?>
                    <table border="0" cellpadding="0" cellspacing="0" class="ssltable">
                    <?php
                    if($title)
                    {
                    ?>
				...
				?>
						<tr>
                        <td colspan="3" class="general_links" valign="top" align="center">
		...
		?>
			<tr>
                ...
                <?php /* FB login script */
					...
					{
				?>
				<li><h2><a href="<?php echo $logoutUrl; ?>" class="userloginmenuytoplink"><?=$Captions_arr['LOGIN_MENU']['LOGOUT']?></a></h1></li>
				<?php
					}
					else
					{
		...
		function mod_preorder($ret_main,$title,$display_id)
		{
			...
			{	
				...
				?>
			<table border="0" cellpadding="0" cellspacing="0" class="preordviwedtable">
			<?php
				if($title)
				{
			?>
				<tr>
					<td  class="preordviewheader"><?php echo $title?></td>
				</tr>
			<?php
				}
			?>	
			<tr>
				...
				{	while ($row_main = $db->fetch_array($ret_main))
							...
							?>
								<ul class="preordprod">  
									<li  class="preordproimage">
									
										<a href="<?php echo url_product($row_main['product_id'],$row_main['product_name'],-1)?>" title="<?php echo stripslashes($row_main['product_name'])?>">
										<?php
											// Calling the function to get the type of image to shown for current 
										    $pass_type = 'image_thumbcategorypath';
											// Calling the function to get the image to be shown
										...
										<a href="<?php echo url_product($row_main['product_id'],$row_main['product_name'],-1)?>" class="preordprodlink" title="<?php echo stripslashes($row_main['product_name'])?>"><?php echo stripslashes($row_main['product_name'])?></a>
									</li>
								</ul> 
							<?php
							}		
				...
				<tr>
				<td align="right" >
				<ul class="preordcompshelflist">
				<li><h2 align="right"><a href="<? url_link('preorder'.$display_id.'.html')?>" class="preordshowall" title="<?php echo $Captions_arr['COMMON']['SHOW_ALL']?>" <?php /*onclick="document.bestseller_component_left<?=$display_id?>.submit();"*/?>><?php echo $Captions_arr['COMMON']['SHOW_ALL']?></a></h2></li>
				</ul>
				</td>
				</tr>
			</table>
