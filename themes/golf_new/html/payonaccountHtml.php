          ...
          <table class="lgn_table" width="100%" border="0" cellpadding="0" cellspacing="4">
            <tbody>
              ...
              <tr>
				...
				<div class="lgn_btn">
				<a href="<?php url_link('registration.html?pagetype=payonacc')?>"><img src="<?php url_site_image('newaccount-btn.gif')?>" border="0" /></a>
				</div>
				</td>
              </tr>
            </tbody>
          ...
          <table class="regifontnormal" width="100%" border="0" cellpadding="0" cellspacing="4">
            <tbody>
              ...
              <tr>
				...
				<div class="lgn_btn">
				<a href="javascript:document.frm_custlogin_payonacc.submit()"><img src="<?php echo url_site_image('login-btn-new.gif')?>" border="0" /></a>
				</div></td>
              </tr>
...
function handle_paytypeselect_payonaccount(obj)
{
  ...
  <tr>
    <td colspan="4" align="center" class="emailfriendtextnormal"><?=$Captions_arr['PAYONACC']['PAYON_VERIFICATION_CODE']?>&nbsp;<span class="redtext">*</span><span class="emailfriendtext">
	  <?php 
  ...
  <td colspan="2">
    ...
    ?>
		...
		?>
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="shoppingcarttable">
			<tr>
				<td align="left" valign="middle"><div class="treemenu"><a href="<? url_link('');?>"><?=$Captions_arr['COMMON']['TREE_MENU_HOME_LINK'];?></a> 
				>> <a href="<? url_link('mypayonaccountpayment.html');?>"> <?=$Captions_arr['PAYONACC']['PAYONACCOUNT_MAINHEADING']?></a>
				>> <?php echo $Captions_arr['PAYONACC']['PAYON_FAILED_TITLE']?></div></td>
			</tr>
			<?php
				if($msg)
				{
