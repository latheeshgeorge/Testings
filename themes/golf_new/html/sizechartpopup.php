...
<tr>
	<td  colspan="4" >
<?php /*?>	<div id="sizechart_close_div" class="sizechart_close">
<a href="javascript:window.close()" title="Click to Close"><img src="<?php url_site_image('comp-icn.gif')?>" width="22" height="22" border="0"></a></div><?php */?>
...
?>
<tr>
  <td colspan="4" ><div id="sizechart_close_div2" class="sizechart_close" align="RIGHT"> <a href="javascript:window.close()" title="Click to Close"><img src="<?php url_site_image('size-close.gif')?>" border="0"></a></div></td>
</tr>
</tbody></table>
</body>
</html>
