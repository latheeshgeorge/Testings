...
$order_id			= trim($order_id_arr[1]);
$fin_code			= trim($_POST['Code']);

$cons_title			= trim($_POST['Title']);
$cons_forename		= trim($_POST['Forename']);
$cons_surname		= trim($_POST['Surname']);
...
$fp = fopen ('finance_test/response.txt','a+');
