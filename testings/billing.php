...
if ( $PaymentOption == "PayPal")
{
	...
	//'------------------------------------
	$returnURL = "http://www.peterfieldonlinegolfshop.co.uk/testings/paypal-return.php";
	...
	//' This is set to the value entered on the Integration Assistant 
	//'------------------------------------
	$cancelURL = "http://www.peterfieldonlinegolfshop.co.uk/testings/paypal-cancel.php";
