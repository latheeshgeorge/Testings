...
?>
	...
	while (($data = fgetcsv($fp, 1000, ",")) !== FALSE)
	{
		if($i!=0) // case of header row
		{
			...
			$update_array				= array();
			$update_array['parent_id']	= $dir_arr[$parent];
			$db->update_from_array($update_array,'images_directory',array('directory_id'=>$new_catid));
	...
	?>
<tr>
	<td colspan="3" align="center" style="color:#006600"><strong>----- Image Directory Parent Mapped Successfully ------ <?php echo date('r')?></strong></td>
</tr>
</table>
