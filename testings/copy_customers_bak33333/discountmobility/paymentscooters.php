<?php
	...
	$import_file 			= 'discountmobility-csv/PAYMENT SCOOTERS.csv';	// Import filename
	$i=0;
	...
	$atleast_one_err = 0;
	$i =0;
	$category_name = "PAYMENT SCOOTERS";
    ...
    */ 
	...
	{ 
		if($i!=0) // case of header row
		{
			...
			if($data[25]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Tiller Type</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[25]</td></tr>";
			if($data[26]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Suspension</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[26]</td></tr>";
			if($data[27]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Swivel Seat</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[27]</td></tr>";
			if($data[28]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Light</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[28]</td></tr>";
			if($data[29]!='')
			$decription_tab  .= "<tr><td class='desc_left'>On/Off-board charging</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[29]</td></tr>";
			if($data[30]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Portable</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[30]</td></tr>";
			if($data[31]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Web Weight (kg)</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[31]</td></tr>";
			if($data[32]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Shipping Weight</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[32]</td></tr>";
			if($data[33]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Shipping Size (S,L)</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[33]</td></tr>";
			if($data[36]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Engineered Delivery</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[36]</td></tr>";
			if($data[37]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Vatable</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[37]</td></tr>";
