<?php
	...
	$import_file 			= 'discountmobility-csv/MOBILITY SCOOTER BATTERIES.csv';	// Import filename
	$i=0;
	...
	$atleast_one_err = 0;
	$i =0;
	$category_name = "MOBILITY SCOOTER BATTERIES";
    ...
    */ 
	...
	{ 
		if($i!=0) // case of header row
		{
			...
			if($data[13]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Length (mm)</td><td class='desc_middle'>:</td><td class='desc_right'>$data[13]</td></tr>";
			if($data[14]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Width(mm)</td><td class='desc_middle'>:</td><td class='desc_right'>$data[14]</td></tr>";
			if($data[15]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Height(mm)</td><td class='desc_middle'>:</td><td class='desc_right'>$data[15]</td></tr>";
			if($data[16]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Web Weight (kg)</td><td class='desc_middle'>:</td><td class='desc_right'>$data[16]</td></tr>";
			if($data[17]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Shipping Weight</td><td class='desc_middle'>:</td><td class='desc_right'>$data[17]</td></tr>";
			if($data[19]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Vatable</td><td class='desc_middle'>:</td><td class='desc_right'>$data[19]</td></tr>";
