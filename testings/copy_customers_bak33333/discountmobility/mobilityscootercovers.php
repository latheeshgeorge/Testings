<?php
	...
	$import_file 			= 'discountmobility-csv/MOBILITY SCOOTER COVERS.csv';	// Import filename
	$i=0;
	...
	$atleast_one_err = 0;
	$i =0;
	$category_name = "MOBILITY SCOOTER COVERS";
	...
	{ 
		if($i!=0) // case of header row
		{
			...
			$web_price        =  trim($data[12]);
			 ...
			 {
			    $variable_array = array("Size"=>trim($data[13]));
			}
			  if(trim($data[14])!=''  and strtolower(trim($data[14]))!='n/a')
			 {
			     $variable_array1= array("Height"=>trim($data[14]));
				 $variable_array  =  $variable_array  +  $variable_array1;
			}
			  if(trim($data[15])!=''  and strtolower(trim($data[15]))!='n/a')
			 {
			     $variable_array2= array("Width"=>trim($data[15]));
				 $variable_array  =  $variable_array  +  $variable_array2;
			}
			  if(trim($data[16])!=''  and strtolower(trim($data[16]))!='n/a')
			 {
			     $variable_array3= array("Legnth"=>trim($data[16]));
				 $variable_array  =  $variable_array  +  $variable_array3;
			}
			  if(trim($data[17])!=''  and strtolower(trim($data[17]))!='n/a')
			 {
			     $variable_array4= array("Colour"=>trim($data[17]));
				 $variable_array  =  $variable_array  +  $variable_array4;
			}
			 //$variable_array = array("Size"=>trim($data[13]),"Height"=>trim($data[14]),"Width"=>trim($data[15]),"Length"=>trim($data[16]),"Colour"=>trim($data[17]));
			...
			if($data[20]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Shipping Size (S,L)</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[20]</td></tr>";
			if($data[22]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Engineered Delivery</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[22]</td></tr>";
			if($data[23]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Vatable</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[23]</td></tr>";
