<?php
	...
	$import_file 			= 'discountmobility-csv/FinalRiseRecliners.csv';	// Import filename
	$i=0;
    ...
    */ 
	...
	{ 
		if($i!=0) // case of header row
		{
			...
			$variable_name1   = "Colours";
			$variable_values2 =  $data[25];
			$variable_name2   = "Material";
			
			 $variable_array = array();
			   if(trim($data[13])!=''  and strtolower(trim($data[13]))!='n/a')
			 {
			     $variable_array1= array("Colours"=>trim($data[13]));
				 $variable_array  =  $variable_array  +  $variable_array1;
			}
			  if(trim($data[25])!=''  and strtolower(trim($data[25]))!='n/a')
			 {
			     $variable_array2= array("Material"=>trim($data[25]));
			...
			if($data[14]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Chair Height(cm)</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[14]</td></tr>";
			if($data[15]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Chair Width (cm)</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[15]</td></tr>";
			if($data[16]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Chair Depth (cm)</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[16]</td></tr>";
			
			if($data[17]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Seat Height (cm)</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[17]</td></tr>";
			if($data[18]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Seat Width (cm)</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[18]</td></tr>";
			if($data[19]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Seat Depth (cm)</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[19]</td></tr>";
			if($data[20]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Maximum User Weight (stones)</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[20]</td></tr>";
			if($data[21]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Footstool Height</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[21]</td></tr>";

			if($data[22]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Footstool Width</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[22]</td></tr>";
			if($data[23]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Footstool Depth</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[23]</td></tr>";
			if($data[24]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Dual/Single Motor</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[24]</td></tr>";
