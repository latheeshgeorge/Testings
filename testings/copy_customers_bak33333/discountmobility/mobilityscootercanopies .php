<?php
	...
	$import_file 			= 'discountmobility-csv/MOBILITY SCOOTER CANOPIES.csv';	// Import filename
	$i=0;
	...
	$atleast_one_err = 0;
	$i =0;
	$category_name = "MOBILITY SCOOTER CANOPIES";
	...
	{ 
		if($i!=0) // case of header row
		{
			...
			$web_price        =  trim($data[12]);
			 ...
			 if($data[16]!=''  and strtolower(trim($data[16]))!='n/a')
			 $variable_array = array("Colour"=>$data[16]);
			...
			if($data[13]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Height</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[13]</td></tr>";

			if($data[14]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Width</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[14]</td></tr>";
if($data[15]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Length</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[15]</td></tr>";

			
if($data[17]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Web Weight (kg)</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[17]</td></tr>";

		
			if($data[19]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Shipping Size (S,L)</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[19]</td></tr>";
			if($data[21]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Engineered Delivery</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[21]</td></tr>";
			if($data[22]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Vatable</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[22]</td></tr>";
