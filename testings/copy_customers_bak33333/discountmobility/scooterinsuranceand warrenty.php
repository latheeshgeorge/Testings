<?php
	...
	$import_file 			= 'discountmobility-csv/SCOOTER INSURANCE AND WARRANTY.csv';	// Import filename
	$i=0;
	...
	$atleast_one_err = 0;
	$i =0;
	$category_name = "SCOOTER INSURANCE AND WARRANTY";
    ...
    */ 
	...
	{ 
		if($i!=0) // case of header row
		{
			...
			$vendor 		  =  trim($data[3]);
			$exactprice       =  trim($data[4]);
			$web_price        =  trim($data[9]);
			$manufacture_id   ="-";
			$decription_tab   = ""; 
			...
			if($data[11]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Accidental Damage	</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[11]</td></tr>";
			if($data[12]!='')
			$decription_tab  .= "<tr><td class='desc_left'>24/7 breakdown recovery (following accident)</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[12]</td></tr>";
			if($data[13]!='')
			$decription_tab  .= "<tr><td class='desc_left'>24/7 breakdown recovery (for puncture and battery failure)</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[13]</td></tr>";
			
			if($data[14]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Public Liability (Up to £2million)</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[14]</td></tr>";
			if($data[15]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Theft and Vandalism</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[15]</td></tr>";
			if($data[16]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Loss of Keys</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[16]</td></tr>";
			if($data[17]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Legal expenses</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[17]</td></tr>";
			if($data[18]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Manual wheelchair</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[18]</td></tr>";

			if($data[19]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Alternative mobility equipment</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[19]</td></tr>";
			if($data[20]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Any driver</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[20]</td></tr>";

			if($data[21]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Mechanical and Electrical Breakdown</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[21]</td></tr>";
			if($data[22]!='')
			$decription_tab  .= "<tr><td class='desc_left'>Parts, Labour and Callout</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[22]</td></tr>";

			if($data[23]!='')
			$decription_tab  .= "<tr><td class='desc_left'>No Excess</td><td class='desc_middle'>&nbsp;:&nbsp;</td><td class='desc_right'>$data[23]</td></tr>";
