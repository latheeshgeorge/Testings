<?php
	...
	$db->select_db();
	$siteid 				= 61;
	$added_date 			= '2015-04-21 00:00:00';
	$filename ='garraways_customers'.$added_date.'.csv';
	$fp = fopen ($filename,'w');
	...
	$sql_prod = "SELECT customer_accounttype,customer_title,customer_fname,customer_mname,customer_surname,customer_position,
					...
					WHERE 
						...
						AND customer_addedon >= '$added_date' 
